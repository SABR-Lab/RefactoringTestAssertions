...
public class UndocumentedRestApiOperationCheck extends com.puppycrawl.tools.checkstyle.api.AbstractCheck {
    ...
    private static boolean isApiOperation(com.puppycrawl.tools.checkstyle.api.DetailAST ast) {
        com.puppycrawl.tools.checkstyle.api.DetailAST modifiers = ast.findFirstToken(com.puppycrawl.tools.checkstyle.api.TokenTypes.MODIFIERS);
        if (modifiers.findFirstToken(com.puppycrawl.tools.checkstyle.api.TokenTypes.LITERAL_PRIVATE) != null) {
            return false;
        }
        ...
        while (annotation != null) {
            com.puppycrawl.tools.checkstyle.api.DetailAST name = annotation.findFirstToken(com.puppycrawl.tools.checkstyle.api.TokenTypes.IDENT);
