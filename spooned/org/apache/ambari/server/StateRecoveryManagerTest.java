...
public class StateRecoveryManagerTest {
    ...
    public void setup() throws java.lang.Exception {
        ...
        serviceComponentDesiredStateDAOMock = org.easymock.EasyMock.createNiceMock(org.apache.ambari.server.orm.dao.ServiceComponentDesiredStateDAO.class);
    ...
    private org.apache.ambari.server.orm.entities.HostVersionEntity getHostVersionMock(java.lang.String name, org.apache.ambari.server.state.RepositoryVersionState state, org.easymock.Capture<org.apache.ambari.server.state.RepositoryVersionState> newStateCaptor) {
        org.apache.ambari.server.orm.entities.HostVersionEntity hvMock = org.easymock.EasyMock.createNiceMock(org.apache.ambari.server.orm.entities.HostVersionEntity.class);
        org.easymock.EasyMock.expect(hvMock.getState()).andReturn(state);
        hvMock.setState(org.easymock.EasyMock.capture(newStateCaptor));
        org.easymock.EasyMock.expectLastCall();
        org.apache.ambari.server.orm.entities.RepositoryVersionEntity rvMock = org.easymock.EasyMock.createNiceMock(org.apache.ambari.server.orm.entities.RepositoryVersionEntity.class);
        org.easymock.EasyMock.expect(rvMock.getDisplayName()).andReturn(name);
        org.easymock.EasyMock.expect(hvMock.getRepositoryVersion()).andReturn(rvMock);
        org.easymock.EasyMock.expect(hvMock.getHostName()).andReturn("somehost");
        org.easymock.EasyMock.replay(hvMock, rvMock);
        return hvMock;
    }
    ...
    private org.apache.ambari.server.orm.entities.ServiceComponentDesiredStateEntity getDesiredStateEntityMock(java.lang.String name, org.apache.ambari.server.state.RepositoryVersionState state, org.easymock.Capture<org.apache.ambari.server.state.RepositoryVersionState> newStateCapture) {
        org.apache.ambari.server.orm.entities.ServiceComponentDesiredStateEntity mock = org.easymock.EasyMock.createNiceMock(org.apache.ambari.server.orm.entities.ServiceComponentDesiredStateEntity.class);
        org.easymock.EasyMock.expect(mock.getRepositoryState()).andReturn(state);
        mock.setRepositoryState(org.easymock.EasyMock.capture(newStateCapture));
        org.easymock.EasyMock.expectLastCall();
        org.apache.ambari.server.orm.entities.RepositoryVersionEntity repositoryVersionMock = org.easymock.EasyMock.createNiceMock(org.apache.ambari.server.orm.entities.RepositoryVersionEntity.class);
        org.easymock.EasyMock.expect(repositoryVersionMock.getVersion()).andReturn(name);
        org.easymock.EasyMock.expect(mock.getDesiredRepositoryVersion()).andReturn(repositoryVersionMock);
        org.easymock.EasyMock.replay(mock, repositoryVersionMock);
        return mock;
    }
