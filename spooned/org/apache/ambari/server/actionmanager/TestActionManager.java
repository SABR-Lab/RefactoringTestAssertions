...
public class TestActionManager {
    ...
    public void testGetActions() throws java.lang.Exception {
        int requestId = 500;
        org.apache.ambari.server.actionmanager.ActionDBAccessor db = org.easymock.EasyMock.createStrictMock(org.apache.ambari.server.actionmanager.ActionDBAccessor.class);
        ...
        org.easymock.EasyMock.expect(db.getLastPersistedRequestIdWhenInitialized()).andReturn(java.lang.Long.valueOf(1000));
        org.easymock.EasyMock.expect(db.getAllStages(requestId)).andReturn(listStages);
        org.easymock.EasyMock.replay(db, clusters);
        org.apache.ambari.server.actionmanager.ActionScheduler actionScheduler = new org.apache.ambari.server.actionmanager.ActionScheduler(0, 0, db, org.easymock.EasyMock.createNiceMock(org.apache.ambari.server.events.publishers.JPAEventPublisher.class));
        ...
        org.easymock.EasyMock.verify(db, clusters);
    }
