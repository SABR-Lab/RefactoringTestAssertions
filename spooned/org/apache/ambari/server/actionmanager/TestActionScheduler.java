...
public class TestActionScheduler {
    ...
    public void setup() throws java.lang.Exception {
        ...
        org.easymock.EasyMock.expect(entityManagerProviderMock.get()).andReturn(null);
        org.easymock.EasyMock.replay(entityManagerProviderMock);
    }
    ...
    public void testActionSchedule() throws java.lang.Exception {
        ...
        org.apache.ambari.server.state.Clusters fsm = org.mockito.Mockito.mock(org.apache.ambari.server.state.Clusters.class);
        org.apache.ambari.server.state.Cluster oneClusterMock = org.mockito.Mockito.mock(org.apache.ambari.server.state.Cluster.class);
        org.apache.ambari.server.state.Service serviceObj = org.mockito.Mockito.mock(org.apache.ambari.server.state.Service.class);
        org.apache.ambari.server.state.ServiceComponent scomp = org.mockito.Mockito.mock(org.apache.ambari.server.state.ServiceComponent.class);
        org.apache.ambari.server.state.ServiceComponentHost sch = org.mockito.Mockito.mock(org.apache.ambari.server.state.ServiceComponentHost.class);
        com.google.inject.persist.UnitOfWork unitOfWork = org.mockito.Mockito.mock(com.google.inject.persist.UnitOfWork.class);
        org.apache.ambari.server.events.publishers.AgentCommandsPublisher agentCommandsPublisher = org.mockito.Mockito.mock(org.apache.ambari.server.events.publishers.AgentCommandsPublisher.class);
        org.mockito.Mockito.when(fsm.getCluster(org.mockito.Matchers.anyString())).thenReturn(oneClusterMock);
        org.mockito.Mockito.when(fsm.getClusterById(org.mockito.Matchers.anyLong())).thenReturn(oneClusterMock);
        org.mockito.Mockito.when(oneClusterMock.getService(org.mockito.Matchers.anyString())).thenReturn(serviceObj);
        org.mockito.Mockito.when(oneClusterMock.getClusterId()).thenReturn(java.lang.Long.valueOf(1L));
        org.mockito.Mockito.when(serviceObj.getServiceComponent(org.mockito.Matchers.anyString())).thenReturn(scomp);
        org.mockito.Mockito.when(scomp.getServiceComponentHost(org.mockito.Matchers.anyString())).thenReturn(sch);
        org.mockito.Mockito.when(serviceObj.getCluster()).thenReturn(oneClusterMock);
        ...
        org.mockito.Mockito.when(scomp.getServiceComponentHosts()).thenReturn(hosts);
        org.mockito.Mockito.when(fsm.getHost(org.mockito.Matchers.anyString())).thenReturn(host);
        org.mockito.Mockito.when(host.getState()).thenReturn(org.apache.ambari.server.state.HostState.HEALTHY);
        org.mockito.Mockito.when(host.getHostName()).thenReturn(hostname);
        org.mockito.Mockito.when(host.getHostId()).thenReturn(hostId);
        org.apache.ambari.server.actionmanager.ActionDBAccessor db = org.mockito.Mockito.mock(org.apache.ambari.server.actionmanager.ActionDBAccessorImpl.class);
        org.apache.ambari.server.orm.dao.HostRoleCommandDAO hostRoleCommandDAOMock = org.mockito.Mockito.mock(org.apache.ambari.server.orm.dao.HostRoleCommandDAO.class);
        org.mockito.Mockito.doNothing().when(hostRoleCommandDAOMock).publishTaskCreateEvent(org.mockito.Matchers.anyListOf(org.apache.ambari.server.actionmanager.HostRoleCommand.class));
        ...
        org.mockito.Mockito.when(db.getCommandsInProgressCount()).thenReturn(stages.size());
        org.mockito.Mockito.when(db.getFirstStageInProgressPerRequest()).thenReturn(stages);
        org.apache.ambari.server.orm.entities.RequestEntity request = org.mockito.Mockito.mock(org.apache.ambari.server.orm.entities.RequestEntity.class);
        org.mockito.Mockito.when(request.isExclusive()).thenReturn(false);
        org.mockito.Mockito.when(request.getClusterHostInfo()).thenReturn(org.apache.ambari.server.actionmanager.TestActionScheduler.CLUSTER_HOST_INFO);
        org.mockito.Mockito.when(db.getRequestEntity(org.mockito.Matchers.anyLong())).thenReturn(request);
    ...
    private java.util.List<org.apache.ambari.server.agent.AgentCommand> waitForQueueSize(java.lang.Long hostId, org.apache.ambari.server.events.publishers.AgentCommandsPublisher agentCommandsPublisher, int expectedQueueSize, org.apache.ambari.server.actionmanager.ActionScheduler scheduler) throws org.apache.ambari.server.AmbariException {
        ...
        while ((counter++) <= MAX_CYCLE_ITERATIONS) {
            ...
            if (callsCount == expectedQueueSize) {
                org.mockito.Mockito.verify(agentCommandsPublisher, org.mockito.Mockito.times(methodCallCounter.get())).sendAgentCommand(executionCommandCaptor.capture());
    ...
    private void resetAgentCommandPublisherMock(org.apache.ambari.server.events.publishers.AgentCommandsPublisher agentCommandsPublisher, com.google.common.util.concurrent.AtomicLongMap<java.lang.Long> callCounterByHost, java.util.concurrent.atomic.AtomicInteger methodCallCounter) throws org.apache.ambari.server.AmbariException {
        org.mockito.Mockito.reset(agentCommandsPublisher);
        org.mockito.Mockito.doAnswer(i -> {
            ...
            return null;
        }).when(agentCommandsPublisher).sendAgentCommand(org.mockito.Matchers.any(com.google.common.collect.Multimap.class));
    }
    ...
    public void testActionScheduleWithDependencyOrderedCommandExecution() throws java.lang.Exception {
        ...
        com.google.inject.persist.UnitOfWork unitOfWork = org.mockito.Mockito.mock(com.google.inject.persist.UnitOfWork.class);
        org.apache.ambari.server.events.publishers.AgentCommandsPublisher agentCommandsPublisher = org.mockito.Mockito.mock(org.apache.ambari.server.events.publishers.AgentCommandsPublisher.class);
        org.apache.ambari.server.metadata.RoleCommandOrderProvider rcoProvider = org.mockito.Mockito.mock(org.apache.ambari.server.metadata.RoleCommandOrderProvider.class);
        org.apache.ambari.server.metadata.RoleCommandOrder rco = org.mockito.Mockito.mock(org.apache.ambari.server.metadata.RoleCommandOrder.class);
        org.mockito.Mockito.when(fsm.getCluster(org.mockito.Matchers.anyString())).thenReturn(oneClusterMock);
        org.mockito.Mockito.when(fsm.getClusterById(org.mockito.Matchers.anyLong())).thenReturn(oneClusterMock);
        org.mockito.Mockito.when(oneClusterMock.getService(org.mockito.Matchers.anyString())).thenReturn(serviceObj);
        org.mockito.Mockito.when(oneClusterMock.getClusterId()).thenReturn(java.lang.Long.valueOf(1L));
        ...
        org.mockito.Mockito.when(scomp.getServiceComponentHost(org.mockito.Matchers.anyString())).thenReturn(sch);
        org.mockito.Mockito.when(serviceObj.getCluster()).thenReturn(oneClusterMock);
        org.mockito.Mockito.when(rcoProvider.getRoleCommandOrder(1L)).thenReturn(rco);
        ...
        org.mockito.Mockito.when(rco.getDependencies()).thenReturn(roleCommandDependencies);
        org.apache.ambari.server.state.Host host = org.mockito.Mockito.mock(org.apache.ambari.server.state.Host.class);
        java.util.HashMap<java.lang.String, org.apache.ambari.server.state.ServiceComponentHost> hosts = new java.util.HashMap<>();
        hosts.put(hostname, sch);
        org.apache.ambari.server.orm.entities.HostEntity hostEntity = new org.apache.ambari.server.orm.entities.HostEntity();
    ...
    public void testActionTimeout() throws java.lang.Exception {
        ...
        com.google.inject.persist.UnitOfWork unitOfWork = org.mockito.Mockito.mock(com.google.inject.persist.UnitOfWork.class);
        org.apache.ambari.server.events.publishers.AgentCommandsPublisher agentCommandsPublisher = org.mockito.Mockito.mock(org.apache.ambari.server.events.publishers.AgentCommandsPublisher.class);
        org.mockito.Mockito.when(fsm.getCluster(org.mockito.ArgumentMatchers.nullable(java.lang.String.class))).thenReturn(oneClusterMock);
        org.mockito.Mockito.when(oneClusterMock.getService(org.mockito.Matchers.anyString())).thenReturn(serviceObj);
        org.mockito.Mockito.when(serviceObj.getServiceComponent(org.mockito.Matchers.anyString())).thenReturn(scomp);
        org.mockito.Mockito.when(scomp.getServiceComponentHost(org.mockito.Matchers.anyString())).thenReturn(sch);
        org.mockito.Mockito.when(serviceObj.getCluster()).thenReturn(oneClusterMock);
        ...
        java.util.List<org.apache.ambari.server.actionmanager.Stage> stages = java.util.Collections.singletonList(s);
        org.apache.ambari.server.actionmanager.ActionDBAccessor db = org.mockito.Mockito.mock(org.apache.ambari.server.actionmanager.ActionDBAccessor.class);
        org.apache.ambari.server.orm.dao.HostRoleCommandDAO hostRoleCommandDAOMock = org.mockito.Mockito.mock(org.apache.ambari.server.orm.dao.HostRoleCommandDAO.class);
        org.mockito.Mockito.doNothing().when(hostRoleCommandDAOMock).publishTaskCreateEvent(org.mockito.Matchers.anyListOf(org.apache.ambari.server.actionmanager.HostRoleCommand.class));
        org.mockito.Mockito.when(db.getCommandsInProgressCount()).thenReturn(stages.size());
        org.mockito.Mockito.when(db.getFirstStageInProgressPerRequest()).thenReturn(stages);
        ...
        org.mockito.Mockito.when(request.getClusterHostInfo()).thenReturn(org.apache.ambari.server.actionmanager.TestActionScheduler.CLUSTER_HOST_INFO);
        org.mockito.Mockito.when(db.getRequestEntity(org.mockito.Matchers.anyLong())).thenReturn(request);
        org.mockito.Mockito.doAnswer(new org.mockito.stubbing.Answer<java.lang.Void>() {
            @java.lang.Override
        ...
        }).when(db).timeoutHostRole(org.mockito.ArgumentMatchers.nullable(java.lang.String.class), org.mockito.Matchers.anyLong(), org.mockito.Matchers.anyLong(), org.mockito.Matchers.anyString(), org.mockito.Matchers.anyBoolean(), org.mockito.Matchers.eq(false));
        ...
        org.mockito.Mockito.verify(db, org.mockito.Mockito.times(1)).startRequest(org.mockito.Matchers.eq(1L));
        org.mockito.Mockito.verify(db, org.mockito.Mockito.times(1)).abortOperation(1L);
        org.easymock.EasyMock.verify(entityManagerProviderMock);
    }
    ...
    public void testActionTimeoutForLostHost() throws java.lang.Exception {
        ...
        org.mockito.Mockito.when(scomp.getServiceComponentHosts()).thenReturn(hosts);
        org.mockito.Mockito.when(fsm.getHost(org.mockito.Matchers.anyString())).thenReturn(host);
        org.mockito.Mockito.when(host.getState()).thenReturn(org.apache.ambari.server.state.HostState.HEARTBEAT_LOST);
        org.mockito.Mockito.when(host.getHostName()).thenReturn(hostname);
        final org.apache.ambari.server.actionmanager.Stage s = org.apache.ambari.server.utils.StageUtils.getATestStage(1, 977, hostname, "{\"host_param\":\"param_value\"}", "{\"stage_param\":\"param_value\"}");
        java.util.List<org.apache.ambari.server.actionmanager.Stage> stages = java.util.Collections.singletonList(s);
        org.apache.ambari.server.actionmanager.ActionDBAccessor db = org.mockito.Mockito.mock(org.apache.ambari.server.actionmanager.ActionDBAccessor.class);
        ...
        }).when(db).timeoutHostRole(org.mockito.ArgumentMatchers.nullable(java.lang.String.class), org.mockito.Matchers.anyLong(), org.mockito.Matchers.anyLong(), org.mockito.Matchers.anyString(), org.mockito.Matchers.anyBoolean(), org.mockito.Matchers.eq(true));
    ...
    public void testOpFailedEventRaisedForAbortedHostRole() throws java.lang.Exception {
        ...
        org.apache.ambari.server.state.Service serviceObj = org.mockito.Mockito.mock(org.apache.ambari.server.state.Service.class);
        org.apache.ambari.server.state.ServiceComponent scomp = org.mockito.Mockito.mock(org.apache.ambari.server.state.ServiceComponent.class);
        org.apache.ambari.server.state.ServiceComponentHost sch1 = org.mockito.Mockito.mock(org.apache.ambari.server.state.ServiceComponentHost.class);
        org.apache.ambari.server.state.ServiceComponentHost sch2 = org.mockito.Mockito.mock(org.apache.ambari.server.state.ServiceComponentHost.class);
        ...
        org.mockito.Mockito.when(scomp.getServiceComponentHosts()).thenReturn(hosts);
        org.mockito.Mockito.when(fsm.getHost(hostname1)).thenReturn(host1);
        org.mockito.Mockito.when(fsm.getHost(hostname2)).thenReturn(host2);
        org.mockito.Mockito.when(host1.getState()).thenReturn(org.apache.ambari.server.state.HostState.HEARTBEAT_LOST);
        org.mockito.Mockito.when(host2.getState()).thenReturn(org.apache.ambari.server.state.HostState.HEALTHY);
        org.mockito.Mockito.when(host1.getHostName()).thenReturn(hostname1);
        org.mockito.Mockito.when(host2.getHostName()).thenReturn(hostname2);
        org.mockito.Mockito.when(scomp.getServiceComponentHost(hostname1)).thenReturn(sch1);
        org.mockito.Mockito.when(scomp.getServiceComponentHost(hostname2)).thenReturn(sch2);
        com.google.inject.persist.UnitOfWork unitOfWork = org.mockito.Mockito.mock(com.google.inject.persist.UnitOfWork.class);
        org.apache.ambari.server.events.publishers.AgentCommandsPublisher agentCommandsPublisher = org.mockito.Mockito.mock(org.apache.ambari.server.events.publishers.AgentCommandsPublisher.class);
        org.mockito.Mockito.when(fsm.getCluster(org.mockito.ArgumentMatchers.nullable(java.lang.String.class))).thenReturn(oneClusterMock);
        org.mockito.Mockito.when(oneClusterMock.getService(org.mockito.Matchers.anyString())).thenReturn(serviceObj);
        ...
        org.mockito.Mockito.doAnswer(new org.mockito.stubbing.Answer<java.util.Collection<org.apache.ambari.server.orm.entities.HostRoleCommandEntity>>() {
            @java.lang.Override
        ...
        }).when(db).abortOperation(org.mockito.Matchers.anyLong());
        ...
        org.mockito.Mockito.verify(sch1, org.mockito.Mockito.atLeastOnce()).handleEvent(eventsCapture1.capture());
        org.mockito.Mockito.verify(sch2, org.mockito.Mockito.atLeastOnce()).handleEvent(eventsCapture2.capture());
    ...
    public void testServerAction() throws java.lang.Exception {
        ...
        }).when(db).updateHostRoleState(org.mockito.ArgumentMatchers.nullable(java.lang.String.class), org.mockito.Matchers.anyLong(), org.mockito.Matchers.anyLong(), org.mockito.Matchers.anyString(), org.mockito.Matchers.any(org.apache.ambari.server.agent.CommandReport.class));
        org.mockito.Mockito.doAnswer(new org.mockito.stubbing.Answer<org.apache.ambari.server.actionmanager.HostRoleCommand>() {
            @java.lang.Override
        ...
        }).when(db).getTask(org.mockito.Matchers.anyLong());
        org.mockito.Mockito.doAnswer(new org.mockito.stubbing.Answer<java.util.List<org.apache.ambari.server.actionmanager.HostRoleCommand>>() {
            @java.lang.Override
        ...
        }).when(db).getTasksByRoleAndStatus(org.mockito.Matchers.anyString(), org.mockito.Matchers.any(org.apache.ambari.server.actionmanager.HostRoleStatus.class));
    ...
    public void testTimeOutWithHostNull() throws org.apache.ambari.server.AmbariException {
        ...
        org.apache.ambari.server.actionmanager.ActionScheduler scheduler = org.easymock.EasyMock.createMockBuilder(org.apache.ambari.server.actionmanager.ActionScheduler.class).withConstructor(long.class, long.class, org.apache.ambari.server.actionmanager.ActionDBAccessor.class, org.apache.ambari.server.state.Clusters.class, int.class, org.apache.ambari.server.controller.HostsMap.class, com.google.inject.persist.UnitOfWork.class, org.apache.ambari.server.events.publishers.AmbariEventPublisher.class, org.apache.ambari.server.configuration.Configuration.class, com.google.inject.Provider.class, org.apache.ambari.server.orm.dao.HostRoleCommandDAO.class, org.apache.ambari.server.actionmanager.HostRoleCommandFactory.class, org.apache.ambari.server.events.publishers.AgentCommandsPublisher.class).withArgs(100L, 50L, null, null, -1, null, null, null, null, entityManagerProviderMock, org.mockito.Mockito.mock(org.apache.ambari.server.orm.dao.HostRoleCommandDAO.class), org.mockito.Mockito.mock(org.apache.ambari.server.actionmanager.HostRoleCommandFactory.class), org.mockito.Mockito.mock(org.apache.ambari.server.events.publishers.AgentCommandsPublisher.class)).createNiceMock();
    ...
    public void testIndependentStagesExecution() throws java.lang.Exception {
        ...
        org.apache.ambari.server.state.Host host1 = org.mockito.Mockito.mock(org.apache.ambari.server.state.Host.class);
        org.mockito.Mockito.when(fsm.getHost(hostname1)).thenReturn(host1);
        org.mockito.Mockito.when(host1.getState()).thenReturn(org.apache.ambari.server.state.HostState.HEALTHY);
        org.mockito.Mockito.when(host1.getHostName()).thenReturn(hostname1);
        org.mockito.Mockito.when(host1.getHostId()).thenReturn(hostId1);
        org.apache.ambari.server.state.Host host2 = org.mockito.Mockito.mock(org.apache.ambari.server.state.Host.class);
        org.mockito.Mockito.when(fsm.getHost(hostname2)).thenReturn(host2);
        org.mockito.Mockito.when(host2.getState()).thenReturn(org.apache.ambari.server.state.HostState.HEALTHY);
        org.mockito.Mockito.when(host2.getHostName()).thenReturn(hostname2);
        org.mockito.Mockito.when(host2.getHostId()).thenReturn(hostId2);
        org.apache.ambari.server.state.Host host3 = org.mockito.Mockito.mock(org.apache.ambari.server.state.Host.class);
        org.mockito.Mockito.when(fsm.getHost(hostname3)).thenReturn(host3);
        org.mockito.Mockito.when(host3.getState()).thenReturn(org.apache.ambari.server.state.HostState.HEALTHY);
        org.mockito.Mockito.when(host3.getHostName()).thenReturn(hostname3);
        org.mockito.Mockito.when(host3.getHostId()).thenReturn(hostId3);
        org.apache.ambari.server.state.Host host4 = org.mockito.Mockito.mock(org.apache.ambari.server.state.Host.class);
        org.mockito.Mockito.when(fsm.getHost(hostname4)).thenReturn(host4);
        org.mockito.Mockito.when(host4.getState()).thenReturn(org.apache.ambari.server.state.HostState.HEALTHY);
        org.mockito.Mockito.when(host4.getHostName()).thenReturn(hostname4);
        org.mockito.Mockito.when(host4.getHostId()).thenReturn(hostId4);
        ...
        org.mockito.Mockito.when(hostRoleCommandDAOMock.getBlockingHostsForRequest(1, 1)).thenReturn(blockingHostsRequest1);
        java.util.List<java.lang.String> blockingHostsRequest2 = com.google.common.collect.Lists.newArrayList(hostname1);
        org.mockito.Mockito.when(hostRoleCommandDAOMock.getBlockingHostsForRequest(1, 2)).thenReturn(blockingHostsRequest2);
        org.apache.ambari.server.orm.entities.RequestEntity request = org.mockito.Mockito.mock(org.apache.ambari.server.orm.entities.RequestEntity.class);
        org.mockito.Mockito.when(request.isExclusive()).thenReturn(false);
        org.mockito.Mockito.when(request.getClusterHostInfo()).thenReturn(org.apache.ambari.server.actionmanager.TestActionScheduler.CLUSTER_HOST_INFO);
        org.mockito.Mockito.when(db.getRequestEntity(org.mockito.Matchers.anyLong())).thenReturn(request);
        org.mockito.Mockito.when(db.getCommandsInProgressCount()).thenReturn(firstStageInProgressPerRequest.size());
        org.mockito.Mockito.when(db.getFirstStageInProgressPerRequest()).thenReturn(firstStageInProgressPerRequest);
        java.util.Properties properties = new java.util.Properties();
        org.apache.ambari.server.configuration.Configuration conf = new org.apache.ambari.server.configuration.Configuration(properties);
        org.apache.ambari.server.actionmanager.ActionScheduler scheduler = org.mockito.Mockito.spy(new org.apache.ambari.server.actionmanager.ActionScheduler(100, 50, db, fsm, 3, new org.apache.ambari.server.controller.HostsMap(((java.lang.String) (null))), unitOfWork, null, conf, entityManagerProviderMock, hostRoleCommandDAOMock, ((org.apache.ambari.server.actionmanager.HostRoleCommandFactory) (null)), agentCommandsPublisher));
        org.mockito.Mockito.doReturn(false).when(scheduler).wasAgentRestartedDuringOperation(org.mockito.Matchers.any(org.apache.ambari.server.state.Host.class), org.mockito.Matchers.any(org.apache.ambari.server.actionmanager.Stage.class), org.mockito.Matchers.anyString());
        scheduler.doWork();
    ...
    public void testRequestFailureOnStageFailure() throws java.lang.Exception {
        ...
        org.apache.ambari.server.state.ServiceComponentHost sch = org.mockito.Mockito.mock(org.apache.ambari.server.state.ServiceComponentHost.class);
        com.google.inject.persist.UnitOfWork unitOfWork = org.mockito.Mockito.mock(com.google.inject.persist.UnitOfWork.class);
        org.apache.ambari.server.events.publishers.AmbariEventPublisher ambariEventPublisher = org.mockito.Mockito.mock(org.apache.ambari.server.events.publishers.AmbariEventPublisher.class);
        org.apache.ambari.server.actionmanager.RequestFactory requestFactory = org.mockito.Mockito.mock(org.apache.ambari.server.actionmanager.RequestFactory.class);
        org.mockito.Mockito.when(fsm.getCluster(org.mockito.Matchers.anyString())).thenReturn(oneClusterMock);
        org.mockito.Mockito.when(oneClusterMock.getService(org.mockito.Matchers.anyString())).thenReturn(serviceObj);
        org.mockito.Mockito.when(serviceObj.getServiceComponent(org.mockito.Matchers.anyString())).thenReturn(scomp);
        org.mockito.Mockito.when(scomp.getServiceComponentHost(org.mockito.Matchers.anyString())).thenReturn(sch);
        ...
        org.mockito.Mockito.when(db.getRequestEntity(org.mockito.Matchers.anyLong())).thenReturn(request);
        org.mockito.Mockito.when(db.getCommandsInProgressCount()).thenReturn(stages.size());
        org.mockito.Mockito.when(db.getFirstStageInProgressPerRequest()).thenReturn(firstStageInProgress);
        org.mockito.Mockito.doAnswer(new org.mockito.stubbing.Answer<java.lang.Void>() {
            @java.lang.Override
            public java.lang.Void answer(org.mockito.invocation.InvocationOnMock invocation) throws java.lang.Throwable {
        ...
        }).when(db).updateHostRoleStates(org.mockito.Matchers.anyCollectionOf(org.apache.ambari.server.agent.CommandReport.class));
        org.mockito.Mockito.when(db.getTask(org.mockito.Matchers.anyLong())).thenAnswer(new org.mockito.stubbing.Answer<java.lang.Object>() {
            @java.lang.Override
        ...
        org.apache.ambari.server.actionmanager.ActionScheduler scheduler = org.easymock.EasyMock.createMockBuilder(org.apache.ambari.server.actionmanager.ActionScheduler.class).withConstructor(((long) (100)), ((long) (50)), db, fsm, 3, new org.apache.ambari.server.controller.HostsMap(((java.lang.String) (null))), unitOfWork, org.easymock.EasyMock.createNiceMock(org.apache.ambari.server.events.publishers.AmbariEventPublisher.class), conf, entityManagerProviderMock, org.mockito.Mockito.mock(org.apache.ambari.server.orm.dao.HostRoleCommandDAO.class), org.mockito.Mockito.mock(org.apache.ambari.server.actionmanager.HostRoleCommandFactory.class), org.mockito.Mockito.mock(org.apache.ambari.server.metadata.RoleCommandOrderProvider.class), org.mockito.Mockito.mock(org.apache.ambari.server.events.publishers.AgentCommandsPublisher.class)).addMockedMethod("cancelHostRoleCommands").createMock();
    ...
    public void testRequestAbortsOnlyWhenNoQueuedTaskAndSuccessFactorUnmet() throws java.lang.Exception {
        ...
        org.mockito.Mockito.when(fsm.getHost(org.mockito.Matchers.anyString())).thenReturn(host);
        org.mockito.Mockito.when(host.getState()).thenReturn(org.apache.ambari.server.state.HostState.HEALTHY);
        org.mockito.Mockito.when(host.getHostName()).thenReturn(host1);
        org.apache.ambari.server.orm.entities.HostEntity hostEntity1 = new org.apache.ambari.server.orm.entities.HostEntity();
        org.apache.ambari.server.orm.entities.HostEntity hostEntity2 = new org.apache.ambari.server.orm.entities.HostEntity();
        ...
        }).when(db).updateHostRoleState(org.mockito.Matchers.anyString(), org.mockito.Matchers.anyLong(), org.mockito.Matchers.anyLong(), org.mockito.Matchers.anyString(), org.mockito.Matchers.any(org.apache.ambari.server.agent.CommandReport.class));
        org.mockito.Mockito.when(db.getTask(org.mockito.Matchers.anyLong())).thenAnswer(new org.mockito.stubbing.Answer<java.lang.Object>() {
            @java.lang.Override
            public java.lang.Object answer(org.mockito.invocation.InvocationOnMock invocation) throws java.lang.Throwable {
                java.lang.Long taskId = ((java.lang.Long) (invocation.getArguments()[0]));
    ...
    public void testRequestFailureBasedOnSuccessFactor() throws java.lang.Exception {
        ...
        org.mockito.Mockito.when(request.isExclusive()).thenReturn(false);
        org.mockito.Mockito.when(db.getRequestEntity(org.mockito.Matchers.anyLong())).thenReturn(request);
        org.mockito.Mockito.when(db.getCommandsInProgressCount()).thenReturn(stageInProgress.size());
        org.mockito.Mockito.when(db.getFirstStageInProgressPerRequest()).thenReturn(stageInProgress);
        org.mockito.Mockito.doAnswer(new org.mockito.stubbing.Answer<java.lang.Void>() {
            @java.lang.Override
            public java.lang.Void answer(org.mockito.invocation.InvocationOnMock invocation) throws java.lang.Throwable {
                java.util.List<org.apache.ambari.server.agent.CommandReport> reports = ((java.util.List<org.apache.ambari.server.agent.CommandReport>) (invocation.getArguments()[0]));
    ...
    public void testClusterHostInfoCache() throws java.lang.Exception {
        ...
        org.mockito.Mockito.when(db.getCommandsInProgressCount()).thenReturn(1);
        org.mockito.Mockito.when(db.getFirstStageInProgressPerRequest()).thenReturn(java.util.Collections.singletonList(s1));
        ...
        org.mockito.Mockito.when(db.getCommandsInProgressCount()).thenReturn(1);
        org.mockito.Mockito.when(db.getFirstStageInProgressPerRequest()).thenReturn(java.util.Collections.singletonList(s2));
    ...
    public void testCommandAbortForDeletedComponent() throws java.lang.Exception {
        ...
        org.apache.ambari.server.state.Service serviceObj = org.mockito.Mockito.mock(org.apache.ambari.server.state.Service.class);
        org.apache.ambari.server.state.ServiceComponent scomp = org.mockito.Mockito.mock(org.apache.ambari.server.state.ServiceComponent.class);
        org.apache.ambari.server.state.ServiceComponent scWithDeletedSCH = org.mockito.Mockito.mock(org.apache.ambari.server.state.ServiceComponent.class);
        org.apache.ambari.server.state.ServiceComponentHost sch1 = org.mockito.Mockito.mock(org.apache.ambari.server.state.ServiceComponentHost.class);
        java.lang.String hostname1 = "host1";
        org.apache.ambari.server.state.Host host1 = org.mockito.Mockito.mock(org.apache.ambari.server.state.Host.class);
        org.mockito.Mockito.when(fsm.getHost(hostname1)).thenReturn(host1);
        ...
        hosts.put(hostname1, sch1);
        org.mockito.Mockito.when(scomp.getServiceComponentHosts()).thenReturn(hosts);
        org.apache.ambari.server.orm.dao.HostRoleCommandDAO hostRoleCommandDAO = org.mockito.Mockito.mock(org.apache.ambari.server.orm.dao.HostRoleCommandDAO.class);
        org.apache.ambari.server.orm.entities.HostEntity hostEntity = new org.apache.ambari.server.orm.entities.HostEntity();
        ...
        org.mockito.Mockito.when(fsm.getCluster(org.mockito.Matchers.anyString())).thenReturn(oneClusterMock);
        org.mockito.Mockito.when(oneClusterMock.getService(org.mockito.Matchers.anyString())).thenReturn(serviceObj);
        org.mockito.Mockito.when(serviceObj.getServiceComponent(org.apache.ambari.server.Role.HBASE_MASTER.toString())).thenReturn(scWithDeletedSCH);
        org.mockito.Mockito.when(serviceObj.getServiceComponent(org.apache.ambari.server.Role.HBASE_REGIONSERVER.toString())).thenReturn(scomp);
        org.mockito.Mockito.when(scWithDeletedSCH.getServiceComponentHost(org.mockito.Matchers.anyString())).thenThrow(new org.apache.ambari.server.ServiceComponentHostNotFoundException("dummyCluster", "dummyService", "dummyComponent", "dummyHostname"));
        org.mockito.Mockito.when(serviceObj.getCluster()).thenReturn(oneClusterMock);
        ...
        org.mockito.Mockito.doAnswer(new org.mockito.stubbing.Answer<java.lang.Object>() {
            @java.lang.Override
            public java.lang.Object answer(org.mockito.invocation.InvocationOnMock invocation) throws java.lang.Throwable {
                java.lang.Long requestId = ((java.lang.Long) (invocation.getArguments()[0]));
                for (org.apache.ambari.server.actionmanager.Stage stage : stages) {
        ...
        org.mockito.Mockito.verify(db, org.mockito.Mockito.times(2)).abortOperation(org.mockito.Matchers.anyLong());
        scheduler.stop();
    }
    ...
    public void testCancelRequests() throws java.lang.Exception {
        ...
        org.apache.ambari.server.events.publishers.AgentCommandsPublisher agentCommandsPublisher = org.mockito.Mockito.mock(org.apache.ambari.server.events.publishers.AgentCommandsPublisher.class);
        org.apache.ambari.server.orm.dao.HostRoleCommandDAO hostRoleCommandDAO = org.mockito.Mockito.mock(org.apache.ambari.server.orm.dao.HostRoleCommandDAO.class);
        org.apache.ambari.server.actionmanager.HostRoleCommandFactory hostRoleCommandFactory = org.mockito.Mockito.mock(org.apache.ambari.server.actionmanager.HostRoleCommandFactory.class);
        org.mockito.Mockito.when(fsm.getCluster(org.mockito.Matchers.anyString())).thenReturn(oneClusterMock);
        org.mockito.Mockito.when(oneClusterMock.getService(org.mockito.Matchers.anyString())).thenReturn(serviceObj);
        org.mockito.Mockito.when(serviceObj.getServiceComponent(org.mockito.Matchers.anyString())).thenReturn(scomp);
        org.mockito.Mockito.when(scomp.getServiceComponentHost(org.mockito.Matchers.anyString())).thenReturn(sch);
        ...
        for (org.apache.ambari.server.actionmanager.HostRoleCommand hostRoleCommand : tasksInProgress) {
            org.apache.ambari.server.orm.entities.HostRoleCommandEntity entity = org.mockito.Mockito.mock(org.apache.ambari.server.orm.entities.HostRoleCommandEntity.class);
            org.mockito.Mockito.when(entity.getTaskId()).thenReturn(hostRoleCommand.getTaskId());
            org.mockito.Mockito.when(entity.getStageId()).thenReturn(hostRoleCommand.getStageId());
            org.mockito.Mockito.when(entity.getRequestId()).thenReturn(hostRoleCommand.getRequestId());
            org.mockito.Mockito.when(entity.getHostId()).thenReturn(hostRoleCommand.getHostId());
            org.mockito.Mockito.when(entity.getHostName()).thenReturn(hostRoleCommand.getHostName());
            org.mockito.Mockito.when(entity.getRole()).thenReturn(hostRoleCommand.getRole());
            org.mockito.Mockito.when(entity.getStatus()).thenReturn(hostRoleCommand.getStatus());
            org.mockito.Mockito.when(entity.getRoleCommand()).thenReturn(hostRoleCommand.getRoleCommand());
            hrcEntitiesInProgress.add(entity);
            org.mockito.Mockito.when(hostRoleCommandFactory.createExisting(entity)).thenReturn(hostRoleCommand);
        }
        org.apache.ambari.server.state.Host host = org.mockito.Mockito.mock(org.apache.ambari.server.state.Host.class);
        org.mockito.Mockito.when(fsm.getHost(org.mockito.Matchers.anyString())).thenReturn(host);
        org.mockito.Mockito.when(host.getState()).thenReturn(org.apache.ambari.server.state.HostState.HEALTHY);
        ...
        org.mockito.Mockito.when(request.getClusterHostInfo()).thenReturn(org.apache.ambari.server.actionmanager.TestActionScheduler.CLUSTER_HOST_INFO);
        org.mockito.Mockito.when(db.getRequestEntity(org.mockito.Matchers.anyLong())).thenReturn(request);
        org.mockito.Mockito.when(db.getCommandsInProgressCount()).thenReturn(stagesInProgress.size());
        org.mockito.Mockito.when(db.getFirstStageInProgressPerRequest()).thenReturn(stagesInProgress);
        org.mockito.Mockito.when(db.getStagesInProgressForRequest(requestId)).thenReturn(stagesInProgress);
        org.mockito.Mockito.when(db.getAllStages(org.mockito.Matchers.anyLong())).thenReturn(allStages);
        ...
        org.mockito.Mockito.when(db.getRequestTasks(org.mockito.Matchers.anyLong())).thenReturn(requestTasks);
        org.mockito.Mockito.doAnswer(new org.mockito.stubbing.Answer<java.lang.Void>() {
            @java.lang.Override
            public java.lang.Void answer(org.mockito.invocation.InvocationOnMock invocation) throws java.lang.Throwable {
                java.util.List<org.apache.ambari.server.agent.CommandReport> reports = ((java.util.List<org.apache.ambari.server.agent.CommandReport>) (invocation.getArguments()[0]));
        ...
        }).when(agentCommandsPublisher).sendAgentCommand(org.mockito.Matchers.anyLong(), org.mockito.Matchers.any(org.apache.ambari.server.agent.AgentCommand.class));
        java.util.Properties properties = new java.util.Properties();
        org.apache.ambari.server.configuration.Configuration conf = new org.apache.ambari.server.configuration.Configuration(properties);
        org.mockito.Mockito.when(hostRoleCommandDAO.findByRequestIdAndStatuses(requestId, org.apache.ambari.server.actionmanager.HostRoleStatus.NOT_COMPLETED_STATUSES)).thenReturn(hrcEntitiesInProgress);
    ...
    public void testExclusiveRequests() throws java.lang.Exception {
        ...
        org.apache.ambari.server.state.Host host1 = org.mockito.Mockito.mock(org.apache.ambari.server.state.Host.class);
        org.mockito.Mockito.when(fsm.getHost(org.mockito.Matchers.anyString())).thenReturn(host1);
        org.mockito.Mockito.when(host1.getState()).thenReturn(org.apache.ambari.server.state.HostState.HEALTHY);
        org.mockito.Mockito.when(host1.getHostName()).thenReturn(hostname);
        org.apache.ambari.server.state.Host host2 = org.mockito.Mockito.mock(org.apache.ambari.server.state.Host.class);
        org.mockito.Mockito.when(fsm.getHost(org.mockito.Matchers.anyString())).thenReturn(host2);
        org.mockito.Mockito.when(host2.getState()).thenReturn(org.apache.ambari.server.state.HostState.HEALTHY);
        org.mockito.Mockito.when(host2.getHostName()).thenReturn(hostname);
        org.apache.ambari.server.state.Host host3 = org.mockito.Mockito.mock(org.apache.ambari.server.state.Host.class);
        org.mockito.Mockito.when(fsm.getHost(org.mockito.Matchers.anyString())).thenReturn(host3);
        org.mockito.Mockito.when(host3.getState()).thenReturn(org.apache.ambari.server.state.HostState.HEALTHY);
        org.mockito.Mockito.when(host3.getHostName()).thenReturn(hostname);
        org.apache.ambari.server.actionmanager.ActionDBAccessor db = org.mockito.Mockito.mock(org.apache.ambari.server.actionmanager.ActionDBAccessor.class);
        org.apache.ambari.server.orm.dao.HostRoleCommandDAO hostRoleCommandDAOMock = org.mockito.Mockito.mock(org.apache.ambari.server.orm.dao.HostRoleCommandDAO.class);
        org.mockito.Mockito.doNothing().when(hostRoleCommandDAOMock).publishTaskCreateEvent(org.mockito.Matchers.anyListOf(org.apache.ambari.server.actionmanager.HostRoleCommand.class));
        org.mockito.Mockito.when(db.getCommandsInProgressCount()).thenReturn(stagesInProgress.size());
        org.mockito.Mockito.when(db.getFirstStageInProgressPerRequest()).thenReturn(firstStageInProgressByRequest);
        java.util.List<org.apache.ambari.server.actionmanager.HostRoleCommand> requestTasks = new java.util.ArrayList<>();
        for (org.apache.ambari.server.actionmanager.Stage stage : stagesInProgress) {
            requestTasks.addAll(stage.getOrderedHostRoleCommands());
        }
        org.mockito.Mockito.when(db.getRequestTasks(org.mockito.Matchers.anyLong())).thenReturn(requestTasks);
        org.mockito.Mockito.when(db.getAllStages(org.mockito.Matchers.anyLong())).thenReturn(stagesInProgress);
        org.mockito.Mockito.doAnswer(new org.mockito.stubbing.Answer<java.lang.Void>() {
            @java.lang.Override
            public java.lang.Void answer(org.mockito.invocation.InvocationOnMock invocation) throws java.lang.Throwable {
                java.util.List<org.apache.ambari.server.agent.CommandReport> reports = ((java.util.List<org.apache.ambari.server.agent.CommandReport>) (invocation.getArguments()[0]));
        ...
        }).when(db).startRequest(org.mockito.Matchers.anyLong());
        org.apache.ambari.server.orm.entities.RequestEntity request1 = org.mockito.Mockito.mock(org.apache.ambari.server.orm.entities.RequestEntity.class);
        org.mockito.Mockito.when(request1.isExclusive()).thenReturn(false);
        org.mockito.Mockito.when(request1.getClusterHostInfo()).thenReturn(org.apache.ambari.server.actionmanager.TestActionScheduler.CLUSTER_HOST_INFO);
        org.apache.ambari.server.orm.entities.RequestEntity request2 = org.mockito.Mockito.mock(org.apache.ambari.server.orm.entities.RequestEntity.class);
        org.mockito.Mockito.when(request2.isExclusive()).thenReturn(true);
        org.mockito.Mockito.when(request2.getClusterHostInfo()).thenReturn(org.apache.ambari.server.actionmanager.TestActionScheduler.CLUSTER_HOST_INFO);
        org.apache.ambari.server.orm.entities.RequestEntity request3 = org.mockito.Mockito.mock(org.apache.ambari.server.orm.entities.RequestEntity.class);
        org.mockito.Mockito.when(request3.isExclusive()).thenReturn(false);
        org.mockito.Mockito.when(request3.getClusterHostInfo()).thenReturn(org.apache.ambari.server.actionmanager.TestActionScheduler.CLUSTER_HOST_INFO);
        org.mockito.Mockito.when(db.getRequestEntity(requestId1)).thenReturn(request1);
        org.mockito.Mockito.when(db.getRequestEntity(requestId2)).thenReturn(request2);
        org.mockito.Mockito.when(db.getRequestEntity(requestId3)).thenReturn(request3);
        java.util.Properties properties = new java.util.Properties();
        org.apache.ambari.server.configuration.Configuration conf = new org.apache.ambari.server.configuration.Configuration(properties);
        org.apache.ambari.server.actionmanager.ActionScheduler scheduler = org.mockito.Mockito.spy(new org.apache.ambari.server.actionmanager.ActionScheduler(100, 50, db, fsm, 3, new org.apache.ambari.server.controller.HostsMap(((java.lang.String) (null))), unitOfWork, null, conf, entityManagerProviderMock, hostRoleCommandDAOMock, ((org.apache.ambari.server.actionmanager.HostRoleCommandFactory) (null)), agentCommandsPublisher));
        org.mockito.Mockito.doReturn(false).when(scheduler).wasAgentRestartedDuringOperation(org.mockito.Matchers.any(org.apache.ambari.server.state.Host.class), org.mockito.Matchers.any(org.apache.ambari.server.actionmanager.Stage.class), org.mockito.Matchers.anyString());
    ...
    public void testSkippableCommandFailureDoesNotAbortRequest() throws java.lang.Exception {
        ...
        org.mockito.Mockito.when(fsm.getCluster(org.mockito.Matchers.anyString())).thenReturn(oneClusterMock);
        org.mockito.Mockito.when(fsm.getHost(org.mockito.Matchers.anyString())).thenReturn(host);
        org.mockito.Mockito.when(host.getHostId()).thenReturn(1L);
        org.mockito.Mockito.when(host.getState()).thenReturn(org.apache.ambari.server.state.HostState.HEALTHY);
        org.mockito.Mockito.when(oneClusterMock.getService(org.mockito.Matchers.anyString())).thenReturn(serviceObj);
        org.mockito.Mockito.when(serviceObj.getServiceComponent(org.mockito.Matchers.anyString())).thenReturn(scomp);
        org.mockito.Mockito.when(scomp.getServiceComponentHost(org.mockito.Matchers.anyString())).thenReturn(sch);
        ...
        org.mockito.Mockito.when(request.isExclusive()).thenReturn(false);
        org.mockito.Mockito.when(db.getRequestEntity(org.mockito.Matchers.anyLong())).thenReturn(request);
        org.mockito.Mockito.when(db.getCommandsInProgressCount()).thenReturn(firstStageInProgress.size());
        org.mockito.Mockito.when(db.getFirstStageInProgressPerRequest()).thenReturn(firstStageInProgress);
        org.mockito.Mockito.doAnswer(new org.mockito.stubbing.Answer<java.lang.Void>() {
            @java.lang.Override
            public java.lang.Void answer(org.mockito.invocation.InvocationOnMock invocation) throws java.lang.Throwable {
    ...
    public void testSkippableCommandFailureDoesNotAbortNextStage() throws java.lang.Exception {
        org.apache.ambari.server.actionmanager.Stage previousStage = org.easymock.EasyMock.createMock(org.apache.ambari.server.actionmanager.Stage.class);
        org.apache.ambari.server.actionmanager.Stage nextStage = org.easymock.EasyMock.createMock(org.apache.ambari.server.actionmanager.Stage.class);
        org.apache.ambari.server.actionmanager.ActionDBAccessor actionDBAccessor = org.easymock.EasyMock.createMock(org.apache.ambari.server.actionmanager.ActionDBAccessor.class);
        org.easymock.EasyMock.expect(previousStage.isSkippable()).andReturn(false);
        org.easymock.EasyMock.expect(nextStage.getStageId()).andReturn(5L);
        org.easymock.EasyMock.expect(nextStage.getRequestId()).andReturn(1L);
        org.easymock.EasyMock.expect(actionDBAccessor.getStage("1-4")).andReturn(previousStage);
        ...
        org.apache.ambari.server.actionmanager.HostRoleCommand hostRoleCommand = org.easymock.EasyMock.createMock(org.apache.ambari.server.actionmanager.HostRoleCommand.class);
        org.easymock.EasyMock.expect(hostRoleCommand.getRole()).andReturn(org.apache.ambari.server.Role.DATANODE).anyTimes();
        org.easymock.EasyMock.expect(hostRoleCommand.getStatus()).andReturn(org.apache.ambari.server.actionmanager.HostRoleStatus.SKIPPED_FAILED);
        ...
        org.easymock.EasyMock.expect(previousStage.getHostRoleCommands()).andReturn(hostRoleCommands).anyTimes();
        org.easymock.EasyMock.expect(previousStage.getSuccessFactor(org.apache.ambari.server.Role.DATANODE)).andReturn(0.5F);
        ...
        org.easymock.EasyMock.replay(previousStage, nextStage, actionDBAccessor, hostRoleCommand);
    ...
    public void testPreviousStageToFailForFirstStage() throws java.lang.Exception {
        org.apache.ambari.server.actionmanager.Stage nextStage = org.easymock.EasyMock.createNiceMock(org.apache.ambari.server.actionmanager.Stage.class);
        org.easymock.EasyMock.expect(nextStage.getStageId()).andReturn(0L);
        ...
        org.easymock.EasyMock.replay(nextStage);
        java.lang.reflect.Method method = scheduler.getClass().getDeclaredMethod("hasPreviousStageFailed", org.apache.ambari.server.actionmanager.Stage.class);
        method.setAccessible(true);
        java.lang.Object result = method.invoke(scheduler, nextStage);
        org.junit.Assert.assertFalse(((java.lang.Boolean) (result)));
    ...
    public void testPreviousStageToFailForSecondStage() throws java.lang.Exception {
        ...
        org.apache.ambari.server.actionmanager.ActionDBAccessor actionDBAccessor = org.easymock.EasyMock.createMock(org.apache.ambari.server.actionmanager.ActionDBAccessor.class);
        org.easymock.EasyMock.expect(previousStage.isSkippable()).andReturn(false);
        org.easymock.EasyMock.expect(nextStage.getStageId()).andReturn(1L);
        org.easymock.EasyMock.expect(nextStage.getRequestId()).andReturn(1L);
        org.easymock.EasyMock.expect(actionDBAccessor.getStage("1-0")).andReturn(previousStage);
        java.util.Map<java.lang.String, org.apache.ambari.server.actionmanager.HostRoleCommand> roleCommandMap = new java.util.HashMap<>();
        org.apache.ambari.server.actionmanager.HostRoleCommand hostRoleCommand = org.easymock.EasyMock.createMock(org.apache.ambari.server.actionmanager.HostRoleCommand.class);
        org.easymock.EasyMock.expect(hostRoleCommand.getRole()).andReturn(org.apache.ambari.server.Role.DATANODE).anyTimes();
        org.easymock.EasyMock.expect(hostRoleCommand.getStatus()).andReturn(org.apache.ambari.server.actionmanager.HostRoleStatus.FAILED);
        roleCommandMap.put(org.apache.ambari.server.Role.DATANODE.toString(), hostRoleCommand);
        java.util.Map<java.lang.String, java.util.Map<java.lang.String, org.apache.ambari.server.actionmanager.HostRoleCommand>> hostRoleCommands = new java.util.HashMap<>();
        hostRoleCommands.put("host", roleCommandMap);
        org.easymock.EasyMock.expect(previousStage.getHostRoleCommands()).andReturn(hostRoleCommands).anyTimes();
    ...
    public static class MockModule extends com.google.inject.AbstractModule {
        ...
        protected void configure() {
            bind(org.apache.ambari.server.state.Clusters.class).toInstance(org.mockito.Mockito.mock(org.apache.ambari.server.state.Clusters.class));
        }
    }
}
