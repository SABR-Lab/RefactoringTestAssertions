...
public class TestHeartbeatHandler {
    ...
    public void testHeartbeat() throws java.lang.Exception {
        ...
        org.easymock.EasyMock.expect(am.getTasks(org.easymock.EasyMock.<java.util.List<java.lang.Long>>anyObject())).andReturn(new java.util.ArrayList<>());
        org.easymock.EasyMock.replay(am);
    ...
    public void testStatusHeartbeatWithAnnotation() throws java.lang.Exception {
        ...
        org.apache.ambari.server.actionmanager.ActionManager am = actionManagerTestHelper.getMockActionManager();
        org.easymock.EasyMock.expect(am.getTasks(org.easymock.EasyMock.<java.util.List<java.lang.Long>>anyObject())).andReturn(new java.util.ArrayList<org.apache.ambari.server.actionmanager.HostRoleCommand>() {
            {
                add(command);
            }
        }).anyTimes();
    ...
    public void testStateCommandsAtRegistration() throws java.lang.Exception, org.apache.ambari.server.state.fsm.InvalidStateTransitionException {
        ...
        org.apache.ambari.server.agent.HeartbeatMonitor hm = org.mockito.Mockito.mock(org.apache.ambari.server.agent.HeartbeatMonitor.class);
        org.mockito.Mockito.when(hm.generateStatusCommands(org.mockito.Matchers.anyString())).thenReturn(dummyCmds);
        org.apache.ambari.server.actionmanager.ActionManager am = actionManagerTestHelper.getMockActionManager();
        org.easymock.EasyMock.replay(am);
        org.apache.ambari.server.agent.HeartBeatHandler handler = createHeartBeatHandler();
    ...
    public void testProcessStatusReports() throws java.lang.Exception {
        ...
        heartbeatProcessor.processHeartbeat(hb1);
        org.junit.Assert.assertEquals(org.apache.ambari.server.state.HostHealthStatus.HealthStatus.HEALTHY.name(), hostObject.getStatus());
        org.easymock.EasyMock.reset(am);
        org.easymock.EasyMock.expect(am.getTasks(org.easymock.EasyMock.<java.util.List<java.lang.Long>>anyObject())).andReturn(new java.util.ArrayList<org.apache.ambari.server.actionmanager.HostRoleCommand>() {
            {
                add(command);
            }
    ...
    public void testComponents() throws java.lang.Exception {
        ...
        org.easymock.EasyMock.expect(service.getName()).andReturn("HDFS").atLeastOnce();
        ...
        org.easymock.EasyMock.expect(nnComponent.getName()).andReturn("NAMENODE").atLeastOnce();
        org.easymock.EasyMock.expect(nnComponent.getDesiredStackId()).andReturn(dummyStackId).atLeastOnce();
        componentMap.put("NAMENODE", nnComponent);
        org.easymock.EasyMock.expect(service.getServiceComponents()).andReturn(componentMap).atLeastOnce();
        org.apache.ambari.server.actionmanager.ActionManager am = actionManagerTestHelper.getMockActionManager();
        org.easymock.EasyMock.replay(service, nnComponent, am);
    ...
    private java.io.File createTestKeytabData(org.apache.ambari.server.events.publishers.AgentCommandsPublisher agentCommandsPublisher, boolean removeKeytabs) throws java.lang.Exception {
        org.apache.ambari.server.serveraction.kerberos.stageutils.KerberosKeytabController kerberosKeytabControllerMock = org.easymock.EasyMock.createMock(org.apache.ambari.server.serveraction.kerberos.stageutils.KerberosKeytabController.class);
        ...
        if (removeKeytabs) {
            ...
            org.apache.ambari.server.serveraction.kerberos.stageutils.ResolvedKerberosPrincipal resolvedKerberosPrincipal = org.easymock.EasyMock.createMock(org.apache.ambari.server.serveraction.kerberos.stageutils.ResolvedKerberosPrincipal.class);
            org.easymock.EasyMock.expect(resolvedKerberosPrincipal.getHostName()).andReturn("c6403.ambari.apache.org");
            org.easymock.EasyMock.expect(resolvedKerberosPrincipal.getPrincipal()).andReturn("dn/_HOST@_REALM");
            org.easymock.EasyMock.expect(resolvedKerberosPrincipal.getServiceMapping()).andReturn(serviceMapping);
            org.easymock.EasyMock.replay(resolvedKerberosPrincipal);
            org.apache.ambari.server.serveraction.kerberos.stageutils.ResolvedKerberosKeytab resolvedKerberosKeytab = org.easymock.EasyMock.createMock(org.apache.ambari.server.serveraction.kerberos.stageutils.ResolvedKerberosKeytab.class);
            org.easymock.EasyMock.expect(resolvedKerberosKeytab.getPrincipals()).andReturn(java.util.Collections.singleton(resolvedKerberosPrincipal));
            org.easymock.EasyMock.replay(resolvedKerberosKeytab);
            org.easymock.EasyMock.expect(kerberosKeytabControllerMock.getKeytabByFile("/etc/security/keytabs/dn.service.keytab")).andReturn(resolvedKerberosKeytab).once();
        } else {
            filter = java.util.Collections.singletonMap("HDFS", java.util.Collections.singletonList("*"));
        }
        org.easymock.EasyMock.expect(kerberosKeytabControllerMock.adjustServiceComponentFilter(org.easymock.EasyMock.anyObject(), org.easymock.EasyMock.eq(false), org.easymock.EasyMock.anyObject())).andReturn(filter).once();
        org.easymock.EasyMock.expect(kerberosKeytabControllerMock.getFilteredKeytabs(((java.util.Collection<org.apache.ambari.server.state.kerberos.KerberosIdentityDescriptor>) (org.easymock.EasyMock.anyObject())), org.easymock.EasyMock.eq(null), org.easymock.EasyMock.eq(null))).andReturn(com.google.common.collect.Sets.newHashSet(new org.apache.ambari.server.serveraction.kerberos.stageutils.ResolvedKerberosKeytab("/etc/security/keytabs/dn.service.keytab", "hdfs", "r", "hadoop", "", com.google.common.collect.Sets.newHashSet(new org.apache.ambari.server.serveraction.kerberos.stageutils.ResolvedKerberosPrincipal(1L, "c6403.ambari.apache.org", "dn/_HOST@_REALM", false, "/tmp", "HDFS", "DATANODE", "/etc/security/keytabs/dn.service.keytab")), false, false))).once();
        org.easymock.EasyMock.expect(kerberosKeytabControllerMock.getServiceIdentities(org.easymock.EasyMock.anyString(), org.easymock.EasyMock.anyObject(), org.easymock.EasyMock.anyObject())).andReturn(java.util.Collections.emptySet()).anyTimes();
        org.easymock.EasyMock.replay(kerberosKeytabControllerMock);
