...
public class AgentHeartbeatAlertRunnableTest {
    ...
    public void setup() throws java.lang.Exception {
        ...
        org.easymock.EasyMock.expect(m_definition.getDefinitionName()).andReturn(org.apache.ambari.server.alerts.AgentHeartbeatAlertRunnableTest.DEFINITION_NAME).atLeastOnce();
        org.easymock.EasyMock.expect(m_definition.getServiceName()).andReturn(org.apache.ambari.server.alerts.AgentHeartbeatAlertRunnableTest.DEFINITION_SERVICE).atLeastOnce();
        org.easymock.EasyMock.expect(m_definition.getComponentName()).andReturn(org.apache.ambari.server.alerts.AgentHeartbeatAlertRunnableTest.DEFINITION_COMPONENT).atLeastOnce();
        org.easymock.EasyMock.expect(m_definition.getLabel()).andReturn(org.apache.ambari.server.alerts.AgentHeartbeatAlertRunnableTest.DEFINITION_LABEL).atLeastOnce();
        ...
        org.easymock.EasyMock.expect(m_cluster.getClusterId()).andReturn(org.apache.ambari.server.alerts.AgentHeartbeatAlertRunnableTest.CLUSTER_ID).atLeastOnce();
        org.easymock.EasyMock.expect(m_cluster.getHosts()).andReturn(java.util.Collections.singleton(m_host)).atLeastOnce();
        org.easymock.EasyMock.expect(m_clusters.getClusters()).andReturn(clusterMap).atLeastOnce();
        org.easymock.EasyMock.expect(m_definitionDao.findByName(org.apache.ambari.server.alerts.AgentHeartbeatAlertRunnableTest.CLUSTER_ID, org.apache.ambari.server.alerts.AgentHeartbeatAlertRunnableTest.DEFINITION_NAME)).andReturn(m_definition).atLeastOnce();
    ...
    public void testHealthyHostAlert() {
        ...
        org.easymock.EasyMock.verify(m_definition, m_host, m_cluster, m_clusters, m_definitionDao);
    }

    @org.junit.Test
    public void testLostHeartbeatAlert() {
        org.easymock.EasyMock.reset(m_host);
        org.easymock.EasyMock.expect(m_host.getState()).andReturn(org.apache.ambari.server.state.HostState.HEARTBEAT_LOST).atLeastOnce();
        org.easymock.EasyMock.replay(m_host);
        junit.framework.Assert.assertEquals(0, m_listener.getAlertEventReceivedCount(org.apache.ambari.server.events.AlertReceivedEvent.class));
        org.apache.ambari.server.alerts.AgentHeartbeatAlertRunnable runnable = new org.apache.ambari.server.alerts.AgentHeartbeatAlertRunnable(m_definition.getDefinitionName());
        m_injector.injectMembers(runnable);
        runnable.run();
    ...
    public void testUnhealthyHostAlert() {
        org.easymock.EasyMock.reset(m_host);
        org.easymock.EasyMock.expect(m_host.getState()).andReturn(org.apache.ambari.server.state.HostState.UNHEALTHY).atLeastOnce();
        org.easymock.EasyMock.replay(m_host);
        junit.framework.Assert.assertEquals(0, m_listener.getAlertEventReceivedCount(org.apache.ambari.server.events.AlertReceivedEvent.class));
        org.apache.ambari.server.alerts.AgentHeartbeatAlertRunnable runnable = new org.apache.ambari.server.alerts.AgentHeartbeatAlertRunnable(m_definition.getDefinitionName());
        m_injector.injectMembers(runnable);
