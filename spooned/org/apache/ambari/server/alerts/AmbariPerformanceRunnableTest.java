...
public class AmbariPerformanceRunnableTest {
    ...
    public void setup() throws java.lang.Exception {
        ...
        org.easymock.EasyMock.expect(m_definition.getDefinitionName()).andReturn(org.apache.ambari.server.alerts.AmbariPerformanceRunnableTest.DEFINITION_NAME).atLeastOnce();
        org.easymock.EasyMock.expect(m_definition.getServiceName()).andReturn(org.apache.ambari.server.alerts.AmbariPerformanceRunnableTest.DEFINITION_SERVICE).atLeastOnce();
        org.easymock.EasyMock.expect(m_definition.getComponentName()).andReturn(org.apache.ambari.server.alerts.AmbariPerformanceRunnableTest.DEFINITION_COMPONENT).atLeastOnce();
        org.easymock.EasyMock.expect(m_definition.getLabel()).andReturn(org.apache.ambari.server.alerts.AmbariPerformanceRunnableTest.DEFINITION_LABEL).atLeastOnce();
        org.easymock.EasyMock.expect(m_definition.getEnabled()).andReturn(true).atLeastOnce();
        org.easymock.EasyMock.expect(m_definition.getScheduleInterval()).andReturn(org.apache.ambari.server.alerts.AmbariPerformanceRunnableTest.DEFINITION_INTERVAL).atLeastOnce();
        org.easymock.EasyMock.expect(m_cluster.getClusterId()).andReturn(org.apache.ambari.server.alerts.AmbariPerformanceRunnableTest.CLUSTER_ID).atLeastOnce();
        org.easymock.EasyMock.expect(m_clusters.getClusters()).andReturn(clusterMap).atLeastOnce();
        org.easymock.EasyMock.expect(m_definitionDao.findByName(org.apache.ambari.server.alerts.AmbariPerformanceRunnableTest.CLUSTER_ID, org.apache.ambari.server.alerts.AmbariPerformanceRunnableTest.DEFINITION_NAME)).andReturn(m_definition).atLeastOnce();
        org.easymock.EasyMock.expect(m_alertsDao.findCurrentByCluster(org.apache.ambari.server.alerts.AmbariPerformanceRunnableTest.CLUSTER_ID)).andReturn(m_currentAlerts).atLeastOnce();
        ...
        org.easymock.EasyMock.expect(factory.coerce(org.easymock.EasyMock.anyObject(org.apache.ambari.server.orm.entities.AlertDefinitionEntity.class))).andReturn(definition).atLeastOnce();
        ...
        org.easymock.EasyMock.expect(org.apache.ambari.server.controller.utilities.ClusterControllerHelper.getClusterController()).andReturn(clusterController);
        org.powermock.api.easymock.PowerMock.replay(org.apache.ambari.server.controller.utilities.ClusterControllerHelper.class);
        org.easymock.EasyMock.replay(m_definition, m_cluster, m_clusters, m_definitionDao, m_alertsDao, factory, clusterController);
    }
    ...
    public void testAlertFiresOKEvent() {
        ...
        org.easymock.EasyMock.verify(m_cluster, m_clusters, m_definitionDao);
    }
    ...
    public void testAlertFiresUnknownEvent() {
        ...
        org.easymock.EasyMock.expect(requestDAO.findAllRequestIds(org.easymock.EasyMock.anyInt(), org.easymock.EasyMock.anyBoolean())).andReturn(new java.util.ArrayList<>());
    ...
    private class MockModule implements com.google.inject.Module {
        ...
        public void configure(com.google.inject.Binder binder) {
            ...
            binder.bind(org.apache.ambari.server.actionmanager.ActionManager.class).toInstance(org.easymock.EasyMock.createNiceMock(org.apache.ambari.server.actionmanager.ActionManager.class));
            ...
            binder.bind(org.apache.ambari.server.state.alert.AlertDefinitionFactory.class).toInstance(org.easymock.EasyMock.createNiceMock(org.apache.ambari.server.state.alert.AlertDefinitionFactory.class));
            binder.bind(org.apache.ambari.server.controller.internal.ClusterResourceProvider.class).toInstance(org.easymock.EasyMock.createNiceMock(org.apache.ambari.server.controller.internal.ClusterResourceProvider.class));
            binder.bind(org.apache.ambari.server.controller.spi.ClusterController.class).toInstance(org.easymock.EasyMock.createNiceMock(org.apache.ambari.server.controller.spi.ClusterController.class));
            binder.bind(org.apache.ambari.server.orm.dao.RequestDAO.class).toInstance(org.easymock.EasyMock.createNiceMock(org.apache.ambari.server.orm.dao.RequestDAO.class));
        }
    }
}
