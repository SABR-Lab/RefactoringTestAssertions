...
public class ComponentVersionAlertRunnableTest extends org.easymock.EasyMockSupport {
    ...
    public void setup() throws java.lang.Exception {
        ...
        org.easymock.EasyMock.expect(host1.getHostName()).andReturn(org.apache.ambari.server.alerts.ComponentVersionAlertRunnableTest.HOSTNAME_1).atLeastOnce();
        org.easymock.EasyMock.expect(host2.getHostName()).andReturn(org.apache.ambari.server.alerts.ComponentVersionAlertRunnableTest.HOSTNAME_2).atLeastOnce();
        m_hosts.add(host1);
        m_hosts.add(host2);
        ...
        org.easymock.EasyMock.expect(m_desidredStackId.getStackName()).andReturn("SOME-STACK").atLeastOnce();
        org.easymock.EasyMock.expect(m_desidredStackId.getStackVersion()).andReturn("STACK-VERSION").atLeastOnce();
        ...
        org.easymock.EasyMock.expect(repositoryVersionEntity.getVersion()).andReturn(org.apache.ambari.server.alerts.ComponentVersionAlertRunnableTest.EXPECTED_VERSION).anyTimes();
        org.apache.ambari.server.state.Service service = createNiceMock(org.apache.ambari.server.state.Service.class);
        org.easymock.EasyMock.expect(service.getDesiredRepositoryVersion()).andReturn(repositoryVersionEntity).atLeastOnce();
        ...
        org.easymock.EasyMock.expect(serviceComponent.getDesiredStackId()).andReturn(m_desidredStackId).atLeastOnce();
        org.easymock.EasyMock.expect(service.getServiceComponent(org.easymock.EasyMock.anyString())).andReturn(serviceComponent).atLeastOnce();
        ...
        org.easymock.EasyMock.expect(sch1_1.getServiceName()).andReturn("FOO").atLeastOnce();
        org.easymock.EasyMock.expect(sch1_1.getServiceComponentName()).andReturn("FOO_COMPONENT").atLeastOnce();
        org.easymock.EasyMock.expect(sch1_1.getVersion()).andReturn(org.apache.ambari.server.alerts.ComponentVersionAlertRunnableTest.EXPECTED_VERSION).atLeastOnce();
        org.easymock.EasyMock.expect(sch1_2.getServiceName()).andReturn("BAR").atLeastOnce();
        org.easymock.EasyMock.expect(sch1_2.getServiceComponentName()).andReturn("BAR_COMPONENT").atLeastOnce();
        org.easymock.EasyMock.expect(sch1_2.getVersion()).andReturn(org.apache.ambari.server.alerts.ComponentVersionAlertRunnableTest.EXPECTED_VERSION).atLeastOnce();
        org.easymock.EasyMock.expect(sch2_1.getServiceName()).andReturn("FOO").atLeastOnce();
        org.easymock.EasyMock.expect(sch2_1.getServiceComponentName()).andReturn("FOO_COMPONENT").atLeastOnce();
        org.easymock.EasyMock.expect(sch2_1.getVersion()).andReturn(org.apache.ambari.server.alerts.ComponentVersionAlertRunnableTest.EXPECTED_VERSION).atLeastOnce();
        org.easymock.EasyMock.expect(sch2_2.getServiceName()).andReturn("BAZ").atLeastOnce();
        org.easymock.EasyMock.expect(sch2_2.getServiceComponentName()).andReturn("BAZ_COMPONENT").atLeastOnce();
        org.easymock.EasyMock.expect(sch2_2.getVersion()).andReturn(org.apache.ambari.server.alerts.ComponentVersionAlertRunnableTest.EXPECTED_VERSION).atLeastOnce();
        ...
        org.easymock.EasyMock.expect(m_definition.getDefinitionName()).andReturn(org.apache.ambari.server.alerts.ComponentVersionAlertRunnableTest.DEFINITION_NAME).atLeastOnce();
        org.easymock.EasyMock.expect(m_definition.getServiceName()).andReturn(org.apache.ambari.server.alerts.ComponentVersionAlertRunnableTest.DEFINITION_SERVICE).atLeastOnce();
        org.easymock.EasyMock.expect(m_definition.getComponentName()).andReturn(org.apache.ambari.server.alerts.ComponentVersionAlertRunnableTest.DEFINITION_COMPONENT).atLeastOnce();
        org.easymock.EasyMock.expect(m_definition.getLabel()).andReturn(org.apache.ambari.server.alerts.ComponentVersionAlertRunnableTest.DEFINITION_LABEL).atLeastOnce();
        org.easymock.EasyMock.expect(m_definition.getEnabled()).andReturn(true).atLeastOnce();
        org.easymock.EasyMock.expect(m_cluster.getClusterId()).andReturn(org.apache.ambari.server.alerts.ComponentVersionAlertRunnableTest.CLUSTER_ID).atLeastOnce();
        org.easymock.EasyMock.expect(m_cluster.getHosts()).andReturn(m_hosts).atLeastOnce();
        org.easymock.EasyMock.expect(m_cluster.getService(org.easymock.EasyMock.anyString())).andReturn(service).atLeastOnce();
        org.easymock.EasyMock.expect(m_clusters.getClusters()).andReturn(clusterMap).atLeastOnce();
        org.easymock.EasyMock.expect(m_definitionDao.findByName(org.apache.ambari.server.alerts.ComponentVersionAlertRunnableTest.CLUSTER_ID, org.apache.ambari.server.alerts.ComponentVersionAlertRunnableTest.DEFINITION_NAME)).andReturn(m_definition).atLeastOnce();
        m_metaInfo.init();
        org.easymock.EasyMock.expectLastCall().anyTimes();
        org.easymock.EasyMock.expect(m_cluster.getServiceComponentHosts(org.apache.ambari.server.alerts.ComponentVersionAlertRunnableTest.HOSTNAME_1)).andReturn(m_hostComponentMap.get(org.apache.ambari.server.alerts.ComponentVersionAlertRunnableTest.HOSTNAME_1)).once();
        org.easymock.EasyMock.expect(m_cluster.getServiceComponentHosts(org.apache.ambari.server.alerts.ComponentVersionAlertRunnableTest.HOSTNAME_2)).andReturn(m_hostComponentMap.get(org.apache.ambari.server.alerts.ComponentVersionAlertRunnableTest.HOSTNAME_2)).once();
        ...
        org.easymock.EasyMock.expect(componentInfo.isVersionAdvertised()).andReturn(true).atLeastOnce();
        org.easymock.EasyMock.expect(m_metaInfo.getComponent(org.easymock.EasyMock.anyString(), org.easymock.EasyMock.anyString(), org.easymock.EasyMock.anyString(), org.easymock.EasyMock.anyString())).andReturn(componentInfo).atLeastOnce();
    }
    ...
    public void testUpgradeInProgress() throws java.lang.Exception {
        ...
        org.easymock.EasyMock.expect(upgrade.getDirection()).andReturn(org.apache.ambari.server.stack.upgrade.Direction.UPGRADE).atLeastOnce();
        org.easymock.EasyMock.expect(m_cluster.getUpgradeInProgress()).andReturn(upgrade).once();
        replayAll();
        m_metaInfo.init();
    ...
    public void testomponentVersionMismatch() throws java.lang.Exception {
        ...
        org.easymock.EasyMock.expect(sch.getServiceName()).andReturn("FOO").atLeastOnce();
        org.easymock.EasyMock.expect(sch.getServiceComponentName()).andReturn("FOO_COMPONENT").atLeastOnce();
        org.easymock.EasyMock.expect(sch.getVersion()).andReturn(org.apache.ambari.server.alerts.ComponentVersionAlertRunnableTest.WRONG_VERSION).atLeastOnce();
        replayAll();
        m_metaInfo.init();
        junit.framework.Assert.assertEquals(0, m_listener.getAlertEventReceivedCount(org.apache.ambari.server.events.AlertReceivedEvent.class));
        org.apache.ambari.server.alerts.ComponentVersionAlertRunnable runnable = new org.apache.ambari.server.alerts.ComponentVersionAlertRunnable(m_definition.getDefinitionName());
