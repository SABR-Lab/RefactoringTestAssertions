...
public class StaleAlertRunnableTest {
    ...
    public void setup() throws java.lang.Exception {
        ...
        org.easymock.EasyMock.expect(m_definition.getDefinitionId()).andReturn(1L).atLeastOnce();
        org.easymock.EasyMock.expect(m_definition.getDefinitionName()).andReturn(org.apache.ambari.server.alerts.StaleAlertRunnableTest.DEFINITION_NAME).atLeastOnce();
        org.easymock.EasyMock.expect(m_definition.getServiceName()).andReturn(org.apache.ambari.server.alerts.StaleAlertRunnableTest.DEFINITION_SERVICE).atLeastOnce();
        org.easymock.EasyMock.expect(m_definition.getComponentName()).andReturn(org.apache.ambari.server.alerts.StaleAlertRunnableTest.DEFINITION_COMPONENT).atLeastOnce();
        org.easymock.EasyMock.expect(m_definition.getLabel()).andReturn(org.apache.ambari.server.alerts.StaleAlertRunnableTest.DEFINITION_LABEL).atLeastOnce();
        org.easymock.EasyMock.expect(m_definition.getEnabled()).andReturn(true).atLeastOnce();
        org.easymock.EasyMock.expect(m_definition.getScheduleInterval()).andReturn(org.apache.ambari.server.alerts.StaleAlertRunnableTest.DEFINITION_INTERVAL).atLeastOnce();
        org.easymock.EasyMock.expect(m_definition.getClusterId()).andReturn(org.apache.ambari.server.alerts.StaleAlertRunnableTest.CLUSTER_ID).atLeastOnce();
        org.easymock.EasyMock.expect(m_definition.getSource()).andReturn("{\"type\" : \"SERVER\"}").anyTimes();
        org.easymock.EasyMock.expect(m_cluster.getClusterId()).andReturn(org.apache.ambari.server.alerts.StaleAlertRunnableTest.CLUSTER_ID).atLeastOnce();
        org.easymock.EasyMock.expect(m_clusters.getClusters()).andReturn(clusterMap).atLeastOnce();
        org.easymock.EasyMock.expect(m_definitionDao.findByName(org.apache.ambari.server.alerts.StaleAlertRunnableTest.CLUSTER_ID, org.apache.ambari.server.alerts.StaleAlertRunnableTest.DEFINITION_NAME)).andReturn(m_definition).atLeastOnce();
        org.easymock.EasyMock.expect(m_alertsDao.findCurrentByCluster(org.apache.ambari.server.alerts.StaleAlertRunnableTest.CLUSTER_ID)).andReturn(m_currentAlerts).atLeastOnce();
        m_host = org.easymock.EasyMock.createNiceMock(org.apache.ambari.server.state.Host.class);
        org.easymock.EasyMock.expect(m_host.getHostId()).andReturn(1L);
        org.easymock.EasyMock.expect(m_host.getState()).andReturn(org.apache.ambari.server.state.HostState.HEALTHY);
        org.easymock.EasyMock.expect(m_cluster.getHost(org.easymock.EasyMock.anyString())).andReturn(m_host).anyTimes();
        ...
        org.easymock.EasyMock.expect(java.lang.management.ManagementFactory.getRuntimeMXBean()).andReturn(m_runtimeMXBean).atLeastOnce();
        org.powermock.api.easymock.PowerMock.replay(java.lang.management.ManagementFactory.class);
        org.easymock.EasyMock.expect(m_runtimeMXBean.getUptime()).andReturn(360000L);
        org.easymock.EasyMock.expect(m_alertHelper.getHostIdsByDefinitionId(org.easymock.EasyMock.anyLong())).andReturn(java.util.Collections.emptyList()).anyTimes();
        org.easymock.EasyMock.expect(m_alertHelper.getWaitFactorMultiplier(org.easymock.EasyMock.anyObject(org.apache.ambari.server.state.alert.AlertDefinition.class))).andReturn(2).anyTimes();
        org.easymock.EasyMock.expect(m_alertHelper.getStaleAlerts(org.easymock.EasyMock.anyLong())).andReturn(java.util.Collections.EMPTY_MAP).anyTimes();
        org.easymock.EasyMock.replay(m_host, m_definition, m_cluster, m_clusters, m_definitionDao, m_alertsDao, m_runtimeMXBean, m_alertHelper);
    }
    ...
    public void testAllAlertsAreCurrent() {
        ...
        org.apache.ambari.server.orm.entities.AlertCurrentEntity current1 = org.easymock.EasyMock.createNiceMock(org.apache.ambari.server.orm.entities.AlertCurrentEntity.class);
        org.apache.ambari.server.orm.entities.AlertHistoryEntity history1 = org.easymock.EasyMock.createNiceMock(org.apache.ambari.server.orm.entities.AlertHistoryEntity.class);
        org.easymock.EasyMock.expect(current1.getAlertHistory()).andReturn(history1).atLeastOnce();
        org.easymock.EasyMock.expect(current1.getDefinitionId()).andReturn(1L).atLeastOnce();
        org.easymock.EasyMock.expect(history1.getAlertDefinition()).andReturn(definition).atLeastOnce();
        org.easymock.EasyMock.expect(current1.getMaintenanceState()).andReturn(org.apache.ambari.server.state.MaintenanceState.OFF).atLeastOnce();
        org.easymock.EasyMock.expect(current1.getLatestTimestamp()).andReturn(java.lang.System.currentTimeMillis()).atLeastOnce();
        org.easymock.EasyMock.replay(current1, history1);
        ...
        org.easymock.EasyMock.verify(m_cluster, m_clusters, m_definitionDao, m_alertHelper);
    }
    ...
    public void testAmbariStaleAlert() {
        ...
        org.easymock.EasyMock.expect(history1.getAlertDefinition()).andReturn(definition).atLeastOnce();
        org.easymock.EasyMock.expect(current1.getMaintenanceState()).andReturn(org.apache.ambari.server.state.MaintenanceState.OFF).atLeastOnce();
        org.easymock.EasyMock.expect(current1.getLatestTimestamp()).andReturn(1L).atLeastOnce();
        org.easymock.EasyMock.replay(current1, history1);
        m_currentAlerts.add(current1);
        junit.framework.Assert.assertEquals(0, m_listener.getAlertEventReceivedCount(org.apache.ambari.server.events.AlertReceivedEvent.class));
        org.apache.ambari.server.alerts.StaleAlertRunnable runnable = new org.apache.ambari.server.alerts.StaleAlertRunnable(m_definition.getDefinitionName());
    ...
    public void testStaleAlertFromAgent() {
        ...
        org.apache.ambari.server.orm.entities.AlertHistoryEntity history1 = org.easymock.EasyMock.createNiceMock(org.apache.ambari.server.orm.entities.AlertHistoryEntity.class);
        org.easymock.EasyMock.expect(current1.getAlertHistory()).andReturn(history1).atLeastOnce();
        org.easymock.EasyMock.expect(current1.getDefinitionId()).andReturn(alertDefinitionId).atLeastOnce();
        org.easymock.EasyMock.expect(history1.getAlertDefinition()).andReturn(definition).atLeastOnce();
        org.easymock.EasyMock.expect(history1.getHostName()).andReturn("host1").atLeastOnce();
        org.easymock.EasyMock.reset(m_alertHelper);
        org.easymock.EasyMock.expect(m_alertHelper.getWaitFactorMultiplier(org.easymock.EasyMock.anyObject(org.apache.ambari.server.state.alert.AlertDefinition.class))).andReturn(2).anyTimes();
        org.easymock.EasyMock.expect(m_alertHelper.getStaleAlerts(org.easymock.EasyMock.anyLong())).andReturn(java.util.Collections.singletonMap(alertDefinitionId, 0L)).atLeastOnce();
        org.easymock.EasyMock.expect(current1.getMaintenanceState()).andReturn(org.apache.ambari.server.state.MaintenanceState.OFF).atLeastOnce();
        org.easymock.EasyMock.expect(current1.getLatestTimestamp()).andReturn(java.lang.System.currentTimeMillis()).atLeastOnce();
        org.easymock.EasyMock.replay(current1, history1, m_alertHelper);
        m_currentAlerts.add(current1);
        junit.framework.Assert.assertEquals(0, m_listener.getAlertEventReceivedCount(org.apache.ambari.server.events.AlertReceivedEvent.class));
        org.apache.ambari.server.alerts.StaleAlertRunnable runnable = new org.apache.ambari.server.alerts.StaleAlertRunnable(m_definition.getDefinitionName());
        m_injector.injectMembers(runnable);
    ...
    public void testStaleAlertHeartbeatLost() {
        ...
        org.easymock.EasyMock.expect(current1.getMaintenanceState()).andReturn(org.apache.ambari.server.state.MaintenanceState.OFF).atLeastOnce();
        org.easymock.EasyMock.expect(current1.getLatestTimestamp()).andReturn(java.lang.System.currentTimeMillis()).atLeastOnce();
        org.easymock.EasyMock.reset(m_cluster, m_host);
        m_host = org.easymock.EasyMock.createNiceMock(org.apache.ambari.server.state.Host.class);
        org.easymock.EasyMock.expect(m_host.getHostId()).andReturn(1L);
        org.easymock.EasyMock.expect(m_host.getState()).andReturn(org.apache.ambari.server.state.HostState.HEARTBEAT_LOST);
        org.easymock.EasyMock.expect(m_cluster.getClusterId()).andReturn(org.apache.ambari.server.alerts.StaleAlertRunnableTest.CLUSTER_ID).atLeastOnce();
        org.easymock.EasyMock.expect(m_cluster.getHost(org.easymock.EasyMock.anyString())).andReturn(m_host).anyTimes();
        org.easymock.EasyMock.replay(current1, history1, m_host, m_cluster);
        m_currentAlerts.add(current1);
        junit.framework.Assert.assertEquals(0, m_listener.getAlertEventReceivedCount(org.apache.ambari.server.events.AlertReceivedEvent.class));
        org.apache.ambari.server.alerts.StaleAlertRunnable runnable = new org.apache.ambari.server.alerts.StaleAlertRunnable(m_definition.getDefinitionName());
        m_injector.injectMembers(runnable);
    ...
    public void testStaleAlertWithHostIgnore() {
        ...
        org.easymock.EasyMock.expect(current1.getMaintenanceState()).andReturn(org.apache.ambari.server.state.MaintenanceState.OFF).atLeastOnce();
        org.easymock.EasyMock.expect(current1.getLatestTimestamp()).andReturn(java.lang.System.currentTimeMillis()).atLeastOnce();
        org.easymock.EasyMock.reset(m_cluster);
        org.apache.ambari.server.state.Host host1 = org.easymock.EasyMock.createNiceMock(org.apache.ambari.server.state.Host.class);
        org.apache.ambari.server.state.Host host2 = org.easymock.EasyMock.createNiceMock(org.apache.ambari.server.state.Host.class);
        org.easymock.EasyMock.expect(host1.getHostId()).andReturn(1L);
        org.easymock.EasyMock.expect(host1.getState()).andReturn(org.apache.ambari.server.state.HostState.HEARTBEAT_LOST).atLeastOnce();
        org.easymock.EasyMock.expect(host1.getLastHeartbeatTime()).andReturn(1L);
        org.easymock.EasyMock.expect(host2.getHostId()).andReturn(2L);
        org.easymock.EasyMock.expect(host2.getState()).andReturn(org.apache.ambari.server.state.HostState.HEALTHY).atLeastOnce();
        org.easymock.EasyMock.expect(host2.getLastHeartbeatTime()).andReturn(2L);
        org.easymock.EasyMock.expect(m_cluster.getClusterId()).andReturn(org.apache.ambari.server.alerts.StaleAlertRunnableTest.CLUSTER_ID).atLeastOnce();
        org.easymock.EasyMock.expect(m_cluster.getHost(org.easymock.EasyMock.eq(1L))).andReturn(host1).anyTimes();
        org.easymock.EasyMock.expect(m_cluster.getHost(org.easymock.EasyMock.eq(2L))).andReturn(host2).anyTimes();
        org.easymock.EasyMock.replay(current1, history1, host1, host2, m_cluster);
        m_currentAlerts.add(current1);
        junit.framework.Assert.assertEquals(0, m_listener.getAlertEventReceivedCount(org.apache.ambari.server.events.AlertReceivedEvent.class));
        org.apache.ambari.server.alerts.StaleAlertRunnable runnable = new org.apache.ambari.server.alerts.StaleAlertRunnable(m_definition.getDefinitionName());
        m_injector.injectMembers(runnable);
    ...
    public void testStaleAlertWithHostIgnoreCritical() {
        ...
        org.easymock.EasyMock.expect(host1.getLastHeartbeatTime()).andReturn(1L);
        org.easymock.EasyMock.expect(host2.getHostId()).andReturn(2L);
        org.easymock.EasyMock.expect(host2.getState()).andReturn(org.apache.ambari.server.state.HostState.HEARTBEAT_LOST).atLeastOnce();
        org.easymock.EasyMock.expect(host2.getLastHeartbeatTime()).andReturn(2L);
        org.easymock.EasyMock.expect(m_cluster.getClusterId()).andReturn(org.apache.ambari.server.alerts.StaleAlertRunnableTest.CLUSTER_ID).atLeastOnce();
        org.easymock.EasyMock.expect(m_cluster.getHost(org.easymock.EasyMock.eq(1L))).andReturn(host1).anyTimes();
        org.easymock.EasyMock.expect(m_cluster.getHost(org.easymock.EasyMock.eq(2L))).andReturn(host2).anyTimes();
    ...
    public void testStaleAlertInMaintenaceMode() {
        ...
        org.apache.ambari.server.orm.entities.AlertCurrentEntity current1 = org.easymock.EasyMock.createNiceMock(org.apache.ambari.server.orm.entities.AlertCurrentEntity.class);
        org.apache.ambari.server.orm.entities.AlertHistoryEntity history1 = org.easymock.EasyMock.createNiceMock(org.apache.ambari.server.orm.entities.AlertHistoryEntity.class);
        org.apache.ambari.server.orm.entities.AlertCurrentEntity current2 = org.easymock.EasyMock.createNiceMock(org.apache.ambari.server.orm.entities.AlertCurrentEntity.class);
        org.apache.ambari.server.orm.entities.AlertHistoryEntity history2 = org.easymock.EasyMock.createNiceMock(org.apache.ambari.server.orm.entities.AlertHistoryEntity.class);
        org.easymock.EasyMock.expect(current1.getAlertHistory()).andReturn(history1).atLeastOnce();
        org.easymock.EasyMock.expect(history1.getAlertDefinition()).andReturn(definition).atLeastOnce();
        org.easymock.EasyMock.expect(current2.getAlertHistory()).andReturn(history2).atLeastOnce();
        org.easymock.EasyMock.expect(history2.getAlertDefinition()).andReturn(definition).atLeastOnce();
        org.easymock.EasyMock.expect(current1.getMaintenanceState()).andReturn(org.apache.ambari.server.state.MaintenanceState.ON).atLeastOnce();
        org.easymock.EasyMock.expect(current1.getLatestTimestamp()).andReturn(1L).atLeastOnce();
        org.easymock.EasyMock.expect(current2.getMaintenanceState()).andReturn(org.apache.ambari.server.state.MaintenanceState.OFF).atLeastOnce();
        org.easymock.EasyMock.expect(current2.getLatestTimestamp()).andReturn(java.lang.System.currentTimeMillis()).atLeastOnce();
        org.easymock.EasyMock.replay(current1, history1, current2, history2);
        m_currentAlerts.add(current1);
    ...
    private class MockModule implements com.google.inject.Module {
        ...
        public void configure(com.google.inject.Binder binder) {
            ...
            binder.bind(org.apache.ambari.server.orm.dao.AlertsDAO.class).toInstance(org.easymock.EasyMock.createNiceMock(org.apache.ambari.server.orm.dao.AlertsDAO.class));
            binder.bind(org.apache.ambari.server.orm.dao.HostRoleCommandDAO.class).toInstance(org.easymock.EasyMock.createNiceMock(org.apache.ambari.server.orm.dao.HostRoleCommandDAO.class));
            binder.bind(org.apache.ambari.server.state.alert.AlertHelper.class).toInstance(org.easymock.EasyMock.createNiceMock(org.apache.ambari.server.state.alert.AlertHelper.class));
        }
    }
}
