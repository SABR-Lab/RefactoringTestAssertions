...
public class ContentTypeOverrideFilter implements javax.servlet.Filter {
    ...
    class ContentTypeOverrideRequestWrapper extends javax.servlet.http.HttpServletRequestWrapper {
        ...
        public java.util.Enumeration<java.lang.String> getHeaders(java.lang.String name) {
            ...
            if (javax.ws.rs.core.HttpHeaders.CONTENT_TYPE.equals(name)) {
                ...
                while (headerValues.hasMoreElements()) {
                    ...
                    if ((value != null) && value.startsWith(javax.ws.rs.core.MediaType.APPLICATION_JSON)) {
                        newContentTypeValues.add(value.replace(javax.ws.rs.core.MediaType.APPLICATION_JSON, javax.ws.rs.core.MediaType.TEXT_PLAIN));
                    } else {
        ...
        public java.lang.String getHeader(java.lang.String name) {
            if (javax.ws.rs.core.HttpHeaders.CONTENT_TYPE.equals(name)) {
                ...
                if ((header != null) && header.startsWith(javax.ws.rs.core.MediaType.APPLICATION_JSON)) {
                    return header.replace(javax.ws.rs.core.MediaType.APPLICATION_JSON, javax.ws.rs.core.MediaType.TEXT_PLAIN);
                }
            }
    ...
    class ContentTypeOverrideResponseWrapper extends javax.servlet.http.HttpServletResponseWrapper {
        public ContentTypeOverrideResponseWrapper(javax.servlet.http.HttpServletResponse response) {
            super(response);
            super.setContentType(javax.ws.rs.core.MediaType.APPLICATION_JSON);
        }
    ...
    public void doFilter(javax.servlet.ServletRequest request, javax.servlet.ServletResponse response, javax.servlet.FilterChain chain) throws java.io.IOException, javax.servlet.ServletException {
        if (request instanceof javax.servlet.http.HttpServletRequest) {
            ...
            if (((contentType != null) && contentType.startsWith(javax.ws.rs.core.MediaType.APPLICATION_JSON)) && (!isUrlExcluded(httpServletRequest.getPathInfo()))) {
                    ...
                    for (java.lang.reflect.Method method : clazz.getMethods()) {
                        if (method.isAnnotationPresent(javax.ws.rs.Consumes.class)) {
                            ...
                            for (java.lang.String consume : consumesAnnotation.value()) {
                                if (javax.ws.rs.core.MediaType.APPLICATION_JSON.equals(consume)) {
