...
public class UserNameOverrideFilterTest extends org.easymock.EasyMockSupport {
    ...
    public void testDoFilterNoUserNameInUri() throws java.lang.Exception {
        org.easymock.EasyMock.expect(userRelatedRequest.getRequestURI()).andReturn("/test/test1").anyTimes();
        filterChain.doFilter(org.easymock.EasyMock.same(userRelatedRequest), org.easymock.EasyMock.same(response));
    ...
    public void testDoFilterWithUserNameInUri() throws java.lang.Exception {
        org.easymock.EasyMock.expect(userRelatedRequest.getRequestURI()).andReturn("/test/users/testUserName/test1").anyTimes();
        filterChain.doFilter(org.easymock.EasyMock.same(userRelatedRequest), org.easymock.EasyMock.same(response));
        org.easymock.EasyMock.expectLastCall();
        replayAll();
        filter.doFilter(userRelatedRequest, response, filterChain);
    ...
    public void testDoFilterWithLoginAliasInUri() throws java.lang.Exception {
        org.easymock.EasyMock.expect(userRelatedRequest.getRequestURI()).andReturn(java.lang.String.format("/test/users/%s/test1", java.net.URLEncoder.encode("testLoginAlias@testdomain.com", "UTF-8"))).anyTimes();
        org.easymock.Capture<javax.servlet.ServletRequest> requestCapture = org.easymock.Capture.newInstance();
        filterChain.doFilter(org.easymock.EasyMock.capture(requestCapture), org.easymock.EasyMock.same(response));
        org.easymock.EasyMock.expectLastCall();
        ...
        org.easymock.EasyMock.expect(org.apache.ambari.server.security.authorization.AuthorizationHelper.resolveLoginAliasToUserName(org.easymock.EasyMock.eq("testLoginAlias@testdomain.com"))).andReturn("testuser1");
