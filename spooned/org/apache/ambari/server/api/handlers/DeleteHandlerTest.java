...
public class DeleteHandlerTest {
    ...
    public void testHandleRequest__Synchronous() throws java.lang.Exception {
        ...
        org.easymock.EasyMock.expect(pm.delete(resource, body)).andReturn(status);
        ...
        org.easymock.EasyMock.expect(status.getStatusMetadata()).andReturn(new org.apache.ambari.server.controller.internal.DeleteStatusMetaData());
    ...
    public void testHandleRequest__Asynchronous() throws java.lang.Exception {
        ...
        org.easymock.EasyMock.replay(request, body, resource, pm, status, resource1, resource2, requestResource, query);
        org.apache.ambari.server.api.services.Result result = new org.apache.ambari.server.api.handlers.DeleteHandlerTest.TestDeleteHandler(pm).handleRequest(request);
        org.junit.Assert.assertNotNull(result);
        org.apache.ambari.server.api.util.TreeNode<org.apache.ambari.server.controller.spi.Resource> tree = result.getResultTree();
        ...
        org.easymock.EasyMock.verify(request, body, resource, pm, status, resource1, resource2, requestResource, query);
    }
    ...
    public void testHandleRequest__AuthorizationFailure() throws java.lang.Exception {
        ...
        org.easymock.EasyMock.expect(request.getRenderer()).andReturn(renderer);
        query.setRenderer(renderer);
        org.easymock.EasyMock.expect(pm.delete(resource, body)).andThrow(new org.apache.ambari.server.security.authorization.AuthorizationException());
        org.easymock.EasyMock.replay(request, body, resource, pm, query);
        org.apache.ambari.server.api.services.Result result = new org.apache.ambari.server.api.handlers.DeleteHandlerTest.TestDeleteHandler(pm).handleRequest(request);
        ...
        org.easymock.EasyMock.verify(request, body, resource, pm, query);
    }

    @org.junit.Test
    public void testIdempotentPersist() throws java.lang.Exception {
        ...
        org.apache.ambari.server.ConfigGroupNotFoundException configGroupNotFoundException = org.easymock.EasyMock.createNiceMock(org.apache.ambari.server.ConfigGroupNotFoundException.class);
        org.apache.ambari.server.api.query.Query query = org.easymock.EasyMock.createNiceMock(org.apache.ambari.server.api.query.Query.class);
        org.easymock.EasyMock.expect(request.getResource()).andReturn(resource).anyTimes();
        org.easymock.EasyMock.expect(request.getBody()).andReturn(body).atLeastOnce();
        org.easymock.EasyMock.expect(pm.delete(resource, body)).andThrow(new org.apache.ambari.server.controller.spi.NoSuchResourceException("Configgroup not exist", configGroupNotFoundException));
        org.easymock.EasyMock.replay(request, body, resource, pm, status, resource1, requestResource, query);
    ...
    private class TestDeleteHandler extends org.apache.ambari.server.api.handlers.DeleteHandler {
        private org.apache.ambari.server.api.services.persistence.PersistenceManager m_testPm;

        private TestDeleteHandler(org.apache.ambari.server.api.services.persistence.PersistenceManager pm) {
            m_testPm = pm;
        }
