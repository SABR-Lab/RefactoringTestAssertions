...
public class ClusterBlueprintRendererTest {
    ...
    private static final org.apache.ambari.server.controller.spi.ClusterController clusterController = org.easymock.EasyMock.createNiceMock(org.apache.ambari.server.controller.internal.ClusterControllerImpl.class);

    private static final org.apache.ambari.server.topology.AmbariContext ambariContext = org.easymock.EasyMock.createNiceMock(org.apache.ambari.server.topology.AmbariContext.class);
    ...
    private static final org.apache.ambari.server.state.Clusters clusters = org.easymock.EasyMock.createNiceMock(org.apache.ambari.server.state.cluster.ClustersImpl.class);

    private static final org.apache.ambari.server.controller.AmbariManagementController controller = org.easymock.EasyMock.createNiceMock(org.apache.ambari.server.controller.AmbariManagementControllerImpl.class);

    private static final org.apache.ambari.server.controller.KerberosHelper kerberosHelper = org.easymock.EasyMock.createNiceMock(org.apache.ambari.server.controller.KerberosHelperImpl.class);

    private static final org.apache.ambari.server.state.kerberos.KerberosDescriptor kerberosDescriptor = org.easymock.EasyMock.createNiceMock(org.apache.ambari.server.state.kerberos.KerberosDescriptor.class);
    ...
    private static final org.apache.ambari.server.topology.HostGroup group1 = org.easymock.EasyMock.createNiceMock(org.apache.ambari.server.topology.HostGroup.class);

    private static final org.apache.ambari.server.topology.HostGroup group2 = org.easymock.EasyMock.createNiceMock(org.apache.ambari.server.topology.HostGroup.class);
    ...
    public void setup() throws java.lang.Exception {
        ...
        org.easymock.EasyMock.expect(org.apache.ambari.server.api.query.render.ClusterBlueprintRendererTest.topology.isNameNodeHAEnabled()).andReturn(false).anyTimes();
        org.easymock.EasyMock.expect(org.apache.ambari.server.api.query.render.ClusterBlueprintRendererTest.topology.getConfiguration()).andReturn(org.apache.ambari.server.api.query.render.ClusterBlueprintRendererTest.clusterConfig).anyTimes();
        org.easymock.EasyMock.expect(org.apache.ambari.server.api.query.render.ClusterBlueprintRendererTest.topology.getBlueprint()).andReturn(org.apache.ambari.server.api.query.render.ClusterBlueprintRendererTest.blueprint).anyTimes();
        org.easymock.EasyMock.expect(org.apache.ambari.server.api.query.render.ClusterBlueprintRendererTest.topology.getHostGroupInfo()).andReturn(groupInfoMap).anyTimes();
        org.easymock.EasyMock.expect(org.apache.ambari.server.api.query.render.ClusterBlueprintRendererTest.blueprint.getStack()).andReturn(org.apache.ambari.server.api.query.render.ClusterBlueprintRendererTest.stack).anyTimes();
        org.easymock.EasyMock.expect(org.apache.ambari.server.api.query.render.ClusterBlueprintRendererTest.blueprint.getHostGroups()).andReturn(hostGroups).anyTimes();
        org.easymock.EasyMock.expect(org.apache.ambari.server.api.query.render.ClusterBlueprintRendererTest.blueprint.getHostGroup("host_group_1")).andReturn(org.apache.ambari.server.api.query.render.ClusterBlueprintRendererTest.group1).anyTimes();
        org.easymock.EasyMock.expect(org.apache.ambari.server.api.query.render.ClusterBlueprintRendererTest.blueprint.getHostGroup("host_group_2")).andReturn(org.apache.ambari.server.api.query.render.ClusterBlueprintRendererTest.group2).anyTimes();
        org.easymock.EasyMock.expect(org.apache.ambari.server.api.query.render.ClusterBlueprintRendererTest.blueprint.getServices()).andReturn(com.google.common.collect.ImmutableSet.of("HDFS", "YARN")).anyTimes();
        org.easymock.EasyMock.expect(org.apache.ambari.server.api.query.render.ClusterBlueprintRendererTest.stack.getName()).andReturn("HDP").anyTimes();
        org.easymock.EasyMock.expect(org.apache.ambari.server.api.query.render.ClusterBlueprintRendererTest.stack.getVersion()).andReturn("1.3.3").anyTimes();
        org.easymock.EasyMock.expect(org.apache.ambari.server.api.query.render.ClusterBlueprintRendererTest.stack.getConfiguration()).andReturn(org.apache.ambari.server.topology.Configuration.newEmpty()).anyTimes();
        org.easymock.EasyMock.expect(org.apache.ambari.server.api.query.render.ClusterBlueprintRendererTest.group1.getName()).andReturn("host_group_1").anyTimes();
        org.easymock.EasyMock.expect(org.apache.ambari.server.api.query.render.ClusterBlueprintRendererTest.group2.getName()).andReturn("host_group_2").anyTimes();
        org.easymock.EasyMock.expect(org.apache.ambari.server.api.query.render.ClusterBlueprintRendererTest.group1.getComponents()).andReturn(group1Components).anyTimes();
        org.easymock.EasyMock.expect(org.apache.ambari.server.api.query.render.ClusterBlueprintRendererTest.group2.getComponents()).andReturn(group2Components).anyTimes();
        org.easymock.EasyMock.expect(org.apache.ambari.server.api.query.render.ClusterBlueprintRendererTest.topology.getAmbariContext()).andReturn(org.apache.ambari.server.api.query.render.ClusterBlueprintRendererTest.ambariContext).anyTimes();
        org.easymock.EasyMock.expect(org.apache.ambari.server.api.query.render.ClusterBlueprintRendererTest.topology.getClusterId()).andReturn(1L).anyTimes();
        org.powermock.api.easymock.PowerMock.mockStatic(org.apache.ambari.server.controller.AmbariServer.class);
        org.easymock.EasyMock.expect(org.apache.ambari.server.controller.AmbariServer.getController()).andReturn(org.apache.ambari.server.api.query.render.ClusterBlueprintRendererTest.controller).anyTimes();
        org.powermock.api.easymock.PowerMock.replay(org.apache.ambari.server.controller.AmbariServer.class);
        org.easymock.EasyMock.expect(org.apache.ambari.server.api.query.render.ClusterBlueprintRendererTest.clusters.getCluster("clusterName")).andReturn(org.apache.ambari.server.api.query.render.ClusterBlueprintRendererTest.cluster).anyTimes();
        org.easymock.EasyMock.expect(org.apache.ambari.server.api.query.render.ClusterBlueprintRendererTest.controller.getKerberosHelper()).andReturn(org.apache.ambari.server.api.query.render.ClusterBlueprintRendererTest.kerberosHelper).anyTimes();
        org.easymock.EasyMock.expect(org.apache.ambari.server.api.query.render.ClusterBlueprintRendererTest.controller.getClusters()).andReturn(org.apache.ambari.server.api.query.render.ClusterBlueprintRendererTest.clusters).anyTimes();
        org.easymock.EasyMock.expect(org.apache.ambari.server.api.query.render.ClusterBlueprintRendererTest.kerberosHelper.getKerberosDescriptor(org.apache.ambari.server.api.query.render.ClusterBlueprintRendererTest.cluster, false)).andReturn(org.apache.ambari.server.api.query.render.ClusterBlueprintRendererTest.kerberosDescriptor).anyTimes();
        java.util.Set<java.lang.String> properties = new java.util.HashSet<>();
        properties.add("core-site/hadoop.security.auth_to_local");
        org.easymock.EasyMock.expect(org.apache.ambari.server.api.query.render.ClusterBlueprintRendererTest.kerberosDescriptor.getAllAuthToLocalProperties()).andReturn(properties).anyTimes();
        org.easymock.EasyMock.expect(org.apache.ambari.server.api.query.render.ClusterBlueprintRendererTest.ambariContext.getClusterName(1L)).andReturn("clusterName").anyTimes();
        org.easymock.EasyMock.replay(org.apache.ambari.server.api.query.render.ClusterBlueprintRendererTest.topology, org.apache.ambari.server.api.query.render.ClusterBlueprintRendererTest.blueprint, org.apache.ambari.server.api.query.render.ClusterBlueprintRendererTest.stack, org.apache.ambari.server.api.query.render.ClusterBlueprintRendererTest.group1, org.apache.ambari.server.api.query.render.ClusterBlueprintRendererTest.group2, org.apache.ambari.server.api.query.render.ClusterBlueprintRendererTest.ambariContext, org.apache.ambari.server.api.query.render.ClusterBlueprintRendererTest.clusters, org.apache.ambari.server.api.query.render.ClusterBlueprintRendererTest.controller, org.apache.ambari.server.api.query.render.ClusterBlueprintRendererTest.kerberosHelper, org.apache.ambari.server.api.query.render.ClusterBlueprintRendererTest.cluster, org.apache.ambari.server.api.query.render.ClusterBlueprintRendererTest.kerberosDescriptor);
    }

    private void setupMocksForKerberosEnabledCluster() throws java.lang.Exception {
        org.apache.ambari.server.topology.AmbariContext ambariContext = org.easymock.EasyMock.createNiceMock(org.apache.ambari.server.topology.AmbariContext.class);
        org.easymock.EasyMock.expect(ambariContext.getClusterName(org.easymock.EasyMock.anyLong())).andReturn("clusterName").anyTimes();
        org.powermock.api.easymock.PowerMock.mockStatic(org.apache.ambari.server.topology.AmbariContext.class);
        org.easymock.EasyMock.expect(org.apache.ambari.server.topology.AmbariContext.getClusterController()).andReturn(org.apache.ambari.server.api.query.render.ClusterBlueprintRendererTest.clusterController).anyTimes();
        org.easymock.EasyMock.expect(org.apache.ambari.server.topology.AmbariContext.getController()).andReturn(org.apache.ambari.server.api.query.render.ClusterBlueprintRendererTest.controller).anyTimes();
        org.easymock.EasyMock.reset(org.apache.ambari.server.api.query.render.ClusterBlueprintRendererTest.topology);
        org.apache.ambari.server.topology.HostGroupInfo group1Info = new org.apache.ambari.server.topology.HostGroupInfo("host_group_1");
        group1Info.addHost("host1");
        group1Info.setConfiguration(org.apache.ambari.server.api.query.render.ClusterBlueprintRendererTest.emptyConfiguration);
        org.apache.ambari.server.topology.HostGroupInfo group2Info = new org.apache.ambari.server.topology.HostGroupInfo("host_group_2");
        ...
        org.easymock.EasyMock.expect(org.apache.ambari.server.api.query.render.ClusterBlueprintRendererTest.topology.getHostGroupInfo()).andReturn(groupInfoMap).anyTimes();
        org.easymock.EasyMock.expect(org.apache.ambari.server.api.query.render.ClusterBlueprintRendererTest.topology.getClusterId()).andReturn(1L).anyTimes();
        org.easymock.EasyMock.expect(org.apache.ambari.server.api.query.render.ClusterBlueprintRendererTest.topology.getAmbariContext()).andReturn(ambariContext).anyTimes();
        org.easymock.EasyMock.expect(org.apache.ambari.server.api.query.render.ClusterBlueprintRendererTest.topology.isClusterKerberosEnabled()).andReturn(true).anyTimes();
        org.apache.ambari.server.controller.spi.ResourceProvider resourceProvider = org.easymock.EasyMock.createStrictMock(org.apache.ambari.server.controller.spi.ResourceProvider.class);
        org.easymock.EasyMock.expect(org.apache.ambari.server.api.query.render.ClusterBlueprintRendererTest.clusterController.ensureResourceProvider(org.apache.ambari.server.controller.spi.Resource.Type.Artifact)).andReturn(resourceProvider).once();
        org.apache.ambari.server.controller.spi.Resource resource = org.easymock.EasyMock.createStrictMock(org.apache.ambari.server.controller.spi.Resource.class);
        java.util.Set<org.apache.ambari.server.controller.spi.Resource> result = java.util.Collections.singleton(resource);
        org.easymock.EasyMock.expect(resourceProvider.getResources(org.easymock.EasyMock.anyObject(org.apache.ambari.server.controller.spi.Request.class), org.easymock.EasyMock.anyObject(org.apache.ambari.server.controller.spi.Predicate.class))).andReturn(result).once();
        ...
        org.easymock.EasyMock.expect(resource.getPropertiesMap()).andReturn(resourcePropertiesMap).once();
        org.powermock.api.easymock.PowerMock.replay(org.apache.ambari.server.topology.AmbariContext.class);
        org.easymock.EasyMock.replay(ambariContext, org.apache.ambari.server.api.query.render.ClusterBlueprintRendererTest.topology, org.apache.ambari.server.api.query.render.ClusterBlueprintRendererTest.clusterController, resource, resourceProvider);
    }

    @org.junit.After
    public void tearDown() {
        org.easymock.EasyMock.verify(org.apache.ambari.server.api.query.render.ClusterBlueprintRendererTest.topology, org.apache.ambari.server.api.query.render.ClusterBlueprintRendererTest.blueprint, org.apache.ambari.server.api.query.render.ClusterBlueprintRendererTest.stack, org.apache.ambari.server.api.query.render.ClusterBlueprintRendererTest.group1, org.apache.ambari.server.api.query.render.ClusterBlueprintRendererTest.group2, org.apache.ambari.server.api.query.render.ClusterBlueprintRendererTest.ambariContext, org.apache.ambari.server.api.query.render.ClusterBlueprintRendererTest.clusters, org.apache.ambari.server.api.query.render.ClusterBlueprintRendererTest.controller, org.apache.ambari.server.api.query.render.ClusterBlueprintRendererTest.kerberosHelper, org.apache.ambari.server.api.query.render.ClusterBlueprintRendererTest.cluster, org.apache.ambari.server.api.query.render.ClusterBlueprintRendererTest.kerberosDescriptor);
        org.easymock.EasyMock.reset(org.apache.ambari.server.api.query.render.ClusterBlueprintRendererTest.topology, org.apache.ambari.server.api.query.render.ClusterBlueprintRendererTest.blueprint, org.apache.ambari.server.api.query.render.ClusterBlueprintRendererTest.stack, org.apache.ambari.server.api.query.render.ClusterBlueprintRendererTest.group1, org.apache.ambari.server.api.query.render.ClusterBlueprintRendererTest.group2, org.apache.ambari.server.api.query.render.ClusterBlueprintRendererTest.ambariContext, org.apache.ambari.server.api.query.render.ClusterBlueprintRendererTest.clusters, org.apache.ambari.server.api.query.render.ClusterBlueprintRendererTest.controller, org.apache.ambari.server.api.query.render.ClusterBlueprintRendererTest.kerberosHelper, org.apache.ambari.server.api.query.render.ClusterBlueprintRendererTest.cluster, org.apache.ambari.server.api.query.render.ClusterBlueprintRendererTest.kerberosDescriptor);
    }
    ...
    private static org.apache.ambari.server.controller.internal.Stack stackForSettingsTest() {
        org.apache.ambari.server.controller.internal.Stack stack = org.easymock.EasyMock.createNiceMock(org.apache.ambari.server.controller.internal.Stack.class);
        org.apache.ambari.server.state.ServiceInfo service1 = org.easymock.EasyMock.createNiceMock(org.apache.ambari.server.state.ServiceInfo.class);
        org.easymock.EasyMock.expect(service1.isCredentialStoreEnabled()).andReturn(true).anyTimes();
        org.easymock.EasyMock.expect(stack.getServiceInfo("service1")).andReturn(java.util.Optional.of(service1)).anyTimes();
        org.apache.ambari.server.state.ComponentInfo component1 = org.easymock.EasyMock.createNiceMock(org.apache.ambari.server.state.ComponentInfo.class);
        org.easymock.EasyMock.expect(component1.isRecoveryEnabled()).andReturn(true).anyTimes();
        org.easymock.EasyMock.expect(service1.getComponentByName("component1")).andReturn(component1).anyTimes();
        org.easymock.EasyMock.expect(stack.getServiceForComponent("component1")).andReturn("service1").anyTimes();
        org.easymock.EasyMock.expect(stack.getComponentInfo("component1")).andReturn(component1).anyTimes();
        org.apache.ambari.server.state.ComponentInfo component2 = org.easymock.EasyMock.createNiceMock(org.apache.ambari.server.state.ComponentInfo.class);
        org.easymock.EasyMock.expect(component2.isRecoveryEnabled()).andReturn(false).anyTimes();
        org.easymock.EasyMock.expect(service1.getComponentByName("component2")).andReturn(component2).anyTimes();
        org.easymock.EasyMock.expect(stack.getServiceForComponent("component2")).andReturn("service1").anyTimes();
        org.easymock.EasyMock.expect(stack.getComponentInfo("component2")).andReturn(component2).anyTimes();
        org.easymock.EasyMock.expect(service1.getComponents()).andReturn(com.google.common.collect.ImmutableList.of(component1, component2)).anyTimes();
        org.apache.ambari.server.state.ServiceInfo service2 = org.easymock.EasyMock.createNiceMock(org.apache.ambari.server.state.ServiceInfo.class);
        org.easymock.EasyMock.expect(service2.isCredentialStoreEnabled()).andReturn(false).anyTimes();
        org.easymock.EasyMock.expect(stack.getServiceInfo("service2")).andReturn(java.util.Optional.of(service2)).anyTimes();
        org.apache.ambari.server.state.ComponentInfo component3 = org.easymock.EasyMock.createNiceMock(org.apache.ambari.server.state.ComponentInfo.class);
        org.easymock.EasyMock.expect(component3.isRecoveryEnabled()).andReturn(false).anyTimes();
        org.easymock.EasyMock.expect(service2.getComponentByName("component3")).andReturn(component3).anyTimes();
        org.easymock.EasyMock.expect(stack.getServiceForComponent("component3")).andReturn("service2").anyTimes();
        org.easymock.EasyMock.expect(stack.getComponentInfo("component3")).andReturn(component3).anyTimes();
        org.easymock.EasyMock.expect(service2.getComponents()).andReturn(com.google.common.collect.ImmutableList.of(component3)).anyTimes();
        org.easymock.EasyMock.expect(stack.getComponents()).andReturn(com.google.common.collect.ImmutableMap.of("service1", com.google.common.collect.ImmutableSet.of("component1", "component2"), "service2", com.google.common.collect.ImmutableSet.of("component3"))).anyTimes();
        org.easymock.EasyMock.replay(stack, service1, service2, component1, component2, component3);
        return stack;
    }
