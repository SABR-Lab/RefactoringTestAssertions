...
public class DefaultRendererTest {
    ...
    public void testFinalizeProperties__instance_noProperties() {
        ...
        org.easymock.EasyMock.expect(schema.getKeyPropertyId(org.apache.ambari.server.controller.spi.Resource.Type.Service)).andReturn("ServiceComponentInfo/service_name").anyTimes();
    ...
    public void testFinalizeProperties__instance_properties() {
        ...
        org.easymock.EasyMock.expect(schema.getKeyPropertyId(org.apache.ambari.server.controller.spi.Resource.Type.Cluster)).andReturn("ServiceInfo/cluster_name").anyTimes();
        org.easymock.EasyMock.replay(schemaFactory, schema);
    ...
    public void testFinalizeProperties__instance_subResource_noProperties() {
        ...
        org.easymock.EasyMock.expect(serviceSchema.getKeyPropertyId(org.apache.ambari.server.controller.spi.Resource.Type.Cluster)).andReturn("ServiceInfo/cluster_name").anyTimes();
        ...
        org.easymock.EasyMock.expect(componentSchema.getKeyPropertyId(org.apache.ambari.server.controller.spi.Resource.Type.Service)).andReturn("ServiceComponentInfo/service_name").anyTimes();
