...
public class MinimalRendererTest {
    ...
    public void testFinalizeProperties__instance_noProperties() {
        org.apache.ambari.server.controller.spi.SchemaFactory schemaFactory = org.easymock.EasyMock.createNiceMock(org.apache.ambari.server.controller.spi.SchemaFactory.class);
        ...
        org.easymock.EasyMock.expect(schemaFactory.getSchema(org.apache.ambari.server.controller.spi.Resource.Type.Component)).andReturn(schema).anyTimes();
        org.easymock.EasyMock.expect(schemaFactory.getSchema(org.apache.ambari.server.controller.spi.Resource.Type.Alert)).andReturn(schema).anyTimes();
        org.easymock.EasyMock.expect(schemaFactory.getSchema(org.apache.ambari.server.controller.spi.Resource.Type.Artifact)).andReturn(schema).anyTimes();
        org.easymock.EasyMock.expect(schema.getKeyPropertyId(org.apache.ambari.server.controller.spi.Resource.Type.Component)).andReturn("ServiceComponentInfo/component_name").anyTimes();
        org.easymock.EasyMock.replay(schemaFactory, schema);
        ...
        org.easymock.EasyMock.verify(schemaFactory, schema);
    }
    ...
    public void testFinalizeProperties__instance_properties() {
        org.apache.ambari.server.controller.spi.SchemaFactory schemaFactory = org.easymock.EasyMock.createNiceMock(org.apache.ambari.server.controller.spi.SchemaFactory.class);
        org.apache.ambari.server.controller.spi.Schema schema = org.easymock.EasyMock.createNiceMock(org.apache.ambari.server.controller.spi.Schema.class);
        org.easymock.EasyMock.expect(schemaFactory.getSchema(org.apache.ambari.server.controller.spi.Resource.Type.Service)).andReturn(schema).anyTimes();
        org.easymock.EasyMock.expect(schema.getKeyPropertyId(org.apache.ambari.server.controller.spi.Resource.Type.Service)).andReturn("ServiceInfo/service_name").anyTimes();
        org.easymock.EasyMock.replay(schemaFactory, schema);
    ...
    public void testFinalizeProperties__instance_subResource_noProperties() {
        ...
        org.easymock.EasyMock.expect(schemaFactory.getSchema(org.apache.ambari.server.controller.spi.Resource.Type.Service)).andReturn(serviceSchema).anyTimes();
        org.easymock.EasyMock.expect(serviceSchema.getKeyPropertyId(org.apache.ambari.server.controller.spi.Resource.Type.Service)).andReturn("ServiceInfo/service_name").anyTimes();
        org.easymock.EasyMock.expect(schemaFactory.getSchema(org.apache.ambari.server.controller.spi.Resource.Type.Component)).andReturn(componentSchema).anyTimes();
        org.easymock.EasyMock.expect(componentSchema.getKeyPropertyId(org.apache.ambari.server.controller.spi.Resource.Type.Component)).andReturn("ServiceComponentInfo/component_name").anyTimes();
        org.easymock.EasyMock.replay(schemaFactory, serviceSchema, componentSchema);
        java.util.HashSet<java.lang.String> serviceProperties = new java.util.HashSet<>();
        org.apache.ambari.server.api.query.QueryInfo rootQuery = new org.apache.ambari.server.api.query.QueryInfo(new org.apache.ambari.server.api.resources.ServiceResourceDefinition(), serviceProperties);
        org.apache.ambari.server.api.util.TreeNode<org.apache.ambari.server.api.query.QueryInfo> queryTree = new org.apache.ambari.server.api.util.TreeNodeImpl<>(null, rootQuery, "Service");
        ...
        org.junit.Assert.assertEquals(1, componentNode.getObject().size());
        org.junit.Assert.assertTrue(componentNode.getObject().contains("ServiceComponentInfo/component_name"));
        org.easymock.EasyMock.verify(schemaFactory, serviceSchema, componentSchema);
    }
    ...
    public void testFinalizeResult() throws java.lang.Exception {
        org.apache.ambari.server.controller.spi.SchemaFactory schemaFactory = org.easymock.EasyMock.createNiceMock(org.apache.ambari.server.controller.spi.SchemaFactory.class);
        org.apache.ambari.server.controller.spi.Schema clusterSchema = org.easymock.EasyMock.createNiceMock(org.apache.ambari.server.controller.spi.Schema.class);
        org.apache.ambari.server.controller.spi.Schema hostSchema = org.easymock.EasyMock.createNiceMock(org.apache.ambari.server.controller.spi.Schema.class);
        org.apache.ambari.server.controller.spi.Schema hostComponentSchema = org.easymock.EasyMock.createNiceMock(org.apache.ambari.server.controller.spi.Schema.class);
        org.easymock.EasyMock.expect(schemaFactory.getSchema(org.apache.ambari.server.controller.spi.Resource.Type.Cluster)).andReturn(clusterSchema).anyTimes();
        org.easymock.EasyMock.expect(schemaFactory.getSchema(org.apache.ambari.server.controller.spi.Resource.Type.Host)).andReturn(hostSchema).anyTimes();
        org.easymock.EasyMock.expect(schemaFactory.getSchema(org.apache.ambari.server.controller.spi.Resource.Type.HostComponent)).andReturn(hostComponentSchema).anyTimes();
        ...
        org.easymock.EasyMock.expect(hostSchema.getKeyPropertyId(org.apache.ambari.server.controller.spi.Resource.Type.Cluster)).andReturn("Hosts/cluster_name").anyTimes();
        ...
        org.easymock.EasyMock.expect(hostComponentSchema.getKeyPropertyId(org.apache.ambari.server.controller.spi.Resource.Type.Cluster)).andReturn("HostRoles/cluster_name").anyTimes();
        org.easymock.EasyMock.expect(hostComponentSchema.getKeyPropertyId(org.apache.ambari.server.controller.spi.Resource.Type.Host)).andReturn("HostRoles/host_name").anyTimes();
        org.easymock.EasyMock.expect(hostComponentSchema.getKeyPropertyId(org.apache.ambari.server.controller.spi.Resource.Type.HostComponent)).andReturn("HostRoles/component_name").anyTimes();
        org.easymock.EasyMock.replay(schemaFactory, clusterSchema, hostSchema, hostComponentSchema);
