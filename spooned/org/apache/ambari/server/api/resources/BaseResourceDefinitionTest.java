...
public class BaseResourceDefinitionTest {
    ...
    public void testGetPostProcessors() throws org.apache.ambari.server.AmbariException {
        ...
        org.easymock.EasyMock.expect(factory.getServiceResourceProvider(org.easymock.EasyMock.anyObject(org.apache.ambari.server.controller.AmbariManagementController.class))).andReturn(serviceResourceProvider);
        org.apache.ambari.server.controller.internal.AbstractControllerResourceProvider.init(factory);
        org.easymock.EasyMock.replay(factory, managementController, maintenanceStateHelper);
