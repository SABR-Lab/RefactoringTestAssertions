...
public class KdcServerConnectionVerificationTest {
    ...
    public void testValidate__Success() throws java.lang.Exception {
        org.apache.directory.kerberos.client.KdcConnection connection = org.easymock.EasyMock.createStrictMock(org.apache.directory.kerberos.client.KdcConnection.class);
        org.easymock.EasyMock.expect(connection.getTgt("noUser@noRealm", "noPassword")).andReturn(null).once();
        org.easymock.EasyMock.replay(connection);
        ...
        org.easymock.EasyMock.verify(connection);
    }
    ...
    public void testValidateTCP__Successful2() throws java.lang.Exception {
        org.apache.directory.shared.kerberos.messages.KrbError error = org.easymock.EasyMock.createNiceMock(org.apache.directory.shared.kerberos.messages.KrbError.class);
        org.easymock.EasyMock.expect(error.getErrorCode()).andReturn(org.apache.directory.shared.kerberos.exceptions.ErrorType.KDC_ERR_C_PRINCIPAL_UNKNOWN).once();
        org.easymock.EasyMock.expect(error.getMessageType()).andReturn(org.apache.directory.shared.kerberos.KerberosMessageType.KRB_ERROR).once();
        org.apache.directory.shared.kerberos.exceptions.KerberosException exception = org.easymock.EasyMock.createNiceMock(org.apache.directory.shared.kerberos.exceptions.KerberosException.class);
        org.easymock.EasyMock.expect(exception.getError()).andReturn(error).once();
        org.apache.directory.kerberos.client.KdcConnection connection = org.easymock.EasyMock.createStrictMock(org.apache.directory.kerberos.client.KdcConnection.class);
        org.easymock.EasyMock.expect(connection.getTgt("noUser@noRealm", "noPassword")).andThrow(exception);
        org.easymock.EasyMock.replay(connection, exception, error);
        org.apache.ambari.server.api.rest.KdcServerConnectionVerificationTest.TestKdcServerConnectionVerification kdcConnVerifier = new org.apache.ambari.server.api.rest.KdcServerConnectionVerificationTest.TestKdcServerConnectionVerification(configuration, connection);
        boolean result = kdcConnVerifier.isKdcReachable("test-host", 11111, org.apache.ambari.server.KdcServerConnectionVerification.ConnectionProtocol.TCP);
        org.junit.Assert.assertTrue(result);
        org.apache.directory.kerberos.client.KdcConfig kdcConfig = kdcConnVerifier.getConfigUsedInConnectionCreation();
        ...
        org.junit.Assert.assertEquals(11111, kdcConfig.getKdcPort());
        org.junit.Assert.assertEquals(10 * 1000, kdcConfig.getTimeout());
        org.easymock.EasyMock.verify(connection, exception);
    }

    @org.junit.Test
    public void testValidateTCP__Fail_UnknownException() throws java.lang.Exception {
        org.apache.directory.kerberos.client.KdcConnection connection = org.easymock.EasyMock.createStrictMock(org.apache.directory.kerberos.client.KdcConnection.class);
        org.easymock.EasyMock.expect(connection.getTgt("noUser@noRealm", "noPassword")).andThrow(new java.lang.RuntimeException("This is a really bad exception"));
        org.easymock.EasyMock.replay(connection);
        org.apache.ambari.server.api.rest.KdcServerConnectionVerificationTest.TestKdcServerConnectionVerification kdcConnVerifier = new org.apache.ambari.server.api.rest.KdcServerConnectionVerificationTest.TestKdcServerConnectionVerification(configuration, connection);
        boolean result = kdcConnVerifier.isKdcReachable("test-host", 11111, org.apache.ambari.server.KdcServerConnectionVerification.ConnectionProtocol.TCP);
    ...
    public void testValidateTCP__Fail_TimeoutErrorCode() throws java.lang.Exception {
        org.apache.directory.kerberos.client.KdcConnection connection = org.easymock.EasyMock.createStrictMock(org.apache.directory.kerberos.client.KdcConnection.class);
        org.easymock.EasyMock.expect(connection.getTgt("noUser@noRealm", "noPassword")).andThrow(new org.apache.directory.shared.kerberos.exceptions.KerberosException(org.apache.directory.shared.kerberos.exceptions.ErrorType.KRB_ERR_GENERIC, "TimeOut occurred"));
        org.easymock.EasyMock.replay(connection);
        org.apache.ambari.server.api.rest.KdcServerConnectionVerificationTest.TestKdcServerConnectionVerification kdcConnVerifier = new org.apache.ambari.server.api.rest.KdcServerConnectionVerificationTest.TestKdcServerConnectionVerification(configuration, connection);
        boolean result = kdcConnVerifier.isKdcReachable("test-host", 11111, org.apache.ambari.server.KdcServerConnectionVerification.ConnectionProtocol.TCP);
        org.junit.Assert.assertFalse(result);
    ...
    public void testValidateTCP__Fail_GeneralErrorCode_NotTimeout() throws java.lang.Exception {
        org.apache.directory.shared.kerberos.messages.KrbError error = org.easymock.EasyMock.createNiceMock(org.apache.directory.shared.kerberos.messages.KrbError.class);
        org.easymock.EasyMock.expect(error.getErrorCode()).andReturn(org.apache.directory.shared.kerberos.exceptions.ErrorType.KRB_ERR_GENERIC).once();
        org.easymock.EasyMock.expect(error.getMessageType()).andReturn(org.apache.directory.shared.kerberos.KerberosMessageType.KRB_ERROR).once();
        org.apache.directory.shared.kerberos.exceptions.KerberosException exception = org.easymock.EasyMock.createNiceMock(org.apache.directory.shared.kerberos.exceptions.KerberosException.class);
        org.easymock.EasyMock.expect(exception.getError()).andReturn(error).once();
        org.apache.directory.kerberos.client.KdcConnection connection = org.easymock.EasyMock.createStrictMock(org.apache.directory.kerberos.client.KdcConnection.class);
