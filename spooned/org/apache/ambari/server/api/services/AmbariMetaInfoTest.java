...
public class AmbariMetaInfoTest {
    ...
    private static class TestAmbariMetaInfo extends org.apache.ambari.server.api.services.AmbariMetaInfo {
        ...
        public TestAmbariMetaInfo(org.apache.ambari.server.configuration.Configuration configuration) throws java.lang.Exception {
            ...
            alertDefinitionDAO = org.easymock.EasyMock.createNiceMock(org.apache.ambari.server.orm.dao.AlertDefinitionDAO.class);
            ...
            if (java.lang.System.getProperty("os.name").contains("Windows")) {
                ...
                org.easymock.EasyMock.expect(config.getResourceDirPath()).andReturn(java.lang.ClassLoader.getSystemClassLoader().getResource("").getPath()).anyTimes();
            } else {
                org.easymock.EasyMock.expect(config.getSharedResourcesDirPath()).andReturn("./src/test/resources").anyTimes();
                org.easymock.EasyMock.expect(config.getResourceDirPath()).andReturn("./src/test/resources").anyTimes();
            }
            org.easymock.EasyMock.replay(config);
        ...
        public void replayAllMocks() {
            org.easymock.EasyMock.replay(alertDefinitionDAO);
        }
        ...
        public class MockModule extends com.google.inject.AbstractModule {
            ...
            protected void configure() {
                bind(org.apache.ambari.server.metadata.ActionMetadata.class);
                bind(org.apache.ambari.server.orm.dao.MetainfoDAO.class).toInstance(org.easymock.EasyMock.createNiceMock(org.apache.ambari.server.orm.dao.MetainfoDAO.class));
            }
        }
    }
}
