...
public abstract class BaseServiceTest {
    protected org.apache.ambari.server.api.resources.ResourceInstance resourceInstance = org.easymock.EasyMock.createNiceMock(org.apache.ambari.server.api.resources.ResourceInstance.class);

    protected org.apache.ambari.server.api.services.RequestFactory requestFactory = org.easymock.EasyMock.createStrictMock(org.apache.ambari.server.api.services.RequestFactory.class);

    protected org.apache.ambari.server.api.services.Request request = org.easymock.EasyMock.createNiceMock(org.apache.ambari.server.api.services.Request.class);

    protected javax.ws.rs.core.HttpHeaders httpHeaders = org.easymock.EasyMock.createNiceMock(javax.ws.rs.core.HttpHeaders.class);

    protected javax.ws.rs.core.UriInfo uriInfo = org.easymock.EasyMock.createNiceMock(javax.ws.rs.core.UriInfo.class);

    protected org.apache.ambari.server.api.services.Result result = org.easymock.EasyMock.createMock(org.apache.ambari.server.api.services.Result.class);

    protected org.apache.ambari.server.api.services.RequestBody requestBody = org.easymock.EasyMock.createNiceMock(org.apache.ambari.server.api.services.RequestBody.class);

    protected org.apache.ambari.server.api.services.parsers.RequestBodyParser bodyParser = org.easymock.EasyMock.createStrictMock(org.apache.ambari.server.api.services.parsers.RequestBodyParser.class);

    protected org.apache.ambari.server.api.services.ResultStatus status = org.easymock.EasyMock.createNiceMock(org.apache.ambari.server.api.services.ResultStatus.class);

    protected org.apache.ambari.server.api.services.serializers.ResultSerializer serializer = org.easymock.EasyMock.createStrictMock(org.apache.ambari.server.api.services.serializers.ResultSerializer.class);
    ...
    private void testMethod(org.apache.ambari.server.api.services.BaseServiceTest.ServiceTestInvocation testMethod) throws java.lang.reflect.InvocationTargetException, java.lang.IllegalAccessException {
        try {
            org.easymock.EasyMock.expect(bodyParser.parse(testMethod.getBody())).andReturn(java.util.Collections.singleton(requestBody));
        } catch (org.apache.ambari.server.api.services.parsers.BodyParseException e) {
        }
        assertCreateRequest(testMethod);
        org.easymock.EasyMock.expect(request.process()).andReturn(result);
        org.easymock.EasyMock.expect(result.getStatus()).andReturn(status).atLeastOnce();
        org.easymock.EasyMock.expect(status.getStatusCode()).andReturn(testMethod.getStatusCode()).atLeastOnce();
        org.easymock.EasyMock.expect(serializer.serialize(result)).andReturn(serializedResult);
        replayMocks();
    ...
    protected void assertCreateRequest(org.apache.ambari.server.api.services.BaseServiceTest.ServiceTestInvocation testMethod) {
        ...
        org.easymock.EasyMock.expect(requestFactory.createRequest(httpHeaders, requestBody, uriInfo, testMethod.getRequestType(), resourceInstance)).andReturn(request);
    }
    ...
    private void testMethod_bodyParseException(org.apache.ambari.server.api.services.BaseServiceTest.ServiceTestInvocation testMethod) throws java.lang.Exception {
        ...
        org.easymock.EasyMock.expect(bodyParser.parse(testMethod.getBody())).andThrow(e);
        org.easymock.EasyMock.expect(serializer.serialize(org.easymock.EasyMock.capture(resultCapture))).andReturn(serializedResult);
        replayMocks();
        javax.ws.rs.core.Response r = testMethod.invoke();
        org.junit.Assert.assertEquals(serializedResult, r.getEntity());
    ...
    private void testMethod_resultInErrorState(org.apache.ambari.server.api.services.BaseServiceTest.ServiceTestInvocation testMethod) throws java.lang.Exception {
        ...
        org.easymock.EasyMock.expect(request.process()).andReturn(result);
        org.easymock.EasyMock.expect(result.getStatus()).andReturn(status).atLeastOnce();
        org.easymock.EasyMock.expect(status.getStatusCode()).andReturn(400).atLeastOnce();
        org.easymock.EasyMock.expect(serializer.serialize(result)).andReturn(serializedResult);
        replayMocks();
        javax.ws.rs.core.Response r = testMethod.invoke();
        org.junit.Assert.assertEquals(serializedResult, r.getEntity());
    ...
    private void replayMocks() {
        org.easymock.EasyMock.replay(resourceInstance, requestFactory, request, result, requestBody, bodyParser, status, serializer);
    }

    private void verifyAndResetMocks() {
        org.easymock.EasyMock.verify(resourceInstance, requestFactory, request, result, requestBody, bodyParser, status, serializer);
        org.easymock.EasyMock.reset(resourceInstance, requestFactory, request, result, requestBody, bodyParser, status, serializer);
    }
