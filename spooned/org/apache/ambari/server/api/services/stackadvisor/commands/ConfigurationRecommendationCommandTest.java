...
public class ConfigurationRecommendationCommandTest {
    ...
    public void testProcessHostGroups() throws java.lang.Exception {
        ...
        org.apache.ambari.server.api.services.stackadvisor.StackAdvisorRequest request = org.mockito.Mockito.mock(org.apache.ambari.server.api.services.stackadvisor.StackAdvisorRequest.class);
        ...
        org.mockito.Mockito.doReturn(componentHostGroupMap).when(request).getHostComponents();
