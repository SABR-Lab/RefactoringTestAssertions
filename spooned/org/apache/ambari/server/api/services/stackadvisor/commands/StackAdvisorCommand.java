...
public abstract class StackAdvisorCommand<T extends org.apache.ambari.server.api.services.stackadvisor.StackAdvisorResponse> extends org.apache.ambari.server.api.services.BaseService {
    ...
    private final java.util.Map<java.lang.String, com.fasterxml.jackson.databind.JsonNode> hostInfoCache;
    ...
    public StackAdvisorCommand(java.io.File recommendationsDir, java.lang.String recommendationsArtifactsLifetime, org.apache.ambari.server.state.ServiceInfo.ServiceAdvisorType serviceAdvisorType, int requestId, org.apache.ambari.server.api.services.stackadvisor.StackAdvisorRunner saRunner, org.apache.ambari.server.api.services.AmbariMetaInfo metaInfo, org.apache.ambari.server.controller.internal.AmbariServerConfigurationHandler ambariServerConfigurationHandler, java.util.Map<java.lang.String, com.fasterxml.jackson.databind.JsonNode> hostInfoCache) {
        ...
        this.mapper.configure(com.fasterxml.jackson.databind.SerializationFeature.INDENT_OUTPUT, true);
    ...
    protected org.apache.ambari.server.api.services.stackadvisor.commands.StackAdvisorCommand.StackAdvisorData adjust(org.apache.ambari.server.api.services.stackadvisor.commands.StackAdvisorCommand.StackAdvisorData data, org.apache.ambari.server.api.services.stackadvisor.StackAdvisorRequest request) {
        try {
            com.fasterxml.jackson.databind.node.ObjectNode root = ((com.fasterxml.jackson.databind.node.ObjectNode) (this.mapper.readTree(data.servicesJSON)));
            ...
            throw new javax.ws.rs.WebApplicationException(javax.ws.rs.core.Response.status(javax.ws.rs.core.Response.Status.BAD_REQUEST).entity(message).build());
        }
        return data;
    }

    void populateAmbariConfiguration(com.fasterxml.jackson.databind.node.ObjectNode root) {
    ...
    protected void populateAmbariServerInfo(com.fasterxml.jackson.databind.node.ObjectNode root) {
        ...
        if ((serverProperties != null) && (!serverProperties.isEmpty())) {
            com.fasterxml.jackson.databind.JsonNode serverPropertiesNode = mapper.convertValue(serverProperties, com.fasterxml.jackson.databind.JsonNode.class);
    ...
    private void populateConfigurations(com.fasterxml.jackson.databind.node.ObjectNode root, org.apache.ambari.server.api.services.stackadvisor.StackAdvisorRequest request) {
        ...
        com.fasterxml.jackson.databind.node.ObjectNode configurationsNode = root.putObject(org.apache.ambari.server.api.services.stackadvisor.commands.StackAdvisorCommand.CONFIGURATIONS_PROPERTY);
        for (java.lang.String siteName : configurations.keySet()) {
            com.fasterxml.jackson.databind.node.ObjectNode siteNode = configurationsNode.putObject(siteName);
            ...
            for (java.lang.String properties : siteMap.keySet()) {
                com.fasterxml.jackson.databind.node.ObjectNode propertiesNode = siteNode.putObject(properties);
        ...
        com.fasterxml.jackson.databind.JsonNode changedConfigs = mapper.valueToTree(request.getChangedConfigurations());
        ...
        com.fasterxml.jackson.databind.JsonNode userContext = mapper.valueToTree(request.getUserContext());
    ...
    private void populateConfigGroups(com.fasterxml.jackson.databind.node.ObjectNode root, org.apache.ambari.server.api.services.stackadvisor.StackAdvisorRequest request) {
        if ((request.getConfigGroups() != null) && (!request.getConfigGroups().isEmpty())) {
            com.fasterxml.jackson.databind.JsonNode configGroups = mapper.valueToTree(request.getConfigGroups());
    ...
    protected void populateStackHierarchy(com.fasterxml.jackson.databind.node.ObjectNode root) {
        com.fasterxml.jackson.databind.node.ObjectNode version = ((com.fasterxml.jackson.databind.node.ObjectNode) (root.get("Versions")));
        com.fasterxml.jackson.databind.node.TextNode stackName = ((com.fasterxml.jackson.databind.node.TextNode) (version.get("stack_name")));
        com.fasterxml.jackson.databind.node.TextNode stackVersion = ((com.fasterxml.jackson.databind.node.TextNode) (version.get("stack_version")));
        com.fasterxml.jackson.databind.node.ObjectNode stackHierarchy = version.putObject("stack_hierarchy");
        stackHierarchy.put("stack_name", stackName);
        com.fasterxml.jackson.databind.node.ArrayNode parents = stackHierarchy.putArray("stack_versions");
    ...
    private void populateComponentHostsMap(com.fasterxml.jackson.databind.node.ObjectNode root, java.util.Map<java.lang.String, java.util.Set<java.lang.String>> componentHostsMap) {
        com.fasterxml.jackson.databind.node.ArrayNode services = ((com.fasterxml.jackson.databind.node.ArrayNode) (root.get(org.apache.ambari.server.api.services.stackadvisor.commands.StackAdvisorCommand.SERVICES_PROPERTY)));
        java.util.Iterator<com.fasterxml.jackson.databind.JsonNode> servicesIter = services.elements();
        while (servicesIter.hasNext()) {
            com.fasterxml.jackson.databind.JsonNode service = servicesIter.next();
            com.fasterxml.jackson.databind.node.ArrayNode components = ((com.fasterxml.jackson.databind.node.ArrayNode) (service.get(org.apache.ambari.server.api.services.stackadvisor.commands.StackAdvisorCommand.SERVICES_COMPONENTS_PROPERTY)));
            java.util.Iterator<com.fasterxml.jackson.databind.JsonNode> componentsIter = components.elements();
            while (componentsIter.hasNext()) {
                com.fasterxml.jackson.databind.JsonNode component = componentsIter.next();
                com.fasterxml.jackson.databind.node.ObjectNode componentInfo = ((com.fasterxml.jackson.databind.node.ObjectNode) (component.get(org.apache.ambari.server.api.services.stackadvisor.commands.StackAdvisorCommand.COMPONENT_INFO_PROPERTY)));
                java.lang.String componentName = componentInfo.get(org.apache.ambari.server.api.services.stackadvisor.commands.StackAdvisorCommand.COMPONENT_NAME_PROPERTY).asText();
                java.util.Set<java.lang.String> componentHosts = componentHostsMap.get(componentName);
                com.fasterxml.jackson.databind.node.ArrayNode hostnames = componentInfo.putArray(org.apache.ambari.server.api.services.stackadvisor.commands.StackAdvisorCommand.COMPONENT_HOSTNAMES_PROPERTY);
    ...
    private void populateServiceAdvisors(com.fasterxml.jackson.databind.node.ObjectNode root) {
        com.fasterxml.jackson.databind.node.ArrayNode services = ((com.fasterxml.jackson.databind.node.ArrayNode) (root.get(org.apache.ambari.server.api.services.stackadvisor.commands.StackAdvisorCommand.SERVICES_PROPERTY)));
        java.util.Iterator<com.fasterxml.jackson.databind.JsonNode> servicesIter = services.elements();
        com.fasterxml.jackson.databind.node.ObjectNode version = ((com.fasterxml.jackson.databind.node.ObjectNode) (root.get("Versions")));
        ...
        while (servicesIter.hasNext()) {
            com.fasterxml.jackson.databind.JsonNode service = servicesIter.next();
            com.fasterxml.jackson.databind.node.ObjectNode serviceVersion = ((com.fasterxml.jackson.databind.node.ObjectNode) (service.get(org.apache.ambari.server.api.services.stackadvisor.commands.StackAdvisorCommand.STACK_SERVICES_PROPERTY)));
            java.lang.String serviceName = serviceVersion.get("service_name").asText();
            try {
    ...
    java.lang.String getHostsInformation(org.apache.ambari.server.api.services.stackadvisor.StackAdvisorRequest request) throws org.apache.ambari.server.api.services.stackadvisor.StackAdvisorException {
        ...
        java.util.List<com.fasterxml.jackson.databind.JsonNode> resultInfos = new java.util.ArrayList<>();
        if ((hostInfoCache != null) && (!hostInfoCache.isEmpty())) {
            ...
            while (hostNamesIterator.hasNext()) {
                ...
                com.fasterxml.jackson.databind.JsonNode node = hostInfoCache.get(hostName);
                if (node != null) {
        ...
        if (hostInfoCache != null) {
            if ((hostsJSON != null) && (!hostsJSON.isEmpty())) {
                try {
                    com.fasterxml.jackson.databind.JsonNode root = mapper.readTree(hostsJSON);
                    java.util.Iterator<com.fasterxml.jackson.databind.JsonNode> iterator = root.get("items").elements();
                    while (iterator.hasNext()) {
                        com.fasterxml.jackson.databind.JsonNode next = iterator.next();
                        java.lang.String hostName = next.get("Hosts").get("host_name").asText();
            ...
            com.fasterxml.jackson.databind.node.JsonNodeFactory f = com.fasterxml.jackson.databind.node.JsonNodeFactory.instance;
            com.fasterxml.jackson.databind.node.ObjectNode resultRoot = f.objectNode();
            resultRoot.put("href", fullHostsURI);
            com.fasterxml.jackson.databind.node.ArrayNode resultArray = resultRoot.putArray("items");
