...
public class RecommendationResponse extends org.apache.ambari.server.api.services.stackadvisor.StackAdvisorResponse {
    ...
    public static class Recommendation {
        ...
        @com.fasterxml.jackson.annotation.JsonProperty("blueprint_cluster_binding")
        ...
        @com.fasterxml.jackson.annotation.JsonProperty("config-groups")
    ...
    public static class Blueprint {
        ...
        @com.fasterxml.jackson.annotation.JsonProperty("host_groups")
    ...
    public static class BlueprintConfigurations {
        ...
        @com.fasterxml.jackson.annotation.JsonProperty("property_attributes")
        @com.fasterxml.jackson.annotation.JsonInclude(com.fasterxml.jackson.annotation.JsonInclude.Include.NON_NULL)
    ...
    public static class ConfigGroup {
        ...
        @com.fasterxml.jackson.annotation.JsonProperty("dependent_configurations")
        @com.fasterxml.jackson.annotation.JsonInclude(com.fasterxml.jackson.annotation.JsonInclude.Include.NON_NULL)
