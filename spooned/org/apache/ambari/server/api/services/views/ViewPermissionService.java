...
public class ViewPermissionService extends org.apache.ambari.server.api.services.BaseService {
    ...
    java.lang.String version) {
        return handleRequest(headers, null, ui, org.apache.ambari.server.api.services.Request.Type.GET, createPermissionResource(viewName, version, null));
    }

    @javax.ws.rs.GET
    @javax.ws.rs.Path("{permissionId}")
    @javax.ws.rs.Produces(javax.ws.rs.core.MediaType.TEXT_PLAIN)
    @io.swagger.annotations.ApiOperation(value = "Get single view permission", response = org.apache.ambari.server.controller.ViewPermissionResponse.class)
    ...
    java.lang.String viewName, @io.swagger.annotations.ApiParam("view version")
    @javax.ws.rs.PathParam("version")
    java.lang.String version, @io.swagger.annotations.ApiParam("permission id")
    @javax.ws.rs.PathParam("permissionId")
    java.lang.String permissionId) {
        return handleRequest(headers, null, ui, org.apache.ambari.server.api.services.Request.Type.GET, createPermissionResource(viewName, version, permissionId));
    }
    ...
    @javax.ws.rs.PathParam("permissionId")
    java.lang.String permissionId) {
        return handleRequest(headers, body, ui, org.apache.ambari.server.api.services.Request.Type.POST, createPermissionResource(viewName, version, permissionId));
    }
    ...
    @javax.ws.rs.PathParam("permissionId")
    java.lang.String permissionId) {
        return handleRequest(headers, body, ui, org.apache.ambari.server.api.services.Request.Type.PUT, createPermissionResource(viewName, version, permissionId));
    }
    ...
    @javax.ws.rs.PathParam("permissionId")
    java.lang.String permissionId) {
        return handleRequest(headers, null, ui, org.apache.ambari.server.api.services.Request.Type.DELETE, createPermissionResource(viewName, version, permissionId));
    }

    protected org.apache.ambari.server.api.resources.ResourceInstance createPermissionResource(java.lang.String viewName, java.lang.String viewVersion, java.lang.String permissionId) {
        ...
        mapIds.put(org.apache.ambari.server.controller.spi.Resource.Type.ViewPermission, permissionId);
        return createResource(org.apache.ambari.server.controller.spi.Resource.Type.ViewPermission, mapIds);
    }
}
