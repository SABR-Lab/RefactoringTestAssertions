...
public class NamedTasksSubscriptionsTest {
    ...
    public void setupTest() {
        taskStatusListenerProvider = org.easymock.EasyMock.createMock(com.google.inject.Provider.class);
        taskStatusListener = org.easymock.EasyMock.createMock(org.apache.ambari.server.events.listeners.tasks.TaskStatusListener.class);
        ...
        org.apache.ambari.server.actionmanager.HostRoleCommand hostRoleCommand1 = org.easymock.EasyMock.createMock(org.apache.ambari.server.actionmanager.HostRoleCommand.class);
        org.apache.ambari.server.actionmanager.HostRoleCommand hostRoleCommand4 = org.easymock.EasyMock.createMock(org.apache.ambari.server.actionmanager.HostRoleCommand.class);
        org.apache.ambari.server.actionmanager.HostRoleCommand hostRoleCommand5 = org.easymock.EasyMock.createMock(org.apache.ambari.server.actionmanager.HostRoleCommand.class);
        org.easymock.EasyMock.expect(hostRoleCommand1.getStatus()).andReturn(org.apache.ambari.server.actionmanager.HostRoleStatus.IN_PROGRESS).anyTimes();
        org.easymock.EasyMock.expect(hostRoleCommand4.getStatus()).andReturn(org.apache.ambari.server.actionmanager.HostRoleStatus.IN_PROGRESS).anyTimes();
        org.easymock.EasyMock.expect(hostRoleCommand5.getStatus()).andReturn(org.apache.ambari.server.actionmanager.HostRoleStatus.IN_PROGRESS).anyTimes();
        hostRoleCommands.put(1L, hostRoleCommand1);
        hostRoleCommands.put(4L, hostRoleCommand4);
        hostRoleCommands.put(5L, hostRoleCommand5);
        org.easymock.EasyMock.expect(taskStatusListener.getActiveTasksMap()).andReturn(hostRoleCommands).anyTimes();
        org.easymock.EasyMock.expect(taskStatusListenerProvider.get()).andReturn(taskStatusListener).anyTimes();
        org.easymock.EasyMock.replay(taskStatusListenerProvider, taskStatusListener, hostRoleCommand1, hostRoleCommand4, hostRoleCommand5);
