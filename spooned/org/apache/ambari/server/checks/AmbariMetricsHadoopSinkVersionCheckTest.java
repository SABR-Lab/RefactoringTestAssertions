...
public class AmbariMetricsHadoopSinkVersionCheckTest {
    ...
    public void testPerform() throws java.lang.Exception {
        ...
        org.mockito.Mockito.when(org.apache.ambari.server.controller.AmbariServer.getController()).thenReturn(ambariManagementControllerMock);
        org.apache.ambari.server.controller.spi.ResourceProvider resourceProviderMock = org.mockito.Mockito.mock(org.apache.ambari.server.controller.spi.ResourceProvider.class);
        ...
        org.mockito.Mockito.when(org.apache.ambari.server.controller.internal.AbstractControllerResourceProvider.getResourceProvider(org.mockito.Matchers.eq(org.apache.ambari.server.controller.spi.Resource.Type.Request), org.mockito.Matchers.any(org.apache.ambari.server.controller.AmbariManagementController.class))).thenReturn(resourceProviderMock);
        org.powermock.api.mockito.PowerMockito.mockStatic(org.apache.ambari.server.controller.utilities.PropertyHelper.class);
        org.apache.ambari.server.controller.spi.Request requestMock = org.mockito.Mockito.mock(org.apache.ambari.server.controller.spi.Request.class);
        org.mockito.Mockito.when(org.apache.ambari.server.controller.utilities.PropertyHelper.getCreateRequest(org.mockito.Matchers.any(), org.mockito.Matchers.any())).thenReturn(requestMock);
        org.mockito.Mockito.when(org.apache.ambari.server.controller.utilities.PropertyHelper.getPropertyId("Requests", "id")).thenReturn("requestIdProp");
        org.apache.ambari.server.controller.spi.RequestStatus requestStatusMock = org.mockito.Mockito.mock(org.apache.ambari.server.controller.spi.RequestStatus.class);
        org.apache.ambari.server.controller.spi.Resource responseResourceMock = org.mockito.Mockito.mock(org.apache.ambari.server.controller.spi.Resource.class);
        org.mockito.Mockito.when(resourceProviderMock.createResources(requestMock)).thenReturn(requestStatusMock);
        org.mockito.Mockito.when(requestStatusMock.getRequestResource()).thenReturn(responseResourceMock);
        org.mockito.Mockito.when(responseResourceMock.getPropertyValue(org.mockito.Matchers.anyString())).thenReturn(100L);
        org.apache.ambari.server.state.Clusters clustersMock = org.mockito.Mockito.mock(org.apache.ambari.server.state.Clusters.class);
        org.mockito.Mockito.when(ambariManagementControllerMock.getClusters()).thenReturn(clustersMock);
        org.apache.ambari.server.state.Cluster clusterMock = org.mockito.Mockito.mock(org.apache.ambari.server.state.Cluster.class);
        org.mockito.Mockito.when(clustersMock.getCluster("c1")).thenReturn(clusterMock);
        org.mockito.Mockito.when(clusterMock.getHosts(org.mockito.Matchers.eq("AMBARI_METRICS"), org.mockito.Matchers.eq("METRICS_MONITOR"))).thenReturn(java.util.Collections.singleton("h1"));
        org.apache.ambari.server.orm.dao.RequestDAO requestDAOMock = org.mockito.Mockito.mock(org.apache.ambari.server.orm.dao.RequestDAO.class);
        org.apache.ambari.server.orm.entities.RequestEntity requestEntityMock = org.mockito.Mockito.mock(org.apache.ambari.server.orm.entities.RequestEntity.class);
        org.mockito.Mockito.when(requestDAOMock.findByPks(java.util.Collections.singleton(100L), true)).thenReturn(java.util.Collections.singletonList(requestEntityMock));
        org.mockito.Mockito.when(requestEntityMock.getStatus()).thenReturn(org.apache.ambari.server.actionmanager.HostRoleStatus.IN_PROGRESS).thenReturn(org.apache.ambari.server.actionmanager.HostRoleStatus.COMPLETED);
    ...
    public void testPerformFail() throws java.lang.Exception {
        ...
        org.mockito.Mockito.when(resourceProviderMock.createResources(requestMock)).thenReturn(requestStatusMock);
        org.mockito.Mockito.when(requestStatusMock.getRequestResource()).thenReturn(responseResourceMock);
        org.mockito.Mockito.when(responseResourceMock.getPropertyValue(org.mockito.Matchers.anyString())).thenReturn(101L);
        org.apache.ambari.server.state.Clusters clustersMock = org.mockito.Mockito.mock(org.apache.ambari.server.state.Clusters.class);
        org.mockito.Mockito.when(ambariManagementControllerMock.getClusters()).thenReturn(clustersMock);
        org.apache.ambari.server.state.Cluster clusterMock = org.mockito.Mockito.mock(org.apache.ambari.server.state.Cluster.class);
        org.mockito.Mockito.when(clustersMock.getCluster("c1")).thenReturn(clusterMock);
        org.mockito.Mockito.when(clusterMock.getHosts(org.mockito.Matchers.eq("AMBARI_METRICS"), org.mockito.Matchers.eq("METRICS_MONITOR"))).thenReturn(java.util.Collections.singleton("h1_fail"));
        org.apache.ambari.server.orm.dao.RequestDAO requestDAOMock = org.mockito.Mockito.mock(org.apache.ambari.server.orm.dao.RequestDAO.class);
        org.apache.ambari.server.orm.entities.RequestEntity requestEntityMock = org.mockito.Mockito.mock(org.apache.ambari.server.orm.entities.RequestEntity.class);
        org.mockito.Mockito.when(requestDAOMock.findByPks(java.util.Collections.singleton(101L), true)).thenReturn(java.util.Collections.singletonList(requestEntityMock));
        org.mockito.Mockito.when(requestEntityMock.getStatus()).thenReturn(org.apache.ambari.server.actionmanager.HostRoleStatus.IN_PROGRESS).thenReturn(org.apache.ambari.server.actionmanager.HostRoleStatus.FAILED);
        java.lang.reflect.Field requestDaoField = m_check.getClass().getDeclaredField("requestDAO");
        requestDaoField.setAccessible(true);
        requestDaoField.set(m_check, requestDAOMock);
        org.mockito.Mockito.when(requestEntityMock.getRequestId()).thenReturn(101L);
        ...
        org.apache.ambari.server.orm.entities.HostRoleCommandEntity hrcEntityMock = org.mockito.Mockito.mock(org.apache.ambari.server.orm.entities.HostRoleCommandEntity.class);
        org.mockito.Mockito.when(hostRoleCommandDAOMock.findByRequest(101L, true)).thenReturn(java.util.Collections.singletonList(hrcEntityMock));
        org.mockito.Mockito.when(hrcEntityMock.getStatus()).thenReturn(org.apache.ambari.server.actionmanager.HostRoleStatus.FAILED);
        org.mockito.Mockito.when(hrcEntityMock.getHostName()).thenReturn("h1_fail");
