...
public class AutoStartDisabledCheckTest {
    ...
    public void before() throws java.lang.Exception {
        ...
        org.easymock.EasyMock.expect(cluster.getDesiredConfigs()).andReturn(map).anyTimes();
        ...
        org.easymock.EasyMock.expect(cluster.getConfig(org.easymock.EasyMock.eq(org.apache.ambari.server.checks.AutoStartDisabledCheck.CLUSTER_ENV_TYPE), org.easymock.EasyMock.anyString())).andReturn(config).anyTimes();
        ...
        org.easymock.EasyMock.expect(clusterInformation.getClusterName()).andReturn("cluster").anyTimes();
        org.easymock.EasyMock.replay(m_clusters, cluster, config, repositoryVersion, clusterInformation);
        m_configMap.clear();
    }
