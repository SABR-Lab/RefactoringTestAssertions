...
public class ClusterCheckTest extends org.easymock.EasyMockSupport {
    ...
    public void testIsApplicable() throws java.lang.Exception {
        ...
        org.easymock.EasyMock.expect(clusters.getCluster(org.easymock.EasyMock.anyString())).andReturn(cluster).atLeastOnce();
        org.easymock.EasyMock.expect(cluster.getServices()).andReturn(services).atLeastOnce();
        ...
        org.easymock.EasyMock.expect(repositoryVersionEntity.getType()).andReturn(org.apache.ambari.spi.RepositoryType.STANDARD).anyTimes();
        org.easymock.EasyMock.expect(repositoryVersionEntity.getRepositoryXml()).andReturn(m_vdfXml).atLeastOnce();
        org.easymock.EasyMock.expect(m_vdfXml.getClusterSummary(org.easymock.EasyMock.anyObject(org.apache.ambari.server.state.Cluster.class), org.easymock.EasyMock.anyObject(org.apache.ambari.server.api.services.AmbariMetaInfo.class))).andReturn(m_clusterVersionSummary).atLeastOnce();
        org.easymock.EasyMock.expect(m_clusterVersionSummary.getAvailableServiceNames()).andReturn(allServicesList).atLeastOnce();
    ...
    public void testIsApplicableForPatch() throws java.lang.Exception {
        ...
        org.easymock.EasyMock.expect(repositoryVersionEntity.getRepositoryXml()).andReturn(m_vdfXml).atLeastOnce();
        org.easymock.EasyMock.expect(m_vdfXml.getClusterSummary(org.easymock.EasyMock.anyObject(org.apache.ambari.server.state.Cluster.class), org.easymock.EasyMock.anyObject(org.apache.ambari.server.api.services.AmbariMetaInfo.class))).andReturn(m_clusterVersionSummary).atLeastOnce();
        org.easymock.EasyMock.expect(m_clusterVersionSummary.getAvailableServiceNames()).andReturn(oneServiceList).atLeastOnce();
