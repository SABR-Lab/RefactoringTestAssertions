...
public class ComponentExistsInRepoCheckTest extends org.easymock.EasyMockSupport {
    ...
    public void before() throws java.lang.Exception {
        ...
        org.easymock.EasyMock.expect(cluster.getCurrentStackVersion()).andReturn(sourceStackId).anyTimes();
    ...
    public void testPassesWhenNoUnsupportedInTargetStack() throws java.lang.Exception {
        org.easymock.EasyMock.expect(serviceComponentSupport.allUnsupported(cluster, org.apache.ambari.server.checks.ComponentExistsInRepoCheckTest.STACK_NAME, org.apache.ambari.server.checks.ComponentExistsInRepoCheckTest.STACK_VERSION)).andReturn(java.util.Collections.emptyList()).anyTimes();
        replayAll();
    ...
    public void testFailsWhenUnsupportedFoundInTargetStack() throws java.lang.Exception {
        org.easymock.EasyMock.expect(serviceComponentSupport.allUnsupported(cluster, org.apache.ambari.server.checks.ComponentExistsInRepoCheckTest.STACK_NAME, org.apache.ambari.server.checks.ComponentExistsInRepoCheckTest.STACK_VERSION)).andReturn(java.util.Collections.singletonList("ANY_SERVICE")).anyTimes();
    ...
    private void suggestedUpgradePackIs(org.apache.ambari.server.stack.upgrade.UpgradePack upgradePack) throws org.apache.ambari.server.AmbariException {
        org.easymock.EasyMock.expect(upgradeHelper.suggestUpgradePack("cluster", sourceStackId, new org.apache.ambari.server.state.StackId(request.getTargetRepositoryVersion().getStackId()), org.apache.ambari.server.stack.upgrade.Direction.UPGRADE, request.getUpgradeType(), null)).andReturn(upgradePack).anyTimes();
    }
