...
public class ConfigurationMergeCheckTest {
    ...
    public void before() throws java.lang.Exception {
        ...
        org.easymock.EasyMock.expect(cluster.getCurrentStackVersion()).andReturn(org.apache.ambari.server.checks.ConfigurationMergeCheckTest.stackId_1_0).anyTimes();
        ...
        org.easymock.EasyMock.expect(config.getProperties()).andReturn(m_configMap).anyTimes();
        org.easymock.EasyMock.expect(cluster.getDesiredConfigByType(org.apache.ambari.server.checks.ConfigurationMergeCheckTest.CONFIG_TYPE)).andReturn(config).anyTimes();
        ...
        org.easymock.EasyMock.replay(clusters, cluster, config);
    }
    ...
    public void testPerform() throws java.lang.Exception {
        ...
        org.easymock.EasyMock.expect(repositoryVersionDAO.findByStackNameAndVersion("HDP", "1.0")).andReturn(createFor("1.0")).anyTimes();
        org.easymock.EasyMock.expect(repositoryVersionDAO.findByStackNameAndVersion("HDP", "1.1.0.0-1234")).andReturn(createFor("1.1")).anyTimes();
        ...
        pi11.setValue("1024");
        org.easymock.EasyMock.expect(ami.getServiceProperties("HDP", "1.0", "HDFS")).andReturn(java.util.Collections.singleton(pi10)).anyTimes();
        org.easymock.EasyMock.expect(ami.getServiceProperties("HDP", "1.1", "HDFS")).andReturn(java.util.Collections.singleton(pi11)).anyTimes();
        org.easymock.EasyMock.expect(ami.getStackProperties(org.easymock.EasyMock.anyObject(java.lang.String.class), org.easymock.EasyMock.anyObject(java.lang.String.class))).andReturn(java.util.Collections.emptySet()).anyTimes();
        org.easymock.EasyMock.replay(ami);
