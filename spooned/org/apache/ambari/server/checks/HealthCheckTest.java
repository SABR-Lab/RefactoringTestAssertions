...
public class HealthCheckTest {
    ...
    private org.apache.ambari.server.orm.dao.AlertsDAO alertsDAO = org.mockito.Mockito.mock(org.apache.ambari.server.orm.dao.AlertsDAO.class);
    ...
    public void setUp() throws java.lang.Exception {
        ...
        org.mockito.Mockito.when(clusters.getCluster(org.apache.ambari.server.checks.HealthCheckTest.CLUSTER_NAME)).thenReturn(cluster);
        org.mockito.Mockito.when(cluster.getClusterId()).thenReturn(org.apache.ambari.server.checks.HealthCheckTest.CLUSTER_ID);
    }

    @org.junit.Test
    public void testWarningWhenNoAlertsExist() throws org.apache.ambari.server.AmbariException {
        org.mockito.Mockito.when(alertsDAO.findCurrentByCluster(org.mockito.Matchers.eq(org.apache.ambari.server.checks.HealthCheckTest.CLUSTER_ID))).thenReturn(java.util.Collections.emptyList());
    ...
    private void expectWarning(org.apache.ambari.server.state.AlertState alertState) throws org.apache.ambari.server.AmbariException {
        ...
        org.mockito.Mockito.when(alertsDAO.findCurrentByCluster(org.mockito.Matchers.eq(org.apache.ambari.server.checks.HealthCheckTest.CLUSTER_ID))).thenReturn(java.util.Arrays.asList(alertCurrentEntity));
        org.apache.ambari.spi.ClusterInformation clusterInformation = new org.apache.ambari.spi.ClusterInformation(org.apache.ambari.server.checks.HealthCheckTest.CLUSTER_NAME, false, null, null, null);
        org.apache.ambari.spi.upgrade.UpgradeCheckRequest request = new org.apache.ambari.spi.upgrade.UpgradeCheckRequest(clusterInformation, org.apache.ambari.spi.upgrade.UpgradeType.ROLLING, null, null, null);
        org.apache.ambari.spi.upgrade.UpgradeCheckResult result = healthCheck.perform(request);
