...
public class HostsRepositoryVersionCheckTest {
    ...
    public void testPerform() throws java.lang.Exception {
        ...
        org.mockito.Mockito.when(hostVersionDAO.findByClusterStackVersionAndHost(org.mockito.Mockito.anyString(), org.mockito.Mockito.any(org.apache.ambari.server.state.StackId.class), org.mockito.Mockito.anyString(), org.mockito.ArgumentMatchers.nullable(java.lang.String.class))).thenReturn(hostVersion);
