...
public class KerberosAdminPersistedCredentialCheckTest extends org.easymock.EasyMockSupport {
    ...
    private org.apache.ambari.spi.upgrade.UpgradeCheckResult executeCheck(boolean kerberosEnabled, boolean manageIdentities, boolean credentialStoreInitialized, boolean credentialSet) throws java.lang.Exception {
        ...
        org.easymock.EasyMock.expect(upgradeHelper.suggestUpgradePack(org.easymock.EasyMock.eq(clusterName), org.easymock.EasyMock.anyObject(), org.easymock.EasyMock.anyObject(), org.easymock.EasyMock.eq(org.apache.ambari.server.stack.upgrade.Direction.UPGRADE), org.easymock.EasyMock.eq(org.apache.ambari.spi.upgrade.UpgradeType.ROLLING), org.easymock.EasyMock.anyObject())).andReturn(upgradePackWithRegenKeytab()).anyTimes();
        ...
        org.easymock.EasyMock.expect(desiredKerberosEnv.getTag()).andReturn("tag").anyTimes();
        ...
        org.easymock.EasyMock.expect(kerberosEnv.getProperties()).andReturn(java.util.Collections.singletonMap("manage_identities", manageIdentities ? "true" : "false")).anyTimes();
        org.apache.ambari.server.state.Cluster cluster = createMock(org.apache.ambari.server.state.Cluster.class);
        org.easymock.EasyMock.expect(cluster.getSecurityType()).andReturn(kerberosEnabled ? org.apache.ambari.server.state.SecurityType.KERBEROS : org.apache.ambari.server.state.SecurityType.NONE).anyTimes();
        org.easymock.EasyMock.expect(cluster.getDesiredConfigs()).andReturn(desiredConfigs).anyTimes();
        org.easymock.EasyMock.expect(cluster.getConfig("kerberos-env", "tag")).andReturn(kerberosEnv).anyTimes();
        org.easymock.EasyMock.expect(cluster.getCurrentStackVersion()).andReturn(createNiceMock(org.apache.ambari.server.state.StackId.class)).anyTimes();
        ...
        org.easymock.EasyMock.expect(credentialStoreProvider.isInitialized(org.apache.ambari.server.security.encryption.CredentialStoreType.PERSISTED)).andReturn(credentialStoreInitialized).anyTimes();
        org.easymock.EasyMock.expect(credentialStoreProvider.getCredential(clusterName, org.apache.ambari.server.controller.KerberosHelper.KDC_ADMINISTRATOR_CREDENTIAL_ALIAS, org.apache.ambari.server.security.encryption.CredentialStoreType.PERSISTED)).andReturn(credentialSet ? credential : null).anyTimes();
    ...
    private org.apache.ambari.server.stack.upgrade.UpgradePack upgradePackWithRegenKeytab() {
        ...
        org.easymock.EasyMock.expect(upgradePack.anyGroupTaskMatch(org.easymock.EasyMock.anyObject())).andReturn(true).anyTimes();
        return upgradePack;
    }
