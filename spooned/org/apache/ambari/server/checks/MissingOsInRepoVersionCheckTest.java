...
public class MissingOsInRepoVersionCheckTest extends org.easymock.EasyMockSupport {
    ...
    public void setUp() throws java.lang.Exception {
        ...
        org.easymock.EasyMock.expect(clusters.getCluster(org.apache.ambari.server.checks.MissingOsInRepoVersionCheckTest.CLUSTER_NAME)).andReturn(cluster).anyTimes();
        ...
        org.easymock.EasyMock.expect(host.getOsFamily()).andReturn(org.apache.ambari.server.checks.MissingOsInRepoVersionCheckTest.OS_FAMILY_IN_CLUSTER).anyTimes();
        org.easymock.EasyMock.expect(host.getMaintenanceState(org.easymock.EasyMock.anyInt())).andReturn(org.apache.ambari.server.state.MaintenanceState.OFF).anyTimes();
    ...
    private void sourceStackRepoIs(java.lang.String osFamily) throws org.apache.ambari.server.AmbariException {
        org.easymock.EasyMock.expect(ambariMetaInfo.getStack(org.apache.ambari.server.checks.MissingOsInRepoVersionCheckTest.SOURCE_STACK)).andReturn(stackInfo(repoInfo(osFamily))).anyTimes();
    }
    ...
    private org.apache.ambari.spi.upgrade.UpgradeCheckRequest request(org.apache.ambari.server.orm.entities.RepositoryVersionEntity targetRepo) {
        ...
        org.easymock.EasyMock.expect(repositoryVersionDAO.findByPK(1L)).andReturn(targetRepo).anyTimes();
        org.apache.ambari.spi.RepositoryVersion repositoryVersion = createNiceMock(org.apache.ambari.spi.RepositoryVersion.class);
        org.easymock.EasyMock.expect(repositoryVersion.getId()).andReturn(1L).anyTimes();
        org.easymock.EasyMock.expect(repositoryVersion.getRepositoryType()).andReturn(org.apache.ambari.spi.RepositoryType.STANDARD).anyTimes();
        org.easymock.EasyMock.expect(repositoryVersion.getStackId()).andReturn(org.apache.ambari.server.checks.MissingOsInRepoVersionCheckTest.SOURCE_STACK.getStackId()).anyTimes();
