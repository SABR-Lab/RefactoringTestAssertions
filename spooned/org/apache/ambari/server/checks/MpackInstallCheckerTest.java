...
public class MpackInstallCheckerTest {
    ...
    public void testCheckValidClusters() throws java.lang.Exception {
        ...
        org.easymock.EasyMock.expect(mpackInstallChecker.getConnection()).andReturn(mockConnection);
        ...
        org.easymock.EasyMock.expect(stackResultSet.getString("stack_name")).andReturn("HDF");
        org.easymock.EasyMock.expect(stackResultSet.getString("stack_version")).andReturn("2.0");
        org.easymock.EasyMock.expect(stackResultSet.getString("cluster_name")).andReturn("cl1");
    ...
    public void testCheckInvalidClusters() throws java.lang.Exception {
        ...
        org.easymock.EasyMock.expect(stackResultSet.getString("stack_version")).andReturn("2.5");
        org.easymock.EasyMock.expect(stackResultSet.getString("cluster_name")).andReturn("cl1");
        easyMockSupport.replayAll();
        mpackInstallChecker.checkClusters(stacksInMpack);
        easyMockSupport.verifyAll();
