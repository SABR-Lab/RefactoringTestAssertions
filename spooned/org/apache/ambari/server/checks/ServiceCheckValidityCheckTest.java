...
public class ServiceCheckValidityCheckTest {
    ...
    public void setUp() throws java.lang.Exception {
        ...
        serviceConfigDAO = org.mockito.Mockito.mock(org.apache.ambari.server.orm.dao.ServiceConfigDAO.class);
        hostRoleCommandDAO = org.mockito.Mockito.mock(org.apache.ambari.server.orm.dao.HostRoleCommandDAO.class);
        ambariMetaInfo = org.mockito.Mockito.mock(org.apache.ambari.server.api.services.AmbariMetaInfo.class);
        ...
        org.mockito.Mockito.when(clusters.getCluster(org.apache.ambari.server.checks.ServiceCheckValidityCheckTest.CLUSTER_NAME)).thenReturn(cluster);
        org.mockito.Mockito.when(cluster.getClusterId()).thenReturn(org.apache.ambari.server.checks.ServiceCheckValidityCheckTest.CLUSTER_ID);
        org.mockito.Mockito.when(cluster.getServices()).thenReturn(com.google.common.collect.ImmutableMap.of(org.apache.ambari.server.checks.ServiceCheckValidityCheckTest.SERVICE_NAME, service));
        org.mockito.Mockito.when(cluster.getCurrentStackVersion()).thenReturn(new org.apache.ambari.server.state.StackId("HDP", "2.2"));
        org.mockito.Mockito.when(service.getName()).thenReturn(org.apache.ambari.server.checks.ServiceCheckValidityCheckTest.SERVICE_NAME);
        org.mockito.Mockito.when(service.getDesiredStackId()).thenReturn(new org.apache.ambari.server.state.StackId("HDP", "2.2"));
        ...
        org.mockito.Mockito.when(ambariMetaInfo.isServiceWithNoConfigs(org.mockito.Mockito.anyString(), org.mockito.Mockito.anyString(), org.mockito.Mockito.anyString())).thenReturn(false);
    ...
    public void testWithNullCommandDetailAtCommand() throws org.apache.ambari.server.AmbariException {
        org.apache.ambari.server.state.ServiceComponent serviceComponent = org.mockito.Mockito.mock(org.apache.ambari.server.state.ServiceComponent.class);
        org.mockito.Mockito.when(serviceComponent.isVersionAdvertised()).thenReturn(true);
        org.mockito.Mockito.when(service.getMaintenanceState()).thenReturn(org.apache.ambari.server.state.MaintenanceState.OFF);
        org.mockito.Mockito.when(service.getServiceComponents()).thenReturn(com.google.common.collect.ImmutableMap.of(org.apache.ambari.server.checks.ServiceCheckValidityCheckTest.SERVICE_COMPONENT_NAME, serviceComponent));
        ...
        org.mockito.Mockito.when(serviceConfigDAO.getLastServiceConfig(org.mockito.Matchers.eq(org.apache.ambari.server.checks.ServiceCheckValidityCheckTest.CLUSTER_ID), org.mockito.Matchers.eq(org.apache.ambari.server.checks.ServiceCheckValidityCheckTest.SERVICE_NAME))).thenReturn(serviceConfigEntity);
        org.mockito.Mockito.when(hostRoleCommandDAO.getLatestServiceChecksByRole(org.mockito.Matchers.any(java.lang.Long.class))).thenReturn(java.util.Arrays.asList(lastServiceCheckDTO1, lastServiceCheckDTO2));
    ...
    public void testFailWhenServiceWithOutdatedServiceCheckExists() throws org.apache.ambari.server.AmbariException {
        ...
        org.mockito.Mockito.when(serviceConfigDAO.getLastServiceConfig(org.mockito.Matchers.eq(org.apache.ambari.server.checks.ServiceCheckValidityCheckTest.CLUSTER_ID), org.mockito.Matchers.eq(org.apache.ambari.server.checks.ServiceCheckValidityCheckTest.SERVICE_NAME))).thenReturn(serviceConfigEntity);
        org.mockito.Mockito.when(hostRoleCommandDAO.getLatestServiceChecksByRole(org.mockito.Matchers.any(java.lang.Long.class))).thenReturn(java.util.Collections.singletonList(lastServiceCheckDTO));
        org.apache.ambari.spi.ClusterInformation clusterInformation = new org.apache.ambari.spi.ClusterInformation(org.apache.ambari.server.checks.ServiceCheckValidityCheckTest.CLUSTER_NAME, false, null, null, null);
        org.apache.ambari.spi.upgrade.UpgradeCheckRequest request = new org.apache.ambari.spi.upgrade.UpgradeCheckRequest(clusterInformation, org.apache.ambari.spi.upgrade.UpgradeType.ROLLING, null, null, null);
        org.apache.ambari.spi.upgrade.UpgradeCheckResult result = serviceCheckValidityCheck.perform(request);
        org.junit.Assert.assertEquals(org.apache.ambari.spi.upgrade.UpgradeCheckStatus.FAIL, result.getStatus());
    ...
    public void testFailWhenServiceWithNoServiceCheckExists() throws org.apache.ambari.server.AmbariException {
        ...
        serviceConfigEntity.setCreateTimestamp(org.apache.ambari.server.checks.ServiceCheckValidityCheckTest.CONFIG_CREATE_TIMESTAMP);
        org.mockito.Mockito.when(serviceConfigDAO.getLastServiceConfig(org.mockito.Matchers.eq(org.apache.ambari.server.checks.ServiceCheckValidityCheckTest.CLUSTER_ID), org.mockito.Matchers.eq(org.apache.ambari.server.checks.ServiceCheckValidityCheckTest.SERVICE_NAME))).thenReturn(serviceConfigEntity);
        org.mockito.Mockito.when(hostRoleCommandDAO.getLatestServiceChecksByRole(org.mockito.Matchers.any(java.lang.Long.class))).thenReturn(java.util.Collections.<org.apache.ambari.server.orm.dao.HostRoleCommandDAO.LastServiceCheckDTO>emptyList());
        org.apache.ambari.spi.ClusterInformation clusterInformation = new org.apache.ambari.spi.ClusterInformation(org.apache.ambari.server.checks.ServiceCheckValidityCheckTest.CLUSTER_NAME, false, null, null, null);
        org.apache.ambari.spi.upgrade.UpgradeCheckRequest request = new org.apache.ambari.spi.upgrade.UpgradeCheckRequest(clusterInformation, org.apache.ambari.spi.upgrade.UpgradeType.ROLLING, null, null, null);
        org.apache.ambari.spi.upgrade.UpgradeCheckResult result = serviceCheckValidityCheck.perform(request);
        org.junit.Assert.assertEquals(org.apache.ambari.spi.upgrade.UpgradeCheckStatus.FAIL, result.getStatus());
