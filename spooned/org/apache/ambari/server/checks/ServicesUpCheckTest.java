...
public class ServicesUpCheckTest {
    ...
    public void testPerform() throws java.lang.Exception {
        ...
        org.mockito.Mockito.when(ambariMetaInfo.getComponent(org.mockito.Mockito.anyString(), org.mockito.Mockito.anyString(), org.mockito.ArgumentMatchers.nullable(java.lang.String.class), org.mockito.Mockito.anyString())).thenAnswer(new org.mockito.stubbing.Answer<org.apache.ambari.server.state.ComponentInfo>() {
            @java.lang.Override
