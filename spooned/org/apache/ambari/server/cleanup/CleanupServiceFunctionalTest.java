...
public class CleanupServiceFunctionalTest {
    ...
    private static com.google.inject.Module getTestPersistModule() {
        ...
        persistenceProperties.setProperty(org.eclipse.persistence.config.PersistenceUnitProperties.SCHEMA_GENERATION_DATABASE_ACTION, org.eclipse.persistence.config.PersistenceUnitProperties.NONE);
        persistenceProperties.setProperty(org.eclipse.persistence.config.PersistenceUnitProperties.THROW_EXCEPTIONS, "true");
        persistenceProperties.setProperty(org.eclipse.persistence.config.PersistenceUnitProperties.JDBC_USER, "ambari");
        persistenceProperties.setProperty(org.eclipse.persistence.config.PersistenceUnitProperties.JDBC_PASSWORD, "bigdata");
