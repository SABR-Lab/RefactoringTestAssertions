...
public class AndPredicateTest extends org.easymock.EasyMockSupport {
    @org.junit.Test
    public void testEvaluate() {
        ...
        org.easymock.EasyMock.expect(mockPredicate1.evaluate("context")).andReturn(true).times(1);
        org.easymock.EasyMock.expect(mockPredicate1.evaluate("context")).andReturn(false).times(1);
        org.easymock.EasyMock.expect(mockPredicate1.evaluate("context")).andReturn(true).times(1);
        ...
        org.easymock.EasyMock.expect(mockPredicate2.evaluate("context")).andReturn(true).times(1);
        org.easymock.EasyMock.expect(mockPredicate2.evaluate("context")).andReturn(true).times(1);
        replayAll();
    ...
    public void testToMap() {
        org.apache.ambari.server.collections.Predicate mockPredicate1 = createStrictMock(org.apache.ambari.server.collections.Predicate.class);
        org.easymock.EasyMock.expect(mockPredicate1.toMap()).andReturn(java.util.Collections.singletonMap("nop", "foo")).times(1);
        org.apache.ambari.server.collections.Predicate mockPredicate2 = createStrictMock(org.apache.ambari.server.collections.Predicate.class);
        org.easymock.EasyMock.expect(mockPredicate2.toMap()).andReturn(java.util.Collections.singletonMap("nop", "baz")).times(1);
        replayAll();
        org.apache.ambari.server.collections.functors.AndPredicate predicate = new org.apache.ambari.server.collections.functors.AndPredicate(mockPredicate1, mockPredicate2);
