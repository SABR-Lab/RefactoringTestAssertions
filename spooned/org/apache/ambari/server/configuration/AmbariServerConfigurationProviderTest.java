...
public class AmbariServerConfigurationProviderTest extends org.easymock.EasyMockSupport {
    ...
    public void testGetAndLoadDataForVariousEvents() {
        ...
        org.easymock.EasyMock.expect(provider.loadInstance(java.util.Collections.emptyList())).andReturn(emptyTestConfiguration).once();
        org.easymock.EasyMock.expect(provider.loadInstance(null)).andReturn(filledTestConfiguration1).once();
        org.easymock.EasyMock.expect(provider.loadInstance(null)).andReturn(filledTestConfiguration2).once();
        replayAll();
