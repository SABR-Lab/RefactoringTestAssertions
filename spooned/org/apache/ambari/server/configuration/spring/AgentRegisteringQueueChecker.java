...
public class AgentRegisteringQueueChecker extends org.springframework.messaging.support.ChannelInterceptorAdapter {
    ...
    public org.springframework.messaging.Message<?> preSend(org.springframework.messaging.Message<?> message, org.springframework.messaging.MessageChannel channel) {
        ...
        if (org.springframework.messaging.simp.SimpMessageType.CONNECT_ACK.equals(headerAccessor.getMessageType()) && (!agentsRegistrationQueue.offer(sessionId))) {
            org.springframework.messaging.simp.stomp.StompHeaderAccessor headerAccessorError = org.springframework.messaging.simp.stomp.StompHeaderAccessor.create(org.springframework.messaging.simp.stomp.StompCommand.ERROR);
        ...
        } else if (org.springframework.messaging.simp.SimpMessageType.DISCONNECT_ACK.equals(headerAccessor.getMessageType())) {
