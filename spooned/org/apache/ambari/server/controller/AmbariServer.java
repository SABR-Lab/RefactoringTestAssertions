...
public class AmbariServer {
    ...
    public void run() throws java.lang.Exception {
        ...
        try {
            ...
            org.eclipse.jetty.servlet.ServletHolder sh = new org.eclipse.jetty.servlet.ServletHolder(new org.glassfish.jersey.servlet.ServletContainer(new org.glassfish.jersey.server.ResourceConfig().packages("org.apache.ambari.server.api.rest", "org.apache.ambari.server.api.services", "org.apache.ambari.eventdb.webservice", "org.apache.ambari.server.api").register(org.glassfish.jersey.jackson.JacksonFeature.class)));
            ...
            org.eclipse.jetty.servlet.ServletHolder agent = new org.eclipse.jetty.servlet.ServletHolder(new org.glassfish.jersey.servlet.ServletContainer(new org.glassfish.jersey.server.ResourceConfig().packages("org.apache.ambari.server.agent.rest", "org.apache.ambari.server.api").register(org.glassfish.jersey.jackson.JacksonFeature.class)));
            ...
            org.eclipse.jetty.servlet.ServletHolder cert = new org.eclipse.jetty.servlet.ServletHolder(new org.glassfish.jersey.servlet.ServletContainer(new org.glassfish.jersey.server.ResourceConfig().packages("org.apache.ambari.server.security.unsecured.rest", "org.apache.ambari.server.api").register(org.glassfish.jersey.jackson.JacksonFeature.class)));
            ...
            if (configs.csrfProtectionEnabled()) {
                sh.setInitParameter("org.glassfish.jersey.server.ContainerRequestFilter", "org.apache.ambari.server.api.AmbariCsrfProtectionFilter");
            }
    ...
    private org.eclipse.jetty.server.ServerConnector createSelectChannelConnectorForAgent(org.eclipse.jetty.server.Server server, int port, boolean needClientAuth, int acceptors) {
        ...
        if (configs.getAgentSSLAuthentication()) {
            ...
            org.eclipse.jetty.server.ServerConnector agentSslConnector = new org.eclipse.jetty.server.ServerConnector(server, acceptors, -1, new org.eclipse.jetty.server.SslConnectionFactory(sslContextFactory, org.apache.http.HttpVersion.HTTP_1_1.toString()), new org.eclipse.jetty.server.HttpConnectionFactory(https_config));
    ...
    private org.eclipse.jetty.server.ServerConnector createSelectChannelConnectorForClient(org.eclipse.jetty.server.Server server, int acceptors) {
        ...
        if (configs.getApiSSLAuthentication()) {
            ...
            apiConnector = new org.eclipse.jetty.server.ServerConnector(server, acceptors, -1, new org.eclipse.jetty.server.SslConnectionFactory(contextFactoryApi, org.apache.http.HttpVersion.HTTP_1_1.toString()), new org.eclipse.jetty.server.HttpConnectionFactory(https_config));
