...
public class AmbariServerTest {
    ...
    public void testConfigureSessionManager() throws java.lang.Exception {
        ...
        org.easymock.EasyMock.expect(configuration.getApiSSLAuthentication()).andReturn(false);
        sessionCookieConfig.setHttpOnly(true);
        org.easymock.EasyMock.expect(configuration.getApiSSLAuthentication()).andReturn(true);
        sessionCookieConfig.setHttpOnly(true);
        sessionCookieConfig.setSecure(true);
        org.easymock.EasyMock.replay(configuration, sessionHandler, sessionCookieConfig);
        sessionHandlerConfigurer.configureSessionHandler(sessionHandler);
        sessionHandlerConfigurer.configureSessionHandler(sessionHandler);
        org.easymock.EasyMock.verify(configuration, sessionHandler, sessionCookieConfig);
    }

    @org.junit.Test
    public void testSystemProperties() throws java.lang.Exception {
        org.apache.ambari.server.configuration.Configuration configuration = org.easymock.EasyMock.createNiceMock(org.apache.ambari.server.configuration.Configuration.class);
        org.easymock.EasyMock.expect(configuration.getServerTempDir()).andReturn("/ambari/server/temp/dir").anyTimes();
    ...
    public void testConfigureRootHandler() throws java.lang.Exception {
        ...
        org.easymock.EasyMock.replay(handler, filter);
    ...
    public void testConfigureCompression() throws java.lang.Exception {
        ...
        final org.eclipse.jetty.servlet.FilterHolder filter = org.easymock.EasyMock.createNiceMock(org.eclipse.jetty.servlet.FilterHolder.class);
        org.easymock.EasyMock.expect(handler.addFilter(org.eclipse.jetty.servlets.GzipFilter.class, "/*", java.util.EnumSet.of(javax.servlet.DispatcherType.REQUEST))).andReturn(filter).once();
        filter.setInitParameter(org.easymock.EasyMock.anyObject(java.lang.String.class), org.easymock.EasyMock.anyObject(java.lang.String.class));
    ...
    public void testConfigureContentTypes() throws java.lang.Exception {
        ...
        org.easymock.EasyMock.expect(handler.addFilter(org.easymock.EasyMock.isA(java.lang.Class.class), org.easymock.EasyMock.anyString(), org.easymock.EasyMock.isA(java.util.EnumSet.class))).andReturn(filter).anyTimes();
        org.easymock.EasyMock.replay(handler, filter);
        injector.getInstance(org.apache.ambari.server.controller.AmbariServer.class).configureRootHandler(handler);
    ...
    public void testRunDatabaseConsistencyCheck() throws java.lang.Exception {
        ...
        org.apache.ambari.server.controller.AmbariServer ambariServer = new org.apache.ambari.server.controller.AmbariServer();
        final org.apache.ambari.server.configuration.Configuration mockConfiguration = org.easymock.EasyMock.partialMockBuilder(org.apache.ambari.server.configuration.Configuration.class).withConstructor().addMockedMethod("getDatabaseType").createMock();
        final javax.persistence.TypedQuery mockQuery = easyMockSupport.createNiceMock(javax.persistence.TypedQuery.class);
        org.easymock.EasyMock.expect(mockConfiguration.getDatabaseType()).andReturn(null).anyTimes();
        org.easymock.EasyMock.expect(mockEntityManager.createNamedQuery(org.easymock.EasyMock.anyString(), org.easymock.EasyMock.anyObject(java.lang.Class.class))).andReturn(mockQuery);
        org.easymock.EasyMock.expect(mockQuery.getResultList()).andReturn(new java.util.ArrayList());
        org.easymock.EasyMock.replay(mockConfiguration);
        ...
        org.easymock.EasyMock.expect(mockDBDbAccessor.getConnection()).andReturn(mockConnection).atLeastOnce();
        org.easymock.EasyMock.expect(mockConnection.createStatement(java.sql.ResultSet.TYPE_SCROLL_SENSITIVE, java.sql.ResultSet.CONCUR_UPDATABLE)).andReturn(mockStatement).atLeastOnce();
        org.easymock.EasyMock.expect(mockStatement.executeQuery(org.easymock.EasyMock.anyString())).andReturn(null).atLeastOnce();
    ...
    public void testRunDatabaseConsistencyCheck_ThrowException() throws java.lang.Exception {
        ...
        org.easymock.EasyMock.replay(mockConfiguration);
        final com.google.inject.Injector mockInjector = createMockInjector(mockAmbariMetainfo, mockDBDbAccessor, mockOSFamily, mockEntityManager, mockClusters, mockConfiguration);
        org.easymock.EasyMock.expect(mockDBDbAccessor.getConnection()).andReturn(null);
        org.apache.ambari.server.checks.DatabaseConsistencyCheckHelper.setInjector(mockInjector);
        easyMockSupport.replayAll();
        mockAmbariMetainfo.init();
