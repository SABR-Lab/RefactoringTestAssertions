...
public class BackgroundCustomCommandExecutionTest {
    ...
    public void testRebalanceHdfsCustomCommand() {
        try {
            ...
            org.mockito.Mockito.verify(am, org.mockito.Mockito.times(1)).sendActions(requestCapture.capture(), org.mockito.Matchers.any(org.apache.ambari.server.controller.ExecuteActionRequest.class));
