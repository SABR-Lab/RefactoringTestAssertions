...
public class ControllerModule extends com.google.inject.AbstractModule {
    ...
    public static java.util.Properties getPersistenceProperties(org.apache.ambari.server.configuration.Configuration configuration) {
        ...
        switch (configuration.getPersistenceType()) {
            case IN_MEMORY :
                properties.setProperty(org.eclipse.persistence.config.PersistenceUnitProperties.JDBC_URL, org.apache.ambari.server.configuration.Configuration.JDBC_IN_MEMORY_URL);
                properties.setProperty(org.eclipse.persistence.config.PersistenceUnitProperties.JDBC_DRIVER, org.apache.ambari.server.configuration.Configuration.JDBC_IN_MEMORY_DRIVER);
                properties.setProperty(org.eclipse.persistence.config.PersistenceUnitProperties.JDBC_USER, org.apache.ambari.server.configuration.Configuration.JDBC_IN_MEMORY_USER);
                properties.setProperty(org.eclipse.persistence.config.PersistenceUnitProperties.JDBC_PASSWORD, org.apache.ambari.server.configuration.Configuration.JDBC_IN_MEMORY_PASSWORD);
                properties.setProperty(org.eclipse.persistence.config.PersistenceUnitProperties.DDL_GENERATION, org.eclipse.persistence.config.PersistenceUnitProperties.CREATE_ONLY);
                properties.setProperty(org.eclipse.persistence.config.PersistenceUnitProperties.THROW_EXCEPTIONS, "true");
                break;
            case REMOTE :
                properties.setProperty(org.eclipse.persistence.config.PersistenceUnitProperties.JDBC_URL, configuration.getDatabaseUrl());
                properties.setProperty(org.eclipse.persistence.config.PersistenceUnitProperties.JDBC_DRIVER, configuration.getDatabaseDriver());
                break;
            case LOCAL :
                properties.setProperty(org.eclipse.persistence.config.PersistenceUnitProperties.JDBC_URL, configuration.getLocalDatabaseUrl());
                properties.setProperty(org.eclipse.persistence.config.PersistenceUnitProperties.JDBC_DRIVER, org.apache.ambari.server.configuration.Configuration.SERVER_JDBC_DRIVER.getDefaultValue());
                break;
        }
        ...
        if (isConnectionPoolingExternal) {
            ...
            properties.put(org.eclipse.persistence.config.PersistenceUnitProperties.NON_JTA_DATASOURCE, dataSource);
        }
        return properties;
    }
    ...
    private com.google.inject.persist.PersistModule buildJpaPersistModule() {
        ...
        if (!persistenceType.equals(org.apache.ambari.server.orm.PersistenceType.IN_MEMORY)) {
            persistenceProperties.setProperty(org.eclipse.persistence.config.PersistenceUnitProperties.JDBC_USER, configuration.getDatabaseUser());
            persistenceProperties.setProperty(org.eclipse.persistence.config.PersistenceUnitProperties.JDBC_PASSWORD, configuration.getDatabasePassword());
            switch (configuration.getJPATableGenerationStrategy()) {
                case CREATE :
                    persistenceProperties.setProperty(org.eclipse.persistence.config.PersistenceUnitProperties.DDL_GENERATION, org.eclipse.persistence.config.PersistenceUnitProperties.CREATE_ONLY);
                    dbInitNeeded = true;
                    break;
                case DROP_AND_CREATE :
                    persistenceProperties.setProperty(org.eclipse.persistence.config.PersistenceUnitProperties.DDL_GENERATION, org.eclipse.persistence.config.PersistenceUnitProperties.DROP_AND_CREATE);
                    dbInitNeeded = true;
                    break;
                case CREATE_OR_EXTEND :
                    persistenceProperties.setProperty(org.eclipse.persistence.config.PersistenceUnitProperties.DDL_GENERATION, org.eclipse.persistence.config.PersistenceUnitProperties.CREATE_OR_EXTEND);
                    break;
                default :
                    break;
            }
            persistenceProperties.setProperty(org.eclipse.persistence.config.PersistenceUnitProperties.DDL_GENERATION_MODE, org.eclipse.persistence.config.PersistenceUnitProperties.DDL_BOTH_GENERATION);
            persistenceProperties.setProperty(org.eclipse.persistence.config.PersistenceUnitProperties.CREATE_JDBC_DDL_FILE, "DDL-create.jdbc");
            persistenceProperties.setProperty(org.eclipse.persistence.config.PersistenceUnitProperties.DROP_JDBC_DDL_FILE, "DDL-drop.jdbc");
        }
