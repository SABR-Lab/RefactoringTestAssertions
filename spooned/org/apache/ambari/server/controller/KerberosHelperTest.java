...
public class KerberosHelperTest extends org.easymock.EasyMockSupport {
    ...
    public void setUp() throws java.lang.Exception {
        org.easymock.EasyMock.reset(clusterController);
        org.easymock.EasyMock.reset(metaInfo);
        ...
        org.easymock.EasyMock.expect(kerberosOperationHandlerFactory.getKerberosOperationHandler(org.apache.ambari.server.serveraction.kerberos.KDCType.NONE)).andReturn(null).anyTimes();
        org.easymock.EasyMock.expect(kerberosOperationHandlerFactory.getKerberosOperationHandler(org.apache.ambari.server.serveraction.kerberos.KDCType.MIT_KDC)).andReturn(new org.apache.ambari.server.serveraction.kerberos.KerberosOperationHandler() {
            @java.lang.Override
        ...
        org.easymock.EasyMock.expect(kerberosHelper.getConfiguredTemporaryDirectory()).andReturn(temporaryFolder.getRoot()).anyTimes();
        ...
        org.easymock.EasyMock.expect(topologyManager.getPendingHostComponents()).andReturn(java.util.Collections.emptyMap()).anyTimes();
        org.apache.ambari.server.utils.StageUtils.setConfiguration(configuration);
        org.easymock.EasyMock.expect(configuration.getApiSSLAuthentication()).andReturn(false).anyTimes();
        org.easymock.EasyMock.expect(configuration.getClientApiPort()).andReturn(8080).anyTimes();
        org.easymock.EasyMock.expect(configuration.getServerTempDir()).andReturn(temporaryFolder.getRoot().getAbsolutePath()).anyTimes();
    ...
    public void testMissingKrb5Conf() throws java.lang.Exception {
        ...
        org.easymock.EasyMock.expect(kerberosEnvProperties.get("ldap_url")).andReturn("").once();
        org.easymock.EasyMock.expect(kerberosEnvProperties.get("container_dn")).andReturn("").once();
        final org.apache.ambari.server.state.Config kerberosEnvConfig = createMock(org.apache.ambari.server.state.Config.class);
        org.easymock.EasyMock.expect(kerberosEnvConfig.getProperties()).andReturn(kerberosEnvProperties).once();
        final org.apache.ambari.server.state.Cluster cluster = createNiceMock(org.apache.ambari.server.state.Cluster.class);
        org.easymock.EasyMock.expect(cluster.getDesiredConfigByType("kerberos-env")).andReturn(kerberosEnvConfig).once();
        replayAll();
    ...
    public void testMissingKerberosEnvConf() throws java.lang.Exception {
        org.apache.ambari.server.controller.KerberosHelper kerberosHelper = org.apache.ambari.server.controller.KerberosHelperTest.injector.getInstance(org.apache.ambari.server.controller.KerberosHelper.class);
        final java.util.Map<java.lang.String, java.lang.String> kerberosEnvProperties = createMock(java.util.Map.class);
        org.easymock.EasyMock.expect(kerberosEnvProperties.get(org.apache.ambari.server.controller.KerberosHelper.DEFAULT_REALM)).andReturn("EXAMPLE.COM").once();
        org.easymock.EasyMock.expect(kerberosEnvProperties.get("kdc_hosts")).andReturn("10.0.100.1").once();
        final java.util.Map<java.lang.String, java.lang.String> krb5ConfProperties = createMock(java.util.Map.class);
        org.easymock.EasyMock.expect(krb5ConfProperties.get("kadmin_host")).andReturn("10.0.100.1").once();
        final org.apache.ambari.server.state.Config krb5ConfConfig = createMock(org.apache.ambari.server.state.Config.class);
        org.easymock.EasyMock.expect(krb5ConfConfig.getProperties()).andReturn(krb5ConfProperties).once();
        final org.apache.ambari.server.state.Cluster cluster = createNiceMock(org.apache.ambari.server.state.Cluster.class);
        org.easymock.EasyMock.expect(cluster.getDesiredConfigByType("krb5-conf")).andReturn(krb5ConfConfig).once();
        replayAll();
        kerberosHelper.toggleKerberos(cluster, org.apache.ambari.server.state.SecurityType.KERBEROS, null, true);
        verifyAll();
    }
    ...
    public void testRegenerateKeytabsWithRetryAllowed() throws java.lang.Exception {
        ...
        customCommandExecutionHelperMock.addExecutionCommandsToStage(org.easymock.EasyMock.capture(captureContext), org.easymock.EasyMock.anyObject(org.apache.ambari.server.actionmanager.Stage.class), org.easymock.EasyMock.anyObject(), org.easymock.EasyMock.eq(null));
    ...
    private void testEnableKerberos(final org.apache.ambari.server.security.credential.PrincipalKeyCredential PrincipalKeyCredential, java.lang.String kdcType, java.lang.String manageIdentities) throws java.lang.Exception {
        ...
        org.easymock.EasyMock.expect(schKerberosClient.getServiceName()).andReturn(org.apache.ambari.server.state.Service.Type.KERBEROS.name()).anyTimes();
        org.easymock.EasyMock.expect(schKerberosClient.getServiceComponentName()).andReturn(org.apache.ambari.server.Role.KERBEROS_CLIENT.name()).anyTimes();
        org.easymock.EasyMock.expect(schKerberosClient.getHostName()).andReturn("host1").anyTimes();
        org.easymock.EasyMock.expect(schKerberosClient.getState()).andReturn(org.apache.ambari.server.state.State.INSTALLED).anyTimes();
        ...
        org.easymock.EasyMock.expect(sch1.getServiceName()).andReturn("SERVICE1").anyTimes();
        org.easymock.EasyMock.expect(sch1.getServiceComponentName()).andReturn("COMPONENT1").anyTimes();
        org.easymock.EasyMock.expect(sch1.getHostName()).andReturn("host1").anyTimes();
        org.easymock.EasyMock.expect(sch1.getState()).andReturn(org.apache.ambari.server.state.State.INSTALLED).anyTimes();
        ...
        org.easymock.EasyMock.expect(sch2.getServiceName()).andReturn("SERVICE2").anyTimes();
        org.easymock.EasyMock.expect(sch2.getServiceComponentName()).andReturn("COMPONENT2").anyTimes();
        org.easymock.EasyMock.expect(sch2.getHostName()).andReturn("host1").anyTimes();
        org.easymock.EasyMock.expect(sch2.getState()).andReturn(org.apache.ambari.server.state.State.INSTALLED).anyTimes();
        ...
        org.easymock.EasyMock.expect(serviceComponentKerberosClient.getName()).andReturn(org.apache.ambari.server.Role.KERBEROS_CLIENT.name()).anyTimes();
        org.easymock.EasyMock.expect(serviceComponentKerberosClient.getServiceComponentHosts()).andReturn(java.util.Collections.singletonMap("host1", schKerberosClient)).anyTimes();
        final org.apache.ambari.server.state.Service serviceKerberos = createNiceMock(org.apache.ambari.server.state.Service.class);
        org.easymock.EasyMock.expect(serviceKerberos.getDesiredStackId()).andReturn(stackId).anyTimes();
        org.easymock.EasyMock.expect(serviceKerberos.getName()).andReturn(org.apache.ambari.server.state.Service.Type.KERBEROS.name()).anyTimes();
        org.easymock.EasyMock.expect(serviceKerberos.getServiceComponents()).andReturn(java.util.Collections.singletonMap(org.apache.ambari.server.Role.KERBEROS_CLIENT.name(), serviceComponentKerberosClient)).anyTimes();
        final org.apache.ambari.server.state.Service service1 = createNiceMock(org.apache.ambari.server.state.Service.class);
        org.easymock.EasyMock.expect(service1.getDesiredStackId()).andReturn(stackId).anyTimes();
        org.easymock.EasyMock.expect(service1.getName()).andReturn("SERVICE1").anyTimes();
        org.easymock.EasyMock.expect(service1.getServiceComponents()).andReturn(java.util.Collections.emptyMap()).anyTimes();
        final org.apache.ambari.server.state.Service service2 = createNiceMock(org.apache.ambari.server.state.Service.class);
        org.easymock.EasyMock.expect(service2.getName()).andReturn("SERVICE2").anyTimes();
        org.easymock.EasyMock.expect(service2.getDesiredStackId()).andReturn(stackId).anyTimes();
        org.easymock.EasyMock.expect(service2.getServiceComponents()).andReturn(java.util.Collections.emptyMap()).anyTimes();
        final java.util.Map<java.lang.String, java.lang.String> kerberosEnvProperties = createMock(java.util.Map.class);
        org.easymock.EasyMock.expect(kerberosEnvProperties.get(org.apache.ambari.server.controller.KerberosHelper.KDC_TYPE)).andReturn(kdcType).anyTimes();
        org.easymock.EasyMock.expect(kerberosEnvProperties.get(org.apache.ambari.server.controller.KerberosHelper.MANAGE_IDENTITIES)).andReturn(manageIdentities).anyTimes();
        org.easymock.EasyMock.expect(kerberosEnvProperties.get(org.apache.ambari.server.controller.KerberosHelper.DEFAULT_REALM)).andReturn("FOOBAR.COM").anyTimes();
        org.easymock.EasyMock.expect(kerberosEnvProperties.get(org.apache.ambari.server.controller.KerberosHelper.CREATE_AMBARI_PRINCIPAL)).andReturn("false").anyTimes();
        org.easymock.EasyMock.expect(kerberosEnvProperties.get(org.apache.ambari.server.controller.KerberosHelper.PRECONFIGURE_SERVICES)).andReturn(org.apache.ambari.server.serveraction.kerberos.PreconfigureServiceType.DEFAULT.name()).anyTimes();
        final org.apache.ambari.server.state.Config kerberosEnvConfig = createMock(org.apache.ambari.server.state.Config.class);
        org.easymock.EasyMock.expect(kerberosEnvConfig.getProperties()).andReturn(kerberosEnvProperties).anyTimes();
        final java.util.Map<java.lang.String, java.lang.String> krb5ConfProperties = createMock(java.util.Map.class);
        final org.apache.ambari.server.state.Config krb5ConfConfig = createMock(org.apache.ambari.server.state.Config.class);
        org.easymock.EasyMock.expect(krb5ConfConfig.getProperties()).andReturn(krb5ConfProperties).anyTimes();
        ...
        org.easymock.EasyMock.expect(cluster.getDesiredStackVersion()).andReturn(new org.apache.ambari.server.state.StackId("HDP-2.2")).anyTimes();
        ...
        org.easymock.EasyMock.expect(cluster.getServiceComponentHosts("host1")).andReturn(new java.util.ArrayList<org.apache.ambari.server.state.ServiceComponentHost>() {
            {
        ...
        org.easymock.EasyMock.expect(cluster.getServiceComponentHosts("KERBEROS", "KERBEROS_CLIENT")).andReturn(java.util.Collections.singletonList(schKerberosClient)).once();
        if (identitiesManaged) {
            ...
            org.easymock.EasyMock.expect(clusters.getHost("host1")).andReturn(host).once();
        }
        ...
        org.easymock.EasyMock.expect(ambariManagementController.findConfigurationTagsWithOverrides(cluster, null, null)).andReturn(java.util.Collections.emptyMap()).once();
        org.easymock.EasyMock.expect(ambariManagementController.getRoleCommandOrder(cluster)).andReturn(createMock(org.apache.ambari.server.metadata.RoleCommandOrder.class)).once();
        ...
        org.easymock.EasyMock.expect(kerberosDescriptor.getService("KERBEROS")).andReturn(null).once();
        org.easymock.EasyMock.expect(kerberosDescriptor.getService("SERVICE1")).andReturn(serviceDescriptor1).once();
        org.easymock.EasyMock.expect(kerberosDescriptor.getService("SERVICE2")).andReturn(serviceDescriptor2).once();
        ...
        org.easymock.EasyMock.expect(requestStageContainer.getLastStageId()).andReturn(-1L).anyTimes();
        org.easymock.EasyMock.expect(requestStageContainer.getId()).andReturn(1L).once();
        requestStageContainer.addStages(org.easymock.EasyMock.anyObject(java.util.List.class));
        ...
        if (identitiesManaged) {
            ...
            requestStageContainer.addStages(org.easymock.EasyMock.anyObject(java.util.List.class));
            org.easymock.EasyMock.expectLastCall().once();
            org.easymock.EasyMock.expect(requestStageContainer.getLastStageId()).andReturn(0L).anyTimes();
            org.easymock.EasyMock.expect(requestStageContainer.getId()).andReturn(1L).once();
            requestStageContainer.addStages(org.easymock.EasyMock.anyObject(java.util.List.class));
            org.easymock.EasyMock.expectLastCall().once();
            org.easymock.EasyMock.expect(requestStageContainer.getLastStageId()).andReturn(1L).anyTimes();
        ...
        org.easymock.EasyMock.expect(requestStageContainer.getLastStageId()).andReturn(2L).anyTimes();
        org.easymock.EasyMock.expect(requestStageContainer.getId()).andReturn(1L).once();
        requestStageContainer.addStages(org.easymock.EasyMock.anyObject(java.util.List.class));
        org.easymock.EasyMock.expectLastCall().once();
        org.easymock.EasyMock.expect(requestStageContainer.getLastStageId()).andReturn(3L).anyTimes();
        org.easymock.EasyMock.expect(requestStageContainer.getId()).andReturn(1L).once();
        requestStageContainer.addStages(org.easymock.EasyMock.anyObject(java.util.List.class));
        org.easymock.EasyMock.expectLastCall().once();
        replayAll();
    ...
    private void testDisableKerberos(final org.apache.ambari.server.security.credential.PrincipalKeyCredential PrincipalKeyCredential) throws java.lang.Exception {
        ...
        org.easymock.EasyMock.expect(schKerberosClient.getState()).andReturn(org.apache.ambari.server.state.State.INSTALLED).anyTimes();
        final org.apache.ambari.server.state.ServiceComponentHost sch1 = createMock(org.apache.ambari.server.state.ServiceComponentHost.class);
        org.easymock.EasyMock.expect(sch1.getServiceName()).andReturn("SERVICE1").times(1);
        org.easymock.EasyMock.expect(sch1.getHostName()).andReturn("host1").anyTimes();
        org.easymock.EasyMock.expect(sch1.getState()).andReturn(org.apache.ambari.server.state.State.INSTALLED).anyTimes();
        final org.apache.ambari.server.state.ServiceComponentHost sch2 = createMock(org.apache.ambari.server.state.ServiceComponentHost.class);
        org.easymock.EasyMock.expect(sch2.getServiceName()).andReturn("SERVICE2").times(1);
        org.easymock.EasyMock.expect(sch2.getHostName()).andReturn("host1").anyTimes();
        org.easymock.EasyMock.expect(sch2.getState()).andReturn(org.apache.ambari.server.state.State.INSTALLED).anyTimes();
        final org.apache.ambari.server.state.Host host = createMockHost("host1");
        final org.apache.ambari.server.state.ServiceComponent serviceComponentKerberosClient = createNiceMock(org.apache.ambari.server.state.ServiceComponent.class);
        ...
        org.easymock.EasyMock.expect(serviceComponentKerberosClient.getServiceComponentHosts()).andReturn(java.util.Collections.singletonMap("host1", schKerberosClient)).anyTimes();
        final org.apache.ambari.server.state.Service serviceKerberos = createNiceMock(org.apache.ambari.server.state.Service.class);
        org.easymock.EasyMock.expect(serviceKerberos.getDesiredStackId()).andReturn(new org.apache.ambari.server.state.StackId("HDP-2.2")).anyTimes();
        org.easymock.EasyMock.expect(serviceKerberos.getName()).andReturn(org.apache.ambari.server.state.Service.Type.KERBEROS.name()).anyTimes();
        org.easymock.EasyMock.expect(serviceKerberos.getServiceComponents()).andReturn(java.util.Collections.singletonMap(org.apache.ambari.server.Role.KERBEROS_CLIENT.name(), serviceComponentKerberosClient)).anyTimes();
        final org.apache.ambari.server.state.Service service1 = createNiceMock(org.apache.ambari.server.state.Service.class);
        org.easymock.EasyMock.expect(service1.getDesiredStackId()).andReturn(new org.apache.ambari.server.state.StackId("HDP-2.2")).anyTimes();
        org.easymock.EasyMock.expect(service1.getName()).andReturn("SERVICE1").anyTimes();
        org.easymock.EasyMock.expect(service1.getServiceComponents()).andReturn(java.util.Collections.emptyMap()).anyTimes();
        final org.apache.ambari.server.state.Service service2 = createNiceMock(org.apache.ambari.server.state.Service.class);
        org.easymock.EasyMock.expect(service2.getDesiredStackId()).andReturn(new org.apache.ambari.server.state.StackId("HDP-2.2")).anyTimes();
        org.easymock.EasyMock.expect(service2.getName()).andReturn("SERVICE2").anyTimes();
        org.easymock.EasyMock.expect(service2.getServiceComponents()).andReturn(java.util.Collections.emptyMap()).anyTimes();
        final java.util.Map<java.lang.String, java.lang.String> kerberosEnvProperties = createMock(java.util.Map.class);
        org.easymock.EasyMock.expect(kerberosEnvProperties.get(org.apache.ambari.server.controller.KerberosHelper.KDC_TYPE)).andReturn("mit-kdc").anyTimes();
        org.easymock.EasyMock.expect(kerberosEnvProperties.get(org.apache.ambari.server.controller.KerberosHelper.DEFAULT_REALM)).andReturn("FOOBAR.COM").anyTimes();
        final org.apache.ambari.server.state.Config kerberosEnvConfig = createMock(org.apache.ambari.server.state.Config.class);
        org.easymock.EasyMock.expect(kerberosEnvConfig.getProperties()).andReturn(kerberosEnvProperties).anyTimes();
        final java.util.Map<java.lang.String, java.lang.String> krb5ConfProperties = createMock(java.util.Map.class);
        ...
        final org.apache.ambari.server.state.kerberos.KerberosServiceDescriptor serviceDescriptor2 = createMock(org.apache.ambari.server.state.kerberos.KerberosServiceDescriptor.class);
        final org.apache.ambari.server.state.kerberos.KerberosDescriptor kerberosDescriptor = createMock(org.apache.ambari.server.state.kerberos.KerberosDescriptor.class);
        org.easymock.EasyMock.expect(kerberosDescriptor.getService("KERBEROS")).andReturn(null).atLeastOnce();
        org.easymock.EasyMock.expect(kerberosDescriptor.getService("SERVICE1")).andReturn(serviceDescriptor1).atLeastOnce();
        org.easymock.EasyMock.expect(kerberosDescriptor.getService("SERVICE2")).andReturn(serviceDescriptor2).atLeastOnce();
        setupKerberosDescriptor(kerberosDescriptor);
        setupStageFactory();
        final org.apache.ambari.server.controller.internal.RequestStageContainer requestStageContainer = createStrictMock(org.apache.ambari.server.controller.internal.RequestStageContainer.class);
        org.easymock.EasyMock.expect(cluster.getService("ZOOKEEPER")).andReturn(service1).anyTimes();
        org.easymock.EasyMock.expect(requestStageContainer.getLastStageId()).andReturn(2L).anyTimes();
        org.easymock.EasyMock.expect(requestStageContainer.getId()).andReturn(1L).once();
        requestStageContainer.addStages(org.easymock.EasyMock.anyObject(java.util.List.class));
        org.easymock.EasyMock.expectLastCall().once();
    ...
    private org.apache.ambari.server.controller.internal.RequestStageContainer testRegenerateKeytabs(final org.apache.ambari.server.security.credential.PrincipalKeyCredential PrincipalKeyCredential, java.util.Map<java.lang.String, java.lang.String> requestMap, boolean mockRequestStageContainer, final boolean testInvalidHost) throws java.lang.Exception {
        ...
        if (testInvalidHost) {
            ...
            org.easymock.EasyMock.expect(schKerberosClientInvalid.getServiceName()).andReturn(org.apache.ambari.server.state.Service.Type.KERBEROS.name()).anyTimes();
            org.easymock.EasyMock.expect(schKerberosClientInvalid.getServiceComponentName()).andReturn(org.apache.ambari.server.Role.KERBEROS_CLIENT.name()).anyTimes();
            org.easymock.EasyMock.expect(schKerberosClientInvalid.getHostName()).andReturn("host2").anyTimes();
            org.easymock.EasyMock.expect(schKerberosClientInvalid.getState()).andReturn(org.apache.ambari.server.state.State.INIT).anyTimes();
            sch1a = createMock(org.apache.ambari.server.state.ServiceComponentHost.class);
            org.easymock.EasyMock.expect(sch1a.getServiceName()).andReturn("SERVICE1").anyTimes();
            org.easymock.EasyMock.expect(sch1a.getServiceComponentName()).andReturn("COMPONENT1").anyTimes();
            org.easymock.EasyMock.expect(sch1a.getHostName()).andReturn("host2").anyTimes();
        ...
        org.easymock.EasyMock.expect(serviceComponentKerberosClient.getServiceComponentHosts()).andReturn(map).anyTimes();
    ...
    public void testIsClusterKerberosEnabled_false() throws java.lang.Exception {
        ...
        org.easymock.EasyMock.expect(cluster.getSecurityType()).andReturn(org.apache.ambari.server.state.SecurityType.NONE);
    ...
    public void testIsClusterKerberosEnabled_true() throws java.lang.Exception {
        org.apache.ambari.server.controller.KerberosHelper kerberosHelper = org.apache.ambari.server.controller.KerberosHelperTest.injector.getInstance(org.apache.ambari.server.controller.KerberosHelper.class);
        org.apache.ambari.server.state.Cluster cluster = createStrictMock(org.apache.ambari.server.state.Cluster.class);
        org.easymock.EasyMock.expect(cluster.getSecurityType()).andReturn(org.apache.ambari.server.state.SecurityType.KERBEROS);
        org.easymock.EasyMock.replay(cluster);
    ...
    private void testSetAuthToLocalRules(boolean includePreconfiguredServices) throws java.lang.Exception {
        ...
        org.easymock.EasyMock.expect(principalDescriptor1.getValue()).andReturn("principal1/host1@EXAMPLE.COM").times(1);
        org.easymock.EasyMock.expect(principalDescriptor1.getLocalUsername()).andReturn("principal1_user").times(1);
        ...
        org.easymock.EasyMock.expect(principalDescriptor2.getValue()).andReturn("principal2/host2@EXAMPLE.COM").times(1);
        org.easymock.EasyMock.expect(principalDescriptor2.getLocalUsername()).andReturn("principal2_user").times(1);
        ...
        org.easymock.EasyMock.expect(principalDescriptor3.getValue()).andReturn("principal3/host3@EXAMPLE.COM").times(1);
        org.easymock.EasyMock.expect(principalDescriptor3.getLocalUsername()).andReturn("principal3_user").times(1);
        ...
        org.easymock.EasyMock.expect(identityDescriptor1.getPrincipalDescriptor()).andReturn(principalDescriptor1).times(1);
        org.easymock.EasyMock.expect(identityDescriptor1.shouldInclude(org.easymock.EasyMock.anyObject())).andReturn(true).anyTimes();
        ...
        org.easymock.EasyMock.expect(identityDescriptor2.getPrincipalDescriptor()).andReturn(principalDescriptor2).times(1);
        org.easymock.EasyMock.expect(identityDescriptor2.shouldInclude(org.easymock.EasyMock.anyObject())).andReturn(true).anyTimes();
        ...
        org.easymock.EasyMock.expect(identityDescriptor3.getPrincipalDescriptor()).andReturn(principalDescriptor3).times(1);
        org.easymock.EasyMock.expect(identityDescriptor3.shouldInclude(org.easymock.EasyMock.anyObject())).andReturn(true).anyTimes();
        ...
        final org.apache.ambari.server.state.kerberos.KerberosServiceDescriptor serviceDescriptor1 = createMock(org.apache.ambari.server.state.kerberos.KerberosServiceDescriptor.class);
        org.easymock.EasyMock.expect(serviceDescriptor1.getName()).andReturn("SERVICE1").times(includePreconfiguredServices ? 2 : 1);
        if (includePreconfiguredServices) {
            org.easymock.EasyMock.expect(serviceDescriptor1.shouldPreconfigure()).andReturn(false).times(2);
        }
        org.easymock.EasyMock.expect(serviceDescriptor1.getIdentities(org.easymock.EasyMock.eq(true), org.easymock.EasyMock.anyObject())).andReturn(java.util.Arrays.asList(identityDescriptor1, identityDescriptor2)).times(1);
        org.easymock.EasyMock.expect(serviceDescriptor1.getComponents()).andReturn(java.util.Collections.singletonMap("COMPONENT1", componentDescriptor1)).times(1);
        org.easymock.EasyMock.expect(serviceDescriptor1.getAuthToLocalProperties()).andReturn(new java.util.HashSet<>(java.util.Arrays.asList("default", "explicit_multiple_lines|new_lines", "explicit_multiple_lines_escaped|new_lines_escaped", "explicit_single_line|spaces", "service-site/default", "service-site/explicit_multiple_lines|new_lines", "service-site/explicit_multiple_lines_escaped|new_lines_escaped", "service-site/explicit_single_line|spaces"))).times(1);
        ...
        if (includePreconfiguredServices) {
            ...
            org.easymock.EasyMock.expect(principalDescriptor4.getValue()).andReturn("${preconfig-site/service_user}/_HOST@EXAMPLE.COM").times(1);
            org.easymock.EasyMock.expect(principalDescriptor4.getLocalUsername()).andReturn("principal4_user").times(1);
            ...
            org.easymock.EasyMock.expect(principalDescriptor5.getValue()).andReturn("${preconfig-site/component_property1}/_HOST@EXAMPLE.COM").times(1);
            org.easymock.EasyMock.expect(principalDescriptor5.getLocalUsername()).andReturn("principal5_user").times(1);
            ...
            org.easymock.EasyMock.expect(identityDescriptor4.getPrincipalDescriptor()).andReturn(principalDescriptor4).times(1);
            org.easymock.EasyMock.expect(identityDescriptor4.shouldInclude(org.easymock.EasyMock.anyObject(java.util.Map.class))).andReturn(true).anyTimes();
            ...
            org.easymock.EasyMock.expect(identityDescriptor5.getPrincipalDescriptor()).andReturn(principalDescriptor5).times(1);
            org.easymock.EasyMock.expect(identityDescriptor5.shouldInclude(org.easymock.EasyMock.anyObject(java.util.Map.class))).andReturn(true).anyTimes();
            ...
            final org.apache.ambari.server.state.kerberos.KerberosServiceDescriptor serviceDescriptor2 = createMock(org.apache.ambari.server.state.kerberos.KerberosServiceDescriptor.class);
            org.easymock.EasyMock.expect(serviceDescriptor2.getName()).andReturn("PRECONFIGURE_SERVICE").times(2);
            org.easymock.EasyMock.expect(serviceDescriptor2.shouldPreconfigure()).andReturn(true).times(2);
            org.easymock.EasyMock.expect(serviceDescriptor2.getIdentities(org.easymock.EasyMock.eq(true), org.easymock.EasyMock.anyObject(java.util.Map.class))).andReturn(java.util.Collections.singletonList(identityDescriptor4)).times(1);
            org.easymock.EasyMock.expect(serviceDescriptor2.getComponents()).andReturn(java.util.Collections.singletonMap("PRECONFIGURE_SERVICE_MASTER", componentDescriptor2)).times(1);
            org.easymock.EasyMock.expect(serviceDescriptor2.getAuthToLocalProperties()).andReturn(java.util.Collections.<java.lang.String>emptySet()).times(1);
            ...
            org.easymock.EasyMock.expect(preconfigureServiceInfo.getProperties()).andReturn(preconfigureServiceProperties).anyTimes();
            org.easymock.EasyMock.expect(preconfigureServiceInfo.getComponents()).andReturn(java.util.Collections.singletonList(preconfigureComponentInfo)).anyTimes();
            ...
            org.easymock.EasyMock.expect(ambariMetaInfo.isValidService("HDP", "2.2", "PRECONFIGURE_SERVICE")).andReturn(true).anyTimes();
            org.easymock.EasyMock.expect(ambariMetaInfo.getService("HDP", "2.2", "PRECONFIGURE_SERVICE")).andReturn(preconfigureServiceInfo).anyTimes();
        }
        final org.apache.ambari.server.state.kerberos.KerberosDescriptor kerberosDescriptor = createMock(org.apache.ambari.server.state.kerberos.KerberosDescriptor.class);
        org.easymock.EasyMock.expect(kerberosDescriptor.getProperty("additional_realms")).andReturn(null).times(1);
        org.easymock.EasyMock.expect(kerberosDescriptor.getIdentities(org.easymock.EasyMock.eq(true), org.easymock.EasyMock.anyObject())).andReturn(null).times(1);
        org.easymock.EasyMock.expect(kerberosDescriptor.getAuthToLocalProperties()).andReturn(null).times(1);
        org.easymock.EasyMock.expect(kerberosDescriptor.getServices()).andReturn(serviceDescriptorMap).times(includePreconfiguredServices ? 2 : 1);
        ...
        if (includePreconfiguredServices) {
            org.easymock.EasyMock.expect(cluster.getServices()).andReturn(serviceMap).once();
        }
    ...
    private org.apache.ambari.server.state.PropertyInfo createMockPropertyInfo(java.lang.String filename, java.lang.String propertyName, java.lang.String value) {
        ...
        org.easymock.EasyMock.expect(propertyInfo.getFilename()).andReturn(filename).anyTimes();
        org.easymock.EasyMock.expect(propertyInfo.getName()).andReturn(propertyName).anyTimes();
        org.easymock.EasyMock.expect(propertyInfo.getValue()).andReturn(value).anyTimes();
        return propertyInfo;
    }
    ...
    public void testSettingAuthToLocalRulesForUninstalledServiceComponents() throws java.lang.Exception {
        final org.apache.ambari.server.state.kerberos.KerberosPrincipalDescriptor principalDescriptor1 = createMock(org.apache.ambari.server.state.kerberos.KerberosPrincipalDescriptor.class);
        org.easymock.EasyMock.expect(principalDescriptor1.getValue()).andReturn("principal1/host1@EXAMPLE.COM").times(2);
        org.easymock.EasyMock.expect(principalDescriptor1.getLocalUsername()).andReturn("principal1_user").times(2);
        final org.apache.ambari.server.state.kerberos.KerberosPrincipalDescriptor principalDescriptor2 = createMock(org.apache.ambari.server.state.kerberos.KerberosPrincipalDescriptor.class);
        org.easymock.EasyMock.expect(principalDescriptor2.getValue()).andReturn("principal2/host2@EXAMPLE.COM").times(1);
        org.easymock.EasyMock.expect(principalDescriptor2.getLocalUsername()).andReturn("principal2_user").times(1);
        final org.apache.ambari.server.state.kerberos.KerberosIdentityDescriptor identityDescriptor1 = createMock(org.apache.ambari.server.state.kerberos.KerberosIdentityDescriptor.class);
        org.easymock.EasyMock.expect(identityDescriptor1.getPrincipalDescriptor()).andReturn(principalDescriptor1).times(2);
        org.easymock.EasyMock.expect(identityDescriptor1.shouldInclude(org.easymock.EasyMock.anyObject())).andReturn(true).anyTimes();
        final org.apache.ambari.server.state.kerberos.KerberosIdentityDescriptor identityDescriptor2 = createMock(org.apache.ambari.server.state.kerberos.KerberosIdentityDescriptor.class);
        org.easymock.EasyMock.expect(identityDescriptor2.getPrincipalDescriptor()).andReturn(principalDescriptor2).times(1);
        org.easymock.EasyMock.expect(identityDescriptor2.shouldInclude(org.easymock.EasyMock.anyObject())).andReturn(true).anyTimes();
        ...
        final org.apache.ambari.server.state.kerberos.KerberosServiceDescriptor serviceDescriptor1 = createMock(org.apache.ambari.server.state.kerberos.KerberosServiceDescriptor.class);
        org.easymock.EasyMock.expect(serviceDescriptor1.getName()).andReturn("SERVICE1").anyTimes();
        org.easymock.EasyMock.expect(serviceDescriptor1.getIdentities(org.easymock.EasyMock.eq(true), org.easymock.EasyMock.anyObject())).andReturn(java.util.Arrays.asList(identityDescriptor1)).times(1);
        ...
        org.easymock.EasyMock.expect(serviceDescriptor1.getComponents()).andReturn(kerberosComponents).times(1);
        org.easymock.EasyMock.expect(serviceDescriptor1.getAuthToLocalProperties()).andReturn(new java.util.HashSet<>(java.util.Arrays.asList("default", "explicit_multiple_lines|new_lines", "explicit_multiple_lines_escaped|new_lines_escaped", "explicit_single_line|spaces", "service-site/default", "service-site/explicit_multiple_lines|new_lines", "service-site/explicit_multiple_lines_escaped|new_lines_escaped", "service-site/explicit_single_line|spaces"))).times(1);
        ...
        org.easymock.EasyMock.expect(kerberosDescriptor.getIdentities(org.easymock.EasyMock.eq(true), org.easymock.EasyMock.anyObject())).andReturn(null).times(1);
        org.easymock.EasyMock.expect(kerberosDescriptor.getAuthToLocalProperties()).andReturn(null).times(1);
        org.easymock.EasyMock.expect(kerberosDescriptor.getServices()).andReturn(serviceDescriptorMap).times(1);
        final org.apache.ambari.server.state.Cluster cluster = createMockCluster("c1", java.util.Collections.<org.apache.ambari.server.state.Host>emptyList(), org.apache.ambari.server.state.SecurityType.KERBEROS, null, null);
    ...
    public void testMergeConfigurationsForPreconfiguring() throws java.lang.Exception {
        ...
        org.easymock.EasyMock.expect(cluster.getServices()).andReturn(services).times(2);
        org.easymock.EasyMock.expect(cluster.getServiceComponentHostMap(null, serviceNames)).andReturn(hostMap).once();
        org.apache.ambari.server.state.kerberos.KerberosDescriptor kerberosDescriptor = createKerberosDescriptor();
        org.apache.ambari.server.state.ComponentInfo preconfigureComponentInfo = createMock(org.apache.ambari.server.state.ComponentInfo.class);
        org.easymock.EasyMock.expect(preconfigureComponentInfo.getName()).andReturn("PRECONFIGURE_SERVICE_MASTER").once();
        ...
        org.easymock.EasyMock.expect(hostGroup1.getName()).andReturn("host1").once();
        org.easymock.EasyMock.expect(hostGroup1.getComponents()).andReturn(host1Components).once();
        ...
        org.easymock.EasyMock.expect(hostGroup2.getName()).andReturn("host2").once();
        org.easymock.EasyMock.expect(hostGroup2.getComponents()).andReturn(host2Components).once();
        ...
        org.easymock.EasyMock.expect(blueprint.getHostGroups()).andReturn(hostGroups).once();
        ...
        org.easymock.EasyMock.expect(bindHostGroup1.getName()).andReturn("host1").once();
        org.easymock.EasyMock.expect(bindHostGroup1.getHosts()).andReturn(java.util.Collections.singleton(java.util.Collections.singletonMap("fqdn", "host1"))).once();
        ...
        org.easymock.EasyMock.expect(bindHostGroup2.getName()).andReturn("host2").once();
        org.easymock.EasyMock.expect(bindHostGroup2.getHosts()).andReturn(java.util.Collections.singleton(java.util.Collections.singletonMap("fqdn", "host2"))).once();
        ...
        org.easymock.EasyMock.expect(binding.getHostGroups()).andReturn(bindingHostGroups).once();
        ...
        org.easymock.EasyMock.expect(recommendation.getBlueprint()).andReturn(blueprint).once();
        org.easymock.EasyMock.expect(recommendation.getBlueprintClusterBinding()).andReturn(binding).once();
        ...
        org.easymock.EasyMock.expect(response.getRecommendations()).andReturn(recommendation).once();
        ...
        org.easymock.EasyMock.expect(stackAdvisorHelper.recommend(org.easymock.EasyMock.anyObject(org.apache.ambari.server.api.services.stackadvisor.StackAdvisorRequest.class))).andReturn(response).once();
        replayAll();
    ...
    public void testGetServiceConfigurationUpdates() throws java.lang.Exception {
        ...
        final org.apache.ambari.server.state.Config kerberosEnvConfig = createMock(org.apache.ambari.server.state.Config.class);
        org.easymock.EasyMock.expect(kerberosEnvConfig.getProperties()).andReturn(kerberosEnvProperties).atLeastOnce();
        final java.util.Map<java.lang.String, java.lang.String> krb5ConfProperties = createMock(java.util.Map.class);
        final org.apache.ambari.server.state.Config krb5ConfConfig = createMock(org.apache.ambari.server.state.Config.class);
        org.easymock.EasyMock.expect(krb5ConfConfig.getProperties()).andReturn(krb5ConfProperties).atLeastOnce();
        ...
        org.easymock.EasyMock.expect(serviceDescriptor1.getComponent("COMPONENT1A")).andReturn(componentDescriptor1a).times(2);
        org.easymock.EasyMock.expect(serviceDescriptor1.getComponent("COMPONENT1B")).andReturn(componentDescriptor1b).times(2);
        ...
        org.easymock.EasyMock.expect(serviceDescriptor2.getComponent("COMPONENT2A")).andReturn(componentDescriptor2a).times(1);
        org.easymock.EasyMock.expect(serviceDescriptor2.getComponent("COMPONENT2B")).andReturn(componentDescriptor2b).times(1);
        ...
        org.easymock.EasyMock.expect(serviceDescriptor3.getComponent("COMPONENT3A")).andReturn(componentDescriptor3a).times(2);
        java.util.Map<java.lang.String, org.apache.ambari.server.state.kerberos.KerberosServiceDescriptor> serviceDescriptorMap = new java.util.HashMap<>();
        serviceDescriptorMap.put("SERVICE1", serviceDescriptor1);
        ...
        final org.apache.ambari.server.state.kerberos.KerberosDescriptor kerberosDescriptor = createMock(org.apache.ambari.server.state.kerberos.KerberosDescriptor.class);
        org.easymock.EasyMock.expect(kerberosDescriptor.getProperties()).andReturn(kerberosDescriptorProperties).atLeastOnce();
        org.easymock.EasyMock.expect(kerberosDescriptor.getService("SERVICE1")).andReturn(serviceDescriptor1).atLeastOnce();
        org.easymock.EasyMock.expect(kerberosDescriptor.getService("SERVICE2")).andReturn(serviceDescriptor2).atLeastOnce();
        org.easymock.EasyMock.expect(kerberosDescriptor.getService("SERVICE3")).andReturn(serviceDescriptor3).atLeastOnce();
        org.easymock.EasyMock.expect(kerberosDescriptor.getServices()).andReturn(serviceDescriptorMap).atLeastOnce();
        org.easymock.EasyMock.expect(kerberosDescriptor.getProperty("additional_realms")).andReturn(null).atLeastOnce();
        org.easymock.EasyMock.expect(kerberosDescriptor.getIdentities(org.easymock.EasyMock.eq(true), org.easymock.EasyMock.anyObject())).andReturn(null).atLeastOnce();
        org.easymock.EasyMock.expect(kerberosDescriptor.getAuthToLocalProperties()).andReturn(java.util.Collections.singleton("core-site/auth.to.local")).atLeastOnce();
        setupKerberosDescriptor(kerberosDescriptor);
        ...
        org.easymock.EasyMock.expect(coreSiteRecommendation.getProperties()).andReturn(java.util.Collections.singletonMap("newPropertyRecommendation", "newPropertyRecommendation"));
        ...
        org.easymock.EasyMock.expect(newTypeRecommendation.getProperties()).andReturn(java.util.Collections.singletonMap("newTypeRecommendation", "newTypeRecommendation"));
        ...
        org.easymock.EasyMock.expect(type1Recommendation.getProperties()).andReturn(java.util.Collections.singletonMap("replacement1", "not replaced"));
        ...
        org.easymock.EasyMock.expect(service1SiteRecommendation.getProperties()).andReturn(java.util.Collections.singletonMap("component1b.property", "replaced value"));
        ...
        org.apache.ambari.server.api.services.stackadvisor.recommendations.RecommendationResponse.Blueprint blueprint = createMock(org.apache.ambari.server.api.services.stackadvisor.recommendations.RecommendationResponse.Blueprint.class);
        org.easymock.EasyMock.expect(blueprint.getConfigurations()).andReturn(configurations).once();
        ...
        org.easymock.EasyMock.expect(recommendations.getBlueprint()).andReturn(blueprint).once();
        ...
        org.easymock.EasyMock.expect(recommendationResponse.getRecommendations()).andReturn(recommendations).once();
        org.apache.ambari.server.api.services.stackadvisor.StackAdvisorHelper stackAdvisorHelper = org.apache.ambari.server.controller.KerberosHelperTest.injector.getInstance(org.apache.ambari.server.api.services.stackadvisor.StackAdvisorHelper.class);
        org.easymock.EasyMock.expect(stackAdvisorHelper.recommend(org.easymock.EasyMock.anyObject(org.apache.ambari.server.api.services.stackadvisor.StackAdvisorRequest.class))).andReturn(null).once();
        org.easymock.EasyMock.expect(stackAdvisorHelper.recommend(org.easymock.EasyMock.anyObject(org.apache.ambari.server.api.services.stackadvisor.StackAdvisorRequest.class))).andReturn(recommendationResponse).once();
        ...
        final org.apache.ambari.server.state.Cluster cluster = createMockCluster("c1", hosts, org.apache.ambari.server.state.SecurityType.KERBEROS, krb5ConfConfig, kerberosEnvConfig);
        org.easymock.EasyMock.expect(cluster.getServices()).andReturn(services).anyTimes();
        org.easymock.EasyMock.expect(cluster.getServiceComponentHostMap(org.easymock.EasyMock.anyObject(), org.easymock.EasyMock.anyObject())).andReturn(serviceComponentHostMap).anyTimes();
        org.easymock.EasyMock.expect(cluster.getDesiredStackVersion()).andReturn(new org.apache.ambari.server.state.StackId("HDP-2.2")).anyTimes();
    ...
    private void testEnsureHeadlessIdentities(boolean createAmbariIdentities, boolean ambariServerPrincipalAsService) throws java.lang.Exception {
        ...
        org.easymock.EasyMock.expect(configKrb5Conf.getProperties()).andReturn(propertiesKrb5Conf).times(1);
        org.apache.ambari.server.state.Config configKerberosEnv = createMock(org.apache.ambari.server.state.Config.class);
        org.easymock.EasyMock.expect(configKerberosEnv.getProperties()).andReturn(propertiesKerberosEnv).times(1);
        ...
        org.easymock.EasyMock.expect(cluster.getServices()).andReturn(servicesMap).anyTimes();
        org.easymock.EasyMock.expect(cluster.getDesiredStackVersion()).andReturn(new org.apache.ambari.server.state.StackId("HDP-2.2")).anyTimes();
        ...
        org.easymock.EasyMock.expect(kerberosDescriptor.getProperties()).andReturn(kerberosDescriptorProperties);
        org.easymock.EasyMock.expect(kerberosDescriptor.getService("SERVICE1")).andReturn(service1KerberosDescriptor).times(1);
        org.easymock.EasyMock.expect(kerberosDescriptor.getService("SERVICE2")).andReturn(service2KerberosDescriptor).times(1);
        org.easymock.Capture<org.apache.ambari.server.serveraction.kerberos.stageutils.ResolvedKerberosPrincipal> spnegoPrincipalCapture = org.easymock.EasyMock.newCapture(org.easymock.CaptureType.LAST);
        org.easymock.Capture<org.apache.ambari.server.serveraction.kerberos.stageutils.ResolvedKerberosPrincipal> ambariPrincipalCapture = org.easymock.EasyMock.newCapture(org.easymock.CaptureType.LAST);
        ...
        if (createAmbariIdentities) {
            ...
            org.easymock.EasyMock.expect(ambariServiceKerberosDescriptor.getComponent(org.apache.ambari.server.controller.RootComponent.AMBARI_SERVER.name())).andReturn(ambariServerComponentKerberosDescriptor).once();
            org.easymock.EasyMock.expect(kerberosDescriptor.getService(org.apache.ambari.server.controller.RootService.AMBARI.name())).andReturn(ambariServiceKerberosDescriptor).once();
            ...
            org.easymock.EasyMock.expect(configureAmbariIdentitiesServerAction.installAmbariServerIdentity(org.easymock.EasyMock.capture(ambariPrincipalCapture), org.easymock.EasyMock.anyString(), org.easymock.EasyMock.eq(ambariServerKeytabFilePath), org.easymock.EasyMock.eq("user1"), org.easymock.EasyMock.eq("rw"), org.easymock.EasyMock.eq("groupA"), org.easymock.EasyMock.eq("r"), ((org.apache.ambari.server.serveraction.ActionLog) (org.easymock.EasyMock.eq(null))))).andReturn(true).once();
            org.easymock.EasyMock.expect(configureAmbariIdentitiesServerAction.installAmbariServerIdentity(org.easymock.EasyMock.capture(spnegoPrincipalCapture), org.easymock.EasyMock.anyString(), org.easymock.EasyMock.eq("spnego.service.keytab"), org.easymock.EasyMock.eq("user1"), org.easymock.EasyMock.eq("rw"), org.easymock.EasyMock.eq("groupA"), org.easymock.EasyMock.eq("r"), ((org.apache.ambari.server.serveraction.ActionLog) (org.easymock.EasyMock.eq(null))))).andReturn(true).once();
        ...
        org.easymock.Capture<? extends java.lang.String> capturePrincipal = org.easymock.EasyMock.newCapture(org.easymock.CaptureType.ALL);
        org.easymock.Capture<? extends java.lang.String> capturePrincipalForKeytab = org.easymock.EasyMock.newCapture(org.easymock.CaptureType.ALL);
        ...
        org.easymock.EasyMock.expect(createPrincipalsServerAction.createPrincipal(org.easymock.EasyMock.capture(capturePrincipal), org.easymock.EasyMock.eq(false), org.easymock.EasyMock.anyObject(), org.easymock.EasyMock.anyObject(org.apache.ambari.server.serveraction.kerberos.KerberosOperationHandler.class), org.easymock.EasyMock.eq(false), org.easymock.EasyMock.isNull(org.apache.ambari.server.serveraction.ActionLog.class))).andReturn(new org.apache.ambari.server.serveraction.kerberos.CreatePrincipalsServerAction.CreatePrincipalResult("anything", "password", 1)).times(3);
        if (createAmbariIdentities) {
            if (ambariServerPrincipalAsService) {
                org.easymock.EasyMock.expect(createPrincipalsServerAction.createPrincipal(org.easymock.EasyMock.capture(capturePrincipal), org.easymock.EasyMock.eq(true), org.easymock.EasyMock.anyObject(), org.easymock.EasyMock.anyObject(org.apache.ambari.server.serveraction.kerberos.KerberosOperationHandler.class), org.easymock.EasyMock.eq(false), org.easymock.EasyMock.isNull(org.apache.ambari.server.serveraction.ActionLog.class))).andReturn(new org.apache.ambari.server.serveraction.kerberos.CreatePrincipalsServerAction.CreatePrincipalResult("anything", "password", 1)).times(2);
            } else {
                org.easymock.EasyMock.expect(createPrincipalsServerAction.createPrincipal(org.easymock.EasyMock.capture(capturePrincipal), org.easymock.EasyMock.eq(true), org.easymock.EasyMock.anyObject(), org.easymock.EasyMock.anyObject(org.apache.ambari.server.serveraction.kerberos.KerberosOperationHandler.class), org.easymock.EasyMock.eq(false), org.easymock.EasyMock.isNull(org.apache.ambari.server.serveraction.ActionLog.class))).andReturn(new org.apache.ambari.server.serveraction.kerberos.CreatePrincipalsServerAction.CreatePrincipalResult("anything", "password", 1)).times(1);
                org.easymock.EasyMock.expect(createPrincipalsServerAction.createPrincipal(org.easymock.EasyMock.capture(capturePrincipal), org.easymock.EasyMock.eq(false), org.easymock.EasyMock.anyObject(), org.easymock.EasyMock.anyObject(org.apache.ambari.server.serveraction.kerberos.KerberosOperationHandler.class), org.easymock.EasyMock.eq(false), org.easymock.EasyMock.isNull(org.apache.ambari.server.serveraction.ActionLog.class))).andReturn(new org.apache.ambari.server.serveraction.kerberos.CreatePrincipalsServerAction.CreatePrincipalResult("anything", "password", 1)).times(1);
            }
        ...
        org.easymock.EasyMock.expect(createKeytabFilesServerAction.createKeytab(org.easymock.EasyMock.capture(capturePrincipalForKeytab), org.easymock.EasyMock.anyObject(), org.easymock.EasyMock.eq("password"), org.easymock.EasyMock.eq(1), org.easymock.EasyMock.anyObject(org.apache.ambari.server.serveraction.kerberos.KerberosOperationHandler.class), org.easymock.EasyMock.eq(true), org.easymock.EasyMock.eq(true), org.easymock.EasyMock.isNull(org.apache.ambari.server.serveraction.ActionLog.class))).andReturn(new org.apache.directory.server.kerberos.shared.keytab.Keytab()).times(createAmbariIdentities ? 5 : 3);
        replayAll();
        org.apache.ambari.server.api.services.AmbariMetaInfo ambariMetaInfo = org.apache.ambari.server.controller.KerberosHelperTest.injector.getInstance(org.apache.ambari.server.api.services.AmbariMetaInfo.class);
        ambariMetaInfo.init();
        org.apache.ambari.server.security.encryption.CredentialStoreService credentialStoreService = org.apache.ambari.server.controller.KerberosHelperTest.injector.getInstance(org.apache.ambari.server.security.encryption.CredentialStoreService.class);
    ...
    public void testServiceWithoutComponents() throws java.lang.Exception {
        ...
        org.apache.ambari.server.state.kerberos.KerberosDescriptor kerberosDescriptor = createMock(org.apache.ambari.server.state.kerberos.KerberosDescriptor.class);
        org.easymock.EasyMock.expect(kerberosDescriptor.getProperties()).andReturn(kerberosDescriptorProperties);
        org.easymock.EasyMock.expect(kerberosDescriptor.getService("SERVICE1")).andReturn(service1KerberosDescriptor).anyTimes();
        setupKerberosDescriptor(kerberosDescriptor);
        java.util.Map<java.lang.String, java.util.Map<java.lang.String, java.lang.String>> existingConfigurations = new java.util.HashMap<>();
        existingConfigurations.put("kerberos-env", propertiesKerberosEnv);
        java.util.Set<java.lang.String> services = new java.util.HashSet<java.lang.String>() {
    ...
    private void setupKerberosDescriptor(org.apache.ambari.server.state.kerberos.KerberosDescriptor kerberosDescriptor) throws java.lang.Exception {
        ...
        org.easymock.EasyMock.expect(metaInfo.getKerberosDescriptor("HDP", "2.2", false)).andReturn(kerberosDescriptor).anyTimes();
        org.easymock.EasyMock.expect(kerberosDescriptor.principals()).andReturn(java.util.Collections.<java.lang.String, java.lang.String>emptyMap()).anyTimes();
    }
    ...
    private void setupStageFactory() {
        ...
        org.easymock.EasyMock.expect(stageFactory.createNew(org.easymock.EasyMock.anyLong(), org.easymock.EasyMock.anyObject(java.lang.String.class), org.easymock.EasyMock.anyObject(java.lang.String.class), org.easymock.EasyMock.anyLong(), org.easymock.EasyMock.anyObject(java.lang.String.class), org.easymock.EasyMock.anyObject(java.lang.String.class), org.easymock.EasyMock.anyObject(java.lang.String.class))).andAnswer(new org.easymock.IAnswer<org.apache.ambari.server.actionmanager.Stage>() {
            @java.lang.Override
            public org.apache.ambari.server.actionmanager.Stage answer() throws java.lang.Throwable {
                ...
                org.easymock.EasyMock.expect(stage.getHostRoleCommands()).andReturn(java.util.Collections.emptyMap()).anyTimes();
                org.easymock.EasyMock.replay(stage);
                return stage;
            }
        }).anyTimes();
    }
    ...
    private void testEnsureIdentities(final org.apache.ambari.server.security.credential.PrincipalKeyCredential PrincipalKeyCredential, java.util.Set<java.lang.String> filteredHosts) throws java.lang.Exception {
        ...
        org.easymock.EasyMock.expect(schKerberosClientA.getServiceName()).andReturn(org.apache.ambari.server.state.Service.Type.KERBEROS.name()).anyTimes();
        org.easymock.EasyMock.expect(schKerberosClientA.getServiceComponentName()).andReturn(org.apache.ambari.server.Role.KERBEROS_CLIENT.name()).anyTimes();
        org.easymock.EasyMock.expect(schKerberosClientA.getHostName()).andReturn("hostA").anyTimes();
        org.easymock.EasyMock.expect(schKerberosClientA.getState()).andReturn(org.apache.ambari.server.state.State.INSTALLED).anyTimes();
        ...
        org.easymock.EasyMock.expect(schKerberosClientB.getServiceName()).andReturn(org.apache.ambari.server.state.Service.Type.KERBEROS.name()).anyTimes();
        org.easymock.EasyMock.expect(schKerberosClientB.getServiceComponentName()).andReturn(org.apache.ambari.server.Role.KERBEROS_CLIENT.name()).anyTimes();
        org.easymock.EasyMock.expect(schKerberosClientB.getHostName()).andReturn("hostB").anyTimes();
        org.easymock.EasyMock.expect(schKerberosClientB.getState()).andReturn(org.apache.ambari.server.state.State.INSTALLED).anyTimes();
        ...
        org.easymock.EasyMock.expect(schKerberosClientC.getServiceName()).andReturn(org.apache.ambari.server.state.Service.Type.KERBEROS.name()).anyTimes();
        org.easymock.EasyMock.expect(schKerberosClientC.getServiceComponentName()).andReturn(org.apache.ambari.server.Role.KERBEROS_CLIENT.name()).anyTimes();
        org.easymock.EasyMock.expect(schKerberosClientC.getHostName()).andReturn("hostC").anyTimes();
        org.easymock.EasyMock.expect(schKerberosClientC.getState()).andReturn(org.apache.ambari.server.state.State.INSTALLED).anyTimes();
        ...
        org.easymock.EasyMock.expect(sch1A.getServiceName()).andReturn("SERVICE1").anyTimes();
        org.easymock.EasyMock.expect(sch1A.getServiceComponentName()).andReturn("COMPONENT1").anyTimes();
        org.easymock.EasyMock.expect(sch1A.getHostName()).andReturn("hostA").anyTimes();
        ...
        org.easymock.EasyMock.expect(sch1B.getServiceName()).andReturn("SERVICE1").anyTimes();
        org.easymock.EasyMock.expect(sch1B.getServiceComponentName()).andReturn("COMPONENT1").anyTimes();
        org.easymock.EasyMock.expect(sch1B.getHostName()).andReturn("hostB").anyTimes();
        ...
        org.easymock.EasyMock.expect(sch1C.getServiceName()).andReturn("SERVICE1").anyTimes();
        org.easymock.EasyMock.expect(sch1C.getServiceComponentName()).andReturn("COMPONENT1").anyTimes();
        org.easymock.EasyMock.expect(sch1C.getHostName()).andReturn("hostC").anyTimes();
        final org.apache.ambari.server.state.ServiceComponentHost sch2 = createMock(org.apache.ambari.server.state.ServiceComponentHost.class);
        org.easymock.EasyMock.expect(sch2.getServiceName()).andReturn("SERVICE2").anyTimes();
        org.easymock.EasyMock.expect(sch2.getServiceComponentName()).andReturn("COMPONENT3").anyTimes();
        org.easymock.EasyMock.expect(sch2.getHostName()).andReturn("hostA").anyTimes();
        ...
        org.easymock.EasyMock.expect(sch3.getServiceName()).andReturn("SERVICE3").anyTimes();
        org.easymock.EasyMock.expect(sch3.getServiceComponentName()).andReturn("COMPONENT3").anyTimes();
        org.easymock.EasyMock.expect(sch3.getHostName()).andReturn("hostA").anyTimes();
        final org.apache.ambari.server.state.Host hostA = createMockHost("hostA");
        final org.apache.ambari.server.state.Host hostB = createMockHost("hostB");
        final org.apache.ambari.server.state.Host hostC = createMockHost("hostC");
        final org.apache.ambari.server.state.ServiceComponent serviceComponentKerberosClient = createNiceMock(org.apache.ambari.server.state.ServiceComponent.class);
        org.easymock.EasyMock.expect(serviceComponentKerberosClient.getName()).andReturn(org.apache.ambari.server.Role.KERBEROS_CLIENT.name()).anyTimes();
        org.easymock.EasyMock.expect(serviceComponentKerberosClient.getServiceComponentHosts()).andReturn(new java.util.HashMap<java.lang.String, org.apache.ambari.server.state.ServiceComponentHost>() {
            {
        ...
        org.easymock.EasyMock.expect(cluster.getServiceComponentHosts("hostA")).andReturn(new java.util.ArrayList<org.apache.ambari.server.state.ServiceComponentHost>() {
            {
                add(sch1A);
                add(sch2);
                add(sch3);
        ...
        org.easymock.EasyMock.expect(cluster.getServiceComponentHosts("hostB")).andReturn(new java.util.ArrayList<org.apache.ambari.server.state.ServiceComponentHost>() {
            {
                add(sch1B);
                add(schKerberosClientB);
            }
        }).once();
        org.easymock.EasyMock.expect(cluster.getServiceComponentHosts("hostC")).andReturn(new java.util.ArrayList<org.apache.ambari.server.state.ServiceComponentHost>() {
            {
                add(sch1C);
                add(schKerberosClientC);
            }
        }).once();
        org.easymock.EasyMock.expect(cluster.getServiceComponentHosts("KERBEROS", "KERBEROS_CLIENT")).andReturn(new java.util.ArrayList<org.apache.ambari.server.state.ServiceComponentHost>() {
            {
                add(schKerberosClientA);
                add(schKerberosClientB);
                add(schKerberosClientC);
        ...
        if ((filteredHosts == null) || filteredHosts.contains("hostA")) {
            org.easymock.EasyMock.expect(clusters.getHost("hostA")).andReturn(hostA).anyTimes();
        }
        if ((filteredHosts == null) || filteredHosts.contains("hostB")) {
            org.easymock.EasyMock.expect(clusters.getHost("hostB")).andReturn(hostB).anyTimes();
        }
        if ((filteredHosts == null) || filteredHosts.contains("hostC")) {
            org.easymock.EasyMock.expect(clusters.getHost("hostC")).andReturn(hostC).anyTimes();
        }
        final org.apache.ambari.server.controller.AmbariManagementController ambariManagementController = org.apache.ambari.server.controller.KerberosHelperTest.injector.getInstance(org.apache.ambari.server.controller.AmbariManagementController.class);
        org.easymock.EasyMock.expect(ambariManagementController.findConfigurationTagsWithOverrides(cluster, null, null)).andReturn(java.util.Collections.emptyMap()).times(3);
        org.easymock.EasyMock.expect(ambariManagementController.getRoleCommandOrder(cluster)).andReturn(createMock(org.apache.ambari.server.metadata.RoleCommandOrder.class)).once();
        ...
        org.easymock.EasyMock.expect(principalDescriptor1a.getValue()).andReturn("component1a/_HOST@${realm}").anyTimes();
        org.easymock.EasyMock.expect(principalDescriptor1a.getType()).andReturn(org.apache.ambari.server.state.kerberos.KerberosPrincipalType.SERVICE).anyTimes();
        org.easymock.EasyMock.expect(principalDescriptor1a.getLocalUsername()).andReturn(null).anyTimes();
        org.easymock.EasyMock.expect(principalDescriptor1a.getConfiguration()).andReturn("service1b-site/component1.kerberos.principal").anyTimes();
        ...
        org.easymock.EasyMock.expect(principalDescriptor1b.getValue()).andReturn("component1b/_HOST@${realm}").anyTimes();
        org.easymock.EasyMock.expect(principalDescriptor1b.getType()).andReturn(org.apache.ambari.server.state.kerberos.KerberosPrincipalType.SERVICE).anyTimes();
        org.easymock.EasyMock.expect(principalDescriptor1b.getLocalUsername()).andReturn(null).anyTimes();
        org.easymock.EasyMock.expect(principalDescriptor1b.getConfiguration()).andReturn("service1b-site/component1.kerberos.principal").anyTimes();
        final org.apache.ambari.server.state.kerberos.KerberosPrincipalDescriptor principalDescriptor3 = createMock(org.apache.ambari.server.state.kerberos.KerberosPrincipalDescriptor.class);
        org.easymock.EasyMock.expect(principalDescriptor3.getValue()).andReturn("component3/${host}@${realm}").anyTimes();
        org.easymock.EasyMock.expect(principalDescriptor3.getType()).andReturn(org.apache.ambari.server.state.kerberos.KerberosPrincipalType.SERVICE).anyTimes();
        org.easymock.EasyMock.expect(principalDescriptor3.getLocalUsername()).andReturn(null).anyTimes();
        org.easymock.EasyMock.expect(principalDescriptor3.getConfiguration()).andReturn("service3-site/component3.kerberos.principal").anyTimes();
        ...
        org.easymock.EasyMock.expect(identityDescriptor1a.getName()).andReturn("identity1a").anyTimes();
        org.easymock.EasyMock.expect(identityDescriptor1a.getPrincipalDescriptor()).andReturn(principalDescriptor1a).anyTimes();
        org.easymock.EasyMock.expect(identityDescriptor1a.getKeytabDescriptor()).andReturn(keytabDescriptor1).anyTimes();
        ...
        org.easymock.EasyMock.expect(identityDescriptor1b.getName()).andReturn("identity1b").anyTimes();
        org.easymock.EasyMock.expect(identityDescriptor1b.getPrincipalDescriptor()).andReturn(principalDescriptor1b).anyTimes();
        final org.apache.ambari.server.state.kerberos.KerberosIdentityDescriptor identityDescriptor3 = createMock(org.apache.ambari.server.state.kerberos.KerberosIdentityDescriptor.class);
        org.easymock.EasyMock.expect(identityDescriptor3.getName()).andReturn("identity3").anyTimes();
        org.easymock.EasyMock.expect(identityDescriptor3.getPrincipalDescriptor()).andReturn(principalDescriptor3).anyTimes();
        org.easymock.EasyMock.expect(identityDescriptor3.getKeytabDescriptor()).andReturn(keytabDescriptor3).anyTimes();
        final org.apache.ambari.server.state.kerberos.KerberosServiceDescriptor serviceDescriptor1 = createMock(org.apache.ambari.server.state.kerberos.KerberosServiceDescriptor.class);
        ...
        if ((filteredHosts == null) || filteredHosts.contains("hostA")) {
            org.easymock.EasyMock.expect(kerberosDescriptor.getService("SERVICE1")).andReturn(serviceDescriptor1).times(1);
            org.easymock.EasyMock.expect(kerberosDescriptor.getService("SERVICE3")).andReturn(serviceDescriptor3).times(1);
        }
        if ((filteredHosts == null) || filteredHosts.contains("hostB")) {
            org.easymock.EasyMock.expect(kerberosDescriptor.getService("SERVICE1")).andReturn(serviceDescriptor1).times(1);
        }
    ...
    private void testDeleteIdentities(final org.apache.ambari.server.security.credential.PrincipalKeyCredential PrincipalKeyCredential) throws java.lang.Exception {
        ...
        org.easymock.EasyMock.expect(sch3.getServiceName()).andReturn("SERVICE3").anyTimes();
        org.easymock.EasyMock.expect(sch3.getServiceComponentName()).andReturn("COMPONENT3").anyTimes();
        org.easymock.EasyMock.expect(sch3.getHostName()).andReturn("host1").anyTimes();
        final org.apache.ambari.server.state.Host host = createMockHost("host1");
        final org.apache.ambari.server.state.ServiceComponent serviceComponentKerberosClient = createNiceMock(org.apache.ambari.server.state.ServiceComponent.class);
        org.easymock.EasyMock.expect(serviceComponentKerberosClient.getName()).andReturn(org.apache.ambari.server.Role.KERBEROS_CLIENT.name()).anyTimes();
        org.easymock.EasyMock.expect(serviceComponentKerberosClient.getServiceComponentHosts()).andReturn(java.util.Collections.singletonMap("host1", schKerberosClient)).anyTimes();
    ...
    private void testCreateTestIdentity(final org.apache.ambari.server.security.credential.PrincipalKeyCredential PrincipalKeyCredential, java.lang.Boolean manageIdentities) throws java.lang.Exception {
        ...
        result.created = true;
        result.kkp = kkp;
        org.easymock.EasyMock.expect(kerberosKeytabPrincipalDAO.findOrCreate(org.easymock.EasyMock.anyObject(), org.easymock.EasyMock.anyObject(), org.easymock.EasyMock.anyObject(), org.easymock.EasyMock.anyObject())).andReturn(result).anyTimes();
        ...
        final org.apache.ambari.server.state.Cluster cluster = createNiceMock(org.apache.ambari.server.state.Cluster.class);
        org.easymock.EasyMock.expect(cluster.getDesiredConfigByType("krb5-conf")).andReturn(krb5ConfConfig).anyTimes();
        org.easymock.EasyMock.expect(cluster.getDesiredConfigByType("kerberos-env")).andReturn(kerberosEnvConfig).anyTimes();
        org.easymock.EasyMock.expect(cluster.getDesiredStackVersion()).andReturn(new org.apache.ambari.server.state.StackId("HDP-2.2")).anyTimes();
        final org.apache.ambari.server.controller.internal.RequestStageContainer requestStageContainer = createStrictMock(org.apache.ambari.server.controller.internal.RequestStageContainer.class);
        if (managingIdentities) {
            final org.apache.ambari.server.state.Host host = createMockHost("host1");
            org.easymock.EasyMock.expect(host.getHostId()).andReturn(1L).anyTimes();
            org.easymock.EasyMock.expect(cluster.getHosts()).andReturn(java.util.Collections.singleton(host)).anyTimes();
            final org.apache.ambari.server.state.ServiceComponentHost schKerberosClient = createMock(org.apache.ambari.server.state.ServiceComponentHost.class);
            org.easymock.EasyMock.expect(schKerberosClient.getServiceName()).andReturn(org.apache.ambari.server.state.Service.Type.KERBEROS.name()).anyTimes();
            org.easymock.EasyMock.expect(schKerberosClient.getServiceComponentName()).andReturn(org.apache.ambari.server.Role.KERBEROS_CLIENT.name()).anyTimes();
            org.easymock.EasyMock.expect(schKerberosClient.getHostName()).andReturn("host1").anyTimes();
            org.easymock.EasyMock.expect(schKerberosClient.getState()).andReturn(org.apache.ambari.server.state.State.INSTALLED).anyTimes();
            org.easymock.EasyMock.expect(schKerberosClient.getHost()).andReturn(host).anyTimes();
            final org.apache.ambari.server.state.ServiceComponent serviceComponentKerberosClient = createNiceMock(org.apache.ambari.server.state.ServiceComponent.class);
            org.easymock.EasyMock.expect(serviceComponentKerberosClient.getName()).andReturn(org.apache.ambari.server.Role.KERBEROS_CLIENT.name()).anyTimes();
            org.easymock.EasyMock.expect(serviceComponentKerberosClient.getServiceComponentHosts()).andReturn(java.util.Collections.singletonMap("host1", schKerberosClient)).anyTimes();
            final org.apache.ambari.server.state.Service serviceKerberos = createNiceMock(org.apache.ambari.server.state.Service.class);
            ...
            org.easymock.EasyMock.expect(cluster.getServiceComponentHosts(org.apache.ambari.server.state.Service.Type.KERBEROS.name(), org.apache.ambari.server.Role.KERBEROS_CLIENT.name())).andReturn(new java.util.ArrayList<org.apache.ambari.server.state.ServiceComponentHost>() {
                {
                    add(schKerberosClient);
                }
            }).anyTimes();
            org.easymock.EasyMock.expect(cluster.getCurrentStackVersion()).andReturn(new org.apache.ambari.server.state.StackId("HDP", "2.2")).anyTimes();
            org.easymock.EasyMock.expect(cluster.getSessionAttributes()).andReturn(attributeMap).anyTimes();
            cluster.setSessionAttribute(org.easymock.EasyMock.anyObject(java.lang.String.class), org.easymock.EasyMock.anyObject());
            ...
            final org.apache.ambari.server.state.Clusters clusters = org.apache.ambari.server.controller.KerberosHelperTest.injector.getInstance(org.apache.ambari.server.state.Clusters.class);
            org.easymock.EasyMock.expect(clusters.getHost("host1")).andReturn(host).anyTimes();
            final org.apache.ambari.server.controller.AmbariManagementController ambariManagementController = org.apache.ambari.server.controller.KerberosHelperTest.injector.getInstance(org.apache.ambari.server.controller.AmbariManagementController.class);
            org.easymock.EasyMock.expect(ambariManagementController.findConfigurationTagsWithOverrides(cluster, null, null)).andReturn(java.util.Collections.emptyMap()).once();
            org.easymock.EasyMock.expect(ambariManagementController.getRoleCommandOrder(cluster)).andReturn(createMock(org.apache.ambari.server.metadata.RoleCommandOrder.class)).once();
            ...
            org.easymock.EasyMock.expect(configHelper.calculateExistingConfigurations(org.easymock.EasyMock.eq(ambariManagementController), org.easymock.EasyMock.anyObject(org.apache.ambari.server.state.Cluster.class), org.easymock.EasyMock.anyObject(), org.easymock.EasyMock.anyObject())).andReturn(new java.util.HashMap<java.lang.String, java.util.Map<java.lang.String, java.lang.String>>() {
                {
            ...
            final org.apache.ambari.server.state.kerberos.KerberosDescriptor kerberosDescriptor = createStrictMock(org.apache.ambari.server.state.kerberos.KerberosDescriptor.class);
            org.easymock.EasyMock.expect(kerberosDescriptor.getProperties()).andReturn(null).once();
            setupKerberosDescriptor(kerberosDescriptor);
            setupStageFactory();
            org.easymock.EasyMock.expect(requestStageContainer.getLastStageId()).andReturn(-1L).anyTimes();
            org.easymock.EasyMock.expect(requestStageContainer.getId()).andReturn(1L).once();
    ...
    private void testDeleteTestIdentity(final org.apache.ambari.server.security.credential.PrincipalKeyCredential PrincipalKeyCredential) throws java.lang.Exception {
        ...
        org.easymock.EasyMock.expect(host1.getHostId()).andReturn(1L).anyTimes();
        final org.apache.ambari.server.state.ServiceComponentHost schKerberosClient = createMock(org.apache.ambari.server.state.ServiceComponentHost.class);
        org.easymock.EasyMock.expect(schKerberosClient.getServiceName()).andReturn(org.apache.ambari.server.state.Service.Type.KERBEROS.name()).anyTimes();
        org.easymock.EasyMock.expect(schKerberosClient.getServiceComponentName()).andReturn(org.apache.ambari.server.Role.KERBEROS_CLIENT.name()).anyTimes();
        org.easymock.EasyMock.expect(schKerberosClient.getHostName()).andReturn("host1").anyTimes();
        org.easymock.EasyMock.expect(schKerberosClient.getState()).andReturn(org.apache.ambari.server.state.State.INSTALLED).anyTimes();
        org.easymock.EasyMock.expect(schKerberosClient.getHost()).andReturn(host1).anyTimes();
        final org.apache.ambari.server.state.ServiceComponentHost sch1 = createMock(org.apache.ambari.server.state.ServiceComponentHost.class);
        org.easymock.EasyMock.expect(sch1.getServiceName()).andReturn("SERVICE1").anyTimes();
        org.easymock.EasyMock.expect(sch1.getServiceComponentName()).andReturn("COMPONENT1").anyTimes();
        org.easymock.EasyMock.expect(sch1.getHostName()).andReturn("host1").anyTimes();
        ...
        org.easymock.EasyMock.expect(kerberosEnvProperties.get(org.apache.ambari.server.controller.KerberosHelper.KDC_TYPE)).andReturn("mit-kdc").anyTimes();
        org.easymock.EasyMock.expect(kerberosEnvProperties.get(org.apache.ambari.server.controller.KerberosHelper.DEFAULT_REALM)).andReturn("FOOBAR.COM").anyTimes();
        org.easymock.EasyMock.expect(kerberosEnvProperties.get("manage_identities")).andReturn(null).anyTimes();
        final org.apache.ambari.server.state.Config kerberosEnvConfig = createMock(org.apache.ambari.server.state.Config.class);
        org.easymock.EasyMock.expect(kerberosEnvConfig.getProperties()).andReturn(kerberosEnvProperties).anyTimes();
        final java.util.Map<java.lang.String, java.lang.String> krb5ConfProperties = createMock(java.util.Map.class);
        final org.apache.ambari.server.state.Config krb5ConfConfig = createMock(org.apache.ambari.server.state.Config.class);
    ...
    private java.util.Map<java.lang.String, java.util.Collection<org.apache.ambari.server.state.kerberos.KerberosIdentityDescriptor>> testGetActiveIdentities(java.lang.String clusterName, java.lang.String hostName, java.lang.String serviceName, java.lang.String componentName, boolean replaceHostNames, org.apache.ambari.server.state.SecurityType clusterSecurityType) throws java.lang.Exception {
        ...
        org.easymock.EasyMock.expect(schKerberosClient1.getServiceName()).andReturn(org.apache.ambari.server.state.Service.Type.KERBEROS.name()).anyTimes();
        org.easymock.EasyMock.expect(schKerberosClient1.getServiceComponentName()).andReturn(org.apache.ambari.server.Role.KERBEROS_CLIENT.name()).anyTimes();
        ...
        org.easymock.EasyMock.expect(schKerberosClient2.getServiceName()).andReturn(org.apache.ambari.server.state.Service.Type.KERBEROS.name()).anyTimes();
        org.easymock.EasyMock.expect(schKerberosClient2.getServiceComponentName()).andReturn(org.apache.ambari.server.Role.KERBEROS_CLIENT.name()).anyTimes();
        final org.apache.ambari.server.state.ServiceComponentHost sch1a = createMock(org.apache.ambari.server.state.ServiceComponentHost.class);
        org.easymock.EasyMock.expect(sch1a.getServiceName()).andReturn("SERVICE1").anyTimes();
        org.easymock.EasyMock.expect(sch1a.getServiceComponentName()).andReturn("COMPONENT1").anyTimes();
        final org.apache.ambari.server.state.ServiceComponentHost sch1b = createMock(org.apache.ambari.server.state.ServiceComponentHost.class);
        org.easymock.EasyMock.expect(sch1b.getServiceName()).andReturn("SERVICE2").anyTimes();
        org.easymock.EasyMock.expect(sch1b.getServiceComponentName()).andReturn("COMPONENT2").anyTimes();
        ...
        org.easymock.EasyMock.expect(sch2a.getServiceName()).andReturn("SERVICE1").anyTimes();
        org.easymock.EasyMock.expect(sch2a.getServiceComponentName()).andReturn("COMPONENT1").anyTimes();
        ...
        org.easymock.EasyMock.expect(sch2b.getServiceName()).andReturn("SERVICE2").anyTimes();
        org.easymock.EasyMock.expect(sch2b.getServiceComponentName()).andReturn("COMPONENT2").anyTimes();
        ...
        final org.apache.ambari.server.state.ServiceComponent serviceComponentKerberosClient = createNiceMock(org.apache.ambari.server.state.ServiceComponent.class);
        org.easymock.EasyMock.expect(serviceComponentKerberosClient.getName()).andReturn(org.apache.ambari.server.Role.KERBEROS_CLIENT.name()).anyTimes();
        org.easymock.EasyMock.expect(serviceComponentKerberosClient.getServiceComponentHosts()).andReturn(java.util.Collections.singletonMap("host1", schKerberosClient1)).anyTimes();
        final org.apache.ambari.server.state.Service serviceKerberos = createNiceMock(org.apache.ambari.server.state.Service.class);
        org.easymock.EasyMock.expect(serviceKerberos.getDesiredStackId()).andReturn(new org.apache.ambari.server.state.StackId("HDP-2.2")).anyTimes();
        org.easymock.EasyMock.expect(serviceKerberos.getName()).andReturn(org.apache.ambari.server.state.Service.Type.KERBEROS.name()).anyTimes();
        org.easymock.EasyMock.expect(serviceKerberos.getServiceComponents()).andReturn(java.util.Collections.singletonMap(org.apache.ambari.server.Role.KERBEROS_CLIENT.name(), serviceComponentKerberosClient)).anyTimes();
        ...
        org.easymock.EasyMock.expect(cluster.getSecurityType()).andReturn(clusterSecurityType).anyTimes();
        ...
        org.easymock.EasyMock.expect(cluster.getDesiredStackVersion()).andReturn(new org.apache.ambari.server.state.StackId("HDP-2.2")).anyTimes();
        org.easymock.EasyMock.expect(cluster.getDesiredConfigByType(org.easymock.EasyMock.anyString(), org.easymock.EasyMock.anyObject())).andReturn(org.easymock.EasyMock.createNiceMock(org.apache.ambari.server.state.Config.class)).anyTimes();
        org.easymock.EasyMock.expect(cluster.getServiceComponentHosts("host1")).andReturn(new java.util.ArrayList<org.apache.ambari.server.state.ServiceComponentHost>() {
            {
        ...
        org.easymock.EasyMock.expect(cluster.getServiceComponentHosts("host2")).andReturn(new java.util.ArrayList<org.apache.ambari.server.state.ServiceComponentHost>() {
            {
        ...
        org.easymock.EasyMock.expect(cluster.getServiceComponentHosts(java.net.InetAddress.getLocalHost().getCanonicalHostName().toLowerCase())).andReturn(new java.util.ArrayList<>()).anyTimes();
        final java.util.Map<java.lang.String, java.lang.String> kerberosEnvProperties = new java.util.HashMap<java.lang.String, java.lang.String>() {
            {
                put(org.apache.ambari.server.controller.KerberosHelper.KDC_TYPE, "mit-kdc");
                put(org.apache.ambari.server.controller.KerberosHelper.DEFAULT_REALM, "FOOBAR.COM");
        ...
        final org.apache.ambari.server.state.Clusters clusters = org.apache.ambari.server.controller.KerberosHelperTest.injector.getInstance(org.apache.ambari.server.state.Clusters.class);
        org.easymock.EasyMock.expect(clusters.getCluster(clusterName)).andReturn(cluster).times(1);
        if (hostName == null) {
            org.easymock.EasyMock.expect(clusters.getHostsForCluster(clusterName)).andReturn(hostMap).once();
        }
        final org.apache.ambari.server.controller.AmbariManagementController ambariManagementController = org.apache.ambari.server.controller.KerberosHelperTest.injector.getInstance(org.apache.ambari.server.controller.AmbariManagementController.class);
        org.easymock.EasyMock.expect(ambariManagementController.findConfigurationTagsWithOverrides(cluster, "host1", null)).andReturn(java.util.Collections.emptyMap()).anyTimes();
        org.easymock.EasyMock.expect(ambariManagementController.findConfigurationTagsWithOverrides(cluster, "host2", null)).andReturn(java.util.Collections.emptyMap()).anyTimes();
        org.easymock.EasyMock.expect(ambariManagementController.findConfigurationTagsWithOverrides(cluster, null, null)).andReturn(java.util.Collections.emptyMap()).anyTimes();
        final org.apache.ambari.server.state.ConfigHelper configHelper = org.apache.ambari.server.controller.KerberosHelperTest.injector.getInstance(org.apache.ambari.server.state.ConfigHelper.class);
        org.easymock.EasyMock.expect(configHelper.calculateExistingConfigurations(org.easymock.EasyMock.eq(ambariManagementController), org.easymock.EasyMock.anyObject(org.apache.ambari.server.state.Cluster.class), org.easymock.EasyMock.anyObject(), org.easymock.EasyMock.anyObject())).andReturn(new java.util.HashMap<java.lang.String, java.util.Map<java.lang.String, java.lang.String>>() {
            {
                put("cluster-env", new java.util.HashMap<java.lang.String, java.lang.String>() {
        ...
        final org.apache.ambari.server.state.kerberos.KerberosPrincipalDescriptor principalDescriptor1 = createMock(org.apache.ambari.server.state.kerberos.KerberosPrincipalDescriptor.class);
        org.easymock.EasyMock.expect(principalDescriptor1.getValue()).andReturn("service1/_HOST@${realm}").anyTimes();
        org.easymock.EasyMock.expect(principalDescriptor1.getType()).andReturn(org.apache.ambari.server.state.kerberos.KerberosPrincipalType.SERVICE).anyTimes();
        org.easymock.EasyMock.expect(principalDescriptor1.getConfiguration()).andReturn("service1-site/component1.kerberos.principal").anyTimes();
        org.easymock.EasyMock.expect(principalDescriptor1.getLocalUsername()).andReturn("service1").anyTimes();
        final org.apache.ambari.server.state.kerberos.KerberosPrincipalDescriptor principalDescriptor2 = createMock(org.apache.ambari.server.state.kerberos.KerberosPrincipalDescriptor.class);
        org.easymock.EasyMock.expect(principalDescriptor2.getValue()).andReturn("component2/${host}@${realm}").anyTimes();
        org.easymock.EasyMock.expect(principalDescriptor2.getType()).andReturn(org.apache.ambari.server.state.kerberos.KerberosPrincipalType.SERVICE).anyTimes();
        org.easymock.EasyMock.expect(principalDescriptor2.getConfiguration()).andReturn("service2-site/component2.kerberos.principal").anyTimes();
        org.easymock.EasyMock.expect(principalDescriptor2.getLocalUsername()).andReturn("service2").anyTimes();
        ...
        org.easymock.EasyMock.expect(principalDescriptorService1.getValue()).andReturn("service1/_HOST@${realm}").anyTimes();
        org.easymock.EasyMock.expect(principalDescriptorService1.getType()).andReturn(org.apache.ambari.server.state.kerberos.KerberosPrincipalType.SERVICE).anyTimes();
        org.easymock.EasyMock.expect(principalDescriptorService1.getConfiguration()).andReturn("service1-site/service1.kerberos.principal").anyTimes();
        org.easymock.EasyMock.expect(principalDescriptorService1.getLocalUsername()).andReturn("service1").anyTimes();
        final org.apache.ambari.server.state.kerberos.KerberosKeytabDescriptor keytabDescriptor1 = createMock(org.apache.ambari.server.state.kerberos.KerberosKeytabDescriptor.class);
        org.easymock.EasyMock.expect(keytabDescriptor1.getFile()).andReturn("${keytab_dir}/service1.keytab").anyTimes();
        org.easymock.EasyMock.expect(keytabDescriptor1.getOwnerName()).andReturn("service1").anyTimes();
        org.easymock.EasyMock.expect(keytabDescriptor1.getOwnerAccess()).andReturn("rw").anyTimes();
        org.easymock.EasyMock.expect(keytabDescriptor1.getGroupName()).andReturn("hadoop").anyTimes();
        org.easymock.EasyMock.expect(keytabDescriptor1.getGroupAccess()).andReturn("").anyTimes();
        org.easymock.EasyMock.expect(keytabDescriptor1.getConfiguration()).andReturn("service1-site/component1.keytab.file").anyTimes();
        org.easymock.EasyMock.expect(keytabDescriptor1.isCachable()).andReturn(false).anyTimes();
        ...
        org.easymock.EasyMock.expect(keytabDescriptor2.getFile()).andReturn("${keytab_dir}/service2.keytab").anyTimes();
        org.easymock.EasyMock.expect(keytabDescriptor2.getOwnerName()).andReturn("service2").anyTimes();
        org.easymock.EasyMock.expect(keytabDescriptor2.getOwnerAccess()).andReturn("rw").anyTimes();
        org.easymock.EasyMock.expect(keytabDescriptor2.getGroupName()).andReturn("hadoop").anyTimes();
        org.easymock.EasyMock.expect(keytabDescriptor2.getGroupAccess()).andReturn("").anyTimes();
        org.easymock.EasyMock.expect(keytabDescriptor2.getConfiguration()).andReturn("service2-site/component2.keytab.file").anyTimes();
        org.easymock.EasyMock.expect(keytabDescriptor2.isCachable()).andReturn(false).anyTimes();
        ...
        org.easymock.EasyMock.expect(keytabDescriptorService1.getFile()).andReturn("${keytab_dir}/service1.service.keytab").anyTimes();
        org.easymock.EasyMock.expect(keytabDescriptorService1.getOwnerName()).andReturn("service1").anyTimes();
        org.easymock.EasyMock.expect(keytabDescriptorService1.getOwnerAccess()).andReturn("rw").anyTimes();
        org.easymock.EasyMock.expect(keytabDescriptorService1.getGroupName()).andReturn("hadoop").anyTimes();
        org.easymock.EasyMock.expect(keytabDescriptorService1.getGroupAccess()).andReturn("").anyTimes();
        org.easymock.EasyMock.expect(keytabDescriptorService1.getConfiguration()).andReturn("service1-site/service1.keytab.file").anyTimes();
        org.easymock.EasyMock.expect(keytabDescriptorService1.isCachable()).andReturn(false).anyTimes();
        final org.apache.ambari.server.state.kerberos.KerberosIdentityDescriptor identityDescriptor1 = createMock(org.apache.ambari.server.state.kerberos.KerberosIdentityDescriptor.class);
        org.easymock.EasyMock.expect(identityDescriptor1.getName()).andReturn("identity1").anyTimes();
        org.easymock.EasyMock.expect(identityDescriptor1.getReference()).andReturn(null).anyTimes();
        org.easymock.EasyMock.expect(identityDescriptor1.getPrincipalDescriptor()).andReturn(principalDescriptor1).anyTimes();
        org.easymock.EasyMock.expect(identityDescriptor1.getKeytabDescriptor()).andReturn(keytabDescriptor1).anyTimes();
        org.easymock.EasyMock.expect(identityDescriptor1.shouldInclude(org.easymock.EasyMock.anyObject())).andReturn(true).anyTimes();
        org.easymock.EasyMock.expect(identityDescriptor1.getWhen()).andReturn(null).anyTimes();
        final org.apache.ambari.server.state.kerberos.KerberosIdentityDescriptor identityDescriptor2 = createMock(org.apache.ambari.server.state.kerberos.KerberosIdentityDescriptor.class);
        org.easymock.EasyMock.expect(identityDescriptor2.getName()).andReturn("identity2").anyTimes();
        org.easymock.EasyMock.expect(identityDescriptor2.getReference()).andReturn(null).anyTimes();
        org.easymock.EasyMock.expect(identityDescriptor2.getPrincipalDescriptor()).andReturn(principalDescriptor2).anyTimes();
        org.easymock.EasyMock.expect(identityDescriptor2.getKeytabDescriptor()).andReturn(keytabDescriptor2).anyTimes();
        org.easymock.EasyMock.expect(identityDescriptor2.shouldInclude(org.easymock.EasyMock.anyObject())).andReturn(true).anyTimes();
        org.easymock.EasyMock.expect(identityDescriptor2.getWhen()).andReturn(null).anyTimes();
        ...
        org.easymock.EasyMock.expect(identityDescriptorService1.getName()).andReturn("identity3").anyTimes();
        org.easymock.EasyMock.expect(identityDescriptorService1.getReference()).andReturn(null).anyTimes();
        org.easymock.EasyMock.expect(identityDescriptorService1.getPrincipalDescriptor()).andReturn(principalDescriptorService1).anyTimes();
        org.easymock.EasyMock.expect(identityDescriptorService1.getKeytabDescriptor()).andReturn(keytabDescriptorService1).anyTimes();
        org.easymock.EasyMock.expect(identityDescriptorService1.shouldInclude(org.easymock.EasyMock.anyObject())).andReturn(true).anyTimes();
        org.easymock.EasyMock.expect(identityDescriptorService1.getWhen()).andReturn(null).anyTimes();
        ...
        org.easymock.EasyMock.expect(componentDescriptor1.getIdentities(org.easymock.EasyMock.eq(true), org.easymock.EasyMock.anyObject())).andReturn(java.util.Collections.singletonList(identityDescriptor1)).anyTimes();
        ...
        org.easymock.EasyMock.expect(componentDescriptor2.getIdentities(org.easymock.EasyMock.eq(true), org.easymock.EasyMock.anyObject())).andReturn(java.util.Collections.singletonList(identityDescriptor2)).anyTimes();
        final org.apache.ambari.server.state.kerberos.KerberosServiceDescriptor serviceDescriptor1 = createMock(org.apache.ambari.server.state.kerberos.KerberosServiceDescriptor.class);
        org.easymock.EasyMock.expect(serviceDescriptor1.getComponent("COMPONENT1")).andReturn(componentDescriptor1).anyTimes();
        org.easymock.EasyMock.expect(serviceDescriptor1.getIdentities(org.easymock.EasyMock.eq(true), org.easymock.EasyMock.anyObject())).andReturn(java.util.Collections.singletonList(identityDescriptorService1)).anyTimes();
        final org.apache.ambari.server.state.kerberos.KerberosServiceDescriptor serviceDescriptor2 = createMock(org.apache.ambari.server.state.kerberos.KerberosServiceDescriptor.class);
        org.easymock.EasyMock.expect(serviceDescriptor2.getComponent("COMPONENT2")).andReturn(componentDescriptor2).anyTimes();
        org.easymock.EasyMock.expect(serviceDescriptor2.getIdentities(org.easymock.EasyMock.eq(true), org.easymock.EasyMock.anyObject())).andReturn(null).anyTimes();
        final org.apache.ambari.server.state.kerberos.KerberosDescriptor kerberosDescriptor = createMock(org.apache.ambari.server.state.kerberos.KerberosDescriptor.class);
        org.easymock.EasyMock.expect(kerberosDescriptor.getProperties()).andReturn(new java.util.HashMap<java.lang.String, java.lang.String>() {
            {
                put(org.apache.ambari.server.controller.KerberosHelper.DEFAULT_REALM, "EXAMPLE.COM");
            }
        }).anyTimes();
        org.easymock.EasyMock.expect(kerberosDescriptor.getService("KERBEROS")).andReturn(null).anyTimes();
        org.easymock.EasyMock.expect(kerberosDescriptor.getService("SERVICE1")).andReturn(serviceDescriptor1).anyTimes();
        org.easymock.EasyMock.expect(kerberosDescriptor.getService("SERVICE2")).andReturn(serviceDescriptor2).anyTimes();
        org.easymock.EasyMock.expect(kerberosDescriptor.getService("AMBARI")).andReturn(null).anyTimes();
        setupKerberosDescriptor(kerberosDescriptor);
        replayAll();
        org.apache.ambari.server.controller.KerberosHelperTest.injector.getInstance(org.apache.ambari.server.api.services.AmbariMetaInfo.class).init();
    ...
    private void addAmbariServerIdentity(java.util.Map<java.lang.String, java.lang.String> kerberosEnvProperties) throws java.lang.Exception {
        ...
        if (createAmbariIdentities) {
            ...
            org.apache.ambari.server.state.kerberos.KerberosServiceDescriptor ambariServiceKerberosDescriptor = createMockServiceDescriptor(org.apache.ambari.server.controller.RootService.AMBARI.name(), ambariServerComponentDescriptorMap, null, false);
            org.easymock.EasyMock.expect(ambariServiceKerberosDescriptor.getComponent(org.apache.ambari.server.controller.RootComponent.AMBARI_SERVER.name())).andReturn(componentDescrptor).once();
            org.easymock.EasyMock.expect(kerberosDescriptor.getService(org.apache.ambari.server.controller.RootService.AMBARI.name())).andReturn(ambariServiceKerberosDescriptor).once();
        }
        replayAll();
        org.apache.ambari.server.controller.KerberosHelperTest.injector.getInstance(org.apache.ambari.server.api.services.AmbariMetaInfo.class).init();
    ...
    private org.apache.ambari.server.state.kerberos.KerberosConfigurationDescriptor createMockConfigurationDescriptor(java.util.Map<java.lang.String, java.lang.String> properties) {
        ...
        org.easymock.EasyMock.expect(descriptor.getProperties()).andReturn(properties).anyTimes();
        return descriptor;
    }
    ...
    private org.apache.ambari.server.state.kerberos.KerberosKeytabDescriptor createMockKeytabDescriptor(java.lang.String file, java.lang.String configuration) {
        ...
        org.easymock.EasyMock.expect(descriptor.getFile()).andReturn(file).anyTimes();
        org.easymock.EasyMock.expect(descriptor.getConfiguration()).andReturn(configuration).anyTimes();
        org.easymock.EasyMock.expect(descriptor.getOwnerName()).andReturn("user1").anyTimes();
        org.easymock.EasyMock.expect(descriptor.getOwnerAccess()).andReturn("rw").anyTimes();
        org.easymock.EasyMock.expect(descriptor.getGroupName()).andReturn("groupA").anyTimes();
        org.easymock.EasyMock.expect(descriptor.getGroupAccess()).andReturn("r").anyTimes();
        return descriptor;
    }
    ...
    private org.apache.ambari.server.state.kerberos.KerberosPrincipalDescriptor createMockPrincipalDescriptor(java.lang.String value, org.apache.ambari.server.state.kerberos.KerberosPrincipalType type, java.lang.String localUsername, java.lang.String configuration) {
        ...
        org.easymock.EasyMock.expect(descriptor.getValue()).andReturn(value).anyTimes();
        org.easymock.EasyMock.expect(descriptor.getType()).andReturn(type).anyTimes();
        org.easymock.EasyMock.expect(descriptor.getLocalUsername()).andReturn(localUsername).anyTimes();
        org.easymock.EasyMock.expect(descriptor.getConfiguration()).andReturn(configuration).anyTimes();
        return descriptor;
    }
    ...
    private org.apache.ambari.server.state.kerberos.KerberosServiceDescriptor createMockServiceDescriptor(java.lang.String serviceName, java.util.HashMap<java.lang.String, org.apache.ambari.server.state.kerberos.KerberosComponentDescriptor> componentMap, java.util.List<org.apache.ambari.server.state.kerberos.KerberosIdentityDescriptor> identities, boolean shouldPreconfigure) throws org.apache.ambari.server.AmbariException {
        ...
        org.easymock.EasyMock.expect(descriptor.getName()).andReturn(serviceName).anyTimes();
        org.easymock.EasyMock.expect(descriptor.getComponents()).andReturn(componentMap).anyTimes();
        org.easymock.EasyMock.expect(descriptor.getIdentities(org.easymock.EasyMock.eq(true), org.easymock.EasyMock.anyObject())).andReturn(identities).anyTimes();
        org.easymock.EasyMock.expect(descriptor.getAuthToLocalProperties()).andReturn(null).anyTimes();
        org.easymock.EasyMock.expect(descriptor.shouldPreconfigure()).andReturn(shouldPreconfigure).anyTimes();
        return descriptor;
    }
    ...
    private org.apache.ambari.server.state.kerberos.KerberosIdentityDescriptor createMockIdentityDescriptor(java.lang.String name, org.apache.ambari.server.state.kerberos.KerberosPrincipalDescriptor principalDescriptor, org.apache.ambari.server.state.kerberos.KerberosKeytabDescriptor keytabDescriptor) {
        ...
        org.easymock.EasyMock.expect(descriptor.getName()).andReturn(name).anyTimes();
        org.easymock.EasyMock.expect(descriptor.getPrincipalDescriptor()).andReturn(principalDescriptor).anyTimes();
        org.easymock.EasyMock.expect(descriptor.getKeytabDescriptor()).andReturn(keytabDescriptor).anyTimes();
        return descriptor;
    }
    ...
    private org.apache.ambari.server.state.kerberos.KerberosComponentDescriptor createMockComponentDescriptor(java.lang.String componentName, java.util.List<org.apache.ambari.server.state.kerberos.KerberosIdentityDescriptor> identities, java.util.Map<java.lang.String, org.apache.ambari.server.state.kerberos.KerberosConfigurationDescriptor> configurations) throws org.apache.ambari.server.AmbariException {
        ...
        org.easymock.EasyMock.expect(descriptor.getName()).andReturn(componentName).anyTimes();
        org.easymock.EasyMock.expect(descriptor.getIdentities(org.easymock.EasyMock.eq(true), org.easymock.EasyMock.anyObject())).andReturn(identities).anyTimes();
        org.easymock.EasyMock.expect(descriptor.getConfigurations(true)).andReturn(configurations).anyTimes();
        org.easymock.EasyMock.expect(descriptor.getAuthToLocalProperties()).andReturn(null).anyTimes();
        return descriptor;
    }
    ...
    private org.apache.ambari.server.state.ServiceComponentHost createMockServiceComponentHost(org.apache.ambari.server.state.State state) {
        ...
        org.easymock.EasyMock.expect(serviceComponentHost.getDesiredState()).andReturn(state).anyTimes();
    ...
    private org.apache.ambari.server.state.ServiceComponent createMockComponent(java.lang.String componentName, boolean isMasterComponent, java.util.Map<java.lang.String, org.apache.ambari.server.state.ServiceComponentHost> hosts) {
        ...
        org.easymock.EasyMock.expect(component.getName()).andReturn(componentName).anyTimes();
        org.easymock.EasyMock.expect(component.isMasterComponent()).andReturn(isMasterComponent).anyTimes();
        org.easymock.EasyMock.expect(component.isClientComponent()).andReturn(!isMasterComponent).anyTimes();
        org.easymock.EasyMock.expect(component.getServiceComponentHosts()).andReturn(hosts).anyTimes();
        return component;
    }
    ...
    private org.apache.ambari.server.state.Service createMockService(java.lang.String serviceName, java.util.Map<java.lang.String, org.apache.ambari.server.state.ServiceComponent> componentMap) {
        ...
        org.easymock.EasyMock.expect(service.getDesiredStackId()).andReturn(new org.apache.ambari.server.state.StackId("HDP-2.2")).anyTimes();
        org.easymock.EasyMock.expect(service.getName()).andReturn(serviceName).anyTimes();
        org.easymock.EasyMock.expect(service.getServiceComponents()).andReturn(componentMap).anyTimes();
        return service;
    }
    ...
    private org.apache.ambari.server.state.Host createMockHost(java.lang.String hostname) {
        ...
        org.easymock.EasyMock.expect(host.getState()).andReturn(org.apache.ambari.server.state.HostState.HEALTHY).anyTimes();
        org.easymock.EasyMock.expect(host.getCurrentPingPort()).andReturn(1).anyTimes();
        org.easymock.EasyMock.expect(host.getRackInfo()).andReturn("rack1").anyTimes();
        org.easymock.EasyMock.expect(host.getIPv4()).andReturn("1.2.3.4").anyTimes();
        return host;
    }
    ...
    private org.apache.ambari.server.state.Cluster createMockCluster(java.lang.String clusterName, java.util.Collection<org.apache.ambari.server.state.Host> hosts, org.apache.ambari.server.state.SecurityType securityType, org.apache.ambari.server.state.Config krb5ConfConfig, org.apache.ambari.server.state.Config kerberosEnvConfig) {
        ...
        org.easymock.EasyMock.expect(cluster.getSecurityType()).andReturn(securityType).anyTimes();
        org.easymock.EasyMock.expect(cluster.getDesiredConfigByType("krb5-conf")).andReturn(krb5ConfConfig).anyTimes();
        org.easymock.EasyMock.expect(cluster.getDesiredConfigByType("kerberos-env")).andReturn(kerberosEnvConfig).anyTimes();
        org.easymock.EasyMock.expect(cluster.getClusterName()).andReturn(clusterName).anyTimes();
        org.easymock.EasyMock.expect(cluster.getCurrentStackVersion()).andReturn(new org.apache.ambari.server.state.StackId("HDP", "2.2")).anyTimes();
