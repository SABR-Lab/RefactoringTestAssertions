...
public class ServiceConfigVersionResponse {
    ...
    @com.fasterxml.jackson.annotation.JsonProperty("service_config_version")
    ...
    @com.fasterxml.jackson.annotation.JsonProperty("service_config_version_note")
    @com.fasterxml.jackson.annotation.JsonInclude(com.fasterxml.jackson.annotation.JsonInclude.Include.NON_NULL)
    private final java.lang.String note;

    @com.fasterxml.jackson.annotation.JsonProperty("stack_id")
    ...
    @com.fasterxml.jackson.annotation.JsonProperty("is_cluster_compatible")
