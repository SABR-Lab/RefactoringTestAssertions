...
public class AbstractControllerResourceProviderTest {
    ...
    public void testGetResourceProvider() throws java.lang.Exception {
        ...
        org.easymock.EasyMock.expect(factory.getServiceResourceProvider(managementController)).andReturn(serviceResourceProvider);
        org.apache.ambari.server.controller.internal.AbstractControllerResourceProvider.init(factory);
        org.easymock.EasyMock.replay(managementController, factory, maintenanceStateHelper, repositoryVersionDAO);
