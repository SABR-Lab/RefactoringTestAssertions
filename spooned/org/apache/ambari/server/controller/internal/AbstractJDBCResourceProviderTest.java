...
public class AbstractJDBCResourceProviderTest {
    ...
    public void test() throws java.sql.SQLException {
        ...
        java.sql.ResultSet rs = org.easymock.EasyMock.createMock(java.sql.ResultSet.class);
        org.easymock.EasyMock.expect(rs.getString(org.apache.ambari.server.controller.internal.AbstractJDBCResourceProviderTest.TestFields.field1.toString())).andReturn("1").once();
        org.easymock.EasyMock.expect(rs.getLong(org.apache.ambari.server.controller.internal.AbstractJDBCResourceProviderTest.TestFields.field2.toString())).andReturn(2L).once();
        org.easymock.EasyMock.expect(rs.getInt(org.apache.ambari.server.controller.internal.AbstractJDBCResourceProviderTest.TestFields.field1.toString())).andReturn(3).once();
