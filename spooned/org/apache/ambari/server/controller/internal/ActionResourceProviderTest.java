...
public class ActionResourceProviderTest {
    ...
    public void testGetResources() throws java.lang.Exception {
        org.apache.ambari.server.controller.spi.Resource.Type type = org.apache.ambari.server.controller.spi.Resource.Type.Action;
        org.apache.ambari.server.api.services.AmbariMetaInfo am = org.easymock.EasyMock.createNiceMock(org.apache.ambari.server.api.services.AmbariMetaInfo.class);
        ...
        org.easymock.EasyMock.expect(managementController.getAmbariMetaInfo()).andReturn(am).anyTimes();
        ...
        org.easymock.EasyMock.expect(am.getAllActionDefinition()).andReturn(allDefinition).once();
        org.easymock.EasyMock.expect(am.getActionDefinition("a1")).andReturn(namedDefinition).once();
        org.easymock.EasyMock.replay(managementController, am);
