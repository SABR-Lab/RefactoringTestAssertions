...
public class ActiveWidgetLayoutResourceProviderTest extends org.easymock.EasyMockSupport {
    ...
    private void getResourcesTest(org.springframework.security.core.Authentication authentication, java.lang.String requestedUsername) throws java.lang.Exception {
        ...
        org.easymock.EasyMock.expect(widgetLayoutDAO.findById(1L)).andReturn(createMockWidgetLayout(1L, requestedUsername)).atLeastOnce();
        org.easymock.EasyMock.expect(widgetLayoutDAO.findById(2L)).andReturn(createMockWidgetLayout(2L, requestedUsername)).atLeastOnce();
        ...
        org.easymock.EasyMock.expect(clusters.getClusterById(2L)).andReturn(cluster).atLeastOnce();
        replayAll();
    ...
    private void updateResourcesTest(org.springframework.security.core.Authentication authentication, java.lang.String requestedUsername, boolean setUserName) throws java.lang.Exception {
        com.google.inject.Injector injector = createInjector();
        org.easymock.Capture<? extends java.lang.String> widgetLayoutJsonCapture = org.easymock.EasyMock.newCapture();
        org.apache.ambari.server.orm.entities.UserEntity userEntity = createMockUserEntity(requestedUsername);
        userEntity.setActiveWidgetLayouts(org.easymock.EasyMock.capture(widgetLayoutJsonCapture));
        org.easymock.EasyMock.expectLastCall().once();
        org.apache.ambari.server.orm.dao.UserDAO userDAO = injector.getInstance(org.apache.ambari.server.orm.dao.UserDAO.class);
        org.easymock.EasyMock.expect(userDAO.findUserByName(requestedUsername)).andReturn(userEntity).atLeastOnce();
        org.easymock.EasyMock.expect(userDAO.merge(userEntity)).andReturn(userEntity).atLeastOnce();
        org.apache.ambari.server.orm.dao.WidgetLayoutDAO widgetLayoutDAO = injector.getInstance(org.apache.ambari.server.orm.dao.WidgetLayoutDAO.class);
        org.easymock.EasyMock.expect(widgetLayoutDAO.findById(1L)).andReturn(createMockWidgetLayout(1L, requestedUsername)).atLeastOnce();
        org.easymock.EasyMock.expect(widgetLayoutDAO.findById(2L)).andReturn(createMockWidgetLayout(2L, requestedUsername)).atLeastOnce();
        replayAll();
    ...
    private org.apache.ambari.server.orm.entities.WidgetLayoutEntity createMockWidgetLayout(java.lang.Long id, java.lang.String username) {
        ...
        org.easymock.EasyMock.expect(widgetLayoutEntity.getId()).andReturn(id).anyTimes();
        org.easymock.EasyMock.expect(widgetLayoutEntity.getUserName()).andReturn(username).anyTimes();
        org.easymock.EasyMock.expect(widgetLayoutEntity.getLayoutName()).andReturn("layout name" + id).anyTimes();
        org.easymock.EasyMock.expect(widgetLayoutEntity.getSectionName()).andReturn("section" + id).anyTimes();
        org.easymock.EasyMock.expect(widgetLayoutEntity.getScope()).andReturn("CLUSTER").anyTimes();
        org.easymock.EasyMock.expect(widgetLayoutEntity.getDisplayName()).andReturn("display name" + id).anyTimes();
        org.easymock.EasyMock.expect(widgetLayoutEntity.getClusterId()).andReturn(2L).anyTimes();
        org.easymock.EasyMock.expect(widgetLayoutEntity.getListWidgetLayoutUserWidgetEntity()).andReturn(java.util.Collections.emptyList()).anyTimes();
    ...
    private org.apache.ambari.server.orm.entities.UserEntity createMockUserEntity(java.lang.String username) {
        ...
        org.easymock.EasyMock.expect(userEntity.getActiveWidgetLayouts()).andReturn("[{\"id\":\"1\"},{\"id\":\"2\"}]").anyTimes();
        return userEntity;
    }
