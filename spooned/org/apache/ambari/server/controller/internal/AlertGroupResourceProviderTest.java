...
public class AlertGroupResourceProviderTest {
    ...
    public void before() throws java.lang.Exception {
        m_dao = org.easymock.EasyMock.createMock(org.apache.ambari.server.orm.dao.AlertDispatchDAO.class);
        m_definitionDao = org.easymock.EasyMock.createMock(org.apache.ambari.server.orm.dao.AlertDefinitionDAO.class);
        m_amc = org.easymock.EasyMock.createMock(org.apache.ambari.server.controller.AmbariManagementController.class);
        m_clusters = org.easymock.EasyMock.createMock(org.apache.ambari.server.state.Clusters.class);
        m_cluster = org.easymock.EasyMock.createMock(org.apache.ambari.server.state.Cluster.class);
        ...
        org.easymock.EasyMock.expect(m_amc.getClusters()).andReturn(m_clusters).anyTimes();
        org.easymock.EasyMock.expect(m_clusters.getCluster(((java.lang.String) (org.easymock.EasyMock.anyObject())))).andReturn(m_cluster).anyTimes();
        org.easymock.EasyMock.expect(m_clusters.getClusterById(1L)).andReturn(m_cluster).anyTimes();
        org.easymock.EasyMock.expect(m_cluster.getClusterId()).andReturn(1L).anyTimes();
        org.easymock.EasyMock.expect(m_cluster.getResourceId()).andReturn(4L).anyTimes();
    ...
    private void testGetResourcesClusterPredicate(org.springframework.security.core.Authentication authentication, boolean expectResults) throws java.lang.Exception {
        ...
        org.easymock.EasyMock.expect(m_dao.findAllGroups(org.apache.ambari.server.controller.internal.AlertGroupResourceProviderTest.ALERT_GROUP_CLUSTER_ID)).andReturn(getMockEntities());
        org.easymock.EasyMock.replay(m_amc, m_clusters, m_cluster, m_dao);
        org.springframework.security.core.context.SecurityContextHolder.getContext().setAuthentication(authentication);
        org.apache.ambari.server.controller.internal.AlertGroupResourceProvider provider = createProvider(m_amc);
        ...
        org.easymock.EasyMock.verify(m_amc, m_clusters, m_cluster, m_dao);
    }
    ...
    private void testGetSingleResource(org.springframework.security.core.Authentication authentication, boolean expectResults) throws java.lang.Exception {
        ...
        org.easymock.EasyMock.expect(m_dao.findGroupById(org.apache.ambari.server.controller.internal.AlertGroupResourceProviderTest.ALERT_GROUP_ID.longValue())).andReturn(getMockEntities().get(0));
        org.easymock.EasyMock.expect(amc.getClusters()).andReturn(m_clusters).atLeastOnce();
        org.easymock.EasyMock.replay(amc, m_dao, m_clusters, m_cluster);
        org.springframework.security.core.context.SecurityContextHolder.getContext().setAuthentication(authentication);
        ...
        org.easymock.EasyMock.verify(amc, m_dao);
    }
    ...
    public void testCreateResources(org.springframework.security.core.Authentication authentication) throws java.lang.Exception {
        ...
        m_dao.createGroups(org.easymock.EasyMock.capture(listCapture));
        org.easymock.EasyMock.expectLastCall().once();
        org.easymock.EasyMock.expect(m_dao.findTargetsById(org.easymock.EasyMock.eq(targetIds))).andReturn(targetEntities).times(1);
        org.easymock.EasyMock.expect(m_definitionDao.findByIds(definitionIds)).andReturn(definitionEntities).times(1);
        org.easymock.EasyMock.replay(m_amc, m_clusters, m_cluster, m_dao, m_definitionDao);
        org.springframework.security.core.context.SecurityContextHolder.getContext().setAuthentication(authentication);
        org.apache.ambari.server.controller.internal.AlertGroupResourceProvider provider = createProvider(m_amc);
        ...
        org.easymock.EasyMock.verify(m_amc, m_clusters, m_cluster, m_dao, m_definitionDao);
    }
    ...
    public void testUpdateResources(org.springframework.security.core.Authentication authentication) throws java.lang.Exception {
        ...
        org.easymock.EasyMock.expect(m_dao.findGroupById(org.apache.ambari.server.controller.internal.AlertGroupResourceProviderTest.ALERT_GROUP_ID)).andReturn(group).times(1);
        org.easymock.EasyMock.expect(m_dao.merge(org.easymock.EasyMock.capture(entityCapture))).andReturn(group).once();
        org.easymock.EasyMock.expect(m_dao.findTargetsById(org.easymock.EasyMock.eq(targetIds))).andReturn(targetEntities).once();
        org.easymock.EasyMock.expect(m_definitionDao.findByIds(definitionIds)).andReturn(definitionEntities).once();
        org.easymock.EasyMock.replay(m_amc, m_clusters, m_cluster, m_dao, m_definitionDao);
        org.springframework.security.core.context.SecurityContextHolder.getContext().setAuthentication(authentication);
        org.apache.ambari.server.controller.internal.AlertGroupResourceProvider provider = createProvider(m_amc);
        java.util.Map<java.lang.String, java.lang.Object> requestProps = new java.util.HashMap<>();
    ...
    private void testUpdateDefaultGroup(org.springframework.security.core.Authentication authentication) throws java.lang.Exception {
        ...
        org.easymock.EasyMock.expect(m_dao.findTargetsById(org.easymock.EasyMock.eq(newTargets))).andReturn(newTargetEntities).once();
        org.easymock.EasyMock.replay(m_dao, m_definitionDao, m_amc, m_clusters, m_cluster);
        org.springframework.security.core.context.SecurityContextHolder.getContext().setAuthentication(authentication);
        org.apache.ambari.server.controller.internal.AlertGroupResourceProvider provider = createProvider(m_amc);
        java.util.Map<java.lang.String, java.lang.Object> requestProps = new java.util.HashMap<>();
        requestProps.put(org.apache.ambari.server.controller.internal.AlertGroupResourceProvider.ALERT_GROUP_ID, org.apache.ambari.server.controller.internal.AlertGroupResourceProviderTest.ALERT_GROUP_ID.toString());
        ...
        org.easymock.EasyMock.verify(m_dao, m_definitionDao);
    }
    ...
    private void testDeleteResources(org.springframework.security.core.Authentication authentication) throws java.lang.Exception {
        ...
        org.easymock.EasyMock.resetToStrict(m_dao);
        org.easymock.EasyMock.expect(m_dao.findGroupById(org.apache.ambari.server.controller.internal.AlertGroupResourceProviderTest.ALERT_GROUP_ID.longValue())).andReturn(entity).anyTimes();
        m_dao.remove(org.easymock.EasyMock.capture(entityCapture));
        org.easymock.EasyMock.expectLastCall();
        org.easymock.EasyMock.replay(m_dao);
    ...
    private void testDeleteDefaultGroup(org.springframework.security.core.Authentication authentication) throws java.lang.Exception {
        ...
        group.setAlertTargets(getMockTargets());
        org.easymock.EasyMock.resetToStrict(m_dao);
        org.easymock.EasyMock.expect(m_dao.findGroupById(org.apache.ambari.server.controller.internal.AlertGroupResourceProviderTest.ALERT_GROUP_ID)).andReturn(group).anyTimes();
        org.easymock.EasyMock.replay(m_dao, m_amc, m_clusters, m_cluster);
        org.springframework.security.core.context.SecurityContextHolder.getContext().setAuthentication(authentication);
        org.apache.ambari.server.controller.internal.AlertGroupResourceProvider provider = createProvider(m_amc);
        org.apache.ambari.server.controller.spi.Predicate predicate = new org.apache.ambari.server.controller.utilities.PredicateBuilder().property(org.apache.ambari.server.controller.internal.AlertGroupResourceProvider.ALERT_GROUP_CLUSTER_NAME).equals(org.apache.ambari.server.controller.internal.AlertGroupResourceProviderTest.ALERT_GROUP_CLUSTER_NAME).and().property(org.apache.ambari.server.controller.internal.AlertGroupResourceProvider.ALERT_GROUP_ID).equals(org.apache.ambari.server.controller.internal.AlertGroupResourceProviderTest.ALERT_GROUP_ID.toString()).toPredicate();
        provider.deleteResources(new org.apache.ambari.server.controller.internal.RequestImpl(null, null, null, null), predicate);
        org.easymock.EasyMock.verify(m_dao, m_amc);
    }
