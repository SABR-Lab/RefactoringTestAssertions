...
public class AlertHistoryResourceProviderTest {
    ...
    @org.junit.Before
    public void before() {
        m_dao = org.easymock.EasyMock.createStrictMock(org.apache.ambari.server.orm.dao.AlertsDAO.class);
    ...
    private void testGetResourcesNoPredicate(org.springframework.security.core.Authentication authentication) throws java.lang.Exception {
        ...
        org.easymock.EasyMock.expect(m_dao.findAll(org.easymock.EasyMock.anyObject(org.apache.ambari.server.controller.AlertHistoryRequest.class))).andReturn(java.util.Collections.emptyList());
    ...
    private void testGetResourcesClusterPredicate(org.springframework.security.core.Authentication authentication) throws java.lang.Exception {
        ...
        org.easymock.EasyMock.expect(m_dao.findAll(org.easymock.EasyMock.anyObject(org.apache.ambari.server.controller.AlertHistoryRequest.class))).andReturn(getMockEntities());
