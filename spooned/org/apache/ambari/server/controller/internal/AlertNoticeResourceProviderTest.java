...
public class AlertNoticeResourceProviderTest {
    ...
    public void testGetResourcesNoPredicate(org.springframework.security.core.Authentication authentication) throws java.lang.Exception {
        ...
        org.easymock.EasyMock.expect(m_dao.findAllNotices(org.easymock.EasyMock.anyObject(org.apache.ambari.server.controller.AlertNoticeRequest.class))).andReturn(java.util.Collections.emptyList());
    ...
    protected void testGetResourcesClusterPredicate(org.springframework.security.core.Authentication authentication) throws java.lang.Exception {
        ...
        org.easymock.EasyMock.expect(m_dao.findAllNotices(org.easymock.EasyMock.anyObject(org.apache.ambari.server.controller.AlertNoticeRequest.class))).andReturn(getMockEntities());
        ...
        org.easymock.EasyMock.replay(m_dao, amc, clusters, cluster);
        org.springframework.security.core.context.SecurityContextHolder.getContext().setAuthentication(authentication);
        org.apache.ambari.server.controller.internal.AlertNoticeResourceProvider provider = createProvider();
        ...
        org.easymock.EasyMock.verify(m_dao, amc, clusters, cluster);
    }
