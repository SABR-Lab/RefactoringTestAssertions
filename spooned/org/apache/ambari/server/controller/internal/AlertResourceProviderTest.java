...
public class AlertResourceProviderTest {
    ...
    public void before() throws java.lang.Exception {
        ...
        org.easymock.EasyMock.expect(m_amc.getClusters()).andReturn(clusters).atLeastOnce();
        org.easymock.EasyMock.expect(clusters.getCluster(org.easymock.EasyMock.capture(org.easymock.EasyMock.<java.lang.String>newCapture()))).andReturn(cluster).atLeastOnce();
        ...
        org.easymock.EasyMock.expect(cluster.getClusterProperty(org.apache.ambari.server.state.ConfigHelper.CLUSTER_ENV_ALERT_REPEAT_TOLERANCE, "1")).andReturn("1").atLeastOnce();
        org.easymock.EasyMock.replay(m_amc, clusters, cluster);
    ...
    private void testGetCluster(org.springframework.security.core.Authentication authentication) throws java.lang.Exception {
        org.easymock.EasyMock.expect(m_dao.findAll(org.easymock.EasyMock.capture(org.easymock.EasyMock.<org.apache.ambari.server.controller.AlertCurrentRequest>newCapture()))).andReturn(getClusterMockEntities()).anyTimes();
        ...
        org.easymock.EasyMock.verify(m_dao);
    }
    ...
    private void testGetClusterSummary(org.springframework.security.core.Authentication authentication) throws java.lang.Exception {
        org.easymock.EasyMock.expect(m_dao.findAll(org.easymock.EasyMock.capture(org.easymock.EasyMock.<org.apache.ambari.server.controller.AlertCurrentRequest>newCapture()))).andReturn(getMockEntitiesManyStates()).anyTimes();
        org.easymock.EasyMock.replay(m_dao);
        org.springframework.security.core.context.SecurityContextHolder.getContext().setAuthentication(authentication);
    ...
    private void testGetClusterGroupedSummaryMaintenanceCounts(org.springframework.security.core.Authentication authentication) throws java.lang.Exception {
        ...
        org.easymock.EasyMock.expect(m_dao.findAll(org.easymock.EasyMock.capture(org.easymock.EasyMock.<org.apache.ambari.server.controller.AlertCurrentRequest>newCapture()))).andReturn(currents).anyTimes();
        org.easymock.EasyMock.replay(m_dao);
        org.springframework.security.core.context.SecurityContextHolder.getContext().setAuthentication(authentication);
        org.apache.ambari.server.controller.spi.Request request = org.apache.ambari.server.controller.utilities.PropertyHelper.getReadRequest(org.apache.ambari.server.controller.internal.AlertResourceProvider.ALERT_ID, org.apache.ambari.server.controller.internal.AlertResourceProvider.ALERT_DEFINITION_NAME, org.apache.ambari.server.controller.internal.AlertResourceProvider.ALERT_LABEL, org.apache.ambari.server.controller.internal.AlertResourceProvider.ALERT_STATE, org.apache.ambari.server.controller.internal.AlertResourceProvider.ALERT_ORIGINAL_TIMESTAMP);
        org.apache.ambari.server.controller.spi.Predicate predicate = new org.apache.ambari.server.controller.utilities.PredicateBuilder().property(org.apache.ambari.server.controller.internal.AlertResourceProvider.ALERT_CLUSTER_NAME).equals("c1").toPredicate();
    ...
    public void testResponseIsPaginated() throws java.lang.Exception {
        org.easymock.EasyMock.expect(m_dao.findAll(org.easymock.EasyMock.anyObject(org.apache.ambari.server.controller.AlertCurrentRequest.class))).andReturn(getClusterMockEntities()).atLeastOnce();
        org.easymock.EasyMock.expect(m_dao.getCount(org.easymock.EasyMock.anyObject(org.apache.ambari.server.controller.spi.Predicate.class))).andReturn(0).atLeastOnce();
        org.easymock.EasyMock.replay(m_dao);
    ...
    private class MockModule implements com.google.inject.Module {
        ...
        public void configure(com.google.inject.Binder binder) {
            ...
            binder.bind(org.apache.ambari.server.controller.AmbariManagementController.class).toInstance(org.easymock.EasyMock.createMock(org.apache.ambari.server.controller.AmbariManagementController.class));
            ...
            org.easymock.EasyMock.expect(configuration.getDatabaseUrl()).andReturn(org.apache.ambari.server.configuration.Configuration.JDBC_IN_MEMORY_URL).anyTimes();
            org.easymock.EasyMock.expect(configuration.getDatabaseDriver()).andReturn(org.apache.ambari.server.configuration.Configuration.JDBC_IN_MEMORY_DRIVER).anyTimes();
            org.easymock.EasyMock.expect(configuration.getDatabaseUser()).andReturn("sa").anyTimes();
            org.easymock.EasyMock.expect(configuration.getDatabasePassword()).andReturn("").anyTimes();
            ...
            org.easymock.EasyMock.expect(configuration.getMasterKeyLocation()).andReturn(new java.io.File("/test")).anyTimes();
            org.easymock.EasyMock.expect(configuration.getTemporaryKeyStoreRetentionMinutes()).andReturn(2L).anyTimes();
            org.easymock.EasyMock.expect(configuration.isActivelyPurgeTemporaryKeyStore()).andReturn(true).anyTimes();
            org.easymock.EasyMock.expect(configuration.getDatabaseSchema()).andReturn(org.apache.ambari.server.configuration.Configuration.DEFAULT_DERBY_SCHEMA).anyTimes();
