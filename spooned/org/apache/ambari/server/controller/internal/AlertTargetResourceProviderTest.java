...
public class AlertTargetResourceProviderTest {
    ...
    @org.junit.Before
    public void before() {
        m_dao = org.easymock.EasyMock.createStrictMock(org.apache.ambari.server.orm.dao.AlertDispatchDAO.class);
    ...
    public void testGetResourcesNoPredicate(org.springframework.security.core.Authentication authentication) throws java.lang.Exception {
        ...
        org.easymock.EasyMock.expect(m_dao.findAllTargets()).andReturn(getMockEntities());
    ...
    private void testGetSingleResource(org.springframework.security.core.Authentication authentication) throws java.lang.Exception {
        ...
        org.easymock.EasyMock.expect(m_dao.findTargetById(org.apache.ambari.server.controller.internal.AlertTargetResourceProviderTest.ALERT_TARGET_ID.longValue())).andReturn(getMockEntities().get(0)).atLeastOnce();
        org.easymock.EasyMock.replay(m_amc, m_dao);
        org.springframework.security.core.context.SecurityContextHolder.getContext().setAuthentication(authentication);
        org.apache.ambari.server.controller.internal.AlertTargetResourceProvider provider = createProvider(m_amc);
        ...
        org.easymock.EasyMock.verify(m_amc, m_dao);
    }
    ...
    private void testCreateResources(org.springframework.security.core.Authentication authentication) throws java.lang.Exception {
        org.easymock.EasyMock.expect(m_dao.findTargetByName(org.apache.ambari.server.controller.internal.AlertTargetResourceProviderTest.ALERT_TARGET_NAME)).andReturn(null).atLeastOnce();
        ...
        m_dao.create(org.easymock.EasyMock.capture(targetCapture));
    ...
    private void testCreateResourcesWithGroups(org.springframework.security.core.Authentication authentication) throws java.lang.Exception {
        ...
        org.easymock.EasyMock.expect(m_dao.findTargetByName(org.apache.ambari.server.controller.internal.AlertTargetResourceProviderTest.ALERT_TARGET_NAME)).andReturn(null).atLeastOnce();
        org.easymock.EasyMock.expect(m_dao.findGroupsById(groupIds)).andReturn(groups).once();
        org.easymock.Capture<org.apache.ambari.server.orm.entities.AlertTargetEntity> targetCapture = org.easymock.EasyMock.newCapture();
        m_dao.create(org.easymock.EasyMock.capture(targetCapture));
        org.easymock.EasyMock.expectLastCall();
        org.easymock.EasyMock.replay(m_amc, m_dao);
    ...
    private void testUpdateResources(org.springframework.security.core.Authentication authentication) throws java.lang.Exception {
        ...
        m_dao.create(org.easymock.EasyMock.capture(entityCapture));
        ...
        org.easymock.EasyMock.expect(m_dao.findTargetById(org.apache.ambari.server.controller.internal.AlertTargetResourceProviderTest.ALERT_TARGET_ID)).andReturn(target).times(1);
        org.easymock.EasyMock.expect(m_dao.merge(org.easymock.EasyMock.capture(entityCapture))).andReturn(target).once();
        org.easymock.EasyMock.replay(m_amc, m_dao);
        org.springframework.security.core.context.SecurityContextHolder.getContext().setAuthentication(authentication);
        org.apache.ambari.server.controller.internal.AlertTargetResourceProvider provider = createProvider(m_amc);
        java.util.Map<java.lang.String, java.lang.Object> requestProps = getCreationProperties();
    ...
    private void testUpdateResourcesWithGroups(org.springframework.security.core.Authentication authentication) throws java.lang.Exception {
        ...
        group3.setGroupId(3L);
        groups.addAll(java.util.Arrays.asList(group1, group2, group3));
        org.easymock.EasyMock.expect(m_dao.findGroupsById(org.easymock.EasyMock.eq(groupIds))).andReturn(groups).once();
        org.easymock.EasyMock.expect(m_dao.merge(org.easymock.EasyMock.capture(entityCapture))).andReturn(target).once();
        org.easymock.EasyMock.replay(m_amc, m_dao);
        org.springframework.security.core.context.SecurityContextHolder.getContext().setAuthentication(authentication);
        org.apache.ambari.server.controller.internal.AlertTargetResourceProvider provider = createProvider(m_amc);
    ...
    private void testDeleteResources(org.springframework.security.core.Authentication authentication) throws java.lang.Exception {
        ...
        org.easymock.EasyMock.expect(m_dao.findTargetById(org.apache.ambari.server.controller.internal.AlertTargetResourceProviderTest.ALERT_TARGET_ID.longValue())).andReturn(entity).anyTimes();
    ...
    public void testDuplicate(org.springframework.security.core.Authentication authentication) throws java.lang.Exception {
        ...
        org.easymock.EasyMock.expect(m_dao.findTargetByName(org.apache.ambari.server.controller.internal.AlertTargetResourceProviderTest.ALERT_TARGET_NAME)).andReturn(entity).atLeastOnce();
        org.easymock.EasyMock.replay(m_amc, m_dao);
        org.springframework.security.core.context.SecurityContextHolder.getContext().setAuthentication(authentication);
        org.apache.ambari.server.controller.internal.AlertTargetResourceProvider provider = createProvider(m_amc);
        java.util.Map<java.lang.String, java.lang.Object> requestProps = getCreationProperties();
    ...
    private void testOverwriteDirective(org.springframework.security.core.Authentication authentication) throws java.lang.Exception {
        ...
        org.easymock.EasyMock.expect(m_dao.findTargetByName(org.apache.ambari.server.controller.internal.AlertTargetResourceProviderTest.ALERT_TARGET_NAME)).andReturn(entity).atLeastOnce();
        org.easymock.Capture<org.apache.ambari.server.orm.entities.AlertTargetEntity> targetCapture = org.easymock.EasyMock.newCapture();
        org.easymock.EasyMock.expect(m_dao.merge(org.easymock.EasyMock.capture(targetCapture))).andReturn(entity).once();
        org.easymock.EasyMock.replay(m_amc, m_dao);
        org.springframework.security.core.context.SecurityContextHolder.getContext().setAuthentication(authentication);
        org.apache.ambari.server.controller.internal.AlertTargetResourceProvider provider = createProvider(m_amc);
        java.util.Map<java.lang.String, java.lang.Object> requestProps = getCreationProperties();
    ...
    public void testUpdateAlertTargetsWithCustomGroups() throws java.lang.Exception {
        ...
        org.easymock.EasyMock.expectLastCall().times(1);
        org.apache.ambari.server.orm.entities.AlertTargetEntity target = new org.apache.ambari.server.orm.entities.AlertTargetEntity();
        org.easymock.EasyMock.expect(m_dao.findTargetById(org.apache.ambari.server.controller.internal.AlertTargetResourceProviderTest.ALERT_TARGET_ID)).andReturn(target).once();
        ...
        java.util.List<java.lang.Long> groupIds = java.util.Arrays.asList(1L, 2L, 3L);
        org.easymock.EasyMock.expect(m_dao.findGroupsById(org.easymock.EasyMock.eq(groupIds))).andReturn(groups).anyTimes();
        org.easymock.EasyMock.expect(m_dao.findAllGroups()).andReturn(groups).anyTimes();
        for (org.apache.ambari.server.orm.entities.AlertGroupEntity group : groups) {
            org.easymock.EasyMock.expect(m_dao.merge(org.easymock.EasyMock.capture(groupEntityCapture))).andReturn(group).anyTimes();
        }
        org.easymock.EasyMock.expect(m_dao.merge(org.easymock.EasyMock.capture(entityCapture))).andReturn(target).anyTimes();
        org.easymock.EasyMock.replay(m_amc, m_dao);
    ...
    public void testUpdateAlertTargetsWithAllGroups() throws java.lang.Exception {
        ...
        java.util.List<java.lang.Long> groupIds = java.util.Arrays.asList(1L, 2L, 3L);
        org.easymock.EasyMock.expect(m_dao.findGroupsById(org.easymock.EasyMock.eq(groupIds))).andReturn(groups).anyTimes();
        org.easymock.EasyMock.expect(m_dao.findAllGroups()).andReturn(groups).once();
        org.easymock.EasyMock.expect(m_dao.merge(org.easymock.EasyMock.capture(entityCapture))).andReturn(target).anyTimes();
        org.easymock.EasyMock.replay(m_amc, m_dao);
        org.springframework.security.core.context.SecurityContextHolder.getContext().setAuthentication(org.apache.ambari.server.security.TestAuthenticationFactory.createAdministrator());
        org.apache.ambari.server.controller.internal.AlertTargetResourceProvider provider = createProvider(m_amc);
