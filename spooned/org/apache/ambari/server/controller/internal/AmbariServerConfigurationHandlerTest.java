...
public class AmbariServerConfigurationHandlerTest extends org.easymock.EasyMockSupport {
    ...
    public void getComponentConfigurations() {
        ...
        org.easymock.EasyMock.expect(ambariConfigurationDAO.findAll()).andReturn(allEntities).once();
        org.easymock.EasyMock.expect(ambariConfigurationDAO.findByCategory(org.apache.ambari.server.configuration.AmbariServerConfigurationCategory.SSO_CONFIGURATION.getCategoryName())).andReturn(ssoEntities).once();
        org.easymock.EasyMock.expect(ambariConfigurationDAO.findByCategory(org.apache.ambari.server.configuration.AmbariServerConfigurationCategory.LDAP_CONFIGURATION.getCategoryName())).andReturn(ldapEntities).once();
        org.easymock.EasyMock.expect(ambariConfigurationDAO.findByCategory(org.apache.ambari.server.configuration.AmbariServerConfigurationCategory.TPROXY_CONFIGURATION.getCategoryName())).andReturn(tproxyEntities).once();
        org.easymock.EasyMock.expect(ambariConfigurationDAO.findByCategory("invalid category")).andReturn(null).once();
    ...
    public void removeComponentConfiguration() {
        org.apache.ambari.server.orm.dao.AmbariConfigurationDAO ambariConfigurationDAO = createMock(org.apache.ambari.server.orm.dao.AmbariConfigurationDAO.class);
        org.easymock.EasyMock.expect(ambariConfigurationDAO.removeByCategory(org.apache.ambari.server.configuration.AmbariServerConfigurationCategory.SSO_CONFIGURATION.getCategoryName())).andReturn(1).once();
        org.easymock.EasyMock.expect(ambariConfigurationDAO.removeByCategory("invalid category")).andReturn(0).once();
        org.apache.ambari.server.events.publishers.AmbariEventPublisher publisher = createMock(org.apache.ambari.server.events.publishers.AmbariEventPublisher.class);
    ...
    public void updateComponentCategory() throws org.apache.ambari.server.AmbariException {
        ...
        org.apache.ambari.server.orm.dao.AmbariConfigurationDAO ambariConfigurationDAO = createMock(org.apache.ambari.server.orm.dao.AmbariConfigurationDAO.class);
        org.easymock.EasyMock.expect(ambariConfigurationDAO.reconcileCategory(org.apache.ambari.server.configuration.AmbariServerConfigurationCategory.SSO_CONFIGURATION.getCategoryName(), properties, true)).andReturn(true).once();
        org.easymock.EasyMock.expect(ambariConfigurationDAO.reconcileCategory(org.apache.ambari.server.configuration.AmbariServerConfigurationCategory.SSO_CONFIGURATION.getCategoryName(), properties, false)).andReturn(true).once();
        org.apache.ambari.server.events.publishers.AmbariEventPublisher publisher = createMock(org.apache.ambari.server.events.publishers.AmbariEventPublisher.class);
        publisher.publish(org.easymock.EasyMock.anyObject(org.apache.ambari.server.events.AmbariConfigurationChangedEvent.class));
