...
public class ArtifactResourceProviderTest {
    private org.apache.ambari.server.orm.dao.ArtifactDAO dao = org.easymock.EasyMock.createStrictMock(org.apache.ambari.server.orm.dao.ArtifactDAO.class);

    private javax.persistence.EntityManager em = org.easymock.EasyMock.createStrictMock(javax.persistence.EntityManager.class);

    private org.apache.ambari.server.controller.AmbariManagementController controller = org.easymock.EasyMock.createStrictMock(org.apache.ambari.server.controller.AmbariManagementController.class);

    private org.apache.ambari.server.controller.spi.Request request = org.easymock.EasyMock.createMock(org.apache.ambari.server.controller.spi.Request.class);
    ...
    private org.apache.ambari.server.state.Cluster cluster = org.easymock.EasyMock.createMock(org.apache.ambari.server.state.Cluster.class);

    private org.apache.ambari.server.orm.entities.ArtifactEntity entity = org.easymock.EasyMock.createMock(org.apache.ambari.server.orm.entities.ArtifactEntity.class);

    private org.apache.ambari.server.orm.entities.ArtifactEntity entity2 = org.easymock.EasyMock.createMock(org.apache.ambari.server.orm.entities.ArtifactEntity.class);

    org.apache.ambari.server.controller.internal.ArtifactResourceProvider resourceProvider;

    @org.junit.Before
    public void setUp() throws java.lang.Exception {
        org.easymock.EasyMock.reset(dao, em, controller, request, clusters, cluster, entity, entity2);
    ...
    public void testGetResources_instance() throws java.lang.Exception {
        ...
        org.easymock.EasyMock.expect(clusters.getCluster("test-cluster")).andReturn(cluster).anyTimes();
        org.easymock.EasyMock.expect(clusters.getClusterById(500L)).andReturn(cluster).anyTimes();
        org.easymock.EasyMock.expect(cluster.getClusterId()).andReturn(500L).anyTimes();
        org.easymock.EasyMock.expect(cluster.getClusterName()).andReturn("test-cluster").anyTimes();
        org.easymock.EasyMock.expect(request.getPropertyIds()).andReturn(propertyIds).anyTimes();
        org.easymock.EasyMock.expect(dao.findByNameAndForeignKeys(org.easymock.EasyMock.eq("test-artifact"), org.easymock.EasyMock.eq(foreignKeys))).andReturn(entity).once();
        org.easymock.EasyMock.expect(entity.getArtifactName()).andReturn("test-artifact").anyTimes();
        org.easymock.EasyMock.expect(entity.getForeignKeys()).andReturn(responseForeignKeys).anyTimes();
        org.easymock.EasyMock.expect(entity.getArtifactData()).andReturn(artifact_data).anyTimes();
        org.easymock.EasyMock.replay(dao, em, controller, request, clusters, cluster, entity, entity2);
    ...
    public void testGetResources_collection() throws java.lang.Exception {
        ...
        org.easymock.EasyMock.expect(cluster.getClusterName()).andReturn("test-cluster").anyTimes();
        org.easymock.EasyMock.expect(request.getPropertyIds()).andReturn(propertyIds).anyTimes();
        org.easymock.EasyMock.expect(dao.findByForeignKeys(org.easymock.EasyMock.eq(foreignKeys))).andReturn(entities).anyTimes();
        org.easymock.EasyMock.expect(entity.getArtifactName()).andReturn("test-artifact").anyTimes();
        org.easymock.EasyMock.expect(entity.getForeignKeys()).andReturn(responseForeignKeys).anyTimes();
        org.easymock.EasyMock.expect(entity.getArtifactData()).andReturn(artifact_data).anyTimes();
        org.easymock.EasyMock.expect(entity2.getArtifactName()).andReturn("test-artifact2").anyTimes();
        org.easymock.EasyMock.expect(entity2.getForeignKeys()).andReturn(responseForeignKeys).anyTimes();
        org.easymock.EasyMock.expect(entity2.getArtifactData()).andReturn(artifact_data2).anyTimes();
        org.easymock.EasyMock.replay(dao, em, controller, request, clusters, cluster, entity, entity2);
        org.apache.ambari.server.controller.utilities.PredicateBuilder pb = new org.apache.ambari.server.controller.utilities.PredicateBuilder();
    ...
    public void testCreateResource() throws java.lang.Exception {
        org.easymock.Capture<org.apache.ambari.server.orm.entities.ArtifactEntity> createEntityCapture = org.easymock.EasyMock.newCapture();
        ...
        org.easymock.EasyMock.expect(request.getRequestInfoProperties()).andReturn(requestInfoProps).anyTimes();
        org.easymock.EasyMock.expect(request.getProperties()).andReturn(requestProperties).anyTimes();
        org.easymock.EasyMock.expect(controller.getClusters()).andReturn(clusters).anyTimes();
        org.easymock.EasyMock.expect(clusters.getCluster("test-cluster")).andReturn(cluster).anyTimes();
        org.easymock.EasyMock.expect(clusters.getClusterById(500L)).andReturn(cluster).anyTimes();
        org.easymock.EasyMock.expect(cluster.getClusterId()).andReturn(500L).anyTimes();
        org.easymock.EasyMock.expect(cluster.getClusterName()).andReturn("test-cluster").anyTimes();
        org.easymock.EasyMock.expect(dao.findByNameAndForeignKeys(org.easymock.EasyMock.eq("test-artifact"), org.easymock.EasyMock.eq(foreignKeys))).andReturn(null).once();
        dao.create(org.easymock.EasyMock.capture(createEntityCapture));
        org.easymock.EasyMock.replay(dao, em, controller, request, clusters, cluster, entity, entity2);
    ...
    public void testUpdateResources() throws java.lang.Exception {
        java.util.Map<java.lang.String, java.lang.String> requestInfoProps = new java.util.HashMap<>();
        requestInfoProps.put(org.apache.ambari.server.controller.spi.Request.REQUEST_INFO_BODY_PROPERTY, bodyJson);
        org.easymock.Capture<org.apache.ambari.server.orm.entities.ArtifactEntity> updateEntityCapture = org.easymock.EasyMock.newCapture();
        org.easymock.Capture<org.apache.ambari.server.orm.entities.ArtifactEntity> updateEntityCapture2 = org.easymock.EasyMock.newCapture();
        java.util.Set<java.lang.String> propertyIds = new java.util.HashSet<>();
        java.util.TreeMap<java.lang.String, java.lang.String> foreignKeys = new java.util.TreeMap<>();
        foreignKeys.put("cluster", "500");
        java.util.List<org.apache.ambari.server.orm.entities.ArtifactEntity> entities = new java.util.ArrayList<>();
        ...
        org.easymock.EasyMock.expect(entity2.getForeignKeys()).andReturn(responseForeignKeys).anyTimes();
        org.easymock.EasyMock.expect(entity2.getArtifactData()).andReturn(artifact_data2).anyTimes();
        org.easymock.EasyMock.expect(dao.merge(org.easymock.EasyMock.capture(updateEntityCapture))).andReturn(entity).once();
        org.easymock.EasyMock.expect(dao.merge(org.easymock.EasyMock.capture(updateEntityCapture2))).andReturn(entity2).once();
        org.easymock.EasyMock.replay(dao, em, controller, request, clusters, cluster, entity, entity2);
        org.apache.ambari.server.controller.utilities.PredicateBuilder pb = new org.apache.ambari.server.controller.utilities.PredicateBuilder();
        org.apache.ambari.server.controller.spi.Predicate predicate = pb.begin().property("Artifacts/cluster_name").equals("test-cluster").end().toPredicate();
        ...
        org.easymock.EasyMock.verify(dao, em, controller, request, clusters, cluster, entity, entity2);
    }

    @org.junit.Test
    public void testDeleteResources() throws java.lang.Exception {
        org.easymock.Capture<org.apache.ambari.server.orm.entities.ArtifactEntity> deleteEntityCapture = org.easymock.EasyMock.newCapture();
        org.easymock.Capture<org.apache.ambari.server.orm.entities.ArtifactEntity> deleteEntityCapture2 = org.easymock.EasyMock.newCapture();
        java.util.TreeMap<java.lang.String, java.lang.String> foreignKeys = new java.util.TreeMap<>();
        foreignKeys.put("cluster", "500");
        java.util.List<org.apache.ambari.server.orm.entities.ArtifactEntity> entities = new java.util.ArrayList<>();
        entities.add(entity);
        ...
        org.easymock.IAnswer<org.apache.ambari.server.orm.entities.ArtifactEntity> findByNameAndForeignKeys = new org.easymock.IAnswer<org.apache.ambari.server.orm.entities.ArtifactEntity>() {
            ...
            public org.apache.ambari.server.orm.entities.ArtifactEntity answer() throws java.lang.Throwable {
                java.lang.String artifactName = ((java.lang.String) (org.easymock.EasyMock.getCurrentArguments()[0]));
        ...
        org.easymock.EasyMock.expect(dao.findByForeignKeys(org.easymock.EasyMock.eq(foreignKeys))).andReturn(entities).once();
        org.easymock.EasyMock.expect(dao.findByNameAndForeignKeys(org.easymock.EasyMock.anyString(), org.easymock.EasyMock.eq(foreignKeys))).andAnswer(findByNameAndForeignKeys).once();
        dao.remove(org.easymock.EasyMock.capture(deleteEntityCapture));
        org.easymock.EasyMock.expect(dao.findByNameAndForeignKeys(org.easymock.EasyMock.anyString(), org.easymock.EasyMock.eq(foreignKeys))).andAnswer(findByNameAndForeignKeys).once();
        dao.remove(org.easymock.EasyMock.capture(deleteEntityCapture2));
        org.easymock.EasyMock.replay(dao, em, controller, request, clusters, cluster, entity, entity2);
        org.apache.ambari.server.controller.utilities.PredicateBuilder pb = new org.apache.ambari.server.controller.utilities.PredicateBuilder();
        org.apache.ambari.server.controller.spi.Predicate predicate = pb.begin().property("Artifacts/cluster_name").equals("test-cluster").end().toPredicate();
