...
public class AtlasServerHttpPropertyRequestTest {
    ...
    public void testGetUrl() throws java.lang.Exception {
        ...
        org.easymock.EasyMock.expect(cluster.getDesiredConfigByType("application-properties")).andReturn(config).anyTimes();
        org.easymock.EasyMock.expect(config.getProperties()).andReturn(map).anyTimes();
