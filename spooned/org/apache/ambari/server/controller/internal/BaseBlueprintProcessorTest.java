...
public class BaseBlueprintProcessorTest {
    ...
    public void testStackRegisterConditionalDependencies() throws java.lang.Exception {
        ...
        org.easymock.EasyMock.expect(mockMgmtController.getStackServices(org.easymock.EasyMock.isA(java.util.Set.class))).andReturn(java.util.Collections.<org.apache.ambari.server.controller.StackServiceResponse>emptySet());
        org.easymock.EasyMock.expect(mockMgmtController.getStackLevelConfigurations(((java.util.Set<org.apache.ambari.server.controller.StackLevelConfigurationRequest>) (org.easymock.EasyMock.anyObject())))).andReturn(java.util.Collections.emptySet()).anyTimes();
