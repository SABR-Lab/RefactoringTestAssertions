...
public class BlueprintConfigurationProcessor {
    ...
    private static class DBTopologyUpdater extends org.apache.ambari.server.controller.internal.BlueprintConfigurationProcessor.SingleHostTopologyUpdater {
        ...
        private boolean isDatabaseManaged(java.util.Map<java.lang.String, java.util.Map<java.lang.String, java.lang.String>> properties) {
            java.util.Map<java.lang.String, java.lang.String> configMap = properties.get(configPropertyType);
            if (configMap == null) {
                org.apache.ambari.server.controller.internal.BlueprintConfigurationProcessor.LOG.warn("Config map is null for property type: {}", configPropertyType);
                return false;
            }
            java.lang.String conditionalValue = configMap.get(conditionalPropertyName);
            if (conditionalValue == null) {
                org.apache.ambari.server.controller.internal.BlueprintConfigurationProcessor.LOG.warn("Conditional value is null for property name: {}", conditionalPropertyName);
                return false;
            }
            boolean isManaged = conditionalValue.startsWith("New");
            org.apache.ambari.server.controller.internal.BlueprintConfigurationProcessor.LOG.info("Database managed status: {} for value: {}", isManaged, conditionalValue);
            return isManaged;
        }
    }
    ...
    private abstract static class AbstractPropertyValueDecorator implements org.apache.ambari.server.controller.internal.BlueprintConfigurationProcessor.PropertyUpdater {
    ...
    private abstract static class NonTopologyUpdater implements org.apache.ambari.server.controller.internal.BlueprintConfigurationProcessor.PropertyUpdater {
        @java.lang.Override
        public java.util.Collection<java.lang.String> getRequiredHostGroups(java.lang.String propertyName, java.lang.String origValue, java.util.Map<java.lang.String, java.util.Map<java.lang.String, java.lang.String>> properties, org.apache.ambari.server.topology.ClusterTopology topology) {
            return java.util.Collections.emptyList();
        }
    ...
    private abstract static class DependencyFilter implements org.apache.ambari.server.controller.internal.BlueprintConfigurationProcessor.PropertyFilter {
