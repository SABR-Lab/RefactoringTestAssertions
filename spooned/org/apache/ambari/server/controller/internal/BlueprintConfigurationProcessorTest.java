...
public class BlueprintConfigurationProcessorTest extends org.easymock.EasyMockSupport {
    ...
    public void init() throws java.lang.Exception {
        org.easymock.EasyMock.expect(bp.getStack()).andReturn(stack).anyTimes();
        org.easymock.EasyMock.expect(bp.getName()).andReturn("test-bp").anyTimes();
        org.easymock.EasyMock.expect(bp.getServiceInfos()).andReturn(java.util.Collections.emptyList()).anyTimes();
        org.easymock.EasyMock.expect(stack.getName()).andReturn(STACK_NAME).atLeastOnce();
        org.easymock.EasyMock.expect(stack.getVersion()).andReturn(STACK_VERSION).atLeastOnce();
        org.easymock.EasyMock.expect(stack.isMasterComponent(((java.lang.String) (org.easymock.EasyMock.anyObject())))).andReturn(false).anyTimes();
        org.easymock.EasyMock.expect(stack.getConfigurationPropertiesWithMetadata(org.easymock.EasyMock.anyObject(java.lang.String.class), org.easymock.EasyMock.anyObject(java.lang.String.class))).andReturn(java.util.Collections.emptyMap()).anyTimes();
        org.easymock.EasyMock.expect(stack.getConfiguration()).andReturn(org.apache.ambari.server.topology.Configuration.newEmpty()).anyTimes();
        org.easymock.EasyMock.expect(serviceInfo.getRequiredProperties()).andReturn(java.util.Collections.emptyMap()).anyTimes();
        org.easymock.EasyMock.expect(serviceInfo.getRequiredServices()).andReturn(java.util.Collections.emptyList()).anyTimes();
        ...
        for (java.util.Map.Entry<java.lang.String, java.util.Collection<java.lang.String>> entry : serviceComponents.entrySet()) {
            ...
            for (java.lang.String component : entry.getValue()) {
                org.easymock.EasyMock.expect(stack.getServiceForComponent(component)).andReturn(service).anyTimes();
            }
        }
        org.easymock.EasyMock.expect(stack.getCardinality("MYSQL_SERVER")).andReturn(new org.apache.ambari.server.topology.Cardinality("0-1")).anyTimes();
        java.util.Set<java.lang.String> emptySet = java.util.Collections.emptySet();
        org.easymock.EasyMock.expect(stack.getExcludedConfigurationTypes(org.easymock.EasyMock.anyObject(java.lang.String.class))).andReturn(emptySet).anyTimes();
        org.easymock.EasyMock.expect(ambariContext.getConfigHelper()).andReturn(configHelper).anyTimes();
        org.easymock.EasyMock.expect(configHelper.getDefaultStackProperties(org.easymock.EasyMock.eq(new org.apache.ambari.server.state.StackId(STACK_NAME, STACK_VERSION)))).andReturn(stackProperties).anyTimes();
        stackProperties.put(org.apache.ambari.server.state.ConfigHelper.CLUSTER_ENV, defaultClusterEnvProperties);
        org.easymock.EasyMock.expect(ambariContext.isClusterKerberosEnabled(1)).andReturn(true).once();
        org.easymock.EasyMock.expect(ambariContext.getClusterName(1L)).andReturn("clusterName").anyTimes();
        org.powermock.api.easymock.PowerMock.mockStatic(org.apache.ambari.server.controller.AmbariServer.class);
        org.easymock.EasyMock.expect(org.apache.ambari.server.controller.AmbariServer.getController()).andReturn(controller).anyTimes();
        ...
        org.easymock.EasyMock.expect(controller.getKerberosHelper()).andReturn(kerberosHelper).anyTimes();
        org.easymock.EasyMock.expect(controller.getClusters()).andReturn(clusters).anyTimes();
        org.easymock.EasyMock.expect(kerberosHelper.getKerberosDescriptor(cluster, false)).andReturn(kerberosDescriptor).anyTimes();
        java.util.Set<java.lang.String> properties = new java.util.HashSet<>();
        properties.add("core-site/hadoop.security.auth_to_local");
        org.easymock.EasyMock.expect(kerberosDescriptor.getAllAuthToLocalProperties()).andReturn(properties).anyTimes();
    }

    @org.junit.After
    public void tearDown() {
        org.easymock.EasyMock.reset(bp, serviceInfo, stack, ambariContext, configHelper);
    }
    ...
    public void testDoUpdateForBlueprintExport_DBHostProperty__External() throws java.lang.Exception {
        ...
        org.apache.ambari.server.controller.internal.BlueprintConfigurationProcessor configProcessor = new org.apache.ambari.server.controller.internal.BlueprintConfigurationProcessor(topology);
        configProcessor.doUpdateForBlueprintExport(org.apache.ambari.server.controller.internal.BlueprintExportType.FULL);
        org.junit.Assert.assertTrue(properties.get("hive-site").containsKey("javax.jdo.option.ConnectionURL"));
    }
    ...
    public void testHiveConfigExported() throws java.lang.Exception {
        ...
        org.junit.Assert.assertEquals("hive property not properly exported", (expectedHostName + ",") + expectedHostNameTwo, webHCatSiteProperties.get("templeton.hive.properties"));
    ...
    public void testOozieJDBCPropertiesNotRemoved() throws java.lang.Exception {
        ...
        hostGroups.add(group1);
        hostGroups.add(group2);
        org.easymock.EasyMock.expect(stack.getCardinality("OOZIE_SERVER")).andReturn(new org.apache.ambari.server.topology.Cardinality("1+")).anyTimes();
        org.apache.ambari.server.topology.ClusterTopology topology = createClusterTopology(bp, clusterConfig, hostGroups);
    ...
    public void testDoUpdateForClusterCreate_SingleHostProperty__MissingComponent() throws java.lang.Exception {
        ...
        hostGroups.add(group1);
        hostGroups.add(group2);
        org.easymock.EasyMock.expect(stack.getCardinality("NAMENODE")).andReturn(new org.apache.ambari.server.topology.Cardinality("1")).anyTimes();
        org.apache.ambari.server.topology.ClusterTopology topology = createClusterTopology(bp, clusterConfig, hostGroups);
        org.apache.ambari.server.controller.internal.BlueprintConfigurationProcessor updater = new org.apache.ambari.server.controller.internal.BlueprintConfigurationProcessor(topology);
        try {
            updater.doUpdateForClusterCreate();
    ...
    public void testDoUpdateForClusterCreate_SingleHostProperty__MultipleMatchingHostGroupsError() throws java.lang.Exception {
        ...
        hostGroups.add(group1);
        hostGroups.add(group2);
        org.easymock.EasyMock.expect(stack.getCardinality("NAMENODE")).andReturn(new org.apache.ambari.server.topology.Cardinality("0-1")).anyTimes();
        org.apache.ambari.server.topology.ClusterTopology topology = createClusterTopology(bp, clusterConfig, hostGroups);
        org.apache.ambari.server.controller.internal.BlueprintConfigurationProcessor updater = new org.apache.ambari.server.controller.internal.BlueprintConfigurationProcessor(topology);
        try {
            updater.doUpdateForClusterCreate();
    ...
    public void testDoUpdateForClusterCreate_SingleHostProperty__MultipleAppTimelineServer() throws java.lang.Exception {
        ...
        hostGroups.add(group1);
        hostGroups.add(group2);
        org.easymock.EasyMock.expect(stack.getCardinality("APP_TIMELINE_SERVER")).andReturn(new org.apache.ambari.server.topology.Cardinality("0-1")).anyTimes();
        org.easymock.EasyMock.expect(stack.getCardinality("TIMELINE_READER")).andReturn(new org.apache.ambari.server.topology.Cardinality("0-1")).anyTimes();
        org.apache.ambari.server.topology.ClusterTopology topology = createClusterTopology(bp, clusterConfig, hostGroups);
        org.apache.ambari.server.controller.internal.BlueprintConfigurationProcessor updater = new org.apache.ambari.server.controller.internal.BlueprintConfigurationProcessor(topology);
        updater.doUpdateForClusterCreate();
    ...
    public void testDoUpdateForClusterWithNameNodeHAEnabledSpecifyingHostNamesDirectly() throws java.lang.Exception {
        ...
        hostGroups.add(group1);
        hostGroups.add(group2);
        org.easymock.EasyMock.expect(stack.getCardinality("NAMENODE")).andReturn(new org.apache.ambari.server.topology.Cardinality("1-2")).anyTimes();
        org.easymock.EasyMock.expect(stack.getCardinality("SECONDARY_NAMENODE")).andReturn(new org.apache.ambari.server.topology.Cardinality("1")).anyTimes();
        org.apache.ambari.server.topology.ClusterTopology topology = createClusterTopology(bp, clusterConfig, hostGroups);
        org.apache.ambari.server.controller.internal.BlueprintConfigurationProcessor updater = new org.apache.ambari.server.controller.internal.BlueprintConfigurationProcessor(topology);
        updater.doUpdateForClusterCreate();
    ...
    public void testHiveConfigClusterUpdateSpecifyingHostNamesHiveServer2HA() throws java.lang.Exception {
        ...
        hostGroups.add(group1);
        hostGroups.add(group2);
        org.easymock.EasyMock.expect(stack.getCardinality("HIVE_SERVER")).andReturn(new org.apache.ambari.server.topology.Cardinality("1+")).anyTimes();
        org.apache.ambari.server.topology.ClusterTopology topology = createClusterTopology(bp, clusterConfig, hostGroups);
        org.apache.ambari.server.controller.internal.BlueprintConfigurationProcessor updater = new org.apache.ambari.server.controller.internal.BlueprintConfigurationProcessor(topology);
        updater.doUpdateForClusterCreate();
    ...
    public void testYarnHighAvailabilityConfigClusterUpdateSpecifyingHostNamesDirectly() throws java.lang.Exception {
        ...
        hostGroups.add(group1);
        hostGroups.add(group2);
        org.easymock.EasyMock.expect(stack.getCardinality("RESOURCEMANAGER")).andReturn(new org.apache.ambari.server.topology.Cardinality("1-2")).anyTimes();
        org.apache.ambari.server.topology.ClusterTopology topology = createClusterTopology(bp, clusterConfig, hostGroups);
        org.apache.ambari.server.controller.internal.BlueprintConfigurationProcessor updater = new org.apache.ambari.server.controller.internal.BlueprintConfigurationProcessor(topology);
        updater.doUpdateForClusterCreate();
    ...
    public void testExcludedPropertiesShouldBeAddedWhenServiceIsInBlueprint() throws java.lang.Exception {
        org.easymock.EasyMock.reset(stack);
        org.easymock.EasyMock.expect(stack.getName()).andReturn("testStack").anyTimes();
        org.easymock.EasyMock.expect(stack.getVersion()).andReturn("1").anyTimes();
        org.easymock.EasyMock.expect(stack.isMasterComponent(((java.lang.String) (org.easymock.EasyMock.anyObject())))).andReturn(false).anyTimes();
        org.easymock.EasyMock.expect(stack.getExcludedConfigurationTypes("FALCON")).andReturn(java.util.Collections.singleton("oozie-site"));
        org.easymock.EasyMock.expect(stack.getExcludedConfigurationTypes("OOZIE")).andReturn(java.util.Collections.emptySet());
        org.easymock.EasyMock.expect(stack.getConfigurationProperties("FALCON", "oozie-site")).andReturn(java.util.Collections.singletonMap("oozie.service.ELService.ext.functions.coord-job-submit-instances", "testValue")).anyTimes();
        org.easymock.EasyMock.expect(stack.getServiceForConfigType("oozie-site")).andReturn("OOZIE").anyTimes();
        java.util.Map<java.lang.String, java.util.Map<java.lang.String, java.lang.String>> properties = new java.util.HashMap<>();
        org.apache.ambari.server.topology.Configuration clusterConfig = new org.apache.ambari.server.topology.Configuration(properties, java.util.Collections.emptyMap());
        java.util.Collection<java.lang.String> hgComponents = new java.util.HashSet<>();
    ...
    public void testExcludedPropertiesShouldBeIgnoredWhenServiceIsNotInBlueprint() throws java.lang.Exception {
        ...
        org.easymock.EasyMock.expect(stack.getVersion()).andReturn("1").anyTimes();
        org.easymock.EasyMock.expect(stack.isMasterComponent(((java.lang.String) (org.easymock.EasyMock.anyObject())))).andReturn(false).anyTimes();
        org.easymock.EasyMock.expect(stack.getExcludedConfigurationTypes("FALCON")).andReturn(java.util.Collections.singleton("oozie-site")).anyTimes();
        org.easymock.EasyMock.expect(stack.getConfigurationProperties("FALCON", "oozie-site")).andReturn(java.util.Collections.singletonMap("oozie.service.ELService.ext.functions.coord-job-submit-instances", "testValue")).anyTimes();
        org.easymock.EasyMock.expect(stack.getServiceForConfigType("oozie-site")).andReturn("OOZIE").anyTimes();
        java.util.Map<java.lang.String, java.util.Map<java.lang.String, java.lang.String>> properties = new java.util.HashMap<>();
        org.apache.ambari.server.topology.Configuration clusterConfig = new org.apache.ambari.server.topology.Configuration(properties, java.util.Collections.emptyMap());
    ...
    public void testExcludedPropertiesHandlingWhenExcludedConfigServiceIsNotFoundInStack() throws java.lang.Exception {
        ...
        org.easymock.EasyMock.expect(stack.getExcludedConfigurationTypes("FALCON")).andReturn(excludedConfigTypes);
        org.easymock.EasyMock.expect(stack.getExcludedConfigurationTypes("OOZIE")).andReturn(java.util.Collections.emptySet());
        org.easymock.EasyMock.expect(stack.getConfigurationProperties("FALCON", "oozie-site")).andReturn(java.util.Collections.singletonMap("oozie.service.ELService.ext.functions.coord-job-submit-instances", "testValue")).anyTimes();
        org.easymock.EasyMock.expect(stack.getServiceForConfigType("oozie-site")).andReturn("OOZIE").anyTimes();
        org.easymock.EasyMock.expect(stack.getServiceForConfigType("storm-site")).andThrow(new java.lang.IllegalArgumentException("TEST: Configuration not found in stack definitions!"));
        java.util.Map<java.lang.String, java.util.Map<java.lang.String, java.lang.String>> properties = new java.util.HashMap<>();
        org.apache.ambari.server.topology.Configuration clusterConfig = new org.apache.ambari.server.topology.Configuration(properties, java.util.Collections.emptyMap());
        java.util.Collection<java.lang.String> hgComponents = new java.util.HashSet<>();
        hgComponents.add("FALCON_SERVER");
    ...
    public void testHiveConfigClusterUpdatePropertiesFilterAuthenticationOff() throws java.lang.Exception {
        ...
        java.util.Set<java.lang.String> emptySet = java.util.Collections.emptySet();
        org.easymock.EasyMock.expect(stack.getExcludedConfigurationTypes(org.easymock.EasyMock.anyObject(java.lang.String.class))).andReturn(emptySet).anyTimes();
        org.easymock.EasyMock.expect(stack.getServiceForConfigType("hive-site")).andReturn("HIVE").atLeastOnce();
        org.easymock.EasyMock.expect(stack.getConfigurationPropertiesWithMetadata("HIVE", "hive-site")).andReturn(mapOfMetadata).atLeastOnce();
        org.apache.ambari.server.topology.Configuration clusterConfig = new org.apache.ambari.server.topology.Configuration(properties, java.util.Collections.emptyMap());
        java.util.Collection<java.lang.String> hgComponents = new java.util.HashSet<>();
        hgComponents.add("NAMENODE");
        java.util.List<java.lang.String> hosts = new java.util.ArrayList<>();
    ...
    public void testHiveConfigClusterUpdatePropertiesFilterAuthenticationOffFilterThrowsError() throws java.lang.Exception {
        ...
        java.util.Set<java.lang.String> emptySet = java.util.Collections.emptySet();
        org.easymock.EasyMock.expect(stack.getExcludedConfigurationTypes(org.easymock.EasyMock.anyObject(java.lang.String.class))).andReturn(emptySet).anyTimes();
        org.easymock.EasyMock.expect(stack.getServiceForConfigType("hive-site")).andThrow(new java.lang.RuntimeException("Expected Test Error")).once();
        org.easymock.EasyMock.expect(stack.getConfigurationPropertiesWithMetadata("HIVE", "hive-site")).andReturn(mapOfMetadata).atLeastOnce();
        org.apache.ambari.server.topology.Configuration clusterConfig = new org.apache.ambari.server.topology.Configuration(properties, java.util.Collections.emptyMap());
        java.util.Collection<java.lang.String> hgComponents = new java.util.HashSet<>();
        hgComponents.add("NAMENODE");
    ...
    public void testHBaseConfigClusterUpdatePropertiesFilterAuthorizationOff() throws java.lang.Exception {
        ...
        java.util.Set<java.lang.String> emptySet = java.util.Collections.emptySet();
        org.easymock.EasyMock.expect(stack.getExcludedConfigurationTypes(org.easymock.EasyMock.anyObject(java.lang.String.class))).andReturn(emptySet).anyTimes();
        org.easymock.EasyMock.expect(stack.getServiceForConfigType("hbase-site")).andReturn("HBASE").atLeastOnce();
        org.easymock.EasyMock.expect(stack.getConfigurationPropertiesWithMetadata("HBASE", "hbase-site")).andReturn(mapOfMetadata).atLeastOnce();
        org.apache.ambari.server.topology.Configuration clusterConfig = new org.apache.ambari.server.topology.Configuration(properties, java.util.Collections.emptyMap());
        java.util.Collection<java.lang.String> hgComponents = new java.util.HashSet<>();
        hgComponents.add("NAMENODE");
        java.util.List<java.lang.String> hosts = new java.util.ArrayList<>();
    ...
    public void testStormAndKafkaConfigClusterUpdateWithoutGangliaServer() throws java.lang.Exception {
        ...
        java.util.Collection<org.apache.ambari.server.controller.internal.BlueprintConfigurationProcessorTest.TestHostGroup> hostGroups = new java.util.HashSet<>();
        hostGroups.add(group1);
        org.easymock.EasyMock.expect(stack.getCardinality("GANGLIA_SERVER")).andReturn(new org.apache.ambari.server.topology.Cardinality("1")).anyTimes();
        org.apache.ambari.server.topology.ClusterTopology topology = createClusterTopology(bp, clusterConfig, hostGroups);
        org.apache.ambari.server.controller.internal.BlueprintConfigurationProcessor updater = new org.apache.ambari.server.controller.internal.BlueprintConfigurationProcessor(topology);
        updater.doUpdateForClusterCreate();
    ...
    public void testDoUpdateForClusterWithNameNodeFederationEnabledErrorClusterNameNotFound() throws java.lang.Exception {
        ...
        org.easymock.EasyMock.expect(mockAmbariContext.getClusterName(1)).andReturn(null).anyTimes();
    ...
    public void testRecommendConfiguration_applyStackDefaultsOnly() throws java.lang.Exception {
        ...
        org.apache.ambari.server.controller.internal.BlueprintConfigurationProcessor configProcessor = new org.apache.ambari.server.controller.internal.BlueprintConfigurationProcessor(topology);
        org.easymock.EasyMock.reset(stack);
        org.easymock.EasyMock.expect(stack.getName()).andReturn(STACK_NAME).anyTimes();
        org.easymock.EasyMock.expect(stack.getVersion()).andReturn(STACK_VERSION).anyTimes();
        org.easymock.EasyMock.expect(stack.getConfiguration(bp.getServices())).andReturn(createStackDefaults()).anyTimes();
        java.util.Set<java.lang.String> emptySet = java.util.Collections.emptySet();
        org.easymock.EasyMock.expect(stack.getExcludedConfigurationTypes(org.easymock.EasyMock.anyObject(java.lang.String.class))).andReturn(emptySet).anyTimes();
        org.easymock.EasyMock.replay(stack);
    ...
    public void testHdfsWithNoRangerKmsServer() throws java.lang.Exception {
        org.easymock.EasyMock.expect(stack.getCardinality("NAMENODE")).andReturn(new org.apache.ambari.server.topology.Cardinality("1-2")).anyTimes();
        org.easymock.EasyMock.expect(stack.getCardinality("DATANODE")).andReturn(new org.apache.ambari.server.topology.Cardinality("1+")).anyTimes();
        org.easymock.EasyMock.expect(stack.getCardinality("RANGER_KMS_SERVER")).andReturn(new org.apache.ambari.server.topology.Cardinality("1+")).anyTimes();
        final java.lang.String configType = "hdfs-site";
        java.util.Map<java.lang.String, java.util.Map<java.lang.String, java.lang.String>> properties = new java.util.HashMap<>();
        java.util.Map<java.lang.String, java.lang.String> configProperties = new java.util.HashMap<>();
        properties.put(configType, configProperties);
    ...
    public void testStackPasswordPropertyFilter() throws java.lang.Exception {
        ...
        hostGroups.add(group1);
        hostGroups.add(group2);
        org.easymock.EasyMock.expect(stack.isPasswordProperty(((java.lang.String) (org.easymock.EasyMock.anyObject())), ((java.lang.String) (org.easymock.EasyMock.anyObject())), ((java.lang.String) (org.easymock.EasyMock.anyObject())))).andReturn(true).once();
        org.apache.ambari.server.topology.ClusterTopology topology = createClusterTopology(bp, clusterConfig, hostGroups);
        org.apache.ambari.server.controller.internal.BlueprintConfigurationProcessor configProcessor = new org.apache.ambari.server.controller.internal.BlueprintConfigurationProcessor(topology);
        configProcessor.doUpdateForBlueprintExport(org.apache.ambari.server.controller.internal.BlueprintExportType.FULL);
    ...
    public void testValuesTrimming() throws java.lang.Exception {
        ...
        org.easymock.EasyMock.expect(stack.getServiceForConfigType("hdfs-site")).andReturn("HDFS").anyTimes();
        org.easymock.EasyMock.expect(stack.getConfigurationPropertiesWithMetadata("HDFS", "hdfs-site")).andReturn(propertyConfigs).anyTimes();
        java.util.Map<java.lang.String, java.util.Map<java.lang.String, java.lang.String>> parentProperties = new java.util.HashMap<>();
        org.apache.ambari.server.topology.Configuration parentClusterConfig = new org.apache.ambari.server.topology.Configuration(parentProperties, java.util.Collections.emptyMap());
        org.apache.ambari.server.topology.Configuration clusterConfig = new org.apache.ambari.server.topology.Configuration(properties, java.util.Collections.emptyMap(), parentClusterConfig);
        java.util.Collection<java.lang.String> hgComponents1 = new java.util.HashSet<>();
    ...
    public void defaultConfigs() {
        ...
        org.easymock.EasyMock.expect(stack.getServices()).andReturn(services).anyTimes();
        org.easymock.EasyMock.expect(stack.getConfiguration()).andReturn(stackConfig).anyTimes();
        org.easymock.EasyMock.expect(topology.getConfiguration()).andReturn(clusterConfig).anyTimes();
        org.easymock.EasyMock.expect(topology.getHostGroupInfo()).andReturn(java.util.Collections.emptyMap()).anyTimes();
        org.easymock.EasyMock.replay(stack, topology);
        org.apache.ambari.server.controller.internal.BlueprintConfigurationProcessor updater = new org.apache.ambari.server.controller.internal.BlueprintConfigurationProcessor(topology);
    ...
    private org.apache.ambari.server.topology.ClusterTopology createClusterTopology(org.apache.ambari.server.topology.Blueprint blueprint, org.apache.ambari.server.topology.Configuration configuration, java.util.Collection<org.apache.ambari.server.controller.internal.BlueprintConfigurationProcessorTest.TestHostGroup> hostGroups, org.apache.ambari.server.topology.AmbariContext ambariContextReplacement) throws org.apache.ambari.server.topology.InvalidTopologyException {
        org.easymock.EasyMock.replay(stack, serviceInfo, ambariContext, configHelper, controller, kerberosHelper, kerberosDescriptor, clusters, cluster);
        ...
        org.easymock.EasyMock.expect(bp.getServices()).andReturn(allServices).anyTimes();
        for (org.apache.ambari.server.topology.HostGroup group : allHostGroups.values()) {
            org.easymock.EasyMock.expect(bp.getHostGroup(group.getName())).andReturn(group).anyTimes();
        }
        org.easymock.EasyMock.expect(bp.getHostGroups()).andReturn(allHostGroups).anyTimes();
        org.easymock.EasyMock.expect(topologyRequestMock.getClusterId()).andReturn(1L).anyTimes();
        org.easymock.EasyMock.expect(topologyRequestMock.getBlueprint()).andReturn(blueprint).anyTimes();
        org.easymock.EasyMock.expect(topologyRequestMock.getConfiguration()).andReturn(configuration).anyTimes();
        org.easymock.EasyMock.expect(topologyRequestMock.getHostGroupInfo()).andReturn(hostGroupInfo).anyTimes();
        org.easymock.EasyMock.replay(bp, topologyRequestMock);
