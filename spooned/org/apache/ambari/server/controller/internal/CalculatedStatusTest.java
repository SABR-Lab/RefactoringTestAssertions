...
public class CalculatedStatusTest {
    ...
    public void testSkippedFailed_UpgradeGroup() throws java.lang.Exception {
        final org.apache.ambari.server.orm.dao.HostRoleCommandStatusSummaryDTO summary1 = org.easymock.EasyMock.createNiceMock(org.apache.ambari.server.orm.dao.HostRoleCommandStatusSummaryDTO.class);
        ...
        final org.apache.ambari.server.orm.dao.HostRoleCommandStatusSummaryDTO summary2 = org.easymock.EasyMock.createNiceMock(org.apache.ambari.server.orm.dao.HostRoleCommandStatusSummaryDTO.class);
        ...
        org.easymock.EasyMock.expect(summary1.getTaskTotal()).andReturn(taskStatuses1.size()).anyTimes();
        org.easymock.EasyMock.expect(summary2.getTaskTotal()).andReturn(taskStatuses2.size()).anyTimes();
        org.easymock.EasyMock.expect(summary1.isStageSkippable()).andReturn(true).anyTimes();
        org.easymock.EasyMock.expect(summary2.isStageSkippable()).andReturn(true).anyTimes();
        org.easymock.EasyMock.expect(summary1.getTaskStatuses()).andReturn(taskStatuses1).anyTimes();
        org.easymock.EasyMock.expect(summary2.getTaskStatuses()).andReturn(taskStatuses2).anyTimes();
        org.easymock.EasyMock.replay(summary1, summary2);
