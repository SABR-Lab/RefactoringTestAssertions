...
public class ClusterControllerImplTest {
    ...
    public void testResourceProviderResponse() throws java.lang.Exception {
        org.apache.ambari.server.controller.spi.ProviderModule providerModule = org.easymock.EasyMock.createNiceMock(org.apache.ambari.server.controller.spi.ProviderModule.class);
        org.apache.ambari.server.controller.spi.ResourceProvider resourceProvider = org.easymock.EasyMock.createNiceMock(org.apache.ambari.server.controller.spi.ResourceProvider.class);
        org.easymock.EasyMock.expect(providerModule.getResourceProvider(org.apache.ambari.server.controller.spi.Resource.Type.AlertHistory)).andReturn(resourceProvider).anyTimes();
        org.easymock.EasyMock.expect(resourceProvider.checkPropertyIds(java.util.Collections.singleton(org.apache.ambari.server.controller.internal.AlertHistoryResourceProvider.ALERT_HISTORY_HOSTNAME))).andReturn(java.util.Collections.emptySet()).anyTimes();
        org.easymock.EasyMock.expect(resourceProvider.getResources(org.easymock.EasyMock.anyObject(org.apache.ambari.server.controller.spi.Request.class), org.easymock.EasyMock.anyObject(org.apache.ambari.server.controller.spi.Predicate.class))).andReturn(java.util.Collections.emptySet()).anyTimes();
        org.easymock.EasyMock.expect(resourceProvider.checkPropertyIds(org.easymock.EasyMock.anyObject())).andReturn(new java.util.HashSet<>()).anyTimes();
        ...
        org.easymock.EasyMock.expect(sortRequest.getPropertyIds()).andReturn(new java.util.ArrayList<>()).atLeastOnce();
        org.easymock.EasyMock.replay(providerModule, resourceProvider, pageRequest, sortRequest);
        org.apache.ambari.server.controller.internal.ClusterControllerImpl controller = new org.apache.ambari.server.controller.internal.ClusterControllerImpl(providerModule);
        java.util.Set<java.lang.String> propertyIds = new java.util.HashSet<>();
        ...
        org.easymock.EasyMock.verify(providerModule, resourceProvider, pageRequest, sortRequest);
    }
