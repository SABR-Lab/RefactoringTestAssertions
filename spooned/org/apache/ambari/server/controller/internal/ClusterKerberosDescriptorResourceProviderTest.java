...
public class ClusterKerberosDescriptorResourceProviderTest extends org.easymock.EasyMockSupport {
    ...
    private void testGetResources(org.springframework.security.core.Authentication authentication) throws java.lang.Exception {
        ...
        org.easymock.EasyMock.expect(clusters.getCluster("c1")).andReturn(cluster).atLeastOnce();
        org.apache.ambari.server.controller.AmbariManagementController managementController = createMock(org.apache.ambari.server.controller.AmbariManagementController.class);
        org.easymock.EasyMock.expect(managementController.getClusters()).andReturn(clusters).atLeastOnce();
        org.apache.ambari.server.controller.spi.Request request = createMock(org.apache.ambari.server.controller.spi.Request.class);
        org.easymock.EasyMock.expect(request.getPropertyIds()).andReturn(null).once();
        replayAll();
        org.springframework.security.core.context.SecurityContextHolder.getContext().setAuthentication(authentication);
        org.apache.ambari.server.controller.spi.ResourceProvider provider = org.apache.ambari.server.controller.internal.AbstractControllerResourceProvider.getResourceProvider(org.apache.ambari.server.controller.spi.Resource.Type.ClusterKerberosDescriptor, managementController);
    ...
    private void testGetResourcesWithPredicate(org.springframework.security.core.Authentication authentication) throws java.lang.Exception {
        ...
        org.easymock.EasyMock.expect(kerberosHelper.getKerberosDescriptor(org.easymock.EasyMock.eq(org.apache.ambari.server.controller.KerberosHelper.KerberosDescriptorType.STACK), org.easymock.EasyMock.eq(cluster), org.easymock.EasyMock.eq(false), org.easymock.EasyMock.anyObject(java.util.Collection.class), org.easymock.EasyMock.eq(false), org.easymock.EasyMock.anyObject(), org.easymock.EasyMock.anyObject())).andReturn(stackKerberosDescriptor).atLeastOnce();
        org.easymock.EasyMock.expect(kerberosHelper.getKerberosDescriptor(org.easymock.EasyMock.eq(org.apache.ambari.server.controller.KerberosHelper.KerberosDescriptorType.USER), org.easymock.EasyMock.eq(cluster), org.easymock.EasyMock.eq(false), org.easymock.EasyMock.anyObject(java.util.Collection.class), org.easymock.EasyMock.eq(false), org.easymock.EasyMock.anyObject(), org.easymock.EasyMock.anyObject())).andReturn(userKerberosDescriptor).atLeastOnce();
        org.easymock.EasyMock.expect(kerberosHelper.getKerberosDescriptor(org.easymock.EasyMock.eq(org.apache.ambari.server.controller.KerberosHelper.KerberosDescriptorType.COMPOSITE), org.easymock.EasyMock.eq(cluster), org.easymock.EasyMock.eq(false), org.easymock.EasyMock.anyObject(java.util.Collection.class), org.easymock.EasyMock.eq(false), org.easymock.EasyMock.anyObject(), org.easymock.EasyMock.anyObject())).andReturn(compositeKerberosDescriptor).atLeastOnce();
        org.apache.ambari.server.controller.AmbariManagementController managementController = createMock(org.apache.ambari.server.controller.AmbariManagementController.class);
        org.easymock.EasyMock.expect(managementController.getClusters()).andReturn(clusters).atLeastOnce();
        org.easymock.EasyMock.expect(managementController.getKerberosHelper()).andReturn(kerberosHelper).atLeastOnce();
        org.apache.ambari.server.controller.spi.Request request = createMock(org.apache.ambari.server.controller.spi.Request.class);
        org.easymock.EasyMock.expect(request.getPropertyIds()).andReturn(null).atLeastOnce();
        org.easymock.EasyMock.expect(request.getRequestInfoProperties()).andReturn(java.util.Collections.emptyMap()).atLeastOnce();
        replayAll();
        org.springframework.security.core.context.SecurityContextHolder.getContext().setAuthentication(authentication);
        org.apache.ambari.server.controller.spi.ResourceProvider provider = org.apache.ambari.server.controller.internal.AbstractControllerResourceProvider.getResourceProvider(org.apache.ambari.server.controller.spi.Resource.Type.ClusterKerberosDescriptor, managementController);
    ...
    private void testGetResourcesWithPredicateAndDirectives(org.springframework.security.core.Authentication authentication) throws java.lang.Exception {
        ...
        org.apache.ambari.server.state.kerberos.KerberosDescriptor compositeKerberosDescriptor = kerberosDescriptorFactory.createInstance(org.apache.ambari.server.controller.internal.ClusterKerberosDescriptorResourceProviderTest.STACK_MAP);
        compositeKerberosDescriptor.update(userKerberosDescriptor);
        org.easymock.Capture<? extends java.util.Collection<java.lang.String>> captureAdditionalServices = org.easymock.EasyMock.newCapture(org.easymock.CaptureType.ALL);
        org.apache.ambari.server.controller.KerberosHelper kerberosHelper = createMock(org.apache.ambari.server.controller.KerberosHelper.class);
        org.easymock.EasyMock.expect(kerberosHelper.getKerberosDescriptor(org.easymock.EasyMock.eq(org.apache.ambari.server.controller.KerberosHelper.KerberosDescriptorType.STACK), org.easymock.EasyMock.eq(cluster), org.easymock.EasyMock.eq(true), org.easymock.EasyMock.capture(captureAdditionalServices), org.easymock.EasyMock.eq(false), org.easymock.EasyMock.anyObject(), org.easymock.EasyMock.anyObject())).andReturn(stackKerberosDescriptor).atLeastOnce();
        org.easymock.EasyMock.expect(kerberosHelper.getKerberosDescriptor(org.easymock.EasyMock.eq(org.apache.ambari.server.controller.KerberosHelper.KerberosDescriptorType.USER), org.easymock.EasyMock.eq(cluster), org.easymock.EasyMock.eq(true), org.easymock.EasyMock.capture(captureAdditionalServices), org.easymock.EasyMock.eq(false), org.easymock.EasyMock.anyObject(), org.easymock.EasyMock.anyObject())).andReturn(userKerberosDescriptor).atLeastOnce();
        org.easymock.EasyMock.expect(kerberosHelper.getKerberosDescriptor(org.easymock.EasyMock.eq(org.apache.ambari.server.controller.KerberosHelper.KerberosDescriptorType.COMPOSITE), org.easymock.EasyMock.eq(cluster), org.easymock.EasyMock.eq(true), org.easymock.EasyMock.capture(captureAdditionalServices), org.easymock.EasyMock.eq(false), org.easymock.EasyMock.anyObject(), org.easymock.EasyMock.anyObject())).andReturn(compositeKerberosDescriptor).atLeastOnce();
        org.apache.ambari.server.controller.AmbariManagementController managementController = createMock(org.apache.ambari.server.controller.AmbariManagementController.class);
        org.easymock.EasyMock.expect(managementController.getClusters()).andReturn(clusters).atLeastOnce();
        org.easymock.EasyMock.expect(managementController.getKerberosHelper()).andReturn(kerberosHelper).atLeastOnce();
        ...
        org.apache.ambari.server.controller.spi.Request request = createMock(org.apache.ambari.server.controller.spi.Request.class);
        org.easymock.EasyMock.expect(request.getPropertyIds()).andReturn(null).atLeastOnce();
        org.easymock.EasyMock.expect(request.getRequestInfoProperties()).andReturn(requestInfoProperties).atLeastOnce();
        replayAll();
        org.springframework.security.core.context.SecurityContextHolder.getContext().setAuthentication(authentication);
        org.apache.ambari.server.controller.spi.ResourceProvider provider = org.apache.ambari.server.controller.internal.AbstractControllerResourceProvider.getResourceProvider(org.apache.ambari.server.controller.spi.Resource.Type.ClusterKerberosDescriptor, managementController);
        org.apache.ambari.server.controller.spi.Predicate clusterPredicate = new org.apache.ambari.server.controller.utilities.PredicateBuilder().property(org.apache.ambari.server.controller.internal.ClusterKerberosDescriptorResourceProvider.CLUSTER_KERBEROS_DESCRIPTOR_CLUSTER_NAME_PROPERTY_ID).equals("c1").toPredicate();
    ...
    private void testGetResourcesWithInvalidKerberosDescriptorType(org.springframework.security.core.Authentication authentication) throws java.lang.Exception {
        ...
        org.easymock.EasyMock.expect(stackVersion.getStackName()).andReturn("stackName").atLeastOnce();
        org.easymock.EasyMock.expect(stackVersion.getStackVersion()).andReturn("stackVersion").atLeastOnce();
        org.apache.ambari.server.state.Cluster cluster = createMock(org.apache.ambari.server.state.Cluster.class);
        org.easymock.EasyMock.expect(cluster.getResourceId()).andReturn(4L).atLeastOnce();
        org.easymock.EasyMock.expect(cluster.getCurrentStackVersion()).andReturn(stackVersion).atLeastOnce();
        org.apache.ambari.server.state.Clusters clusters = createMock(org.apache.ambari.server.state.Clusters.class);
        org.easymock.EasyMock.expect(clusters.getCluster("c1")).andReturn(cluster).atLeastOnce();
        ...
        org.easymock.EasyMock.expect(kerberosDescriptor.toMap()).andReturn(org.apache.ambari.server.controller.internal.ClusterKerberosDescriptorResourceProviderTest.STACK_MAP).atLeastOnce();
        ...
        org.easymock.EasyMock.expect(metaInfo.getKerberosDescriptor("stackName", "stackVersion", false)).andReturn(kerberosDescriptor).atLeastOnce();
        org.apache.ambari.server.controller.AmbariManagementController managementController = createMock(org.apache.ambari.server.controller.AmbariManagementController.class);
        org.easymock.EasyMock.expect(managementController.getClusters()).andReturn(clusters).atLeastOnce();
        org.easymock.EasyMock.expect(managementController.getAmbariMetaInfo()).andReturn(metaInfo).atLeastOnce();
        org.apache.ambari.server.controller.spi.Request request = createMock(org.apache.ambari.server.controller.spi.Request.class);
        org.easymock.EasyMock.expect(request.getPropertyIds()).andReturn(null).once();
        replayAll();
        org.springframework.security.core.context.SecurityContextHolder.getContext().setAuthentication(authentication);
