...
public class CompatibleRepositoryVersionResourceProviderTest {
    ...
    public void before() throws java.lang.Exception {
        ...
        org.easymock.EasyMock.expect(repoVersionDAO.findByStack(org.apache.ambari.server.controller.internal.CompatibleRepositoryVersionResourceProviderTest.stackId11)).andReturn(java.util.Collections.singletonList(entity1)).atLeastOnce();
        org.easymock.EasyMock.expect(repoVersionDAO.findByStack(org.apache.ambari.server.controller.internal.CompatibleRepositoryVersionResourceProviderTest.stackId22)).andReturn(java.util.Collections.singletonList(entity2)).atLeastOnce();
        org.easymock.EasyMock.replay(repoVersionDAO);
        ...
        org.easymock.EasyMock.expect(ambariMetaInfo.getStack("HDP", "1.1")).andReturn(stack1).atLeastOnce();
        org.easymock.EasyMock.expect(ambariMetaInfo.getStack("HDP", "2.2")).andReturn(stack2).atLeastOnce();
        org.easymock.EasyMock.expect(ambariMetaInfo.getUpgradePacks("HDP", "1.1")).andReturn(stack1.getUpgradePacks()).atLeastOnce();
        org.easymock.EasyMock.expect(ambariMetaInfo.getUpgradePacks("HDP", "2.2")).andReturn(stack2.getUpgradePacks()).atLeastOnce();
        org.easymock.EasyMock.replay(ambariMetaInfo);
    ...
    public void testGetResources() throws java.lang.Exception {
        ...
        org.easymock.EasyMock.expect(mockXml.getAvailableServices(((org.apache.ambari.server.state.StackInfo) (org.easymock.EasyMock.anyObject())))).andReturn(java.util.Collections.singletonList(mockAvailable)).atLeastOnce();
        org.easymock.EasyMock.expect(mockXml.getStackServices(((org.apache.ambari.server.state.StackInfo) (org.easymock.EasyMock.anyObject())))).andReturn(java.util.Collections.singletonList(mockStackService)).atLeastOnce();
        org.easymock.EasyMock.replay(mockXml);
