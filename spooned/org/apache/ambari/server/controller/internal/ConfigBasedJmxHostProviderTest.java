...
public class ConfigBasedJmxHostProviderTest extends org.easymock.EasyMockSupport {
    ...
    public void testGetsUriFromConfigWhenHostIsOverridden() throws java.lang.Exception {
        org.easymock.EasyMock.expect(configHelper.getEffectiveConfigProperties(org.apache.ambari.server.controller.internal.ConfigBasedJmxHostProviderTest.CLUSTER_1, null)).andReturn(config()).anyTimes();
        replayAll();
