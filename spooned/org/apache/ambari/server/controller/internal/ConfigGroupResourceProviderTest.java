...
public class ConfigGroupResourceProviderTest {
    ...
    public void setup() throws java.lang.Exception {
        ...
        hostDAO = org.easymock.EasyMock.createStrictMock(org.apache.ambari.server.orm.dao.HostDAO.class);
    ...
    private org.apache.ambari.server.controller.internal.ConfigGroupResourceProvider getConfigGroupResourceProvider(org.apache.ambari.server.controller.AmbariManagementController managementController) throws java.lang.NoSuchFieldException, java.lang.IllegalAccessException {
        ...
        org.easymock.EasyMock.expect(configHelperProvider.get()).andReturn(org.easymock.EasyMock.createNiceMock(org.apache.ambari.server.state.ConfigHelper.class));
        org.easymock.EasyMock.replay(configHelperProvider);
    ...
    private void testCreateConfigGroup(org.springframework.security.core.Authentication authentication) throws java.lang.Exception {
        ...
        org.apache.ambari.server.state.Host h1 = org.easymock.EasyMock.createNiceMock(org.apache.ambari.server.state.Host.class);
        org.apache.ambari.server.state.Host h2 = org.easymock.EasyMock.createNiceMock(org.apache.ambari.server.state.Host.class);
        org.apache.ambari.server.orm.entities.HostEntity hostEntity1 = org.easymock.EasyMock.createMock(org.apache.ambari.server.orm.entities.HostEntity.class);
        org.apache.ambari.server.orm.entities.HostEntity hostEntity2 = org.easymock.EasyMock.createMock(org.apache.ambari.server.orm.entities.HostEntity.class);
        org.apache.ambari.server.state.configgroup.ConfigGroupFactory configGroupFactory = org.easymock.EasyMock.createNiceMock(org.apache.ambari.server.state.configgroup.ConfigGroupFactory.class);
        org.apache.ambari.server.state.configgroup.ConfigGroup configGroup = org.easymock.EasyMock.createNiceMock(org.apache.ambari.server.state.configgroup.ConfigGroup.class);
        ...
        org.easymock.EasyMock.expect(clusters.getHost("h1")).andReturn(h1);
        org.easymock.EasyMock.expect(clusters.getHost("h2")).andReturn(h2);
        org.easymock.EasyMock.expect(cluster.getClusterName()).andReturn("Cluster100").anyTimes();
        org.easymock.EasyMock.expect(cluster.isConfigTypeExists(org.easymock.EasyMock.anyString())).andReturn(true).anyTimes();
        org.easymock.EasyMock.expect(managementController.getConfigGroupFactory()).andReturn(configGroupFactory);
        org.easymock.EasyMock.expect(managementController.getAuthName()).andReturn("admin").anyTimes();
        org.easymock.EasyMock.expect(hostDAO.findByName("h1")).andReturn(hostEntity1).atLeastOnce();
        org.easymock.EasyMock.expect(hostDAO.findByName("h2")).andReturn(hostEntity2).atLeastOnce();
        org.easymock.EasyMock.expect(hostEntity1.getHostId()).andReturn(1L).atLeastOnce();
        org.easymock.EasyMock.expect(hostEntity2.getHostId()).andReturn(2L).atLeastOnce();
        org.easymock.Capture<org.apache.ambari.server.state.Cluster> clusterCapture = org.easymock.EasyMock.newCapture();
        org.easymock.Capture<java.lang.String> serviceName = org.easymock.EasyMock.newCapture();
        org.easymock.Capture<java.lang.String> captureName = org.easymock.EasyMock.newCapture();
        org.easymock.Capture<java.lang.String> captureDesc = org.easymock.EasyMock.newCapture();
        org.easymock.Capture<java.lang.String> captureTag = org.easymock.EasyMock.newCapture();
        org.easymock.Capture<java.util.Map<java.lang.String, org.apache.ambari.server.state.Config>> captureConfigs = org.easymock.EasyMock.newCapture();
        org.easymock.Capture<java.util.Map<java.lang.Long, org.apache.ambari.server.state.Host>> captureHosts = org.easymock.EasyMock.newCapture();
        org.easymock.EasyMock.expect(configGroupFactory.createNew(org.easymock.EasyMock.capture(clusterCapture), org.easymock.EasyMock.capture(serviceName), org.easymock.EasyMock.capture(captureName), org.easymock.EasyMock.capture(captureTag), org.easymock.EasyMock.capture(captureDesc), org.easymock.EasyMock.capture(captureConfigs), org.easymock.EasyMock.capture(captureHosts))).andReturn(configGroup);
        org.easymock.EasyMock.replay(managementController, clusters, cluster, configGroupFactory, configGroup, response, hostDAO, hostEntity1, hostEntity2);
        ...
        org.easymock.EasyMock.verify(managementController, clusters, cluster, configGroupFactory, configGroup, response, hostDAO, hostEntity1, hostEntity2);
    ...
    private void testDuplicateNameConfigGroup(org.springframework.security.core.Authentication authentication) throws java.lang.Exception {
        ...
        org.easymock.EasyMock.expect(managementController.getClusters()).andReturn(clusters).anyTimes();
        org.easymock.EasyMock.expect(clusters.getCluster("Cluster100")).andReturn(cluster).anyTimes();
        org.easymock.EasyMock.expect(managementController.getConfigGroupFactory()).andReturn(configGroupFactory).anyTimes();
        org.easymock.EasyMock.expect(managementController.getAuthName()).andReturn("admin").anyTimes();
        org.easymock.EasyMock.expect(cluster.getConfigGroups()).andReturn(configGroupMap);
        org.easymock.EasyMock.expect(configGroupFactory.createNew(((org.apache.ambari.server.state.Cluster) (org.easymock.EasyMock.anyObject())), ((java.lang.String) (org.easymock.EasyMock.anyObject())), ((java.lang.String) (org.easymock.EasyMock.anyObject())), ((java.lang.String) (org.easymock.EasyMock.anyObject())), ((java.lang.String) (org.easymock.EasyMock.anyObject())), org.easymock.EasyMock.anyObject(), org.easymock.EasyMock.anyObject())).andReturn(configGroup).anyTimes();
        org.easymock.EasyMock.expect(configGroup.getClusterName()).andReturn("Cluster100").anyTimes();
        org.easymock.EasyMock.expect(configGroup.getName()).andReturn("test-1").anyTimes();
        org.easymock.EasyMock.expect(configGroup.getTag()).andReturn("tag-1").anyTimes();
        org.easymock.EasyMock.replay(managementController, clusters, cluster, configGroupFactory, configGroup, response);
        org.apache.ambari.server.controller.spi.ResourceProvider provider = getConfigGroupResourceProvider(managementController);
        java.util.Map<java.lang.String, java.lang.Object> properties = new java.util.LinkedHashMap<>();
        java.util.Set<java.util.Map<java.lang.String, java.lang.Object>> propertySet = new java.util.LinkedHashSet<>();
        properties.put(org.apache.ambari.server.controller.internal.ConfigGroupResourceProvider.CLUSTER_NAME, "Cluster100");
        ...
        org.easymock.EasyMock.verify(managementController, clusters, cluster, configGroupFactory, configGroup, response);
    ...
    public void testUpdateConfigGroupWithWrongConfigType() throws java.lang.Exception {
        ...
        org.apache.ambari.server.orm.entities.HostEntity hostEntity1 = org.easymock.EasyMock.createMock(org.apache.ambari.server.orm.entities.HostEntity.class);
        org.apache.ambari.server.orm.entities.HostEntity hostEntity2 = org.easymock.EasyMock.createMock(org.apache.ambari.server.orm.entities.HostEntity.class);
        final org.apache.ambari.server.state.configgroup.ConfigGroup configGroup = org.easymock.EasyMock.createNiceMock(org.apache.ambari.server.state.configgroup.ConfigGroup.class);
        org.apache.ambari.server.controller.ConfigGroupResponse configGroupResponse = org.easymock.EasyMock.createNiceMock(org.apache.ambari.server.controller.ConfigGroupResponse.class);
        org.easymock.EasyMock.expect(cluster.isConfigTypeExists("core-site")).andReturn(false).anyTimes();
        org.easymock.EasyMock.expect(managementController.getClusters()).andReturn(clusters).anyTimes();
        org.easymock.EasyMock.expect(managementController.getAuthName()).andReturn("admin").anyTimes();
        org.easymock.EasyMock.expect(clusters.getCluster("Cluster100")).andReturn(cluster).anyTimes();
        org.easymock.EasyMock.expect(clusters.getHost("h1")).andReturn(h1);
        org.easymock.EasyMock.expect(clusters.getHost("h2")).andReturn(h2);
        org.easymock.EasyMock.expect(hostDAO.findByName("h1")).andReturn(hostEntity1).anyTimes();
        org.easymock.EasyMock.expect(hostDAO.findById(1L)).andReturn(hostEntity1).anyTimes();
        org.easymock.EasyMock.expect(hostDAO.findByName("h2")).andReturn(hostEntity2).anyTimes();
        org.easymock.EasyMock.expect(hostDAO.findById(2L)).andReturn(hostEntity2).anyTimes();
        org.easymock.EasyMock.expect(hostEntity1.getHostId()).andReturn(1L).atLeastOnce();
        org.easymock.EasyMock.expect(hostEntity2.getHostId()).andReturn(2L).atLeastOnce();
        ...
        org.easymock.EasyMock.expect(configGroup.getName()).andReturn("test-1").anyTimes();
        org.easymock.EasyMock.expect(configGroup.getId()).andReturn(25L).anyTimes();
        org.easymock.EasyMock.expect(configGroup.getTag()).andReturn("tag-1").anyTimes();
        org.easymock.EasyMock.expect(configGroup.convertToResponse()).andReturn(configGroupResponse).anyTimes();
        org.easymock.EasyMock.expect(configGroupResponse.getClusterName()).andReturn("Cluster100").anyTimes();
        org.easymock.EasyMock.expect(configGroupResponse.getId()).andReturn(25L).anyTimes();
        org.easymock.EasyMock.expect(cluster.getConfigGroups()).andStubAnswer(new org.easymock.IAnswer<java.util.Map<java.lang.Long, org.apache.ambari.server.state.configgroup.ConfigGroup>>() {
            @java.lang.Override
        ...
        org.easymock.EasyMock.replay(managementController, clusters, cluster, configGroup, response, configGroupResponse, configHelper, hostDAO, hostEntity1, hostEntity2, h1, h2);
        org.apache.ambari.server.controller.spi.ResourceProvider provider = getConfigGroupResourceProvider(managementController);
        java.util.Map<java.lang.String, java.lang.Object> properties = new java.util.LinkedHashMap<>();
        java.util.Set<java.util.Map<java.lang.String, java.lang.Object>> hostSet = new java.util.HashSet<>();
        java.util.Map<java.lang.String, java.lang.Object> host1 = new java.util.HashMap<>();
        ...
        org.easymock.EasyMock.verify(managementController, clusters, cluster, configGroup, response, configGroupResponse, configHelper, hostDAO, hostEntity1, hostEntity2, h1, h2);
    }
    ...
    private void testUpdateConfigGroup(org.springframework.security.core.Authentication authentication) throws java.lang.Exception {
        ...
        final org.apache.ambari.server.state.configgroup.ConfigGroup configGroup = org.easymock.EasyMock.createNiceMock(org.apache.ambari.server.state.configgroup.ConfigGroup.class);
        org.apache.ambari.server.controller.ConfigGroupResponse configGroupResponse = org.easymock.EasyMock.createNiceMock(org.apache.ambari.server.controller.ConfigGroupResponse.class);
        org.easymock.EasyMock.expect(cluster.isConfigTypeExists("core-site")).andReturn(true).anyTimes();
        org.easymock.EasyMock.expect(managementController.getClusters()).andReturn(clusters).anyTimes();
        org.easymock.EasyMock.expect(managementController.getAuthName()).andReturn("admin").anyTimes();
        org.easymock.EasyMock.expect(clusters.getCluster("Cluster100")).andReturn(cluster).anyTimes();
        org.easymock.EasyMock.expect(clusters.getHost("h1")).andReturn(h1);
        ...
        org.easymock.EasyMock.expect(h1.getHostId()).andReturn(1L).anyTimes();
        org.easymock.EasyMock.expect(h2.getHostId()).andReturn(2L).anyTimes();
        org.easymock.EasyMock.expect(managementController.getConfigGroupUpdateResults(((org.apache.ambari.server.controller.ConfigGroupRequest) (org.easymock.EasyMock.anyObject())))).andReturn(new org.apache.ambari.server.controller.ConfigGroupResponse(1L, "", "", "", "", new java.util.HashSet<>(), new java.util.HashSet<>())).atLeastOnce();
        org.easymock.EasyMock.expect(configGroup.getName()).andReturn("test-1").anyTimes();
        org.easymock.EasyMock.expect(configGroup.getId()).andReturn(25L).anyTimes();
        org.easymock.EasyMock.expect(configGroup.getTag()).andReturn("tag-1").anyTimes();
        org.easymock.EasyMock.expect(configGroup.convertToResponse()).andReturn(configGroupResponse).anyTimes();
    ...
    private void testGetConfigGroup(org.springframework.security.core.Authentication authentication) throws java.lang.Exception {
        ...
        org.apache.ambari.server.orm.entities.HostEntity hostEntity1 = org.easymock.EasyMock.createMock(org.apache.ambari.server.orm.entities.HostEntity.class);
        org.easymock.EasyMock.expect(hostDAO.getHostNamesByHostIds(hostIds)).andReturn(hostNames).atLeastOnce();
        org.easymock.EasyMock.expect(hostDAO.findByName("h1")).andReturn(hostEntity1).anyTimes();
        org.easymock.EasyMock.expect(hostEntity1.getHostId()).andReturn(host1Id).anyTimes();
        org.apache.ambari.server.state.configgroup.ConfigGroup configGroup1 = org.easymock.EasyMock.createNiceMock(org.apache.ambari.server.state.configgroup.ConfigGroup.class);
        org.apache.ambari.server.state.configgroup.ConfigGroup configGroup2 = org.easymock.EasyMock.createNiceMock(org.apache.ambari.server.state.configgroup.ConfigGroup.class);
        org.apache.ambari.server.state.configgroup.ConfigGroup configGroup3 = org.easymock.EasyMock.createNiceMock(org.apache.ambari.server.state.configgroup.ConfigGroup.class);
        org.apache.ambari.server.state.configgroup.ConfigGroup configGroup4 = org.easymock.EasyMock.createNiceMock(org.apache.ambari.server.state.configgroup.ConfigGroup.class);
        org.apache.ambari.server.controller.ConfigGroupResponse response1 = org.easymock.EasyMock.createNiceMock(org.apache.ambari.server.controller.ConfigGroupResponse.class);
        org.apache.ambari.server.controller.ConfigGroupResponse response2 = org.easymock.EasyMock.createNiceMock(org.apache.ambari.server.controller.ConfigGroupResponse.class);
        org.apache.ambari.server.controller.ConfigGroupResponse response3 = org.easymock.EasyMock.createNiceMock(org.apache.ambari.server.controller.ConfigGroupResponse.class);
        org.apache.ambari.server.controller.ConfigGroupResponse response4 = org.easymock.EasyMock.createNiceMock(org.apache.ambari.server.controller.ConfigGroupResponse.class);
        java.util.Map<java.lang.Long, org.apache.ambari.server.state.configgroup.ConfigGroup> configGroupMap = new java.util.HashMap<>();
        ...
        org.easymock.EasyMock.expect(configGroup1.convertToResponse()).andReturn(response1).anyTimes();
        org.easymock.EasyMock.expect(configGroup2.convertToResponse()).andReturn(response2).anyTimes();
        org.easymock.EasyMock.expect(configGroup3.convertToResponse()).andReturn(response3).anyTimes();
        org.easymock.EasyMock.expect(configGroup4.convertToResponse()).andReturn(response4).anyTimes();
        org.easymock.EasyMock.expect(managementController.getClusters()).andReturn(clusters).anyTimes();
        org.easymock.EasyMock.expect(clusters.getCluster("Cluster100")).andReturn(cluster).anyTimes();
        org.easymock.EasyMock.expect(cluster.getConfigGroups()).andReturn(configGroupMap).anyTimes();
        org.easymock.EasyMock.expect(cluster.getClusterName()).andReturn("Cluster100").anyTimes();
        org.easymock.EasyMock.expect(configGroup1.getName()).andReturn("g1").anyTimes();
        org.easymock.EasyMock.expect(configGroup2.getName()).andReturn("g2").anyTimes();
        org.easymock.EasyMock.expect(configGroup3.getName()).andReturn("g3").anyTimes();
        org.easymock.EasyMock.expect(configGroup4.getName()).andReturn("g4").anyTimes();
        org.easymock.EasyMock.expect(configGroup1.getTag()).andReturn("t1").anyTimes();
        org.easymock.EasyMock.expect(configGroup2.getTag()).andReturn("t2").anyTimes();
        org.easymock.EasyMock.expect(configGroup3.getTag()).andReturn("t3").anyTimes();
        org.easymock.EasyMock.expect(configGroup4.getTag()).andReturn("t4").anyTimes();
        java.util.Map<java.lang.Long, org.apache.ambari.server.state.Host> hostMap = new java.util.HashMap<>();
        hostMap.put(host1Id, h1);
        org.easymock.EasyMock.expect(configGroup4.getHosts()).andReturn(hostMap).anyTimes();
        org.easymock.EasyMock.expect(response1.getClusterName()).andReturn("Cluster100").anyTimes();
        org.easymock.EasyMock.expect(response2.getClusterName()).andReturn("Cluster100").anyTimes();
        org.easymock.EasyMock.expect(response3.getClusterName()).andReturn("Cluster100").anyTimes();
        org.easymock.EasyMock.expect(response4.getClusterName()).andReturn("Cluster100").anyTimes();
        org.easymock.EasyMock.expect(response1.getId()).andReturn(1L).anyTimes();
        org.easymock.EasyMock.expect(response2.getId()).andReturn(2L).anyTimes();
        org.easymock.EasyMock.expect(response3.getId()).andReturn(3L).anyTimes();
        org.easymock.EasyMock.expect(response4.getId()).andReturn(4L).anyTimes();
        org.easymock.EasyMock.expect(response2.getGroupName()).andReturn("g2").anyTimes();
        org.easymock.EasyMock.expect(response3.getTag()).andReturn("t3").anyTimes();
        org.easymock.EasyMock.expect(cluster.getConfigGroupsByHostname("h1")).andReturn(configGroupByHostname).anyTimes();
        ...
        org.easymock.EasyMock.expect(response4.getHosts()).andReturn(hostObj).anyTimes();
        org.easymock.EasyMock.replay(managementController, clusters, cluster, hostDAO, hostEntity1, configGroup1, configGroup2, configGroup3, configGroup4, response1, response2, response3, response4);
        org.springframework.security.core.context.SecurityContextHolder.getContext().setAuthentication(authentication);
        ...
        org.easymock.EasyMock.verify(managementController, clusters, cluster, hostDAO, hostEntity1, configGroup1, configGroup2, configGroup3, configGroup4, response1, response2, response3, response4);
    }
    ...
    private void testDeleteConfigGroup(org.springframework.security.core.Authentication authentication) throws java.lang.Exception {
        ...
        org.easymock.EasyMock.expect(managementController.getClusters()).andReturn(clusters).anyTimes();
        org.easymock.EasyMock.expect(clusters.getCluster("Cluster100")).andReturn(cluster).anyTimes();
        org.easymock.EasyMock.expect(cluster.getConfigGroups()).andReturn(java.util.Collections.singletonMap(1L, configGroup));
        cluster.deleteConfigGroup(1L);
        org.easymock.EasyMock.replay(managementController, clusters, cluster, configGroup);
        org.apache.ambari.server.controller.spi.ResourceProvider resourceProvider = getConfigGroupResourceProvider(managementController);
        ...
        org.easymock.EasyMock.verify(managementController, clusters, cluster, configGroup);
    }
