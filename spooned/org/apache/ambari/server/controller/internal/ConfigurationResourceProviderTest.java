...
public class ConfigurationResourceProviderTest {
    ...
    public void testCreateResources() throws java.lang.Exception {
        ...
        org.easymock.EasyMock.expectLastCall().andReturn(null);
    ...
    public void testGetResources() throws java.lang.Exception {
        ...
        org.easymock.EasyMock.expect(managementController.getConfigurations(org.easymock.EasyMock.capture(configRequestCapture1))).andReturn(allResponse).once();
        org.easymock.EasyMock.expect(managementController.getConfigurations(org.easymock.EasyMock.capture(configRequestCapture2))).andReturn(orResponse).once();
