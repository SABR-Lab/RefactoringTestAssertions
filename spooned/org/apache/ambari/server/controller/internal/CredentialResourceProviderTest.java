...
public class CredentialResourceProviderTest {
    ...
    private void testCreateResources(org.springframework.security.core.Authentication authentication) throws java.lang.Exception {
        ...
        org.apache.ambari.server.controller.ResourceProviderFactory factory = org.easymock.EasyMock.createMock(org.apache.ambari.server.controller.ResourceProviderFactory.class);
        org.easymock.EasyMock.expect(factory.getCredentialResourceProvider(org.easymock.EasyMock.anyObject(org.apache.ambari.server.controller.AmbariManagementController.class))).andReturn(credentialResourceProvider);
        org.easymock.EasyMock.replay(request, factory, managementController);
        ...
        org.easymock.EasyMock.verify(request, factory, managementController);
    }
    ...
    public void testCreateResources_NotInitialized() throws java.lang.Exception {
        ...
        org.apache.ambari.server.controller.internal.CredentialResourceProvider credentialResourceProvider = new org.apache.ambari.server.controller.internal.CredentialResourceProvider(managementController);
        injector.injectMembers(credentialResourceProvider);
        org.easymock.EasyMock.expect(request.getProperties()).andReturn(getCredentialTestProperties("c1", "alias1", "username1", "password1", org.apache.ambari.server.security.encryption.CredentialStoreType.TEMPORARY)).once();
        org.easymock.EasyMock.expect(request.getProperties()).andReturn(getCredentialTestProperties("c1", "alias1", "username1", "password1", org.apache.ambari.server.security.encryption.CredentialStoreType.PERSISTED)).once();
    ...
    private void testGetResources(org.springframework.security.core.Authentication authentication) throws java.lang.Exception {
        ...
        injector.injectMembers(credentialResourceProvider);
        org.easymock.EasyMock.expect(request.getProperties()).andReturn(getCredentialTestProperties("c1", "alias1", "username1", "password1", org.apache.ambari.server.security.encryption.CredentialStoreType.TEMPORARY)).once();
        org.easymock.EasyMock.expect(request.getProperties()).andReturn(getCredentialTestProperties("c1", "alias2", "username2", "password2", org.apache.ambari.server.security.encryption.CredentialStoreType.PERSISTED)).once();
        org.easymock.EasyMock.expect(request.getProperties()).andReturn(getCredentialTestProperties("c1", "alias3", "username3", "password3", org.apache.ambari.server.security.encryption.CredentialStoreType.TEMPORARY)).once();
    ...
    private void testUpdateResources(org.springframework.security.core.Authentication authentication) throws java.lang.Exception {
        ...
        org.easymock.EasyMock.expect(request.getProperties()).andReturn(properties).once();
        org.easymock.EasyMock.expect(request.getProperties()).andReturn(getCredentialTestProperties("c1", null, "username1", "password1", org.apache.ambari.server.security.encryption.CredentialStoreType.PERSISTED)).once();
        org.easymock.EasyMock.expect(request.getPropertyIds()).andReturn(null).anyTimes();
        org.apache.ambari.server.controller.ResourceProviderFactory factory = org.easymock.EasyMock.createMock(org.apache.ambari.server.controller.ResourceProviderFactory.class);
        org.easymock.EasyMock.expect(factory.getCredentialResourceProvider(org.easymock.EasyMock.anyObject(org.apache.ambari.server.controller.AmbariManagementController.class))).andReturn(credentialResourceProvider);
        org.easymock.EasyMock.replay(request, factory, managementController);
