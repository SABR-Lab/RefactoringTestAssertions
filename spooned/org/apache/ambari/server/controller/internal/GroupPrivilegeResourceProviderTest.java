...
public class GroupPrivilegeResourceProviderTest extends org.easymock.EasyMockSupport {
    ...
    public void testToResource_AMBARI() {
        ...
        org.easymock.EasyMock.expect(principalTypeEntity.getName()).andReturn("GROUP").atLeastOnce();
        ...
        org.easymock.EasyMock.expect(groupEntity.getGroupName()).andReturn("group1").atLeastOnce();
        org.apache.ambari.server.orm.dao.GroupDAO groupDAO = createMock(org.apache.ambari.server.orm.dao.GroupDAO.class);
        org.easymock.EasyMock.expect(groupDAO.findGroupByPrincipal(org.easymock.EasyMock.anyObject(org.apache.ambari.server.orm.entities.PrincipalEntity.class))).andReturn(groupEntity).anyTimes();
    ...
    private void getResourcesTest(org.springframework.security.core.Authentication authentication, java.lang.String requestedGroupName) throws java.lang.Exception {
        ...
        org.easymock.EasyMock.expect(privilegeDAO.findAllByPrincipal(groupPrincipals)).andReturn(java.util.Collections.singletonList(privilegeEntity)).once();
        org.easymock.EasyMock.expect(groupDAO.findGroupByName(requestedGroupName)).andReturn(groupEntity).atLeastOnce();
        org.easymock.EasyMock.expect(groupEntity.getPrincipal()).andReturn(principalEntity).atLeastOnce();
        org.easymock.EasyMock.expect(privilegeEntity.getPermission()).andReturn(permissionEntity).atLeastOnce();
        org.easymock.EasyMock.expect(privilegeEntity.getPrincipal()).andReturn(principalEntity).atLeastOnce();
        org.easymock.EasyMock.expect(principalEntity.getPrincipalType()).andReturn(principalTypeEntity).atLeastOnce();
        org.easymock.EasyMock.expect(principalTypeEntity.getName()).andReturn(org.apache.ambari.server.orm.entities.PrincipalTypeEntity.GROUP_PRINCIPAL_TYPE_NAME).atLeastOnce();
        org.easymock.EasyMock.expect(groupDAO.findGroupByPrincipal(org.easymock.EasyMock.anyObject(org.apache.ambari.server.orm.entities.PrincipalEntity.class))).andReturn(groupEntity).atLeastOnce();
        org.easymock.EasyMock.expect(groupEntity.getGroupName()).andReturn(requestedGroupName).atLeastOnce();
        org.easymock.EasyMock.expect(privilegeEntity.getResource()).andReturn(resourceEntity).atLeastOnce();
        org.easymock.EasyMock.expect(resourceEntity.getResourceType()).andReturn(resourceTypeEntity).atLeastOnce();
