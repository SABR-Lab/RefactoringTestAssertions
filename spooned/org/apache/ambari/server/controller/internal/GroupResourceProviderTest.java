...
public class GroupResourceProviderTest {
    ...
    public void testGetResources(org.springframework.security.core.Authentication authentication) throws java.lang.Exception {
        ...
        org.easymock.EasyMock.expect(managementController.getGroups(org.apache.ambari.server.controller.internal.AbstractResourceProviderTest.Matcher.getGroupRequestSet("engineering"))).andReturn(allResponse).once();
