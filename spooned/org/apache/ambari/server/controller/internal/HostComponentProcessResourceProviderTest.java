...
public class HostComponentProcessResourceProviderTest {
    ...
    private org.apache.ambari.server.controller.spi.ResourceProvider init(java.util.Map<java.lang.String, java.lang.String>... processes) throws java.lang.Exception {
        ...
        org.easymock.EasyMock.expect(amc.getClusters()).andReturn(clusters);
        org.easymock.EasyMock.expect(clusters.getCluster("c1")).andReturn(cluster);
        org.easymock.EasyMock.expect(cluster.getServiceComponentHosts(((java.lang.String) (org.easymock.EasyMock.anyObject())))).andReturn(schList);
        org.easymock.EasyMock.expect(sch.getServiceComponentName()).andReturn("comp1");
        org.easymock.EasyMock.expect(sch.getHostName()).andReturn("h1").anyTimes();
        org.easymock.EasyMock.expect(sch.getProcesses()).andReturn(procList);
        org.easymock.EasyMock.replay(amc, clusters, cluster, sch);
