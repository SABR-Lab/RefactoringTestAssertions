...
public class HostComponentResourceProviderTest {
    ...
    private void testCreateResources(org.springframework.security.core.Authentication authentication) throws java.lang.Exception {
        ...
        org.easymock.EasyMock.expect(resourceProviderFactory.getHostComponentResourceProvider(org.easymock.EasyMock.eq(managementController))).andReturn(hostComponentResourceProvider).anyTimes();
        org.easymock.EasyMock.replay(managementController, response, resourceProviderFactory);
        ...
        org.easymock.EasyMock.verify(managementController, response, resourceProviderFactory);
    }
    ...
    private void testGetResources(org.springframework.security.core.Authentication authentication) throws java.lang.Exception {
        ...
        org.apache.ambari.server.controller.AmbariManagementController managementController = org.easymock.EasyMock.createMock(org.apache.ambari.server.controller.AmbariManagementController.class);
        org.apache.ambari.server.controller.ResourceProviderFactory resourceProviderFactory = org.easymock.EasyMock.createNiceMock(org.apache.ambari.server.controller.ResourceProviderFactory.class);
        org.apache.ambari.server.controller.spi.ResourceProvider hostComponentResourceProvider = org.easymock.EasyMock.createNiceMock(org.apache.ambari.server.controller.internal.HostComponentResourceProvider.class);
        org.apache.ambari.server.controller.internal.AbstractControllerResourceProvider.init(resourceProviderFactory);
        ...
        org.easymock.EasyMock.expect(hostComponentResourceProvider.getResources(org.easymock.EasyMock.eq(request), org.easymock.EasyMock.eq(predicate))).andReturn(hostsComponentResources).anyTimes();
        org.easymock.EasyMock.replay(managementController, resourceProviderFactory, hostComponentResourceProvider);
        org.springframework.security.core.context.SecurityContextHolder.getContext().setAuthentication(authentication);
        org.apache.ambari.server.controller.spi.ResourceProvider provider = org.apache.ambari.server.controller.internal.AbstractControllerResourceProvider.getResourceProvider(type, managementController);
        ...
        org.easymock.EasyMock.verify(managementController, resourceProviderFactory, hostComponentResourceProvider);
    }
    ...
    private void testUpdateResources(org.springframework.security.core.Authentication authentication) throws java.lang.Exception {
        org.apache.ambari.server.controller.spi.Resource.Type type = org.apache.ambari.server.controller.spi.Resource.Type.HostComponent;
        org.apache.ambari.server.controller.AmbariManagementController managementController = org.easymock.EasyMock.createMock(org.apache.ambari.server.controller.AmbariManagementController.class);
        org.apache.ambari.server.orm.dao.HostVersionDAO hostVersionDAO = org.easymock.EasyMock.createMock(org.apache.ambari.server.orm.dao.HostVersionDAO.class);
        org.apache.ambari.server.controller.RequestStatusResponse response = org.easymock.EasyMock.createNiceMock(org.apache.ambari.server.controller.RequestStatusResponse.class);
        org.apache.ambari.server.controller.ResourceProviderFactory resourceProviderFactory = org.easymock.EasyMock.createNiceMock(org.apache.ambari.server.controller.ResourceProviderFactory.class);
        com.google.inject.Injector injector = org.easymock.EasyMock.createNiceMock(com.google.inject.Injector.class);
        ...
        org.apache.ambari.server.state.ServiceComponentHost componentHost = org.easymock.EasyMock.createNiceMock(org.apache.ambari.server.state.ServiceComponentHost.class);
        org.apache.ambari.server.controller.internal.RequestStageContainer stageContainer = org.easymock.EasyMock.createNiceMock(org.apache.ambari.server.controller.internal.RequestStageContainer.class);
        ...
        org.easymock.EasyMock.expect(managementController.findServiceName(cluster, "Component100")).andReturn("Service100").anyTimes();
        org.easymock.EasyMock.expect(clusters.getCluster("Cluster102")).andReturn(cluster).anyTimes();
        ...
        org.easymock.EasyMock.expect(service.getServiceComponent("Component100")).andReturn(component).anyTimes();
        org.easymock.EasyMock.expect(component.getServiceComponentHost("Host100")).andReturn(componentHost).anyTimes();
        org.easymock.EasyMock.expect(component.getName()).andReturn("Component100").anyTimes();
        org.easymock.EasyMock.expect(componentHost.getState()).andReturn(org.apache.ambari.server.state.State.INSTALLED).anyTimes();
        org.easymock.EasyMock.expect(response.getMessage()).andReturn("response msg").anyTimes();
        org.easymock.EasyMock.expect(response.getRequestId()).andReturn(1000L);
        org.easymock.EasyMock.expect(maintenanceStateHelper.isOperationAllowed(org.apache.ambari.server.controller.spi.Resource.Type.Cluster, componentHost)).andReturn(true).anyTimes();
        org.easymock.EasyMock.expect(managementController.getHostComponents(org.easymock.EasyMock.anyObject())).andReturn(nameResponse).once();
        ...
        org.easymock.EasyMock.expect(managementController.addStages(null, cluster, mapRequestProps, null, null, null, changedHosts, java.util.Collections.emptyList(), false, false, false, false)).andReturn(stageContainer).once();
        stageContainer.persist();
        org.easymock.EasyMock.expect(stageContainer.getRequestStatusResponse()).andReturn(response).once();
        ...
        org.easymock.EasyMock.expect(resourceProviderFactory.getHostComponentResourceProvider(org.easymock.EasyMock.eq(managementController))).andReturn(provider).anyTimes();
        org.easymock.EasyMock.replay(managementController, response, resourceProviderFactory, clusters, cluster, service, component, componentHost, stageContainer, maintenanceStateHelper);
        org.springframework.security.core.context.SecurityContextHolder.getContext().setAuthentication(authentication);
        java.util.Map<java.lang.String, java.lang.Object> properties = new java.util.LinkedHashMap<>();
        ...
        org.easymock.EasyMock.verify(managementController, response, resourceProviderFactory, stageContainer);
    }
    ...
    private void testDeleteResources(org.springframework.security.core.Authentication authentication) throws java.lang.Exception {
        org.apache.ambari.server.controller.spi.Resource.Type type = org.apache.ambari.server.controller.spi.Resource.Type.HostComponent;
        org.apache.ambari.server.controller.AmbariManagementController managementController = org.easymock.EasyMock.createMock(org.apache.ambari.server.controller.AmbariManagementController.class);
        org.apache.ambari.server.controller.internal.DeleteStatusMetaData deleteStatusMetaData = org.easymock.EasyMock.createNiceMock(org.apache.ambari.server.controller.internal.DeleteStatusMetaData.class);
        com.google.inject.Injector injector = org.easymock.EasyMock.createNiceMock(com.google.inject.Injector.class);
        ...
        org.easymock.EasyMock.expect(managementController.deleteHostComponents(org.apache.ambari.server.controller.internal.AbstractResourceProviderTest.Matcher.getHostComponentRequestSet(null, null, "Component100", "Host100", null, null))).andReturn(deleteStatusMetaData);
        org.easymock.EasyMock.replay(managementController, deleteStatusMetaData);
        org.springframework.security.core.context.SecurityContextHolder.getContext().setAuthentication(authentication);
        ...
        org.easymock.EasyMock.verify(managementController, deleteStatusMetaData);
    }
    ...
    public void testUpdateResourcesNothingToUpdate() throws java.lang.Exception {
        ...
        org.easymock.EasyMock.expect(componentHost.getState()).andReturn(org.apache.ambari.server.state.State.INSTALLED).anyTimes();
        org.easymock.EasyMock.expect(maintenanceStateHelper.isOperationAllowed(org.apache.ambari.server.controller.spi.Resource.Type.Cluster, componentHost)).andReturn(true).anyTimes();
        org.easymock.EasyMock.expect(managementController.getHostComponents(org.easymock.EasyMock.anyObject())).andReturn(java.util.Collections.emptySet()).once();
        java.util.Map<java.lang.String, java.util.Map<org.apache.ambari.server.state.State, java.util.List<org.apache.ambari.server.state.ServiceComponentHost>>> changedHosts = new java.util.HashMap<>();
        java.util.List<org.apache.ambari.server.state.ServiceComponentHost> changedComponentHosts = new java.util.ArrayList<>();
        changedComponentHosts.add(componentHost);
        changedHosts.put("Component100", java.util.Collections.singletonMap(org.apache.ambari.server.state.State.STARTED, changedComponentHosts));
        ...
        provider.setFieldValue("hostVersionDAO", hostVersionDAO);
        org.easymock.EasyMock.expect(resourceProviderFactory.getHostComponentResourceProvider(org.easymock.EasyMock.eq(managementController))).andReturn(provider).anyTimes();
        org.easymock.EasyMock.replay(managementController, resourceProviderFactory, clusters, cluster, service, component, componentHost, stageContainer, maintenanceStateHelper);
        org.springframework.security.core.context.SecurityContextHolder.getContext().setAuthentication(authentication);
        java.util.Map<java.lang.String, java.lang.Object> properties = new java.util.LinkedHashMap<>();
        properties.put(org.apache.ambari.server.controller.internal.HostComponentResourceProvider.STATE, "STARTED");
        org.apache.ambari.server.controller.spi.Request request = org.apache.ambari.server.controller.utilities.PropertyHelper.getUpdateRequest(properties, mapRequestProps);
        ...
        org.easymock.EasyMock.verify(managementController, resourceProviderFactory, stageContainer);
    }
