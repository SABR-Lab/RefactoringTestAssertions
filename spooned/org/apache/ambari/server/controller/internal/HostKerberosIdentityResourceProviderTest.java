...
public class HostKerberosIdentityResourceProviderTest extends org.easymock.EasyMockSupport {
    ...
    public void testGetResources() throws java.lang.Exception {
        ...
        org.easymock.EasyMock.expect(clusters.getCluster(org.easymock.EasyMock.anyString())).andReturn(createNiceMock(org.apache.ambari.server.state.Cluster.class)).once();
        org.apache.ambari.server.controller.AmbariManagementController managementController = createMock(org.apache.ambari.server.controller.AmbariManagementController.class);
        ...
        org.easymock.EasyMock.expect(principalDescriptor1.getValue()).andReturn("principal1@EXAMPLE.COM");
        org.easymock.EasyMock.expect(principalDescriptor1.getType()).andReturn(org.apache.ambari.server.state.kerberos.KerberosPrincipalType.USER).times(1);
        org.easymock.EasyMock.expect(principalDescriptor1.getLocalUsername()).andReturn("principal1");
        ...
        org.easymock.EasyMock.expect(keytabDescriptor1.getFile()).andReturn("/etc/security/keytabs/principal1.headless.keytab").times(1);
        org.easymock.EasyMock.expect(keytabDescriptor1.getOwnerAccess()).andReturn("rw").once();
        org.easymock.EasyMock.expect(keytabDescriptor1.getGroupAccess()).andReturn("r").once();
        org.easymock.EasyMock.expect(keytabDescriptor1.getFile()).andReturn("/etc/security/keytabs/principal1.headless.keytab").times(1);
        org.easymock.EasyMock.expect(keytabDescriptor1.getOwnerName()).andReturn("principal1").once();
        org.easymock.EasyMock.expect(keytabDescriptor1.getGroupName()).andReturn("principal1").once();
        ...
        org.easymock.EasyMock.expect(identity1.getPrincipalDescriptor()).andReturn(principalDescriptor1).times(1);
        org.easymock.EasyMock.expect(identity1.getKeytabDescriptor()).andReturn(keytabDescriptor1).times(1);
        org.easymock.EasyMock.expect(identity1.getName()).andReturn("identity1").times(1);
        ...
        org.easymock.EasyMock.expect(principalDescriptor2.getValue()).andReturn("principal2/Host100@EXAMPLE.COM");
        org.easymock.EasyMock.expect(principalDescriptor2.getType()).andReturn(org.apache.ambari.server.state.kerberos.KerberosPrincipalType.SERVICE).times(1);
        org.easymock.EasyMock.expect(principalDescriptor2.getLocalUsername()).andReturn("principal2");
        ...
        org.easymock.EasyMock.expect(identity2.getPrincipalDescriptor()).andReturn(principalDescriptor2).times(1);
        org.easymock.EasyMock.expect(identity2.getKeytabDescriptor()).andReturn(null).times(1);
        org.easymock.EasyMock.expect(identity2.getName()).andReturn("identity2").times(1);
        ...
        org.easymock.EasyMock.expect(identity3.getPrincipalDescriptor()).andReturn(null).times(1);
        ...
        org.easymock.EasyMock.expect(identity4.getPrincipalDescriptor()).andReturn(null).times(1);
        ...
        org.easymock.EasyMock.expect(principalDescriptor5.getValue()).andReturn("principal5@EXAMPLE.COM");
        org.easymock.EasyMock.expect(principalDescriptor5.getType()).andReturn(org.apache.ambari.server.state.kerberos.KerberosPrincipalType.USER).times(1);
        org.easymock.EasyMock.expect(principalDescriptor5.getLocalUsername()).andReturn("principal5");
        ...
        org.easymock.EasyMock.expect(keytabDescriptor5.getOwnerAccess()).andReturn("r").times(1);
        org.easymock.EasyMock.expect(keytabDescriptor5.getGroupAccess()).andReturn("r").times(1);
        org.easymock.EasyMock.expect(keytabDescriptor5.getFile()).andReturn("/etc/security/keytabs/principal5.headless.keytab").times(1);
        org.easymock.EasyMock.expect(keytabDescriptor5.getOwnerName()).andReturn("principal5").times(1);
        org.easymock.EasyMock.expect(keytabDescriptor5.getGroupName()).andReturn("hadoop").times(1);
        ...
        org.easymock.EasyMock.expect(identity5.getPrincipalDescriptor()).andReturn(principalDescriptor5).times(1);
        org.easymock.EasyMock.expect(identity5.getKeytabDescriptor()).andReturn(keytabDescriptor5).times(1);
        org.easymock.EasyMock.expect(identity5.getName()).andReturn("identity5").times(1);
        ...
        org.easymock.EasyMock.expect(kerberosPrincipalDAO.exists("principal1@EXAMPLE.COM")).andReturn(true).times(1);
        org.easymock.EasyMock.expect(kerberosPrincipalDAO.exists("principal2/Host100@EXAMPLE.COM")).andReturn(true).times(1);
        org.easymock.EasyMock.expect(kerberosPrincipalDAO.exists("principal5@EXAMPLE.COM")).andReturn(false).times(1);
        ...
        org.easymock.EasyMock.expect(kerberosKeytabPrincipalDAO.findByNaturalKey(100L, "/etc/security/keytabs/principal1.headless.keytab", "principal1@EXAMPLE.COM")).andReturn(distributedEntity).times(1);
        ...
        org.easymock.EasyMock.expect(host100.getHostId()).andReturn(100L).times(1);
        org.apache.ambari.server.orm.dao.HostDAO hostDAO = createStrictMock(org.apache.ambari.server.orm.dao.HostDAO.class);
        org.easymock.EasyMock.expect(hostDAO.findByName("Host100")).andReturn(host100).times(1);
        ...
        org.easymock.EasyMock.expect(kerberosHelper.getKerberosDescriptor(org.easymock.EasyMock.anyObject(org.apache.ambari.server.state.Cluster.class), org.easymock.EasyMock.eq(false))).andReturn(kerberosDescriptor).atLeastOnce();
        org.easymock.EasyMock.expect(kerberosHelper.getActiveIdentities("Cluster100", "Host100", null, null, true, null, kerberosDescriptor, null)).andReturn(activeIdentities).once();
        replayAll();
        org.apache.ambari.server.controller.spi.ResourceProvider provider = new org.apache.ambari.server.controller.internal.HostKerberosIdentityResourceProvider(managementController);
