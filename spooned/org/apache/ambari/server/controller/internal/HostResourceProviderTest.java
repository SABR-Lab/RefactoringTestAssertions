...
public class HostResourceProviderTest extends org.easymock.EasyMockSupport {
    ...
    private void testCreateResources(org.springframework.security.core.Authentication authentication) throws java.lang.Exception {
        ...
        managementController.registerRackChange(org.easymock.EasyMock.capture(rackChangeAffectedClusterName));
        org.easymock.EasyMock.expectLastCall().once();
        org.easymock.EasyMock.expect(managementController.getBlueprintProvisioningStates(org.easymock.EasyMock.anyLong(), org.easymock.EasyMock.anyLong())).andReturn(java.util.Collections.EMPTY_MAP).anyTimes();
        ...
        org.easymock.EasyMock.expect(cluster.getDesiredConfigs()).andReturn(new java.util.HashMap<>()).anyTimes();
        org.easymock.EasyMock.expect(clusters.getCluster("Cluster100")).andReturn(cluster).atLeastOnce();
        org.easymock.EasyMock.expect(clusters.getHost("Host100")).andReturn(host).atLeastOnce();
        clusters.updateHostWithClusterAndAttributes(org.easymock.EasyMock.anyObject(), org.easymock.EasyMock.anyObject());
        org.easymock.EasyMock.expectLastCall().once();
        org.easymock.EasyMock.expect(host.getRackInfo()).andReturn("/default-rack").anyTimes();
        org.easymock.EasyMock.expect(host.getHostId()).andReturn(1L).anyTimes();
        org.easymock.EasyMock.expect(host.getHostName()).andReturn("Host100").anyTimes();
        org.easymock.EasyMock.expect(host.getIPv4()).andReturn("0.0.0.0").anyTimes();
        org.easymock.Capture<java.lang.String> newRack = org.easymock.EasyMock.newCapture();
        host.setRackInfo(org.easymock.EasyMock.capture(newRack));
        org.easymock.EasyMock.expectLastCall().once();
        org.easymock.EasyMock.expect(managementController.getClusters()).andReturn(clusters).atLeastOnce();
        org.easymock.EasyMock.expect(resourceProviderFactory.getHostResourceProvider(org.easymock.EasyMock.eq(managementController))).andReturn(hostResourceProvider).anyTimes();
        replayAll();
    ...
    private void testGetResources(org.springframework.security.core.Authentication authentication) throws java.lang.Exception {
        ...
        org.easymock.EasyMock.expect(host100.getMaintenanceState(2)).andReturn(org.apache.ambari.server.state.MaintenanceState.OFF).anyTimes();
        org.easymock.EasyMock.expect(host101.getMaintenanceState(2)).andReturn(org.apache.ambari.server.state.MaintenanceState.OFF).anyTimes();
        org.easymock.EasyMock.expect(host102.getMaintenanceState(2)).andReturn(org.apache.ambari.server.state.MaintenanceState.OFF).anyTimes();
        ...
        org.easymock.EasyMock.expect(clusters.getClustersForHost("Host101")).andReturn(clusterSet).anyTimes();
        org.easymock.EasyMock.expect(clusters.getClustersForHost("Host102")).andReturn(clusterSet).anyTimes();
        org.easymock.EasyMock.expect(cluster.getClusterId()).andReturn(2L).anyTimes();
        org.easymock.EasyMock.expect(cluster.getDesiredConfigs()).andReturn(new java.util.HashMap<>()).anyTimes();
        org.easymock.EasyMock.expect(healthStatus.getHealthStatus()).andReturn(org.apache.ambari.server.state.HostHealthStatus.HealthStatus.HEALTHY).anyTimes();
        org.easymock.EasyMock.expect(healthStatus.getHealthReport()).andReturn("HEALTHY").anyTimes();
    ...
    public void testGetResources_Status_NoCluster() throws java.lang.Exception {
        ...
        org.easymock.EasyMock.expect(clusters.getCluster("Cluster100")).andReturn(cluster).anyTimes();
        org.easymock.EasyMock.expect(clusters.getClustersForHost("Host100")).andReturn(clusterSet).anyTimes();
        org.easymock.EasyMock.expect(clusters.getHosts()).andReturn(java.util.Arrays.asList(host100)).anyTimes();
        org.easymock.EasyMock.expect(cluster.getClusterId()).andReturn(2L).anyTimes();
        org.easymock.EasyMock.expect(cluster.getDesiredConfigs()).andReturn(new java.util.HashMap<>()).anyTimes();
        org.easymock.EasyMock.expect(hostResponse1.getClusterName()).andReturn("").anyTimes();
        org.easymock.EasyMock.expect(hostResponse1.getHostname()).andReturn("Host100").anyTimes();
        org.easymock.EasyMock.expect(hostResponse1.getStatus()).andReturn(org.apache.ambari.server.state.HostHealthStatus.HealthStatus.HEALTHY.name()).anyTimes();
        org.easymock.EasyMock.expect(hostResponse1.getHealthReport()).andReturn("HEALTHY").anyTimes();
        org.easymock.EasyMock.expect(ambariMetaInfo.getComponent(((java.lang.String) (org.easymock.EasyMock.anyObject())), ((java.lang.String) (org.easymock.EasyMock.anyObject())), ((java.lang.String) (org.easymock.EasyMock.anyObject())), ((java.lang.String) (org.easymock.EasyMock.anyObject())))).andReturn(componentInfo).anyTimes();
        org.easymock.EasyMock.expect(componentInfo.getCategory()).andReturn("MASTER").anyTimes();
        org.easymock.EasyMock.expect(resourceProviderFactory.getHostResourceProvider(org.easymock.EasyMock.eq(managementController))).andReturn(hostResourceProvider).anyTimes();
        java.util.Set<java.lang.String> propertyIds = new java.util.HashSet<>();
        propertyIds.add(org.apache.ambari.server.controller.internal.HostResourceProvider.HOST_CLUSTER_NAME_PROPERTY_ID);
        propertyIds.add(org.apache.ambari.server.controller.internal.HostResourceProvider.HOST_HOST_NAME_PROPERTY_ID);
    ...
    public void testGetResources_Status_Unhealthy() throws java.lang.Exception {
        ...
        org.easymock.EasyMock.expect(hostResponse1.getHostname()).andReturn("Host100").anyTimes();
        org.easymock.EasyMock.expect(hostResponse1.getStatus()).andReturn(org.apache.ambari.server.state.HostHealthStatus.HealthStatus.UNHEALTHY.name()).anyTimes();
        org.easymock.EasyMock.expect(hostResponse1.getHealthReport()).andReturn("HEALTHY").anyTimes();
        org.easymock.EasyMock.expect(ambariMetaInfo.getComponent(((java.lang.String) (org.easymock.EasyMock.anyObject())), ((java.lang.String) (org.easymock.EasyMock.anyObject())), ((java.lang.String) (org.easymock.EasyMock.anyObject())), ((java.lang.String) (org.easymock.EasyMock.anyObject())))).andReturn(componentInfo).anyTimes();
        org.easymock.EasyMock.expect(componentInfo.getCategory()).andReturn("MASTER").anyTimes();
        org.easymock.EasyMock.expect(resourceProviderFactory.getHostResourceProvider(org.easymock.EasyMock.eq(managementController))).andReturn(hostResourceProvider).anyTimes();
    ...
    public void testGetResources_Status_Unknown() throws java.lang.Exception {
        ...
        org.easymock.EasyMock.expect(hostResponse1.getClusterName()).andReturn("Cluster100").anyTimes();
        org.easymock.EasyMock.expect(hostResponse1.getHostname()).andReturn("Host100").anyTimes();
        org.easymock.EasyMock.expect(hostResponse1.getStatus()).andReturn(org.apache.ambari.server.state.HostHealthStatus.HealthStatus.UNKNOWN.name()).anyTimes();
        org.easymock.EasyMock.expect(hostResponse1.getHealthReport()).andReturn("UNKNOWN").anyTimes();
        org.easymock.EasyMock.expect(resourceProviderFactory.getHostResourceProvider(org.easymock.EasyMock.eq(managementController))).andReturn(hostResourceProvider).anyTimes();
        java.util.Set<java.lang.String> propertyIds = new java.util.HashSet<>();
        propertyIds.add(org.apache.ambari.server.controller.internal.HostResourceProvider.HOST_CLUSTER_NAME_PROPERTY_ID);
        propertyIds.add(org.apache.ambari.server.controller.internal.HostResourceProvider.HOST_HOST_NAME_PROPERTY_ID);
    ...
    private void testGetRecoveryReport(org.springframework.security.core.Authentication authentication) throws java.lang.Exception {
        ...
        org.easymock.EasyMock.expect(cluster.getDesiredConfigs()).andReturn(new java.util.HashMap<>()).anyTimes();
        org.easymock.EasyMock.expect(ambariMetaInfo.getComponent(((java.lang.String) (org.easymock.EasyMock.anyObject())), ((java.lang.String) (org.easymock.EasyMock.anyObject())), ((java.lang.String) (org.easymock.EasyMock.anyObject())), ((java.lang.String) (org.easymock.EasyMock.anyObject())))).andReturn(componentInfo).anyTimes();
        org.easymock.EasyMock.expect(componentInfo.getCategory()).andReturn("SLAVE").anyTimes();
        org.easymock.EasyMock.expect(resourceProviderFactory.getHostResourceProvider(org.easymock.EasyMock.eq(managementController))).andReturn(hostResourceProvider).anyTimes();
        java.util.Set<java.lang.String> propertyIds = new java.util.HashSet<>();
        propertyIds.add(org.apache.ambari.server.controller.internal.HostResourceProvider.HOST_CLUSTER_NAME_PROPERTY_ID);
        propertyIds.add(org.apache.ambari.server.controller.internal.HostResourceProvider.HOST_HOST_NAME_PROPERTY_ID);
    ...
    public void testGetResources_Status_Alert() throws java.lang.Exception {
        ...
        org.easymock.EasyMock.expect(hostResponse1.getClusterName()).andReturn("Cluster100").anyTimes();
        org.easymock.EasyMock.expect(hostResponse1.getHostname()).andReturn("Host100").anyTimes();
        org.easymock.EasyMock.expect(hostResponse1.getStatus()).andReturn(org.apache.ambari.server.state.HostHealthStatus.HealthStatus.ALERT.name()).anyTimes();
        org.easymock.EasyMock.expect(hostResponse1.getHealthReport()).andReturn("HEALTHY").anyTimes();
        org.easymock.EasyMock.expect(ambariMetaInfo.getComponent(((java.lang.String) (org.easymock.EasyMock.anyObject())), ((java.lang.String) (org.easymock.EasyMock.anyObject())), ((java.lang.String) (org.easymock.EasyMock.anyObject())), ((java.lang.String) (org.easymock.EasyMock.anyObject())))).andReturn(componentInfo).anyTimes();
        org.easymock.EasyMock.expect(componentInfo.getCategory()).andReturn("SLAVE").anyTimes();
        org.easymock.EasyMock.expect(resourceProviderFactory.getHostResourceProvider(org.easymock.EasyMock.eq(managementController))).andReturn(hostResourceProvider).anyTimes();
    ...
    private void testUpdateDesiredConfig(org.springframework.security.core.Authentication authentication) throws java.lang.Exception {
        ...
        org.easymock.EasyMock.expect(clusters.getClustersForHost("Host100")).andReturn(clusterSet).anyTimes();
        org.easymock.EasyMock.expect(clusters.getHosts()).andReturn(java.util.Arrays.asList(host100)).anyTimes();
        org.easymock.EasyMock.expect(clusters.getHostsForCluster("Cluster100")).andReturn(java.util.Collections.singletonMap("Host100", host100)).anyTimes();
        org.easymock.EasyMock.expect(clusters.getHost("Host100")).andReturn(host100).anyTimes();
    ...
    private void testDeleteResources(org.springframework.security.core.Authentication authentication) throws java.lang.Exception {
        ...
        java.util.Set<org.apache.ambari.server.state.Cluster> clusterSet = new java.util.HashSet<>();
        org.easymock.EasyMock.expect(managementController.getClusters()).andReturn(clusters).anyTimes();
        org.easymock.EasyMock.expect(clusters.getHosts()).andReturn(java.util.Arrays.asList(host1)).anyTimes();
        org.easymock.EasyMock.expect(clusters.getHost("Host100")).andReturn(host1).anyTimes();
        org.easymock.EasyMock.expect(clusters.getCluster("Cluster100")).andReturn(cluster).anyTimes();
        org.easymock.EasyMock.expect(clusters.getClustersForHost("Host100")).andReturn(clusterSet).anyTimes();
        org.easymock.EasyMock.expect(cluster.getServiceComponentHosts("Host100")).andReturn(java.util.Collections.emptyList());
        org.easymock.EasyMock.expect(cluster.getClusterId()).andReturn(100L).anyTimes();
        org.easymock.EasyMock.expect(cluster.getDesiredConfigs()).andReturn(new java.util.HashMap<>()).anyTimes();
        ...
        org.easymock.EasyMock.expect(healthStatus.getHealthStatus()).andReturn(org.apache.ambari.server.state.HostHealthStatus.HealthStatus.HEALTHY).anyTimes();
        org.easymock.EasyMock.expect(healthStatus.getHealthReport()).andReturn("HEALTHY").anyTimes();
        org.easymock.EasyMock.expect(topologyManager.getRequests(java.util.Collections.emptyList())).andReturn(java.util.Collections.emptyList()).anyTimes();
        replayAll();
    ...
    public static org.apache.ambari.server.controller.internal.HostResourceProvider getHostProvider(org.apache.ambari.server.controller.AmbariManagementController managementController) throws java.lang.NoSuchFieldException, java.lang.IllegalAccessException {
        ...
        org.easymock.EasyMock.replay(topologyHolder, recoveryConfigHelper, hostLevelParamsHolder);
    ...
    private void testGetHosts(org.springframework.security.core.Authentication authentication) throws java.lang.Exception {
        ...
        org.easymock.EasyMock.expect(clusters.getHost("host1")).andReturn(host);
        org.easymock.EasyMock.expect(clusters.getClustersForHost("host1")).andReturn(setCluster);
        org.easymock.EasyMock.expect(clusters.getCluster("Cluster100")).andReturn(cluster).anyTimes();
        org.easymock.EasyMock.expect(cluster.getClusterId()).andReturn(2L).anyTimes();
        org.easymock.EasyMock.expect(cluster.getDesiredConfigs()).andReturn(desiredConfigs);
        org.easymock.EasyMock.expect(host.getDesiredHostConfigs(cluster, desiredConfigs)).andReturn(desiredHostConfigs);
        org.easymock.EasyMock.expect(host.getHostName()).andReturn("host1").anyTimes();
        org.easymock.EasyMock.expect(host.convertToResponse()).andReturn(response);
    ...
    public void testGetHosts___HostNotFoundException() throws java.lang.Exception {
        ...
        org.easymock.EasyMock.expect(managementController.getClusters()).andReturn(clusters).anyTimes();
        org.easymock.EasyMock.expect(clusters.getCluster("cluster1")).andReturn(cluster);
        org.easymock.EasyMock.expect(clusters.getHost("host1")).andThrow(new org.apache.ambari.server.HostNotFoundException("host1"));
        replayAll();
        org.springframework.security.core.context.SecurityContextHolder.getContext().setAuthentication(org.apache.ambari.server.security.TestAuthenticationFactory.createAdministrator());
    ...
    public void testGetHosts___HostNotFoundException_HostNotAssociatedWithCluster() throws java.lang.Exception {
        ...
        org.easymock.EasyMock.expect(cluster.getDesiredConfigs()).andReturn(new java.util.HashMap<>()).anyTimes();
        org.easymock.EasyMock.expect(host.getHostName()).andReturn("host1").anyTimes();
        org.easymock.EasyMock.expect(clusters.getClustersForHost("host1")).andReturn(java.util.Collections.emptySet());
        replayAll();
        org.springframework.security.core.context.SecurityContextHolder.getContext().setAuthentication(org.apache.ambari.server.security.TestAuthenticationFactory.createAdministrator());
        org.apache.ambari.server.controller.internal.HostResourceProviderTest.getHosts(managementController, setRequests);
        verifyAll();
    ...
    public void testGetHosts___OR_Predicate_HostNotFoundException() throws java.lang.Exception {
        ...
        org.easymock.EasyMock.expect(managementController.getClusters()).andReturn(clusters).anyTimes();
        org.easymock.EasyMock.expect(clusters.getCluster("cluster1")).andReturn(cluster).times(4);
        org.easymock.EasyMock.expect(clusters.getHost("host1")).andReturn(host1);
        org.easymock.EasyMock.expect(host1.getHostName()).andReturn("host1").anyTimes();
        org.easymock.EasyMock.expect(clusters.getClustersForHost("host1")).andReturn(java.util.Collections.singleton(cluster));
        org.easymock.EasyMock.expect(host1.convertToResponse()).andReturn(response);
        response.setClusterName("cluster1");
        org.easymock.EasyMock.expect(clusters.getHost("host2")).andReturn(host2);
        org.easymock.EasyMock.expect(host2.getHostName()).andReturn("host2").anyTimes();
        org.easymock.EasyMock.expect(clusters.getClustersForHost("host2")).andReturn(java.util.Collections.singleton(cluster));
        org.easymock.EasyMock.expect(host2.convertToResponse()).andReturn(response2);
        response2.setClusterName("cluster1");
        org.easymock.EasyMock.expect(clusters.getHost("host3")).andThrow(new org.apache.ambari.server.HostNotFoundException("host3"));
        org.easymock.EasyMock.expect(clusters.getHost("host4")).andThrow(new org.apache.ambari.server.HostNotFoundException("host4"));
        org.easymock.EasyMock.expect(cluster.getClusterId()).andReturn(2L).anyTimes();
        org.easymock.EasyMock.expect(cluster.getDesiredConfigs()).andReturn(new java.util.HashMap<>()).anyTimes();
        replayAll();
        org.springframework.security.core.context.SecurityContextHolder.getContext().setAuthentication(org.apache.ambari.server.security.TestAuthenticationFactory.createAdministrator());
    ...
    public static void deleteHosts(org.apache.ambari.server.controller.AmbariManagementController controller, java.util.Set<org.apache.ambari.server.controller.HostRequest> requests) throws org.apache.ambari.server.AmbariException, java.lang.NoSuchFieldException, java.lang.IllegalAccessException {
        ...
        org.easymock.EasyMock.expect(topologyManager.getRequests(java.util.Collections.emptyList())).andReturn(java.util.Collections.emptyList()).anyTimes();
        org.easymock.EasyMock.replay(topologyManager);
        org.apache.ambari.server.controller.internal.HostResourceProvider provider = org.apache.ambari.server.controller.internal.HostResourceProviderTest.getHostProvider(controller);
        org.apache.ambari.server.controller.internal.HostResourceProvider.setTopologyManager(topologyManager);
    ...
    private com.google.inject.Injector createInjector() throws java.lang.Exception {
        ...
        org.easymock.EasyMock.reset(stageDAO, ambariMetaInfo);
        return injector;
    }
    ...
    private org.apache.ambari.server.state.Host createMockHost(java.lang.String hostName, java.lang.String clusterName, java.util.Map<java.lang.String, org.apache.ambari.server.state.HostConfig> desiredConfigs, java.lang.String status, java.lang.String recoverySummary, org.apache.ambari.server.agent.RecoveryReport recoveryReport) {
        ...
        org.easymock.EasyMock.expect(host.convertToResponse()).andReturn(hostResponse).anyTimes();
        try {
            org.easymock.EasyMock.expect(host.getDesiredHostConfigs(org.easymock.EasyMock.anyObject(), org.easymock.EasyMock.anyObject())).andReturn(desiredConfigs).anyTimes();
        } catch (org.apache.ambari.server.AmbariException e) {
            org.junit.Assert.fail(e.getMessage());
        }
        org.easymock.EasyMock.expect(host.getHostName()).andReturn(hostName).anyTimes();
        org.easymock.EasyMock.expect(host.getHostId()).andReturn(1L).anyTimes();
        org.easymock.EasyMock.expect(host.getRackInfo()).andReturn("rackInfo").anyTimes();
