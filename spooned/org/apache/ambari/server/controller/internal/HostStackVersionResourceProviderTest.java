...
public class HostStackVersionResourceProviderTest {
    ...
    public void setup() throws java.lang.Exception {
        ...
        hostVersionDAOMock = org.easymock.EasyMock.createNiceMock(org.apache.ambari.server.orm.dao.HostVersionDAO.class);
        ...
        response = org.easymock.EasyMock.createNiceMock(org.apache.ambari.server.controller.RequestStatusResponse.class);
        resourceProviderFactory = org.easymock.EasyMock.createNiceMock(org.apache.ambari.server.controller.ResourceProviderFactory.class);
        csvResourceProvider = org.easymock.EasyMock.createNiceMock(org.apache.ambari.server.controller.internal.ClusterStackVersionResourceProvider.class);
        hostVersionEntityMock = org.easymock.EasyMock.createNiceMock(org.apache.ambari.server.orm.entities.HostVersionEntity.class);
    ...
    public void testGetResources() throws java.lang.Exception {
        ...
        org.easymock.EasyMock.expect(hostVersionDAOMock.findByClusterAndHost(clustername, hostname)).andReturn(java.util.Collections.singletonList(hostVersionEntityMock));
        org.easymock.EasyMock.expect(hostVersionEntityMock.getRepositoryVersion()).andReturn(repoVersion).anyTimes();
        org.easymock.EasyMock.expect(repositoryVersionDAOMock.findByStackAndVersion(org.easymock.EasyMock.isA(org.apache.ambari.server.state.StackId.class), org.easymock.EasyMock.isA(java.lang.String.class))).andReturn(null).anyTimes();
        org.easymock.EasyMock.expect(hostVersionEntityMock.getState()).andReturn(org.apache.ambari.server.state.RepositoryVersionState.INSTALLING).anyTimes();
        org.easymock.EasyMock.replay(hostVersionDAOMock, hostVersionEntityMock, repositoryVersionDAOMock);
        ...
        org.easymock.EasyMock.verify(hostVersionDAOMock, hostVersionEntityMock, repositoryVersionDAOMock);
    }
    ...
    public void testCreateResources() throws java.lang.Exception {
        ...
        final org.apache.ambari.server.state.Host host1 = org.easymock.EasyMock.createNiceMock("host1", org.apache.ambari.server.state.Host.class);
        org.easymock.EasyMock.expect(host1.getHostName()).andReturn("host1").anyTimes();
        org.easymock.EasyMock.expect(host1.getOsFamily()).andReturn("redhat6").anyTimes();
        org.easymock.EasyMock.replay(host1);
        ...
        org.easymock.EasyMock.expect(clusters.getHost(org.easymock.EasyMock.anyObject(java.lang.String.class))).andReturn(host1);
        ...
        org.easymock.EasyMock.expect(cluster.getServiceComponentHosts(org.easymock.EasyMock.anyObject(java.lang.String.class))).andReturn(schs).anyTimes();
        org.easymock.EasyMock.expect(sch.getServiceName()).andReturn("HIVE").anyTimes();
        ...
        org.easymock.EasyMock.expect(hostVersionDAOMock.findByClusterStackVersionAndHost(org.easymock.EasyMock.anyObject(java.lang.String.class), org.easymock.EasyMock.anyObject(org.apache.ambari.server.state.StackId.class), org.easymock.EasyMock.anyObject(java.lang.String.class), org.easymock.EasyMock.anyObject(java.lang.String.class))).andReturn(hostVersionEntityMock);
        org.easymock.EasyMock.expect(hostVersionEntityMock.getState()).andReturn(org.apache.ambari.server.state.RepositoryVersionState.INSTALL_FAILED).anyTimes();
        ...
        org.easymock.EasyMock.replay(managementController, response, clusters, resourceProviderFactory, csvResourceProvider, cluster, repositoryVersionDAOMock, configHelper, sch, actionManager, hostVersionEntityMock, hostVersionDAOMock);
        org.apache.ambari.server.controller.spi.ResourceProvider provider = org.apache.ambari.server.controller.internal.AbstractControllerResourceProvider.getResourceProvider(type, managementController);
    ...
    public void testCreateResources_on_host_not_belonging_To_any_cluster() throws java.lang.Exception {
        ...
        org.easymock.EasyMock.expect(managementController.getActionManager()).andReturn(actionManager).anyTimes();
        org.easymock.EasyMock.expect(managementController.getJdkResourceUrl()).andReturn("/JdkResourceUrl").anyTimes();
        org.easymock.EasyMock.expect(managementController.getPackagesForServiceHost(org.easymock.EasyMock.anyObject(org.apache.ambari.server.state.ServiceInfo.class), org.easymock.EasyMock.anyObject(java.util.Map.class), org.easymock.EasyMock.anyObject(java.lang.String.class))).andReturn(packages).anyTimes();
        org.easymock.EasyMock.expect(resourceProviderFactory.getHostResourceProvider(org.easymock.EasyMock.eq(managementController))).andReturn(csvResourceProvider).anyTimes();
        org.easymock.EasyMock.expect(clusters.getCluster(org.easymock.EasyMock.anyObject(java.lang.String.class))).andReturn(cluster);
        org.easymock.EasyMock.expect(clusters.getHost(org.easymock.EasyMock.anyObject(java.lang.String.class))).andReturn(host1);
        org.easymock.EasyMock.expect(cluster.getHosts()).andReturn(hostsForCluster.values()).atLeastOnce();
        ...
        org.easymock.EasyMock.expect(repositoryVersionDAOMock.findByStackAndVersion(org.easymock.EasyMock.anyObject(org.apache.ambari.server.state.StackId.class), org.easymock.EasyMock.anyObject(java.lang.String.class))).andReturn(repoVersion);
        org.easymock.EasyMock.expect(actionManager.getRequestTasks(org.easymock.EasyMock.anyLong())).andReturn(java.util.Collections.emptyList()).anyTimes();
        requestCapture = org.easymock.EasyMock.newCapture();
        executeActionRequestCapture = org.easymock.EasyMock.newCapture();
        actionManager.sendActions(org.easymock.EasyMock.capture(requestCapture), org.easymock.EasyMock.capture(executeActionRequestCapture));
        org.apache.ambari.server.utils.StageUtils.setTopologyManager(injector.getInstance(org.apache.ambari.server.topology.TopologyManager.class));
        org.apache.ambari.server.utils.StageUtils.setConfiguration(injector.getInstance(org.apache.ambari.server.configuration.Configuration.class));
        org.easymock.EasyMock.replay(managementController, response, clusters, resourceProviderFactory, csvResourceProvider, cluster, repositoryVersionDAOMock, configHelper, sch, actionManager, hostVersionEntityMock, hostVersionDAOMock);
        org.apache.ambari.server.controller.spi.ResourceProvider provider = org.apache.ambari.server.controller.internal.AbstractControllerResourceProvider.getResourceProvider(type, managementController);
    ...
    public void testCreateResources_in_out_of_sync_state() throws java.lang.Exception {
        ...
        org.easymock.EasyMock.expect(repositoryVersionDAOMock.findByStackAndVersion(org.easymock.EasyMock.anyObject(org.apache.ambari.server.state.StackId.class), org.easymock.EasyMock.anyObject(java.lang.String.class))).andReturn(repoVersion);
        org.easymock.EasyMock.expect(hostVersionDAOMock.findByClusterStackVersionAndHost(org.easymock.EasyMock.anyObject(java.lang.String.class), org.easymock.EasyMock.anyObject(org.apache.ambari.server.state.StackId.class), org.easymock.EasyMock.anyObject(java.lang.String.class), org.easymock.EasyMock.anyObject(java.lang.String.class))).andReturn(hostVersionEntityMock);
        org.easymock.EasyMock.expect(hostVersionEntityMock.getState()).andReturn(org.apache.ambari.server.state.RepositoryVersionState.OUT_OF_SYNC).anyTimes();
        org.easymock.EasyMock.expect(actionManager.getRequestTasks(org.easymock.EasyMock.anyLong())).andReturn(java.util.Collections.emptyList()).anyTimes();
        org.apache.ambari.server.utils.StageUtils.setTopologyManager(injector.getInstance(org.apache.ambari.server.topology.TopologyManager.class));
        org.apache.ambari.server.utils.StageUtils.setConfiguration(injector.getInstance(org.apache.ambari.server.configuration.Configuration.class));
        org.easymock.EasyMock.replay(managementController, response, clusters, resourceProviderFactory, csvResourceProvider, cluster, repositoryVersionDAOMock, configHelper, sch, actionManager, hostVersionEntityMock, hostVersionDAOMock);
