...
public class JMXHostProviderTest {
    ...
    public void testGetHostNames() throws org.apache.ambari.server.AmbariException {
        org.apache.ambari.server.controller.AmbariManagementController managementControllerMock = org.easymock.EasyMock.createNiceMock(org.apache.ambari.server.controller.AmbariManagementController.class);
        ...
        org.apache.ambari.server.state.Clusters clustersMock = org.easymock.EasyMock.createNiceMock(org.apache.ambari.server.state.Clusters.class);
        ...
        org.apache.ambari.server.state.Service serviceMock = org.easymock.EasyMock.createNiceMock(org.apache.ambari.server.state.Service.class);
        org.apache.ambari.server.state.ServiceComponent serviceComponentMock = org.easymock.EasyMock.createNiceMock(org.apache.ambari.server.state.ServiceComponent.class);
        ...
        org.easymock.EasyMock.expect(managementControllerMock.getClusters()).andReturn(clustersMock).anyTimes();
        org.easymock.EasyMock.expect(managementControllerMock.findServiceName(clusterMock, "DATANODE")).andReturn("HDFS");
        org.easymock.EasyMock.expect(clustersMock.getCluster("c1")).andReturn(clusterMock).anyTimes();
        org.easymock.EasyMock.expect(clusterMock.getService("HDFS")).andReturn(serviceMock).anyTimes();
        org.easymock.EasyMock.expect(serviceMock.getServiceComponent("DATANODE")).andReturn(serviceComponentMock).anyTimes();
        org.easymock.EasyMock.expect(serviceComponentMock.getServiceComponentHosts()).andReturn(hostComponents).anyTimes();
        org.easymock.EasyMock.replay(managementControllerMock, clustersMock, clusterMock, serviceMock, serviceComponentMock);
    ...
    private static class JMXHostProviderModule extends org.apache.ambari.server.controller.internal.AbstractProviderModule {
        ...
        {
            org.easymock.EasyMock.expect(injector.getInstance(org.apache.ambari.server.state.Clusters.class)).andReturn(null);
            org.easymock.EasyMock.replay(maintenanceStateHelper, injector);
        }
