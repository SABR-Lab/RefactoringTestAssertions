        ...
        public java.util.Set<org.apache.ambari.server.controller.spi.Resource> fetchJobDetails(java.util.Set<java.lang.String> requestedIds, java.lang.String clusterName, java.lang.String workflowId, java.lang.String jobId) {
            ...
            try {
                ...
                while (rs.next()) {
                    ...
                    org.apache.ambari.server.controller.internal.JobResourceProvider.setResourceProperty(resource, org.apache.ambari.server.controller.internal.JobResourceProvider.JOB_CLUSTER_NAME_PROPERTY_ID, clusterName, requestedIds);
                    ...
                    if (requestedIds.contains(org.apache.ambari.server.controller.internal.JobResourceProvider.JOB_SUBMIT_TIME_PROPERTY_ID) || requestedIds.contains(org.apache.ambari.server.controller.internal.JobResourceProvider.JOB_ELAPSED_TIME_PROPERTY_ID)) {
                        ...
                        if (requestedIds.contains(org.apache.ambari.server.controller.internal.JobResourceProvider.JOB_SUBMIT_TIME_PROPERTY_ID))
                            org.apache.ambari.server.controller.internal.JobResourceProvider.setResourceProperty(resource, org.apache.ambari.server.controller.internal.JobResourceProvider.JOB_SUBMIT_TIME_PROPERTY_ID, submitTime, requestedIds);
                        ...
                        if (requestedIds.contains(org.apache.ambari.server.controller.internal.JobResourceProvider.JOB_ELAPSED_TIME_PROPERTY_ID)) {
                            ...
                            if (finishTime > submitTime)
                                org.apache.ambari.server.controller.internal.JobResourceProvider.setResourceProperty(resource, org.apache.ambari.server.controller.internal.JobResourceProvider.JOB_ELAPSED_TIME_PROPERTY_ID, finishTime - submitTime, requestedIds);
                            else
                                org.apache.ambari.server.controller.internal.JobResourceProvider.setResourceProperty(resource, org.apache.ambari.server.controller.internal.JobResourceProvider.JOB_ELAPSED_TIME_PROPERTY_ID, 0L, requestedIds);
