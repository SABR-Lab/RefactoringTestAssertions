...
public class JobResourceProviderTest {
    ...
    public void testGetResources() throws org.apache.ambari.server.controller.spi.SystemException, org.apache.ambari.server.controller.spi.UnsupportedPropertyException, org.apache.ambari.server.controller.spi.NoSuchResourceException, org.apache.ambari.server.controller.spi.NoSuchParentResourceException {
        ...
        org.apache.ambari.server.controller.internal.JobResourceProvider.JobFetcher jobFetcher = org.easymock.EasyMock.createMock(org.apache.ambari.server.controller.internal.JobResourceProvider.JobFetcher.class);
        org.easymock.EasyMock.expect(jobFetcher.fetchJobDetails(propertyIds, null, "workflow2", null)).andReturn(expected).once();
        org.easymock.EasyMock.replay(jobFetcher);
        ...
        org.easymock.EasyMock.verify(jobFetcher);
    }
    ...
    private static class TestJobResourceProvider extends org.apache.ambari.server.controller.internal.JobResourceProvider {
        ...
        private class TestJobFetcher extends org.apache.ambari.server.controller.internal.JobResourceProvider.PostgresJobFetcher {
            ...
            protected java.sql.ResultSet getResultSet(java.util.Set<java.lang.String> requestedIds, java.lang.String workflowId, java.lang.String jobId) throws java.sql.SQLException {
                rs = org.easymock.EasyMock.createMock(java.sql.ResultSet.class);
                org.easymock.EasyMock.expect(rs.next()).andReturn(true).once();
                org.easymock.EasyMock.expect(rs.getString(getDBField(org.apache.ambari.server.controller.internal.JobResourceProvider.JOB_ID_PROPERTY_ID).toString())).andReturn("job1").once();
                if (type > 1)
                    org.easymock.EasyMock.expect(rs.getLong(getDBField(org.apache.ambari.server.controller.internal.JobResourceProvider.JOB_SUBMIT_TIME_PROPERTY_ID).toString())).andReturn(42L).once();

                if (type == 3)
                    org.easymock.EasyMock.expect(rs.getLong(org.apache.ambari.server.controller.internal.JobResourceProvider.JobFields.FINISHTIME.toString())).andReturn(43L).once();

                if (type == 4)
                    org.easymock.EasyMock.expect(rs.getLong(org.apache.ambari.server.controller.internal.JobResourceProvider.JobFields.FINISHTIME.toString())).andReturn(41L).once();

                org.easymock.EasyMock.expect(rs.next()).andReturn(false).once();
                rs.close();
