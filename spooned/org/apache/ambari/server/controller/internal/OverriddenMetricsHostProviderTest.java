...
public class OverriddenMetricsHostProviderTest extends org.easymock.EasyMockSupport {
    ...
    public void testReturnOverriddenHostIfPresent() throws java.lang.Exception {
        org.easymock.EasyMock.expect(configHelper.getEffectiveConfigProperties(org.apache.ambari.server.controller.internal.OverriddenMetricsHostProviderTest.CLUSTER_1, null)).andReturn(java.util.Collections.emptyMap()).anyTimes();
        replayAll();
    ...
    public void testReplacesPlaceholderInOverriddenHost() throws java.lang.Exception {
        org.easymock.EasyMock.expect(configHelper.getEffectiveConfigProperties(org.apache.ambari.server.controller.internal.OverriddenMetricsHostProviderTest.CLUSTER_1, null)).andReturn(config()).anyTimes();
        replayAll();
