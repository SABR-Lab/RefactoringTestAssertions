...
public class QuickLinkArtifactResourceProviderTest {
    ...
    private class MockModule implements com.google.inject.Module {
        ...
        public void configure(com.google.inject.Binder binder) {
            org.apache.ambari.server.api.services.AmbariMetaInfo metaInfo = org.easymock.EasyMock.createMock(org.apache.ambari.server.api.services.AmbariMetaInfo.class);
            org.apache.ambari.server.state.StackInfo stack = org.easymock.EasyMock.createMock(org.apache.ambari.server.state.StackInfo.class);
            org.apache.ambari.server.state.ServiceInfo service = org.easymock.EasyMock.createMock(org.apache.ambari.server.state.ServiceInfo.class);
            ...
            org.easymock.EasyMock.expect(amc.getAmbariMetaInfo()).andReturn(metaInfo).anyTimes();
            org.easymock.EasyMock.expect(amc.getQuicklinkVisibilityController()).andAnswer(() -> org.apache.ambari.server.state.quicklinksprofile.QuickLinkVisibilityControllerFactory.get(org.apache.ambari.server.controller.internal.quicklinkProfile)).anyTimes();
            try {
                org.easymock.EasyMock.expect(metaInfo.getStack(org.easymock.EasyMock.anyString(), org.easymock.EasyMock.anyString())).andReturn(stack).anyTimes();
            } catch (org.apache.ambari.server.AmbariException ex) {
                throw new java.lang.RuntimeException(ex);
            }
            org.easymock.EasyMock.expect(stack.getServices()).andReturn(com.google.common.collect.ImmutableList.of(service)).anyTimes();
            org.easymock.EasyMock.expect(stack.getService("YARN")).andReturn(service).anyTimes();
            org.easymock.EasyMock.expect(service.getQuickLinksConfigurationsMap()).andReturn(com.google.common.collect.ImmutableMap.of("YARN", qlConfigInfo));
            org.easymock.EasyMock.expect(service.getName()).andReturn("YARN").anyTimes();
            binder.bind(org.apache.ambari.server.controller.AmbariManagementController.class).toInstance(amc);
            org.easymock.EasyMock.replay(amc, metaInfo, stack, service);
        }
    }
}
