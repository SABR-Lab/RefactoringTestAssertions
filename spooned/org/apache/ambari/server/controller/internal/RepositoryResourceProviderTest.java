...
public class RepositoryResourceProviderTest {
    ...
    public void testGetResources() throws java.lang.Exception {
        ...
        allResponse.add(rr);
        org.easymock.EasyMock.expect(managementController.getRepositories(org.easymock.EasyMock.anyObject())).andReturn(allResponse).times(2);
    ...
    public void testUpdateResources() throws java.lang.Exception {
        ...
        java.util.Set<org.apache.ambari.server.controller.RepositoryResponse> allResponse = new java.util.HashSet<>();
        allResponse.add(rr);
        org.easymock.EasyMock.expect(managementController.getRepositories(org.easymock.EasyMock.anyObject())).andReturn(allResponse).times(1);
