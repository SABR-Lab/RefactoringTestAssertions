...
public class RequestResourceProviderTest {
    ...
    public void before() throws java.lang.Exception {
        requestDAO = org.powermock.api.easymock.PowerMock.createNiceMock(org.apache.ambari.server.orm.dao.RequestDAO.class);
        hrcDAO = org.powermock.api.easymock.PowerMock.createNiceMock(org.apache.ambari.server.orm.dao.HostRoleCommandDAO.class);
        topologyManager = org.powermock.api.easymock.PowerMock.createNiceMock(org.apache.ambari.server.topology.TopologyManager.class);
        org.powermock.api.easymock.PowerMock.reset(topologyManager);
        org.easymock.EasyMock.expect(topologyManager.getStageSummaries(org.easymock.EasyMock.<java.lang.Long>anyObject())).andReturn(java.util.Collections.emptyMap()).anyTimes();
        org.easymock.EasyMock.expect(topologyManager.getRequests(org.easymock.EasyMock.anyObject())).andReturn(java.util.Collections.emptyList()).anyTimes();
        org.powermock.api.easymock.PowerMock.replay(topologyManager);
    ...
    public void testCreateResources() throws java.lang.Exception {
        ...
        org.apache.ambari.server.controller.AmbariManagementController managementController = org.powermock.api.easymock.PowerMock.createMock(org.apache.ambari.server.controller.AmbariManagementController.class);
        org.apache.ambari.server.controller.RequestStatusResponse response = org.powermock.api.easymock.PowerMock.createNiceMock(org.apache.ambari.server.controller.RequestStatusResponse.class);
        org.powermock.api.easymock.PowerMock.replay(managementController, response);
        ...
        org.powermock.api.easymock.PowerMock.verify(managementController, response);
    }

    @org.junit.Test
    public void testGetResourcesWithRequestInfo() throws java.lang.Exception {
        org.apache.ambari.server.controller.spi.Resource.Type type = org.apache.ambari.server.controller.spi.Resource.Type.Request;
        org.easymock.EasyMock.expect(requestDAO.findByPks(java.util.Collections.emptyList(), true)).andReturn(java.util.Collections.emptyList()).anyTimes();
        prepareGetAuthorizationExpectations();
        org.apache.ambari.server.actionmanager.ActionManager actionManager = org.powermock.api.easymock.PowerMock.createNiceMock(org.apache.ambari.server.actionmanager.ActionManager.class);
        ...
        org.easymock.EasyMock.expect(cluster.getResourceId()).andReturn(4L).anyTimes();
        ...
        org.easymock.EasyMock.expect(clusters.getCluster("foo_cluster")).andReturn(cluster).anyTimes();
        org.apache.ambari.server.controller.AmbariManagementController managementController = org.powermock.api.easymock.PowerMock.createMock(org.apache.ambari.server.controller.AmbariManagementController.class);
        ...
        org.powermock.api.easymock.PowerMock.replay(managementController, clusters, cluster);
        org.apache.ambari.server.controller.spi.ResourceProvider provider = org.apache.ambari.server.controller.internal.AbstractControllerResourceProvider.getResourceProvider(type, managementController);
        ...
        org.easymock.EasyMock.expect(requestDAO.findAllRequestIds(org.apache.ambari.server.api.services.BaseRequest.DEFAULT_PAGE_SIZE, false, 1L)).andReturn(java.util.Collections.emptyList()).anyTimes();
        org.powermock.api.easymock.PowerMock.replay(requestDAO);
        provider.getResources(request, predicate);
        org.powermock.api.easymock.PowerMock.verify(requestDAO);
        requestInfoProperties.put(org.apache.ambari.server.api.services.BaseRequest.PAGE_SIZE_PROPERTY_KEY, "20");
        request = org.apache.ambari.server.controller.utilities.PropertyHelper.getReadRequest(new java.util.HashSet<>(), requestInfoProperties, null, null, null);
        provider.getResources(request, predicate);
        org.powermock.api.easymock.PowerMock.verify(requestDAO);
        org.powermock.api.easymock.PowerMock.reset(requestDAO);
        requestInfoProperties.put(org.apache.ambari.server.api.services.BaseRequest.ASC_ORDER_PROPERTY_KEY, "true");
        request = org.apache.ambari.server.controller.utilities.PropertyHelper.getReadRequest(new java.util.HashSet<>(), requestInfoProperties, null, null, null);
        org.easymock.EasyMock.expect(requestDAO.findByPks(java.util.Collections.emptyList(), true)).andReturn(java.util.Collections.emptyList()).anyTimes();
        org.easymock.EasyMock.expect(requestDAO.findAllRequestIds(org.apache.ambari.server.api.services.BaseRequest.DEFAULT_PAGE_SIZE, true, 1L)).andReturn(java.util.Collections.emptyList()).anyTimes();
        org.powermock.api.easymock.PowerMock.replay(requestDAO);
        provider.getResources(request, predicate);
        org.powermock.api.easymock.PowerMock.verify(requestDAO);
    }
    ...
    public void testGetResources() throws java.lang.Exception {
        ...
        org.apache.ambari.server.controller.AmbariManagementController managementController = org.powermock.api.easymock.PowerMock.createMock(org.apache.ambari.server.controller.AmbariManagementController.class);
        org.apache.ambari.server.actionmanager.ActionManager actionManager = org.powermock.api.easymock.PowerMock.createNiceMock(org.apache.ambari.server.actionmanager.ActionManager.class);
        org.apache.ambari.server.orm.entities.RequestEntity requestMock = org.powermock.api.easymock.PowerMock.createNiceMock(org.apache.ambari.server.orm.entities.RequestEntity.class);
        org.easymock.EasyMock.expect(requestMock.getRequestContext()).andReturn("this is a context").anyTimes();
        org.easymock.EasyMock.expect(requestMock.getRequestId()).andReturn(100L).anyTimes();
        org.easymock.EasyMock.expect(requestMock.getInputs()).andReturn(storedInputs).anyTimes();
        org.easymock.Capture<java.util.Collection<java.lang.Long>> requestIdsCapture = org.easymock.EasyMock.newCapture();
        org.easymock.EasyMock.expect(managementController.getActionManager()).andReturn(actionManager);
        org.easymock.EasyMock.expect(requestDAO.findByPks(org.easymock.EasyMock.capture(requestIdsCapture), org.easymock.EasyMock.eq(true))).andReturn(java.util.Collections.singletonList(requestMock)).anyTimes();
        org.easymock.EasyMock.expect(hrcDAO.findAggregateCounts(((java.lang.Long) (org.easymock.EasyMock.anyObject())))).andReturn(new java.util.HashMap<java.lang.Long, org.apache.ambari.server.orm.dao.HostRoleCommandStatusSummaryDTO>() {
            {
                put(1L, org.apache.ambari.server.orm.dao.HostRoleCommandStatusSummaryDTO.create().inProgress(1));
            }
        }).anyTimes();
        prepareGetAuthorizationExpectations();
        org.powermock.api.easymock.PowerMock.replay(managementController, actionManager, requestDAO, hrcDAO, requestMock);
        org.apache.ambari.server.controller.spi.ResourceProvider provider = org.apache.ambari.server.controller.internal.AbstractControllerResourceProvider.getResourceProvider(type, managementController);
        ...
        org.powermock.api.easymock.PowerMock.verify(managementController, actionManager, requestDAO, hrcDAO);
    }
    ...
    public void testGetResourcesWithRequestSchedule() throws java.lang.Exception {
        ...
        org.easymock.EasyMock.expect(requestMock.getRequestContext()).andReturn("this is a context").anyTimes();
        org.easymock.EasyMock.expect(requestMock.getRequestId()).andReturn(100L).anyTimes();
        org.easymock.EasyMock.expect(requestMock.getRequestScheduleId()).andReturn(11L).anyTimes();
        org.easymock.Capture<java.util.Collection<java.lang.Long>> requestIdsCapture = org.easymock.EasyMock.newCapture();
        org.easymock.EasyMock.expect(managementController.getActionManager()).andReturn(actionManager);
        org.easymock.EasyMock.expect(requestDAO.findByPks(org.easymock.EasyMock.capture(requestIdsCapture), org.easymock.EasyMock.eq(true))).andReturn(java.util.Collections.singletonList(requestMock)).anyTimes();
        org.easymock.EasyMock.expect(hrcDAO.findAggregateCounts(((java.lang.Long) (org.easymock.EasyMock.anyObject())))).andReturn(new java.util.HashMap<java.lang.Long, org.apache.ambari.server.orm.dao.HostRoleCommandStatusSummaryDTO>() {
    ...
    public void testGetResourcesWithoutRequestSchedule() throws java.lang.Exception {
        ...
        org.easymock.EasyMock.expect(requestMock.getRequestContext()).andReturn("this is a context").anyTimes();
        org.easymock.EasyMock.expect(requestMock.getRequestId()).andReturn(100L).anyTimes();
        org.easymock.EasyMock.expect(requestMock.getRequestScheduleId()).andReturn(null).anyTimes();
        org.easymock.Capture<java.util.Collection<java.lang.Long>> requestIdsCapture = org.easymock.EasyMock.newCapture();
        org.easymock.EasyMock.expect(managementController.getActionManager()).andReturn(actionManager);
        org.easymock.EasyMock.expect(requestDAO.findByPks(org.easymock.EasyMock.capture(requestIdsCapture), org.easymock.EasyMock.eq(true))).andReturn(java.util.Collections.singletonList(requestMock)).anyTimes();
        org.easymock.EasyMock.expect(hrcDAO.findAggregateCounts(((java.lang.Long) (org.easymock.EasyMock.anyObject())))).andReturn(new java.util.HashMap<java.lang.Long, org.apache.ambari.server.orm.dao.HostRoleCommandStatusSummaryDTO>() {
        ...
        prepareGetAuthorizationExpectations();
        org.powermock.api.easymock.PowerMock.replay(managementController, actionManager, requestMock, requestDAO, hrcDAO);
        org.apache.ambari.server.controller.spi.ResourceProvider provider = org.apache.ambari.server.controller.internal.AbstractControllerResourceProvider.getResourceProvider(type, managementController);
        java.util.Set<java.lang.String> propertyIds = new java.util.HashSet<>();
        propertyIds.add(org.apache.ambari.server.controller.internal.RequestResourceProvider.REQUEST_ID_PROPERTY_ID);
        propertyIds.add(org.apache.ambari.server.controller.internal.RequestResourceProvider.REQUEST_STATUS_PROPERTY_ID);
        ...
        org.powermock.api.easymock.PowerMock.verify(managementController, actionManager, requestMock, requestDAO, hrcDAO);
    }
    ...
    public void testGetResourcesWithCluster() throws java.lang.Exception {
        ...
        org.apache.ambari.server.state.Clusters clusters = org.powermock.api.easymock.PowerMock.createNiceMock(org.apache.ambari.server.state.Clusters.class);
        org.apache.ambari.server.state.Cluster cluster = org.powermock.api.easymock.PowerMock.createNiceMock(org.apache.ambari.server.state.Cluster.class);
        org.easymock.EasyMock.expect(cluster.getClusterId()).andReturn(50L).anyTimes();
        org.apache.ambari.server.orm.entities.RequestEntity requestMock = org.powermock.api.easymock.PowerMock.createNiceMock(org.apache.ambari.server.orm.entities.RequestEntity.class);
        org.easymock.EasyMock.expect(requestMock.getRequestContext()).andReturn("this is a context").anyTimes();
        org.easymock.EasyMock.expect(requestMock.getClusterId()).andReturn(50L).anyTimes();
        org.easymock.EasyMock.expect(requestMock.getRequestId()).andReturn(100L).anyTimes();
        org.easymock.Capture<java.util.Collection<java.lang.Long>> requestIdsCapture = org.easymock.EasyMock.newCapture();
        org.easymock.EasyMock.expect(managementController.getActionManager()).andReturn(actionManager).anyTimes();
        org.easymock.EasyMock.expect(managementController.getClusters()).andReturn(clusters).anyTimes();
        org.easymock.EasyMock.expect(clusters.getCluster("c1")).andReturn(cluster).anyTimes();
        org.easymock.EasyMock.expect(clusters.getCluster("bad-cluster")).andThrow(new org.apache.ambari.server.AmbariException("bad cluster!")).anyTimes();
        org.easymock.EasyMock.expect(requestDAO.findByPks(org.easymock.EasyMock.capture(requestIdsCapture), org.easymock.EasyMock.eq(true))).andReturn(java.util.Collections.singletonList(requestMock));
        org.easymock.EasyMock.expect(hrcDAO.findAggregateCounts(((java.lang.Long) (org.easymock.EasyMock.anyObject())))).andReturn(new java.util.HashMap<java.lang.Long, org.apache.ambari.server.orm.dao.HostRoleCommandStatusSummaryDTO>() {
            {
                put(1L, org.apache.ambari.server.orm.dao.HostRoleCommandStatusSummaryDTO.create().inProgress(1));
            }
        ...
        prepareGetAuthorizationExpectations();
        org.powermock.api.easymock.PowerMock.replay(managementController, actionManager, clusters, cluster, requestMock, requestDAO, hrcDAO);
        org.apache.ambari.server.controller.spi.ResourceProvider provider = org.apache.ambari.server.controller.internal.AbstractControllerResourceProvider.getResourceProvider(type, managementController);
        java.util.Set<java.lang.String> propertyIds = new java.util.HashSet<>();
        propertyIds.add(org.apache.ambari.server.controller.internal.RequestResourceProvider.REQUEST_ID_PROPERTY_ID);
        propertyIds.add(org.apache.ambari.server.controller.internal.RequestResourceProvider.REQUEST_STATUS_PROPERTY_ID);
        ...
        org.powermock.api.easymock.PowerMock.verify(managementController, actionManager, clusters, cluster, requestMock, requestDAO, hrcDAO);
    }
    ...
    public void testGetResourcesOrPredicate() throws java.lang.Exception {
        ...
        org.easymock.EasyMock.expect(requestMock.getRequestContext()).andReturn("this is a context").anyTimes();
        org.easymock.EasyMock.expect(requestMock.getRequestId()).andReturn(100L).anyTimes();
        org.apache.ambari.server.orm.entities.RequestEntity requestMock1 = org.powermock.api.easymock.PowerMock.createNiceMock(org.apache.ambari.server.orm.entities.RequestEntity.class);
        org.easymock.EasyMock.expect(requestMock1.getRequestContext()).andReturn("this is a context").anyTimes();
        org.easymock.EasyMock.expect(requestMock1.getRequestId()).andReturn(101L).anyTimes();
        org.easymock.Capture<java.util.Collection<java.lang.Long>> requestIdsCapture = org.easymock.EasyMock.newCapture();
        org.easymock.EasyMock.expect(managementController.getActionManager()).andReturn(actionManager).anyTimes();
        org.easymock.EasyMock.expect(requestDAO.findByPks(org.easymock.EasyMock.capture(requestIdsCapture), org.easymock.EasyMock.eq(true))).andReturn(java.util.Arrays.asList(requestMock, requestMock1)).anyTimes();
        org.easymock.EasyMock.expect(hrcDAO.findAggregateCounts(((java.lang.Long) (org.easymock.EasyMock.anyObject())))).andReturn(new java.util.HashMap<java.lang.Long, org.apache.ambari.server.orm.dao.HostRoleCommandStatusSummaryDTO>() {
            {
                put(1L, org.apache.ambari.server.orm.dao.HostRoleCommandStatusSummaryDTO.create().inProgress(1));
            }
        ...
        prepareGetAuthorizationExpectations();
        org.powermock.api.easymock.PowerMock.replay(managementController, actionManager, requestMock, requestMock1, requestDAO, hrcDAO);
        org.apache.ambari.server.controller.spi.ResourceProvider provider = org.apache.ambari.server.controller.internal.AbstractControllerResourceProvider.getResourceProvider(type, managementController);
        java.util.Set<java.lang.String> propertyIds = new java.util.HashSet<>();
        propertyIds.add(org.apache.ambari.server.controller.internal.RequestResourceProvider.REQUEST_ID_PROPERTY_ID);
        ...
        org.powermock.api.easymock.PowerMock.verify(managementController, actionManager, requestMock, requestMock1, requestDAO, hrcDAO);
    }
    ...
    public void testGetResourcesCompleted() throws java.lang.Exception {
        ...
        org.apache.ambari.server.controller.AmbariManagementController managementController = org.powermock.api.easymock.PowerMock.createMock(org.apache.ambari.server.controller.AmbariManagementController.class);
        org.apache.ambari.server.actionmanager.ActionManager actionManager = org.powermock.api.easymock.PowerMock.createNiceMock(org.apache.ambari.server.actionmanager.ActionManager.class);
        org.apache.ambari.server.orm.entities.RequestEntity requestMock0 = org.powermock.api.easymock.PowerMock.createNiceMock(org.apache.ambari.server.orm.entities.RequestEntity.class);
        org.easymock.EasyMock.expect(requestMock0.getRequestContext()).andReturn("this is a context").anyTimes();
        org.easymock.EasyMock.expect(requestMock0.getRequestId()).andReturn(100L).anyTimes();
        org.apache.ambari.server.orm.entities.RequestEntity requestMock1 = org.powermock.api.easymock.PowerMock.createNiceMock(org.apache.ambari.server.orm.entities.RequestEntity.class);
        org.easymock.EasyMock.expect(requestMock1.getRequestContext()).andReturn("this is a context").anyTimes();
        org.easymock.EasyMock.expect(requestMock1.getRequestId()).andReturn(101L).anyTimes();
        org.easymock.Capture<java.util.Collection<java.lang.Long>> requestIdsCapture = org.easymock.EasyMock.newCapture();
        org.easymock.EasyMock.expect(managementController.getActionManager()).andReturn(actionManager).anyTimes();
        org.easymock.EasyMock.expect(requestDAO.findByPks(org.easymock.EasyMock.capture(requestIdsCapture), org.easymock.EasyMock.eq(true))).andReturn(java.util.Arrays.asList(requestMock0));
        org.easymock.EasyMock.expect(requestDAO.findByPks(org.easymock.EasyMock.capture(requestIdsCapture), org.easymock.EasyMock.eq(true))).andReturn(java.util.Arrays.asList(requestMock1));
        org.easymock.EasyMock.expect(hrcDAO.findAggregateCounts(((java.lang.Long) (org.easymock.EasyMock.anyObject())))).andReturn(new java.util.HashMap<java.lang.Long, org.apache.ambari.server.orm.dao.HostRoleCommandStatusSummaryDTO>() {
            {
        ...
        prepareGetAuthorizationExpectations();
        org.powermock.api.easymock.PowerMock.replay(managementController, actionManager, requestMock0, requestMock1, requestDAO, hrcDAO);
        org.apache.ambari.server.controller.spi.ResourceProvider provider = org.apache.ambari.server.controller.internal.AbstractControllerResourceProvider.getResourceProvider(type, managementController);
        java.util.Set<java.lang.String> propertyIds = new java.util.HashSet<>();
        propertyIds.add(org.apache.ambari.server.controller.internal.RequestResourceProvider.REQUEST_ID_PROPERTY_ID);
        propertyIds.add(org.apache.ambari.server.controller.internal.RequestResourceProvider.REQUEST_STATUS_PROPERTY_ID);
        ...
        org.powermock.api.easymock.PowerMock.verify(managementController, actionManager, requestMock0, requestMock1, requestDAO, hrcDAO);
    }
    ...
    public void testGetResourcesInProgress() throws java.lang.Exception {
        ...
        org.easymock.EasyMock.expect(requestDAO.findByPks(org.easymock.EasyMock.capture(requestIdsCapture), org.easymock.EasyMock.eq(true))).andReturn(java.util.Arrays.asList(requestMock0));
        org.easymock.EasyMock.expect(requestDAO.findByPks(org.easymock.EasyMock.capture(requestIdsCapture), org.easymock.EasyMock.eq(true))).andReturn(java.util.Arrays.asList(requestMock1));
        org.easymock.EasyMock.expect(hrcDAO.findAggregateCounts(100L)).andReturn(new java.util.HashMap<java.lang.Long, org.apache.ambari.server.orm.dao.HostRoleCommandStatusSummaryDTO>() {
            {
                put(1L, org.apache.ambari.server.orm.dao.HostRoleCommandStatusSummaryDTO.create().inProgress(1).pending(1));
            }
        }).once();
        org.easymock.EasyMock.expect(hrcDAO.findAggregateCounts(101L)).andReturn(new java.util.HashMap<java.lang.Long, org.apache.ambari.server.orm.dao.HostRoleCommandStatusSummaryDTO>() {
            {
    ...
    public void testUpdateResources_CancelRequest() throws java.lang.Exception {
        ...
        org.apache.ambari.server.controller.AmbariManagementController managementController = org.powermock.api.easymock.PowerMock.createMock(org.apache.ambari.server.controller.AmbariManagementController.class);
        org.apache.ambari.server.actionmanager.ActionManager actionManager = org.powermock.api.easymock.PowerMock.createNiceMock(org.apache.ambari.server.actionmanager.ActionManager.class);
        org.apache.ambari.server.actionmanager.HostRoleCommand hostRoleCommand = org.powermock.api.easymock.PowerMock.createNiceMock(org.apache.ambari.server.actionmanager.HostRoleCommand.class);
        org.apache.ambari.server.actionmanager.Stage stage = org.powermock.api.easymock.PowerMock.createNiceMock(org.apache.ambari.server.actionmanager.Stage.class);
        org.apache.ambari.server.state.Clusters clusters = org.powermock.api.easymock.PowerMock.createNiceMock(org.apache.ambari.server.state.Clusters.class);
        ...
        stages.add(stage);
        org.apache.ambari.server.actionmanager.Request requestMock = org.powermock.api.easymock.PowerMock.createNiceMock(org.apache.ambari.server.actionmanager.Request.class);
        org.easymock.EasyMock.expect(requestMock.getCommands()).andReturn(hostRoleCommands).anyTimes();
        org.easymock.EasyMock.expect(requestMock.getStages()).andReturn(stages).anyTimes();
        org.easymock.EasyMock.expect(stage.getOrderedHostRoleCommands()).andReturn(hostRoleCommands).anyTimes();
        org.easymock.Capture<java.util.Collection<java.lang.Long>> requestIdsCapture = org.easymock.EasyMock.newCapture();
        org.easymock.EasyMock.expect(managementController.getActionManager()).andReturn(actionManager).anyTimes();
        org.easymock.EasyMock.expect(actionManager.getRequests(org.easymock.EasyMock.capture(requestIdsCapture))).andReturn(java.util.Collections.singletonList(requestMock)).anyTimes();
        org.easymock.EasyMock.expect(hostRoleCommand.getStatus()).andReturn(org.apache.ambari.server.actionmanager.HostRoleStatus.IN_PROGRESS).anyTimes();
        org.apache.ambari.server.controller.RequestStatusResponse response = org.powermock.api.easymock.PowerMock.createNiceMock(org.apache.ambari.server.controller.RequestStatusResponse.class);
        prepareGetAuthorizationExpectations();
        org.powermock.api.easymock.PowerMock.replay(managementController, actionManager, hostRoleCommand, clusters, requestMock, response, stage);
        org.apache.ambari.server.controller.spi.ResourceProvider provider = org.apache.ambari.server.controller.internal.AbstractControllerResourceProvider.getResourceProvider(type, managementController);
        java.util.Map<java.lang.String, java.lang.Object> properties = new java.util.LinkedHashMap<>();
        ...
        for (org.apache.ambari.server.actionmanager.HostRoleStatus status : org.apache.ambari.server.actionmanager.HostRoleStatus.values()) {
            org.powermock.api.easymock.PowerMock.reset(hostRoleCommand);
            org.easymock.EasyMock.expect(hostRoleCommand.getStatus()).andReturn(status).anyTimes();
            org.powermock.api.easymock.PowerMock.replay(hostRoleCommand);
            request = org.apache.ambari.server.controller.utilities.PropertyHelper.getUpdateRequest(properties, null);
        ...
        org.powermock.api.easymock.PowerMock.verify(managementController, response, stage);
    }
    ...
    public void testDeleteResources() throws java.lang.Exception {
        org.apache.ambari.server.controller.spi.Resource.Type type = org.apache.ambari.server.controller.spi.Resource.Type.Request;
        org.apache.ambari.server.controller.AmbariManagementController managementController = org.powermock.api.easymock.PowerMock.createMock(org.apache.ambari.server.controller.AmbariManagementController.class);
        org.powermock.api.easymock.PowerMock.replay(managementController);
        org.apache.ambari.server.controller.spi.ResourceProvider provider = org.apache.ambari.server.controller.internal.AbstractControllerResourceProvider.getResourceProvider(type, managementController);
        ...
        org.powermock.api.easymock.PowerMock.verify(managementController);
    }
    ...
    private void testCreateResourcesForCommands(org.springframework.security.core.Authentication authentication) throws java.lang.Exception {
        ...
        org.apache.ambari.server.state.Cluster cluster = org.powermock.api.easymock.PowerMock.createMock(org.apache.ambari.server.state.Cluster.class);
        org.easymock.EasyMock.expect(cluster.getClusterId()).andReturn(2L).anyTimes();
        org.easymock.EasyMock.expect(cluster.getResourceId()).andReturn(4L).anyTimes();
        org.apache.ambari.server.state.Clusters clusters = org.powermock.api.easymock.PowerMock.createMock(org.apache.ambari.server.state.Clusters.class);
        org.easymock.EasyMock.expect(clusters.getCluster("c1")).andReturn(cluster).anyTimes();
        org.apache.ambari.server.controller.AmbariManagementController managementController = org.powermock.api.easymock.PowerMock.createMock(org.apache.ambari.server.controller.AmbariManagementController.class);
        org.apache.ambari.server.controller.RequestStatusResponse response = org.powermock.api.easymock.PowerMock.createNiceMock(org.apache.ambari.server.controller.RequestStatusResponse.class);
        org.easymock.EasyMock.expect(managementController.getClusters()).andReturn(clusters).anyTimes();
        org.easymock.EasyMock.expect(managementController.createAction(org.easymock.EasyMock.capture(actionRequest), org.easymock.EasyMock.capture(propertyMap))).andReturn(response).anyTimes();
        org.easymock.EasyMock.expect(response.getMessage()).andReturn("Message").anyTimes();
        org.powermock.api.easymock.PowerMock.replay(cluster, clusters, managementController, response);
    ...
    public void testCreateResourcesForCommandWithHostPredicate() throws java.lang.Exception {
        ...
        org.apache.ambari.server.controller.internal.ClusterControllerImpl controller = org.powermock.api.easymock.PowerMock.createNiceMock(org.apache.ambari.server.controller.internal.ClusterControllerImpl.class);
        org.apache.ambari.server.controller.internal.HostComponentProcessResourceProvider hostComponentProcessResourceProvider = org.powermock.api.easymock.PowerMock.createNiceMock(org.apache.ambari.server.controller.internal.HostComponentProcessResourceProvider.class);
        ...
        org.apache.ambari.server.controller.spi.Resource resource = org.powermock.api.easymock.PowerMock.createNiceMock(org.apache.ambari.server.controller.spi.Resource.class);
        ...
        org.easymock.EasyMock.expect(org.apache.ambari.server.controller.utilities.ClusterControllerHelper.getClusterController()).andReturn(controller);
        org.easymock.EasyMock.expect(controller.ensureResourceProvider(org.apache.ambari.server.controller.spi.Resource.Type.HostComponent)).andReturn(hostComponentProcessResourceProvider);
        org.apache.ambari.server.controller.spi.QueryResponse queryResponse = org.powermock.api.easymock.PowerMock.createNiceMock(org.apache.ambari.server.controller.spi.QueryResponse.class);
        org.easymock.EasyMock.expect(controller.getResources(org.easymock.EasyMock.eq(org.apache.ambari.server.controller.spi.Resource.Type.HostComponent), org.easymock.EasyMock.capture(requestCapture), org.easymock.EasyMock.capture(predicateCapture))).andReturn(queryResponse);
        org.easymock.EasyMock.expect(controller.getIterable(org.easymock.EasyMock.eq(org.apache.ambari.server.controller.spi.Resource.Type.HostComponent), org.easymock.EasyMock.eq(queryResponse), ((org.apache.ambari.server.controller.spi.Request) (org.easymock.EasyMock.anyObject())), ((org.apache.ambari.server.controller.spi.Predicate) (org.easymock.EasyMock.anyObject())), org.easymock.EasyMock.eq(null), org.easymock.EasyMock.eq(null))).andReturn(resourceIterable);
    ...
    private void testCreateResources(org.springframework.security.core.Authentication authentication, java.lang.String clusterName, java.lang.String commandName, java.lang.String actionName, java.util.Set<org.apache.ambari.server.security.authorization.RoleAuthorization> permissions) throws java.lang.Exception {
        ...
        org.easymock.Capture<java.util.HashMap<java.lang.String, java.lang.String>> propertyMap = org.easymock.EasyMock.newCapture();
        org.apache.ambari.server.controller.AmbariManagementController managementController = org.powermock.api.easymock.PowerMock.createMock(org.apache.ambari.server.controller.AmbariManagementController.class);
        org.apache.ambari.server.api.services.AmbariMetaInfo metaInfo = org.powermock.api.easymock.PowerMock.createMock(org.apache.ambari.server.api.services.AmbariMetaInfo.class);
        org.apache.ambari.server.customactions.ActionDefinition actionDefinition = org.powermock.api.easymock.PowerMock.createMock(org.apache.ambari.server.customactions.ActionDefinition.class);
        org.apache.ambari.server.controller.RequestStatusResponse response = org.powermock.api.easymock.PowerMock.createNiceMock(org.apache.ambari.server.controller.RequestStatusResponse.class);
        org.easymock.EasyMock.expect(managementController.createAction(org.easymock.EasyMock.capture(actionRequest), org.easymock.EasyMock.capture(propertyMap))).andReturn(response).anyTimes();
        org.easymock.EasyMock.expect(managementController.getAmbariMetaInfo()).andReturn(metaInfo).anyTimes();
        org.easymock.EasyMock.expect(metaInfo.getActionDefinition(actionName)).andReturn(actionDefinition).anyTimes();
        org.easymock.EasyMock.expect(actionDefinition.getPermissions()).andReturn(permissions).anyTimes();
        org.easymock.EasyMock.expect(response.getMessage()).andReturn("Message").anyTimes();
        org.apache.ambari.server.state.Cluster cluster = org.powermock.api.easymock.PowerMock.createMock(org.apache.ambari.server.state.Cluster.class);
        org.apache.ambari.server.state.Clusters clusters = org.powermock.api.easymock.PowerMock.createMock(org.apache.ambari.server.state.Clusters.class);
        if (clusterName != null) {
        ...
        org.powermock.api.easymock.PowerMock.replay(managementController, metaInfo, actionDefinition, response, cluster, clusters);
        java.util.Set<java.util.Map<java.lang.String, java.lang.Object>> propertySet = new java.util.LinkedHashSet<>();
        java.util.Map<java.lang.String, java.lang.Object> properties = new java.util.LinkedHashMap<>();
        java.util.Set<java.util.Map<java.lang.String, java.lang.Object>> filterSet = new java.util.HashSet<>();
        java.util.Map<java.lang.String, java.lang.Object> filterMap = new java.util.HashMap<>();
    ...
    public void testGetResourcesWithoutCluster() throws java.lang.Exception {
        ...
        org.easymock.EasyMock.expect(managementController.getActionManager()).andReturn(actionManager).anyTimes();
        org.easymock.EasyMock.expect(managementController.getClusters()).andReturn(clusters).anyTimes();
        org.easymock.EasyMock.expect(clusters.getCluster(org.easymock.EasyMock.anyObject(java.lang.String.class))).andReturn(null).anyTimes();
        org.easymock.EasyMock.expect(requestDAO.findByPks(org.easymock.EasyMock.capture(requestIdsCapture), org.easymock.EasyMock.eq(true))).andReturn(java.util.Collections.singletonList(requestMock));
        org.easymock.EasyMock.expect(hrcDAO.findAggregateCounts(((java.lang.Long) (org.easymock.EasyMock.anyObject())))).andReturn(new java.util.HashMap<java.lang.Long, org.apache.ambari.server.orm.dao.HostRoleCommandStatusSummaryDTO>() {
            {
                put(1L, org.apache.ambari.server.orm.dao.HostRoleCommandStatusSummaryDTO.create().inProgress(1));
        ...
        prepareGetAuthorizationExpectations();
        org.powermock.api.easymock.PowerMock.replay(managementController, actionManager, clusters, requestMock, requestDAO, hrcDAO);
        org.apache.ambari.server.controller.spi.ResourceProvider provider = org.apache.ambari.server.controller.internal.AbstractControllerResourceProvider.getResourceProvider(type, managementController);
        java.util.Set<java.lang.String> propertyIds = new java.util.HashSet<>();
        propertyIds.add(org.apache.ambari.server.controller.internal.RequestResourceProvider.REQUEST_ID_PROPERTY_ID);
        propertyIds.add(org.apache.ambari.server.controller.internal.RequestResourceProvider.REQUEST_STATUS_PROPERTY_ID);
        ...
        org.powermock.api.easymock.PowerMock.verify(managementController, actionManager, clusters, requestMock, requestDAO, hrcDAO);
    }
    ...
    public void testRequestStatusWithNoTasks() throws java.lang.Exception {
        ...
        org.easymock.EasyMock.expect(clusters.getCluster(org.easymock.EasyMock.anyObject(java.lang.String.class))).andReturn(null).anyTimes();
        org.easymock.EasyMock.expect(requestDAO.findByPks(org.easymock.EasyMock.capture(requestIdsCapture), org.easymock.EasyMock.eq(true))).andReturn(java.util.Collections.singletonList(requestMock));
        org.easymock.EasyMock.expect(hrcDAO.findAggregateCounts(((java.lang.Long) (org.easymock.EasyMock.anyObject())))).andReturn(java.util.Collections.emptyMap()).anyTimes();
        prepareGetAuthorizationExpectations();
        org.powermock.api.easymock.PowerMock.replay(managementController, actionManager, clusters, requestMock, requestDAO, hrcDAO);
        org.apache.ambari.server.controller.spi.ResourceProvider provider = org.apache.ambari.server.controller.internal.AbstractControllerResourceProvider.getResourceProvider(type, managementController);
        java.util.Set<java.lang.String> propertyIds = new java.util.HashSet<>();
    ...
    public void testGetLogicalRequestStatusWithNoTasks() throws java.lang.Exception {
        ...
        for (org.apache.ambari.server.controller.internal.CalculatedStatus calculatedStatus : statusList) {
            ...
            org.apache.ambari.server.state.Cluster cluster = org.powermock.api.easymock.PowerMock.createNiceMock(org.apache.ambari.server.state.Cluster.class);
            org.apache.ambari.server.orm.entities.RequestEntity requestMock = org.powermock.api.easymock.PowerMock.createNiceMock(org.apache.ambari.server.orm.entities.RequestEntity.class);
            org.apache.ambari.server.topology.Blueprint blueprint = org.powermock.api.easymock.PowerMock.createNiceMock(org.apache.ambari.server.topology.Blueprint.class);
            org.apache.ambari.server.topology.ClusterTopology topology = org.powermock.api.easymock.PowerMock.createNiceMock(org.apache.ambari.server.topology.ClusterTopology.class);
            org.apache.ambari.server.topology.HostGroup hostGroup = org.powermock.api.easymock.PowerMock.createNiceMock(org.apache.ambari.server.topology.HostGroup.class);
            org.apache.ambari.server.topology.TopologyRequest topologyRequest = org.powermock.api.easymock.PowerMock.createNiceMock(org.apache.ambari.server.topology.TopologyRequest.class);
            org.apache.ambari.server.topology.LogicalRequest logicalRequest = org.powermock.api.easymock.PowerMock.createNiceMock(org.apache.ambari.server.topology.LogicalRequest.class);
            org.apache.ambari.server.topology.HostRequest hostRequest = org.powermock.api.easymock.PowerMock.createNiceMock(org.apache.ambari.server.topology.HostRequest.class);
            ...
            org.easymock.EasyMock.expect(requestMock.getRequestContext()).andReturn("this is a context").anyTimes();
            org.easymock.EasyMock.expect(requestMock.getRequestId()).andReturn(requestId).anyTimes();
            org.easymock.EasyMock.expect(hostGroup.getName()).andReturn(hostGroupName).anyTimes();
            org.easymock.EasyMock.expect(blueprint.getHostGroup(hostGroupName)).andReturn(hostGroup).anyTimes();
            org.easymock.EasyMock.expect(topology.getClusterId()).andReturn(2L).anyTimes();
            org.easymock.EasyMock.expect(cluster.getClusterId()).andReturn(clusterId).anyTimes();
            org.easymock.EasyMock.expect(cluster.getClusterName()).andReturn(clusterName).anyTimes();
            org.easymock.EasyMock.expect(managementController.getActionManager()).andReturn(actionManager).anyTimes();
            org.easymock.EasyMock.expect(managementController.getClusters()).andReturn(clusters).anyTimes();
            org.easymock.EasyMock.expect(clusters.getCluster(org.easymock.EasyMock.eq(clusterName))).andReturn(cluster).anyTimes();
            org.easymock.EasyMock.expect(clusters.getClusterById(clusterId)).andReturn(cluster).anyTimes();
            java.util.Collection<java.lang.Long> requestIds = org.easymock.EasyMock.anyObject();
            org.easymock.EasyMock.expect(requestDAO.findByPks(requestIds, org.easymock.EasyMock.eq(true))).andReturn(com.google.common.collect.Lists.newArrayList(requestMock));
            org.easymock.EasyMock.expect(hrcDAO.findAggregateCounts(((java.lang.Long) (org.easymock.EasyMock.anyObject())))).andReturn(dtoMap).anyTimes();
            org.easymock.EasyMock.expect(topologyManager.getRequest(requestId)).andReturn(logicalRequest).anyTimes();
            org.easymock.EasyMock.expect(topologyManager.getRequests(org.easymock.EasyMock.eq(java.util.Collections.singletonList(requestId)))).andReturn(java.util.Collections.singletonList(logicalRequest)).anyTimes();
            org.easymock.EasyMock.expect(topologyManager.getStageSummaries(org.easymock.EasyMock.<java.lang.Long>anyObject())).andReturn(dtoMap).anyTimes();
            org.easymock.EasyMock.expect(topologyRequest.getHostGroupInfo()).andReturn(hostGroupInfoMap).anyTimes();
            org.easymock.EasyMock.expect(topology.getBlueprint()).andReturn(blueprint).anyTimes();
            org.easymock.EasyMock.expect(blueprint.shouldSkipFailure()).andReturn(true).anyTimes();
            org.easymock.EasyMock.expect(logicalRequest.getHostRequests()).andReturn(hostRequests).anyTimes();
            org.easymock.EasyMock.expect(logicalRequest.constructNewPersistenceEntity()).andReturn(requestMock).anyTimes();
            org.easymock.EasyMock.expect(logicalRequest.calculateStatus()).andReturn(calculatedStatus).anyTimes();
            ...
            org.easymock.EasyMock.expect(logicalRequest.getFailureReason()).andReturn(failureReason).anyTimes();
            prepareGetAuthorizationExpectations();
            org.powermock.api.easymock.PowerMock.replayAll();
            org.apache.ambari.server.controller.spi.Resource.Type type = org.apache.ambari.server.controller.spi.Resource.Type.Request;
            org.apache.ambari.server.controller.spi.ResourceProvider provider = org.apache.ambari.server.controller.internal.AbstractControllerResourceProvider.getResourceProvider(type, managementController);
