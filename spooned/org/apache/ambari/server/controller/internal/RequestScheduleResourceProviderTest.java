...
public class RequestScheduleResourceProviderTest {
    ...
    public void testCreateRequestSchedule() throws java.lang.Exception {
        ...
        org.apache.ambari.server.state.scheduler.RequestExecutionFactory executionFactory = org.easymock.EasyMock.createNiceMock(org.apache.ambari.server.state.scheduler.RequestExecutionFactory.class);
        org.apache.ambari.server.state.scheduler.RequestExecution requestExecution = org.easymock.EasyMock.createNiceMock(org.apache.ambari.server.state.scheduler.RequestExecution.class);
        org.apache.ambari.server.scheduler.ExecutionScheduleManager executionScheduleManager = org.easymock.EasyMock.createNiceMock(org.apache.ambari.server.scheduler.ExecutionScheduleManager.class);
        ...
        org.easymock.EasyMock.expect(managementController.getExecutionScheduleManager()).andReturn(executionScheduleManager).anyTimes();
        org.easymock.EasyMock.expect(managementController.getRequestExecutionFactory()).andReturn(executionFactory);
        org.easymock.EasyMock.expect(managementController.getAuthName()).andReturn("admin").anyTimes();
        org.easymock.EasyMock.expect(managementController.getAuthId()).andReturn(1).anyTimes();
        ...
        org.easymock.EasyMock.expect(executionFactory.createNew(org.easymock.EasyMock.capture(clusterCapture), org.easymock.EasyMock.capture(batchCapture), org.easymock.EasyMock.capture(scheduleCapture))).andReturn(requestExecution);
        org.easymock.EasyMock.replay(managementController, clusters, cluster, executionFactory, requestExecution, response, executionScheduleManager);
        ...
        org.easymock.EasyMock.verify(managementController, clusters, cluster, executionFactory, requestExecution, response, executionScheduleManager);
    ...
    public void testUpdateRequestSchedule() throws java.lang.Exception {
        ...
        org.apache.ambari.server.state.Clusters clusters = org.easymock.EasyMock.createNiceMock(org.apache.ambari.server.state.Clusters.class);
        org.apache.ambari.server.state.Cluster cluster = org.easymock.EasyMock.createNiceMock(org.apache.ambari.server.state.Cluster.class);
        final org.apache.ambari.server.state.scheduler.RequestExecution requestExecution = org.easymock.EasyMock.createNiceMock(org.apache.ambari.server.state.scheduler.RequestExecution.class);
        org.apache.ambari.server.controller.RequestScheduleResponse requestScheduleResponse = org.easymock.EasyMock.createNiceMock(org.apache.ambari.server.controller.RequestScheduleResponse.class);
        org.apache.ambari.server.scheduler.ExecutionScheduleManager executionScheduleManager = org.easymock.EasyMock.createNiceMock(org.apache.ambari.server.scheduler.ExecutionScheduleManager.class);
        ...
        org.easymock.EasyMock.expect(managementController.getAuthId()).andReturn(1).anyTimes();
        org.easymock.EasyMock.expect(managementController.getExecutionScheduleManager()).andReturn(executionScheduleManager).anyTimes();
        org.easymock.EasyMock.expect(requestExecution.getId()).andReturn(25L).anyTimes();
        org.easymock.EasyMock.expect(requestExecution.convertToResponse()).andReturn(requestScheduleResponse).anyTimes();
        org.easymock.EasyMock.expect(requestExecution.convertToResponseWithBody()).andReturn(requestScheduleResponse).anyTimes();
        org.easymock.EasyMock.expect(requestScheduleResponse.getId()).andReturn(25L).anyTimes();
        org.easymock.EasyMock.expect(requestScheduleResponse.getClusterName()).andReturn("Cluster100").anyTimes();
        org.easymock.EasyMock.expect(cluster.getAllRequestExecutions()).andStubAnswer(new org.easymock.IAnswer<java.util.Map<java.lang.Long, org.apache.ambari.server.state.scheduler.RequestExecution>>() {
            @java.lang.Override
        ...
        org.easymock.EasyMock.replay(managementController, clusters, cluster, requestExecution, response, requestScheduleResponse, executionScheduleManager);
        org.apache.ambari.server.controller.internal.RequestScheduleResourceProvider resourceProvider = getResourceProvider(managementController);
        java.util.Map<java.lang.String, java.lang.Object> properties = new java.util.LinkedHashMap<>();
        properties.put(org.apache.ambari.server.controller.internal.RequestScheduleResourceProvider.CLUSTER_NAME, "Cluster100");
        properties.put(org.apache.ambari.server.controller.internal.RequestScheduleResourceProvider.DESCRIPTION, "some description");
        ...
        org.easymock.EasyMock.verify(managementController, clusters, cluster, requestExecution, response, requestScheduleResponse, executionScheduleManager);
    }
    ...
    public void testGetRequestSchedule() throws java.lang.Exception {
        ...
        org.easymock.EasyMock.expect(managementController.getAuthName()).andReturn("admin").anyTimes();
        org.easymock.EasyMock.expect(requestExecution.getId()).andReturn(25L).anyTimes();
        org.easymock.EasyMock.expect(requestExecution.getStatus()).andReturn(org.apache.ambari.server.state.scheduler.RequestExecution.Status.SCHEDULED.name()).anyTimes();
        org.easymock.EasyMock.expect(requestExecution.convertToResponse()).andReturn(requestScheduleResponse).anyTimes();
        org.easymock.EasyMock.expect(requestExecution.convertToResponseWithBody()).andReturn(requestScheduleResponse).anyTimes();
        org.easymock.EasyMock.expect(requestScheduleResponse.getId()).andReturn(25L).anyTimes();
        org.easymock.EasyMock.expect(requestScheduleResponse.getClusterName()).andReturn("Cluster100").anyTimes();
        ...
        org.easymock.EasyMock.replay(managementController, clusters, cluster, requestExecution, response, requestScheduleResponse);
        org.apache.ambari.server.controller.internal.RequestScheduleResourceProvider resourceProvider = getResourceProvider(managementController);
        java.util.Map<java.lang.String, java.lang.Object> properties = new java.util.LinkedHashMap<>();
        properties.put(org.apache.ambari.server.controller.internal.RequestScheduleResourceProvider.CLUSTER_NAME, "Cluster100");
        properties.put(org.apache.ambari.server.controller.internal.RequestScheduleResourceProvider.DESCRIPTION, "some description");
        ...
        junit.framework.Assert.assertEquals(1, resources.size());
        junit.framework.Assert.assertEquals(25L, resources.iterator().next().getPropertyValue(org.apache.ambari.server.controller.internal.RequestScheduleResourceProvider.ID));
        org.easymock.EasyMock.verify(managementController, clusters, cluster, requestExecution, response, requestScheduleResponse);
    }
    ...
    public void testDeleteRequestSchedule() throws java.lang.Exception {
        ...
        org.easymock.EasyMock.expect(managementController.getExecutionScheduleManager()).andReturn(executionScheduleManager).anyTimes();
        org.easymock.EasyMock.expect(clusters.getCluster("Cluster100")).andReturn(cluster).anyTimes();
        org.easymock.EasyMock.expect(cluster.getAllRequestExecutions()).andReturn(requestExecutionMap);
        org.easymock.EasyMock.replay(managementController, clusters, cluster, executionScheduleManager, requestExecution);
        org.apache.ambari.server.controller.internal.RequestScheduleResourceProvider resourceProvider = getResourceProvider(managementController);
        ...
        org.easymock.EasyMock.verify(managementController, clusters, cluster, executionScheduleManager, requestExecution);
    }
}
