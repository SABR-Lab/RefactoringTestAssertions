...
public class RoleAuthorizationResourceProviderTest extends org.easymock.EasyMockSupport {
    ...
    public void testGetResources() throws java.lang.Exception {
        ...
        org.easymock.EasyMock.expect(roleAuthorizationEntity.getAuthorizationId()).andReturn("TEST.DO_SOMETHING");
        org.easymock.EasyMock.expect(roleAuthorizationEntity.getAuthorizationName()).andReturn("Do Something");
        ...
        org.easymock.EasyMock.expect(roleAuthorizationDAO.findAll()).andReturn(authorizationEntities);
        replayAll();
    ...
    public void testGetResourcesForPermission() throws java.lang.Exception {
        org.apache.ambari.server.orm.entities.RoleAuthorizationEntity roleAuthorizationEntity = createNiceMock(org.apache.ambari.server.orm.entities.RoleAuthorizationEntity.class);
        org.easymock.EasyMock.expect(roleAuthorizationEntity.getAuthorizationId()).andReturn("TEST.DO_SOMETHING").once();
        org.easymock.EasyMock.expect(roleAuthorizationEntity.getAuthorizationName()).andReturn("Do Something").once();
        java.util.List<org.apache.ambari.server.orm.entities.RoleAuthorizationEntity> authorizationEntities = new java.util.ArrayList<>();
        authorizationEntities.add(roleAuthorizationEntity);
        ...
        org.easymock.EasyMock.expect(permissionEntry.getAuthorizations()).andReturn(authorizationEntities).once();
        ...
        org.easymock.EasyMock.expect(permissionDAO.findById(1)).andReturn(permissionEntry).once();
        replayAll();
        org.apache.ambari.server.controller.AmbariManagementController managementController = org.apache.ambari.server.controller.internal.RoleAuthorizationResourceProviderTest.injector.getInstance(org.apache.ambari.server.controller.AmbariManagementController.class);
        org.apache.ambari.server.controller.internal.RoleAuthorizationResourceProvider provider = new org.apache.ambari.server.controller.internal.RoleAuthorizationResourceProvider(managementController);
    ...
    public void testGetResource() throws java.lang.Exception {
        ...
        org.easymock.EasyMock.expect(roleAuthorizationEntity1.getAuthorizationId()).andReturn("TEST.DO_SOMETHING").anyTimes();
        org.easymock.EasyMock.expect(roleAuthorizationEntity1.getAuthorizationName()).andReturn("Do Something").anyTimes();
        ...
        org.easymock.EasyMock.expect(roleAuthorizationEntity2.getAuthorizationId()).andReturn("TEST.DO_SOMETHING_ELSE").anyTimes();
        org.easymock.EasyMock.expect(roleAuthorizationEntity2.getAuthorizationName()).andReturn("Do Something Else").anyTimes();
        java.util.List<org.apache.ambari.server.orm.entities.RoleAuthorizationEntity> authorizationEntities = new java.util.ArrayList<>();
