...
public class RootServiceComponentConfigurationResourceProviderTest extends org.easymock.EasyMockSupport {
    ...
    private void testCreateResources(org.springframework.security.core.Authentication authentication, java.lang.String opDirective) throws java.lang.Exception {
        ...
        org.easymock.EasyMock.expect(request.getProperties()).andReturn(propertySets).once();
        org.easymock.EasyMock.expect(request.getRequestInfoProperties()).andReturn(requestInfoProperties).once();
        org.easymock.Capture<java.util.Map<java.lang.String, java.lang.String>> capturedProperties1 = org.easymock.EasyMock.newCapture();
        org.easymock.Capture<java.util.Map<java.lang.String, java.lang.String>> capturedProperties2 = org.easymock.EasyMock.newCapture();
        if (opDirective == null) {
            org.easymock.EasyMock.expect(dao.reconcileCategory(org.easymock.EasyMock.eq(org.apache.ambari.server.controller.internal.RootServiceComponentConfigurationResourceProviderTest.LDAP_CONFIG_CATEGORY), org.easymock.EasyMock.capture(capturedProperties1), org.easymock.EasyMock.eq(true))).andReturn(true).once();
            org.easymock.EasyMock.expect(dao.reconcileCategory(org.easymock.EasyMock.eq(org.apache.ambari.server.controller.internal.RootServiceComponentConfigurationResourceProviderTest.SSO_CONFIG_CATEGORY), org.easymock.EasyMock.capture(capturedProperties2), org.easymock.EasyMock.eq(true))).andReturn(true).once();
            org.easymock.EasyMock.expect(dao.findByCategory(org.easymock.EasyMock.eq(org.apache.ambari.server.controller.internal.RootServiceComponentConfigurationResourceProviderTest.SSO_CONFIG_CATEGORY))).andReturn(java.util.Collections.emptyList()).once();
            publisher.publish(org.easymock.EasyMock.anyObject(org.apache.ambari.server.events.AmbariConfigurationChangedEvent.class));
            org.easymock.EasyMock.expectLastCall().times(2);
        }
        org.easymock.EasyMock.expect(factory.getInstance(org.apache.ambari.server.controller.RootService.AMBARI.name(), org.apache.ambari.server.controller.RootComponent.AMBARI_SERVER.name(), org.apache.ambari.server.controller.internal.RootServiceComponentConfigurationResourceProviderTest.LDAP_CONFIG_CATEGORY)).andReturn(ambariServerLDAPConfigurationHandler).once();
        if (opDirective == null) {
    ...
    private void testDeleteResources(org.springframework.security.core.Authentication authentication) throws java.lang.Exception {
        org.easymock.EasyMock.expect(dao.removeByCategory(org.apache.ambari.server.controller.internal.RootServiceComponentConfigurationResourceProviderTest.LDAP_CONFIG_CATEGORY)).andReturn(1).once();
        publisher.publish(org.easymock.EasyMock.anyObject(org.apache.ambari.server.events.AmbariConfigurationChangedEvent.class));
    ...
    private void testGetResources(org.springframework.security.core.Authentication authentication) throws java.lang.Exception {
        org.easymock.EasyMock.expect(request.getPropertyIds()).andReturn(null).anyTimes();
        java.util.Map<java.lang.String, java.lang.String> properties = new java.util.HashMap<>();
        ...
        org.easymock.EasyMock.expect(dao.findByCategory(org.apache.ambari.server.controller.internal.RootServiceComponentConfigurationResourceProviderTest.LDAP_CONFIG_CATEGORY)).andReturn(createEntities(org.apache.ambari.server.controller.internal.RootServiceComponentConfigurationResourceProviderTest.LDAP_CONFIG_CATEGORY, properties)).once();
        org.easymock.EasyMock.expect(factory.getInstance(org.apache.ambari.server.controller.RootService.AMBARI.name(), org.apache.ambari.server.controller.RootComponent.AMBARI_SERVER.name(), org.apache.ambari.server.controller.internal.RootServiceComponentConfigurationResourceProviderTest.LDAP_CONFIG_CATEGORY)).andReturn(ambariServerLDAPConfigurationHandler).once();
        replayAll();
        org.springframework.security.core.context.SecurityContextHolder.getContext().setAuthentication(authentication);
    ...
    private void testUpdateResources(org.springframework.security.core.Authentication authentication, java.lang.String opDirective) throws java.lang.Exception {
        ...
        org.easymock.Capture<java.util.Map<java.lang.String, java.lang.String>> capturedProperties1 = org.easymock.EasyMock.newCapture();
        if (opDirective == null) {
            org.easymock.EasyMock.expect(dao.reconcileCategory(org.easymock.EasyMock.eq(org.apache.ambari.server.controller.internal.RootServiceComponentConfigurationResourceProviderTest.LDAP_CONFIG_CATEGORY), org.easymock.EasyMock.capture(capturedProperties1), org.easymock.EasyMock.eq(false))).andReturn(true).once();
            publisher.publish(org.easymock.EasyMock.anyObject(org.apache.ambari.server.events.AmbariConfigurationChangedEvent.class));
