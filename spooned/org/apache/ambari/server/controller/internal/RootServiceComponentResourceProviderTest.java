...
public class RootServiceComponentResourceProviderTest {
    ...
    public void testGetResources() throws java.lang.Exception {
        ...
        org.easymock.EasyMock.expect(managementController.getRootServiceComponents(org.easymock.EasyMock.anyObject())).andReturn(allResponse).once();
        org.easymock.EasyMock.expect(managementController.getRootServiceComponents(org.easymock.EasyMock.anyObject())).andReturn(nameResponse).once();
