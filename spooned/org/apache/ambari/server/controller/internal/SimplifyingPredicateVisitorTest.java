...
public class SimplifyingPredicateVisitorTest {
    ...
    public void testVisit() {
        org.apache.ambari.server.controller.spi.ResourceProvider provider = org.easymock.EasyMock.createStrictMock(org.apache.ambari.server.controller.spi.ResourceProvider.class);
        ...
        org.easymock.EasyMock.expect(provider.checkPropertyIds(org.easymock.EasyMock.capture(propertiesCapture))).andReturn(java.util.Collections.emptySet()).anyTimes();
        org.easymock.EasyMock.replay(provider);
        ...
        org.easymock.EasyMock.verify(provider);
        org.easymock.EasyMock.reset(provider);
        org.easymock.EasyMock.expect(provider.checkPropertyIds(org.easymock.EasyMock.capture(propertiesCapture))).andReturn(java.util.Collections.emptySet());
        org.easymock.EasyMock.expect(provider.checkPropertyIds(org.easymock.EasyMock.capture(propertiesCapture))).andReturn(java.util.Collections.singleton(org.apache.ambari.server.controller.internal.SimplifyingPredicateVisitorTest.PROPERTY_D));
        org.easymock.EasyMock.replay(provider);
