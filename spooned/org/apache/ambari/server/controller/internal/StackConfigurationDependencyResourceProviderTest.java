...
public class StackConfigurationDependencyResourceProviderTest {
    ...
    public void testGetResources() throws java.lang.Exception {
        ...
        org.easymock.EasyMock.expect(managementController.getStackConfigurationDependencies(org.apache.ambari.server.controller.internal.AbstractResourceProviderTest.Matcher.getStackConfigurationDependencyRequestSet(null, null, null, null, null))).andReturn(allResponse).times(1);
