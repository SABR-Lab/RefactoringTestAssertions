...
public class StackDefinedPropertyProviderTest {
    ...
    public void setup() throws java.lang.Exception {
        ...
        org.easymock.EasyMock.expect(amc.getAmbariEventPublisher()).andReturn(org.easymock.EasyMock.createNiceMock(org.apache.ambari.server.events.publishers.AmbariEventPublisher.class)).anyTimes();
        org.easymock.EasyMock.expect(amc.getClusters()).andReturn(clustersMock).anyTimes();
        org.easymock.EasyMock.expect(clustersMock.getCluster(org.apache.ambari.server.controller.internal.StackDefinedPropertyProviderTest.CLUSTER_NAME_PROPERTY_ID)).andReturn(clusterMock).anyTimes();
        org.easymock.EasyMock.expect(clusterMock.getResourceId()).andReturn(2L).anyTimes();
        try {
            org.easymock.EasyMock.expect(clustersMock.getCluster(org.easymock.EasyMock.anyObject(java.lang.String.class))).andReturn(clusterMock).anyTimes();
        } catch (org.apache.ambari.server.AmbariException e) {
            e.printStackTrace();
        }
        org.easymock.EasyMock.replay(amc, clustersMock, clusterMock);
    }
