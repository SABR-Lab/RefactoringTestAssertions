...
public class StackLevelConfigurationResourceProviderTest {
    ...
    public void testGetResources() throws java.lang.Exception {
        ...
        org.easymock.EasyMock.expect(managementController.getStackLevelConfigurations(org.apache.ambari.server.controller.internal.AbstractResourceProviderTest.Matcher.getStackLevelConfigurationRequestSet(null, null, null))).andReturn(allResponse).times(1);
