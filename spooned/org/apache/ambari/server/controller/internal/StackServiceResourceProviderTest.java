...
public class StackServiceResourceProviderTest {
    ...
    public void testGetServiceProperties() throws java.lang.Exception {
        ...
        org.apache.ambari.server.controller.StackServiceResponse stackServiceResponse = org.easymock.EasyMock.createNiceMock(org.apache.ambari.server.controller.StackServiceResponse.class);
        org.easymock.EasyMock.expect(stackServiceResponse.getServiceProperties()).andReturn(TEST_SERVICE_PROPERTIES);
        org.easymock.EasyMock.expect(managementController.getStackServices(org.easymock.EasyMock.anyObject())).andReturn(com.google.common.collect.ImmutableSet.of(stackServiceResponse));
        org.easymock.EasyMock.replay(managementController, stackServiceResponse);
        ...
        org.easymock.EasyMock.verify(managementController, stackServiceResponse);
    }
