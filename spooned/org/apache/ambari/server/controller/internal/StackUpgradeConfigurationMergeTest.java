...
public class StackUpgradeConfigurationMergeTest extends org.easymock.EasyMockSupport {
    ...
    public void before() throws java.lang.Exception {
        ...
        org.easymock.EasyMock.reset(m_injector.getInstance(org.apache.ambari.server.orm.dao.StageDAO.class));
    }
    ...
    public void testMergedConfigurationsDoNotAddExplicitelyRemovedProperties() throws java.lang.Exception {
        ...
        org.easymock.EasyMock.expect(zookeeperServiceConfig.getClusterConfigEntities()).andReturn(com.google.common.collect.Lists.newArrayList(fooConfigEntity, barConfigEntity));
        ...
        org.easymock.EasyMock.expect(context.getHostRoleCommandFactory()).andStubReturn(m_injector.getInstance(org.apache.ambari.server.actionmanager.HostRoleCommandFactory.class));
        org.easymock.EasyMock.expect(context.getRoleGraphFactory()).andStubReturn(m_injector.getInstance(org.apache.ambari.server.stageplanner.RoleGraphFactory.class));
        replayAll();
    ...
    public void testReadOnlyPropertyIsTakenFromTargetStack() throws java.lang.Exception {
        ...
        org.easymock.EasyMock.expect(m_metainfo.getServiceProperties(stack211.getStackName(), stack211.getStackVersion(), serviceName)).andReturn(com.google.common.collect.Sets.newHashSet(readOnlyProperty)).atLeastOnce();
        java.util.Map<java.lang.String, java.lang.String> existingFooType = new java.util.HashMap<>();
        org.apache.ambari.server.orm.entities.ClusterConfigEntity fooConfigEntity = createNiceMock(org.apache.ambari.server.orm.entities.ClusterConfigEntity.class);
        org.easymock.EasyMock.expect(fooConfigEntity.getType()).andReturn(fooSite);
        org.apache.ambari.server.state.Config fooConfig = createNiceMock(org.apache.ambari.server.state.Config.class);
        existingFooType.put(fooPropertyName, "my-foo-property-1");
        org.easymock.EasyMock.expect(fooConfig.getType()).andReturn(fooSite).atLeastOnce();
        org.easymock.EasyMock.expect(fooConfig.getProperties()).andReturn(existingFooType);
        java.util.Map<java.lang.String, org.apache.ambari.server.state.DesiredConfig> desiredConfigurations = new java.util.HashMap<>();
        desiredConfigurations.put(fooSite, null);
        org.apache.ambari.server.state.Service zookeeper = createNiceMock(org.apache.ambari.server.state.Service.class);
        org.easymock.EasyMock.expect(zookeeper.getName()).andReturn(serviceName).atLeastOnce();
        org.easymock.EasyMock.expect(zookeeper.getServiceComponents()).andReturn(new java.util.HashMap<java.lang.String, org.apache.ambari.server.state.ServiceComponent>()).once();
        zookeeper.setDesiredRepositoryVersion(repoVersion220);
        org.easymock.EasyMock.expectLastCall().once();
        org.apache.ambari.server.state.Cluster cluster = createNiceMock(org.apache.ambari.server.state.Cluster.class);
        org.easymock.EasyMock.expect(cluster.getCurrentStackVersion()).andReturn(stack211).atLeastOnce();
        org.easymock.EasyMock.expect(cluster.getDesiredStackVersion()).andReturn(stack220);
        org.easymock.EasyMock.expect(cluster.getDesiredConfigs()).andReturn(desiredConfigurations);
        org.easymock.EasyMock.expect(cluster.getDesiredConfigByType(fooSite)).andReturn(fooConfig);
        org.easymock.EasyMock.expect(cluster.getService(serviceName)).andReturn(zookeeper);
        org.apache.ambari.server.state.ConfigHelper configHelper = m_injector.getInstance(org.apache.ambari.server.state.ConfigHelper.class);
        org.easymock.EasyMock.expect(configHelper.getDefaultProperties(stack211, serviceName)).andReturn(stack211Configs).anyTimes();
        org.easymock.EasyMock.expect(configHelper.getDefaultProperties(stack220, serviceName)).andReturn(stack220Configs).anyTimes();
        org.easymock.Capture<java.util.Map<java.lang.String, java.util.Map<java.lang.String, java.lang.String>>> expectedConfigurationsCapture = org.easymock.EasyMock.newCapture();
        org.easymock.EasyMock.expect(configHelper.createConfigTypes(org.easymock.EasyMock.anyObject(org.apache.ambari.server.state.Cluster.class), org.easymock.EasyMock.anyObject(org.apache.ambari.server.state.StackId.class), org.easymock.EasyMock.anyObject(org.apache.ambari.server.controller.AmbariManagementController.class), org.easymock.EasyMock.capture(expectedConfigurationsCapture), org.easymock.EasyMock.anyObject(java.lang.String.class), org.easymock.EasyMock.anyObject(java.lang.String.class))).andReturn(true);
        org.apache.ambari.server.orm.entities.ServiceConfigEntity zookeeperServiceConfig = createNiceMock(org.apache.ambari.server.orm.entities.ServiceConfigEntity.class);
        org.easymock.EasyMock.expect(zookeeperServiceConfig.getClusterConfigEntities()).andReturn(com.google.common.collect.Lists.newArrayList(fooConfigEntity));
        org.apache.ambari.server.orm.dao.ServiceConfigDAO serviceConfigDAOMock = m_injector.getInstance(org.apache.ambari.server.orm.dao.ServiceConfigDAO.class);
        java.util.List<org.apache.ambari.server.orm.entities.ServiceConfigEntity> latestServiceConfigs = com.google.common.collect.Lists.newArrayList(zookeeperServiceConfig);
        org.easymock.EasyMock.expect(serviceConfigDAOMock.getLastServiceConfigsForService(org.easymock.EasyMock.anyLong(), org.easymock.EasyMock.eq(serviceName))).andReturn(latestServiceConfigs).once();
        org.apache.ambari.server.stack.upgrade.orchestrate.UpgradeContext context = createNiceMock(org.apache.ambari.server.stack.upgrade.orchestrate.UpgradeContext.class);
        org.easymock.EasyMock.expect(context.getCluster()).andReturn(cluster).atLeastOnce();
        org.easymock.EasyMock.expect(context.getType()).andReturn(org.apache.ambari.spi.upgrade.UpgradeType.ROLLING).atLeastOnce();
        org.easymock.EasyMock.expect(context.getDirection()).andReturn(org.apache.ambari.server.stack.upgrade.Direction.UPGRADE).atLeastOnce();
        org.easymock.EasyMock.expect(context.getRepositoryVersion()).andReturn(repoVersion220).anyTimes();
        org.easymock.EasyMock.expect(context.getSupportedServices()).andReturn(com.google.common.collect.Sets.newHashSet(serviceName)).atLeastOnce();
        org.easymock.EasyMock.expect(context.getSourceRepositoryVersion(org.easymock.EasyMock.anyString())).andReturn(repoVersion211).atLeastOnce();
        org.easymock.EasyMock.expect(context.getTargetRepositoryVersion(org.easymock.EasyMock.anyString())).andReturn(repoVersion220).atLeastOnce();
        org.easymock.EasyMock.expect(context.getOrchestrationType()).andReturn(org.apache.ambari.spi.RepositoryType.STANDARD).anyTimes();
        org.easymock.EasyMock.expect(context.getHostRoleCommandFactory()).andStubReturn(m_injector.getInstance(org.apache.ambari.server.actionmanager.HostRoleCommandFactory.class));
    ...
    private class MockModule implements com.google.inject.Module {
        ...
        public void configure(com.google.inject.Binder binder) {
            ...
            org.easymock.EasyMock.expect(stageDAO.getLastRequestId()).andReturn(1L).anyTimes();
