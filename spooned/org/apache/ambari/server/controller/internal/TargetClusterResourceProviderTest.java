...
public class TargetClusterResourceProviderTest {
    ...
    public void testCreateResources() throws java.lang.Exception {
        org.apache.ambari.server.controller.ivory.IvoryService service = org.easymock.EasyMock.createMock(org.apache.ambari.server.controller.ivory.IvoryService.class);
        ...
        org.easymock.EasyMock.verify(service);
    }
    ...
    public void testGetResources() throws java.lang.Exception {
        ...
        org.easymock.EasyMock.expect(service.getClusterNames()).andReturn(targetClusterNames);
        org.easymock.EasyMock.expect(service.getCluster("Cluster1")).andReturn(targetCluster1);
        org.easymock.EasyMock.expect(service.getCluster("Cluster2")).andReturn(targetCluster2);
        org.easymock.EasyMock.expect(service.getCluster("Cluster3")).andReturn(targetCluster3);
        org.easymock.EasyMock.replay(service);
        propertySet.add(properties);
        org.apache.ambari.server.controller.spi.Request request = org.apache.ambari.server.controller.utilities.PropertyHelper.getCreateRequest(propertySet, java.util.Collections.emptyMap());
        org.apache.ambari.server.controller.internal.TargetClusterResourceProvider provider = new org.apache.ambari.server.controller.internal.TargetClusterResourceProvider(service);
