        ...
        public java.util.Set<org.apache.ambari.server.controller.spi.Resource> fetchTaskAttemptDetails(java.util.Set<java.lang.String> requestedIds, java.lang.String clusterName, java.lang.String workflowId, java.lang.String jobId, java.lang.String taskAttemptId) {
            ...
            try {
                ...
                while (rs.next()) {
                    ...
                    org.apache.ambari.server.controller.internal.TaskAttemptResourceProvider.setResourceProperty(resource, org.apache.ambari.server.controller.internal.TaskAttemptResourceProvider.TASK_ATTEMPT_CLUSTER_NAME_PROPERTY_ID, clusterName, requestedIds);
                    org.apache.ambari.server.controller.internal.TaskAttemptResourceProvider.setResourceProperty(resource, org.apache.ambari.server.controller.internal.TaskAttemptResourceProvider.TASK_ATTEMPT_WORKFLOW_ID_PROPERTY_ID, workflowId, requestedIds);
