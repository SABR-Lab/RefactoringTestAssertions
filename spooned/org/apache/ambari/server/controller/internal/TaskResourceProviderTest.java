...
public class TaskResourceProviderTest {
    ...
    public void testGetResources() throws java.lang.Exception {
        ...
        org.apache.ambari.server.orm.dao.HostRoleCommandDAO hostRoleCommandDAO = org.easymock.EasyMock.createMock(org.apache.ambari.server.orm.dao.HostRoleCommandDAO.class);
        ...
        org.easymock.EasyMock.expect(hostRoleCommandDAO.findAll(org.easymock.EasyMock.anyObject(org.apache.ambari.server.controller.spi.Request.class), org.easymock.EasyMock.anyObject(org.apache.ambari.server.controller.spi.Predicate.class))).andReturn(entities).once();
        org.easymock.EasyMock.replay(hostRoleCommandDAO);
        ...
        org.easymock.EasyMock.verify(hostRoleCommandDAO);
    }
    ...
    public void testGetResourcesForTopology() throws java.lang.Exception {
        ...
        org.apache.ambari.server.controller.AmbariManagementController amc = org.easymock.EasyMock.createMock(org.apache.ambari.server.controller.AmbariManagementController.class);
        org.apache.ambari.server.orm.dao.HostRoleCommandDAO hostRoleCommandDAO = org.easymock.EasyMock.createMock(org.apache.ambari.server.orm.dao.HostRoleCommandDAO.class);
        org.apache.ambari.server.topology.TopologyManager topologyManager = org.easymock.EasyMock.createMock(org.apache.ambari.server.topology.TopologyManager.class);
        org.apache.ambari.server.orm.dao.HostDAO hostDAO = org.easymock.EasyMock.createMock(org.apache.ambari.server.orm.dao.HostDAO.class);
        org.apache.ambari.server.orm.dao.ExecutionCommandDAO executionCommandDAO = org.easymock.EasyMock.createMock(org.apache.ambari.server.orm.dao.ExecutionCommandDAO.class);
        org.apache.ambari.server.actionmanager.ExecutionCommandWrapperFactory ecwFactory = org.easymock.EasyMock.createMock(org.apache.ambari.server.actionmanager.ExecutionCommandWrapperFactory.class);
        com.google.inject.Injector m_injector = com.google.inject.Guice.createInjector(new org.apache.ambari.server.orm.InMemoryDefaultTestModule());
        org.apache.ambari.server.controller.internal.TaskResourceProvider provider = ((org.apache.ambari.server.controller.internal.TaskResourceProvider) (org.apache.ambari.server.controller.internal.AbstractControllerResourceProvider.getResourceProvider(type, amc)));
        m_injector.injectMembers(provider);
        org.apache.ambari.server.controller.internal.TaskResourceProvider.s_dao = hostRoleCommandDAO;
        ...
        org.easymock.EasyMock.expect(hostRoleCommandDAO.findAll(org.easymock.EasyMock.anyObject(org.apache.ambari.server.controller.spi.Request.class), org.easymock.EasyMock.anyObject(org.apache.ambari.server.controller.spi.Predicate.class))).andReturn(entities).once();
        org.easymock.EasyMock.expect(topologyManager.getTasks(org.easymock.EasyMock.anyLong())).andReturn(commands).once();
        org.easymock.EasyMock.replay(hostRoleCommandDAO, topologyManager);
        java.util.Set<java.lang.String> propertyIds = new java.util.HashSet<>();
        propertyIds.add(org.apache.ambari.server.controller.internal.TaskResourceProvider.TASK_ID_PROPERTY_ID);
        propertyIds.add(org.apache.ambari.server.controller.internal.TaskResourceProvider.TASK_REQUEST_ID_PROPERTY_ID);
        propertyIds.add(org.apache.ambari.server.controller.internal.TaskResourceProvider.TASK_COMMAND_DET_PROPERTY_ID);
        ...
        org.easymock.EasyMock.verify(hostRoleCommandDAO, topologyManager);
    }
