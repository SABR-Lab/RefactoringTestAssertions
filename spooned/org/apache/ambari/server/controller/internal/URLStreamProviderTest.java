...
public class URLStreamProviderTest {
    ...
    public void testProcessURL() throws java.lang.Exception {
        ...
        org.apache.ambari.server.controller.internal.AppCookieManager appCookieManager = org.easymock.EasyMock.createNiceMock(org.apache.ambari.server.controller.internal.AppCookieManager.class);
        ...
        org.easymock.EasyMock.expect(urlStreamProvider.getAppCookieManager()).andReturn(appCookieManager).anyTimes();
        org.easymock.EasyMock.expect(urlStreamProvider.getConnection(url)).andReturn(connection);
        ...
        org.easymock.EasyMock.expect(appCookieManager.getCachedAppCookie(fakeURL)).andReturn("APPCOOKIE=abcdef");
        ...
        org.easymock.EasyMock.replay(urlStreamProvider, connection, appCookieManager);
        org.junit.Assert.assertEquals(connection, urlStreamProvider.processURL(fakeURL, "GET", ((java.lang.String) (null)), headerMap));
        org.easymock.EasyMock.verify(urlStreamProvider, connection, appCookieManager);
    }
    ...
    public void testProcessURL_securityNotSetup() throws java.lang.Exception {
        ...
        headerMap.put("Header1", java.util.Collections.singletonList("value"));
        headerMap.put("Cookie", java.util.Collections.singletonList("FOO=bar"));
        org.easymock.EasyMock.replay(urlStreamProvider);
        try {
            urlStreamProvider.processURL("https://spec", "GET", ((java.lang.String) (null)), headerMap);
            org.junit.Assert.fail("Expected IllegalStateException");
        } catch (java.lang.IllegalStateException e) {
        }
        org.easymock.EasyMock.verify(urlStreamProvider);
    }
