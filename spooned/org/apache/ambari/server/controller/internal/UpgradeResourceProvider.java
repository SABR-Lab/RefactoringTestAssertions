...
public class UpgradeResourceProvider extends org.apache.ambari.server.controller.internal.AbstractControllerResourceProvider {
    ...
    static final class RepositoryVersions {
        @com.fasterxml.jackson.annotation.JsonProperty("from_repository_id")
        final long fromRepositoryId;

        @com.fasterxml.jackson.annotation.JsonProperty("from_repository_version")
        final java.lang.String fromRepositoryVersion;

        @com.fasterxml.jackson.annotation.JsonProperty("to_repository_id")
        final long toRepositoryId;

        @com.fasterxml.jackson.annotation.JsonProperty("to_repository_version")
