...
public class UpgradeResourceProviderTest extends org.easymock.EasyMockSupport {
    ...
    public void before() throws java.lang.Exception {
        ...
        org.easymock.EasyMock.expect(configHelper.getPlaceholderValueFromDesiredConfigurations(org.easymock.EasyMock.anyObject(org.apache.ambari.server.state.Cluster.class), org.easymock.EasyMock.eq("{{foo/bar}}"))).andReturn("placeholder-rendered-properly").anyTimes();
        org.easymock.EasyMock.expect(configHelper.getDefaultProperties(org.easymock.EasyMock.anyObject(org.apache.ambari.server.state.StackId.class), org.easymock.EasyMock.anyString())).andReturn(new java.util.HashMap<>()).anyTimes();
        org.easymock.EasyMock.expect(configHelper.getChangedConfigTypes(org.easymock.EasyMock.anyObject(org.apache.ambari.server.state.Cluster.class), org.easymock.EasyMock.anyObject(org.apache.ambari.server.orm.entities.ServiceConfigEntity.class), org.easymock.EasyMock.anyLong(), org.easymock.EasyMock.anyLong(), org.easymock.EasyMock.anyString())).andReturn(java.util.Collections.emptyMap()).anyTimes();
    ...
    public void testCreateRegenerateKeytabStages() throws java.lang.Exception {
        ...
        org.easymock.EasyMock.expect(requestStageContainer.getStages()).andReturn(com.google.common.collect.Lists.newArrayList()).once();
        org.easymock.EasyMock.expect(kerberosHelperMock.executeCustomOperations(org.easymock.EasyMock.eq(cluster), org.easymock.EasyMock.capture(requestPropertyMapCapture), org.easymock.EasyMock.anyObject(org.apache.ambari.server.controller.internal.RequestStageContainer.class), org.easymock.EasyMock.eq(null))).andReturn(requestStageContainer).once();
        replayAll();
        org.apache.ambari.server.controller.spi.ResourceProvider upgradeResourceProvider = createProvider(amc);
        org.apache.ambari.server.controller.spi.Request request = org.apache.ambari.server.controller.utilities.PropertyHelper.getCreateRequest(java.util.Collections.singleton(requestProps), null);
        try {
