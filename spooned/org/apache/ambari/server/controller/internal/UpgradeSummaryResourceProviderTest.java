...
public class UpgradeSummaryResourceProviderTest {
    ...
    public void before() throws java.lang.Exception {
        m_upgradeHelper = org.easymock.EasyMock.createNiceMock(org.apache.ambari.server.stack.upgrade.orchestrate.UpgradeHelper.class);
    ...
    public void testGetUpgradeSummary() throws java.lang.Exception {
        ...
        org.easymock.EasyMock.expect(m_upgradeHelper.getTaskResource(org.easymock.EasyMock.anyString(), org.easymock.EasyMock.anyLong(), org.easymock.EasyMock.anyLong(), org.easymock.EasyMock.anyLong())).andReturn(failedTask).anyTimes();
        org.easymock.EasyMock.replay(m_upgradeHelper);
        resources = upgradeSummaryResourceProvider.getResources(requestResource, p1And2);
        org.junit.Assert.assertEquals(1, resources.size());
        r = resources.iterator().next();
