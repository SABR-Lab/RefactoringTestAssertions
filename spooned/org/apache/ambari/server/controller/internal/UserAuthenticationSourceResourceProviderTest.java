...
public class UserAuthenticationSourceResourceProviderTest extends org.easymock.EasyMockSupport {
    ...
    private void createResourcesTest(org.springframework.security.core.Authentication authentication) throws java.lang.Exception {
        ...
        org.easymock.EasyMock.expect(users.getUserEntity("User100")).andReturn(userEntity100).once();
        org.easymock.EasyMock.expect(users.getUserEntity("User200")).andReturn(userEntity200).once();
    ...
    private void getResourcesTest(org.springframework.security.core.Authentication authentication) throws java.lang.Exception {
        ...
        if ("admin".equals(authentication.getName())) {
            ...
            org.easymock.EasyMock.expect(users.getUserAuthenticationEntities(((java.lang.String) (null)), null)).andReturn(entities.values()).once();
        } else {
            org.easymock.EasyMock.expect(users.getUserAuthenticationEntities("user1", null)).andReturn(entities.values()).once();
        }
        replayAll();
        org.apache.ambari.server.api.services.AmbariMetaInfo ambariMetaInfo = injector.getInstance(org.apache.ambari.server.api.services.AmbariMetaInfo.class);
        ambariMetaInfo.init();
    ...
    private void getResourceTest(org.springframework.security.core.Authentication authentication, java.lang.String requestedUsername) throws java.lang.Exception {
        ...
        org.apache.ambari.server.security.authorization.Users users = injector.getInstance(org.apache.ambari.server.security.authorization.Users.class);
        org.easymock.EasyMock.expect(users.getUserAuthenticationEntities(requestedUsername, null)).andReturn(entities).once();
        replayAll();
        org.apache.ambari.server.api.services.AmbariMetaInfo ambariMetaInfo = injector.getInstance(org.apache.ambari.server.api.services.AmbariMetaInfo.class);
        ambariMetaInfo.init();
        org.springframework.security.core.context.SecurityContextHolder.getContext().setAuthentication(authentication);
    ...
    private void updateResources_SetAuthenticationKey(org.springframework.security.core.Authentication authentication, java.lang.String requestedUsername, java.lang.String authenticationType) throws java.lang.Exception {
        ...
        org.easymock.EasyMock.expect(userEntity.getAuthenticationEntities()).andReturn(userAuthenticationEntities).once();
        if (isSelf) {
            org.easymock.EasyMock.expect(userEntity.getUserId()).andReturn(((org.apache.ambari.server.security.authentication.AmbariUserDetails) (authentication.getPrincipal())).getUserId()).once();
        } else {
            org.easymock.EasyMock.expect(userEntity.getUserId()).andReturn(org.apache.ambari.server.security.authorization.AuthorizationHelper.getAuthenticatedId() + 100).once();
        }
        org.apache.ambari.server.security.authorization.Users users = injector.getInstance(org.apache.ambari.server.security.authorization.Users.class);
        org.easymock.EasyMock.expect(users.getUserEntity(requestedUsername)).andReturn(userEntity).once();
    ...
    private org.apache.ambari.server.orm.entities.UserAuthenticationEntity createMockUserAuthenticationEntity(java.lang.String username) {
        ...
        org.apache.ambari.server.orm.entities.UserEntity userEntity = createMock(org.apache.ambari.server.orm.entities.UserEntity.class);
        org.easymock.EasyMock.expect(entity.getAuthenticationType()).andReturn(org.apache.ambari.server.security.authorization.UserAuthenticationType.LOCAL).anyTimes();
        org.easymock.EasyMock.expect(entity.getAuthenticationKey()).andReturn("this is a secret").anyTimes();
        org.easymock.EasyMock.expect(entity.getCreateTime()).andReturn(org.apache.ambari.server.controller.internal.UserAuthenticationSourceResourceProviderTest.CREATE_TIME).anyTimes();
        org.easymock.EasyMock.expect(entity.getUpdateTime()).andReturn(org.apache.ambari.server.controller.internal.UserAuthenticationSourceResourceProviderTest.UPDATE_TIME).anyTimes();
        org.easymock.EasyMock.expect(entity.getUserAuthenticationId()).andReturn(100L).anyTimes();
        org.easymock.EasyMock.expect(entity.getUser()).andReturn(userEntity).anyTimes();
