...
public class UserAuthorizationResourceProviderTest extends org.easymock.EasyMockSupport {
    ...
    public void testCreateResources() throws java.lang.Exception {
        ...
        provider.createResources(((org.apache.ambari.server.controller.spi.Request) (createNiceMock(org.apache.ambari.server.controller.spi.Request.class))));
        verifyAll();
    }
    ...
    private void getResourcesTest(org.springframework.security.core.Authentication authentication, java.lang.String requestedUsername) throws java.lang.Exception {
        ...
        org.easymock.EasyMock.expect(clusterResource.getPropertyValue(org.apache.ambari.server.controller.internal.UserPrivilegeResourceProvider.PERMISSION_NAME)).andReturn("CLUSTER.DO_SOMETHING").anyTimes();
        org.easymock.EasyMock.expect(clusterResource.getPropertyValue(org.apache.ambari.server.controller.internal.UserPrivilegeResourceProvider.TYPE)).andReturn("CLUSTER").anyTimes();
        org.easymock.EasyMock.expect(clusterResource.getPropertyValue(org.apache.ambari.server.controller.internal.UserPrivilegeResourceProvider.CLUSTER_NAME)).andReturn("Cluster Name").anyTimes();
        ...
        org.easymock.EasyMock.expect(viewResource.getPropertyValue(org.apache.ambari.server.controller.internal.UserPrivilegeResourceProvider.PERMISSION_NAME)).andReturn("VIEW.DO_SOMETHING").anyTimes();
        org.easymock.EasyMock.expect(viewResource.getPropertyValue(org.apache.ambari.server.controller.internal.UserPrivilegeResourceProvider.TYPE)).andReturn("VIEW").anyTimes();
        org.easymock.EasyMock.expect(viewResource.getPropertyValue(org.apache.ambari.server.controller.internal.UserPrivilegeResourceProvider.VIEW_NAME)).andReturn("View Name").anyTimes();
        org.easymock.EasyMock.expect(viewResource.getPropertyValue(org.apache.ambari.server.controller.internal.UserPrivilegeResourceProvider.VIEW_VERSION)).andReturn("View Version").anyTimes();
        org.easymock.EasyMock.expect(viewResource.getPropertyValue(org.apache.ambari.server.controller.internal.UserPrivilegeResourceProvider.INSTANCE_NAME)).andReturn("View Instance Name").anyTimes();
        ...
        org.easymock.EasyMock.expect(adminResource.getPropertyValue(org.apache.ambari.server.controller.internal.UserPrivilegeResourceProvider.PERMISSION_NAME)).andReturn("ADMIN.DO_SOMETHING").anyTimes();
        org.easymock.EasyMock.expect(adminResource.getPropertyValue(org.apache.ambari.server.controller.internal.UserPrivilegeResourceProvider.TYPE)).andReturn("ADMIN").anyTimes();
        org.easymock.EasyMock.expect(adminResource.getPropertyValue(org.apache.ambari.server.controller.internal.UserPrivilegeResourceProvider.CLUSTER_NAME)).andReturn(null).anyTimes();
        ...
        org.easymock.EasyMock.expect(emptyResource.getPropertyValue(org.apache.ambari.server.controller.internal.UserPrivilegeResourceProvider.PERMISSION_NAME)).andReturn("EMPTY.DO_SOMETHING").anyTimes();
        org.easymock.EasyMock.expect(emptyResource.getPropertyValue(org.apache.ambari.server.controller.internal.UserPrivilegeResourceProvider.TYPE)).andReturn("ADMIN").anyTimes();
        org.easymock.EasyMock.expect(emptyResource.getPropertyValue(org.apache.ambari.server.controller.internal.UserPrivilegeResourceProvider.CLUSTER_NAME)).andReturn(null).anyTimes();
        ...
        org.easymock.EasyMock.expect(nullResource.getPropertyValue(org.apache.ambari.server.controller.internal.UserPrivilegeResourceProvider.PERMISSION_NAME)).andReturn("NULL.DO_SOMETHING").anyTimes();
        org.easymock.EasyMock.expect(nullResource.getPropertyValue(org.apache.ambari.server.controller.internal.UserPrivilegeResourceProvider.TYPE)).andReturn("ADMIN").anyTimes();
        org.easymock.EasyMock.expect(nullResource.getPropertyValue(org.apache.ambari.server.controller.internal.UserPrivilegeResourceProvider.CLUSTER_NAME)).andReturn(null).anyTimes();
        ...
        org.easymock.EasyMock.expect(userPrivilegeProvider.getResources(org.easymock.EasyMock.anyObject(org.apache.ambari.server.controller.spi.Request.class), org.easymock.EasyMock.anyObject(org.apache.ambari.server.controller.spi.Predicate.class))).andReturn(userPrivilegeResources);
        ...
        org.easymock.EasyMock.expect(clusterController.ensureResourceProvider(org.apache.ambari.server.controller.spi.Resource.Type.UserPrivilege)).andReturn(userPrivilegeProvider).anyTimes();
        ...
        org.easymock.EasyMock.expect(clusterResourceTypeEntity.getId()).andReturn(1).anyTimes();
        ...
        org.easymock.EasyMock.expect(viewResourceTypeEntity.getId()).andReturn(2).anyTimes();
        ...
        org.easymock.EasyMock.expect(adminResourceTypeEntity.getId()).andReturn(3).anyTimes();
        ...
        org.easymock.EasyMock.expect(resourceTypeDAO.findByName("CLUSTER")).andReturn(clusterResourceTypeEntity).anyTimes();
        org.easymock.EasyMock.expect(resourceTypeDAO.findByName("VIEW")).andReturn(viewResourceTypeEntity).anyTimes();
        org.easymock.EasyMock.expect(resourceTypeDAO.findByName("ADMIN")).andReturn(adminResourceTypeEntity).anyTimes();
        ...
        org.easymock.EasyMock.expect(clusterRoleAuthorizationEntity.getAuthorizationId()).andReturn("CLUSTER.DO_SOMETHING").anyTimes();
        org.easymock.EasyMock.expect(clusterRoleAuthorizationEntity.getAuthorizationName()).andReturn("CLUSTER DO_SOMETHING").anyTimes();
        ...
        org.easymock.EasyMock.expect(viewRoleAuthorizationEntity.getAuthorizationId()).andReturn("VIEW.DO_SOMETHING").anyTimes();
        org.easymock.EasyMock.expect(viewRoleAuthorizationEntity.getAuthorizationName()).andReturn("VIEW DO_SOMETHING").anyTimes();
        ...
        org.easymock.EasyMock.expect(adminRoleAuthorizationEntity.getAuthorizationId()).andReturn("ADMIN.DO_SOMETHING").anyTimes();
        org.easymock.EasyMock.expect(adminRoleAuthorizationEntity.getAuthorizationName()).andReturn("ADMIN DO_SOMETHING").anyTimes();
        ...
        org.easymock.EasyMock.expect(clusterPermissionEntity.getAuthorizations()).andReturn(clusterPermissionAuthorizations).anyTimes();
        ...
        org.easymock.EasyMock.expect(viewPermissionEntity.getAuthorizations()).andReturn(viewPermissionAuthorizations).anyTimes();
        ...
        org.easymock.EasyMock.expect(adminPermissionEntity.getAuthorizations()).andReturn(adminPermissionAuthorizations).anyTimes();
        ...
        org.easymock.EasyMock.expect(emptyPermissionEntity.getAuthorizations()).andReturn(java.util.Collections.emptyList()).anyTimes();
        ...
        org.easymock.EasyMock.expect(nullPermissionEntity.getAuthorizations()).andReturn(null).anyTimes();
        ...
        org.easymock.EasyMock.expect(permissionDAO.findPermissionByNameAndType("CLUSTER.DO_SOMETHING", clusterResourceTypeEntity)).andReturn(clusterPermissionEntity).anyTimes();
        org.easymock.EasyMock.expect(permissionDAO.findPermissionByNameAndType("VIEW.DO_SOMETHING", viewResourceTypeEntity)).andReturn(viewPermissionEntity).anyTimes();
        org.easymock.EasyMock.expect(permissionDAO.findPermissionByNameAndType("ADMIN.DO_SOMETHING", adminResourceTypeEntity)).andReturn(adminPermissionEntity).anyTimes();
        org.easymock.EasyMock.expect(permissionDAO.findPermissionByNameAndType("EMPTY.DO_SOMETHING", adminResourceTypeEntity)).andReturn(emptyPermissionEntity).anyTimes();
        org.easymock.EasyMock.expect(permissionDAO.findPermissionByNameAndType("NULL.DO_SOMETHING", adminResourceTypeEntity)).andReturn(nullPermissionEntity).anyTimes();
        replayAll();
