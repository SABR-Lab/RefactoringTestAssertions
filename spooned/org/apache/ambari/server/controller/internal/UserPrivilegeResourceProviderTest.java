...
public class UserPrivilegeResourceProviderTest extends org.easymock.EasyMockSupport {
    ...
    public void testCreateResources() throws java.lang.Exception {
        ...
        resourceProvider.createResources(((org.apache.ambari.server.controller.spi.Request) (createNiceMock(org.apache.ambari.server.controller.spi.Request.class))));
    }
    ...
    public void testToResource_AMBARI() {
        ...
        org.easymock.EasyMock.expect(userEntity.getUserName()).andReturn("jdoe").atLeastOnce();
        org.apache.ambari.server.orm.dao.UserDAO userDAO = createMock(org.apache.ambari.server.orm.dao.UserDAO.class);
        org.easymock.EasyMock.expect(userDAO.findUserByPrincipal(org.easymock.EasyMock.anyObject(org.apache.ambari.server.orm.entities.PrincipalEntity.class))).andReturn(userEntity).anyTimes();
    ...
    public void testToResource_CLUSTER() {
        ...
        org.easymock.EasyMock.expect(userEntity.getUserName()).andReturn("jdoe").atLeastOnce();
        org.apache.ambari.server.orm.dao.ClusterDAO clusterDAO = createMock(org.apache.ambari.server.orm.dao.ClusterDAO.class);
        org.easymock.EasyMock.expect(clusterDAO.findByResourceId(1L)).andReturn(clusterEntity).atLeastOnce();
        org.apache.ambari.server.orm.dao.GroupDAO groupDAO = createMock(org.apache.ambari.server.orm.dao.GroupDAO.class);
        org.apache.ambari.server.orm.dao.ViewInstanceDAO viewInstanceDAO = createMock(org.apache.ambari.server.orm.dao.ViewInstanceDAO.class);
        org.apache.ambari.server.orm.dao.UserDAO userDAO = createMock(org.apache.ambari.server.orm.dao.UserDAO.class);
        org.easymock.EasyMock.expect(userDAO.findUserByPrincipal(org.easymock.EasyMock.anyObject(org.apache.ambari.server.orm.entities.PrincipalEntity.class))).andReturn(userEntity).anyTimes();
    ...
    public void testToResource_VIEW() {
        ...
        org.apache.ambari.server.orm.dao.GroupDAO groupDAO = createMock(org.apache.ambari.server.orm.dao.GroupDAO.class);
        org.apache.ambari.server.orm.dao.ViewInstanceDAO viewInstanceDAO = createMock(org.apache.ambari.server.orm.dao.ViewInstanceDAO.class);
        org.easymock.EasyMock.expect(viewInstanceDAO.findByResourceId(1L)).andReturn(viewInstanceEntity).atLeastOnce();
        org.apache.ambari.server.orm.dao.UserDAO userDAO = createMock(org.apache.ambari.server.orm.dao.UserDAO.class);
        org.easymock.EasyMock.expect(userDAO.findUserByPrincipal(org.easymock.EasyMock.anyObject(org.apache.ambari.server.orm.entities.PrincipalEntity.class))).andReturn(userEntity).anyTimes();
        org.apache.ambari.server.security.authorization.Users users = createNiceMock(org.apache.ambari.server.security.authorization.Users.class);
        replayAll();
    ...
    public void testToResource_SpecificVIEW_WithClusterInheritedPermission() throws java.lang.Exception {
        ...
        org.easymock.EasyMock.expect(rolePrincipalTypeEntity.getName()).andReturn("ROLE").atLeastOnce();
        ...
        org.easymock.EasyMock.expect(rolePrincipalEntity.getPrincipalType()).andReturn(rolePrincipalTypeEntity).atLeastOnce();
        ...
        org.easymock.EasyMock.expect(permissionEntity.getPrincipal()).andReturn(rolePrincipalEntity).atLeastOnce();
        org.easymock.EasyMock.expect(permissionEntity.getPermissionName()).andReturn("CLUSTER.ADMINISTRATOR").atLeastOnce();
        org.easymock.EasyMock.expect(permissionEntity.getPermissionLabel()).andReturn("Cluster Administrator").atLeastOnce();
        ...
        org.easymock.EasyMock.expect(resourceEntity.getId()).andReturn(1L).anyTimes();
        ...
        org.easymock.EasyMock.expect(explicitPrivilegeEntity.getId()).andReturn(1).atLeastOnce();
        org.easymock.EasyMock.expect(explicitPrivilegeEntity.getPermission()).andReturn(permissionEntity).atLeastOnce();
        org.easymock.EasyMock.expect(explicitPrivilegeEntity.getPrincipal()).andReturn(principalEntity).atLeastOnce();
        org.easymock.EasyMock.expect(explicitPrivilegeEntity.getResource()).andReturn(resourceEntity).atLeastOnce();
        ...
        org.easymock.EasyMock.expect(implicitPrivilegeEntity.getId()).andReturn(2).atLeastOnce();
        org.easymock.EasyMock.expect(implicitPrivilegeEntity.getPermission()).andReturn(permissionEntity).atLeastOnce();
        org.easymock.EasyMock.expect(implicitPrivilegeEntity.getPrincipal()).andReturn(rolePrincipalEntity).atLeastOnce();
        org.easymock.EasyMock.expect(implicitPrivilegeEntity.getResource()).andReturn(resourceEntity).atLeastOnce();
        org.apache.ambari.server.orm.entities.UserEntity userEntity = createMock(org.apache.ambari.server.orm.entities.UserEntity.class);
        org.easymock.EasyMock.expect(userEntity.getUserName()).andReturn("jdoe").atLeastOnce();
        org.easymock.EasyMock.expect(userEntity.getPrincipal()).andReturn(principalEntity).atLeastOnce();
        org.easymock.EasyMock.expect(viewInstanceDAO.findByResourceId(1L)).andReturn(viewInstanceEntity).atLeastOnce();
        org.easymock.EasyMock.expect(userDAO.findUserByName("jdoe")).andReturn(userEntity).anyTimes();
        org.easymock.EasyMock.expect(userDAO.findUserByPrincipal(org.easymock.EasyMock.anyObject(org.apache.ambari.server.orm.entities.PrincipalEntity.class))).andReturn(userEntity).anyTimes();
        org.easymock.EasyMock.expect(userDAO.findAll()).andReturn(java.util.Collections.emptyList()).anyTimes();
        ...
        org.easymock.EasyMock.expect(privilegeDAO.findAllByPrincipal(userPrincipals)).andReturn(java.util.Collections.singletonList(explicitPrivilegeEntity)).once();
        org.easymock.EasyMock.expect(privilegeDAO.findAllByPrincipal(rolePrincipals)).andReturn(java.util.Collections.singletonList(implicitPrivilegeEntity)).once();
        org.easymock.EasyMock.expect(memberDAO.findAllMembersByUser(userEntity)).andReturn(java.util.Collections.emptyList()).atLeastOnce();
        replayAll();
    ...
    private void getResourcesTest(org.springframework.security.core.Authentication authentication, java.lang.String requestedUsername) throws java.lang.Exception {
        ...
        java.util.List<org.apache.ambari.server.orm.entities.PrincipalEntity> userPrincipals = new java.util.LinkedList<>();
        userPrincipals.add(principalEntity);
        org.easymock.EasyMock.expect(privilegeDAO.findAllByPrincipal(userPrincipals)).andReturn(java.util.Collections.singletonList(privilegeEntity)).atLeastOnce();
        org.easymock.EasyMock.expect(memberDAO.findAllMembersByUser(userEntity)).andReturn(java.util.Collections.emptyList()).atLeastOnce();
        org.easymock.EasyMock.expect(userDAO.findAll()).andReturn(java.util.Collections.emptyList()).anyTimes();
        org.easymock.EasyMock.expect(userDAO.findUserByName(requestedUsername)).andReturn(userEntity).anyTimes();
        org.easymock.EasyMock.expect(userEntity.getPrincipal()).andReturn(principalEntity).anyTimes();
        org.easymock.EasyMock.expect(userEntity.getMemberEntities()).andReturn(java.util.Collections.emptySet()).anyTimes();
        ...
        org.easymock.EasyMock.expect(principalTypeEntity.getName()).andReturn(org.apache.ambari.server.orm.entities.PrincipalTypeEntity.USER_PRINCIPAL_TYPE_NAME).anyTimes();
        org.easymock.EasyMock.expect(principalEntity.getPrivileges()).andReturn(new java.util.HashSet<org.apache.ambari.server.orm.entities.PrivilegeEntity>() {
            {
                add(privilegeEntity);
            }
        }).anyTimes();
        ...
        org.easymock.EasyMock.expect(resourceEntity.getResourceType()).andReturn(resourceTypeEntity).anyTimes();
        org.easymock.EasyMock.expect(resourceTypeEntity.getName()).andReturn(org.apache.ambari.server.security.authorization.ResourceType.AMBARI.name());
        org.easymock.EasyMock.expect(viewInstanceDAO.findAll()).andReturn(new java.util.ArrayList<>()).anyTimes();
        replayAll();
        org.apache.ambari.server.controller.internal.UserPrivilegeResourceProvider.init(userDAO, clusterDAO, groupDAO, viewInstanceDAO, users);
        final java.util.Set<java.lang.String> propertyIds = new java.util.HashSet<>();
        propertyIds.add(org.apache.ambari.server.controller.internal.UserPrivilegeResourceProvider.USER_NAME);
