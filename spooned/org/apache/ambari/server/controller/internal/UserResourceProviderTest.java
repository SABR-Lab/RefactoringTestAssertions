...
public class UserResourceProviderTest extends org.easymock.EasyMockSupport {
    ...
    private void createResourcesTest(org.springframework.security.core.Authentication authentication, java.util.Set<java.util.Map<java.lang.String, java.lang.Object>> resourceProperties) throws java.lang.Exception {
        ...
        org.easymock.Capture<? extends org.apache.ambari.server.orm.entities.UserEntity> userEntityCapture = org.easymock.EasyMock.newCapture(org.easymock.CaptureType.ALL);
        ...
        for (java.util.Map<java.lang.String, java.lang.Object> properties : resourceProperties) {
            ...
            if (!org.apache.commons.lang.StringUtils.isEmpty(username)) {
                ...
                org.easymock.EasyMock.expect(userDAO.findUserByName(username)).andReturn(null).times(2);
                userDAO.create(org.easymock.EasyMock.capture(userEntityCapture));
                ...
                org.easymock.EasyMock.expect(principalTypeDAO.findById(org.apache.ambari.server.orm.entities.PrincipalTypeEntity.USER_PRINCIPAL_TYPE)).andReturn(principalTypeEntity).once();
                ...
                principalDAO.create(org.easymock.EasyMock.anyObject(org.apache.ambari.server.orm.entities.PrincipalEntity.class));
                ...
                org.easymock.EasyMock.expect(hookContextFactory.createUserHookContext(username)).andReturn(null).once();
                ...
                org.easymock.EasyMock.expect(hookService.execute(org.easymock.EasyMock.anyObject(org.apache.ambari.server.hooks.HookContext.class))).andReturn(true).once();
                if (properties.get(org.apache.ambari.server.controller.internal.UserResourceProvider.USER_PASSWORD_PROPERTY_ID) != null) {
                    ...
                    org.easymock.EasyMock.expect(resourceProvider.createResources(org.easymock.EasyMock.anyObject(org.apache.ambari.server.controller.spi.Request.class))).andReturn(status).once();
                    org.easymock.EasyMock.expect(factory.getUserAuthenticationSourceResourceProvider()).andReturn(resourceProvider).once();
                ...
                if (properties.get(org.apache.ambari.server.controller.internal.UserResourceProvider.USER_ADMIN_PROPERTY_ID) != null) {
                    ...
                    if (isAdmin) {
                        ...
                        org.easymock.EasyMock.expect(permissionDAO.findAmbariAdminPermission()).andReturn(permissionEntity).once();
                        ...
                        org.easymock.EasyMock.expect(resourceDAO.findAmbariResource()).andReturn(resourceEntity).once();
                        ...
                        org.easymock.EasyMock.expect(principalDAO.merge(org.easymock.EasyMock.anyObject(org.apache.ambari.server.orm.entities.PrincipalEntity.class))).andReturn(null).once();
                        org.easymock.EasyMock.expect(userDAO.merge(org.easymock.EasyMock.anyObject(org.apache.ambari.server.orm.entities.UserEntity.class))).andReturn(null).once();
                    }
                }
    ...
    private void getResourcesTest(org.springframework.security.core.Authentication authentication, java.lang.String requestedUsername) throws java.lang.Exception {
        ...
        org.easymock.EasyMock.expect(userPrincipalEntity.getPrivileges()).andReturn(null).anyTimes();
        if (username == null) {
            org.apache.ambari.server.orm.entities.UserEntity userEntity1 = createMockUserEntity("User1");
            org.easymock.EasyMock.expect(userEntity1.getPrincipal()).andReturn(userPrincipalEntity).once();
            org.apache.ambari.server.orm.entities.UserEntity userEntity10 = createMockUserEntity("User10");
            org.easymock.EasyMock.expect(userEntity10.getPrincipal()).andReturn(userPrincipalEntity).once();
            org.apache.ambari.server.orm.entities.UserEntity userEntity100 = createMockUserEntity("User100");
            org.easymock.EasyMock.expect(userEntity100.getPrincipal()).andReturn(userPrincipalEntity).once();
            org.apache.ambari.server.orm.entities.UserEntity userEntityAdmin = createMockUserEntity("admin");
            org.easymock.EasyMock.expect(userEntityAdmin.getPrincipal()).andReturn(userPrincipalEntity).once();
            ...
            org.easymock.EasyMock.expect(userDAO.findAll()).andReturn(allUsers).once();
        } else {
            org.apache.ambari.server.orm.entities.UserEntity userEntity = createMockUserEntity(username);
            org.easymock.EasyMock.expect(userEntity.getPrincipal()).andReturn(userPrincipalEntity).once();
            org.easymock.EasyMock.expect(userDAO.findUserByName(username)).andReturn(userEntity).once();
        }
        replayAll();
        org.apache.ambari.server.api.services.AmbariMetaInfo ambariMetaInfo = injector.getInstance(org.apache.ambari.server.api.services.AmbariMetaInfo.class);
        ambariMetaInfo.init();
    ...
    private void updateResourcesTest(org.springframework.security.core.Authentication authentication, java.lang.String requestedUsername, java.util.Map<java.lang.String, java.lang.Object> updates, boolean passwordAlreadyExists) throws java.lang.Exception {
        com.google.inject.Injector injector = createInjector();
        org.easymock.Capture<org.apache.ambari.server.controller.spi.Request> requestCapture = org.easymock.EasyMock.newCapture(org.easymock.CaptureType.FIRST);
        org.easymock.Capture<org.apache.ambari.server.controller.spi.Predicate> predicateCapture = org.easymock.EasyMock.newCapture(org.easymock.CaptureType.FIRST);
        ...
        org.easymock.EasyMock.expect(userEntity.getUserName()).andReturn(requestedUsername).anyTimes();
        org.easymock.EasyMock.expect(userEntity.getActive()).andReturn(true).anyTimes();
        org.easymock.EasyMock.expect(userEntity.getDisplayName()).andReturn(requestedUsername).anyTimes();
        org.easymock.EasyMock.expect(userEntity.getLocalUsername()).andReturn(requestedUsername).anyTimes();
        ...
        org.apache.ambari.server.orm.dao.UserDAO userDAO = injector.getInstance(org.apache.ambari.server.orm.dao.UserDAO.class);
        org.easymock.EasyMock.expect(userDAO.findUserByName(requestedUsername)).andReturn(userEntity).once();
        if (hasUpdates) {
            org.easymock.EasyMock.expect(userDAO.merge(userEntity)).andReturn(userEntity).once();
        }
        if (updates.get(org.apache.ambari.server.controller.internal.UserResourceProvider.USER_ADMIN_PROPERTY_ID) != null) {
            ...
            if (isAdmin) {
                ...
                org.easymock.EasyMock.expect(principalEntity.getPrivileges()).andReturn(new java.util.HashSet<org.apache.ambari.server.orm.entities.PrivilegeEntity>()).anyTimes();
        ...
        if (updates.containsKey(org.apache.ambari.server.controller.internal.UserResourceProvider.USER_PASSWORD_PROPERTY_ID)) {
            if (passwordAlreadyExists) {
                ...
                org.easymock.EasyMock.expect(authenticationEntity.getUserAuthenticationId()).andReturn(100L).anyTimes();
                org.easymock.EasyMock.expect(authenticationEntity.getAuthenticationType()).andReturn(org.apache.ambari.server.security.authorization.UserAuthenticationType.LOCAL).anyTimes();
                org.easymock.EasyMock.expect(userEntity.getAuthenticationEntities()).andReturn(java.util.Collections.singletonList(authenticationEntity)).once();
            } else {
                org.easymock.EasyMock.expect(userEntity.getAuthenticationEntities()).andReturn(java.util.Collections.<org.apache.ambari.server.orm.entities.UserAuthenticationEntity>emptyList()).once();
            }
            org.apache.ambari.server.controller.spi.RequestStatus status = createMock(org.apache.ambari.server.controller.spi.RequestStatus.class);
            org.apache.ambari.server.controller.spi.ResourceProvider resourceProvider = createMock(org.apache.ambari.server.controller.spi.ResourceProvider.class);
            if (passwordAlreadyExists) {
                org.easymock.EasyMock.expect(resourceProvider.updateResources(org.easymock.EasyMock.capture(requestCapture), org.easymock.EasyMock.capture(predicateCapture))).andReturn(status).once();
            } else {
                org.easymock.EasyMock.expect(resourceProvider.createResources(org.easymock.EasyMock.capture(requestCapture))).andReturn(status).once();
            }
            org.easymock.EasyMock.expect(factory.getUserAuthenticationSourceResourceProvider()).andReturn(resourceProvider).once();
        }
    ...
    private void deleteResourcesTest(org.springframework.security.core.Authentication authentication, java.lang.String requestedUsername) throws java.lang.Exception {
        ...
        org.apache.ambari.server.orm.dao.UserDAO userDAO = injector.getInstance(org.apache.ambari.server.orm.dao.UserDAO.class);
        org.easymock.EasyMock.expect(userDAO.findUserByName(requestedUsername)).andReturn(userEntity).once();
        org.easymock.EasyMock.expect(userDAO.findUsersByPrincipal(adminPrincipals)).andReturn(adminUserEntities).once();
        userDAO.remove(userEntity);
        org.easymock.EasyMock.expectLastCall().atLeastOnce();
        org.apache.ambari.server.orm.dao.PrincipalDAO principalDAO = injector.getInstance(org.apache.ambari.server.orm.dao.PrincipalDAO.class);
        org.easymock.EasyMock.expect(principalDAO.findByPermissionId(org.apache.ambari.server.orm.entities.PermissionEntity.AMBARI_ADMINISTRATOR_PERMISSION)).andReturn(adminPrincipals).once();
        replayAll();
        org.apache.ambari.server.api.services.AmbariMetaInfo ambariMetaInfo = injector.getInstance(org.apache.ambari.server.api.services.AmbariMetaInfo.class);
        ambariMetaInfo.init();
        org.springframework.security.core.context.SecurityContextHolder.getContext().setAuthentication(authentication);
    ...
    private org.apache.ambari.server.orm.entities.UserEntity createMockUserEntity(java.lang.String username) {
        org.apache.ambari.server.orm.entities.UserEntity userEntity = createMock(org.apache.ambari.server.orm.entities.UserEntity.class);
        org.easymock.EasyMock.expect(userEntity.getUserId()).andReturn(username.hashCode()).anyTimes();
        org.easymock.EasyMock.expect(userEntity.getUserName()).andReturn(username).anyTimes();
        org.easymock.EasyMock.expect(userEntity.getLocalUsername()).andReturn(username).anyTimes();
        org.easymock.EasyMock.expect(userEntity.getDisplayName()).andReturn(username).anyTimes();
        org.easymock.EasyMock.expect(userEntity.getActive()).andReturn(true).anyTimes();
        org.easymock.EasyMock.expect(userEntity.getCreateTime()).andReturn(org.apache.ambari.server.controller.internal.UserResourceProviderTest.CREATE_TIME).anyTimes();
        org.easymock.EasyMock.expect(userEntity.getConsecutiveFailures()).andReturn(0).anyTimes();
        org.easymock.EasyMock.expect(userEntity.getAuthenticationEntities()).andReturn(java.util.Collections.<org.apache.ambari.server.orm.entities.UserAuthenticationEntity>emptyList()).anyTimes();
        org.easymock.EasyMock.expect(userEntity.getMemberEntities()).andReturn(java.util.Collections.<org.apache.ambari.server.orm.entities.MemberEntity>emptySet()).anyTimes();
        return userEntity;
    }
