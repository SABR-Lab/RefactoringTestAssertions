        ...
        public java.util.Set<org.apache.ambari.server.controller.spi.Resource> fetchWorkflows(java.util.Set<java.lang.String> requestedIds, java.lang.String clusterName, java.lang.String workflowId) {
            ...
            try {
                ...
                while (rs.next()) {
                    ...
                    org.apache.ambari.server.controller.internal.WorkflowResourceProvider.setResourceProperty(resource, org.apache.ambari.server.controller.internal.WorkflowResourceProvider.WORKFLOW_CLUSTER_NAME_PROPERTY_ID, clusterName, requestedIds);
