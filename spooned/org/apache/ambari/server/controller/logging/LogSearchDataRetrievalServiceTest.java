...
public class LogSearchDataRetrievalServiceTest {
    ...
    public void testGetTailFileWhenHelperIsAvailable() throws java.lang.Exception {
        ...
        org.easymock.EasyMock.expect(helperFactoryMock.getHelper(null, expectedClusterName)).andReturn(helperMock);
        org.easymock.EasyMock.expect(helperMock.createLogFileTailURI("http://localhost", expectedComponentName, expectedHostName)).andReturn(expectedResultURI);
        org.easymock.EasyMock.expect(configurationMock.getLogSearchMetadataCacheExpireTimeout()).andReturn(1).atLeastOnce();
    ...
    public void testGetTailFileWhenRequestHelperIsNull() throws java.lang.Exception {
        ...
        org.apache.ambari.server.controller.logging.LoggingRequestHelperFactory helperFactoryMock = mockSupport.createMock(org.apache.ambari.server.controller.logging.LoggingRequestHelperFactory.class);
        org.apache.ambari.server.configuration.Configuration configurationMock = mockSupport.createMock(org.apache.ambari.server.configuration.Configuration.class);
        org.easymock.EasyMock.expect(helperFactoryMock.getHelper(null, expectedClusterName)).andReturn(null);
        org.easymock.EasyMock.expect(configurationMock.getLogSearchMetadataCacheExpireTimeout()).andReturn(1).atLeastOnce();
        mockSupport.replayAll();
        org.apache.ambari.server.controller.logging.LogSearchDataRetrievalService retrievalService = new org.apache.ambari.server.controller.logging.LogSearchDataRetrievalService();
        retrievalService.setLoggingRequestHelperFactory(helperFactoryMock);
    ...
    public void testGetLogFileNamesDefault() throws java.lang.Exception {
        ...
        org.apache.ambari.server.configuration.Configuration configurationMock = mockSupport.createMock(org.apache.ambari.server.configuration.Configuration.class);
        executorMock.execute(org.easymock.EasyMock.isA(org.apache.ambari.server.controller.logging.LogSearchDataRetrievalService.LogSearchFileNameRequestRunnable.class));
        org.easymock.EasyMock.expectLastCall().once();
        org.easymock.EasyMock.expect(injectorMock.getInstance(org.apache.ambari.server.controller.logging.LoggingRequestHelperFactory.class)).andReturn(helperFactoryMock);
        org.easymock.EasyMock.expect(configurationMock.getLogSearchMetadataCacheExpireTimeout()).andReturn(1).atLeastOnce();
        mockSupport.replayAll();
        org.apache.ambari.server.controller.logging.LogSearchDataRetrievalService retrievalService = new org.apache.ambari.server.controller.logging.LogSearchDataRetrievalService();
        retrievalService.setLoggingRequestHelperFactory(helperFactoryMock);
    ...
    public void testRunnableWithSuccessfulCall() throws java.lang.Exception {
        ...
        org.easymock.EasyMock.expect(helperFactoryMock.getHelper(controllerMock, expectedClusterName)).andReturn(helperMock);
        org.easymock.EasyMock.expect(helperMock.sendGetLogFileNamesRequest(expectedHostName)).andReturn(resp);
        cacheMock.put(expectedComponentAndHostName, java.util.Collections.singleton("/this/is/just/a/test/directory"));
        org.easymock.EasyMock.expect(currentRequestsMock.remove(expectedComponentAndHostName)).andReturn(true).once();
        mockSupport.replayAll();
    ...
    public void testRunnableWithFailedCallNullHelper() throws java.lang.Exception {
        ...
        java.util.Set<java.lang.String> currentRequestsMock = mockSupport.createMock(java.util.Set.class);
        java.util.Map<java.lang.String, java.util.concurrent.atomic.AtomicInteger> componentFailureCounts = mockSupport.createMock(java.util.Map.class);
        org.easymock.EasyMock.expect(helperFactoryMock.getHelper(controllerMock, expectedClusterName)).andReturn(null);
        org.easymock.EasyMock.expect(currentRequestsMock.remove(expectedComponentAndHostName)).andReturn(true).once();
        mockSupport.replayAll();
        org.apache.ambari.server.controller.logging.LogSearchDataRetrievalService.LogSearchFileNameRequestRunnable loggingRunnable = new org.apache.ambari.server.controller.logging.LogSearchDataRetrievalService.LogSearchFileNameRequestRunnable(expectedHostName, expectedComponentName, expectedClusterName, cacheMock, currentRequestsMock, helperFactoryMock, componentFailureCounts, controllerMock);
        loggingRunnable.run();
    ...
    public void testRunnableWithFailedCallNullResult() throws java.lang.Exception {
        ...
        org.easymock.EasyMock.expect(helperFactoryMock.getHelper(controllerMock, expectedClusterName)).andReturn(helperMock);
        org.easymock.EasyMock.expect(helperMock.sendGetLogFileNamesRequest(expectedHostName)).andReturn(null);
        org.easymock.EasyMock.expect(currentRequestsMock.remove(expectedComponentAndHostName)).andReturn(true).once();
        org.easymock.EasyMock.expect(componentFailureCounts.containsKey(expectedComponentName)).andReturn(false);
        org.easymock.EasyMock.expect(componentFailureCounts.put(org.easymock.EasyMock.eq(expectedComponentName), org.easymock.EasyMock.capture(captureFailureCount))).andReturn(new java.util.concurrent.atomic.AtomicInteger(0));
        org.easymock.EasyMock.expect(componentFailureCounts.get(expectedComponentName)).andReturn(testInteger);
        mockSupport.replayAll();
        org.apache.ambari.server.controller.logging.LogSearchDataRetrievalService.LogSearchFileNameRequestRunnable loggingRunnable = new org.apache.ambari.server.controller.logging.LogSearchDataRetrievalService.LogSearchFileNameRequestRunnable(expectedHostName, expectedComponentName, expectedClusterName, cacheMock, currentRequestsMock, helperFactoryMock, componentFailureCounts, controllerMock);
        loggingRunnable.run();
    ...
    public void testRunnableWithFailedCallNullResultExistingFailureCount() throws java.lang.Exception {
        ...
        org.easymock.EasyMock.expect(helperMock.sendGetLogFileNamesRequest(expectedHostName)).andReturn(null);
        org.easymock.EasyMock.expect(currentRequestsMock.remove(expectedComponentAndHostName)).andReturn(true).once();
        org.easymock.EasyMock.expect(componentFailureCounts.containsKey(expectedComponentName)).andReturn(true);
        org.easymock.EasyMock.expect(componentFailureCounts.get(expectedComponentName)).andReturn(testFailureCount);
        mockSupport.replayAll();
