...
public class LoggingRequestHelperFactoryImplTest {
    ...
    public void testHelperCreation() throws java.lang.Exception {
        ...
        org.easymock.EasyMock.expect(controllerMock.getCredentialStoreService()).andReturn(credentialStoreServiceMock).atLeastOnce();
        org.easymock.EasyMock.expect(clustersMock.getCluster(expectedClusterName)).andReturn(clusterMock).atLeastOnce();
        org.easymock.EasyMock.expect(clusterMock.getDesiredConfigByType("logsearch-properties")).andReturn(logSearchEnvConfig).atLeastOnce();
        org.easymock.EasyMock.expect(clusterMock.getServiceComponentHosts("LOGSEARCH", "LOGSEARCH_SERVER")).andReturn(java.util.Collections.singletonList(serviceComponentHostMock)).atLeastOnce();
        org.easymock.EasyMock.expect(clusterMock.getServices()).andReturn(java.util.Collections.singletonMap("LOGSEARCH", ((org.apache.ambari.server.state.Service) (null)))).atLeastOnce();
        org.easymock.EasyMock.expect(logSearchEnvConfig.getProperties()).andReturn(testProperties).atLeastOnce();
        org.easymock.EasyMock.expect(serviceComponentHostMock.getHostName()).andReturn(expectedHostName).atLeastOnce();
        org.easymock.EasyMock.expect(serviceComponentHostMock.getState()).andReturn(org.apache.ambari.server.state.State.STARTED).atLeastOnce();
        org.easymock.EasyMock.expect(serverConfigMock.getLogSearchPortalExternalAddress()).andReturn("");
        org.easymock.EasyMock.expect(serverConfigMock.getLogSearchPortalConnectTimeout()).andReturn(expectedConnectTimeout);
        org.easymock.EasyMock.expect(serverConfigMock.getLogSearchPortalReadTimeout()).andReturn(expectedReadTimeout);
    ...
    public void testHelperCreationLogSearchServerNotStarted() throws java.lang.Exception {
        ...
        org.easymock.EasyMock.expect(clusterMock.getServices()).andReturn(java.util.Collections.singletonMap("LOGSEARCH", ((org.apache.ambari.server.state.Service) (null)))).atLeastOnce();
        org.easymock.EasyMock.expect(serverConfigMock.getLogSearchPortalExternalAddress()).andReturn("");
        org.easymock.EasyMock.expect(serviceComponentHostMock.getState()).andReturn(org.apache.ambari.server.state.State.INSTALLED).atLeastOnce();
        mockSupport.replayAll();
        org.apache.ambari.server.controller.logging.LoggingRequestHelperFactory helperFactory = new org.apache.ambari.server.controller.logging.LoggingRequestHelperFactoryImpl();
        ((org.apache.ambari.server.controller.logging.LoggingRequestHelperFactoryImpl) (helperFactory)).setAmbariServerConfiguration(serverConfigMock);
        org.apache.ambari.server.controller.logging.LoggingRequestHelper helper = helperFactory.getHelper(controllerMock, expectedClusterName);
    ...
    public void testHelperCreationWithNoLogSearchServersAvailable() throws java.lang.Exception {
        ...
        org.easymock.EasyMock.expect(clustersMock.getCluster(expectedClusterName)).andReturn(clusterMock).atLeastOnce();
        org.easymock.EasyMock.expect(clusterMock.getDesiredConfigByType("logsearch-properties")).andReturn(logSearchEnvConfig).atLeastOnce();
        org.easymock.EasyMock.expect(clusterMock.getServiceComponentHosts("LOGSEARCH", "LOGSEARCH_SERVER")).andReturn(java.util.Collections.emptyList()).atLeastOnce();
        org.easymock.EasyMock.expect(clusterMock.getServices()).andReturn(java.util.Collections.singletonMap("LOGSEARCH", ((org.apache.ambari.server.state.Service) (null)))).atLeastOnce();
        org.easymock.EasyMock.expect(serverConfigMock.getLogSearchPortalExternalAddress()).andReturn("");
        mockSupport.replayAll();
        org.apache.ambari.server.controller.logging.LoggingRequestHelperFactory helperFactory = new org.apache.ambari.server.controller.logging.LoggingRequestHelperFactoryImpl();
    ...
    public void testHelperCreationWithNoLogSearchServiceDeployed() throws java.lang.Exception {
        ...
        org.easymock.EasyMock.expect(controllerMock.getClusters()).andReturn(clustersMock).atLeastOnce();
        org.easymock.EasyMock.expect(clustersMock.getCluster(expectedClusterName)).andReturn(clusterMock).atLeastOnce();
        org.easymock.EasyMock.expect(clusterMock.getServices()).andReturn(java.util.Collections.singletonMap("HDFS", ((org.apache.ambari.server.state.Service) (null)))).atLeastOnce();
        org.easymock.EasyMock.expect(serverConfigMock.getLogSearchPortalExternalAddress()).andReturn("");
        mockSupport.replayAll();
        org.apache.ambari.server.controller.logging.LoggingRequestHelperFactory helperFactory = new org.apache.ambari.server.controller.logging.LoggingRequestHelperFactoryImpl();
        ((org.apache.ambari.server.controller.logging.LoggingRequestHelperFactoryImpl) (helperFactory)).setAmbariServerConfiguration(serverConfigMock);
    ...
    public void testHelperCreationWithExternalLogSearchPortal() throws java.lang.Exception {
        ...
        org.easymock.EasyMock.expect(controllerMock.getClusters()).andReturn(clustersMock).atLeastOnce();
        org.easymock.EasyMock.expect(clustersMock.getCluster(expectedClusterName)).andReturn(clusterMock).atLeastOnce();
        org.easymock.EasyMock.expect(serverConfigMock.getLogSearchPortalExternalAddress()).andReturn("http://logsearch.org:61888").times(2);
        org.easymock.EasyMock.expect(controllerMock.getCredentialStoreService()).andReturn(null);
        org.easymock.EasyMock.expect(serverConfigMock.getLogSearchPortalConnectTimeout()).andReturn(expectedConnectTimeout);
        org.easymock.EasyMock.expect(serverConfigMock.getLogSearchPortalReadTimeout()).andReturn(expectedReadTimeout);
        mockSupport.replayAll();
        org.apache.ambari.server.controller.logging.LoggingRequestHelperFactory helperFactory = new org.apache.ambari.server.controller.logging.LoggingRequestHelperFactoryImpl();
