...
public class LoggingRequestHelperImplTest {
    ...
    public void testLogQueryRequestBasic() throws java.lang.Exception {
        ...
        org.easymock.EasyMock.expect(clusterMock.getDesiredConfigByType("logsearch-admin-json")).andReturn(adminPropertiesConfigMock).atLeastOnce();
        org.easymock.EasyMock.expect(clusterMock.getClusterName()).andReturn("clusterone").atLeastOnce();
        org.easymock.EasyMock.expect(adminPropertiesConfigMock.getProperties()).andReturn(testConfigProperties).atLeastOnce();
        org.easymock.EasyMock.expect(networkConnectionMock.readQueryResponseFromServer(org.easymock.EasyMock.capture(captureURLConnection))).andReturn(new java.lang.StringBuffer(org.apache.ambari.server.controller.logging.LoggingRequestHelperImplTest.TEST_JSON_INPUT_TWO_LIST_ENTRIES)).atLeastOnce();
        networkConnectionMock.setupBasicAuthentication(org.easymock.EasyMock.capture(captureURLConnectionForAuthentication), org.easymock.EasyMock.eq(org.apache.ambari.server.controller.logging.LoggingRequestHelperImplTest.EXPECTED_ENCODED_CREDENTIALS));
    ...
    public void testLogLevelRequestBasic() throws java.lang.Exception {
        ...
        org.easymock.EasyMock.expect(clusterMock.getDesiredConfigByType("logsearch-admin-json")).andReturn(adminPropertiesConfigMock).atLeastOnce();
        org.easymock.EasyMock.expect(adminPropertiesConfigMock.getProperties()).andReturn(testConfigProperties).atLeastOnce();
        org.easymock.EasyMock.expect(networkConnectionMock.readQueryResponseFromServer(org.easymock.EasyMock.capture(captureURLConnection))).andReturn(new java.lang.StringBuffer(org.apache.ambari.server.controller.logging.LoggingRequestHelperImplTest.TEST_JSON_INPUT_LOG_LEVEL_QUERY)).atLeastOnce();
        networkConnectionMock.setupBasicAuthentication(org.easymock.EasyMock.capture(captureURLConnectionForAuthentication), org.easymock.EasyMock.eq(org.apache.ambari.server.controller.logging.LoggingRequestHelperImplTest.EXPECTED_ENCODED_CREDENTIALS));
        mockSupport.replayAll();
        org.apache.ambari.server.controller.logging.LoggingRequestHelper helper = new org.apache.ambari.server.controller.logging.LoggingRequestHelperImpl(EXPECTED_HOST_NAME, EXPECTED_PORT_NUMBER, org.apache.ambari.server.controller.logging.LoggingRequestHelperImplTest.EXPECTED_PROTOCOL, credentialStoreServiceMock, clusterMock, null, networkConnectionMock);
    ...
    public void testLogFileNameRequestBasic() throws java.lang.Exception {
        ...
        org.easymock.EasyMock.expect(clusterMock.getClusterName()).andReturn("clusterone").atLeastOnce();
        org.easymock.EasyMock.expect(adminPropertiesConfigMock.getProperties()).andReturn(testConfigProperties).atLeastOnce();
        org.easymock.EasyMock.expect(networkConnectionMock.readQueryResponseFromServer(org.easymock.EasyMock.capture(captureURLConnection))).andReturn(new java.lang.StringBuffer(org.apache.ambari.server.controller.logging.LoggingRequestHelperImplTest.TEST_JSON_INPUT_LOG_FILES_MAP)).atLeastOnce();
        networkConnectionMock.setupBasicAuthentication(org.easymock.EasyMock.capture(captureURLConnectionForAuthentication), org.easymock.EasyMock.eq(org.apache.ambari.server.controller.logging.LoggingRequestHelperImplTest.EXPECTED_ENCODED_CREDENTIALS));
        mockSupport.replayAll();
        org.apache.ambari.server.controller.logging.LoggingRequestHelper helper = new org.apache.ambari.server.controller.logging.LoggingRequestHelperImpl(EXPECTED_HOST_NAME, EXPECTED_PORT_NUMBER, org.apache.ambari.server.controller.logging.LoggingRequestHelperImplTest.EXPECTED_PROTOCOL, credentialStoreServiceMock, clusterMock, null, networkConnectionMock);
    ...
    public void testLogFileNameRequestWithNullLogList() throws java.lang.Exception {
        ...
        testConfigProperties.put("logsearch_admin_password", "admin-pwd");
        testConfigProperties = java.util.Collections.unmodifiableMap(testConfigProperties);
        org.easymock.Capture<java.net.HttpURLConnection> captureURLConnection = org.easymock.Capture.newInstance();
        org.easymock.Capture<java.net.HttpURLConnection> captureURLConnectionForAuthentication = org.easymock.Capture.newInstance();
        org.easymock.EasyMock.expect(clusterMock.getDesiredConfigByType("logsearch-admin-json")).andReturn(adminPropertiesConfigMock).atLeastOnce();
        org.easymock.EasyMock.expect(clusterMock.getClusterName()).andReturn("clusterone").atLeastOnce();
        org.easymock.EasyMock.expect(adminPropertiesConfigMock.getProperties()).andReturn(testConfigProperties).atLeastOnce();
        org.easymock.EasyMock.expect(networkConnectionMock.readQueryResponseFromServer(org.easymock.EasyMock.capture(captureURLConnection))).andReturn(new java.lang.StringBuffer(org.apache.ambari.server.controller.logging.LoggingRequestHelperImplTest.TEST_JSON_INPUT_NULL_LOG_LIST)).atLeastOnce();
        networkConnectionMock.setupBasicAuthentication(org.easymock.EasyMock.capture(captureURLConnectionForAuthentication), org.easymock.EasyMock.eq(org.apache.ambari.server.controller.logging.LoggingRequestHelperImplTest.EXPECTED_ENCODED_CREDENTIALS));
        mockSupport.replayAll();
        org.apache.ambari.server.controller.logging.LoggingRequestHelper helper = new org.apache.ambari.server.controller.logging.LoggingRequestHelperImpl(EXPECTED_HOST_NAME, EXPECTED_PORT_NUMBER, org.apache.ambari.server.controller.logging.LoggingRequestHelperImplTest.EXPECTED_PROTOCOL, credentialStoreServiceMock, clusterMock, null, networkConnectionMock);
        org.apache.ambari.server.controller.logging.HostLogFilesResponse result = helper.sendGetLogFileNamesRequest(EXPECTED_HOST_NAME);
    ...
    public void testLogQueryRequestBasicCredentialsNotInConfig() throws java.lang.Exception {
        ...
        org.easymock.Capture<java.net.HttpURLConnection> captureURLConnectionForAuthentication = org.easymock.EasyMock.newCapture();
        org.easymock.EasyMock.expect(clusterMock.getDesiredConfigByType("logsearch-admin-json")).andReturn(adminPropertiesConfigMock).atLeastOnce();
        org.easymock.EasyMock.expect(clusterMock.getClusterName()).andReturn(expectedClusterName).atLeastOnce();
        org.easymock.EasyMock.expect(adminPropertiesConfigMock.getProperties()).andReturn(java.util.Collections.emptyMap()).atLeastOnce();
        org.easymock.EasyMock.expect(networkConnectionMock.readQueryResponseFromServer(org.easymock.EasyMock.capture(captureURLConnection))).andReturn(new java.lang.StringBuffer(org.apache.ambari.server.controller.logging.LoggingRequestHelperImplTest.TEST_JSON_INPUT_TWO_LIST_ENTRIES)).atLeastOnce();
        org.easymock.EasyMock.expect(credentialStoreServiceMock.getCredential(expectedClusterName, "logsearch.admin.credential")).andReturn(new org.apache.ambari.server.security.credential.PrincipalKeyCredential(org.apache.ambari.server.controller.logging.LoggingRequestHelperImplTest.EXPECTED_USER_NAME, org.apache.ambari.server.controller.logging.LoggingRequestHelperImplTest.EXPECTED_ADMIN_PASSWORD)).atLeastOnce();
        networkConnectionMock.setupBasicAuthentication(org.easymock.EasyMock.capture(captureURLConnectionForAuthentication), org.easymock.EasyMock.eq(org.apache.ambari.server.controller.logging.LoggingRequestHelperImplTest.EXPECTED_ENCODED_CREDENTIALS));
        mockSupport.replayAll();
        org.apache.ambari.server.controller.logging.LoggingRequestHelper helper = new org.apache.ambari.server.controller.logging.LoggingRequestHelperImpl(EXPECTED_HOST_NAME, EXPECTED_PORT_NUMBER, org.apache.ambari.server.controller.logging.LoggingRequestHelperImplTest.EXPECTED_PROTOCOL, credentialStoreServiceMock, clusterMock, null, networkConnectionMock);
        org.apache.ambari.server.controller.logging.LogQueryResponse result = helper.sendQueryRequest(java.util.Collections.emptyMap());
