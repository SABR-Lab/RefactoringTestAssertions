...
public class LoggingSearchPropertyProviderTest {
    ...
    private void testBasicCall(org.springframework.security.core.Authentication authentication, boolean authorizedForLogSearch) throws java.lang.Exception {
        ...
        org.easymock.EasyMock.expect(resourceMock.getPropertyValue(org.apache.ambari.server.controller.utilities.PropertyHelper.getPropertyId("HostRoles", "component_name"))).andReturn(expectedComponentName).atLeastOnce();
        org.easymock.EasyMock.expect(resourceMock.getPropertyValue(org.apache.ambari.server.controller.utilities.PropertyHelper.getPropertyId("HostRoles", "host_name"))).andReturn("c6401.ambari.apache.org").atLeastOnce();
        org.easymock.EasyMock.expect(resourceMock.getPropertyValue(org.apache.ambari.server.controller.utilities.PropertyHelper.getPropertyId("HostRoles", "cluster_name"))).andReturn("clusterone").atLeastOnce();
        ...
        if (authorizedForLogSearch) {
            resourceMock.setProperty(org.easymock.EasyMock.eq("logging"), org.easymock.EasyMock.capture(captureLogInfo));
        }
        ...
        if (authorizedForLogSearch) {
            ...
            org.easymock.EasyMock.expect(controllerMock.findServiceName(clusterMock, expectedComponentName)).andReturn(expectedServiceName).atLeastOnce();
            org.easymock.EasyMock.expect(clusterMock.getService(expectedServiceName)).andReturn(serviceMock).anyTimes();
            org.easymock.EasyMock.expect(serviceMock.getDesiredStackId()).andReturn(stackIdMock).anyTimes();
            org.easymock.EasyMock.expect(controllerMock.getAmbariServerURI(expectedSearchEnginePath)).andReturn(expectedAmbariURL + expectedSearchEnginePath).atLeastOnce();
            org.easymock.EasyMock.expect(controllerMock.getAmbariMetaInfo()).andReturn(metaInfoMock).atLeastOnce();
            org.easymock.EasyMock.expect(metaInfoMock.getComponent(expectedStackName, expectedStackVersion, expectedServiceName, expectedComponentName)).andReturn(componentInfoMock).atLeastOnce();
            org.easymock.EasyMock.expect(stackIdMock.getStackName()).andReturn(expectedStackName).atLeastOnce();
            org.easymock.EasyMock.expect(stackIdMock.getStackVersion()).andReturn(expectedStackVersion).atLeastOnce();
            org.easymock.EasyMock.expect(componentInfoMock.getLogs()).andReturn(java.util.Collections.singletonList(logDefinitionMock)).atLeastOnce();
            org.easymock.EasyMock.expect(logDefinitionMock.getLogId()).andReturn(expectedLogSearchComponentName).atLeastOnce();
            org.easymock.EasyMock.expect(dataRetrievalServiceMock.getLogFileNames(expectedLogSearchComponentName, "c6401.ambari.apache.org", "clusterone")).andReturn(java.util.Collections.singleton(expectedLogFilePath)).atLeastOnce();
            org.easymock.EasyMock.expect(dataRetrievalServiceMock.getLogFileTailURI(expectedAmbariURL + expectedSearchEnginePath, expectedLogSearchComponentName, "c6401.ambari.apache.org", "clusterone")).andReturn("").atLeastOnce();
            org.easymock.EasyMock.expect(loggingRequestHelperFactoryMock.getHelper(org.easymock.EasyMock.anyObject(org.apache.ambari.server.controller.AmbariManagementController.class), org.easymock.EasyMock.anyObject(java.lang.String.class))).andReturn(loggingRequestHelperMock).atLeastOnce();
        }
        org.easymock.EasyMock.expect(controllerMock.getClusters()).andReturn(clustersMock).atLeastOnce();
        org.easymock.EasyMock.expect(clustersMock.getCluster("clusterone")).andReturn(clusterMock).atLeastOnce();
        org.easymock.EasyMock.expect(clusterMock.getResourceId()).andReturn(4L).atLeastOnce();
    ...
    private void testBasicCallWithNullTailLogURIReturned(org.springframework.security.core.Authentication authentication, boolean authorizedForLogSearch) throws java.lang.Exception {
        ...
        if (authorizedForLogSearch) {
            ...
            org.easymock.EasyMock.expect(serviceMock.getDesiredStackId()).andReturn(stackIdMock).anyTimes();
            org.easymock.EasyMock.expect(dataRetrievalServiceMock.getLogFileNames(expectedLogSearchComponentName, "c6401.ambari.apache.org", "clusterone")).andReturn(java.util.Collections.singleton(expectedLogFilePath)).atLeastOnce();
            org.easymock.EasyMock.expect(dataRetrievalServiceMock.getLogFileTailURI(expectedAmbariURL + expectedSearchEnginePath, expectedLogSearchComponentName, "c6401.ambari.apache.org", "clusterone")).andReturn(null).atLeastOnce();
            org.easymock.EasyMock.expect(loggingRequestHelperFactoryMock.getHelper(org.easymock.EasyMock.anyObject(org.apache.ambari.server.controller.AmbariManagementController.class), org.easymock.EasyMock.anyObject(java.lang.String.class))).andReturn(loggingRequestHelperMock).atLeastOnce();
            org.easymock.EasyMock.expect(controllerMock.getAmbariServerURI(expectedSearchEnginePath)).andReturn(expectedAmbariURL + expectedSearchEnginePath).atLeastOnce();
            org.easymock.EasyMock.expect(controllerMock.getAmbariMetaInfo()).andReturn(metaInfoMock).atLeastOnce();
            org.easymock.EasyMock.expect(metaInfoMock.getComponent(expectedStackName, expectedStackVersion, expectedServiceName, expectedComponentName)).andReturn(componentInfoMock).atLeastOnce();
    ...
    private void testCheckWhenLogSearchNotAvailable(org.springframework.security.core.Authentication authentication, boolean authorizedForLogSearch) throws java.lang.Exception {
        ...
        if (authorizedForLogSearch) {
            ...
            org.easymock.EasyMock.expect(stackIdMock.getStackVersion()).andReturn(expectedStackVersion).atLeastOnce();
            org.easymock.EasyMock.expect(metaInfoMock.getComponent(expectedStackName, expectedStackVersion, expectedServiceName, expectedComponentName)).andReturn(componentInfoMock).atLeastOnce();
            org.easymock.EasyMock.expect(dataRetrievalServiceMock.getLogFileNames(expectedLogSearchComponentName, "c6401.ambari.apache.org", "clusterone")).andReturn(null).atLeastOnce();
            org.easymock.EasyMock.expect(componentInfoMock.getLogs()).andReturn(java.util.Collections.singletonList(logDefinitionMock)).atLeastOnce();
            org.easymock.EasyMock.expect(logDefinitionMock.getLogId()).andReturn(expectedLogSearchComponentName).atLeastOnce();
            org.easymock.EasyMock.expect(loggingRequestHelperFactoryMock.getHelper(org.easymock.EasyMock.anyObject(org.apache.ambari.server.controller.AmbariManagementController.class), org.easymock.EasyMock.anyObject(java.lang.String.class))).andReturn(loggingRequestHelperMock).atLeastOnce();
        }
