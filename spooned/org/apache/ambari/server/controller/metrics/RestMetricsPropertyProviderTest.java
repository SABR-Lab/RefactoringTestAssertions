...
public class RestMetricsPropertyProviderTest {
    ...
    public static void setup() throws java.lang.Exception {
        ...
        org.apache.ambari.server.controller.metrics.RestMetricsPropertyProviderTest.amc = org.easymock.EasyMock.createNiceMock(org.apache.ambari.server.controller.AmbariManagementController.class);
        ...
        org.apache.ambari.server.state.ConfigHelper configHelperMock = org.easymock.EasyMock.createNiceMock(org.apache.ambari.server.state.ConfigHelper.class);
        org.easymock.EasyMock.expect(org.apache.ambari.server.controller.metrics.RestMetricsPropertyProviderTest.amc.getClusters()).andReturn(org.apache.ambari.server.controller.metrics.RestMetricsPropertyProviderTest.clusters).anyTimes();
        org.easymock.EasyMock.expect(org.apache.ambari.server.controller.metrics.RestMetricsPropertyProviderTest.amc.getAmbariEventPublisher()).andReturn(org.easymock.EasyMock.createNiceMock(org.apache.ambari.server.events.publishers.AmbariEventPublisher.class)).anyTimes();
        org.easymock.EasyMock.expect(org.apache.ambari.server.controller.metrics.RestMetricsPropertyProviderTest.amc.findConfigurationTagsWithOverrides(org.easymock.EasyMock.eq(org.apache.ambari.server.controller.metrics.RestMetricsPropertyProviderTest.c1), org.easymock.EasyMock.anyString(), org.easymock.EasyMock.anyObject())).andReturn(java.util.Collections.singletonMap("storm-site", java.util.Collections.singletonMap("tag", "version1"))).anyTimes();
        org.easymock.EasyMock.expect(org.apache.ambari.server.controller.metrics.RestMetricsPropertyProviderTest.amc.getConfigHelper()).andReturn(configHelperMock).anyTimes();
        org.easymock.EasyMock.expect(configHelperMock.getEffectiveConfigProperties(org.easymock.EasyMock.eq(org.apache.ambari.server.controller.metrics.RestMetricsPropertyProviderTest.c1), org.easymock.EasyMock.anyObject())).andReturn(java.util.Collections.singletonMap("storm-site", java.util.Collections.singletonMap("ui.port", org.apache.ambari.server.controller.metrics.RestMetricsPropertyProviderTest.DEFAULT_STORM_UI_PORT))).anyTimes();
        org.easymock.EasyMock.replay(org.apache.ambari.server.controller.metrics.RestMetricsPropertyProviderTest.amc, configHelperMock);
    }
    ...
    public void testResolvePort() throws java.lang.Exception {
        org.apache.ambari.server.state.stack.MetricDefinition metricDefinition = org.easymock.EasyMock.createNiceMock(org.apache.ambari.server.state.stack.MetricDefinition.class);
        org.easymock.EasyMock.expect(metricDefinition.getMetrics()).andReturn(org.apache.ambari.server.controller.metrics.RestMetricsPropertyProviderTest.componentMetrics);
        org.easymock.EasyMock.expect(metricDefinition.getType()).andReturn("org.apache.ambari.server.controller.metrics.RestMetricsPropertyProvider");
        org.easymock.EasyMock.expect(metricDefinition.getProperties()).andReturn(org.apache.ambari.server.controller.metrics.RestMetricsPropertyProviderTest.metricsProperties);
        org.easymock.EasyMock.replay(metricDefinition);
