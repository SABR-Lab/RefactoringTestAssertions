...
public class GangliaPropertyProviderTest {
    ...
    public void testPopulateResources_checkHostComponent() throws java.lang.Exception {
        ...
        temporalInfoMap.put(org.apache.ambari.server.controller.metrics.ganglia.GangliaPropertyProviderTest.PROPERTY_ID, new org.apache.ambari.server.controller.internal.TemporalInfoImpl(10L, 20L, 1L));
        org.apache.ambari.server.controller.spi.Request request = org.apache.ambari.server.controller.utilities.PropertyHelper.getReadRequest(java.util.Collections.singleton(org.apache.ambari.server.controller.metrics.ganglia.GangliaPropertyProviderTest.PROPERTY_ID), temporalInfoMap);
        org.easymock.EasyMock.expect(hostProvider.getCollectorHostName(org.easymock.EasyMock.anyObject(java.lang.String.class), org.easymock.EasyMock.eq(org.apache.ambari.server.controller.metrics.MetricsServiceProvider.MetricsService.GANGLIA))).andReturn("ganglia-host");
        org.easymock.EasyMock.expect(hostProvider.isCollectorComponentLive(org.easymock.EasyMock.anyObject(java.lang.String.class), org.easymock.EasyMock.eq(org.apache.ambari.server.controller.metrics.MetricsServiceProvider.MetricsService.GANGLIA))).andReturn(true).once();
        org.easymock.EasyMock.expect(hostProvider.isCollectorHostLive(org.easymock.EasyMock.anyObject(java.lang.String.class), org.easymock.EasyMock.eq(org.apache.ambari.server.controller.metrics.MetricsServiceProvider.MetricsService.GANGLIA))).andReturn(true).once();
    ...
    private void setUpCommonMocks() throws org.apache.ambari.server.AmbariException, java.lang.NoSuchFieldException, java.lang.IllegalAccessException {
        ...
        org.easymock.EasyMock.expect(clusters.getCluster(org.apache.ambari.server.controller.metrics.ganglia.GangliaPropertyProviderTest.CLUSTER_NAME_PROPERTY_ID)).andReturn(cluster).anyTimes();
        ...
        org.easymock.EasyMock.replay(amc, clusters, cluster);
