                ...
                for (java.lang.String hostNamesBatch : hostNamesBatches) {
                    try {
                        if (!hostComponentHostMetrics.isEmpty()) {
                            java.lang.String hostComponentHostMetricParams = org.apache.ambari.server.controller.metrics.timeline.AMSPropertyProvider.getSetString(processRegexps(hostComponentHostMetrics), -1);
                        ...
                        if (!nonHostComponentMetrics.isEmpty()) {
                            java.lang.String nonHostComponentHostMetricParams = org.apache.ambari.server.controller.metrics.timeline.AMSPropertyProvider.getSetString(processRegexps(nonHostComponentMetrics), -1);
                                ...
                                if (containsArguments(propertyId)) {
                                    ...
                                    if (!parameterList.isEmpty()) {
                                        for (java.lang.String param : parameterList) {
                                            propertyId = org.apache.ambari.server.controller.metrics.timeline.AMSPropertyProvider.substituteArgument(propertyId, "$" + i, param);
                                            ++i;
                                        }
                                    } else {
                                        propertyId = org.apache.ambari.server.controller.metrics.timeline.AMSPropertyProvider.substituteArgument(propertyId, "$1", metric.getInstanceId());
                                    }
