...
public class AMSPropertyProviderTest {
    ...
    public void testPopulateResourcesForSingleHostMetric() throws java.lang.Exception {
        ...
        org.apache.ambari.server.configuration.ComponentSSLConfiguration sslConfiguration = org.mockito.Mockito.mock(org.apache.ambari.server.configuration.ComponentSSLConfiguration.class);
        ...
        org.easymock.EasyMock.expect(cacheProviderMock.getTimelineMetricsCache()).andReturn(cacheMock).anyTimes();
    ...
    public void testPopulateMetricsForEmbeddedHBase() throws java.lang.Exception {
        org.apache.ambari.server.controller.AmbariManagementController amc = org.easymock.EasyMock.createNiceMock(org.apache.ambari.server.controller.AmbariManagementController.class);
        org.powermock.api.easymock.PowerMock.mockStatic(org.apache.ambari.server.controller.AmbariServer.class);
        org.easymock.EasyMock.expect(org.apache.ambari.server.controller.AmbariServer.getController()).andReturn(amc).anyTimes();
        ...
        org.easymock.EasyMock.expect(amc.getClusters()).andReturn(clusters).anyTimes();
        org.easymock.EasyMock.expect(clusters.getCluster("HostRoles/cluster_name")).andReturn(cluster).anyTimes();
        org.easymock.EasyMock.expect(cluster.getResourceId()).andReturn(2L).anyTimes();
        ...
        org.apache.ambari.server.state.Service amsService = org.easymock.EasyMock.createNiceMock(org.apache.ambari.server.state.Service.class);
        org.easymock.EasyMock.expect(amsService.getDesiredStackId()).andReturn(stackId);
        org.easymock.EasyMock.expect(amsService.getName()).andReturn("AMS");
        org.easymock.EasyMock.expect(cluster.getServiceByComponentName("METRICS_COLLECTOR")).andReturn(amsService);
        org.easymock.EasyMock.expect(cluster.getCurrentStackVersion()).andReturn(stackId).anyTimes();
        org.easymock.EasyMock.expect(amc.getAmbariMetaInfo()).andReturn(ambariMetaInfo).anyTimes();
        org.easymock.EasyMock.expect(ambariMetaInfo.getComponentToService("HDP", "2.2", "METRICS_COLLECTOR")).andReturn("AMS").anyTimes();
        org.easymock.EasyMock.expect(ambariMetaInfo.getComponent("HDP", "2.2", "AMS", "METRICS_COLLECTOR")).andReturn(componentInfo).anyTimes();
        org.easymock.EasyMock.expect(componentInfo.getTimelineAppid()).andReturn("AMS-HBASE");
        org.easymock.EasyMock.replay(amc, clusters, cluster, amsService, ambariMetaInfo, componentInfo);
    ...
    public void testAggregateFunctionForComponentMetrics() throws java.lang.Exception {
        ...
        org.easymock.EasyMock.expect(hbaseService.getDesiredStackId()).andReturn(stackId);
        org.easymock.EasyMock.expect(hbaseService.getName()).andReturn("HBASE");
        org.easymock.EasyMock.expect(cluster.getServiceByComponentName("HBASE_REGIONSERVER")).andReturn(hbaseService);
        org.easymock.EasyMock.expect(cluster.getCurrentStackVersion()).andReturn(stackId).anyTimes();
        org.easymock.EasyMock.expect(amc.getAmbariMetaInfo()).andReturn(ambariMetaInfo).anyTimes();
        org.easymock.EasyMock.expect(ambariMetaInfo.getComponentToService("HDP", "2.2", "HBASE_REGIONSERVER")).andReturn("HBASE").anyTimes();
        org.easymock.EasyMock.expect(ambariMetaInfo.getComponent("HDP", "2.2", "HBASE", "HBASE_REGIONSERVER")).andReturn(componentInfo).anyTimes();
        org.easymock.EasyMock.expect(componentInfo.getTimelineAppid()).andReturn("HBASE");
        org.easymock.EasyMock.replay(amc, clusters, cluster, hbaseService, ambariMetaInfo, componentInfo);
        org.powermock.api.easymock.PowerMock.replayAll();
    ...
    public void testSocketTimeoutExceptionBehavior() throws java.lang.Exception {
        ...
        java.net.HttpURLConnection connection = org.easymock.EasyMock.createNiceMock(java.net.HttpURLConnection.class);
        org.easymock.EasyMock.expect(streamProvider.processURL(((java.lang.String) (org.easymock.EasyMock.anyObject())), ((java.lang.String) (org.easymock.EasyMock.anyObject())), ((java.lang.String) (org.easymock.EasyMock.anyObject())), ((java.util.Map<java.lang.String, java.util.List<java.lang.String>>) (org.easymock.EasyMock.anyObject())))).andReturn(connection);
        org.easymock.EasyMock.expect(connection.getInputStream()).andThrow(new java.net.SocketTimeoutException("Unit test raising Exception")).once();
        org.easymock.EasyMock.replay(streamProvider, connection);
        injectCacheEntryFactoryWithStreamProvider(streamProvider);
        org.apache.ambari.server.controller.metrics.timeline.AMSPropertyProviderTest.TestMetricHostProvider metricHostProvider = new org.apache.ambari.server.controller.metrics.timeline.AMSPropertyProviderTest.TestMetricHostProvider();
        org.apache.ambari.server.configuration.ComponentSSLConfiguration sslConfiguration = org.mockito.Mockito.mock(org.apache.ambari.server.configuration.ComponentSSLConfiguration.class);
        java.util.Map<java.lang.String, java.util.Map<java.lang.String, org.apache.ambari.server.controller.internal.PropertyInfo>> propertyIds = org.apache.ambari.server.controller.utilities.PropertyHelper.getMetricPropertyIds(org.apache.ambari.server.controller.spi.Resource.Type.Host);
        ...
        org.easymock.EasyMock.verify(streamProvider, connection);
        org.junit.Assert.assertEquals(2, resources.size());
        org.apache.ambari.server.controller.spi.Resource res = resources.iterator().next();
        java.util.Map<java.lang.String, java.lang.Object> properties = org.apache.ambari.server.controller.utilities.PropertyHelper.getProperties(resources.iterator().next());
        org.junit.Assert.assertNotNull(properties);
    ...
    private void setUpCommonMocks() throws org.apache.ambari.server.AmbariException {
        org.apache.ambari.server.controller.AmbariManagementController ams = org.easymock.EasyMock.createNiceMock(org.apache.ambari.server.controller.AmbariManagementController.class);
        org.powermock.api.easymock.PowerMock.mockStatic(org.apache.ambari.server.controller.AmbariServer.class);
        org.easymock.EasyMock.expect(org.apache.ambari.server.controller.AmbariServer.getController()).andReturn(ams).anyTimes();
        org.apache.ambari.server.api.services.AmbariMetaInfo ambariMetaInfo = org.easymock.EasyMock.createNiceMock(org.apache.ambari.server.api.services.AmbariMetaInfo.class);
        org.apache.ambari.server.state.Clusters clusters = org.easymock.EasyMock.createNiceMock(org.apache.ambari.server.state.Clusters.class);
        org.apache.ambari.server.state.Cluster cluster = org.easymock.EasyMock.createNiceMock(org.apache.ambari.server.state.Cluster.class);
        org.apache.ambari.server.state.ComponentInfo componentInfo = org.easymock.EasyMock.createNiceMock(org.apache.ambari.server.state.ComponentInfo.class);
        org.apache.ambari.server.state.StackId stackId = new org.apache.ambari.server.state.StackId("HDP", "2.2");
        org.easymock.EasyMock.expect(ams.getClusters()).andReturn(clusters).anyTimes();
        try {
            org.easymock.EasyMock.expect(clusters.getCluster(org.easymock.EasyMock.anyObject(java.lang.String.class))).andReturn(cluster).anyTimes();
        } catch (org.apache.ambari.server.AmbariException e) {
            e.printStackTrace();
        ...
        org.easymock.EasyMock.expect(cluster.getCurrentStackVersion()).andReturn(stackId).anyTimes();
        org.easymock.EasyMock.expect(ams.getAmbariMetaInfo()).andReturn(ambariMetaInfo).anyTimes();
        org.easymock.EasyMock.expect(ambariMetaInfo.getComponentToService(org.easymock.EasyMock.anyObject(java.lang.String.class), org.easymock.EasyMock.anyObject(java.lang.String.class), org.easymock.EasyMock.anyObject(java.lang.String.class))).andReturn("HDFS").anyTimes();
        org.easymock.EasyMock.expect(ambariMetaInfo.getComponent(org.easymock.EasyMock.anyObject(java.lang.String.class), org.easymock.EasyMock.anyObject(java.lang.String.class), org.easymock.EasyMock.anyObject(java.lang.String.class), org.easymock.EasyMock.anyObject(java.lang.String.class))).andReturn(componentInfo).anyTimes();
        org.easymock.EasyMock.expect(componentInfo.getTimelineAppid()).andReturn(null).anyTimes();
        org.easymock.EasyMock.replay(ams, clusters, cluster, ambariMetaInfo, componentInfo);
        org.powermock.api.easymock.PowerMock.replayAll();
    }
