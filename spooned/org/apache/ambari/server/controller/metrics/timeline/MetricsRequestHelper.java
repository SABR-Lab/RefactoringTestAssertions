...
public class MetricsRequestHelper {
    ...
    private static final com.fasterxml.jackson.databind.ObjectReader timelineObjectReader;
    ...
    public org.apache.hadoop.metrics2.sink.timeline.TimelineMetrics fetchTimelineMetrics(org.apache.http.client.utils.URIBuilder uriBuilder, java.lang.Long startTime, java.lang.Long endTime) throws java.io.IOException {
        ...
        try {
            java.net.HttpURLConnection connection = streamProvider.processURL(uriBuilder.toString(), javax.ws.rs.HttpMethod.GET, ((java.lang.String) (null)), java.util.Collections.emptyMap());
            if (!checkConnectionForPrecisionException(connection)) {
                ...
                if (higherPrecision != null) {
                    ...
                    connection = streamProvider.processURL(newSpec, javax.ws.rs.HttpMethod.GET, ((java.lang.String) (null)), java.util.Collections.<java.lang.String, java.util.List<java.lang.String>>emptyMap());
                    if (!checkConnectionForPrecisionException(connection)) {
