...
public class TimelineMetricCacheTest {
    ...
    public void testTimelineMetricCache() throws java.lang.Exception {
        org.apache.ambari.server.controller.metrics.timeline.cache.TimelineMetricCacheEntryFactory cacheEntryFactory = org.easymock.EasyMock.createMock(org.apache.ambari.server.controller.metrics.timeline.cache.TimelineMetricCacheEntryFactory.class);
        ...
        org.easymock.EasyMock.expect(cacheEntryFactory.load(testKey)).andReturn(testValue).anyTimes();
        org.easymock.EasyMock.replay(cacheEntryFactory);
        ...
        org.easymock.EasyMock.expect(configuration.getMetricCacheTTLSeconds()).andReturn(3600);
        org.easymock.EasyMock.expect(configuration.getMetricCacheIdleSeconds()).andReturn(1800);
        org.easymock.EasyMock.expect(configuration.getMetricCacheEntryUnitSize()).andReturn(100).anyTimes();
        ...
        org.easymock.EasyMock.verify(cacheEntryFactory);
    }
    ...
    public void testTimelineMetricCacheProviderGets() throws java.lang.Exception {
        ...
        org.easymock.EasyMock.expect(cacheEntryFactory.load(org.easymock.EasyMock.anyObject())).andReturn(value);
        org.easymock.EasyMock.replay(cacheEntryFactory);
        org.apache.ambari.server.controller.metrics.timeline.cache.TimelineMetricCacheProvider cacheProvider = org.easymock.EasyMock.createMockBuilder(org.apache.ambari.server.controller.metrics.timeline.cache.TimelineMetricCacheProvider.class).addMockedMethod("createCacheConfiguration").withConstructor(configuration, cacheEntryFactory).createNiceMock();
        org.easymock.EasyMock.expect(cacheProvider.createCacheConfiguration()).andReturn(createTestCacheConfiguration(configuration, cacheEntryFactory)).anyTimes();
        org.easymock.EasyMock.replay(cacheProvider);
        ...
        junit.framework.Assert.assertEquals("app1", metric.getAppId());
        junit.framework.Assert.assertSame(metricValues, metric.getMetricValues());
        org.easymock.EasyMock.verify(configuration, cacheEntryFactory);
    }
    ...
    public void testCacheUpdateBoundsOnVariousRequestScenarios() throws java.lang.Exception {
        org.apache.ambari.server.configuration.Configuration configuration = org.easymock.EasyMock.createNiceMock(org.apache.ambari.server.configuration.Configuration.class);
        org.easymock.EasyMock.expect(configuration.getMetricsRequestConnectTimeoutMillis()).andReturn(10000);
        org.easymock.EasyMock.expect(configuration.getMetricsRequestReadTimeoutMillis()).andReturn(10000);
        org.easymock.EasyMock.expect(configuration.getMetricsRequestIntervalReadTimeoutMillis()).andReturn(10000);
        org.easymock.EasyMock.expect(configuration.getMetricRequestBufferTimeCatchupInterval()).andReturn(0L);
        org.easymock.EasyMock.replay(configuration);
        org.apache.ambari.server.controller.metrics.timeline.cache.TimelineMetricCacheEntryFactory factory = org.easymock.EasyMock.createMockBuilder(org.apache.ambari.server.controller.metrics.timeline.cache.TimelineMetricCacheEntryFactory.class).withConstructor(configuration).createMock();
        org.easymock.EasyMock.replay(factory);
        ...
        org.easymock.EasyMock.verify(configuration, factory);
    }
    ...
    public void testTimelineMetricCachePrecisionUpdates() throws java.lang.Exception {
        ...
        org.easymock.EasyMock.expect(configuration.getMetricCacheIdleSeconds()).andReturn(1800);
        org.easymock.EasyMock.expect(configuration.getMetricCacheEntryUnitSize()).andReturn(100).anyTimes();
        org.easymock.EasyMock.expect(configuration.getMetricRequestBufferTimeCatchupInterval()).andReturn(1000L).anyTimes();
        org.easymock.EasyMock.replay(configuration);
        final long now = java.lang.System.currentTimeMillis();
        long second = 1000;
        long min = 60 * second;
        ...
        newKey.setSpec("");
        org.apache.ambari.server.controller.metrics.timeline.MetricsRequestHelper metricsRequestHelperForGets = org.easymock.EasyMock.createMock(org.apache.ambari.server.controller.metrics.timeline.MetricsRequestHelper.class);
        org.easymock.EasyMock.expect(metricsRequestHelperForGets.fetchTimelineMetrics(org.easymock.EasyMock.isA(org.apache.http.client.utils.URIBuilder.class), org.easymock.EasyMock.anyLong(), org.easymock.EasyMock.anyLong())).andReturn(metrics).andReturn(newMetrics);
        org.easymock.EasyMock.replay(metricsRequestHelperForGets);
        org.apache.ambari.server.controller.metrics.timeline.cache.TimelineMetricCacheEntryFactory cacheEntryFactory = org.easymock.EasyMock.createMockBuilder(org.apache.ambari.server.controller.metrics.timeline.cache.TimelineMetricCacheEntryFactory.class).withConstructor(configuration).createMock();
        ...
        org.easymock.EasyMock.verify(configuration, metricsRequestHelperForGets, cacheEntryFactory);
    }
}
