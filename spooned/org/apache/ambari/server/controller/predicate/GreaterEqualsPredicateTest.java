...
public class GreaterEqualsPredicateTest {
    ...
    public void testApply() {
        ...
        org.apache.ambari.server.controller.spi.Predicate predicate = new org.apache.ambari.server.controller.predicate.GreaterEqualsPredicate<>(propertyId, 10);
    ...
    public void testNullValue() {
        try {
            new org.apache.ambari.server.controller.predicate.GreaterEqualsPredicate<java.lang.Integer>("category/foo", null);
    ...
    public void testGetProperties() {
        java.lang.String propertyId = org.apache.ambari.server.controller.utilities.PropertyHelper.getPropertyId("category1", "foo");
        org.apache.ambari.server.controller.predicate.GreaterEqualsPredicate predicate = new org.apache.ambari.server.controller.predicate.GreaterEqualsPredicate<>(propertyId, 10);
