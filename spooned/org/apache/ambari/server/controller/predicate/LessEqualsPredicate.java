...
public class LessEqualsPredicate<T> extends org.apache.ambari.server.controller.predicate.ComparisonPredicate<T> {
    public LessEqualsPredicate(java.lang.String propertyId, java.lang.Comparable<T> value) {
    ...
    public org.apache.ambari.server.controller.predicate.ComparisonPredicate<T> copy(java.lang.String propertyId) {
        return new org.apache.ambari.server.controller.predicate.LessEqualsPredicate<>(propertyId, getValue());
    }
}
