...
public class LessEqualsPredicateTest {
    ...
    public void testApply() {
        ...
        org.apache.ambari.server.controller.spi.Predicate predicate = new org.apache.ambari.server.controller.predicate.LessEqualsPredicate<>(propertyId, 10);
    ...
    public void testNullValue() {
        try {
            new org.apache.ambari.server.controller.predicate.LessEqualsPredicate<java.lang.Integer>("category/foo", null);
    ...
    public void testGetProperties() {
        java.lang.String propertyId = org.apache.ambari.server.controller.utilities.PropertyHelper.getPropertyId("category1", "foo");
        org.apache.ambari.server.controller.predicate.LessEqualsPredicate predicate = new org.apache.ambari.server.controller.predicate.LessEqualsPredicate<>(propertyId, 10);
