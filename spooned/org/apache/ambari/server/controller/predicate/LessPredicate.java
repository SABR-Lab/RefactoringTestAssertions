...
public class LessPredicate<T> extends org.apache.ambari.server.controller.predicate.ComparisonPredicate<T> {
    public LessPredicate(java.lang.String propertyId, java.lang.Comparable<T> value) {
    ...
    public org.apache.ambari.server.controller.predicate.ComparisonPredicate<T> copy(java.lang.String propertyId) {
        return new org.apache.ambari.server.controller.predicate.LessPredicate<>(propertyId, getValue());
    }
}
