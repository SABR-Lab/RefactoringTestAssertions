...
public class DatabaseCheckerTest {
    ...
    public void testCheckDBVersion_Valid() throws java.lang.Exception {
        org.apache.ambari.server.orm.dao.MetainfoDAO metainfoDAO = org.easymock.EasyMock.createMock(org.apache.ambari.server.orm.dao.MetainfoDAO.class);
        ...
        org.easymock.EasyMock.expect(metainfoDAO.findByKey(org.apache.ambari.server.configuration.Configuration.SERVER_VERSION_KEY)).andReturn(metainfoEntity);
        org.easymock.EasyMock.replay(metainfoDAO);
