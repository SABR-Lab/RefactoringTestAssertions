...
public class YarnServiceCalculatedStateTest extends org.apache.ambari.server.controller.utilities.state.GeneralServiceCalculatedStateTest {
    @java.lang.Override
    ...
    protected org.apache.ambari.server.controller.utilities.state.ServiceCalculatedState getServiceCalculatedStateObject() {
        return new org.apache.ambari.server.controller.utilities.state.YARNServiceCalculatedState();
    }

    @java.lang.Override
    protected void createComponentsAndHosts() throws java.lang.Exception {
        org.apache.ambari.server.state.ServiceComponent masterComponent = service.addServiceComponent("RESOURCEMANAGER");
        org.apache.ambari.server.state.ServiceComponent secondMasterComponent = service.addServiceComponent("NODEMANAGER");
        org.apache.ambari.server.state.ServiceComponent clientComponent = service.addServiceComponent("YARN_CLIENT");
        for (java.lang.String hostName : hosts) {
            ...
            org.apache.ambari.server.state.ServiceComponentHost sch = secondMasterComponent.addServiceComponentHost(hostName);
