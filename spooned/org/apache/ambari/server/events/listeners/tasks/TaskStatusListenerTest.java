...
public class TaskStatusListenerTest extends org.easymock.EasyMockSupport {
    ...
    public void testOnTaskUpdateEvent() throws org.apache.ambari.server.ClusterNotFoundException {
        ...
        org.easymock.EasyMock.expect(stageDAO.findByPK(org.easymock.EasyMock.anyObject(org.apache.ambari.server.orm.entities.StageEntityPK.class))).andReturn(stageEntity).anyTimes();
        ...
        org.easymock.EasyMock.expect(requestDAO.findByPK(org.easymock.EasyMock.anyLong())).andReturn(requestEntity).anyTimes();
        org.easymock.EasyMock.expect(requestDAO.updateStatus(org.easymock.EasyMock.eq(1L), org.easymock.EasyMock.eq(org.apache.ambari.server.actionmanager.HostRoleStatus.COMPLETED), org.easymock.EasyMock.eq(org.apache.ambari.server.actionmanager.HostRoleStatus.SKIPPED_FAILED))).andReturn(new org.apache.ambari.server.orm.entities.RequestEntity()).times(1);
    ...
    public void testNamedTasksEnabled() {
        ...
        stompUpdatePublisher.publish(org.easymock.EasyMock.capture(namedTaskUpdateEventCapture));
        ...
        org.easymock.EasyMock.expect(taskStatusListenerProvider.get()).andReturn(listener);
