...
public class StackUpgradeFinishListenerTest extends org.easymock.EasyMockSupport {
    ...
    public void setup() throws java.lang.Exception {
        ...
        org.easymock.EasyMock.expect(cluster.getServices()).andReturn(services);
        org.easymock.EasyMock.expect(service.getServiceComponents()).andReturn(components);
        org.easymock.EasyMock.expect(ambariMetaInfoProvider.get()).andReturn(ami);
