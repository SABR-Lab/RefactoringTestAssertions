...
public class StackVersionListenerTest extends org.easymock.EasyMockSupport {
    ...
    public void setup() throws java.lang.Exception {
        ...
        org.easymock.EasyMock.expect(cluster.getClusterId()).andReturn(org.apache.ambari.server.events.listeners.upgrade.StackVersionListenerTest.CLUSTER_ID);
        org.easymock.EasyMock.expect(cluster.getService(org.apache.ambari.server.events.listeners.upgrade.StackVersionListenerTest.SERVICE_NAME)).andReturn(service).anyTimes();
        org.easymock.EasyMock.expect(service.getServiceComponent(org.apache.ambari.server.events.listeners.upgrade.StackVersionListenerTest.SERVICE_COMPONENT_NAME)).andReturn(serviceComponent).anyTimes();
        org.easymock.EasyMock.expect(sch.getDesiredStackId()).andReturn(stackId).atLeastOnce();
        org.easymock.EasyMock.expect(sch.getServiceName()).andReturn(org.apache.ambari.server.events.listeners.upgrade.StackVersionListenerTest.SERVICE_NAME).atLeastOnce();
        org.easymock.EasyMock.expect(sch.getServiceComponentName()).andReturn(org.apache.ambari.server.events.listeners.upgrade.StackVersionListenerTest.SERVICE_COMPONENT_NAME).atLeastOnce();
        org.easymock.EasyMock.expect(ambariMetaInfoProvider.get()).andReturn(ambariMetaInfo).atLeastOnce();
        org.easymock.EasyMock.expect(m_hostLevelParamsHolder.get()).andReturn(hostLevelParamsHolder).anyTimes();
        org.easymock.EasyMock.expect(ambariMetaInfo.getComponent(org.apache.ambari.server.events.listeners.upgrade.StackVersionListenerTest.STACK_NAME, org.apache.ambari.server.events.listeners.upgrade.StackVersionListenerTest.STACK_VERSION, org.apache.ambari.server.events.listeners.upgrade.StackVersionListenerTest.SERVICE_NAME, org.apache.ambari.server.events.listeners.upgrade.StackVersionListenerTest.SERVICE_COMPONENT_NAME)).andReturn(componentInfo).atLeastOnce();
        org.easymock.EasyMock.expect(hostLevelParamsHolder.getCurrentData(org.easymock.EasyMock.anyLong())).andReturn(createNiceMock(org.apache.ambari.server.events.HostLevelParamsUpdateEvent.class)).anyTimes();
    ...
    public void testRecalculateHostVersionStateWhenVersionIsNullAndNewVersionIsNotBlank() throws org.apache.ambari.server.AmbariException {
        org.easymock.EasyMock.expect(sch.getVersion()).andReturn(null);
        org.easymock.EasyMock.expect(componentInfo.isVersionAdvertised()).andReturn(true).once();
        ...
        org.easymock.EasyMock.expect(sch.recalculateHostVersionState()).andReturn(null).once();
        replayAll();
    ...
    public void testRecalculateHostVersionStateWhenVersionIsUnknownAndNewVersionIsNotBlank() throws org.apache.ambari.server.AmbariException {
        org.easymock.EasyMock.expect(sch.getVersion()).andReturn(org.apache.ambari.server.events.listeners.upgrade.StackVersionListenerTest.UNKNOWN_VERSION);
        org.easymock.EasyMock.expect(componentInfo.isVersionAdvertised()).andReturn(true).once();
        sch.setVersion(org.apache.ambari.server.events.listeners.upgrade.StackVersionListenerTest.INVALID_NEW_VERSION);
        org.easymock.EasyMock.expectLastCall().once();
        org.easymock.EasyMock.expect(sch.recalculateHostVersionState()).andReturn(null).once();
    ...
    public void testRecalculateClusterVersionStateWhenVersionIsNullAndNewVersionIsValid() throws org.apache.ambari.server.AmbariException {
        ...
        org.easymock.EasyMock.expectLastCall().once();
        org.easymock.EasyMock.expect(sch.recalculateHostVersionState()).andReturn(org.apache.ambari.server.events.listeners.upgrade.StackVersionListenerTest.DUMMY_HOST_VERSION_ENTITY).once();
        replayAll();
    ...
    public void testRecalculateHostVersionStateWhenComponentDesiredVersionIsUnknownAndNewVersionIsNotValid() throws org.apache.ambari.server.AmbariException {
        org.easymock.EasyMock.expect(serviceComponent.getDesiredVersion()).andReturn(org.apache.ambari.server.events.listeners.upgrade.StackVersionListenerTest.UNKNOWN_VERSION);
        org.easymock.EasyMock.expect(componentInfo.isVersionAdvertised()).andReturn(true).once();
    ...
    public void testRecalculateClusterVersionStateWhenVersionNotAdvertised() throws org.apache.ambari.server.AmbariException {
        org.easymock.EasyMock.expect(componentInfo.isVersionAdvertised()).andReturn(false).once();
        replayAll();
        sendEventAndVerify(org.apache.ambari.server.events.listeners.upgrade.StackVersionListenerTest.VALID_NEW_VERSION);
    }
    ...
    public void testSetUpgradeStateToCompleteWhenUpgradeIsInProgressAndNewVersionIsEqualToComponentDesiredVersion() throws org.apache.ambari.server.AmbariException {
        org.easymock.EasyMock.expect(cluster.getUpgradeInProgress()).andReturn(org.apache.ambari.server.events.listeners.upgrade.StackVersionListenerTest.DUMMY_UPGRADE_ENTITY);
        org.easymock.EasyMock.expect(sch.getVersion()).andReturn(org.apache.ambari.server.events.listeners.upgrade.StackVersionListenerTest.VALID_PREVIOUS_VERSION);
        org.easymock.EasyMock.expect(sch.getUpgradeState()).andReturn(org.apache.ambari.server.state.UpgradeState.IN_PROGRESS);
        org.easymock.EasyMock.expect(componentInfo.isVersionAdvertised()).andReturn(true).once();
        sch.setUpgradeState(org.apache.ambari.server.state.UpgradeState.COMPLETE);
        org.easymock.EasyMock.expectLastCall().once();
        org.easymock.EasyMock.expect(serviceComponent.getDesiredVersion()).andStubReturn(org.apache.ambari.server.events.listeners.upgrade.StackVersionListenerTest.VALID_NEW_VERSION);
        replayAll();
        sendEventAndVerify(org.apache.ambari.server.events.listeners.upgrade.StackVersionListenerTest.VALID_NEW_VERSION);
    }
    ...
    public void testSetUpgradeStateToVersionMismatchWhenUpgradeIsInProgressAndNewVersionIsNotEqualToComponentDesiredVersion() throws org.apache.ambari.server.AmbariException {
        ...
        sch.setVersion(org.apache.ambari.server.events.listeners.upgrade.StackVersionListenerTest.VALID_NEW_VERSION);
        org.easymock.EasyMock.expectLastCall().once();
        org.easymock.EasyMock.expect(serviceComponent.getDesiredVersion()).andStubReturn(org.apache.ambari.server.events.listeners.upgrade.StackVersionListenerTest.VALID_PREVIOUS_VERSION);
        replayAll();
        sendEventAndVerify(org.apache.ambari.server.events.listeners.upgrade.StackVersionListenerTest.VALID_NEW_VERSION);
    }
    ...
    public void testSetUpgradeStateToCompleteWhenHostHasVersionMismatchAndNewVersionIsEqualToComponentDesiredVersionAndClusterUpgradeIsInProgress() throws org.apache.ambari.server.AmbariException {
        org.easymock.EasyMock.expect(sch.getVersion()).andReturn(org.apache.ambari.server.events.listeners.upgrade.StackVersionListenerTest.VALID_PREVIOUS_VERSION);
        org.easymock.EasyMock.expect(sch.getUpgradeState()).andReturn(org.apache.ambari.server.state.UpgradeState.VERSION_MISMATCH);
        org.easymock.EasyMock.expect(cluster.getUpgradeInProgress()).andReturn(org.apache.ambari.server.events.listeners.upgrade.StackVersionListenerTest.DUMMY_UPGRADE_ENTITY);
        org.easymock.EasyMock.expect(serviceComponent.getDesiredVersion()).andStubReturn(org.apache.ambari.server.events.listeners.upgrade.StackVersionListenerTest.VALID_NEW_VERSION);
        org.easymock.EasyMock.expect(componentInfo.isVersionAdvertised()).andReturn(true).once();
        sch.setUpgradeState(org.apache.ambari.server.state.UpgradeState.COMPLETE);
    ...
    public void testSetRepositoryVersion() throws java.lang.Exception {
        ...
        org.easymock.EasyMock.expect(sch.getVersion()).andReturn(org.apache.ambari.server.events.listeners.upgrade.StackVersionListenerTest.UNKNOWN_VERSION);
        org.easymock.EasyMock.expect(sch.getHost()).andReturn(host).anyTimes();
        org.easymock.EasyMock.expect(componentInfo.isVersionAdvertised()).andReturn(true).once();
        ...
        org.easymock.EasyMock.expect(entity.getVersion()).andReturn("2.4.0.0").once();
        entity.setResolved(true);
        org.easymock.EasyMock.expectLastCall().once();
        org.easymock.EasyMock.expect(dao.findByPK(1L)).andReturn(entity).once();
        org.easymock.EasyMock.expect(dao.merge(entity)).andReturn(entity).once();
        replayAll();
    ...
    public void testRepositoryResolvedWhenVersionsMatch() throws java.lang.Exception {
        ...
        org.apache.ambari.server.state.Host host = createMock(org.apache.ambari.server.state.Host.class);
        org.easymock.EasyMock.expect(host.getHostId()).andReturn(1L).anyTimes();
        org.easymock.EasyMock.expect(sch.getVersion()).andReturn(version);
        org.easymock.EasyMock.expect(sch.getHost()).andReturn(host).anyTimes();
        org.easymock.EasyMock.expect(componentInfo.isVersionAdvertised()).andReturn(true).once();
        org.apache.ambari.server.orm.dao.RepositoryVersionDAO dao = createNiceMock(org.apache.ambari.server.orm.dao.RepositoryVersionDAO.class);
        org.apache.ambari.server.orm.entities.RepositoryVersionEntity entity = createNiceMock(org.apache.ambari.server.orm.entities.RepositoryVersionEntity.class);
        org.easymock.EasyMock.expect(entity.getVersion()).andReturn(version).once();
        org.easymock.EasyMock.expect(entity.isResolved()).andReturn(false).once();
        entity.setResolved(true);
        org.easymock.EasyMock.expectLastCall().once();
        org.easymock.EasyMock.expect(dao.findByPK(1L)).andReturn(entity).once();
        org.easymock.EasyMock.expect(dao.merge(entity)).andReturn(entity).once();
    ...
    public void testRepositoryVersionNotSetDuringUpgrade() throws java.lang.Exception {
        org.easymock.EasyMock.expect(componentInfo.isVersionAdvertised()).andReturn(true).once();
        org.easymock.EasyMock.expect(cluster.getUpgradeInProgress()).andReturn(createNiceMock(org.apache.ambari.server.orm.entities.UpgradeEntity.class));
