...
public class DefaultLdapConfigurationService implements org.apache.ambari.server.ldap.service.LdapConfigurationService {
    ...
    public java.lang.String checkUserAttributes(java.lang.String testUserName, java.lang.String testPassword, org.apache.ambari.server.ldap.domain.AmbariLdapConfiguration ambariLdapConfiguration) throws org.apache.ambari.server.ldap.service.AmbariLdapException {
        ...
        try {
            ...
            java.lang.String filter = org.apache.directory.ldap.client.api.search.FilterBuilder.and(org.apache.directory.ldap.client.api.search.FilterBuilder.equal(org.apache.directory.api.ldap.model.constants.SchemaConstants.OBJECT_CLASS_AT, ambariLdapConfiguration.userObjectClass()), org.apache.directory.ldap.client.api.search.FilterBuilder.equal(ambariLdapConfiguration.userNameAttribute(), testUserName)).toString();
            ...
            userDn = ldapConnectionTemplateFactory.create(ambariLdapConfiguration).searchFirst(new org.apache.directory.api.ldap.model.name.Dn(ambariLdapConfiguration.userSearchBase()), filter, org.apache.directory.api.ldap.model.message.SearchScope.SUBTREE, getUserDnNameEntryMapper(ambariLdapConfiguration));
            if (null == userDn) {
    ...
    public java.util.Set<java.lang.String> checkGroupAttributes(java.lang.String userDn, org.apache.ambari.server.ldap.domain.AmbariLdapConfiguration ambariLdapConfiguration) throws org.apache.ambari.server.ldap.service.AmbariLdapException {
        ...
        try {
            ...
            java.lang.String filter = org.apache.directory.ldap.client.api.search.FilterBuilder.and(org.apache.directory.ldap.client.api.search.FilterBuilder.equal(org.apache.directory.api.ldap.model.constants.SchemaConstants.OBJECT_CLASS_AT, ambariLdapConfiguration.groupObjectClass()), org.apache.directory.ldap.client.api.search.FilterBuilder.equal(ambariLdapConfiguration.groupMemberAttribute(), userDn)).toString();
            ...
            org.apache.directory.ldap.client.template.LdapConnectionTemplate ldapConnectionTemplate = ldapConnectionTemplateFactory.create(ambariLdapConfiguration);
            org.apache.directory.api.ldap.model.message.SearchRequest searchRequest = ldapConnectionTemplate.newSearchRequest(new org.apache.directory.api.ldap.model.name.Dn(ambariLdapConfiguration.groupSearchBase()), filter, org.apache.directory.api.ldap.model.message.SearchScope.SUBTREE);
