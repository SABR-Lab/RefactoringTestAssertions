...
public class ProfiledReentrantReadWriteLockTest extends org.easymock.EasyMockSupport {
    ...
    private void timeWaitingForLockIsRecorded(org.apache.ambari.server.logging.ProfiledLock testSubject, com.google.common.base.Ticker ticker) {
        org.easymock.EasyMock.expect(ticker.read()).andReturn(java.util.concurrent.TimeUnit.MILLISECONDS.toNanos(1L));
        org.easymock.EasyMock.expect(ticker.read()).andReturn(java.util.concurrent.TimeUnit.MILLISECONDS.toNanos(4L));
        org.easymock.EasyMock.expect(ticker.read()).andReturn(java.util.concurrent.TimeUnit.MILLISECONDS.toNanos(5L));
        replayAll();
        testSubject.lock();
    ...
    private void timeSpentLockedIsRecorded(com.google.common.base.Ticker ticker, org.apache.ambari.server.logging.ProfiledLock testSubject) {
        org.easymock.EasyMock.expect(ticker.read()).andReturn(java.util.concurrent.TimeUnit.MILLISECONDS.toNanos(0L));
        org.easymock.EasyMock.expect(ticker.read()).andReturn(java.util.concurrent.TimeUnit.MILLISECONDS.toNanos(0L));
        org.easymock.EasyMock.expect(ticker.read()).andReturn(java.util.concurrent.TimeUnit.MILLISECONDS.toNanos(6L));
        org.easymock.EasyMock.expect(ticker.read()).andReturn(java.util.concurrent.TimeUnit.MILLISECONDS.toNanos(13L));
        replayAll();
        testSubject.lock();
        testSubject.unlock();
    ...
    private void onlyOutermostLockUnlockIsProfiled(org.apache.ambari.server.logging.ProfiledLock testSubject, com.google.common.base.Ticker ticker) {
        ...
        org.easymock.EasyMock.expect(ticker.read()).andReturn(java.util.concurrent.TimeUnit.MILLISECONDS.toNanos(0L));
        org.easymock.EasyMock.expect(ticker.read()).andReturn(java.util.concurrent.TimeUnit.MILLISECONDS.toNanos(5L));
        org.easymock.EasyMock.expect(ticker.read()).andReturn(java.util.concurrent.TimeUnit.MILLISECONDS.toNanos(19L));
        replayAll();
        testSubject.lock();
        testSubject.lock();
        testSubject.unlock();
