...
public class RoleGraphTest {
    ...
    public void testValidateOrder() throws org.apache.ambari.server.AmbariException {
        ...
        org.mockito.Mockito.when(cluster.getServices()).thenReturn(com.google.common.collect.ImmutableMap.<java.lang.String, org.apache.ambari.server.state.Service>builder().put("HDFS", hdfsService).build());
        ...
        org.apache.ambari.server.state.Service hdfsServiceMock = org.mockito.Mockito.mock(org.apache.ambari.server.state.Service.class);
        org.apache.ambari.server.state.ServiceComponent jnComponentMock = org.mockito.Mockito.mock(org.apache.ambari.server.state.ServiceComponent.class);
        org.mockito.Mockito.when(cluster.getService("HDFS")).thenReturn(hdfsServiceMock);
        org.mockito.Mockito.when(hdfsServiceMock.getServiceComponent("JOURNALNODE")).thenReturn(jnComponentMock);
    ...
    public void testGetOrderedHostRoleCommands() throws org.apache.ambari.server.AmbariException {
        ...
        org.mockito.Mockito.when(cluster.getServices()).thenReturn(com.google.common.collect.ImmutableMap.<java.lang.String, org.apache.ambari.server.state.Service>builder().put("HDFS", hdfsService).put("ZOOKEEPER", zkService).put("HBASE", hbaseService).build());
        org.apache.ambari.server.metadata.RoleCommandOrder rco = roleCommandOrderProvider.getRoleCommandOrder(cluster);
