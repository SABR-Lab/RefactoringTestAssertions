...
public class AmbariMetricSinkImpl extends org.apache.hadoop.metrics2.sink.timeline.AbstractTimelineMetricsSink implements org.apache.ambari.server.metrics.system.MetricsSink {
    ...
    public void init(org.apache.ambari.server.metrics.system.impl.MetricsConfiguration configuration) {
        ...
        int maxRowCacheSize = java.lang.Integer.parseInt(configuration.getProperty(org.apache.ambari.server.metrics.system.impl.MAX_METRIC_ROW_CACHE_SIZE, java.lang.String.valueOf(org.apache.hadoop.metrics2.sink.timeline.cache.TimelineMetricsCache.MAX_RECS_PER_NAME_DEFAULT)));
        int metricsSendInterval = java.lang.Integer.parseInt(configuration.getProperty(org.apache.ambari.server.metrics.system.impl.METRICS_SEND_INTERVAL, java.lang.String.valueOf(org.apache.hadoop.metrics2.sink.timeline.cache.TimelineMetricsCache.MAX_EVICTION_TIME_MILLIS)));
