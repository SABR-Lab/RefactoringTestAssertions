...
public class MpackManagerMock extends org.apache.ambari.server.mpack.MpackManager {
    ...
    public MpackManagerMock(@com.google.inject.assistedinject.Assisted("mpacksv2Staging")
    ...
    java.io.File stackRootDir, org.apache.ambari.server.orm.dao.MpackDAO mpackDAOObj, org.apache.ambari.server.orm.dao.StackDAO stackDAOObj) {
        super(mpacksStagingLocation, stackRootDir, mpackDAOObj, stackDAOObj);
        ...
        try {
            for (final java.io.File dirEntry : mpackStaging.listFiles()) {
                if (dirEntry.isDirectory()) {
                    ...
                    org.apache.ambari.server.mpack.MpackManagerMock.LOG.info("Reading mpack :" + mpackName);
                    if (!mpackName.equals(org.apache.ambari.server.mpack.MpackManagerMock.MPACK_TAR_LOCATION)) {
                        for (final java.io.File file : dirEntry.listFiles()) {
                            if (file.isDirectory()) {
                                ...
                                if (resultSet.size() > 0) {
                                    ...
                                    java.lang.String mpackJsonContents = new java.lang.String(java.nio.file.Files.readAllBytes(java.nio.file.Paths.get((file + "/") + org.apache.ambari.server.mpack.MpackManagerMock.MPACK_METADATA)), "UTF-8");
    ...
    public org.apache.ambari.server.controller.MpackResponse registerMpack(org.apache.ambari.server.controller.MpackRequest mpackRequest) throws java.io.IOException, java.lang.IllegalArgumentException, org.apache.ambari.server.controller.spi.ResourceAlreadyExistsException {
        ...
        if (mpackRequest.getRegistryId() != null) {
            ...
            org.apache.ambari.server.mpack.MpackManagerMock.LOG.info("Mpack Registration via Registry :" + mpackName);
            ...
            mpack = downloadMpackMetadata(mpackRequest.getMpackUri());
            mpackTarPath = downloadMpack(mpackRequest.getMpackUri(), mpack.getDefinition());
            org.apache.ambari.server.mpack.MpackManagerMock.LOG.info("Custom Mpack Registration :" + mpackRequest.getMpackUri());
    ...
    private org.apache.ambari.server.state.Mpack downloadMpackMetadata(java.lang.String mpackURI) throws java.io.IOException {
        ...
        java.io.File stagingDir = new java.io.File((mpackStaging.toString() + java.io.File.separator) + org.apache.ambari.server.mpack.MpackManagerMock.MPACK_TAR_LOCATION);
        java.nio.file.Path targetPath = new java.io.File((stagingDir.getPath() + java.io.File.separator) + org.apache.ambari.server.mpack.MpackManagerMock.MPACK_METADATA).toPath();
        org.apache.ambari.server.mpack.MpackManagerMock.LOG.debug("Download mpack.json and store in :" + targetPath);
    ...
    private void extractTar(java.nio.file.Path tarPath, java.io.File untarDirectory) throws java.io.IOException {
        ...
        org.apache.ambari.server.mpack.MpackManagerMock.LOG.debug("Extracting tar file :" + tarFile);
        while ((entry = tarFile.getNextTarEntry()) != null) {
            outputFile = new java.io.File(untarDirectory, entry.getName());
            if (entry.isDirectory()) {
                if (!outputFile.exists()) {
                    org.apache.ambari.server.mpack.MpackManagerMock.LOG.debug("Creating output directory " + outputFile.getAbsolutePath());
                ...
                if (!parentDir.exists()) {
                    org.apache.ambari.server.mpack.MpackManagerMock.LOG.debug("Attempting to create output directory " + parentDir.getAbsolutePath());
                    if (!parentDir.mkdirs()) {
                        throw new java.lang.IllegalStateException("Couldn't create directory " + parentDir.getAbsolutePath());
                    }
                }
                org.apache.ambari.server.mpack.MpackManagerMock.LOG.debug("Creating output file " + outputFile.getAbsolutePath());
    ...
    private void extractMpackTar(org.apache.ambari.server.state.Mpack mpack, java.nio.file.Path mpackTarPath, java.lang.String mpackDirectory) throws java.io.IOException {
        ...
        org.apache.ambari.server.mpack.MpackManagerMock.LOG.debug("Extracting Mpack definitions into :" + extractedMpackDirectory);
    ...
    private void generateMetainfo(java.io.File metainfoFile, org.apache.ambari.server.state.Mpack mpack) throws java.io.IOException {
        org.apache.ambari.server.mpack.MpackManagerMock.LOG.info("Generating {} for mpack {}", metainfoFile, mpack.getName());
        ...
        if ((prerequisites != null) && prerequisites.containsKey(org.apache.ambari.server.mpack.MpackManagerMock.MIN_JDK_PROPERTY)) {
            generatedMetainfo.setMinJdk(mpack.getPrerequisites().get(org.apache.ambari.server.mpack.MpackManagerMock.MIN_JDK_PROPERTY));
        } else {
            org.apache.ambari.server.mpack.MpackManagerMock.LOG.warn("Couldn't detect {} for mpack {}. Using default value {}", org.apache.ambari.server.mpack.MpackManagerMock.MIN_JDK_PROPERTY, mpack.getName(), org.apache.ambari.server.mpack.MpackManagerMock.DEFAULT_JDK_VALUE);
            generatedMetainfo.setMinJdk(org.apache.ambari.server.mpack.MpackManagerMock.DEFAULT_JDK_VALUE);
        }
        if ((prerequisites != null) && prerequisites.containsKey(org.apache.ambari.server.mpack.MpackManagerMock.MAX_JDK_PROPERTY)) {
            generatedMetainfo.setMaxJdk(mpack.getPrerequisites().get(org.apache.ambari.server.mpack.MpackManagerMock.MAX_JDK_PROPERTY));
        } else {
            org.apache.ambari.server.mpack.MpackManagerMock.LOG.warn("Couldn't detect {} for mpack {}. Using default value {}", org.apache.ambari.server.mpack.MpackManagerMock.MAX_JDK_PROPERTY, mpack.getName(), org.apache.ambari.server.mpack.MpackManagerMock.DEFAULT_JDK_VALUE);
            generatedMetainfo.setMaxJdk(org.apache.ambari.server.mpack.MpackManagerMock.DEFAULT_JDK_VALUE);
        }
        try {
    ...
    private void createServicesDirectory(java.nio.file.Path extractedMpackDirectory, org.apache.ambari.server.state.Mpack mpack) throws java.io.IOException {
        java.io.File servicesDir = new java.io.File((extractedMpackDirectory.toAbsolutePath() + java.io.File.separator) + org.apache.ambari.server.mpack.MpackManagerMock.MODULES_DIRECTORY);
        if (!servicesDir.exists()) {
            servicesDir.mkdir();
        }
        java.util.List<org.apache.ambari.server.state.Module> modules = mpack.getModules();
        org.apache.ambari.server.mpack.MpackManagerMock.LOG.info("Creating services directory for mpack :" + mpack.getName());
    ...
    protected boolean validateMpackInfo(java.lang.String expectedMpackName, java.lang.String expectedMpackVersion, java.lang.String actualMpackName, java.lang.String actualMpackVersion) {
        if (expectedMpackName.equalsIgnoreCase(actualMpackName) && expectedMpackVersion.equalsIgnoreCase(actualMpackVersion)) {
            ...
            org.apache.ambari.server.mpack.MpackManagerMock.LOG.info(((((((("Incorrect information : Mismatch in - (" + expectedMpackName) + ",") + actualMpackName) + ") or (") + expectedMpackVersion) + ",") + actualMpackVersion) + ")");
            return false;
        }
    }
    ...
    protected java.lang.Long populateDB(org.apache.ambari.server.state.Mpack mpacks) throws java.io.IOException {
        ...
        if ((resultSet.size() == 0) && (stackEntity == null)) {
            org.apache.ambari.server.mpack.MpackManagerMock.LOG.info("Adding mpack {}-{} to the database", mpackName, mpackVersion);
    ...
    protected void populateStackDB(org.apache.ambari.server.state.Mpack mpack) throws java.io.IOException, org.apache.ambari.server.controller.spi.ResourceAlreadyExistsException {
        ...
        if (stackEntity == null) {
            org.apache.ambari.server.mpack.MpackManagerMock.LOG.info("Adding stack {}-{} to the database", stackName, stackVersion);
            ...
            org.apache.ambari.server.mpack.MpackManagerMock.LOG.error(message);
            throw new org.apache.ambari.server.controller.spi.ResourceAlreadyExistsException(message);
        }
    }
    ...
    public boolean removeMpack(org.apache.ambari.server.orm.entities.MpackEntity mpackEntity, org.apache.ambari.server.orm.entities.StackEntity stackEntity) throws java.io.IOException {
        ...
        java.nio.file.Path mpackTarFile = java.nio.file.Paths.get((((mpackStaging + java.io.File.separator) + org.apache.ambari.server.mpack.MpackManagerMock.MPACK_TAR_LOCATION) + java.io.File.separator) + mpackName);
        org.apache.ambari.server.mpack.MpackManagerMock.LOG.info("Removing mpack :" + mpackName);
