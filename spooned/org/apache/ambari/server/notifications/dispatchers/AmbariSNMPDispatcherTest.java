...
public class AmbariSNMPDispatcherTest {
    ...
    public void testDispatch_nullProperties() throws java.lang.Exception {
        ...
        org.apache.ambari.server.notifications.Notification notification = org.mockito.Mockito.mock(org.apache.ambari.server.state.alert.AlertNotification.class);
        notification.Callback = org.mockito.Mockito.mock(org.apache.ambari.server.notifications.DispatchCallback.class);
        notification.CallbackIds = new java.util.ArrayList<>();
        dispatcher.dispatch(notification);
        org.mockito.Mockito.verify(notification.Callback).onFailure(notification.CallbackIds);
        org.mockito.Mockito.verify(notification.Callback, org.mockito.Mockito.never()).onSuccess(notification.CallbackIds);
    }

    @org.junit.Test
    public void testDispatchUdpTransportMappingCrash() throws java.lang.Exception {
        org.apache.ambari.server.notifications.dispatchers.AmbariSNMPDispatcher dispatcher = org.mockito.Mockito.spy(new org.apache.ambari.server.notifications.dispatchers.AmbariSNMPDispatcher(org.apache.ambari.server.notifications.dispatchers.AmbariSNMPDispatcherTest.DEFAULT_SNMP_PORT));
        ...
        org.apache.ambari.server.notifications.Notification notification = org.mockito.Mockito.mock(org.apache.ambari.server.state.alert.AlertNotification.class);
        notification.Callback = org.mockito.Mockito.mock(org.apache.ambari.server.notifications.DispatchCallback.class);
        notification.CallbackIds = org.mockito.Mockito.mock(java.util.List.class);
        ...
        org.mockito.Mockito.doThrow(new java.io.IOException()).when(dispatcher).sendTraps(notification, snmpVersion);
        dispatcher.dispatch(notification);
        org.mockito.Mockito.verify(notification.Callback).onFailure(notification.CallbackIds);
        org.mockito.Mockito.verify(notification.Callback, org.mockito.Mockito.never()).onSuccess(notification.CallbackIds);
    ...
    public void testDispatch_sendTrapError() throws java.lang.Exception {
        ...
        notification.DispatchProperties = properties;
        notification.Recipients = java.util.Arrays.asList(new org.apache.ambari.server.notifications.Recipient());
        org.mockito.Mockito.doThrow(new java.lang.RuntimeException()).when(dispatcher).sendTraps(org.mockito.Matchers.eq(notification), org.mockito.Matchers.any(org.apache.ambari.server.notifications.dispatchers.SNMPDispatcher.SnmpVersion.class));
        dispatcher.dispatch(notification);
        org.mockito.Mockito.verify(notification.Callback).onFailure(notification.CallbackIds);
        org.mockito.Mockito.verify(notification.Callback, org.mockito.Mockito.never()).onSuccess(notification.CallbackIds);
    }
    ...
    public void testDispatch_successful_v1() throws java.lang.Exception {
        ...
        notification.DispatchProperties = properties;
        notification.Recipients = java.util.Arrays.asList(new org.apache.ambari.server.notifications.Recipient());
        org.mockito.Mockito.doNothing().when(dispatcher).sendTraps(notification, snmpVersion);
        dispatcher.dispatch(notification);
        org.mockito.Mockito.verify(notification.Callback, org.mockito.Mockito.never()).onFailure(notification.CallbackIds);
        org.mockito.Mockito.verify(notification.Callback).onSuccess(notification.CallbackIds);
    }
    ...
    public void testPrepareTrap_v1() throws java.lang.Exception {
        ...
        org.junit.Assert.assertEquals(org.snmp4j.PDU.V1TRAP, pdu.getType());
        ...
        org.junit.Assert.assertEquals(org.apache.ambari.server.notifications.dispatchers.AmbariSNMPDispatcher.AMBARI_ALERT_TRAP_OID, variableBindings.get(org.snmp4j.mp.SnmpConstants.snmpTrapOID.toString()).toValueString());
        org.junit.Assert.assertTrue(variableBindings.get(org.snmp4j.mp.SnmpConstants.snmpTrapOID.toString()).getVariable() instanceof org.snmp4j.smi.OID);
    ...
    public void testPrepareTrap_v2c() throws java.lang.Exception {
        ...
        org.apache.ambari.server.notifications.Notification notification = getAlertNotification(true);
        org.snmp4j.PDU pdu = dispatcher.prepareTrap(notification, snmpVersion);
        org.junit.Assert.assertEquals(org.snmp4j.PDU.TRAP, pdu.getType());
        java.util.Map<java.lang.String, org.snmp4j.smi.VariableBinding> variableBindings = new java.util.HashMap<>();
        for (org.snmp4j.smi.VariableBinding variableBinding : pdu.toArray()) {
            variableBindings.put(variableBinding.getOid().toString(), variableBinding);
        }
    ...
    public void testSendTraps_v1() throws java.lang.Exception {
        org.apache.ambari.server.notifications.dispatchers.SNMPDispatcher.SnmpVersion snmpVersion = org.apache.ambari.server.notifications.dispatchers.SNMPDispatcher.SnmpVersion.SNMPv1;
        org.snmp4j.Snmp snmp = org.mockito.Mockito.mock(org.snmp4j.Snmp.class);
        org.apache.ambari.server.notifications.dispatchers.AmbariSNMPDispatcher dispatcher = org.mockito.Mockito.spy(new org.apache.ambari.server.notifications.dispatchers.AmbariSNMPDispatcher(snmp));
        org.snmp4j.PDU trap = org.mockito.Mockito.mock(org.snmp4j.PDU.class);
        ...
        org.mockito.Mockito.doReturn(trap).when(dispatcher).prepareTrap(notification, snmpVersion);
        ...
        org.mockito.Mockito.verify(snmp, org.mockito.Mockito.times(1)).send(org.mockito.Matchers.eq(trap), argument.capture());
        org.junit.Assert.assertEquals("192.168.0.2/162", argument.getValue().getAddress().toString());
        org.junit.Assert.assertEquals(org.snmp4j.mp.SnmpConstants.version1, argument.getValue().getVersion());
    }
    ...
    public void testSendTraps_v2() throws java.lang.Exception {
        ...
        org.mockito.Mockito.verify(snmp, org.mockito.Mockito.times(1)).send(org.mockito.Matchers.eq(trap), argument.capture());
        org.junit.Assert.assertEquals("192.168.0.2/162", argument.getValue().getAddress().toString());
        org.junit.Assert.assertEquals(org.snmp4j.mp.SnmpConstants.version2c, argument.getValue().getVersion());
    }
    ...
    public void testSendTraps_v3() throws java.lang.Exception {
        ...
        org.mockito.Mockito.verify(snmp, org.mockito.Mockito.times(1)).send(org.mockito.Matchers.eq(trap), argument.capture());
        org.junit.Assert.assertEquals("192.168.0.2/162", argument.getValue().getAddress().toString());
        org.junit.Assert.assertEquals(org.snmp4j.mp.SnmpConstants.version3, argument.getValue().getVersion());
    }
