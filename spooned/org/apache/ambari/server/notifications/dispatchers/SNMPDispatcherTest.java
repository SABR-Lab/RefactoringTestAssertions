...
public class SNMPDispatcherTest {
    ...
    public void testDispatch_nullProperties() throws java.lang.Exception {
        ...
        org.apache.ambari.server.notifications.Notification notification = org.mockito.Mockito.mock(org.apache.ambari.server.notifications.Notification.class);
    ...
    public void testDispatchUdpTransportMappingCrash() throws java.lang.Exception {
        org.apache.ambari.server.notifications.dispatchers.SNMPDispatcher dispatcher = org.mockito.Mockito.spy(new org.apache.ambari.server.notifications.dispatchers.SNMPDispatcher(org.apache.ambari.server.notifications.dispatchers.SNMPDispatcherTest.DEFAULT_SNMP_PORT));
    ...
    public void testPrepareTrap_v1() throws java.lang.Exception {
        ...
        org.junit.Assert.assertEquals("3", variableBindings.get(org.snmp4j.mp.SnmpConstants.snmpTrapOID.toString()).toValueString());
    }
    ...
    public void testPrepareTrap_v2c() throws java.lang.Exception {
        ...
        org.junit.Assert.assertEquals("subject", variableBindings.get("1").toValueString());
        org.junit.Assert.assertEquals("body", variableBindings.get("2").toValueString());
        org.junit.Assert.assertEquals("4", variableBindings.get(org.snmp4j.mp.SnmpConstants.snmpTrapOID.toString()).toValueString());
    }
    ...
    public void testSendTraps_v1() throws java.lang.Exception {
        ...
        org.apache.ambari.server.notifications.dispatchers.SNMPDispatcher dispatcher = org.mockito.Mockito.spy(new org.apache.ambari.server.notifications.dispatchers.SNMPDispatcher(snmp));
