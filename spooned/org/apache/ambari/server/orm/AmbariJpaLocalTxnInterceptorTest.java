...
public class AmbariJpaLocalTxnInterceptorTest extends org.easymock.EasyMockSupport {
    ...
    public void canBeCommittedIfExceptionsToBeRolledBackOnIsEmpty() {
        ...
        org.easymock.EasyMock.expect(transaction.getRollbackOnly()).andReturn(false);
        org.easymock.EasyMock.expect(transactional.rollbackOn()).andReturn(org.apache.ambari.server.orm.AmbariJpaLocalTxnInterceptorTest.asArray());
        replayAll();
    ...
    public void canBeCommittedIfUnknownExceptionThrown() {
        ...
        javax.persistence.EntityTransaction transaction = createStrictMock(javax.persistence.EntityTransaction.class);
        org.easymock.EasyMock.expect(transaction.getRollbackOnly()).andReturn(false);
        org.easymock.EasyMock.expect(transactional.rollbackOn()).andReturn(org.apache.ambari.server.orm.AmbariJpaLocalTxnInterceptorTest.asArray(java.lang.IllegalArgumentException.class));
        replayAll();
        boolean canCommit = org.apache.ambari.server.orm.AmbariJpaLocalTxnInterceptor.rollbackIfNecessary(transactional, new java.lang.RuntimeException(), transaction);
    ...
    public void rolledBackForKnownException() {
        ...
        javax.persistence.EntityTransaction transaction = createStrictMock(javax.persistence.EntityTransaction.class);
        org.easymock.EasyMock.expect(transaction.getRollbackOnly()).andReturn(false);
        org.easymock.EasyMock.expect(transactional.rollbackOn()).andReturn(org.apache.ambari.server.orm.AmbariJpaLocalTxnInterceptorTest.asArray(java.lang.NullPointerException.class, java.lang.IllegalArgumentException.class));
        org.easymock.EasyMock.expect(transactional.ignore()).andReturn(org.apache.ambari.server.orm.AmbariJpaLocalTxnInterceptorTest.asArray());
    ...
    public void rolledBackForSubclassOfKnownException() {
        ...
        javax.persistence.EntityTransaction transaction = createStrictMock(javax.persistence.EntityTransaction.class);
        org.easymock.EasyMock.expect(transaction.getRollbackOnly()).andReturn(false);
        org.easymock.EasyMock.expect(transactional.rollbackOn()).andReturn(org.apache.ambari.server.orm.AmbariJpaLocalTxnInterceptorTest.asArray(java.lang.RuntimeException.class));
        org.easymock.EasyMock.expect(transactional.ignore()).andReturn(org.apache.ambari.server.orm.AmbariJpaLocalTxnInterceptorTest.asArray());
        transaction.rollback();
        replayAll();
        boolean canCommit = org.apache.ambari.server.orm.AmbariJpaLocalTxnInterceptor.rollbackIfNecessary(transactional, new java.lang.IllegalArgumentException("rolling back"), transaction);
    ...
    public void canBeCommittedIfIgnoredExceptionThrown() {
        ...
        org.easymock.EasyMock.expect(transaction.getRollbackOnly()).andReturn(false);
        org.easymock.EasyMock.expect(transactional.rollbackOn()).andReturn(org.apache.ambari.server.orm.AmbariJpaLocalTxnInterceptorTest.asArray(java.lang.IllegalArgumentException.class));
        org.easymock.EasyMock.expect(transactional.ignore()).andReturn(org.apache.ambari.server.orm.AmbariJpaLocalTxnInterceptorTest.asArray(java.lang.NumberFormatException.class));
        replayAll();
    ...
    public void canBeCommittedIfSubclassOfIgnoredExceptionThrown() {
        ...
        javax.persistence.EntityTransaction transaction = createStrictMock(javax.persistence.EntityTransaction.class);
        org.easymock.EasyMock.expect(transaction.getRollbackOnly()).andReturn(false);
        org.easymock.EasyMock.expect(transactional.rollbackOn()).andReturn(org.apache.ambari.server.orm.AmbariJpaLocalTxnInterceptorTest.asArray(java.lang.Exception.class));
        org.easymock.EasyMock.expect(transactional.ignore()).andReturn(org.apache.ambari.server.orm.AmbariJpaLocalTxnInterceptorTest.asArray(java.io.IOException.class));
        replayAll();
    ...
    public void rolledBackIfTransactionMarkedRollbackOnly() {
        com.google.inject.persist.Transactional transactional = createNiceMock(com.google.inject.persist.Transactional.class);
        javax.persistence.EntityTransaction transaction = createStrictMock(javax.persistence.EntityTransaction.class);
        org.easymock.EasyMock.expect(transaction.getRollbackOnly()).andReturn(true);
        transaction.rollback();
        replayAll();
