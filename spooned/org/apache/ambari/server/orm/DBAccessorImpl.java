...
public class DBAccessorImpl implements org.apache.ambari.server.orm.DBAccessor {
    ...
    public DBAccessorImpl(org.apache.ambari.server.configuration.Configuration configuration) {
        ...
        try {
            ...
            java.lang.String vendorName = connection.getMetaData().getDatabaseProductName();
            java.lang.String majorVersion = java.lang.Integer.toString(connection.getMetaData().getDatabaseMajorVersion());
            java.lang.String minorVersion = java.lang.Integer.toString(connection.getMetaData().getDatabaseMinorVersion());
            java.lang.String dbPlatform = org.eclipse.persistence.internal.helper.DBPlatformHelper.getDBPlatform(vendorName, majorVersion, minorVersion, new org.eclipse.persistence.logging.AbstractSessionLog() {
                @java.lang.Override
