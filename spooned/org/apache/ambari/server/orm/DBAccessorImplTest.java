...
public class DBAccessorImplTest {
    ...
    public void escapesEnumValue() {
        org.eclipse.persistence.platform.database.DatabasePlatform platform = org.easymock.EasyMock.createNiceMock(org.eclipse.persistence.platform.database.DatabasePlatform.class);
        java.lang.Object value = org.apache.ambari.server.state.State.UNKNOWN;
        org.easymock.EasyMock.expect(platform.convertToDatabaseType(value)).andReturn(value).anyTimes();
        org.easymock.EasyMock.reset(platform);
