...
public class EclipseLinkSessionCustomizer implements org.eclipse.persistence.config.SessionCustomizer {
    ...
    public void customize(org.eclipse.persistence.sessions.Session session) throws java.lang.Exception {
        ...
        databaseLogin.setTransactionIsolation(org.eclipse.persistence.sessions.DatabaseLogin.TRANSACTION_READ_COMMITTED);
        java.lang.Object ddlGeneration = session.getProperty(org.eclipse.persistence.config.PersistenceUnitProperties.DDL_GENERATION);
        if ((null == ddlGeneration) || org.eclipse.persistence.config.PersistenceUnitProperties.NONE.equals(ddlGeneration)) {
