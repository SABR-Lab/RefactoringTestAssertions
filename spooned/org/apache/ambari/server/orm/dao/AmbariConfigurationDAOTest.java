...
public class AmbariConfigurationDAOTest extends org.easymock.EasyMockSupport {
    ...
    public void testReconcileCategoryNewCategory() throws java.lang.Exception {
        org.easymock.Capture<org.apache.ambari.server.orm.entities.AmbariConfigurationEntity> capturedEntities = org.easymock.EasyMock.newCapture(org.easymock.CaptureType.ALL);
        org.apache.ambari.server.orm.dao.AmbariConfigurationDAO dao = createDao();
        org.easymock.EasyMock.expect(dao.findByCategory(org.apache.ambari.server.orm.dao.AmbariConfigurationDAOTest.CATEGORY_NAME)).andReturn(null).once();
        dao.create(org.easymock.EasyMock.capture(capturedEntities));
    ...
    public void testReconcileCategoryReplaceCategory() throws java.lang.Exception {
        ...
        org.easymock.Capture<org.apache.ambari.server.orm.entities.AmbariConfigurationEntity> capturedCreatedEntities = org.easymock.EasyMock.newCapture(org.easymock.CaptureType.ALL);
        org.easymock.Capture<org.apache.ambari.server.orm.entities.AmbariConfigurationEntity> capturedRemovedEntities = org.easymock.EasyMock.newCapture(org.easymock.CaptureType.ALL);
        org.apache.ambari.server.orm.dao.AmbariConfigurationDAO dao = createDao();
        org.easymock.EasyMock.expect(dao.findByCategory(org.apache.ambari.server.orm.dao.AmbariConfigurationDAOTest.CATEGORY_NAME)).andReturn(toEntities(org.apache.ambari.server.orm.dao.AmbariConfigurationDAOTest.CATEGORY_NAME, existingProperties)).once();
        dao.remove(org.easymock.EasyMock.capture(capturedRemovedEntities));
        org.easymock.EasyMock.expectLastCall().anyTimes();
        dao.create(org.easymock.EasyMock.capture(capturedCreatedEntities));
        org.easymock.EasyMock.expectLastCall().anyTimes();
        replayAll();
    ...
    public void testReconcileCategoryUpdateCategoryKeepNotSpecified() throws java.lang.Exception {
        ...
        existingProperties.put("property2", "value2");
        org.easymock.Capture<org.apache.ambari.server.orm.entities.AmbariConfigurationEntity> capturedCreatedEntities = org.easymock.EasyMock.newCapture(org.easymock.CaptureType.ALL);
        org.easymock.Capture<org.apache.ambari.server.orm.entities.AmbariConfigurationEntity> capturedMergedEntities = org.easymock.EasyMock.newCapture(org.easymock.CaptureType.ALL);
        org.apache.ambari.server.orm.dao.AmbariConfigurationDAO dao = createDao();
        org.easymock.EasyMock.expect(dao.findByCategory(org.apache.ambari.server.orm.dao.AmbariConfigurationDAOTest.CATEGORY_NAME)).andReturn(toEntities(org.apache.ambari.server.orm.dao.AmbariConfigurationDAOTest.CATEGORY_NAME, existingProperties)).once();
        org.easymock.EasyMock.expect(dao.merge(org.easymock.EasyMock.capture(capturedMergedEntities))).andReturn(createNiceMock(org.apache.ambari.server.orm.entities.AmbariConfigurationEntity.class)).anyTimes();
        dao.create(org.easymock.EasyMock.capture(capturedCreatedEntities));
        org.easymock.EasyMock.expectLastCall().anyTimes();
        replayAll();
        java.util.Map<java.lang.String, java.lang.String> newProperties;
