...
public class UserDAOTest {
    ...
    public void init(org.apache.ambari.server.orm.entities.UserEntity userInDB) {
        final javax.persistence.EntityManager entityManager = org.easymock.EasyMock.createStrictMock(javax.persistence.EntityManager.class);
        final org.apache.ambari.server.orm.dao.DaoUtils daoUtils = org.easymock.EasyMock.createNiceMock(org.apache.ambari.server.orm.dao.DaoUtils.class);
        ...
        javax.persistence.TypedQuery<org.apache.ambari.server.orm.entities.UserEntity> userQuery = org.easymock.EasyMock.createNiceMock(javax.persistence.TypedQuery.class);
        org.easymock.EasyMock.expect(userQuery.getSingleResult()).andReturn(userInDB);
        org.easymock.EasyMock.expect(entityManager.createNamedQuery(org.easymock.EasyMock.anyString(), org.easymock.EasyMock.anyObject(java.lang.Class.class))).andReturn(userQuery);
        org.easymock.EasyMock.replay(entityManager, daoUtils, dbAccessor, userQuery);
    }
