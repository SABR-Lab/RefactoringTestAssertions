...
public class ViewEntityTest {
    ...
    public void testAddGetResourceProvider() throws java.lang.Exception {
        org.apache.ambari.server.orm.entities.ViewEntity viewDefinition = org.apache.ambari.server.orm.entities.ViewEntityTest.getViewEntity();
        org.apache.ambari.server.controller.spi.ResourceProvider provider1 = org.easymock.EasyMock.createNiceMock(org.apache.ambari.server.controller.spi.ResourceProvider.class);
        ...
        org.apache.ambari.server.controller.spi.ResourceProvider provider2 = org.easymock.EasyMock.createNiceMock(org.apache.ambari.server.controller.spi.ResourceProvider.class);
    ...
    public void testAddGetResourceDefinition() throws java.lang.Exception {
        org.apache.ambari.server.orm.entities.ViewEntity viewDefinition = org.apache.ambari.server.orm.entities.ViewEntityTest.getViewEntity();
        org.apache.ambari.server.view.ViewSubResourceDefinition definition = org.easymock.EasyMock.createNiceMock(org.apache.ambari.server.view.ViewSubResourceDefinition.class);
        ...
        org.easymock.EasyMock.expect(definition.getType()).andReturn(type);
        org.easymock.EasyMock.replay(definition);
        ...
        org.easymock.EasyMock.verify(definition);
    }
    ...
    public void testAddGetInstanceDefinition() throws java.lang.Exception {
        org.apache.ambari.server.orm.entities.ViewEntity viewDefinition = org.apache.ambari.server.orm.entities.ViewEntityTest.getViewEntity();
        org.apache.ambari.server.orm.entities.ViewInstanceEntity definition = org.easymock.EasyMock.createNiceMock(org.apache.ambari.server.orm.entities.ViewInstanceEntity.class);
        org.easymock.EasyMock.expect(definition.getName()).andReturn("instance1").anyTimes();
        org.easymock.EasyMock.replay(definition);
