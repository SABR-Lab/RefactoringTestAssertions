    ...
    private javax.ws.rs.core.Response handleRequest(java.lang.String requestType, javax.ws.rs.core.UriInfo ui, java.io.InputStream body, javax.ws.rs.core.HttpHeaders headers) {
        ...
        if ((query != null) && (query.indexOf(org.apache.ambari.server.proxy.ProxyService.QUERY_PARAMETER_URL) != (-1))) {
            ...
            if (m.containsKey(org.apache.ambari.server.view.ImpersonatorSettingImpl.DEFAULT_DO_AS_PARAM)) {
                ...
                return javax.ws.rs.core.Response.status(Response.Status.BAD_REQUEST.getStatusCode()).type(javax.ws.rs.core.MediaType.TEXT_PLAIN).entity(org.apache.ambari.server.proxy.ProxyService.INVALID_PARAM_IN_URL).build();
            }
            try {
                ...
                return javax.ws.rs.core.Response.status(Response.Status.BAD_REQUEST.getStatusCode()).type(javax.ws.rs.core.MediaType.TEXT_PLAIN).entity(e.getMessage()).build();
            }
        }
        return null;
    }
