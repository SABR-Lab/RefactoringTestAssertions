...
public class ExecutionScheduleManager {
    ...
    protected javax.ws.rs.client.Client ambariClient;

    protected javax.ws.rs.client.WebTarget ambariWebResource;
    ...
    protected void buildApiClient() throws java.security.NoSuchAlgorithmException, java.security.KeyManagementException {
        ...
        if (configuration.getApiSSLAuthentication()) {
            ...
            client = javax.ws.rs.client.ClientBuilder.newBuilder().sslContext(sc).withConfig(config).build();
        } else {
        ...
        javax.ws.rs.client.ClientRequestFilter csrfFilter = new org.glassfish.jersey.client.filter.CsrfProtectionFilter("RequestSchedule");
        javax.ws.rs.client.ClientRequestFilter tokenFilter = new org.apache.ambari.server.security.authorization.internal.InternalTokenClientFilter(tokenStorage);
    ...
    public void scheduleBatch(org.apache.ambari.server.state.scheduler.RequestExecution requestExecution, long startingBatchOrderId) throws org.apache.ambari.server.AmbariException {
        ...
        if (schedule != null) {
            ...
            org.quartz.Trigger trigger = org.quartz.TriggerBuilder.newTrigger().withIdentity((org.apache.ambari.server.scheduler.ExecutionScheduleManager.REQUEST_EXECUTION_TRIGGER_PREFIX + "-") + requestExecution.getId(), org.apache.ambari.server.scheduler.ExecutionJob.LINEAR_EXECUTION_TRIGGER_GROUP).withSchedule(org.quartz.CronScheduleBuilder.cronSchedule(triggerExpression).withMisfireHandlingInstructionFireAndProceed()).forJob(firstJobDetail).usingJobData(org.apache.ambari.server.state.scheduler.BatchRequestJob.BATCH_REQUEST_FAILED_TASKS_KEY, failedCount).startAt(startDate).endAt(endDate).build();
            try {
                executionScheduler.scheduleJob(trigger);
            ...
            org.quartz.Trigger trigger = org.quartz.TriggerBuilder.newTrigger().forJob(firstJobDetail).withIdentity((org.apache.ambari.server.scheduler.ExecutionScheduleManager.REQUEST_EXECUTION_TRIGGER_PREFIX + "-") + requestExecution.getId(), org.apache.ambari.server.scheduler.ExecutionJob.LINEAR_EXECUTION_TRIGGER_GROUP).withSchedule(org.quartz.SimpleScheduleBuilder.simpleSchedule().withMisfireHandlingInstructionFireNow()).usingJobData(org.apache.ambari.server.state.scheduler.BatchRequestJob.BATCH_REQUEST_FAILED_TASKS_KEY, failedCount).startNow().build();
            try {
                executionScheduler.scheduleJob(trigger);
                org.apache.ambari.server.scheduler.ExecutionScheduleManager.LOG.debug("Scheduled trigger next fire time: {}", trigger.getNextFireTime());
            } catch (org.quartz.SchedulerException e) {
    ...
    private org.apache.ambari.server.state.scheduler.BatchRequestResponse convertToBatchRequestResponse(javax.ws.rs.core.Response clientResponse) {
        ...
        java.lang.String responseString = ((java.lang.String) (clientResponse.getEntity()));
    ...
    protected org.apache.ambari.server.state.scheduler.BatchRequestResponse performUriRequest(java.lang.String url, java.lang.String body, java.lang.String method) {
        ...
        try {
            javax.ws.rs.client.WebTarget target = javax.ws.rs.client.ClientBuilder.newClient().target(url);
            javax.ws.rs.client.Invocation.Builder invocationBuilder = target.request();
            if (method.equalsIgnoreCase("GET")) {
                response = invocationBuilder.get();
            } else if (method.equalsIgnoreCase("POST")) {
                response = invocationBuilder.post(javax.ws.rs.client.Entity.entity(body, javax.ws.rs.core.MediaType.APPLICATION_JSON));
            } else if (method.equalsIgnoreCase("PUT")) {
                response = invocationBuilder.put(javax.ws.rs.client.Entity.entity(body, javax.ws.rs.core.MediaType.APPLICATION_JSON));
            } else if (method.equalsIgnoreCase("DELETE")) {
                response = invocationBuilder.delete();
            } else {
                throw new java.lang.IllegalArgumentException("Invalid HTTP method: " + method);
            }
        } catch (java.lang.Exception e) {
            response = null;
        }
    ...
    protected org.apache.ambari.server.state.scheduler.BatchRequestResponse performApiGetRequest(java.lang.String relativeUri, boolean queryAllFields) {
        ...
        javax.ws.rs.client.WebTarget target = client.target(relativeUri);
        if (queryAllFields) {
    ...
    protected org.apache.ambari.server.state.scheduler.BatchRequestResponse performApiRequest(java.lang.String relativeUri, java.lang.String body, java.lang.String method, java.lang.Integer userId) {
        ...
        javax.ws.rs.core.Response response;
        try {
            javax.ws.rs.client.Invocation.Builder invocationBuilder = target.request().header(org.apache.ambari.server.scheduler.ExecutionScheduleManager.USER_ID_HEADER, userId);
            if (method.equalsIgnoreCase("GET")) {
                response = invocationBuilder.get();
            } else if (method.equalsIgnoreCase("POST")) {
                response = invocationBuilder.post(javax.ws.rs.client.Entity.entity(body, javax.ws.rs.core.MediaType.APPLICATION_JSON));
    ...
    protected javax.ws.rs.client.WebTarget extendApiResource(javax.ws.rs.client.WebTarget webTarget, java.lang.String relativeUri) {
        javax.ws.rs.client.WebTarget result = webTarget;
        if (org.apache.commons.lang.StringUtils.isNotEmpty(relativeUri) && (!org.apache.ambari.server.scheduler.ExecutionScheduleManager.CONTAINS_API_VERSION_PATTERN.matcher(relativeUri).matches())) {
            result = webTarget.path(org.apache.ambari.server.scheduler.ExecutionScheduleManager.DEFAULT_API_PATH);
        }
