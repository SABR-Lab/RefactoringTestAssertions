...
public class AmbariLdapUtilsTest {
    ...
    public void testIsLdapObjectOutOfScopeFromBaseDn() throws javax.naming.NamingException {
        ...
        org.easymock.EasyMock.expect(adapter.getDn()).andReturn(fullDn);
        org.easymock.EasyMock.expect(adapter.getNameInNamespace()).andReturn(org.apache.ambari.server.security.AmbariLdapUtilsTest.USER_DN);
        org.easymock.EasyMock.replay(adapter);
        ...
        org.easymock.EasyMock.verify(adapter);
    }
    ...
    public void testGetFullDn() throws java.lang.Exception {
        org.springframework.ldap.core.DirContextAdapter adapterFullDn = org.easymock.EasyMock.createStrictMock(org.springframework.ldap.core.DirContextAdapter.class);
        org.easymock.EasyMock.expect(adapterFullDn.getNameInNamespace()).andReturn(org.apache.ambari.server.security.AmbariLdapUtilsTest.USER_DN).anyTimes();
        org.springframework.ldap.core.DirContextAdapter adapterBaseDn = org.easymock.EasyMock.createStrictMock(org.springframework.ldap.core.DirContextAdapter.class);
        org.easymock.EasyMock.expect(adapterBaseDn.getNameInNamespace()).andReturn(org.apache.ambari.server.security.AmbariLdapUtilsTest.USER_BASE_DN).anyTimes();
        ...
        org.easymock.EasyMock.replay(adapterFullDn, adapterBaseDn);
        ...
        org.easymock.EasyMock.verify(adapterFullDn, adapterBaseDn);
    }
}
