...
public class CertificateManagerTest extends org.easymock.EasyMockSupport {
    ...
    public void testSignAgentCrt() throws java.lang.Exception {
        ...
        org.easymock.EasyMock.expect(configuration.validateAgentHostnames()).andReturn(true).once();
        org.easymock.EasyMock.expect(configuration.getConfigsMap()).andReturn(configurationMap).anyTimes();
        ...
        org.easymock.EasyMock.expect(certificateManager.runCommand(expectedCommand)).andAnswer(new org.easymock.IAnswer<java.lang.Integer>() {
            @java.lang.Override
    ...
    public void testSignAgentCrtBadPassphrase() throws java.lang.Exception {
        ...
        org.apache.ambari.server.configuration.Configuration configuration = injector.getInstance(org.apache.ambari.server.configuration.Configuration.class);
        org.easymock.EasyMock.expect(configuration.validateAgentHostnames()).andReturn(true).once();
        org.easymock.EasyMock.expect(configuration.getConfigsMap()).andReturn(java.util.Collections.singletonMap(org.apache.ambari.server.configuration.Configuration.PASSPHRASE.getKey(), "some_passphrase")).once();
        replayAll();
        org.apache.ambari.server.security.CertificateManager certificateManager = new org.apache.ambari.server.security.CertificateManager();
        injector.injectMembers(certificateManager);
    ...
    public void testSignAgentCrtInvalidHostnameIgnoreBadPassphrase() throws java.lang.Exception {
        com.google.inject.Injector injector = getInjector();
        org.apache.ambari.server.configuration.Configuration configuration = injector.getInstance(org.apache.ambari.server.configuration.Configuration.class);
        org.easymock.EasyMock.expect(configuration.validateAgentHostnames()).andReturn(false).once();
        org.easymock.EasyMock.expect(configuration.getConfigsMap()).andReturn(java.util.Collections.singletonMap(org.apache.ambari.server.configuration.Configuration.PASSPHRASE.getKey(), "some_passphrase")).once();
        replayAll();
        org.apache.ambari.server.security.CertificateManager certificateManager = new org.apache.ambari.server.security.CertificateManager();
        injector.injectMembers(certificateManager);
    ...
    public void testGetCACertificateChain() throws java.io.IOException {
        ...
        org.apache.ambari.server.configuration.Configuration configuration = injector.getInstance(org.apache.ambari.server.configuration.Configuration.class);
        org.easymock.EasyMock.expect(configuration.getProperty(org.apache.ambari.server.configuration.Configuration.SRVR_KSTR_DIR)).andReturn(directory.getAbsolutePath()).anyTimes();
        org.easymock.EasyMock.expect(configuration.getProperty(org.apache.ambari.server.configuration.Configuration.SRVR_CRT_NAME)).andReturn(caCertFileName).anyTimes();
        org.easymock.EasyMock.expect(configuration.getProperty(org.apache.ambari.server.configuration.Configuration.SRVR_CRT_CHAIN_NAME)).andReturn(caCertChainFileName).anyTimes();
