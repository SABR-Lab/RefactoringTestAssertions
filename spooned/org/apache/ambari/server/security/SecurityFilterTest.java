...
public class SecurityFilterTest {
    ...
    private class MockModule implements com.google.inject.Module {
        ...
        public void configure(com.google.inject.Binder binder) {
            binder.bind(org.apache.ambari.server.state.stack.OsFamily.class).toInstance(org.easymock.EasyMock.createNiceMock(org.apache.ambari.server.state.stack.OsFamily.class));
        }
    }
}
