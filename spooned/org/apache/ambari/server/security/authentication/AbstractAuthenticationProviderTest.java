...
public abstract class AbstractAuthenticationProviderTest extends org.easymock.EasyMockSupport {
    ...
    public void testAuthenticationSuccess() {
        ...
        org.easymock.EasyMock.expect(users.getUserEntity(org.apache.ambari.server.security.authentication.AbstractAuthenticationProviderTest.TEST_USER_NAME)).andReturn(userEntity).atLeastOnce();
        org.easymock.EasyMock.expect(users.getUserAuthorities(userEntity)).andReturn(null).atLeastOnce();
    ...
    public void testAuthenticationWithIncorrectUserName() {
        ...
        org.apache.ambari.server.security.authorization.Users users = injector.getInstance(org.apache.ambari.server.security.authorization.Users.class);
        org.easymock.EasyMock.expect(users.getUserEntity(org.easymock.EasyMock.anyString())).andReturn(null).atLeastOnce();
        replayAll();
        org.springframework.security.authentication.AuthenticationProvider provider = getAuthenticationProvider(injector);
    ...
    public void testAuthenticationWithoutCredentials() {
        ...
        org.easymock.EasyMock.expect(authentication.getName()).andReturn(org.apache.ambari.server.security.authentication.AbstractAuthenticationProviderTest.TEST_USER_NAME).atLeastOnce();
        org.easymock.EasyMock.expect(authentication.getCredentials()).andReturn(null).atLeastOnce();
        replayAll();
        org.springframework.security.authentication.AuthenticationProvider provider = getAuthenticationProvider(injector);
        provider.authenticate(authentication);
    }
    ...
    protected com.google.inject.Injector getInjector() {
        ...
        return com.google.inject.Guice.createInjector(new com.google.inject.AbstractModule() {
            ...
            protected void configure() {
                ...
                org.easymock.EasyMock.expect(configuration.showLockedOutUserMessage()).andReturn(true).anyTimes();
