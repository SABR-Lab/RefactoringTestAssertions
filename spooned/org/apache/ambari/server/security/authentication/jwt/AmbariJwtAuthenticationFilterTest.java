...
public class AmbariJwtAuthenticationFilterTest extends org.easymock.EasyMockSupport {
    ...
    public void testGetJWTFromCookie() throws java.lang.Exception {
        ...
        org.easymock.EasyMock.expect(cookie.getName()).andReturn("non-default");
        org.easymock.EasyMock.expect(cookie.getValue()).andReturn("stubtokenstring");
        org.easymock.EasyMock.expect(request.getCookies()).andReturn(new javax.servlet.http.Cookie[]{ cookie });
        ...
        org.easymock.EasyMock.expect(jwtAuthenticationPropertiesProvider.get()).andReturn(createTestProperties()).anyTimes();
    ...
    public void testValidateNullAudiences() throws java.lang.Exception {
        org.apache.ambari.server.security.authentication.jwt.JwtAuthenticationPropertiesProvider jwtAuthenticationPropertiesProvider = createMock(org.apache.ambari.server.security.authentication.jwt.JwtAuthenticationPropertiesProvider.class);
        org.easymock.EasyMock.expect(jwtAuthenticationPropertiesProvider.get()).andReturn(createTestProperties(null)).anyTimes();
        org.apache.ambari.server.security.authentication.AmbariAuthenticationEventHandler eventHandler = createNiceMock(org.apache.ambari.server.security.authentication.AmbariAuthenticationEventHandler.class);
        replayAll();
        org.apache.ambari.server.security.authentication.jwt.AmbariJwtAuthenticationFilter filter = new org.apache.ambari.server.security.authentication.jwt.AmbariJwtAuthenticationFilter(null, jwtAuthenticationPropertiesProvider, null, eventHandler);
        org.junit.Assert.assertTrue(filter.validateAudiences(getSignedToken()));
    ...
    public void testShouldApplyTrue() throws com.nimbusds.jose.JOSEException {
        ...
        org.easymock.EasyMock.expect(cookie.getName()).andReturn("non-default").atLeastOnce();
        org.easymock.EasyMock.expect(cookie.getValue()).andReturn(token.serialize()).atLeastOnce();
    ...
    public void testShouldApplyTrueBadToken() throws com.nimbusds.jose.JOSEException {
        ...
        javax.servlet.http.Cookie cookie = createMock(javax.servlet.http.Cookie.class);
        org.easymock.EasyMock.expect(cookie.getName()).andReturn("non-default").atLeastOnce();
        org.easymock.EasyMock.expect(cookie.getValue()).andReturn("bad token").atLeastOnce();
        javax.servlet.http.HttpServletRequest request = createMock(javax.servlet.http.HttpServletRequest.class);
        org.easymock.EasyMock.expect(request.getCookies()).andReturn(new javax.servlet.http.Cookie[]{ cookie });
        org.apache.ambari.server.security.authentication.AmbariAuthenticationEventHandler eventHandler = createNiceMock(org.apache.ambari.server.security.authentication.AmbariAuthenticationEventHandler.class);
        replayAll();
    ...
    public void testShouldApplyFalseMissingCookie() throws com.nimbusds.jose.JOSEException {
        ...
        org.easymock.EasyMock.expect(jwtAuthenticationPropertiesProvider.get()).andReturn(createTestProperties()).anyTimes();
        javax.servlet.http.Cookie cookie = createMock(javax.servlet.http.Cookie.class);
        org.easymock.EasyMock.expect(cookie.getName()).andReturn("some-other-cookie").atLeastOnce();
        javax.servlet.http.HttpServletRequest request = createMock(javax.servlet.http.HttpServletRequest.class);
        org.easymock.EasyMock.expect(request.getCookies()).andReturn(new javax.servlet.http.Cookie[]{ cookie });
        org.apache.ambari.server.security.authentication.AmbariAuthenticationEventHandler eventHandler = createNiceMock(org.apache.ambari.server.security.authentication.AmbariAuthenticationEventHandler.class);
        replayAll();
    ...
    public void testShouldApplyFalseNotEnabled() throws com.nimbusds.jose.JOSEException {
        org.apache.ambari.server.security.authentication.jwt.JwtAuthenticationPropertiesProvider jwtAuthenticationPropertiesProvider = createMock(org.apache.ambari.server.security.authentication.jwt.JwtAuthenticationPropertiesProvider.class);
        org.easymock.EasyMock.expect(jwtAuthenticationPropertiesProvider.get()).andReturn(null).anyTimes();
        javax.servlet.http.HttpServletRequest request = createMock(javax.servlet.http.HttpServletRequest.class);
        org.apache.ambari.server.security.authentication.AmbariAuthenticationEventHandler eventHandler = createNiceMock(org.apache.ambari.server.security.authentication.AmbariAuthenticationEventHandler.class);
        replayAll();
        org.apache.ambari.server.security.authentication.jwt.AmbariJwtAuthenticationFilter filter = new org.apache.ambari.server.security.authentication.jwt.AmbariJwtAuthenticationFilter(null, jwtAuthenticationPropertiesProvider, null, eventHandler);
    ...
    public void testDoFilterSuccessful() throws java.lang.Exception {
        ...
        org.easymock.EasyMock.expect(configuration.getMaxAuthenticationFailures()).andReturn(10).anyTimes();
        javax.servlet.http.HttpServletRequest request = createMock(javax.servlet.http.HttpServletRequest.class);
        ...
        javax.servlet.http.Cookie cookie = createMock(javax.servlet.http.Cookie.class);
        org.easymock.EasyMock.expect(cookie.getName()).andReturn("non-default").once();
        org.easymock.EasyMock.expect(cookie.getValue()).andReturn(token.serialize()).once();
        org.easymock.EasyMock.expect(request.getCookies()).andReturn(new javax.servlet.http.Cookie[]{ cookie }).once();
        ...
        org.easymock.EasyMock.expect(userAuthenticationEntity.getAuthenticationType()).andReturn(org.apache.ambari.server.security.authorization.UserAuthenticationType.JWT).anyTimes();
        org.easymock.EasyMock.expect(userAuthenticationEntity.getAuthenticationKey()).andReturn("").anyTimes();
        ...
        org.easymock.EasyMock.expect(userEntity.getAuthenticationEntities()).andReturn(java.util.Collections.singletonList(userAuthenticationEntity)).atLeastOnce();
        ...
        org.easymock.EasyMock.expect(users.getUserEntity("test-user")).andReturn(userEntity).once();
        org.easymock.EasyMock.expect(users.getUser(userEntity)).andReturn(user).once();
        org.easymock.EasyMock.expect(user.getUserName()).andReturn("test-user").atLeastOnce();
        org.easymock.EasyMock.expect(users.getUserAuthorities(userEntity)).andReturn(java.util.Collections.emptyList()).once();
    ...
    public void testDoFilterUnsuccessful() throws java.lang.Exception {
        ...
        org.easymock.EasyMock.expect(request.getCookies()).andReturn(new javax.servlet.http.Cookie[]{ cookie }).once();
        org.apache.ambari.server.security.authorization.Users users = createMock(org.apache.ambari.server.security.authorization.Users.class);
        org.easymock.EasyMock.expect(users.getUserEntity("test-user")).andReturn(null).once();
        org.apache.ambari.server.security.authentication.AmbariAuthenticationEventHandler eventHandler = createNiceMock(org.apache.ambari.server.security.authentication.AmbariAuthenticationEventHandler.class);
        eventHandler.beforeAttemptAuthentication(org.easymock.EasyMock.capture(captureFilter), org.easymock.EasyMock.eq(request), org.easymock.EasyMock.eq(response));
        org.easymock.EasyMock.expectLastCall().once();
