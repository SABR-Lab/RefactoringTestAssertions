...
public class AmbariPamAuthenticationProviderTest extends org.easymock.EasyMockSupport {
    ...
    public void testBadCredential() throws java.lang.Exception {
        ...
        org.easymock.EasyMock.expect(pam.authenticate(org.easymock.EasyMock.eq(org.apache.ambari.server.security.authentication.pam.AmbariPamAuthenticationProviderTest.TEST_USER_NAME), org.easymock.EasyMock.eq(org.apache.ambari.server.security.authentication.pam.AmbariPamAuthenticationProviderTest.TEST_USER_INCORRECT_PASS))).andThrow(new org.jvnet.libpam.PAMException()).once();
        pam.dispose();
        ...
        org.easymock.EasyMock.expect(pamAuthenticationFactory.createInstance(injector.getInstance(org.apache.ambari.server.configuration.Configuration.class))).andReturn(pam).once();
        ...
        org.easymock.EasyMock.expect(users.getUserEntity(org.apache.ambari.server.security.authentication.pam.AmbariPamAuthenticationProviderTest.TEST_USER_NAME)).andReturn(null).once();
        replayAll();
    ...
    public void testAuthenticateExistingUser() throws java.lang.Exception {
        ...
        org.jvnet.libpam.PAM pam = createMock(org.jvnet.libpam.PAM.class);
        org.easymock.EasyMock.expect(pam.authenticate(org.easymock.EasyMock.eq(org.apache.ambari.server.security.authentication.pam.AmbariPamAuthenticationProviderTest.TEST_USER_NAME), org.easymock.EasyMock.eq(org.apache.ambari.server.security.authentication.pam.AmbariPamAuthenticationProviderTest.TEST_USER_PASS))).andReturn(unixUser).once();
        pam.dispose();
        org.easymock.EasyMock.expectLastCall().once();
        org.apache.ambari.server.security.authentication.pam.PamAuthenticationFactory pamAuthenticationFactory = injector.getInstance(org.apache.ambari.server.security.authentication.pam.PamAuthenticationFactory.class);
        org.easymock.EasyMock.expect(pamAuthenticationFactory.createInstance(injector.getInstance(org.apache.ambari.server.configuration.Configuration.class))).andReturn(pam).once();
        ...
        org.apache.ambari.server.security.authorization.Users users = injector.getInstance(org.apache.ambari.server.security.authorization.Users.class);
        org.easymock.EasyMock.expect(users.getUserEntity(org.apache.ambari.server.security.authentication.pam.AmbariPamAuthenticationProviderTest.TEST_USER_NAME)).andReturn(userEntity).once();
        org.easymock.EasyMock.expect(users.getUser(userEntity)).andReturn(new org.apache.ambari.server.security.authorization.User(userEntity)).once();
        org.easymock.EasyMock.expect(users.getUserAuthorities(userEntity)).andReturn(null).once();
        replayAll();
        org.springframework.security.core.Authentication authentication = new org.springframework.security.authentication.UsernamePasswordAuthenticationToken(org.apache.ambari.server.security.authentication.pam.AmbariPamAuthenticationProviderTest.TEST_USER_NAME, org.apache.ambari.server.security.authentication.pam.AmbariPamAuthenticationProviderTest.TEST_USER_PASS);
        org.apache.ambari.server.security.authentication.pam.AmbariPamAuthenticationProvider authenticationProvider = injector.getInstance(org.apache.ambari.server.security.authentication.pam.AmbariPamAuthenticationProvider.class);
    ...
    public void testAuthenticateNewUser() throws java.lang.Exception {
        org.jvnet.libpam.UnixUser unixUser = createNiceMock(org.jvnet.libpam.UnixUser.class);
        org.easymock.EasyMock.expect(unixUser.getUserName()).andReturn(org.apache.ambari.server.security.authentication.pam.AmbariPamAuthenticationProviderTest.TEST_USER_NAME.toLowerCase()).atLeastOnce();
        org.jvnet.libpam.PAM pam = createMock(org.jvnet.libpam.PAM.class);
        org.easymock.EasyMock.expect(pam.authenticate(org.easymock.EasyMock.eq(org.apache.ambari.server.security.authentication.pam.AmbariPamAuthenticationProviderTest.TEST_USER_NAME), org.easymock.EasyMock.eq(org.apache.ambari.server.security.authentication.pam.AmbariPamAuthenticationProviderTest.TEST_USER_PASS))).andReturn(unixUser).once();
        pam.dispose();
        org.easymock.EasyMock.expectLastCall().once();
