...
public class AmbariAuthorizationFilterTest {
    ...
    public void testDoFilter_NotLoggedIn_UseDefaultUser() throws java.lang.Exception {
        ...
        final javax.servlet.http.HttpServletResponse response = org.easymock.EasyMock.createNiceMock(javax.servlet.http.HttpServletResponse.class);
        final javax.servlet.http.HttpServletRequest request = org.easymock.EasyMock.createNiceMock(javax.servlet.http.HttpServletRequest.class);
        org.easymock.EasyMock.expect(request.getRequestURI()).andReturn("/uri").anyTimes();
        org.easymock.EasyMock.expect(request.getQueryString()).andReturn(null).anyTimes();
        org.easymock.EasyMock.expect(request.getMethod()).andReturn("GET").anyTimes();
        ...
        org.easymock.EasyMock.expect(configuration.getDefaultApiAuthenticatedUser()).andReturn("user1").once();
        ...
        org.easymock.EasyMock.expect(user.getUserName()).andReturn("user1").anyTimes();
        ...
        org.easymock.EasyMock.expect(users.getUser("user1")).andReturn(user).once();
        org.easymock.EasyMock.expect(users.getUserAuthorities("user1")).andReturn(java.util.Collections.<org.apache.ambari.server.security.authorization.AmbariGrantedAuthority>emptyList()).once();
        org.easymock.EasyMock.replay(request, response, chain, configuration, users, user);
    ...
    private void performGeneralDoFilterTest(org.springframework.security.core.Authentication authentication, com.google.common.collect.Table<java.lang.String, java.lang.String, java.lang.Boolean> urlTests, boolean expectRedirect) throws java.lang.Exception {
        ...
        final javax.servlet.FilterConfig filterConfig = org.easymock.EasyMock.createNiceMock(javax.servlet.FilterConfig.class);
        final org.apache.ambari.server.configuration.Configuration configuration = org.easymock.EasyMock.createMock(org.apache.ambari.server.configuration.Configuration.class);
        org.easymock.EasyMock.expect(configuration.getDefaultApiAuthenticatedUser()).andReturn(null).anyTimes();
        ...
        org.easymock.EasyMock.expect(auditLogger.isEnabled()).andReturn(false).anyTimes();
        final org.apache.ambari.server.security.authorization.AmbariAuthorizationFilter filter = org.easymock.EasyMock.createMockBuilder(org.apache.ambari.server.security.authorization.AmbariAuthorizationFilter.class).addMockedMethod("getSecurityContext").addMockedMethod("getViewRegistry").withConstructor(org.easymock.EasyMock.createNiceMock(org.apache.ambari.server.security.AmbariEntryPoint.class), configuration, org.easymock.EasyMock.createNiceMock(org.apache.ambari.server.security.authorization.Users.class), auditLogger, org.easymock.EasyMock.createNiceMock(org.apache.ambari.server.security.authorization.PermissionHelper.class)).createMock();
        final org.apache.ambari.server.view.ViewRegistry viewRegistry = org.easymock.EasyMock.createNiceMock(org.apache.ambari.server.view.ViewRegistry.class);
        org.easymock.EasyMock.expect(filterConfig.getInitParameter("realm")).andReturn("AuthFilter").anyTimes();
        org.easymock.EasyMock.expect(filter.getSecurityContext()).andReturn(org.springframework.security.core.context.SecurityContextHolder.getContext()).anyTimes();
        org.easymock.EasyMock.expect(filter.getViewRegistry()).andReturn(viewRegistry).anyTimes();
        org.easymock.EasyMock.expect(viewRegistry.checkPermission(org.easymock.EasyMock.eq("DeniedView"), org.easymock.EasyMock.anyObject(), org.easymock.EasyMock.anyObject(), org.easymock.EasyMock.anyBoolean())).andReturn(false).anyTimes();
        org.easymock.EasyMock.replay(filterConfig, filter, viewRegistry, configuration, auditLogger);
        for (final com.google.common.collect.Table.Cell<java.lang.String, java.lang.String, java.lang.Boolean> urlTest : urlTests.cellSet()) {
            ...
            org.easymock.EasyMock.expect(request.getRequestURI()).andReturn(URIParts[0]).anyTimes();
            org.easymock.EasyMock.expect(request.getQueryString()).andReturn(URIParts.length == 2 ? URIParts[1] : null).anyTimes();
            org.easymock.EasyMock.expect(request.getMethod()).andReturn(urlTest.getColumnKey()).anyTimes();
            if (expectRedirect) {
                ...
                org.easymock.EasyMock.expect(response.encodeRedirectURL(redirectURL)).andReturn(redirectURL);
            ...
            org.easymock.EasyMock.replay(request, response, chain);
            try {
                filter.doFilter(request, response, chain);
            ...
            try {
                org.easymock.EasyMock.verify(chain);
                if (expectRedirect) {
