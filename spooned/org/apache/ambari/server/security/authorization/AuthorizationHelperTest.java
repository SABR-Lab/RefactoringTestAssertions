...
public class AuthorizationHelperTest extends org.easymock.EasyMockSupport {
    ...
    public void testIsAuthorized() {
        ...
        org.easymock.EasyMock.expect(privilegeDAOProvider.get()).andReturn(privilegeDAO).anyTimes();
        replayAll();
    ...
    public void testAddLoginNameAlias() throws java.lang.Exception {
        org.easymock.EasyMock.reset(servletRequestAttributes);
        org.springframework.web.context.request.RequestContextHolder.setRequestAttributes(servletRequestAttributes);
        servletRequestAttributes.setAttribute(org.easymock.EasyMock.eq("loginAlias"), org.easymock.EasyMock.eq("user"), org.easymock.EasyMock.eq(org.springframework.web.context.request.RequestAttributes.SCOPE_SESSION));
        org.easymock.EasyMock.expectLastCall().once();
        org.easymock.EasyMock.replay(servletRequestAttributes);
        org.apache.ambari.server.security.authorization.AuthorizationHelper.addLoginNameAlias("user", "loginAlias");
        org.easymock.EasyMock.verify(servletRequestAttributes);
    }
    ...
    public void testResolveLoginAliasToUserName() throws java.lang.Exception {
        org.easymock.EasyMock.reset(servletRequestAttributes);
        org.springframework.web.context.request.RequestContextHolder.setRequestAttributes(servletRequestAttributes);
        org.easymock.EasyMock.expect(servletRequestAttributes.getAttribute(org.easymock.EasyMock.eq("loginAlias1"), org.easymock.EasyMock.eq(org.springframework.web.context.request.RequestAttributes.SCOPE_SESSION))).andReturn("user1").atLeastOnce();
        org.easymock.EasyMock.replay(servletRequestAttributes);
    ...
    public void testResolveNoLoginAliasToUserName() throws java.lang.Exception {
        ...
        org.springframework.web.context.request.RequestContextHolder.setRequestAttributes(servletRequestAttributes);
        org.easymock.EasyMock.expect(servletRequestAttributes.getAttribute(org.easymock.EasyMock.eq("nosuchalias"), org.easymock.EasyMock.eq(org.springframework.web.context.request.RequestAttributes.SCOPE_SESSION))).andReturn(null).atLeastOnce();
        org.easymock.EasyMock.replay(servletRequestAttributes);
