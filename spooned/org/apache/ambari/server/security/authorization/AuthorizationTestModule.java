...
public class AuthorizationTestModule extends com.google.inject.AbstractModule {
    @java.lang.Override
    protected void configure() {
        ...
        properties.setProperty(org.apache.ambari.server.configuration.AmbariServerConfigurationKey.GROUP_BASE.key(), "ou=groups,dc=ambari,dc=apache,dc=org");
        try {
