...
public class LdapServerPropertiesTest {
    ...
    public void testEquals() throws java.lang.Exception {
        nl.jqno.equalsverifier.api.SingleTypeEqualsVerifierApi<org.apache.ambari.server.security.authorization.LdapServerProperties> verifier = nl.jqno.equalsverifier.EqualsVerifier.forClass(org.apache.ambari.server.security.authorization.LdapServerProperties.class);
        verifier.suppress(nl.jqno.equalsverifier.Warning.NONFINAL_FIELDS);
        verifier.verify();
    }
