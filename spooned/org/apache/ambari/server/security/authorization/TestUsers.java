...
public class TestUsers {
    ...
    private void setAuthenticatedUser(org.apache.ambari.server.orm.entities.UserEntity userEntity) {
        ...
        org.springframework.security.core.Authentication auth = org.easymock.EasyMock.mock(org.springframework.security.core.Authentication.class);
        org.easymock.EasyMock.expect(auth.getPrincipal()).andReturn(principal).anyTimes();
        org.springframework.security.core.context.SecurityContext securityContext = org.easymock.EasyMock.mock(org.springframework.security.core.context.SecurityContext.class);
        org.easymock.EasyMock.expect(securityContext.getAuthentication()).andReturn(auth).anyTimes();
        org.easymock.EasyMock.replay(auth, securityContext);
