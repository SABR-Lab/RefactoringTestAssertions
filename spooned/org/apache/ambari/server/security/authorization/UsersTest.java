...
public class UsersTest extends org.easymock.EasyMockSupport {
    ...
    public void testGetUserAuthorities() throws java.lang.Exception {
        ...
        org.easymock.EasyMock.expect(userEntity.getPrincipal()).andReturn(userPrincipalEntity).times(1);
        org.apache.ambari.server.orm.dao.UserDAO userDAO = injector.getInstance(org.apache.ambari.server.orm.dao.UserDAO.class);
        org.easymock.EasyMock.expect(userDAO.findUserByName("user1")).andReturn(userEntity).times(1);
        ...
        org.easymock.EasyMock.expect(groupEntity.getPrincipal()).andReturn(groupPrincipalEntity).times(1);
        ...
        org.easymock.EasyMock.expect(memberEntity.getGroup()).andReturn(groupEntity).times(1);
        ...
        org.easymock.EasyMock.expect(memberDAO.findAllMembersByUser(userEntity)).andReturn(java.util.Collections.singletonList(memberEntity)).times(1);
        ...
        org.easymock.EasyMock.expect(clusterUserPrivilegePermissionEntity.getPrincipal()).andReturn(clusterUserPrivilegePermissionPrincipalEntity).times(1);
        ...
        org.easymock.EasyMock.expect(clusterUserPrivilegeEntity.getPermission()).andReturn(clusterUserPrivilegePermissionEntity).times(1);
        ...
        org.easymock.EasyMock.expect(clusterOperatorPrivilegePermissionEntity.getPrincipal()).andReturn(clusterOperatorPrivilegePermissionPrincipalEntity).times(1);
        ...
        org.easymock.EasyMock.expect(clusterOperatorPrivilegeEntity.getPermission()).andReturn(clusterOperatorPrivilegePermissionEntity).times(1);
        ...
        org.easymock.Capture<? extends java.util.List<org.apache.ambari.server.orm.entities.PrincipalEntity>> principalEntitiesCapture = org.easymock.EasyMock.newCapture();
        org.easymock.Capture<? extends java.util.List<org.apache.ambari.server.orm.entities.PrincipalEntity>> rolePrincipalEntitiesCapture = org.easymock.EasyMock.newCapture();
        ...
        org.easymock.EasyMock.expect(privilegeDAO.findAllByPrincipal(org.easymock.EasyMock.capture(principalEntitiesCapture))).andReturn(privilegeEntities).times(1);
        org.easymock.EasyMock.expect(privilegeDAO.findAllByPrincipal(org.easymock.EasyMock.capture(rolePrincipalEntitiesCapture))).andReturn(rolePrivilegeEntities).times(1);
        replayAll();
    ...
    org.apache.ambari.server.orm.entities.UserEntity existingUser) {
        ...
        org.easymock.EasyMock.expect(userDao.findUserByName(org.easymock.EasyMock.anyString())).andReturn(existingUser);
        userDao.create(org.easymock.EasyMock.anyObject(org.apache.ambari.server.orm.entities.UserEntity.class));
        ...
        org.easymock.EasyMock.expect(entityManager.find(org.easymock.EasyMock.eq(org.apache.ambari.server.orm.entities.PrincipalEntity.class), org.easymock.EasyMock.anyObject())).andReturn(null);
        replayAll();
    ...
    private org.apache.ambari.server.orm.entities.UserAuthenticationEntity initForModifyAuthentication() {
        ...
        org.easymock.EasyMock.expect(manager.merge(userEntity)).andReturn(userEntity).once();
        ...
        org.easymock.EasyMock.expect(dao.findByPK(org.easymock.EasyMock.anyInt())).andReturn(admin).anyTimes();
    ...
    private void createInjector(final org.apache.ambari.server.orm.dao.UserDAO mockUserDao, final javax.persistence.EntityManager mockEntityManager) {
        injector = com.google.inject.Guice.createInjector(new com.google.inject.AbstractModule() {
            ...
            protected void configure() {
                ...
                org.easymock.EasyMock.expect(nopEncoder.matches(org.easymock.EasyMock.anyString(), org.easymock.EasyMock.anyString())).andAnswer(() -> java.util.Objects.equals(org.easymock.EasyMock.getCurrentArguments()[0], org.easymock.EasyMock.getCurrentArguments()[1])).anyTimes();
                org.easymock.EasyMock.expect(nopEncoder.encode(org.easymock.EasyMock.anyString())).andAnswer(() -> ((java.lang.String) (org.easymock.EasyMock.getCurrentArguments()[0]))).anyTimes();
                ...
                org.easymock.EasyMock.expect(noConfig.getPasswordPolicyHistoryCount()).andReturn(3).anyTimes();
                org.easymock.EasyMock.expect(noConfig.getPasswordPolicyRegexp()).andReturn(".*").anyTimes();
