...
public class SensitiveDataEncryptionTest {
    ...
    public void testSensitiveDataEncryption() throws java.lang.Exception {
        ...
        org.easymock.EasyMock.expect(mockClusters.getClusters()).andReturn(clusters).once();
        ...
        configs.add(config);
        org.easymock.EasyMock.expect(cluster.getAllConfigs()).andReturn(configs).once();
