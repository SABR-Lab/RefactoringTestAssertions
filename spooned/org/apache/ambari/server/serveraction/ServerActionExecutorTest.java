...
public class ServerActionExecutorTest {
    ...
    public void testServerActionManualStage() throws java.lang.Exception {
        final org.apache.ambari.server.actionmanager.Request request = createMockRequest();
        org.apache.ambari.server.serveraction.ServerActionExecutorTest.stageFactory = org.easymock.EasyMock.createNiceMock(org.apache.ambari.server.actionmanager.StageFactory.class);
    ...
    private org.apache.ambari.server.actionmanager.Request createMockRequest() {
        org.apache.ambari.server.actionmanager.Request request = org.mockito.Mockito.mock(org.apache.ambari.server.actionmanager.Request.class);
        org.mockito.Mockito.when(request.isExclusive()).thenReturn(false);
        org.mockito.Mockito.when(request.getRequestId()).thenReturn(1L);
        return request;
    }
    ...
    private org.apache.ambari.server.actionmanager.ActionDBAccessor createMockActionDBAccessor(final org.apache.ambari.server.actionmanager.Request request, final java.util.List<org.apache.ambari.server.actionmanager.Stage> stages) {
        ...
        org.mockito.Mockito.doAnswer(new org.mockito.stubbing.Answer() {
            @java.lang.Override
        ...
        }).when(db).getRequestsByStatus(org.mockito.Matchers.any(org.apache.ambari.server.actionmanager.RequestStatus.class), org.easymock.EasyMock.anyInt(), org.easymock.EasyMock.anyBoolean());
        org.mockito.Mockito.doAnswer(new org.mockito.stubbing.Answer() {
            @java.lang.Override
            public java.lang.Object answer(org.mockito.invocation.InvocationOnMock invocation) throws java.lang.Throwable {
        ...
        }).when(db).updateHostRoleState(org.mockito.Matchers.anyString(), org.easymock.EasyMock.anyLong(), org.easymock.EasyMock.anyLong(), org.mockito.Matchers.anyString(), org.mockito.Matchers.any(org.apache.ambari.server.agent.CommandReport.class));
        org.mockito.Mockito.doAnswer(new org.mockito.stubbing.Answer() {
            @java.lang.Override
            public java.lang.Object answer(org.mockito.invocation.InvocationOnMock invocation) throws java.lang.Throwable {
                java.lang.String host = ((java.lang.String) (invocation.getArguments()[0]));
        ...
        }).when(db).getTasksByHostRoleAndStatus(org.mockito.Matchers.anyString(), org.mockito.Matchers.anyString(), org.mockito.Matchers.any(org.apache.ambari.server.actionmanager.HostRoleStatus.class));
        return db;
    }
    ...
    private static org.apache.ambari.server.actionmanager.Stage getStageWithServerAction(final long requestId, final long stageId, final java.util.Map<java.lang.String, java.lang.String> payload, final java.lang.String requestContext, final int timeout) {
        org.apache.ambari.server.serveraction.ServerActionExecutorTest.stageFactory = org.easymock.EasyMock.createNiceMock(org.apache.ambari.server.actionmanager.StageFactory.class);
        org.easymock.EasyMock.expect(org.apache.ambari.server.serveraction.ServerActionExecutorTest.stageFactory.createNew(org.easymock.EasyMock.anyLong(), org.easymock.EasyMock.anyObject(java.lang.String.class), org.easymock.EasyMock.anyObject(java.lang.String.class), org.easymock.EasyMock.anyLong(), org.easymock.EasyMock.anyObject(java.lang.String.class), org.easymock.EasyMock.anyObject(java.lang.String.class), org.easymock.EasyMock.anyObject(java.lang.String.class))).andAnswer(new org.easymock.IAnswer<org.apache.ambari.server.actionmanager.Stage>() {
            @java.lang.Override
