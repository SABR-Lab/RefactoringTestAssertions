...
public class ADKerberosOperationHandlerTest extends org.apache.ambari.server.serveraction.kerberos.KerberosOperationHandlerTest {
    ...
    public void testTestAdministratorCredentialsIncorrectAdminPassword() throws java.lang.Exception {
        ...
        org.easymock.EasyMock.expect(handler.createInitialLdapContext(org.easymock.EasyMock.anyObject(java.util.Properties.class), org.easymock.EasyMock.anyObject(javax.naming.ldap.Control[].class))).andAnswer(new org.easymock.IAnswer<javax.naming.ldap.LdapContext>() {
            @java.lang.Override
    ...
    public void testTestAdministratorCredentialsSuccess() throws java.lang.Exception {
        ...
        org.easymock.EasyMock.expect(handler.createInitialLdapContext(org.easymock.EasyMock.anyObject(java.util.Properties.class), org.easymock.EasyMock.anyObject(javax.naming.ldap.Control[].class))).andAnswer(new org.easymock.IAnswer<javax.naming.ldap.LdapContext>() {
            ...
            public javax.naming.ldap.LdapContext answer() throws java.lang.Throwable {
                ...
                org.easymock.EasyMock.expect(ldapContext.search(org.easymock.EasyMock.anyObject(java.lang.String.class), org.easymock.EasyMock.anyObject(java.lang.String.class), org.easymock.EasyMock.anyObject(javax.naming.directory.SearchControls.class))).andAnswer(new org.easymock.IAnswer<javax.naming.NamingEnumeration<javax.naming.directory.SearchResult>>() {
                    @java.lang.Override
                    public javax.naming.NamingEnumeration<javax.naming.directory.SearchResult> answer() throws java.lang.Throwable {
                        ...
                        org.easymock.EasyMock.expect(result.hasMore()).andReturn(false).once();
                        org.easymock.EasyMock.replay(result);
                        return result;
                    }
                }).once();
                return ldapContext;
    ...
    public void testProcessCreateTemplateDefault() throws java.lang.Exception {
        com.google.inject.Injector injector = getInjector();
        org.apache.ambari.server.security.credential.PrincipalKeyCredential kc = new org.apache.ambari.server.security.credential.PrincipalKeyCredential(org.apache.ambari.server.serveraction.kerberos.ADKerberosOperationHandlerTest.DEFAULT_ADMIN_PRINCIPAL, org.apache.ambari.server.serveraction.kerberos.ADKerberosOperationHandlerTest.DEFAULT_ADMIN_PASSWORD);
        org.easymock.Capture<javax.naming.Name> capturedName = org.easymock.EasyMock.newCapture(org.easymock.CaptureType.ALL);
        org.easymock.Capture<javax.naming.directory.Attributes> capturedAttributes = org.easymock.EasyMock.newCapture(org.easymock.CaptureType.ALL);
        ...
        org.easymock.EasyMock.expect(searchResult.hasMore()).andReturn(false).once();
        javax.naming.ldap.LdapContext ldapContext = createNiceMock(javax.naming.ldap.LdapContext.class);
        org.easymock.EasyMock.expect(ldapContext.search(org.easymock.EasyMock.anyObject(java.lang.String.class), org.easymock.EasyMock.anyObject(java.lang.String.class), org.easymock.EasyMock.anyObject(javax.naming.directory.SearchControls.class))).andReturn(searchResult).once();
        org.easymock.EasyMock.expect(ldapContext.createSubcontext(org.easymock.EasyMock.capture(capturedName), org.easymock.EasyMock.capture(capturedAttributes))).andReturn(createNiceMock(javax.naming.directory.DirContext.class)).anyTimes();
        org.easymock.EasyMock.expect(handler.createInitialLdapContext(org.easymock.EasyMock.anyObject(java.util.Properties.class), org.easymock.EasyMock.anyObject(javax.naming.ldap.Control[].class))).andReturn(ldapContext).once();
        org.easymock.EasyMock.expect(handler.createSearchControls()).andAnswer(new org.easymock.IAnswer<javax.naming.directory.SearchControls>() {
            @java.lang.Override
            public javax.naming.directory.SearchControls answer() throws java.lang.Throwable {
                ...
                org.easymock.EasyMock.replay(searchControls);
    ...
    public void testProcessCreateTemplateCustom() throws java.lang.Exception {
        ...
        org.easymock.Capture<javax.naming.Name> capturedName = org.easymock.EasyMock.newCapture();
        org.easymock.Capture<javax.naming.directory.Attributes> capturedAttributes = org.easymock.EasyMock.newCapture();
        org.apache.ambari.server.serveraction.kerberos.ADKerberosOperationHandler handler = createMockBuilder(org.apache.ambari.server.serveraction.kerberos.ADKerberosOperationHandler.class).addMockedMethod(org.apache.ambari.server.serveraction.kerberos.ADKerberosOperationHandler.class.getDeclaredMethod("createInitialLdapContext", java.util.Properties.class, javax.naming.ldap.Control[].class)).addMockedMethod(org.apache.ambari.server.serveraction.kerberos.ADKerberosOperationHandler.class.getDeclaredMethod("createSearchControls")).createNiceMock();
        injector.injectMembers(handler);
        @java.lang.SuppressWarnings("unchecked")
        javax.naming.NamingEnumeration<javax.naming.directory.SearchResult> searchResult = createNiceMock(javax.naming.NamingEnumeration.class);
        ...
        javax.naming.ldap.LdapContext ldapContext = createNiceMock(javax.naming.ldap.LdapContext.class);
        org.easymock.EasyMock.expect(ldapContext.search(org.easymock.EasyMock.anyObject(java.lang.String.class), org.easymock.EasyMock.anyObject(java.lang.String.class), org.easymock.EasyMock.anyObject(javax.naming.directory.SearchControls.class))).andReturn(searchResult).once();
        org.easymock.EasyMock.expect(ldapContext.createSubcontext(org.easymock.EasyMock.capture(capturedName), org.easymock.EasyMock.capture(capturedAttributes))).andReturn(createNiceMock(javax.naming.directory.DirContext.class)).once();
        org.easymock.EasyMock.expect(handler.createInitialLdapContext(org.easymock.EasyMock.anyObject(java.util.Properties.class), org.easymock.EasyMock.anyObject(javax.naming.ldap.Control[].class))).andReturn(ldapContext).once();
        org.easymock.EasyMock.expect(handler.createSearchControls()).andAnswer(new org.easymock.IAnswer<javax.naming.directory.SearchControls>() {
            @java.lang.Override
            public javax.naming.directory.SearchControls answer() throws java.lang.Throwable {
    ...
    public void testDigests() throws java.lang.Exception {
        ...
        javax.naming.ldap.LdapContext ldapContext = createNiceMock(javax.naming.ldap.LdapContext.class);
        org.easymock.EasyMock.expect(ldapContext.search(org.easymock.EasyMock.anyObject(java.lang.String.class), org.easymock.EasyMock.anyObject(java.lang.String.class), org.easymock.EasyMock.anyObject(javax.naming.directory.SearchControls.class))).andReturn(searchResult).once();
        org.easymock.EasyMock.expect(ldapContext.createSubcontext(org.easymock.EasyMock.anyObject(javax.naming.Name.class), org.easymock.EasyMock.capture(capturedAttributes))).andReturn(createNiceMock(javax.naming.directory.DirContext.class)).once();
        org.easymock.EasyMock.expect(handler.createInitialLdapContext(org.easymock.EasyMock.anyObject(java.util.Properties.class), org.easymock.EasyMock.anyObject(javax.naming.ldap.Control[].class))).andReturn(ldapContext).once();
        org.easymock.EasyMock.expect(handler.createSearchControls()).andAnswer(new org.easymock.IAnswer<javax.naming.directory.SearchControls>() {
            @java.lang.Override
            public javax.naming.directory.SearchControls answer() throws java.lang.Throwable {
    ...
    private void testCreateLdapContextSSLSocketFactory(boolean trusting) throws java.lang.Exception {
        ...
        org.easymock.EasyMock.expect(configuration.validateKerberosOperationSSLCertTrust()).andReturn(!trusting).once();
        javax.naming.ldap.LdapContext initialContext = createNiceMock(javax.naming.ldap.LdapContext.class);
        org.easymock.Capture<? extends java.util.Properties> capturedProperties = org.easymock.EasyMock.newCapture(org.easymock.CaptureType.FIRST);
        org.apache.ambari.server.serveraction.kerberos.ADKerberosOperationHandler handler = createMockBuilder(org.apache.ambari.server.serveraction.kerberos.ADKerberosOperationHandler.class).addMockedMethod(org.apache.ambari.server.serveraction.kerberos.ADKerberosOperationHandler.class.getDeclaredMethod("createInitialLdapContext", java.util.Properties.class, javax.naming.ldap.Control[].class)).createNiceMock();
        injector.injectMembers(handler);
        org.easymock.EasyMock.expect(handler.createInitialLdapContext(org.easymock.EasyMock.capture(capturedProperties), org.easymock.EasyMock.anyObject(javax.naming.ldap.Control[].class))).andReturn(initialContext).once();
        replayAll();
    ...
    protected void setupOpenSuccess(org.apache.ambari.server.serveraction.kerberos.KerberosOperationHandler handler) throws java.lang.Exception {
        ...
        org.easymock.EasyMock.expect(adHandler.createInitialLdapContext(org.easymock.EasyMock.anyObject(java.util.Properties.class), org.easymock.EasyMock.isNull())).andReturn(ldapContext).anyTimes();
    }
    ...
    protected void setupOpenFailure(org.apache.ambari.server.serveraction.kerberos.KerberosOperationHandler handler) throws java.lang.Exception {
        org.apache.ambari.server.serveraction.kerberos.ADKerberosOperationHandler adHandler = ((org.apache.ambari.server.serveraction.kerberos.ADKerberosOperationHandler) (handler));
        org.easymock.EasyMock.expect(adHandler.createInitialLdapContext(org.easymock.EasyMock.anyObject(java.util.Properties.class), org.easymock.EasyMock.isNull())).andThrow(new javax.naming.AuthenticationException("Bogus error!")).anyTimes();
    }
    ...
    protected void setupPrincipalDoesNotExist(org.apache.ambari.server.serveraction.kerberos.KerberosOperationHandler handler, boolean service) throws java.lang.Exception {
        ...
        org.easymock.EasyMock.expect(results.hasMore()).andReturn(false).anyTimes();
        org.easymock.EasyMock.expect(ldapContext.search(org.easymock.EasyMock.anyObject(javax.naming.Name.class), org.easymock.EasyMock.anyString(), org.easymock.EasyMock.anyObject(javax.naming.directory.SearchControls.class))).andReturn(results).anyTimes();
        ldapContext.close();
        org.easymock.EasyMock.expectLastCall().once();
    }
    ...
    protected void setupPrincipalExists(org.apache.ambari.server.serveraction.kerberos.KerberosOperationHandler handler, boolean service) throws java.lang.Exception {
        ...
        org.easymock.EasyMock.expect(result.getNameInNamespace()).andReturn("user/service dn").anyTimes();
        javax.naming.NamingEnumeration<javax.naming.directory.SearchResult> results = createMock(javax.naming.NamingEnumeration.class);
        results.close();
        org.easymock.EasyMock.expectLastCall().anyTimes();
        org.easymock.EasyMock.expect(results.hasMore()).andReturn(true).once();
        org.easymock.EasyMock.expect(results.next()).andReturn(result).once();
        org.easymock.EasyMock.expect(results.hasMore()).andReturn(false).anyTimes();
        org.easymock.EasyMock.expect(ldapContext.search(org.easymock.EasyMock.anyObject(javax.naming.Name.class), org.easymock.EasyMock.anyString(), org.easymock.EasyMock.anyObject(javax.naming.directory.SearchControls.class))).andReturn(results).anyTimes();
        ldapContext.close();
        org.easymock.EasyMock.expectLastCall().once();
