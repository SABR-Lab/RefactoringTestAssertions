...
public class AbstractPrepareKerberosServerActionTest extends org.easymock.EasyMockSupport {
    ...
    public void testProcessServiceComponentHosts() throws java.lang.Exception {
        ...
        org.easymock.EasyMock.expect(kerberosIdentityDataFileWriterFactory.createKerberosIdentityDataFileWriter(org.easymock.EasyMock.anyObject(java.io.File.class))).andReturn(kerberosIdentityDataFileWriter);
        org.easymock.EasyMock.expect(cluster.getServices()).andReturn(new java.util.HashMap<>(clusterServices)).atLeastOnce();
        org.easymock.EasyMock.expect(serviceComponentHostHDFS.getHostName()).andReturn(hostName).atLeastOnce();
        org.easymock.EasyMock.expect(serviceComponentHostHDFS.getServiceName()).andReturn(hdfsService).atLeastOnce();
        org.easymock.EasyMock.expect(serviceComponentHostHDFS.getServiceComponentName()).andReturn(hdfsComponent).atLeastOnce();
        org.easymock.EasyMock.expect(serviceComponentHostHDFS.getHost()).andReturn(createNiceMock(org.apache.ambari.server.state.Host.class)).atLeastOnce();
        org.easymock.EasyMock.expect(serviceComponentHostZK.getHostName()).andReturn(hostName).atLeastOnce();
        org.easymock.EasyMock.expect(serviceComponentHostZK.getServiceName()).andReturn(zookeeperService).atLeastOnce();
        org.easymock.EasyMock.expect(serviceComponentHostZK.getServiceComponentName()).andReturn(zkComponent).atLeastOnce();
        org.easymock.EasyMock.expect(serviceComponentHostZK.getHost()).andReturn(createNiceMock(org.apache.ambari.server.state.Host.class)).atLeastOnce();
        org.easymock.EasyMock.expect(kerberosDescriptor.getService(hdfsService)).andReturn(serviceDescriptor).once();
        org.easymock.EasyMock.expect(serviceDescriptor.getComponent(hdfsComponent)).andReturn(componentDescriptor).once();
        org.easymock.EasyMock.expect(componentDescriptor.getConfigurations(org.easymock.EasyMock.anyBoolean())).andReturn(null);
        replayAll();
    ...
    public void testProcessConfigurationChanges() throws java.lang.Exception {
        ...
        org.easymock.EasyMock.expect(configHelper.getEffectiveConfigProperties(org.easymock.EasyMock.eq("c1"), org.easymock.EasyMock.eq(null))).andReturn(effectiveProperties).anyTimes();
    ...
    private org.apache.ambari.server.serveraction.kerberos.AbstractPrepareKerberosServerActionTest.ConfigWriterData setupConfigWriter(org.apache.ambari.server.serveraction.kerberos.KerberosConfigDataFileWriterFactory factory) throws java.io.IOException {
        org.easymock.Capture<java.lang.String> captureConfigType = org.easymock.EasyMock.newCapture(org.easymock.CaptureType.ALL);
        org.easymock.Capture<java.lang.String> capturePropertyName = org.easymock.EasyMock.newCapture(org.easymock.CaptureType.ALL);
        org.easymock.Capture<java.lang.String> capturePropertyValue = org.easymock.EasyMock.newCapture(org.easymock.CaptureType.ALL);
        ...
        mockWriter.addRecord(org.easymock.EasyMock.capture(captureConfigType), org.easymock.EasyMock.capture(capturePropertyName), org.easymock.EasyMock.capture(capturePropertyValue), org.easymock.EasyMock.eq(org.apache.ambari.server.serveraction.kerberos.KerberosConfigDataFileWriter.OPERATION_TYPE_SET));
        org.easymock.EasyMock.expectLastCall().anyTimes();
        mockWriter.close();
        org.easymock.EasyMock.expectLastCall().anyTimes();
        org.easymock.EasyMock.expect(factory.createKerberosConfigDataFileWriter(org.easymock.EasyMock.anyObject(java.io.File.class))).andReturn(mockWriter).once();
