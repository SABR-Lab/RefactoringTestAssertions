...
public abstract class KDCKerberosOperationHandlerTest extends org.apache.ambari.server.serveraction.kerberos.KerberosOperationHandlerTest {
    ...
    protected org.apache.ambari.server.serveraction.kerberos.KerberosOperationHandler createMockedHandler() throws org.apache.ambari.server.serveraction.kerberos.KerberosOperationException {
        ...
        org.easymock.EasyMock.expect(handler.getExecutable(org.easymock.EasyMock.anyString())).andAnswer(new org.easymock.IAnswer<java.lang.String>() {
            @java.lang.Override
    ...
    protected void setupOpenSuccess(org.apache.ambari.server.serveraction.kerberos.KerberosOperationHandler handler) throws java.lang.Exception {
        ...
        org.easymock.EasyMock.expect(result.isSuccessful()).andReturn(true);
        org.easymock.EasyMock.expect(handler.executeCommand(org.apache.ambari.server.serveraction.kerberos.KDCKerberosOperationHandlerTest.arrayContains("kinit"), org.easymock.EasyMock.anyObject(java.util.Map.class), org.easymock.EasyMock.anyObject(org.apache.ambari.server.serveraction.kerberos.KDCKerberosOperationHandler.InteractivePasswordHandler.class))).andReturn(result).anyTimes();
    }
    ...
    protected void setupOpenFailure(org.apache.ambari.server.serveraction.kerberos.KerberosOperationHandler handler) throws java.lang.Exception {
        org.apache.ambari.server.utils.ShellCommandUtil.Result result = createMock(org.apache.ambari.server.utils.ShellCommandUtil.Result.class);
        org.easymock.EasyMock.expect(result.isSuccessful()).andReturn(false).once();
        org.easymock.EasyMock.expect(result.getExitCode()).andReturn(-1).once();
        org.easymock.EasyMock.expect(result.getStdout()).andReturn("STDOUT data").once();
        org.easymock.EasyMock.expect(result.getStderr()).andReturn("STDERR data").once();
        org.easymock.EasyMock.expect(handler.executeCommand(org.apache.ambari.server.serveraction.kerberos.KDCKerberosOperationHandlerTest.arrayContains("kinit"), org.easymock.EasyMock.anyObject(java.util.Map.class), org.easymock.EasyMock.anyObject(org.apache.ambari.server.serveraction.kerberos.KDCKerberosOperationHandler.InteractivePasswordHandler.class))).andReturn(result).anyTimes();
    }
