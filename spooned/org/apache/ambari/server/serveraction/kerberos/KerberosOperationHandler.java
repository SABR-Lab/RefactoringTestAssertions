...
public abstract class KerberosOperationHandler {
    ...
    private static final java.util.Map<java.lang.String, java.util.Set<org.apache.directory.shared.kerberos.codec.types.EncryptionType>> ENCRYPTION_TYPE_TRANSLATION_MAP = java.util.Collections.unmodifiableMap(new java.util.HashMap<java.lang.String, java.util.Set<org.apache.directory.shared.kerberos.codec.types.EncryptionType>>() {
        {
            put("aes", java.util.EnumSet.of(org.apache.directory.shared.kerberos.codec.types.EncryptionType.AES256_CTS_HMAC_SHA1_96, org.apache.directory.shared.kerberos.codec.types.EncryptionType.AES128_CTS_HMAC_SHA1_96));
            put("aes256-cts-hmac-sha1-96", java.util.EnumSet.of(org.apache.directory.shared.kerberos.codec.types.EncryptionType.AES256_CTS_HMAC_SHA1_96));
            put("aes256-cts", java.util.EnumSet.of(org.apache.directory.shared.kerberos.codec.types.EncryptionType.AES256_CTS_HMAC_SHA1_96));
            put("aes-256", java.util.EnumSet.of(org.apache.directory.shared.kerberos.codec.types.EncryptionType.AES256_CTS_HMAC_SHA1_96));
            put("aes128-cts-hmac-sha1-96", java.util.EnumSet.of(org.apache.directory.shared.kerberos.codec.types.EncryptionType.AES128_CTS_HMAC_SHA1_96));
            put("aes128-cts", java.util.EnumSet.of(org.apache.directory.shared.kerberos.codec.types.EncryptionType.AES128_CTS_HMAC_SHA1_96));
            put("aes-128", java.util.EnumSet.of(org.apache.directory.shared.kerberos.codec.types.EncryptionType.AES128_CTS_HMAC_SHA1_96));
            put("rc4", java.util.EnumSet.of(org.apache.directory.shared.kerberos.codec.types.EncryptionType.RC4_HMAC));
            put("arcfour-hmac", java.util.EnumSet.of(org.apache.directory.shared.kerberos.codec.types.EncryptionType.RC4_HMAC));
            put("rc4-hmac", java.util.EnumSet.of(org.apache.directory.shared.kerberos.codec.types.EncryptionType.RC4_HMAC));
            put("arcfour-hmac-md5", java.util.EnumSet.of(org.apache.directory.shared.kerberos.codec.types.EncryptionType.UNKNOWN));
            put("arcfour-hmac-exp", java.util.EnumSet.of(org.apache.directory.shared.kerberos.codec.types.EncryptionType.RC4_HMAC_EXP));
            put("rc4-hmac-exp", java.util.EnumSet.of(org.apache.directory.shared.kerberos.codec.types.EncryptionType.RC4_HMAC_EXP));
            put("arcfour-hmac-md5-exp", java.util.EnumSet.of(org.apache.directory.shared.kerberos.codec.types.EncryptionType.UNKNOWN));
            put("camellia", java.util.EnumSet.of(org.apache.directory.shared.kerberos.codec.types.EncryptionType.UNKNOWN));
            put("camellia256-cts-cmac", java.util.EnumSet.of(org.apache.directory.shared.kerberos.codec.types.EncryptionType.UNKNOWN));
            put("camellia256-cts", java.util.EnumSet.of(org.apache.directory.shared.kerberos.codec.types.EncryptionType.UNKNOWN));
            put("camellia128-cts-cmac", java.util.EnumSet.of(org.apache.directory.shared.kerberos.codec.types.EncryptionType.UNKNOWN));
            put("camellia128-cts", java.util.EnumSet.of(org.apache.directory.shared.kerberos.codec.types.EncryptionType.UNKNOWN));
            put("des", java.util.EnumSet.of(org.apache.directory.shared.kerberos.codec.types.EncryptionType.DES_CBC_CRC, org.apache.directory.shared.kerberos.codec.types.EncryptionType.DES_CBC_MD5, org.apache.directory.shared.kerberos.codec.types.EncryptionType.DES_CBC_MD4));
            put("des-cbc-md4", java.util.EnumSet.of(org.apache.directory.shared.kerberos.codec.types.EncryptionType.DES_CBC_MD4));
            put("des-cbc-md5", java.util.EnumSet.of(org.apache.directory.shared.kerberos.codec.types.EncryptionType.DES_CBC_MD5));
            put("des-cbc-crc", java.util.EnumSet.of(org.apache.directory.shared.kerberos.codec.types.EncryptionType.DES_CBC_CRC));
            put("des-cbc-raw", java.util.EnumSet.of(org.apache.directory.shared.kerberos.codec.types.EncryptionType.UNKNOWN));
            put("des-hmac-sha1", java.util.EnumSet.of(org.apache.directory.shared.kerberos.codec.types.EncryptionType.UNKNOWN));
            put("des3", java.util.EnumSet.of(org.apache.directory.shared.kerberos.codec.types.EncryptionType.DES3_CBC_SHA1_KD));
            put("des3-cbc-raw", java.util.EnumSet.of(org.apache.directory.shared.kerberos.codec.types.EncryptionType.UNKNOWN));
            put("des3-cbc-sha1", java.util.EnumSet.of(org.apache.directory.shared.kerberos.codec.types.EncryptionType.DES3_CBC_SHA1_KD));
            put("des3-hmac-sha1", java.util.EnumSet.of(org.apache.directory.shared.kerberos.codec.types.EncryptionType.UNKNOWN));
            put("des3-cbc-sha1-kd", java.util.EnumSet.of(org.apache.directory.shared.kerberos.codec.types.EncryptionType.DES3_CBC_SHA1_KD));
        }
    });
    ...
    private static final java.util.Set<org.apache.directory.shared.kerberos.codec.types.EncryptionType> DEFAULT_CIPHERS = java.util.Collections.unmodifiableSet(new java.util.HashSet<org.apache.directory.shared.kerberos.codec.types.EncryptionType>() {
        {
            add(org.apache.directory.shared.kerberos.codec.types.EncryptionType.DES_CBC_MD5);
            add(org.apache.directory.shared.kerberos.codec.types.EncryptionType.DES3_CBC_SHA1_KD);
            add(org.apache.directory.shared.kerberos.codec.types.EncryptionType.RC4_HMAC);
            add(org.apache.directory.shared.kerberos.codec.types.EncryptionType.AES128_CTS_HMAC_SHA1_96);
            add(org.apache.directory.shared.kerberos.codec.types.EncryptionType.AES256_CTS_HMAC_SHA1_96);
        }
    });
