...
public class KerberosServerActionTest extends org.easymock.EasyMockSupport {
    ...
    public void setUp() throws java.lang.Exception {
        ...
        org.easymock.EasyMock.expect(kerberosEnvConfig.getProperties()).andReturn(org.apache.ambari.server.serveraction.kerberos.KerberosServerActionTest.KERBEROS_ENV_PROPERTIES).anyTimes();
        ...
        org.easymock.EasyMock.expect(clusters.getCluster(org.easymock.EasyMock.anyString())).andReturn(cluster).anyTimes();
        ...
        org.easymock.EasyMock.expect(mockExecutionCommand.getCommandParams()).andReturn(commandParams).anyTimes();
        org.easymock.EasyMock.expect(mockExecutionCommand.getClusterName()).andReturn("c1").anyTimes();
        org.easymock.EasyMock.expect(mockExecutionCommand.getClusterId()).andReturn("1").anyTimes();
        org.easymock.EasyMock.expect(mockExecutionCommand.getConfigurations()).andReturn(java.util.Collections.emptyMap()).anyTimes();
        org.easymock.EasyMock.expect(mockExecutionCommand.getRoleCommand()).andReturn(null).anyTimes();
        org.easymock.EasyMock.expect(mockExecutionCommand.getRole()).andReturn(null).anyTimes();
        org.easymock.EasyMock.expect(mockExecutionCommand.getServiceName()).andReturn(null).anyTimes();
        org.easymock.EasyMock.expect(mockExecutionCommand.getTaskId()).andReturn(1L).anyTimes();
        org.easymock.EasyMock.expect(mockHostRoleCommand.getRequestId()).andReturn(1L).anyTimes();
        org.easymock.EasyMock.expect(mockHostRoleCommand.getStageId()).andReturn(1L).anyTimes();
    }
    ...
    public void testProcessIdentitiesSuccess() throws java.lang.Exception {
        ...
        org.easymock.EasyMock.expect(kerberosHelper.getKDCAdministratorCredentials(org.easymock.EasyMock.anyObject(java.lang.String.class))).andReturn(new org.apache.ambari.server.security.credential.PrincipalKeyCredential("principal", "password")).anyTimes();
        ...
        kerberosOperationHandler.open(org.easymock.EasyMock.anyObject(org.apache.ambari.server.security.credential.PrincipalKeyCredential.class), org.easymock.EasyMock.anyString(), org.easymock.EasyMock.anyObject(java.util.Map.class));
        ...
        org.easymock.EasyMock.expect(factory.getKerberosOperationHandler(org.apache.ambari.server.serveraction.kerberos.KDCType.MIT_KDC)).andReturn(kerberosOperationHandler).once();
        replayAll();
        java.util.concurrent.ConcurrentMap<java.lang.String, java.lang.Object> sharedMap = new java.util.concurrent.ConcurrentHashMap<>();
    ...
    public void testProcessIdentitiesFail() throws java.lang.Exception {
        ...
        org.easymock.EasyMock.expectLastCall().atLeastOnce();
        org.apache.ambari.server.serveraction.kerberos.KerberosOperationHandlerFactory factory = injector.getInstance(org.apache.ambari.server.serveraction.kerberos.KerberosOperationHandlerFactory.class);
        org.easymock.EasyMock.expect(factory.getKerberosOperationHandler(org.apache.ambari.server.serveraction.kerberos.KDCType.MIT_KDC)).andReturn(kerberosOperationHandler).anyTimes();
        replayAll();
        java.util.concurrent.ConcurrentMap<java.lang.String, java.lang.Object> sharedMap = new java.util.concurrent.ConcurrentHashMap<>();
    ...
    public void testGetConfigurationProperties() throws org.apache.ambari.server.AmbariException {
        ...
        org.easymock.EasyMock.expect(emptyConfig.getProperties()).andReturn(java.util.Collections.emptyMap()).once();
        org.apache.ambari.server.state.Config missingPropertiesConfig = createMock(org.apache.ambari.server.state.Config.class);
        org.easymock.EasyMock.expect(missingPropertiesConfig.getProperties()).andReturn(null).once();
        org.easymock.EasyMock.expect(cluster.getDesiredConfigByType("invalid-type")).andReturn(null).once();
        org.easymock.EasyMock.expect(cluster.getDesiredConfigByType("missing-properties-type")).andReturn(missingPropertiesConfig).once();
        org.easymock.EasyMock.expect(cluster.getDesiredConfigByType("empty-type")).andReturn(emptyConfig).once();
        replayAll();
