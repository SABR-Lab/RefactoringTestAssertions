...
public class MITKerberosOperationHandlerTest extends org.apache.ambari.server.serveraction.kerberos.KDCKerberosOperationHandlerTest {
    ...
    public void beforeMITKerberosOperationHandlerTest() throws java.lang.Exception {
        injector = com.google.inject.Guice.createInjector(new com.google.inject.AbstractModule() {
            ...
            protected void configure() {
                ...
                org.easymock.EasyMock.expect(configuration.getKerberosOperationRetryTimeout()).andReturn(1).anyTimes();
    ...
    public void testSetPrincipalPassword() throws java.lang.Exception {
        ...
        org.easymock.EasyMock.expect(handler.isOpen()).andReturn(true).atLeastOnce();
        org.easymock.EasyMock.expect(handler.principalExists(org.apache.ambari.server.serveraction.kerberos.KerberosOperationHandlerTest.DEFAULT_ADMIN_PRINCIPAL, false)).andReturn(true).atLeastOnce();
        org.easymock.EasyMock.expect(handler.principalExists(null, false)).andReturn(false).atLeastOnce();
        org.easymock.EasyMock.expect(handler.principalExists("", false)).andReturn(false).atLeastOnce();
        replayAll();
    ...
    public void testCreateServicePrincipal_AdditionalAttributes() throws java.lang.Exception {
        org.easymock.Capture<? extends java.lang.String> query = org.easymock.EasyMock.newCapture();
        ...
        org.easymock.EasyMock.expect(result1.getStderr()).andReturn("").anyTimes();
        org.easymock.EasyMock.expect(result1.getStdout()).andReturn(("Principal \"" + org.apache.ambari.server.serveraction.kerberos.KerberosOperationHandlerTest.DEFAULT_ADMIN_PRINCIPAL) + "\" created\"").anyTimes();
        ...
        org.easymock.EasyMock.expect(result2.getStderr()).andReturn("").anyTimes();
        org.easymock.EasyMock.expect(result2.getStdout()).andReturn("Key: vno 1").anyTimes();
        ...
        org.easymock.EasyMock.expect(kinitResult.isSuccessful()).andReturn(true);
        ...
        org.easymock.EasyMock.expect(handler.executeCommand(org.easymock.EasyMock.anyObject(java.lang.String[].class), org.easymock.EasyMock.anyObject(java.util.Map.class), org.easymock.EasyMock.anyObject(org.apache.ambari.server.serveraction.kerberos.KDCKerberosOperationHandler.InteractivePasswordHandler.class))).andReturn(kinitResult).once();
        org.easymock.EasyMock.expect(handler.invokeKAdmin(org.easymock.EasyMock.capture(query))).andReturn(result1).once();
        replayAll();
    ...
    public void testKDCConnectionException() throws java.lang.Exception {
        ...
        org.easymock.EasyMock.expect(kadminResult.getExitCode()).andReturn(1).anyTimes();
        org.easymock.EasyMock.expect(kadminResult.isSuccessful()).andReturn(false).anyTimes();
        org.easymock.EasyMock.expect(kadminResult.getStderr()).andReturn("kadmin: Cannot contact any KDC for requested realm while initializing kadmin interface").anyTimes();
        org.easymock.EasyMock.expect(kadminResult.getStdout()).andReturn("Authenticating as principal admin/admin with password.").anyTimes();
        org.apache.ambari.server.serveraction.kerberos.MITKerberosOperationHandler handler = createMockedHandler(org.apache.ambari.server.serveraction.kerberos.KDCKerberosOperationHandlerTest.methodExecuteCommand);
        org.easymock.EasyMock.expect(handler.executeCommand(org.easymock.EasyMock.anyObject(java.lang.String[].class), org.easymock.EasyMock.anyObject(java.util.Map.class), org.easymock.EasyMock.anyObject(org.apache.ambari.server.serveraction.kerberos.KDCKerberosOperationHandler.InteractivePasswordHandler.class))).andReturn(kinitResult).once();
        org.easymock.EasyMock.expect(handler.executeCommand(org.easymock.EasyMock.anyObject(java.lang.String[].class), org.easymock.EasyMock.anyObject(java.util.Map.class), org.easymock.EasyMock.anyObject(org.apache.ambari.server.serveraction.kerberos.KDCKerberosOperationHandler.InteractivePasswordHandler.class))).andReturn(kadminResult).once();
        replayAll();
        handler.open(getAdminCredentials(), org.apache.ambari.server.serveraction.kerberos.KerberosOperationHandlerTest.DEFAULT_REALM, org.apache.ambari.server.serveraction.kerberos.MITKerberosOperationHandlerTest.KERBEROS_ENV_MAP);
    ...
    public void testTestAdministratorCredentialsKDCConnectionException2() throws java.lang.Exception {
        ...
        org.easymock.EasyMock.expect(kadminResult.getExitCode()).andReturn(1).anyTimes();
        org.easymock.EasyMock.expect(kadminResult.isSuccessful()).andReturn(false).anyTimes();
        org.easymock.EasyMock.expect(kadminResult.getStderr()).andReturn("kadmin: Cannot resolve network address for admin server in requested realm while initializing kadmin interface").anyTimes();
        org.easymock.EasyMock.expect(kadminResult.getStdout()).andReturn("Authenticating as principal admin/admin with password.").anyTimes();
        org.apache.ambari.server.serveraction.kerberos.MITKerberosOperationHandler handler = createMockedHandler(org.apache.ambari.server.serveraction.kerberos.KDCKerberosOperationHandlerTest.methodExecuteCommand);
        org.easymock.EasyMock.expect(handler.executeCommand(org.easymock.EasyMock.anyObject(java.lang.String[].class), org.easymock.EasyMock.anyObject(java.util.Map.class), org.easymock.EasyMock.anyObject(org.apache.ambari.server.serveraction.kerberos.KDCKerberosOperationHandler.InteractivePasswordHandler.class))).andReturn(kinitResult).once();
        org.easymock.EasyMock.expect(handler.executeCommand(org.easymock.EasyMock.anyObject(java.lang.String[].class), org.easymock.EasyMock.anyObject(java.util.Map.class), org.easymock.EasyMock.anyObject(org.apache.ambari.server.serveraction.kerberos.KDCKerberosOperationHandler.InteractivePasswordHandler.class))).andReturn(kadminResult).once();
    ...
    protected void setupPrincipalAlreadyExists(org.apache.ambari.server.serveraction.kerberos.KerberosOperationHandler handler, boolean service) throws java.lang.Exception {
        ...
        org.easymock.EasyMock.expect(result.getStderr()).andReturn(java.lang.String.format("add_principal: Principal or policy already exists while creating \"%s@EXAMPLE.COM\".", service ? "service/host" : "user")).anyTimes();
        org.easymock.EasyMock.expect(result.getStdout()).andReturn("Authenticating as principal admin/admin with password.").anyTimes();
        org.easymock.EasyMock.expect(handler.executeCommand(org.apache.ambari.server.serveraction.kerberos.KDCKerberosOperationHandlerTest.arrayContains(new java.lang.String[]{ "kadmin", "add_principal" }), org.easymock.EasyMock.anyObject(java.util.Map.class), org.easymock.EasyMock.anyObject(org.apache.ambari.server.serveraction.kerberos.KDCKerberosOperationHandler.InteractivePasswordHandler.class))).andReturn(result).anyTimes();
    }
    ...
    protected void setupPrincipalDoesNotExist(org.apache.ambari.server.serveraction.kerberos.KerberosOperationHandler handler, boolean service) throws java.lang.Exception {
        ...
        org.easymock.EasyMock.expect(result.getExitCode()).andReturn(0).anyTimes();
        org.easymock.EasyMock.expect(result.isSuccessful()).andReturn(true).anyTimes();
        org.easymock.EasyMock.expect(result.getStderr()).andReturn(java.lang.String.format("get_principal: Principal does not exist while retrieving \"%s@EXAMPLE.COM\".", service ? "service/host" : "user")).anyTimes();
        org.easymock.EasyMock.expect(result.getStdout()).andReturn("Authenticating as principal admin/admin with password.").anyTimes();
        org.easymock.EasyMock.expect(handler.executeCommand(org.apache.ambari.server.serveraction.kerberos.KDCKerberosOperationHandlerTest.arrayContains(new java.lang.String[]{ "kadmin", "get_principal" }), org.easymock.EasyMock.anyObject(java.util.Map.class), org.easymock.EasyMock.anyObject(org.apache.ambari.server.serveraction.kerberos.KDCKerberosOperationHandler.InteractivePasswordHandler.class))).andReturn(result).anyTimes();
    }
