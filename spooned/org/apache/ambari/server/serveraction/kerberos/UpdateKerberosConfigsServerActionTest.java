...
public class UpdateKerberosConfigsServerActionTest extends org.easymock.EasyMockSupport {
    ...
    public void setup() throws java.lang.Exception {
        ...
        org.easymock.EasyMock.expect(clusters.getCluster(org.easymock.EasyMock.anyObject(java.lang.String.class))).andReturn(cluster).once();
        ...
        org.easymock.EasyMock.expect(controller.getClusters()).andReturn(clusters).once();
    ...
    public void testUpdateConfig() throws java.lang.Exception {
        ...
        configHelper.updateBulkConfigType(org.easymock.EasyMock.anyObject(), org.easymock.EasyMock.anyObject(), org.easymock.EasyMock.anyObject(), org.easymock.EasyMock.anyObject(), org.easymock.EasyMock.anyObject(), org.easymock.EasyMock.anyObject(), org.easymock.EasyMock.anyObject(), org.easymock.EasyMock.anyObject());
    ...
    public void testUpdateConfigForceSecurityEnabled() throws java.lang.Exception {
        ...
        executionCommand.setCommandParams(commandParams);
        org.apache.ambari.server.state.ConfigHelper configHelper = injector.getInstance(org.apache.ambari.server.state.ConfigHelper.class);
        org.easymock.Capture<java.lang.Iterable<java.lang.String>> configTypes = org.easymock.Capture.newInstance(org.easymock.CaptureType.ALL);
        org.easymock.Capture<java.util.Map<java.lang.String, java.util.Map<java.lang.String, java.lang.String>>> configUpdates = org.easymock.Capture.newInstance(org.easymock.CaptureType.ALL);
        configHelper.updateBulkConfigType(org.easymock.EasyMock.anyObject(), org.easymock.EasyMock.anyObject(), org.easymock.EasyMock.anyObject(), org.easymock.EasyMock.capture(configTypes), org.easymock.EasyMock.capture(configUpdates), org.easymock.EasyMock.anyObject(), org.easymock.EasyMock.anyObject(), org.easymock.EasyMock.anyObject());
        org.easymock.EasyMock.expectLastCall().atLeastOnce();
        replayAll();
        action.setExecutionCommand(executionCommand);
        action.execute(null);
