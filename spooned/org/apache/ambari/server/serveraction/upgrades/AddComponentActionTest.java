...
public class AddComponentActionTest extends org.easymock.EasyMockSupport {
    ...
    public void before() throws java.lang.Exception {
        ...
        org.easymock.EasyMock.expect(org.apache.ambari.server.stack.MasterHostResolver.getCandidateHosts(m_mockCluster, org.apache.ambari.server.stack.upgrade.ExecuteHostType.ALL, org.apache.ambari.server.serveraction.upgrades.AddComponentActionTest.CANDIDATE_SERVICE, org.apache.ambari.server.serveraction.upgrades.AddComponentActionTest.CANDIDATE_COMPONENT)).andReturn(m_candidateHosts).once();
        ...
        org.easymock.EasyMock.expect(m_action.getClusters()).andReturn(m_mockClusters).atLeastOnce();
        org.easymock.EasyMock.expect(m_action.getUpgradeContext(m_mockCluster)).andReturn(m_mockUpgradeContext).once();
        org.easymock.EasyMock.expect(m_action.getGson()).andReturn(new com.google.gson.Gson()).once();
        ...
        org.easymock.EasyMock.expect(m_mockClusters.getCluster(org.apache.ambari.server.serveraction.upgrades.AddComponentActionTest.CLUSTER_NAME)).andReturn(m_mockCluster).once();
    }
    ...
    public void testAddComponentDuringUpgrade() throws java.lang.Exception {
        org.easymock.EasyMock.expect(m_mockCluster.getService(org.apache.ambari.server.serveraction.upgrades.AddComponentActionTest.NEW_SERVICE)).andReturn(m_mockCandidateService).once();
        org.easymock.EasyMock.expect(m_mockCandidateService.getServiceComponent(org.apache.ambari.server.serveraction.upgrades.AddComponentActionTest.NEW_COMPONENT)).andThrow(new org.apache.ambari.server.ServiceComponentNotFoundException(org.apache.ambari.server.serveraction.upgrades.AddComponentActionTest.CLUSTER_NAME, org.apache.ambari.server.serveraction.upgrades.AddComponentActionTest.NEW_SERVICE, org.apache.ambari.server.serveraction.upgrades.AddComponentActionTest.NEW_COMPONENT));
        org.easymock.EasyMock.expect(m_mockCandidateService.addServiceComponent(org.apache.ambari.server.serveraction.upgrades.AddComponentActionTest.NEW_COMPONENT)).andReturn(m_mockCandidateServiceComponent).once();
        org.easymock.EasyMock.expect(m_mockHost.getHostName()).andReturn(CANDIDATE_HOST_NAME).atLeastOnce();
        ...
        org.easymock.EasyMock.expect(m_mockCandidateServiceComponent.getServiceComponentHosts()).andReturn(existingSCHs).once();
        ...
        org.easymock.EasyMock.expect(m_mockCandidateServiceComponent.addServiceComponentHost(CANDIDATE_HOST_NAME)).andReturn(mockServiceComponentHost).once();
