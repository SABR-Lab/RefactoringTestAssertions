...
public class AutoSkipFailedSummaryActionTest {
    ...
    public void setup() throws java.lang.Exception {
        upgradeDAOMock = org.easymock.EasyMock.createNiceMock(org.apache.ambari.server.orm.dao.UpgradeDAO.class);
        hostRoleCommandDAOMock = org.easymock.EasyMock.createNiceMock(org.apache.ambari.server.orm.dao.HostRoleCommandDAO.class);
        clustersMock = org.easymock.EasyMock.createNiceMock(org.apache.ambari.server.state.Clusters.class);
        clusterMock = org.easymock.EasyMock.createNiceMock(org.apache.ambari.server.state.Cluster.class);
        org.easymock.EasyMock.expect(clustersMock.getCluster(org.easymock.EasyMock.anyString())).andReturn(clusterMock).anyTimes();
        org.easymock.EasyMock.replay(clustersMock);
        org.easymock.EasyMock.expect(clusterMock.getDesiredStackVersion()).andReturn(org.apache.ambari.server.serveraction.upgrades.AutoSkipFailedSummaryActionTest.HDP_STACK).anyTimes();
        org.easymock.EasyMock.replay(clusterMock);
    ...
    public void testAutoSkipFailedSummaryAction__green() throws java.lang.Exception {
        ...
        org.apache.ambari.server.state.ServiceComponentHostEvent event = org.easymock.EasyMock.createNiceMock(org.apache.ambari.server.state.ServiceComponentHostEvent.class);
        ...
        org.easymock.EasyMock.expect(upgradeDAOMock.findUpgradeItemByRequestAndStage(org.easymock.EasyMock.anyLong(), org.easymock.EasyMock.anyLong())).andReturn(upgradeItemEntity).anyTimes();
        org.easymock.EasyMock.expect(upgradeDAOMock.findUpgradeGroup(org.easymock.EasyMock.anyLong())).andReturn(upgradeGroupEntity).anyTimes();
        org.easymock.EasyMock.replay(upgradeDAOMock);
        ...
        org.easymock.EasyMock.expect(hostRoleCommandDAOMock.findByStatusBetweenStages(org.easymock.EasyMock.anyLong(), org.easymock.EasyMock.anyObject(org.apache.ambari.server.actionmanager.HostRoleStatus.class), org.easymock.EasyMock.anyLong(), org.easymock.EasyMock.anyLong())).andReturn(skippedTasks).anyTimes();
        org.easymock.EasyMock.replay(hostRoleCommandDAOMock);
    ...
    public void testAutoSkipFailedSummaryAction__red() throws java.lang.Exception {
        ...
        org.easymock.EasyMock.expect(clusterMock.getServiceByComponentName("DATANODE")).andReturn(hdfsService).anyTimes();
        org.apache.ambari.server.state.Service zkService = org.easymock.EasyMock.createNiceMock(org.apache.ambari.server.state.Service.class);
        org.easymock.EasyMock.expect(zkService.getName()).andReturn("ZOOKEEPER").anyTimes();
        org.easymock.EasyMock.expect(clusterMock.getServiceByComponentName("ZOOKEEPER_CLIENT")).andReturn(zkService).anyTimes();
        org.easymock.EasyMock.replay(clusterMock, hdfsService, zkService);
        org.apache.ambari.server.state.ServiceComponentHostEvent event = org.easymock.EasyMock.createNiceMock(org.apache.ambari.server.state.ServiceComponentHostEvent.class);
    ...
    public void testAutoSkipFailedSummaryAction__red__host_components_only() throws java.lang.Exception {
        ...
        org.easymock.EasyMock.expect(hdfsService.getName()).andReturn("HDFS").anyTimes();
        org.easymock.EasyMock.expect(clusterMock.getServiceByComponentName("DATANODE")).andReturn(hdfsService).anyTimes();
        org.easymock.EasyMock.replay(clusterMock, hdfsService);
        org.apache.ambari.server.state.ServiceComponentHostEvent event = org.easymock.EasyMock.createNiceMock(org.apache.ambari.server.state.ServiceComponentHostEvent.class);
        final org.apache.ambari.server.actionmanager.HostRoleCommand hostRoleCommand = new org.apache.ambari.server.actionmanager.HostRoleCommand("host1", org.apache.ambari.server.Role.AMBARI_SERVER_ACTION, event, org.apache.ambari.server.RoleCommand.EXECUTE, hostDAO, executionCommandDAO, ecwFactory);
        hostRoleCommand.setRequestId(1L);
        hostRoleCommand.setStageId(1L);
