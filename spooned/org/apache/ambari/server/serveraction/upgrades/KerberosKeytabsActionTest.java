...
public class KerberosKeytabsActionTest {
    ...
    public void setup() throws java.lang.Exception {
        ...
        org.easymock.EasyMock.expect(m_kerberosConfig.getType()).andReturn("kerberos-env").anyTimes();
        org.easymock.EasyMock.expect(m_kerberosConfig.getProperties()).andReturn(mockProperties).anyTimes();
        ...
        org.easymock.EasyMock.expect(cluster.getDesiredConfigByType("kerberos-env")).andReturn(m_kerberosConfig).atLeastOnce();
        ...
        org.easymock.EasyMock.replay(m_clusters, cluster, m_kerberosConfig);
    ...
    public void testAction_NotKerberized() throws java.lang.Exception {
        org.easymock.EasyMock.reset(m_kerberosHelper);
        org.easymock.EasyMock.expect(m_kerberosHelper.isClusterKerberosEnabled(org.easymock.EasyMock.anyObject(org.apache.ambari.server.state.Cluster.class))).andReturn(java.lang.Boolean.FALSE).atLeastOnce();
        org.easymock.EasyMock.replay(m_kerberosHelper);
    ...
    public void testAction_NoKdcType() throws java.lang.Exception {
        org.easymock.EasyMock.reset(m_kerberosHelper);
        org.easymock.EasyMock.expect(m_kerberosHelper.isClusterKerberosEnabled(org.easymock.EasyMock.anyObject(org.apache.ambari.server.state.Cluster.class))).andReturn(java.lang.Boolean.TRUE).atLeastOnce();
        org.easymock.EasyMock.replay(m_kerberosHelper);
        java.util.Map<java.lang.String, java.lang.String> commandParams = new java.util.HashMap<>();
        commandParams.put("clusterName", "c1");
        org.apache.ambari.server.agent.ExecutionCommand executionCommand = new org.apache.ambari.server.agent.ExecutionCommand();
