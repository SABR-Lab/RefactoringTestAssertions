...
public class PluginUpgradeServerActionTest extends org.easymock.EasyMockSupport {
    ...
    public void before() throws java.lang.Exception {
        ...
        org.easymock.EasyMock.expect(m_mockCluster.getHosts()).andReturn(new java.util.ArrayList<>()).once();
        ...
        org.easymock.EasyMock.expect(executionCommand.getClusterName()).andReturn(org.apache.ambari.server.serveraction.upgrades.PluginUpgradeServerActionTest.CLUSTER_NAME).anyTimes();
        org.easymock.EasyMock.expect(executionCommand.getCommandParams()).andReturn(m_commandParams).once();
        ...
        org.easymock.EasyMock.expect(m_mockController.getAuthName()).andReturn(org.apache.ambari.server.serveraction.upgrades.PluginUpgradeServerActionTest.AUTH_USERNAME).anyTimes();
        org.easymock.EasyMock.expect(m_mocRepoEntity.getStackId()).andReturn(m_stackId).anyTimes();
        org.easymock.EasyMock.expect(m_mocRepoEntity.getVersion()).andReturn("1.0.0.0-b1").anyTimes();
        org.easymock.EasyMock.expect(m_mocRepoEntity.getRepositoryVersion()).andReturn(m_repositoryVersion).anyTimes();
        org.easymock.EasyMock.expect(m_mockUpgradeContext.getUpgradePack()).andReturn(m_mockUpgradePack).atLeastOnce();
        org.easymock.EasyMock.expect(m_mockUpgradeContext.getDirection()).andReturn(org.apache.ambari.server.stack.upgrade.Direction.UPGRADE).anyTimes();
        org.easymock.EasyMock.expect(m_mockUpgradeContext.getRepositoryVersion()).andReturn(m_mocRepoEntity).anyTimes();
        org.easymock.EasyMock.expect(m_mockUpgradePack.getOwnerStackId()).andReturn(m_stackId).atLeastOnce();
        org.easymock.EasyMock.expect(m_mockMetaInfo.getStack(m_stackId)).andReturn(m_mockStackInfo).atLeastOnce();
        org.easymock.EasyMock.expect(m_mockStackInfo.getLibraryClassLoader()).andReturn(m_mockClassLoader).atLeastOnce();
        org.easymock.EasyMock.expect(m_mockStackInfo.getLibraryInstance(org.easymock.EasyMock.anyString())).andReturn(new org.apache.ambari.server.serveraction.upgrades.PluginUpgradeServerActionTest.MockUpgradeAction()).atLeastOnce();
        org.easymock.EasyMock.expect(m_action.getClusters()).andReturn(m_mockClusters).anyTimes();
        org.easymock.EasyMock.expect(m_action.getUpgradeContext(m_mockCluster)).andReturn(m_mockUpgradeContext).once();
        ...
        org.easymock.EasyMock.expect(m_mockClusters.getCluster(org.apache.ambari.server.serveraction.upgrades.PluginUpgradeServerActionTest.CLUSTER_NAME)).andReturn(m_mockCluster).once();
    }
    ...
    public void testExecute() throws java.lang.Exception {
        org.easymock.EasyMock.expect(m_mockCluster.getDesiredConfigByType(org.apache.ambari.server.serveraction.upgrades.PluginUpgradeServerActionTest.FOO_SITE)).andReturn(m_mockConfig).once();
    ...
    public void testExecuteAddNewConfiguration() throws java.lang.Exception {
        org.easymock.EasyMock.expect(m_mockCluster.getDesiredConfigByType(org.apache.ambari.server.serveraction.upgrades.PluginUpgradeServerActionTest.FOO_SITE)).andReturn(null).once();
        org.easymock.EasyMock.expect(m_mockCluster.getDesiredConfigByType(org.apache.ambari.server.serveraction.upgrades.PluginUpgradeServerActionTest.FOO_SITE)).andReturn(m_mockConfig).once();
        m_mockConfigHelper.createConfigType(org.easymock.EasyMock.eq(m_mockCluster), org.easymock.EasyMock.eq(m_stackId), org.easymock.EasyMock.eq(m_mockController), org.easymock.EasyMock.eq(org.apache.ambari.server.serveraction.upgrades.PluginUpgradeServerActionTest.FOO_SITE), org.easymock.EasyMock.eq(new java.util.HashMap<>()), org.easymock.EasyMock.eq(org.apache.ambari.server.serveraction.upgrades.PluginUpgradeServerActionTest.AUTH_USERNAME), org.easymock.EasyMock.eq("Upgrade to 1.0.0.0-b1"));
