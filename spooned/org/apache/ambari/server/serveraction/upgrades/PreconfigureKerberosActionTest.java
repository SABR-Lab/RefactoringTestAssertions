...
public class PreconfigureKerberosActionTest extends org.easymock.EasyMockSupport {
    ...
    public void testSkipWhenNotKerberos() throws java.lang.Exception {
        ...
        org.easymock.EasyMock.expect(clusters.getCluster(org.apache.ambari.server.serveraction.upgrades.PreconfigureKerberosActionTest.CLUSTER_NAME)).andReturn(cluster).atLeastOnce();
        replayAll();
        injector.getInstance(org.apache.ambari.server.api.services.AmbariMetaInfo.class).init();
        org.apache.ambari.server.serveraction.upgrades.PreconfigureKerberosAction action = injector.getInstance(org.apache.ambari.server.serveraction.upgrades.PreconfigureKerberosAction.class);
        java.util.concurrent.ConcurrentMap<java.lang.String, java.lang.Object> context = new java.util.concurrent.ConcurrentHashMap<>();
    ...
    private org.apache.ambari.server.state.Host createMockHost(java.lang.String hostname) {
        ...
        org.easymock.EasyMock.expect(host.getHostId()).andReturn(hostId).anyTimes();
        hostId++;
        return host;
    }
    ...
    public void testUpgrade() throws java.lang.Exception {
        org.easymock.Capture<? extends java.util.Map<java.lang.String, java.lang.String>> captureCoreSiteProperties = org.easymock.EasyMock.newCapture();
        com.google.inject.Injector injector = getInjector();
        ...
        org.easymock.EasyMock.expect(principalMock.getHostId()).andReturn(1L).anyTimes();
        org.easymock.EasyMock.expect(hostDAO.findByName(org.easymock.EasyMock.anyString())).andReturn(hostEntityMock).anyTimes();
        org.easymock.EasyMock.expect(hostDAO.findById(org.easymock.EasyMock.anyLong())).andReturn(hostEntityMock).anyTimes();
        org.easymock.EasyMock.expect(entityManager.find(org.easymock.EasyMock.eq(org.apache.ambari.server.orm.entities.KerberosKeytabEntity.class), org.easymock.EasyMock.anyString())).andReturn(createNiceMock(org.apache.ambari.server.orm.entities.KerberosKeytabEntity.class)).anyTimes();
        org.easymock.EasyMock.expect(entityManager.find(org.easymock.EasyMock.eq(org.apache.ambari.server.orm.entities.KerberosKeytabPrincipalEntity.class), org.easymock.EasyMock.anyObject())).andReturn(principalMock).anyTimes();
        org.apache.ambari.server.agent.ExecutionCommand executionCommand = createMockExecutionCommand(getDefaultCommandParams());
        ...
        org.easymock.EasyMock.expect(targetStackId.getStackId()).andReturn("HDP-2.6").anyTimes();
        org.easymock.EasyMock.expect(targetStackId.getStackName()).andReturn("HDP").anyTimes();
        org.easymock.EasyMock.expect(targetStackId.getStackVersion()).andReturn("2.6").anyTimes();
        ...
        org.easymock.EasyMock.expect(cluster.getUpgradeInProgress()).andReturn(upgradeProgress).once();
        ...
        org.easymock.EasyMock.expect(targetRepositoryVersion.getStackId()).andReturn(targetStackId).atLeastOnce();
        ...
        org.easymock.EasyMock.expect(upgradeContext.getTargetRepositoryVersion(org.easymock.EasyMock.anyString())).andReturn(targetRepositoryVersion).atLeastOnce();
        ...
        org.easymock.EasyMock.expect(upgradeContextFactory.create(cluster, upgradeProgress)).andReturn(upgradeContext).once();
        ...
        org.easymock.EasyMock.expect(ambariMetaInfo.getKerberosDescriptor("HDP", "2.6", false)).andReturn(getKerberosDescriptor(false)).once();
        org.easymock.EasyMock.expect(ambariMetaInfo.getKerberosDescriptor("HDP", "2.6", true)).andReturn(getKerberosDescriptor(true)).once();
        org.easymock.EasyMock.expect(ambariMetaInfo.isValidService("HDP", "2.6", "BEACON")).andReturn(false).anyTimes();
        org.easymock.EasyMock.expect(ambariMetaInfo.isValidService("HDP", "2.6", "KNOX")).andReturn(true).anyTimes();
        org.easymock.EasyMock.expect(ambariMetaInfo.getService("HDP", "2.6", "KNOX")).andReturn(createMockServiceInfo("KNOX", knoxProperties, java.util.Collections.singletonList(createMockComponentInfo("KNOX_GATEWAY")))).anyTimes();
        ...
        org.easymock.EasyMock.expect(managementController.findConfigurationTagsWithOverrides(cluster, null, null)).andReturn(clusterConfig).once();
        ...
        org.easymock.EasyMock.expect(configHelper.getEffectiveConfigProperties(cluster, clusterConfig)).andReturn(clusterConfig).anyTimes();
        configHelper.updateConfigType(org.easymock.EasyMock.eq(cluster), org.easymock.EasyMock.eq(targetStackId), org.easymock.EasyMock.eq(managementController), org.easymock.EasyMock.eq("core-site"), org.easymock.EasyMock.capture(captureCoreSiteProperties), org.easymock.EasyMock.anyObject(java.util.Collection.class), org.easymock.EasyMock.eq("admin"), org.easymock.EasyMock.anyString());
        ...
        org.easymock.EasyMock.expect(topologyManager.getPendingHostComponents()).andReturn(java.util.Collections.<java.lang.String, java.util.Collection<java.lang.String>>emptyMap()).anyTimes();
        ...
        org.easymock.EasyMock.expect(stackAdvisorHelper.recommend(org.easymock.EasyMock.anyObject(org.apache.ambari.server.api.services.stackadvisor.StackAdvisorRequest.class))).andAnswer(new org.easymock.IAnswer<org.apache.ambari.server.api.services.stackadvisor.recommendations.RecommendationResponse>() {
            @java.lang.Override
    ...
    private org.apache.ambari.server.state.ComponentInfo createMockComponentInfo(java.lang.String componentName) {
        ...
        org.easymock.EasyMock.expect(componentInfo.getName()).andReturn(componentName).anyTimes();
    ...
    private org.apache.ambari.server.state.PropertyInfo crateMockPropertyInfo(java.lang.String fileName, java.lang.String propertyName, java.lang.String propertyValue) {
        ...
        org.easymock.EasyMock.expect(propertyInfo.getValue()).andReturn(propertyValue).anyTimes();
        return propertyInfo;
    }
    ...
    private org.apache.ambari.server.state.ServiceInfo createMockServiceInfo(java.lang.String name, java.util.List<org.apache.ambari.server.state.PropertyInfo> properties, java.util.List<org.apache.ambari.server.state.ComponentInfo> components) {
        ...
        org.easymock.EasyMock.expect(serviceInfo.getName()).andReturn(name).anyTimes();
        org.easymock.EasyMock.expect(serviceInfo.getProperties()).andReturn(properties).anyTimes();
        org.easymock.EasyMock.expect(serviceInfo.getComponents()).andReturn(components).anyTimes();
        return serviceInfo;
    }
    ...
    private org.apache.ambari.server.state.ServiceComponent createMockServiceComponent(java.lang.String name, java.lang.Boolean isClientComponent, java.util.Map<java.lang.String, org.apache.ambari.server.state.ServiceComponentHost> serviceComponentHostMap) throws org.apache.ambari.server.AmbariException {
        ...
        org.easymock.EasyMock.expect(serviceComponent.getName()).andReturn(name).anyTimes();
        org.easymock.EasyMock.expect(serviceComponent.isClientComponent()).andReturn(isClientComponent).anyTimes();
        for (java.util.Map.Entry<java.lang.String, org.apache.ambari.server.state.ServiceComponentHost> entry : serviceComponentHostMap.entrySet()) {
            org.easymock.EasyMock.expect(serviceComponent.getServiceComponentHost(entry.getKey())).andReturn(serviceComponentHostMap.get(entry.getKey())).anyTimes();
        }
        org.easymock.EasyMock.expect(serviceComponent.getServiceComponentHosts()).andReturn(serviceComponentHostMap).anyTimes();
    ...
    private org.apache.ambari.server.state.ServiceComponentHost createMockServiceComponentHost(java.lang.String serviceName, java.lang.String componentName, java.lang.String hostname, org.apache.ambari.server.state.Host host) {
        ...
        org.easymock.EasyMock.expect(serviceComponentHost.getServiceName()).andReturn(serviceName).anyTimes();
        org.easymock.EasyMock.expect(serviceComponentHost.getServiceComponentName()).andReturn(componentName).anyTimes();
        org.easymock.EasyMock.expect(serviceComponentHost.getHostName()).andReturn(hostname).anyTimes();
        org.easymock.EasyMock.expect(serviceComponentHost.getHost()).andReturn(host).anyTimes();
        org.easymock.EasyMock.expect(serviceComponentHost.getComponentAdminState()).andReturn(org.apache.ambari.server.state.HostComponentAdminState.INSERVICE).anyTimes();
    ...
    private org.apache.ambari.server.state.Service createMockService(java.lang.String name, java.util.Map<java.lang.String, org.apache.ambari.server.state.ServiceComponent> components, org.apache.ambari.server.state.StackId desiredStackId) {
        ...
        org.easymock.EasyMock.expect(service.getName()).andReturn(name).anyTimes();
        org.easymock.EasyMock.expect(service.getServiceComponents()).andReturn(components).anyTimes();
        org.easymock.EasyMock.expect(service.getDesiredStackId()).andReturn(desiredStackId).anyTimes();
        return service;
    }
    ...
    private org.apache.ambari.server.state.Cluster createMockCluster(org.apache.ambari.server.state.SecurityType securityType, java.util.Collection<org.apache.ambari.server.state.Host> hosts, java.util.Map<java.lang.String, org.apache.ambari.server.state.Service> services, java.util.Map<java.lang.String, java.util.List<org.apache.ambari.server.state.ServiceComponentHost>> serviceComponentHosts, org.apache.ambari.server.state.StackId currentStackId, final java.util.Map<java.lang.String, org.apache.ambari.server.state.Config> clusterConfigs) {
        ...
        org.easymock.EasyMock.expect(cluster.getClusterName()).andReturn(org.apache.ambari.server.serveraction.upgrades.PreconfigureKerberosActionTest.CLUSTER_NAME).anyTimes();
        ...
        for (java.util.Map.Entry<java.lang.String, java.util.List<org.apache.ambari.server.state.ServiceComponentHost>> entry : serviceComponentHosts.entrySet()) {
            org.easymock.EasyMock.expect(cluster.getServiceComponentHosts(entry.getKey())).andReturn(entry.getValue()).atLeastOnce();
        }
        org.easymock.EasyMock.expect(cluster.getServiceComponentHostMap(null, new java.util.HashSet<>(java.util.Arrays.asList("HDFS", "ZOOKEEPER", "YARN", "KNOX")))).andReturn(null).anyTimes();
        org.easymock.EasyMock.expect(cluster.getServiceComponentHostMap(null, new java.util.HashSet<>(java.util.Arrays.asList("HDFS", "ZOOKEEPER", "YARN")))).andReturn(null).anyTimes();
        ...
        for (java.util.Map.Entry<java.lang.String, java.lang.String> entry : configTypeService.entrySet()) {
            org.easymock.EasyMock.expect(cluster.getServiceByConfigType(entry.getKey())).andReturn(entry.getValue()).anyTimes();
        }
        for (java.util.Map.Entry<java.lang.String, org.apache.ambari.server.state.Config> entry : clusterConfigs.entrySet()) {
            org.easymock.EasyMock.expect(cluster.getDesiredConfigByType(entry.getKey())).andReturn(entry.getValue()).anyTimes();
            org.easymock.EasyMock.expect(cluster.getConfigsByType(entry.getKey())).andReturn(java.util.Collections.singletonMap(entry.getKey(), entry.getValue())).anyTimes();
            org.easymock.EasyMock.expect(cluster.getConfigPropertiesTypes(entry.getKey())).andReturn(java.util.Collections.<org.apache.ambari.server.state.PropertyInfo.PropertyType, java.util.Set<java.lang.String>>emptyMap()).anyTimes();
        }
        return cluster;
    }
    ...
    private org.apache.ambari.server.agent.ExecutionCommand createMockExecutionCommand(java.util.Map<java.lang.String, java.lang.String> commandParams) {
        ...
        org.easymock.EasyMock.expect(executionCommand.getCommandParams()).andReturn(commandParams).atLeastOnce();
