...
public class UpgradeUserKerberosDescriptorTest {
    ...
    public void setup() throws java.lang.Exception {
        ...
        org.easymock.EasyMock.expect(clusters.getCluster(((java.lang.String) (org.easymock.EasyMock.anyObject())))).andReturn(cluster).anyTimes();
        org.easymock.EasyMock.expect(cluster.getClusterId()).andReturn(1L).atLeastOnce();
        org.easymock.EasyMock.expect(cluster.getCurrentStackVersion()).andReturn(HDP_24).atLeastOnce();
        org.easymock.EasyMock.expect(cluster.getUpgradeInProgress()).andReturn(upgrade).atLeastOnce();
        org.easymock.EasyMock.expect(upgradeContextFactory.create(cluster, upgrade)).andReturn(upgradeContext).atLeastOnce();
        org.easymock.EasyMock.replay(clusters, cluster, upgradeContextFactory, upgrade);
        prepareFields();
    }
    ...
    public void testUpgrade() throws java.lang.Exception {
        ...
        org.easymock.EasyMock.expect(repositoryVersion.getStackId()).andReturn(stackId).atLeastOnce();
        org.easymock.EasyMock.expect(upgradeContext.getDirection()).andReturn(org.apache.ambari.server.stack.upgrade.Direction.UPGRADE).atLeastOnce();
        org.easymock.EasyMock.expect(upgradeContext.getRepositoryVersion()).andReturn(repositoryVersion).atLeastOnce();
        org.easymock.EasyMock.replay(repositoryVersion, upgradeContext);
        ...
        org.easymock.EasyMock.replay(hrc);
        ...
        org.easymock.EasyMock.expect(entity.getArtifactData()).andReturn(null).anyTimes();
        org.easymock.EasyMock.expect(entity.getForeignKeys()).andReturn(null).anyTimes();
        org.easymock.EasyMock.expect(artifactDAO.findByNameAndForeignKeys(org.easymock.EasyMock.anyString(), ((java.util.TreeMap<java.lang.String, java.lang.String>) (org.easymock.EasyMock.anyObject())))).andReturn(entity).atLeastOnce();
        ...
        org.easymock.EasyMock.expect(kerberosDescriptorFactory.createInstance(((java.util.Map) (null)))).andReturn(userDescriptor).atLeastOnce();
        org.easymock.EasyMock.expect(ambariMetaInfo.getKerberosDescriptor("HDP", "2.5", false)).andReturn(newDescriptor).atLeastOnce();
        org.easymock.EasyMock.expect(ambariMetaInfo.getKerberosDescriptor("HDP", "2.4", false)).andReturn(previousDescriptor).atLeastOnce();
        org.easymock.EasyMock.expect(updatedKerberosDescriptor.toMap()).andReturn(null).once();
        org.easymock.EasyMock.expect(artifactDAO.merge(entity)).andReturn(entity).once();
        org.easymock.Capture<org.apache.ambari.server.orm.entities.ArtifactEntity> createCapture = org.easymock.Capture.newInstance();
        artifactDAO.create(org.easymock.EasyMock.capture(createCapture));
        org.easymock.EasyMock.expectLastCall().once();
        org.easymock.EasyMock.replay(artifactDAO, entity, ambariMetaInfo, kerberosDescriptorFactory, updatedKerberosDescriptor);
        action.execute(null);
        org.easymock.EasyMock.verify(artifactDAO, updatedKerberosDescriptor);
    ...
    public void testDowngrade() throws java.lang.Exception {
        ...
        org.apache.ambari.server.orm.entities.RepositoryVersionEntity repositoryVersion = org.easymock.EasyMock.createNiceMock(org.apache.ambari.server.orm.entities.RepositoryVersionEntity.class);
        org.easymock.EasyMock.expect(repositoryVersion.getStackId()).andReturn(stackId).atLeastOnce();
        org.easymock.EasyMock.expect(upgradeContext.getDirection()).andReturn(org.apache.ambari.server.stack.upgrade.Direction.DOWNGRADE).atLeastOnce();
        org.easymock.EasyMock.expect(upgradeContext.getRepositoryVersion()).andReturn(repositoryVersion).atLeastOnce();
        org.easymock.EasyMock.replay(repositoryVersion, upgradeContext);
        java.util.Map<java.lang.String, java.lang.String> commandParams = new java.util.HashMap<>();
        commandParams.put("clusterName", "c1");
        ...
        org.easymock.EasyMock.replay(artifactDAO, entity, ambariMetaInfo, kerberosDescriptorFactory);
        action.execute(null);
        org.easymock.EasyMock.verify(artifactDAO);
