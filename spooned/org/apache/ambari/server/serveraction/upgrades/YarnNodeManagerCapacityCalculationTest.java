...
public class YarnNodeManagerCapacityCalculationTest {
    ...
    public void setup() throws java.lang.Exception {
        ...
        agentConfigsHolder = org.easymock.EasyMock.createMock(org.apache.ambari.server.agent.stomp.AgentConfigsHolder.class);
        ...
        org.easymock.EasyMock.expect(yarnConfig.getType()).andReturn(org.apache.ambari.server.serveraction.upgrades.YarnNodeManagerCapacityCalculationTest.YARN_SITE_CONFIG_TYPE).anyTimes();
        org.easymock.EasyMock.expect(yarnConfig.getProperties()).andReturn(mockYarnProperties).anyTimes();
        org.easymock.EasyMock.expect(cluster.getDesiredConfigByType(org.apache.ambari.server.serveraction.upgrades.YarnNodeManagerCapacityCalculationTest.YARN_SITE_CONFIG_TYPE)).andReturn(yarnConfig).anyTimes();
        ...
        org.easymock.EasyMock.expect(hbaseEnvConfig.getType()).andReturn(org.apache.ambari.server.serveraction.upgrades.YarnNodeManagerCapacityCalculationTest.YARN_HBASE_ENV_CONFIG_TYPE).anyTimes();
        org.easymock.EasyMock.expect(hbaseEnvConfig.getProperties()).andReturn(mockHbaseEnvProps).anyTimes();
        org.easymock.EasyMock.expect(cluster.getDesiredConfigByType(org.apache.ambari.server.serveraction.upgrades.YarnNodeManagerCapacityCalculationTest.YARN_HBASE_ENV_CONFIG_TYPE)).andReturn(hbaseEnvConfig).anyTimes();
        ...
        org.easymock.EasyMock.expect(yarnEnvConfig.getType()).andReturn(org.apache.ambari.server.serveraction.upgrades.YarnNodeManagerCapacityCalculationTest.YARN_ENV_CONFIG_TYPE).anyTimes();
        org.easymock.EasyMock.expect(yarnEnvConfig.getProperties()).andReturn(mockYarnEnvProps).anyTimes();
        org.easymock.EasyMock.expect(cluster.getDesiredConfigByType(org.apache.ambari.server.serveraction.upgrades.YarnNodeManagerCapacityCalculationTest.YARN_ENV_CONFIG_TYPE)).andReturn(yarnEnvConfig).anyTimes();
        ...
        org.easymock.EasyMock.expect(yarnCsConfig.getType()).andReturn(org.apache.ambari.server.serveraction.upgrades.YarnNodeManagerCapacityCalculationTest.CAPACITY_SCHEDULER_CONFIG_TYPE).anyTimes();
        org.easymock.EasyMock.expect(yarnCsConfig.getProperties()).andReturn(mockCsProps).anyTimes();
        org.easymock.EasyMock.expect(cluster.getDesiredConfigByType(org.apache.ambari.server.serveraction.upgrades.YarnNodeManagerCapacityCalculationTest.CAPACITY_SCHEDULER_CONFIG_TYPE)).andReturn(yarnCsConfig).anyTimes();
        org.easymock.EasyMock.expect(m_clusters.getCluster(((java.lang.String) (org.easymock.EasyMock.anyObject())))).andReturn(cluster).anyTimes();
        org.easymock.EasyMock.expect(m_injector.getInstance(org.apache.ambari.server.state.Clusters.class)).andReturn(m_clusters).atLeastOnce();
        org.easymock.EasyMock.expect(cluster.getClusterId()).andReturn(1L).atLeastOnce();
        org.easymock.EasyMock.expect(cluster.getHosts()).andReturn(java.util.Collections.emptyList()).atLeastOnce();
        ...
        org.easymock.EasyMock.expect(cluster.getService("YARN")).andReturn(service);
        org.mockito.Mockito.when(service.getServiceComponent("NODEMANAGER")).thenReturn(serviceComponent);
        agentConfigsHolder.updateData(org.easymock.EasyMock.eq(1L), org.easymock.EasyMock.eq(java.util.Collections.emptyList()));
        org.easymock.EasyMock.expectLastCall().atLeastOnce();
        org.easymock.EasyMock.replay(m_injector, m_clusters, yarnConfig, hbaseEnvConfig, yarnEnvConfig, yarnCsConfig, agentConfigsHolder);
    ...
    private org.apache.ambari.server.serveraction.upgrades.YarnNodeManagerCapacityCalculation getYarnNodeManagerCapacityCalculation() throws java.lang.IllegalAccessException {
        ...
        org.easymock.EasyMock.expect(hrc.getRequestId()).andReturn(1L).anyTimes();
        org.easymock.EasyMock.expect(hrc.getStageId()).andReturn(2L).anyTimes();
        org.easymock.EasyMock.expect(hrc.getExecutionCommandWrapper()).andReturn(new org.apache.ambari.server.actionmanager.ExecutionCommandWrapper(executionCommand)).anyTimes();
        org.easymock.EasyMock.replay(cluster, hrc);
