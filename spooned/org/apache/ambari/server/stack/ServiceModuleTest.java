...
public class ServiceModuleTest {
    ...
    public void testServiceCheckRegistered() throws java.lang.Exception {
        ...
        info.setCommandScript(org.easymock.EasyMock.createNiceMock(org.apache.ambari.server.state.CommandScriptDefinition.class));
    ...
    private org.apache.ambari.server.stack.ServiceDirectory createServiceDirectory(java.lang.String dir, org.apache.ambari.server.stack.ConfigurationDirectory configDir) {
        org.apache.ambari.server.stack.ServiceDirectory serviceDirectory = org.easymock.EasyMock.createNiceMock(org.apache.ambari.server.stack.ServiceDirectory.class);
        org.easymock.EasyMock.expect(serviceDirectory.getConfigurationDirectory(dir, org.apache.ambari.server.stack.StackDirectory.SERVICE_PROPERTIES_FOLDER_NAME)).andReturn(configDir).anyTimes();
        org.easymock.EasyMock.expect(serviceDirectory.getMetricsFile(org.easymock.EasyMock.anyObject(java.lang.String.class))).andReturn(new java.io.File("testMetricsFile")).anyTimes();
        org.easymock.EasyMock.expect(serviceDirectory.getWidgetsDescriptorFile(org.easymock.EasyMock.anyObject(java.lang.String.class))).andReturn(new java.io.File("testWidgetsFile")).anyTimes();
        org.easymock.EasyMock.expect(serviceDirectory.getAlertsFile()).andReturn(new java.io.File("testAlertsFile")).anyTimes();
        org.easymock.EasyMock.expect(serviceDirectory.getKerberosDescriptorFile()).andReturn(new java.io.File("testKerberosDescriptorFile")).anyTimes();
        org.easymock.EasyMock.expect(serviceDirectory.getPackageDir()).andReturn("packageDir").anyTimes();
        org.easymock.EasyMock.replay(serviceDirectory);
    ...
    private org.apache.ambari.server.stack.ConfigurationDirectory createConfigurationDirectory(java.util.Collection<org.apache.ambari.server.stack.ConfigurationModule> modules) {
        org.apache.ambari.server.stack.ConfigurationDirectory configDir = org.easymock.EasyMock.createNiceMock(org.apache.ambari.server.stack.ConfigurationDirectory.class);
        org.easymock.EasyMock.expect(configDir.getConfigurationModules()).andReturn(modules).anyTimes();
        org.easymock.EasyMock.replay(configDir);
        return configDir;
    }
    ...
    private org.apache.ambari.server.stack.StackContext createStackContext(java.lang.String serviceName, boolean expectServiceRegistration) {
        org.apache.ambari.server.stack.StackContext context = org.easymock.EasyMock.createStrictMock(org.apache.ambari.server.stack.StackContext.class);
