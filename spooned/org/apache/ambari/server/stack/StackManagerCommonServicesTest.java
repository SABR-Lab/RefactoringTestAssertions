...
public class StackManagerCommonServicesTest {
    ...
    public static org.apache.ambari.server.stack.StackManager createTestStackManager(java.lang.String stackRoot, java.lang.String commonServicesRoot, java.lang.String extensionRoot) throws java.lang.Exception {
        org.apache.ambari.server.stack.StackManagerCommonServicesTest.metaInfoDao = org.easymock.EasyMock.createNiceMock(org.apache.ambari.server.orm.dao.MetainfoDAO.class);
        org.apache.ambari.server.stack.StackManagerCommonServicesTest.stackDao = org.easymock.EasyMock.createNiceMock(org.apache.ambari.server.orm.dao.StackDAO.class);
        org.apache.ambari.server.stack.StackManagerCommonServicesTest.extensionDao = org.easymock.EasyMock.createNiceMock(org.apache.ambari.server.orm.dao.ExtensionDAO.class);
        org.apache.ambari.server.stack.StackManagerCommonServicesTest.linkDao = org.easymock.EasyMock.createNiceMock(org.apache.ambari.server.orm.dao.ExtensionLinkDAO.class);
        org.apache.ambari.server.stack.StackManagerCommonServicesTest.actionMetadata = org.easymock.EasyMock.createNiceMock(org.apache.ambari.server.metadata.ActionMetadata.class);
        org.apache.ambari.server.configuration.Configuration config = org.easymock.EasyMock.createNiceMock(org.apache.ambari.server.configuration.Configuration.class);
        org.apache.ambari.server.orm.entities.StackEntity stackEntity = org.easymock.EasyMock.createNiceMock(org.apache.ambari.server.orm.entities.StackEntity.class);
        org.apache.ambari.server.orm.entities.ExtensionEntity extensionEntity = org.easymock.EasyMock.createNiceMock(org.apache.ambari.server.orm.entities.ExtensionEntity.class);
        org.easymock.EasyMock.expect(config.getSharedResourcesDirPath()).andReturn(java.lang.ClassLoader.getSystemClassLoader().getResource("").getPath()).anyTimes();
        org.easymock.EasyMock.expect(org.apache.ambari.server.stack.StackManagerCommonServicesTest.stackDao.find(org.easymock.EasyMock.anyObject(java.lang.String.class), org.easymock.EasyMock.anyObject(java.lang.String.class))).andReturn(stackEntity).atLeastOnce();
        org.easymock.EasyMock.expect(org.apache.ambari.server.stack.StackManagerCommonServicesTest.extensionDao.find(org.easymock.EasyMock.anyObject(java.lang.String.class), org.easymock.EasyMock.anyObject(java.lang.String.class))).andReturn(extensionEntity).atLeastOnce();
        java.util.List<org.apache.ambari.server.orm.entities.ExtensionLinkEntity> list = java.util.Collections.emptyList();
        org.easymock.EasyMock.expect(org.apache.ambari.server.stack.StackManagerCommonServicesTest.linkDao.findByStack(org.easymock.EasyMock.anyObject(java.lang.String.class), org.easymock.EasyMock.anyObject(java.lang.String.class))).andReturn(list).atLeastOnce();
        org.easymock.EasyMock.replay(config, org.apache.ambari.server.stack.StackManagerCommonServicesTest.stackDao, org.apache.ambari.server.stack.StackManagerCommonServicesTest.extensionDao, org.apache.ambari.server.stack.StackManagerCommonServicesTest.linkDao);
        ...
        org.easymock.EasyMock.replay(org.apache.ambari.server.stack.StackManagerCommonServicesTest.metaInfoDao, org.apache.ambari.server.stack.StackManagerCommonServicesTest.actionMetadata);
