...
public class StackManagerMiscTest {
    ...
    public void testCycleDetection() throws java.lang.Exception {
        ...
        org.easymock.EasyMock.expect(stackDao.find(org.easymock.EasyMock.anyObject(java.lang.String.class), org.easymock.EasyMock.anyObject(java.lang.String.class))).andReturn(stackEntity).atLeastOnce();
        ...
        org.easymock.EasyMock.replay(actionMetadata, stackDao, extensionDao, linkDao, metaInfoDao, osFamily);
    ...
    public void testGetServiceInfoFromSingleStack() throws java.lang.Exception {
        ...
        java.util.List<org.apache.ambari.server.orm.entities.ExtensionLinkEntity> list = java.util.Collections.emptyList();
        org.easymock.EasyMock.expect(linkDao.findByStack(org.easymock.EasyMock.anyObject(java.lang.String.class), org.easymock.EasyMock.anyObject(java.lang.String.class))).andReturn(list).atLeastOnce();
        org.easymock.EasyMock.replay(metaInfoDao, stackDao, extensionDao, linkDao, actionMetadata, osFamily);
        ...
        org.easymock.EasyMock.verify(metaInfoDao, stackDao, actionMetadata, osFamily);
    }
