...
public class StackManagerTest {
    ...
    public static org.apache.ambari.server.stack.StackManager createTestStackManager(java.lang.String stackRoot) throws java.lang.Exception {
        org.apache.ambari.server.stack.StackManagerTest.metaInfoDao = org.easymock.EasyMock.createNiceMock(org.apache.ambari.server.orm.dao.MetainfoDAO.class);
        org.apache.ambari.server.stack.StackManagerTest.stackDao = org.easymock.EasyMock.createNiceMock(org.apache.ambari.server.orm.dao.StackDAO.class);
        org.apache.ambari.server.stack.StackManagerTest.extensionDao = org.easymock.EasyMock.createNiceMock(org.apache.ambari.server.orm.dao.ExtensionDAO.class);
        org.apache.ambari.server.stack.StackManagerTest.linkDao = org.easymock.EasyMock.createNiceMock(org.apache.ambari.server.orm.dao.ExtensionLinkDAO.class);
        org.apache.ambari.server.stack.StackManagerTest.actionMetadata = org.easymock.EasyMock.createNiceMock(org.apache.ambari.server.metadata.ActionMetadata.class);
        ...
        org.easymock.EasyMock.expect(org.apache.ambari.server.stack.StackManagerTest.extensionDao.find(org.easymock.EasyMock.anyObject(java.lang.String.class), org.easymock.EasyMock.anyObject(java.lang.String.class))).andReturn(extensionEntity).atLeastOnce();
        java.util.List<org.apache.ambari.server.orm.entities.ExtensionLinkEntity> list = java.util.Collections.emptyList();
        org.easymock.EasyMock.expect(org.apache.ambari.server.stack.StackManagerTest.linkDao.findByStack(org.easymock.EasyMock.anyObject(java.lang.String.class), org.easymock.EasyMock.anyObject(java.lang.String.class))).andReturn(list).atLeastOnce();
        org.easymock.EasyMock.replay(config, org.apache.ambari.server.stack.StackManagerTest.metaInfoDao, org.apache.ambari.server.stack.StackManagerTest.stackDao, org.apache.ambari.server.stack.StackManagerTest.extensionDao, org.apache.ambari.server.stack.StackManagerTest.linkDao, org.apache.ambari.server.stack.StackManagerTest.actionMetadata);
        ...
        org.easymock.EasyMock.verify(config, org.apache.ambari.server.stack.StackManagerTest.metaInfoDao, org.apache.ambari.server.stack.StackManagerTest.stackDao, org.apache.ambari.server.stack.StackManagerTest.actionMetadata);
        return stackManager;
    }
    ...
    public void testMetricsLoaded() throws java.lang.Exception {
        ...
        org.apache.ambari.server.orm.entities.ExtensionEntity extensionEntity = org.easymock.EasyMock.createNiceMock(org.apache.ambari.server.orm.entities.ExtensionEntity.class);
        org.easymock.EasyMock.expect(config.getSharedResourcesDirPath()).andReturn(java.lang.ClassLoader.getSystemClassLoader().getResource("").getPath()).anyTimes();
        org.easymock.EasyMock.expect(extensionDao.find(org.easymock.EasyMock.anyObject(java.lang.String.class), org.easymock.EasyMock.anyObject(java.lang.String.class))).andReturn(extensionEntity).atLeastOnce();
        java.util.List<org.apache.ambari.server.orm.entities.ExtensionLinkEntity> list = java.util.Collections.emptyList();
        ...
        org.easymock.EasyMock.replay(config, metaInfoDao, stackDao, extensionDao, linkDao, actionMetadata);
