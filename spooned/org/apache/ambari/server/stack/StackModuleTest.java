...
public class StackModuleTest {
    ...
    private static org.apache.ambari.server.stack.StackModule createStackModule(java.lang.String stackName, java.lang.String stackVersion, com.google.common.base.Optional<? extends java.util.List<org.apache.ambari.server.state.RepositoryInfo>> stackRepos, java.util.List<org.apache.ambari.server.state.RepositoryInfo>... serviceRepoLists) throws org.apache.ambari.server.AmbariException {
        org.apache.ambari.server.stack.StackDirectory sd = org.mockito.Mockito.mock(org.apache.ambari.server.stack.StackDirectory.class);
        ...
        for (java.util.List<org.apache.ambari.server.state.RepositoryInfo> serviceRepoList : serviceRepoLists) {
            org.apache.ambari.server.stack.StackServiceDirectory svd = org.mockito.Mockito.mock(org.apache.ambari.server.stack.StackServiceDirectory.class);
            org.apache.ambari.server.state.stack.RepositoryXml serviceRepoXml = org.mockito.Mockito.mock(org.apache.ambari.server.state.stack.RepositoryXml.class);
            org.mockito.Mockito.when(svd.getRepoFile()).thenReturn(serviceRepoXml);
            org.mockito.Mockito.when(serviceRepoXml.getRepositories()).thenReturn(serviceRepoList);
            org.apache.ambari.server.state.stack.ServiceMetainfoXml serviceMetainfoXml = org.mockito.Mockito.mock(org.apache.ambari.server.state.stack.ServiceMetainfoXml.class);
            org.mockito.Mockito.when(serviceMetainfoXml.isValid()).thenReturn(true);
            org.apache.ambari.server.state.ServiceInfo serviceInfo = org.mockito.Mockito.mock(org.apache.ambari.server.state.ServiceInfo.class);
            org.mockito.Mockito.when(serviceInfo.isValid()).thenReturn(true);
            org.mockito.Mockito.when(serviceInfo.getName()).thenReturn(java.util.UUID.randomUUID().toString());
            org.mockito.Mockito.when(serviceMetainfoXml.getServices()).thenReturn(com.google.common.collect.Lists.newArrayList(serviceInfo));
            org.mockito.Mockito.when(svd.getMetaInfoFile()).thenReturn(serviceMetainfoXml);
            serviceDirectories.add(svd);
        }
        if (stackRepos.isPresent()) {
            org.apache.ambari.server.state.stack.RepositoryXml stackRepoXml = org.mockito.Mockito.mock(org.apache.ambari.server.state.stack.RepositoryXml.class);
            org.mockito.Mockito.when(sd.getRepoFile()).thenReturn(stackRepoXml);
            org.mockito.Mockito.when(stackRepoXml.getRepositories()).thenReturn(stackRepos.get());
        }
        org.mockito.Mockito.when(sd.getServiceDirectories()).thenReturn(serviceDirectories);
        org.mockito.Mockito.when(sd.getStackDirName()).thenReturn(stackName);
        org.mockito.Mockito.when(sd.getDirectory()).thenReturn(new java.io.File(stackVersion));
        org.apache.ambari.server.stack.StackContext ctx = org.mockito.Mockito.mock(org.apache.ambari.server.stack.StackContext.class);
