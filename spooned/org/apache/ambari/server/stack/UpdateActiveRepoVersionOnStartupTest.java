...
public class UpdateActiveRepoVersionOnStartupTest {
    ...
    private void verifyRepoIsAdded() throws java.lang.Exception {
        org.mockito.Mockito.verify(repositoryVersionDao, org.mockito.Mockito.atLeast(1)).merge(org.mockito.Mockito.any(org.apache.ambari.server.orm.entities.RepositoryVersionEntity.class));
    }

    public void init(boolean addClusterVersion) throws java.lang.Exception {
        org.apache.ambari.server.orm.dao.ClusterDAO clusterDao = org.mockito.Mockito.mock(org.apache.ambari.server.orm.dao.ClusterDAO.class);
        repositoryVersionDao = org.mockito.Mockito.mock(org.apache.ambari.server.orm.dao.RepositoryVersionDAO.class);
        ...
        org.apache.ambari.server.stack.StackManager stackManager = org.mockito.Mockito.mock(org.apache.ambari.server.stack.StackManager.class);
        org.mockito.Mockito.when(metaInfo.getStackManager()).thenReturn(stackManager);
        ...
        org.mockito.Mockito.when(clusterDao.findAll()).thenReturn(com.google.common.collect.ImmutableList.of(cluster));
        ...
        org.mockito.Mockito.when(stackManager.getStack("HDP", "2.3")).thenReturn(stackInfo);
        final com.google.inject.Provider<org.apache.ambari.server.stack.upgrade.RepositoryVersionHelper> repositoryVersionHelperProvider = org.mockito.Mockito.mock(com.google.inject.Provider.class);
        org.mockito.Mockito.when(repositoryVersionHelperProvider.get()).thenReturn(repositoryVersionHelper);
