...
public class UpgradeContextTest extends org.easymock.EasyMockSupport {
    ...
    public void setup() throws java.lang.Exception {
        injectMocks(this);
        org.easymock.EasyMock.expect(m_ambariMetaInfo.getUpgradePacks(org.easymock.EasyMock.anyString(), org.easymock.EasyMock.anyString())).andReturn(java.util.Collections.emptyMap()).anyTimes();
        org.easymock.EasyMock.expect(m_sourceRepositoryVersion.getId()).andReturn(1L).anyTimes();
        org.easymock.EasyMock.expect(m_sourceRepositoryVersion.getStackId()).andReturn(new org.apache.ambari.server.state.StackId("HDP", "2.6")).anyTimes();
        org.easymock.EasyMock.expect(m_sourceRepositoryVersion.getVersion()).andReturn("2.6.0.0").anyTimes();
        org.easymock.EasyMock.expect(m_targetRepositoryVersion.getId()).andReturn(99L).anyTimes();
        org.easymock.EasyMock.expect(m_targetRepositoryVersion.getStackId()).andReturn(new org.apache.ambari.server.state.StackId("HDP", "2.6")).anyTimes();
        org.easymock.EasyMock.expect(m_targetRepositoryVersion.getVersion()).andReturn("2.6.0.2").anyTimes();
        ...
        org.easymock.EasyMock.expect(upgradeHistoryEntity.getServiceName()).andReturn(org.apache.ambari.server.stack.upgrade.orchestrate.UpgradeContextTest.HDFS_SERVICE_NAME).anyTimes();
        org.easymock.EasyMock.expect(upgradeHistoryEntity.getFromReposistoryVersion()).andReturn(m_sourceRepositoryVersion).anyTimes();
        org.easymock.EasyMock.expect(upgradeHistoryEntity.getTargetRepositoryVersion()).andReturn(m_targetRepositoryVersion).anyTimes();
        m_upgradeHistory = com.google.common.collect.Lists.newArrayList(upgradeHistoryEntity);
        org.easymock.EasyMock.expect(m_repositoryVersionDAO.findByPK(1L)).andReturn(m_sourceRepositoryVersion).anyTimes();
        org.easymock.EasyMock.expect(m_repositoryVersionDAO.findByPK(99L)).andReturn(m_targetRepositoryVersion).anyTimes();
        org.easymock.EasyMock.expect(m_upgradeDAO.findUpgrade(1L)).andReturn(m_completedRevertableUpgrade).anyTimes();
        org.easymock.EasyMock.expect(m_upgradeDAO.findLastUpgradeForCluster(org.easymock.EasyMock.anyLong(), org.easymock.EasyMock.eq(org.apache.ambari.server.stack.upgrade.Direction.UPGRADE))).andReturn(m_completedRevertableUpgrade).anyTimes();
        org.easymock.EasyMock.expect(m_completedRevertableUpgrade.getId()).andReturn(1L).anyTimes();
        org.easymock.EasyMock.expect(m_completedRevertableUpgrade.getDirection()).andReturn(org.apache.ambari.server.stack.upgrade.Direction.UPGRADE).anyTimes();
        org.easymock.EasyMock.expect(m_completedRevertableUpgrade.getRepositoryVersion()).andReturn(m_targetRepositoryVersion).anyTimes();
        org.easymock.EasyMock.expect(m_completedRevertableUpgrade.getOrchestration()).andReturn(org.apache.ambari.spi.RepositoryType.PATCH).anyTimes();
        org.easymock.EasyMock.expect(m_completedRevertableUpgrade.getHistory()).andReturn(m_upgradeHistory).anyTimes();
        org.easymock.EasyMock.expect(m_completedRevertableUpgrade.getUpgradePackage()).andReturn("myUpgradePack").anyTimes();
        org.easymock.EasyMock.expect(m_completedRevertableUpgrade.getUpgradePackStackId()).andReturn(new org.apache.ambari.server.state.StackId(((java.lang.String) (null)))).anyTimes();
        ...
        org.easymock.EasyMock.expect(hdfsRepositoryVersion.getId()).andReturn(1L).anyTimes();
        org.easymock.EasyMock.expect(hdfsRepositoryVersion.getStackId()).andReturn(new org.apache.ambari.server.state.StackId("HDP-2.6")).anyTimes();
        org.easymock.EasyMock.expect(m_hdfsService.getDesiredRepositoryVersion()).andReturn(hdfsRepositoryVersion).anyTimes();
        org.easymock.EasyMock.expect(m_zookeeperService.getDesiredRepositoryVersion()).andReturn(hdfsRepositoryVersion).anyTimes();
        org.easymock.EasyMock.expect(m_cluster.getService(org.apache.ambari.server.stack.upgrade.orchestrate.UpgradeContextTest.HDFS_SERVICE_NAME)).andReturn(m_hdfsService).anyTimes();
        m_services.put(org.apache.ambari.server.stack.upgrade.orchestrate.UpgradeContextTest.HDFS_SERVICE_NAME, m_hdfsService);
        org.easymock.EasyMock.expect(m_cluster.getServices()).andReturn(m_services).anyTimes();
        org.easymock.EasyMock.expect(m_cluster.getClusterId()).andReturn(1L).anyTimes();
        org.easymock.EasyMock.expect(m_cluster.getClusterName()).andReturn("c1").anyTimes();
        org.easymock.EasyMock.expect(m_cluster.getUpgradeInProgress()).andReturn(null).atLeastOnce();
        org.easymock.EasyMock.expect(m_vdfXml.getClusterSummary(org.easymock.EasyMock.anyObject(org.apache.ambari.server.state.Cluster.class), org.easymock.EasyMock.anyObject(org.apache.ambari.server.api.services.AmbariMetaInfo.class))).andReturn(m_clusterVersionSummary).anyTimes();
    }
    ...
    public void testFullUpgrade() throws java.lang.Exception {
        ...
        org.easymock.EasyMock.expect(m_targetRepositoryVersion.getType()).andReturn(org.apache.ambari.spi.RepositoryType.STANDARD).atLeastOnce();
    ...
    public void testPatchUpgrade() throws java.lang.Exception {
        ...
        org.apache.ambari.server.stack.upgrade.UpgradePack upgradePack = createNiceMock(org.apache.ambari.server.stack.upgrade.UpgradePack.class);
        org.apache.ambari.server.api.services.AmbariMetaInfo ami = createNiceMock(org.apache.ambari.server.api.services.AmbariMetaInfo.class);
        org.easymock.EasyMock.expect(m_clusterVersionSummary.getAvailableServiceNames()).andReturn(com.google.common.collect.Sets.newHashSet(org.apache.ambari.server.stack.upgrade.orchestrate.UpgradeContextTest.HDFS_SERVICE_NAME)).once();
        org.easymock.EasyMock.expect(m_targetRepositoryVersion.getType()).andReturn(org.apache.ambari.spi.RepositoryType.PATCH).atLeastOnce();
        org.easymock.EasyMock.expect(m_targetRepositoryVersion.getRepositoryXml()).andReturn(m_vdfXml).once();
        org.easymock.EasyMock.expect(upgradeHelper.suggestUpgradePack(org.easymock.EasyMock.anyString(), org.easymock.EasyMock.anyObject(org.apache.ambari.server.state.StackId.class), org.easymock.EasyMock.anyObject(org.apache.ambari.server.state.StackId.class), org.easymock.EasyMock.anyObject(org.apache.ambari.server.stack.upgrade.Direction.class), org.easymock.EasyMock.anyObject(org.apache.ambari.spi.upgrade.UpgradeType.class), org.easymock.EasyMock.anyString())).andReturn(upgradePack).once();
        org.easymock.EasyMock.expect(m_cluster.getService(org.apache.ambari.server.stack.upgrade.orchestrate.UpgradeContextTest.ZOOKEEPER_SERVICE_NAME)).andReturn(m_zookeeperService).anyTimes();
    ...
    public void testMaintUpgrade() throws java.lang.Exception {
        ...
        org.apache.ambari.server.api.services.AmbariMetaInfo ami = createNiceMock(org.apache.ambari.server.api.services.AmbariMetaInfo.class);
        org.easymock.EasyMock.expect(m_clusterVersionSummary.getAvailableServiceNames()).andReturn(com.google.common.collect.Sets.newHashSet(org.apache.ambari.server.stack.upgrade.orchestrate.UpgradeContextTest.HDFS_SERVICE_NAME)).once();
        org.easymock.EasyMock.expect(m_targetRepositoryVersion.getType()).andReturn(org.apache.ambari.spi.RepositoryType.MAINT).atLeastOnce();
        org.easymock.EasyMock.expect(m_targetRepositoryVersion.getRepositoryXml()).andReturn(m_vdfXml).once();
        org.easymock.EasyMock.expect(upgradeHelper.suggestUpgradePack(org.easymock.EasyMock.anyString(), org.easymock.EasyMock.anyObject(org.apache.ambari.server.state.StackId.class), org.easymock.EasyMock.anyObject(org.apache.ambari.server.state.StackId.class), org.easymock.EasyMock.anyObject(org.apache.ambari.server.stack.upgrade.Direction.class), org.easymock.EasyMock.anyObject(org.apache.ambari.spi.upgrade.UpgradeType.class), org.easymock.EasyMock.anyString())).andReturn(upgradePack).once();
        org.easymock.EasyMock.expect(m_cluster.getService(org.apache.ambari.server.stack.upgrade.orchestrate.UpgradeContextTest.ZOOKEEPER_SERVICE_NAME)).andReturn(m_zookeeperService).anyTimes();
        m_services.put(org.apache.ambari.server.stack.upgrade.orchestrate.UpgradeContextTest.ZOOKEEPER_SERVICE_NAME, m_zookeeperService);
    ...
    public void testRevert() throws java.lang.Exception {
        ...
        org.easymock.EasyMock.expect(ami.getUpgradePacks(org.easymock.EasyMock.anyString(), org.easymock.EasyMock.anyString())).andReturn(map).anyTimes();
        org.easymock.EasyMock.expect(m_upgradeDAO.findRevertable(1L)).andReturn(m_completedRevertableUpgrade).once();
        java.util.Map<java.lang.String, java.lang.Object> requestMap = new java.util.HashMap<>();
        requestMap.put(org.apache.ambari.server.controller.internal.UpgradeResourceProvider.UPGRADE_TYPE, org.apache.ambari.spi.upgrade.UpgradeType.ROLLING.name());
    ...
    public void testRevertEU() throws java.lang.Exception {
        ...
        org.easymock.EasyMock.expect(ami.getUpgradePacks(org.easymock.EasyMock.anyString(), org.easymock.EasyMock.anyString())).andReturn(map).anyTimes();
        org.easymock.EasyMock.expect(m_upgradeDAO.findRevertable(1L)).andReturn(m_completedRevertableUpgrade).once();
        org.easymock.EasyMock.expect(m_completedRevertableUpgrade.getUpgradeType()).andReturn(org.apache.ambari.spi.upgrade.UpgradeType.NON_ROLLING);
        java.util.Map<java.lang.String, java.lang.Object> requestMap = new java.util.HashMap<>();
        requestMap.put(org.apache.ambari.server.controller.internal.UpgradeResourceProvider.UPGRADE_REVERT_UPGRADE_ID, "1");
        replayAll();
        org.apache.ambari.server.stack.upgrade.orchestrate.UpgradeContext context = new org.apache.ambari.server.stack.upgrade.orchestrate.UpgradeContext(m_cluster, requestMap, null, upgradeHelper, m_upgradeDAO, m_repositoryVersionDAO, configHelper, ami);
    ...
    public void testRevertWithDeletedService() throws java.lang.Exception {
        ...
        org.apache.ambari.server.api.services.AmbariMetaInfo ami = createNiceMock(org.apache.ambari.server.api.services.AmbariMetaInfo.class);
        org.apache.ambari.server.orm.entities.UpgradeHistoryEntity upgradeHistoryEntity = createNiceMock(org.apache.ambari.server.orm.entities.UpgradeHistoryEntity.class);
        org.easymock.EasyMock.expect(upgradeHistoryEntity.getServiceName()).andReturn(org.apache.ambari.server.stack.upgrade.orchestrate.UpgradeContextTest.ZOOKEEPER_SERVICE_NAME).anyTimes();
        org.easymock.EasyMock.expect(upgradeHistoryEntity.getFromReposistoryVersion()).andReturn(m_sourceRepositoryVersion).anyTimes();
        org.easymock.EasyMock.expect(upgradeHistoryEntity.getTargetRepositoryVersion()).andReturn(m_targetRepositoryVersion).anyTimes();
    ...
    public void testWrongUpgradeBeingReverted() throws java.lang.Exception {
        ...
        org.easymock.EasyMock.expect(repositoryVersionEntity.getVersion()).andReturn("1.2.3.4").anyTimes();
        ...
        org.easymock.EasyMock.expect(wrongRevertableUpgrade.getId()).andReturn(upgradeIdWhichCanBeReverted).atLeastOnce();
        org.easymock.EasyMock.expect(wrongRevertableUpgrade.getRepositoryVersion()).andReturn(repositoryVersionEntity).atLeastOnce();
        org.easymock.EasyMock.expect(m_upgradeDAO.findRevertable(1L)).andReturn(wrongRevertableUpgrade).once();
        java.util.Map<java.lang.String, java.lang.Object> requestMap = new java.util.HashMap<>();
        requestMap.put(org.apache.ambari.server.controller.internal.UpgradeResourceProvider.UPGRADE_TYPE, org.apache.ambari.spi.upgrade.UpgradeType.ROLLING.name());
