...
public class UpgradeHelperTest extends org.easymock.EasyMockSupport {
    ...
    private void setConfigMocks() throws java.lang.Exception {
        ...
        org.easymock.EasyMock.expect(m_configHelper.getPlaceholderValueFromDesiredConfigurations(org.easymock.EasyMock.anyObject(org.apache.ambari.server.state.Cluster.class), org.easymock.EasyMock.eq("{{foo/bar}}"))).andReturn("placeholder-rendered-properly").anyTimes();
        org.easymock.EasyMock.expect(m_configHelper.getEffectiveDesiredTags(org.easymock.EasyMock.anyObject(org.apache.ambari.server.state.Cluster.class), org.easymock.EasyMock.anyObject(java.lang.String.class))).andReturn(new java.util.HashMap<>()).anyTimes();
        org.easymock.EasyMock.expect(m_configHelper.getHostActualConfigs(org.easymock.EasyMock.anyLong())).andReturn(new org.apache.ambari.server.events.AgentConfigsUpdateEvent(null, java.util.Collections.emptySortedMap())).anyTimes();
        org.easymock.EasyMock.expect(m_configHelper.getChangedConfigTypes(org.easymock.EasyMock.anyObject(org.apache.ambari.server.state.Cluster.class), org.easymock.EasyMock.anyObject(org.apache.ambari.server.orm.entities.ServiceConfigEntity.class), org.easymock.EasyMock.anyLong(), org.easymock.EasyMock.anyLong(), org.easymock.EasyMock.anyString())).andReturn(java.util.Collections.emptyMap()).anyTimes();
    }
    ...
    public void teardown() throws org.apache.ambari.server.AmbariException, java.sql.SQLException {
        try {
            ...
            org.easymock.EasyMock.reset(m_configHelper, m_masterHostResolver);
        }
    }
    ...
    public void testUpgradeOrchestrationWithHostsInMM() throws java.lang.Exception {
        ...
        org.easymock.EasyMock.expect(context.getResolver()).andReturn(masterHostResolver).anyTimes();
    ...
    private org.apache.ambari.server.state.Cluster makeCluster(boolean clean, java.util.Set<java.lang.String> additionalServices, java.lang.String yamlFileName) throws org.apache.ambari.server.AmbariException, org.apache.ambari.server.security.authorization.AuthorizationException {
        ...
        org.easymock.EasyMock.expect(m_masterHostResolver.getMasterAndHosts("ZOOKEEPER", "ZOOKEEPER_SERVER")).andReturn(type).anyTimes();
        org.easymock.EasyMock.expect(m_masterHostResolver.getMasterAndHosts("ZOOKEEPER", "ZOOKEEPER_CLIENT")).andReturn(type).anyTimes();
        org.easymock.EasyMock.expect(m_masterHostResolver.getMasterAndHosts("HDFS", "NAMENODE")).andReturn(namenodeHosts).anyTimes();
        if (clean) {
        ...
        org.easymock.EasyMock.expect(m_masterHostResolver.getMasterAndHosts("HDFS", "DATANODE")).andReturn(type).anyTimes();
        type = org.apache.ambari.server.stack.HostsType.normal("h2");
        org.easymock.EasyMock.expect(m_masterHostResolver.getMasterAndHosts("YARN", "RESOURCEMANAGER")).andReturn(type).anyTimes();
        type = org.apache.ambari.server.stack.HostsType.normal(com.google.common.collect.Sets.newLinkedHashSet());
        org.easymock.EasyMock.expect(m_masterHostResolver.getMasterAndHosts("YARN", "APP_TIMELINE_SERVER")).andReturn(type).anyTimes();
        type = org.apache.ambari.server.stack.HostsType.normal("h1", "h3");
        org.easymock.EasyMock.expect(m_masterHostResolver.getMasterAndHosts("YARN", "NODEMANAGER")).andReturn(type).anyTimes();
        org.easymock.EasyMock.expect(m_masterHostResolver.getMasterAndHosts("HIVE", "HIVE_SERVER")).andReturn(type).anyTimes();
        type = org.apache.ambari.server.stack.HostsType.normal("h2", "h3");
        org.easymock.EasyMock.expect(m_masterHostResolver.getMasterAndHosts("OOZIE", "OOZIE_SERVER")).andReturn(type).anyTimes();
        type = org.apache.ambari.server.stack.HostsType.normal("h1", "h2", "h3");
        org.easymock.EasyMock.expect(m_masterHostResolver.getMasterAndHosts("OOZIE", "OOZIE_CLIENT")).andReturn(type).anyTimes();
        org.easymock.EasyMock.expect(m_masterHostResolver.getCluster()).andReturn(c).anyTimes();
        org.easymock.EasyMock.expect(m_masterHostResolver.getValueFromDesiredConfigurations("cluster-env", "rack_yaml_file_path")).andReturn(yamlFileName).anyTimes();
        for (java.lang.String service : additionalServices) {
            ...
            if (service.equals("HBASE")) {
                ...
                org.easymock.EasyMock.expect(m_masterHostResolver.getMasterAndHosts("HBASE", "HBASE_MASTER")).andReturn(type).anyTimes();
            }
        }
        org.easymock.EasyMock.replay(m_masterHostResolver);
        return c;
    }
    ...
    public void testDowngradeAfterPartialUpgrade() throws java.lang.Exception {
        ...
        org.easymock.EasyMock.expect(m_masterHostResolver.getMasterAndHosts("ZOOKEEPER", "ZOOKEEPER_SERVER")).andReturn(null).anyTimes();
        org.easymock.EasyMock.expect(m_masterHostResolver.getMasterAndHosts("HDFS", "NAMENODE")).andReturn(type).anyTimes();
        org.easymock.EasyMock.expect(m_masterHostResolver.getCluster()).andReturn(c).anyTimes();
        org.easymock.EasyMock.replay(m_masterHostResolver);
    ...
    public void testResolverWithFailedUpgrade() throws java.lang.Exception {
        ...
        org.easymock.EasyMock.expect(context.getResolver()).andReturn(resolver).anyTimes();
        org.easymock.EasyMock.replay(context);
    ...
    public void testResolverCaseInsensitive() throws java.lang.Exception {
        ...
        org.junit.Assert.assertEquals(2, schs.size());
        setConfigMocks();
        org.easymock.EasyMock.expect(m_configHelper.getValueFromDesiredConfigurations(c, "hdfs-site", "dfs.internal.nameservices")).andReturn("ha").anyTimes();
        org.easymock.EasyMock.expect(m_configHelper.getValueFromDesiredConfigurations(c, "hdfs-site", "dfs.ha.namenodes.ha")).andReturn("nn1,nn2").anyTimes();
        org.easymock.EasyMock.expect(m_configHelper.getValueFromDesiredConfigurations(c, "hdfs-site", "dfs.http.policy")).andReturn("HTTP_ONLY").anyTimes();
        org.easymock.EasyMock.expect(m_configHelper.getValueFromDesiredConfigurations(c, "hdfs-site", "dfs.namenode.http-address.ha.nn1")).andReturn("H1:50070").anyTimes();
        org.easymock.EasyMock.expect(m_configHelper.getValueFromDesiredConfigurations(c, "hdfs-site", "dfs.namenode.http-address.ha.nn2")).andReturn("H2:50070").anyTimes();
        org.easymock.EasyMock.replay(m_configHelper);
        ...
        org.easymock.EasyMock.expect(context.getResolver()).andReturn(mhr).anyTimes();
        org.easymock.EasyMock.replay(context);
    ...
    public void testMultipleServerTasks() throws java.lang.Exception {
        ...
        type = org.apache.ambari.server.stack.HostsType.normal("h1", "h2");
        org.easymock.EasyMock.expect(m_masterHostResolver.getMasterAndHosts("ZOOKEEPER", "ZOOKEEPER_CLIENT")).andReturn(type).anyTimes();
        org.easymock.EasyMock.expect(m_masterHostResolver.getValueFromDesiredConfigurations("cluster-env", "rack_yaml_file_path")).andReturn("").anyTimes();
        org.easymock.EasyMock.replay(m_masterHostResolver);
        java.util.Map<java.lang.String, org.apache.ambari.server.stack.upgrade.UpgradePack> upgrades = ambariMetaInfo.getUpgradePacks("HDP", "2.1.1");
        org.apache.ambari.server.state.ServiceInfo si = ambariMetaInfo.getService("HDP", "2.1.1", "ZOOKEEPER");
        si.setDisplayName("Zk");
    ...
    public void testUpgradeConditions() throws java.lang.Exception {
        ...
        org.easymock.EasyMock.expect(kerberosDetails.getKdcType()).andReturn(org.apache.ambari.server.serveraction.kerberos.KDCType.NONE).atLeastOnce();
        org.easymock.EasyMock.replay(kerberosDetails);
        ...
        org.easymock.EasyMock.expect(context.getKerberosDetails()).andReturn(kerberosDetails).atLeastOnce();
        org.easymock.EasyMock.replay(context);
        java.util.List<org.apache.ambari.server.stack.upgrade.orchestrate.UpgradeGroupHolder> groups = m_upgradeHelper.createSequence(upgrade, context);
        org.junit.Assert.assertEquals(1, groups.size());
    ...
    public void testMergeConfigurations() throws java.lang.Exception {
        ...
        org.easymock.EasyMock.expect(repoVersion211.getStackId()).andReturn(stack211).atLeastOnce();
        org.easymock.EasyMock.expect(repoVersion211.getVersion()).andReturn(version211).atLeastOnce();
        org.easymock.EasyMock.expect(repoVersion220.getStackId()).andReturn(stack220).atLeastOnce();
        org.easymock.EasyMock.expect(repoVersion220.getVersion()).andReturn(version220).atLeastOnce();
        ...
        org.easymock.EasyMock.expect(fooConfigEntity.getType()).andReturn("foo-site");
        org.easymock.EasyMock.expect(barConfigEntity.getType()).andReturn("bar-site");
        org.easymock.EasyMock.expect(bazConfigEntity.getType()).andReturn("baz-site");
        ...
        org.easymock.EasyMock.expect(fooConfig.getType()).andReturn("foo-site").atLeastOnce();
        org.easymock.EasyMock.expect(barConfig.getType()).andReturn("bar-site").atLeastOnce();
        org.easymock.EasyMock.expect(bazConfig.getType()).andReturn("baz-site").atLeastOnce();
        org.easymock.EasyMock.expect(fooConfig.getProperties()).andReturn(existingFooType);
        org.easymock.EasyMock.expect(barConfig.getProperties()).andReturn(existingBarType);
        org.easymock.EasyMock.expect(bazConfig.getProperties()).andReturn(existingBazType);
        ...
        org.easymock.EasyMock.expect(zookeeper.getName()).andReturn("ZOOKEEPER").atLeastOnce();
        org.easymock.EasyMock.expect(zookeeper.getServiceComponents()).andReturn(new java.util.HashMap<>()).once();
        ...
        org.easymock.EasyMock.expect(cluster.getCurrentStackVersion()).andReturn(stack211).atLeastOnce();
        org.easymock.EasyMock.expect(cluster.getDesiredStackVersion()).andReturn(stack220);
        org.easymock.EasyMock.expect(cluster.getDesiredConfigs()).andReturn(desiredConfigurations);
        org.easymock.EasyMock.expect(cluster.getDesiredConfigByType("foo-site")).andReturn(fooConfig);
        org.easymock.EasyMock.expect(cluster.getDesiredConfigByType("bar-site")).andReturn(barConfig);
        org.easymock.EasyMock.expect(cluster.getDesiredConfigByType("baz-site")).andReturn(bazConfig);
        org.easymock.EasyMock.expect(cluster.getService("ZOOKEEPER")).andReturn(zookeeper);
        org.easymock.EasyMock.expect(cluster.getDesiredConfigByType("foo-type")).andReturn(fooConfig);
        org.easymock.EasyMock.expect(cluster.getDesiredConfigByType("bar-type")).andReturn(barConfig);
        org.easymock.EasyMock.expect(cluster.getDesiredConfigByType("baz-type")).andReturn(bazConfig);
        ...
        org.easymock.EasyMock.expect(configHelperProvider.get()).andStubReturn(configHelper);
        org.easymock.EasyMock.expect(configHelper.getDefaultProperties(stack211, "ZOOKEEPER")).andReturn(stack211Configs).anyTimes();
        org.easymock.EasyMock.expect(configHelper.getDefaultProperties(stack220, "ZOOKEEPER")).andReturn(stack220Configs).anyTimes();
        ...
        org.easymock.EasyMock.expect(configHelper.createConfigTypes(org.easymock.EasyMock.anyObject(org.apache.ambari.server.state.Cluster.class), org.easymock.EasyMock.anyObject(org.apache.ambari.server.state.StackId.class), org.easymock.EasyMock.anyObject(org.apache.ambari.server.controller.AmbariManagementController.class), org.easymock.EasyMock.capture(expectedConfigurationsCapture), org.easymock.EasyMock.anyObject(java.lang.String.class), org.easymock.EasyMock.anyObject(java.lang.String.class))).andReturn(true);
        ...
        org.easymock.EasyMock.expect(zookeeperServiceConfig.getClusterConfigEntities()).andReturn(com.google.common.collect.Lists.newArrayList(fooConfigEntity, barConfigEntity, bazConfigEntity));
        ...
        org.easymock.EasyMock.expect(serviceConfigDAOMock.getLastServiceConfigsForService(org.easymock.EasyMock.anyLong(), org.easymock.EasyMock.eq("ZOOKEEPER"))).andReturn(latestServiceConfigs).once();
        org.easymock.EasyMock.replay(serviceConfigDAOMock);
        ...
        org.easymock.EasyMock.expect(context.getCluster()).andReturn(cluster).atLeastOnce();
        org.easymock.EasyMock.expect(context.getType()).andReturn(org.apache.ambari.spi.upgrade.UpgradeType.ROLLING).atLeastOnce();
        org.easymock.EasyMock.expect(context.getDirection()).andReturn(org.apache.ambari.server.stack.upgrade.Direction.UPGRADE).atLeastOnce();
        org.easymock.EasyMock.expect(context.getRepositoryVersion()).andReturn(repoVersion220).anyTimes();
        org.easymock.EasyMock.expect(context.getSupportedServices()).andReturn(com.google.common.collect.Sets.newHashSet("ZOOKEEPER")).atLeastOnce();
        org.easymock.EasyMock.expect(context.getSourceRepositoryVersion(org.easymock.EasyMock.anyString())).andReturn(repoVersion211).atLeastOnce();
        org.easymock.EasyMock.expect(context.getTargetRepositoryVersion(org.easymock.EasyMock.anyString())).andReturn(repoVersion220).atLeastOnce();
        org.easymock.EasyMock.expect(context.getOrchestrationType()).andReturn(org.apache.ambari.spi.RepositoryType.STANDARD).anyTimes();
        org.easymock.EasyMock.expect(context.getAmbariMetaInfo()).andReturn(ambariMetaInfo).anyTimes();
        org.easymock.EasyMock.expect(context.getHostRoleCommandFactory()).andStubReturn(injector.getInstance(org.apache.ambari.server.actionmanager.HostRoleCommandFactory.class));
        org.easymock.EasyMock.expect(context.getRoleGraphFactory()).andStubReturn(injector.getInstance(org.apache.ambari.server.stageplanner.RoleGraphFactory.class));
        org.easymock.EasyMock.expect(context.getUpgradePack()).andReturn(upgradePack).atLeastOnce();
        replayAll();
    ...
    public void testMergeConfigurationsWithClusterEnv() throws java.lang.Exception {
        ...
        final org.apache.ambari.server.stack.upgrade.orchestrate.UpgradeHelperTest.ClusterEnvWrapper clusterEnvWrapper = new org.apache.ambari.server.stack.upgrade.orchestrate.UpgradeHelperTest.ClusterEnvWrapper();
        java.lang.System.out.println("Initial clusterEnvMap: " + clusterEnvWrapper.getClusterEnvMap());
        org.easymock.EasyMock.reset(m_configHelper);
        org.easymock.EasyMock.expect(m_configHelper.getDefaultProperties(oldStack, "HIVE")).andReturn(stackMap).atLeastOnce();
        org.easymock.EasyMock.expect(m_configHelper.getDefaultProperties(newStack, "HIVE")).andReturn(stackMap).atLeastOnce();
        org.easymock.EasyMock.expect(m_configHelper.getDefaultProperties(oldStack, "ZOOKEEPER")).andReturn(stackMap).atLeastOnce();
        org.easymock.EasyMock.expect(m_configHelper.getDefaultProperties(newStack, "ZOOKEEPER")).andReturn(stackMap).atLeastOnce();
        org.easymock.EasyMock.expect(m_configHelper.createConfigTypes(org.easymock.EasyMock.anyObject(org.apache.ambari.server.state.Cluster.class), org.easymock.EasyMock.anyObject(org.apache.ambari.server.state.StackId.class), org.easymock.EasyMock.anyObject(org.apache.ambari.server.controller.AmbariManagementController.class), org.apache.ambari.server.stack.upgrade.orchestrate.UpgradeHelperTest.eqClusterEnv(clusterEnvWrapper), org.easymock.EasyMock.anyString(), org.easymock.EasyMock.anyString())).andReturn(true);
        org.easymock.EasyMock.replay(m_configHelper);
        ...
        org.apache.ambari.server.stack.upgrade.orchestrate.UpgradeHelper upgradeHelper = injector.getInstance(org.apache.ambari.server.stack.upgrade.orchestrate.UpgradeHelper.class);
        upgradeHelper.updateDesiredRepositoriesAndConfigs(context);
        org.junit.Assert.assertEquals("b", clusterEnvWrapper.getClusterEnvMap().get("a"));
        org.junit.Assert.assertTrue(clusterEnvWrapper.getClusterEnvMap().containsKey("a"));
        stackManagerMock.invalidateCurrentPaths();
        ambariMetaInfo.init();
    }

    private static java.util.Map<java.lang.String, java.util.Map<java.lang.String, java.lang.String>> eqClusterEnv(final org.apache.ambari.server.stack.upgrade.orchestrate.UpgradeHelperTest.ClusterEnvWrapper wrapper) {
        org.easymock.EasyMock.reportMatcher(new org.easymock.IArgumentMatcher() {
            @java.lang.Override
            public boolean matches(java.lang.Object argument) {
                if (argument instanceof java.util.Map) {
                    java.util.Map<java.lang.String, java.util.Map<java.lang.String, java.lang.String>> map = ((java.util.Map<java.lang.String, java.util.Map<java.lang.String, java.lang.String>>) (argument));
    ...
    private static class ClusterEnvWrapper {
        private final java.util.Map<java.lang.String, java.lang.String> clusterEnvMap = new java.util.HashMap<>();

        public void updateClusterEnvMap(java.util.Map<java.lang.String, java.lang.String> newMap) {
            clusterEnvMap.putAll(newMap);
        }

        public java.util.Map<java.lang.String, java.lang.String> getClusterEnvMap() {
    ...
    public void testSequentialServiceChecksWithServiceCheckFailure() throws java.lang.Exception {
        ...
        org.easymock.EasyMock.expect(context.isServiceCheckFailureAutoSkipped()).andReturn(java.lang.Boolean.TRUE).atLeastOnce();
        org.easymock.EasyMock.replay(context);
        java.util.List<org.apache.ambari.server.stack.upgrade.orchestrate.UpgradeGroupHolder> groups = m_upgradeHelper.createSequence(upgrade, context);
        org.junit.Assert.assertEquals(5, groups.size());
        org.apache.ambari.server.stack.upgrade.orchestrate.UpgradeGroupHolder serviceCheckGroup = groups.get(2);
    ...
    public void testOrchestrationOptions() throws java.lang.Exception {
        ...
        org.easymock.EasyMock.expect(context.getOrchestrationOptions()).andReturn(options).anyTimes();
        org.easymock.EasyMock.replay(context);
        java.util.List<org.apache.ambari.server.stack.upgrade.orchestrate.UpgradeGroupHolder> groups = m_upgradeHelper.createSequence(upgrade, context);
    ...
    private org.apache.ambari.server.stack.upgrade.orchestrate.UpgradeContext getMockUpgradeContext(org.apache.ambari.server.state.Cluster cluster, org.apache.ambari.server.stack.upgrade.Direction direction, org.apache.ambari.spi.upgrade.UpgradeType type, org.apache.ambari.server.orm.entities.RepositoryVersionEntity repositoryVersion, final org.apache.ambari.spi.RepositoryType repositoryType, java.util.Set<java.lang.String> services, org.apache.ambari.server.stack.MasterHostResolver resolver, boolean replay) {
        ...
        org.easymock.EasyMock.expect(context.getCluster()).andReturn(cluster).anyTimes();
        org.easymock.EasyMock.expect(context.getType()).andReturn(type).anyTimes();
        org.easymock.EasyMock.expect(context.getDirection()).andReturn(direction).anyTimes();
        org.easymock.EasyMock.expect(context.getRepositoryVersion()).andReturn(repositoryVersion).anyTimes();
        org.easymock.EasyMock.expect(context.getSupportedServices()).andReturn(services).anyTimes();
        org.easymock.EasyMock.expect(context.getOrchestrationType()).andReturn(repositoryType).anyTimes();
        org.easymock.EasyMock.expect(context.getAmbariMetaInfo()).andReturn(ambariMetaInfo).anyTimes();
        org.easymock.EasyMock.expect(context.getHostRoleCommandFactory()).andStubReturn(injector.getInstance(org.apache.ambari.server.actionmanager.HostRoleCommandFactory.class));
        org.easymock.EasyMock.expect(context.getRoleGraphFactory()).andStubReturn(injector.getInstance(org.apache.ambari.server.stageplanner.RoleGraphFactory.class));
        if (null != resolver) {
        ...
        org.easymock.EasyMock.expect(context.getTargetRepositoryVersion(org.easymock.EasyMock.capture(repoVersionServiceName))).andAnswer(new org.easymock.IAnswer<org.apache.ambari.server.orm.entities.RepositoryVersionEntity>() {
            @java.lang.Override
        ...
        org.easymock.EasyMock.expect(context.isServiceSupported(org.easymock.EasyMock.capture(serviceNameSupported))).andAnswer(new org.easymock.IAnswer<java.lang.Boolean>() {
            @java.lang.Override
        ...
        org.easymock.EasyMock.expect(context.getServiceDisplay(org.easymock.EasyMock.capture(getServiceDisplayArgument1))).andAnswer(new org.easymock.IAnswer<java.lang.String>() {
            @java.lang.Override
        ...
        org.easymock.EasyMock.expect(context.getComponentDisplay(org.easymock.EasyMock.capture(getComponentDisplayArgument1), org.easymock.EasyMock.capture(getComponentDisplayArgument2))).andAnswer(new org.easymock.IAnswer<java.lang.String>() {
            @java.lang.Override
            public java.lang.String answer() {
        ...
        org.easymock.EasyMock.expect(context.isScoped(org.easymock.EasyMock.capture(isScopedCapture))).andStubAnswer(new org.easymock.IAnswer<java.lang.Boolean>() {
            @java.lang.Override
