...
public class TestStagePlanner {
    ...
    public void testSingleStagePlan() throws org.apache.ambari.server.AmbariException {
        org.apache.ambari.server.state.cluster.ClusterImpl cluster = org.mockito.Mockito.mock(org.apache.ambari.server.state.cluster.ClusterImpl.class);
        org.mockito.Mockito.when(cluster.getCurrentStackVersion()).thenReturn(new org.apache.ambari.server.state.StackId("HDP-2.0.6"));
    ...
    public void testSCCInGraphDetectedShort() {
        org.apache.ambari.server.state.cluster.ClusterImpl cluster = org.mockito.Mockito.mock(org.apache.ambari.server.state.cluster.ClusterImpl.class);
        org.mockito.Mockito.when(cluster.getCurrentStackVersion()).thenReturn(new org.apache.ambari.server.state.StackId("HDP-2.0.6.1"));
        org.apache.ambari.server.state.Service hbaseService = org.mockito.Mockito.mock(org.apache.ambari.server.state.Service.class);
        org.mockito.Mockito.when(hbaseService.getDesiredStackId()).thenReturn(new org.apache.ambari.server.state.StackId("HDP-2.0.6.1"));
        org.apache.ambari.server.state.Service zkService = org.mockito.Mockito.mock(org.apache.ambari.server.state.Service.class);
        org.mockito.Mockito.when(zkService.getDesiredStackId()).thenReturn(new org.apache.ambari.server.state.StackId("HDP-2.0.6.1"));
        org.mockito.Mockito.when(cluster.getServices()).thenReturn(com.google.common.collect.ImmutableMap.<java.lang.String, org.apache.ambari.server.state.Service>builder().put("HBASE", hbaseService).put("ZOOKEEPER", zkService).build());
        org.apache.ambari.server.metadata.RoleCommandOrder rco = roleCommandOrderProvider.getRoleCommandOrder(cluster);
        org.apache.ambari.server.stageplanner.RoleGraph rg = roleGraphFactory.createNew(rco);
    ...
    public void testSCCInGraphDetectedLong() {
        ...
        org.apache.ambari.server.state.Service zkService = org.mockito.Mockito.mock(org.apache.ambari.server.state.Service.class);
        org.mockito.Mockito.when(zkService.getDesiredStackId()).thenReturn(new org.apache.ambari.server.state.StackId("HDP-2.0.6.1"));
        org.apache.ambari.server.state.Service yarnService = org.mockito.Mockito.mock(org.apache.ambari.server.state.Service.class);
        org.mockito.Mockito.when(yarnService.getDesiredStackId()).thenReturn(new org.apache.ambari.server.state.StackId("HDP-2.0.6.1"));
        org.mockito.Mockito.when(cluster.getServices()).thenReturn(com.google.common.collect.ImmutableMap.<java.lang.String, org.apache.ambari.server.state.Service>builder().put("HBASE", hbaseService).put("ZOOKEEPER", zkService).put("YARN", yarnService).build());
        org.apache.ambari.server.metadata.RoleCommandOrder rco = roleCommandOrderProvider.getRoleCommandOrder(cluster);
        org.apache.ambari.server.stageplanner.RoleGraph rg = roleGraphFactory.createNew(rco);
        long now = java.lang.System.currentTimeMillis();
        org.apache.ambari.server.actionmanager.Stage stage = org.apache.ambari.server.utils.StageUtils.getATestStage(1, 1, "host1", "", "");
    ...
    public void testNoSCCInGraphDetected() {
        ...
        org.mockito.Mockito.when(cluster.getCurrentStackVersion()).thenReturn(new org.apache.ambari.server.state.StackId("HDP-2.0.6"));
        org.apache.ambari.server.state.Service hbaseService = org.mockito.Mockito.mock(org.apache.ambari.server.state.Service.class);
        org.mockito.Mockito.when(hbaseService.getDesiredStackId()).thenReturn(new org.apache.ambari.server.state.StackId("HDP-2.0.6"));
        org.apache.ambari.server.state.Service zkService = org.mockito.Mockito.mock(org.apache.ambari.server.state.Service.class);
        org.mockito.Mockito.when(zkService.getDesiredStackId()).thenReturn(new org.apache.ambari.server.state.StackId("HDP-2.0.6"));
        org.mockito.Mockito.when(cluster.getServices()).thenReturn(com.google.common.collect.ImmutableMap.<java.lang.String, org.apache.ambari.server.state.Service>builder().put("HBASE", hbaseService).put("ZOOKEEPER", zkService).build());
        org.apache.ambari.server.metadata.RoleCommandOrder rco = roleCommandOrderProvider.getRoleCommandOrder(cluster);
        org.apache.ambari.server.stageplanner.RoleGraph rg = roleGraphFactory.createNew(rco);
        long now = java.lang.System.currentTimeMillis();
    ...
    public void testRestartStagePlan() throws java.lang.Throwable {
        org.apache.ambari.server.state.cluster.ClusterImpl cluster = org.mockito.Mockito.mock(org.apache.ambari.server.state.cluster.ClusterImpl.class);
        org.mockito.Mockito.when(cluster.getCurrentStackVersion()).thenReturn(new org.apache.ambari.server.state.StackId("HDP-2.0.6"));
        org.apache.ambari.server.state.Service hiveService = org.mockito.Mockito.mock(org.apache.ambari.server.state.Service.class);
        org.mockito.Mockito.when(hiveService.getDesiredStackId()).thenReturn(new org.apache.ambari.server.state.StackId("HDP-2.0.6"));
        org.mockito.Mockito.when(cluster.getServices()).thenReturn(com.google.common.collect.ImmutableMap.<java.lang.String, org.apache.ambari.server.state.Service>builder().put("HIVE", hiveService).build());
        org.apache.ambari.server.metadata.RoleCommandOrder rco = roleCommandOrderProvider.getRoleCommandOrder(cluster);
        org.apache.ambari.server.stageplanner.RoleGraph rg = roleGraphFactory.createNew(rco);
    ...
    public void testManyStages() throws java.lang.Throwable {
        org.apache.ambari.server.state.cluster.ClusterImpl cluster = org.mockito.Mockito.mock(org.apache.ambari.server.state.cluster.ClusterImpl.class);
        org.mockito.Mockito.when(cluster.getCurrentStackVersion()).thenReturn(new org.apache.ambari.server.state.StackId("HDP-2.0.6"));
        org.apache.ambari.server.state.Service hdfsService = org.mockito.Mockito.mock(org.apache.ambari.server.state.Service.class);
        org.mockito.Mockito.when(hdfsService.getDesiredStackId()).thenReturn(new org.apache.ambari.server.state.StackId("HDP-2.0.6"));
        org.apache.ambari.server.state.Service hbaseService = org.mockito.Mockito.mock(org.apache.ambari.server.state.Service.class);
        org.mockito.Mockito.when(hbaseService.getDesiredStackId()).thenReturn(new org.apache.ambari.server.state.StackId("HDP-2.0.6"));
        org.apache.ambari.server.state.Service zkService = org.mockito.Mockito.mock(org.apache.ambari.server.state.Service.class);
        org.mockito.Mockito.when(zkService.getDesiredStackId()).thenReturn(new org.apache.ambari.server.state.StackId("HDP-2.0.6"));
        org.apache.ambari.server.state.Service mrService = org.mockito.Mockito.mock(org.apache.ambari.server.state.Service.class);
        org.mockito.Mockito.when(mrService.getDesiredStackId()).thenReturn(new org.apache.ambari.server.state.StackId("HDP-2.0.6"));
        org.apache.ambari.server.state.Service oozieService = org.mockito.Mockito.mock(org.apache.ambari.server.state.Service.class);
        org.mockito.Mockito.when(oozieService.getDesiredStackId()).thenReturn(new org.apache.ambari.server.state.StackId("HDP-2.0.6"));
        org.apache.ambari.server.state.Service webhcatService = org.mockito.Mockito.mock(org.apache.ambari.server.state.Service.class);
        org.mockito.Mockito.when(webhcatService.getDesiredStackId()).thenReturn(new org.apache.ambari.server.state.StackId("HDP-2.0.6"));
        org.apache.ambari.server.state.Service gangliaService = org.mockito.Mockito.mock(org.apache.ambari.server.state.Service.class);
        org.mockito.Mockito.when(gangliaService.getDesiredStackId()).thenReturn(new org.apache.ambari.server.state.StackId("HDP-2.0.6"));
        org.mockito.Mockito.when(cluster.getServices()).thenReturn(com.google.common.collect.ImmutableMap.<java.lang.String, org.apache.ambari.server.state.Service>builder().put("HDFS", hdfsService).put("HBASE", hbaseService).put("ZOOKEEPER", zkService).put("MAPREDUCE", mrService).put("OOZIE", oozieService).put("WEBHCAT", webhcatService).put("GANGLIA", gangliaService).build());
        org.apache.ambari.server.metadata.RoleCommandOrder rco = roleCommandOrderProvider.getRoleCommandOrder(cluster);
        org.apache.ambari.server.stageplanner.RoleGraph rg = roleGraphFactory.createNew(rco);
        long now = java.lang.System.currentTimeMillis();
        org.apache.ambari.server.actionmanager.Stage stage = org.apache.ambari.server.utils.StageUtils.getATestStage(1, 1, "host1", "", "");
