...
public class ConfigHelperTest {
    public static class RunWithInMemoryDefaultTestModule {
        ...
        public void testCalculateIsStaleConfigs() throws java.lang.Exception {
            ...
            org.easymock.EasyMock.expect(sc.getDesiredStackId()).andReturn(org.apache.ambari.server.state.ConfigHelperTest.RunWithInMemoryDefaultTestModule.cluster.getDesiredStackVersion()).anyTimes();
            org.easymock.EasyMock.expect(sch.getActualConfigs()).andReturn(schReturn).times(6);
            org.easymock.EasyMock.expect(sch.getHostName()).andReturn("h1").anyTimes();
            org.easymock.EasyMock.expect(sch.getClusterId()).andReturn(org.apache.ambari.server.state.ConfigHelperTest.RunWithInMemoryDefaultTestModule.cluster.getClusterId()).anyTimes();
            org.easymock.EasyMock.expect(sch.getServiceName()).andReturn("FLUME").anyTimes();
            org.easymock.EasyMock.expect(sch.getServiceComponentName()).andReturn("FLUME_HANDLER").anyTimes();
            org.easymock.EasyMock.expect(sch.getServiceComponent()).andReturn(sc).anyTimes();
            org.easymock.EasyMock.replay(sc, sch);
            ...
            junit.framework.Assert.assertTrue(org.apache.ambari.server.state.ConfigHelperTest.RunWithInMemoryDefaultTestModule.configHelper.isStaleConfigs(sch, null));
            org.easymock.EasyMock.verify(sch);
        }
        ...
        public void testCalculateRefreshCommands() throws java.lang.Exception {
            ...
            org.apache.ambari.server.state.ServiceComponentHost sch = org.easymock.EasyMock.createNiceMock(org.apache.ambari.server.state.ServiceComponentHost.class);
            org.easymock.EasyMock.expect(sc.getDesiredStackId()).andReturn(org.apache.ambari.server.state.ConfigHelperTest.RunWithInMemoryDefaultTestModule.cluster.getDesiredStackVersion()).anyTimes();
            org.easymock.EasyMock.expect(sch.getActualConfigs()).andReturn(schReturn).anyTimes();
            org.easymock.EasyMock.expect(sch.getHostName()).andReturn("h1").anyTimes();
            org.easymock.EasyMock.expect(sch.getClusterId()).andReturn(org.apache.ambari.server.state.ConfigHelperTest.RunWithInMemoryDefaultTestModule.cluster.getClusterId()).anyTimes();
            org.easymock.EasyMock.expect(sch.getServiceName()).andReturn("HDFS").anyTimes();
            org.easymock.EasyMock.expect(sch.getServiceComponentName()).andReturn("NAMENODE").anyTimes();
            org.easymock.EasyMock.expect(sch.getServiceComponent()).andReturn(sc).anyTimes();
            org.easymock.EasyMock.replay(sc, sch);
            junit.framework.Assert.assertTrue(org.apache.ambari.server.state.ConfigHelperTest.RunWithInMemoryDefaultTestModule.configHelper.isStaleConfigs(sch, null));
    ...
    public static class RunWithCustomModule {
        ...
        public void setup() throws java.lang.Exception {
            injector = com.google.inject.Guice.createInjector(new com.google.inject.AbstractModule() {
                ...
                protected void configure() {
                    final org.apache.ambari.server.api.services.AmbariMetaInfo mockMetaInfo = org.easymock.EasyMock.createNiceMock(org.apache.ambari.server.api.services.AmbariMetaInfo.class);
                    final org.apache.ambari.server.controller.spi.ClusterController clusterController = org.easymock.EasyMock.createStrictMock(org.apache.ambari.server.controller.spi.ClusterController.class);
                    ...
                    bind(org.apache.ambari.server.security.SecurityHelper.class).toInstance(org.easymock.EasyMock.createNiceMock(org.apache.ambari.server.security.SecurityHelper.class));
                    ...
                    bind(org.apache.ambari.server.controller.AmbariCustomCommandExecutionHelper.class).toInstance(org.easymock.EasyMock.createNiceMock(org.apache.ambari.server.controller.AmbariCustomCommandExecutionHelper.class));
                    ...
                    bind(org.apache.ambari.server.orm.dao.HostRoleCommandDAO.class).toInstance(org.easymock.EasyMock.createNiceMock(org.apache.ambari.server.orm.dao.HostRoleCommandDAO.class));
        ...
        public void testGetServicePropertiesSimpleInvocation() throws java.lang.Exception {
            org.apache.ambari.server.state.Cluster mockCluster = org.easymock.EasyMock.createStrictMock(org.apache.ambari.server.state.Cluster.class);
            org.apache.ambari.server.state.StackId mockStackVersion = org.easymock.EasyMock.createStrictMock(org.apache.ambari.server.state.StackId.class);
            ...
            org.apache.ambari.server.state.Service mockService = org.easymock.EasyMock.createStrictMock(org.apache.ambari.server.state.Service.class);
            org.apache.ambari.server.state.ServiceInfo mockServiceInfo = org.easymock.EasyMock.createStrictMock(org.apache.ambari.server.state.ServiceInfo.class);
            org.apache.ambari.server.state.PropertyInfo mockPropertyInfo1 = org.easymock.EasyMock.createStrictMock(org.apache.ambari.server.state.PropertyInfo.class);
            org.apache.ambari.server.state.PropertyInfo mockPropertyInfo2 = org.easymock.EasyMock.createStrictMock(org.apache.ambari.server.state.PropertyInfo.class);
            ...
            org.easymock.EasyMock.expect(mockCluster.getService("SERVICE")).andReturn(mockService).once();
            org.easymock.EasyMock.expect(mockService.getDesiredStackId()).andReturn(mockStackVersion).once();
            org.easymock.EasyMock.expect(mockStackVersion.getStackName()).andReturn("HDP").once();
            org.easymock.EasyMock.expect(mockStackVersion.getStackVersion()).andReturn("2.2").once();
            org.easymock.EasyMock.expect(mockAmbariMetaInfo.getService("HDP", "2.2", "SERVICE")).andReturn(mockServiceInfo).once();
            org.easymock.EasyMock.expect(mockServiceInfo.getProperties()).andReturn(serviceProperties).once();
            org.easymock.EasyMock.replay(mockAmbariMetaInfo, mockCluster, mockService, mockStackVersion, mockServiceInfo, mockPropertyInfo1, mockPropertyInfo2);
            ...
            org.easymock.EasyMock.verify(mockAmbariMetaInfo, mockCluster, mockStackVersion, mockServiceInfo, mockPropertyInfo1, mockPropertyInfo2);
        }
        ...
        public void testGetServicePropertiesDoNoRemoveExcluded() throws java.lang.Exception {
            ...
            org.easymock.EasyMock.expect(mockAmbariMetaInfo.getService("HDP", "2.2", "SERVICE")).andReturn(mockServiceInfo).once();
            org.easymock.EasyMock.expect(mockServiceInfo.getProperties()).andReturn(serviceProperties).once();
            org.easymock.EasyMock.replay(mockAmbariMetaInfo, mockStackVersion, mockServiceInfo, mockPropertyInfo1, mockPropertyInfo2);
            mockAmbariMetaInfo.init();
            ...
            junit.framework.Assert.assertNotNull(result);
            junit.framework.Assert.assertEquals(2, result.size());
            org.easymock.EasyMock.verify(mockAmbariMetaInfo, mockStackVersion, mockServiceInfo, mockPropertyInfo1, mockPropertyInfo2);
        }
        ...
        public void testGetServicePropertiesRemoveExcluded() throws java.lang.Exception {
            ...
            org.easymock.EasyMock.expect(mockAmbariMetaInfo.getService("HDP", "2.2", "SERVICE")).andReturn(mockServiceInfo).once();
            org.easymock.EasyMock.expect(mockServiceInfo.getProperties()).andReturn(serviceProperties).once();
            org.easymock.EasyMock.expect(mockServiceInfo.getExcludedConfigTypes()).andReturn(java.util.Collections.singleton("excluded-type")).once();
            org.easymock.EasyMock.expect(mockPropertyInfo1.getFilename()).andReturn("included-type.xml").times(2);
            org.easymock.EasyMock.expect(mockPropertyInfo2.getFilename()).andReturn("excluded-type.xml").once();
            org.easymock.EasyMock.replay(mockAmbariMetaInfo, mockStackVersion, mockServiceInfo, mockPropertyInfo1, mockPropertyInfo2);
            mockAmbariMetaInfo.init();
