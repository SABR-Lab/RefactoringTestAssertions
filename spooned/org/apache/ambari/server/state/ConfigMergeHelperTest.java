...
public class ConfigMergeHelperTest {
    ...
    public void before() throws java.lang.Exception {
        clustersMock = org.easymock.EasyMock.createNiceMock(org.apache.ambari.server.state.Clusters.class);
        ambariMetaInfoMock = org.easymock.EasyMock.createNiceMock(org.apache.ambari.server.api.services.AmbariMetaInfo.class);
    ...
    public void testGetConflicts() throws java.lang.Exception {
        org.apache.ambari.server.state.Cluster clusterMock = org.easymock.EasyMock.createNiceMock(org.apache.ambari.server.state.Cluster.class);
        org.easymock.EasyMock.expect(clustersMock.getCluster(org.easymock.EasyMock.anyString())).andReturn(clusterMock);
        org.easymock.EasyMock.expect(clusterMock.getCurrentStackVersion()).andReturn(org.apache.ambari.server.state.ConfigMergeHelperTest.currentStackId);
        org.easymock.EasyMock.expect(clusterMock.getServices()).andReturn(new java.util.HashMap<java.lang.String, org.apache.ambari.server.state.Service>() {
            {
                put("HDFS", org.easymock.EasyMock.createNiceMock(org.apache.ambari.server.state.Service.class));
                put("ZK", org.easymock.EasyMock.createNiceMock(org.apache.ambari.server.state.Service.class));
            }
        });
        ...
        org.easymock.EasyMock.expect(ambariMetaInfoMock.getServiceProperties(org.apache.ambari.server.state.ConfigMergeHelperTest.currentStackId.getStackName(), org.apache.ambari.server.state.ConfigMergeHelperTest.currentStackId.getStackVersion(), "HDFS")).andReturn(currentHDFSProperties);
        org.easymock.EasyMock.expect(ambariMetaInfoMock.getServiceProperties(org.apache.ambari.server.state.ConfigMergeHelperTest.currentStackId.getStackName(), org.apache.ambari.server.state.ConfigMergeHelperTest.currentStackId.getStackVersion(), "ZK")).andReturn(currentZKProperties);
        org.easymock.EasyMock.expect(ambariMetaInfoMock.getStackProperties(org.apache.ambari.server.state.ConfigMergeHelperTest.currentStackId.getStackName(), org.apache.ambari.server.state.ConfigMergeHelperTest.currentStackId.getStackVersion())).andReturn(currentStackProperties);
        ...
        org.easymock.EasyMock.expect(ambariMetaInfoMock.getServiceProperties(org.apache.ambari.server.state.ConfigMergeHelperTest.newStackId.getStackName(), org.apache.ambari.server.state.ConfigMergeHelperTest.newStackId.getStackVersion(), "HDFS")).andReturn(newHDFSProperties);
        org.easymock.EasyMock.expect(ambariMetaInfoMock.getServiceProperties(org.apache.ambari.server.state.ConfigMergeHelperTest.newStackId.getStackName(), org.apache.ambari.server.state.ConfigMergeHelperTest.newStackId.getStackVersion(), "ZK")).andReturn(newZKProperties);
        org.easymock.EasyMock.expect(ambariMetaInfoMock.getStackProperties(org.apache.ambari.server.state.ConfigMergeHelperTest.newStackId.getStackName(), org.apache.ambari.server.state.ConfigMergeHelperTest.newStackId.getStackVersion())).andReturn(newStackProperties);
        java.util.Map<java.lang.String, java.lang.String> desiredHdfsEnvProperties = new java.util.HashMap<>();
        org.easymock.EasyMock.expect(clusterMock.getDesiredConfigByType("hdfs-env.xml")).andReturn(createConfigMock(desiredHdfsEnvProperties));
        java.util.Map<java.lang.String, java.lang.String> desiredZkEnvProperties = new java.util.HashMap<>();
        org.easymock.EasyMock.expect(clusterMock.getDesiredConfigByType("hdfs-env.xml")).andReturn(createConfigMock(desiredZkEnvProperties));
        java.util.Map<java.lang.String, java.lang.String> desiredHadoopEnvProperties = new java.util.HashMap<>();
        org.easymock.EasyMock.expect(clusterMock.getDesiredConfigByType("hadoop-env.xml")).andReturn(createConfigMock(desiredHadoopEnvProperties));
        org.easymock.EasyMock.replay(clusterMock, clustersMock, ambariMetaInfoMock);
    ...
    private org.apache.ambari.server.state.Config createConfigMock(java.util.Map<java.lang.String, java.lang.String> properties) {
        org.apache.ambari.server.state.Config result = org.easymock.EasyMock.createNiceMock(org.apache.ambari.server.state.Config.class);
        org.easymock.EasyMock.expect(result.getProperties()).andReturn(properties);
        return result;
    }
