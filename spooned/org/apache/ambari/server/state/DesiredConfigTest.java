...
public class DesiredConfigTest {
    ...
    public void testEquals() throws java.lang.Exception {
        nl.jqno.equalsverifier.EqualsVerifier.forClass(org.apache.ambari.server.state.DesiredConfig.class).usingGetClass().suppress(nl.jqno.equalsverifier.Warning.NONFINAL_FIELDS).verify();
    }
