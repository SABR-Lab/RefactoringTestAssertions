...
public class PropertyInfoTest {
    ...
    public void testAttributes() throws java.lang.Exception {
        ...
        org.w3c.dom.Element e1 = org.easymock.EasyMock.createNiceMock(org.w3c.dom.Element.class);
        org.w3c.dom.Element e2 = org.easymock.EasyMock.createNiceMock(org.w3c.dom.Element.class);
        org.w3c.dom.Node n1 = org.easymock.EasyMock.createNiceMock(org.w3c.dom.Node.class);
        org.w3c.dom.Node n2 = org.easymock.EasyMock.createNiceMock(org.w3c.dom.Node.class);
        elements.add(e1);
        elements.add(e2);
        org.easymock.EasyMock.expect(e1.getTagName()).andReturn("foo").anyTimes();
        org.easymock.EasyMock.expect(e1.getFirstChild()).andReturn(n1).anyTimes();
        org.easymock.EasyMock.expect(n1.getNodeValue()).andReturn("value1").anyTimes();
        org.easymock.EasyMock.expect(e2.getTagName()).andReturn("bar").anyTimes();
        org.easymock.EasyMock.expect(e2.getFirstChild()).andReturn(n2).anyTimes();
        org.easymock.EasyMock.expect(n2.getNodeValue()).andReturn("value2").anyTimes();
        org.easymock.EasyMock.replay(e1, e2, n1, n2);
