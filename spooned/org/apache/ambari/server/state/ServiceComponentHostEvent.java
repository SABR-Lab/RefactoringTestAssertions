...
public abstract class ServiceComponentHostEvent extends org.apache.ambari.server.state.fsm.event.AbstractEvent<org.apache.ambari.server.state.ServiceComponentHostEventType> {
    ...
    public static org.apache.ambari.server.state.ServiceComponentHostEvent create(@com.fasterxml.jackson.annotation.JsonProperty("type")
    org.apache.ambari.server.state.ServiceComponentHostEventType type, @com.fasterxml.jackson.annotation.JsonProperty("serviceComponentName")
    java.lang.String serviceComponentName, @com.fasterxml.jackson.annotation.JsonProperty("hostName")
    java.lang.String hostName, @com.fasterxml.jackson.annotation.JsonProperty("opTimestamp")
    long opTimestamp, @com.fasterxml.jackson.annotation.JsonProperty("configs")
    java.util.Map<java.lang.String, java.lang.String> configs, @com.fasterxml.jackson.annotation.JsonProperty("stackId")
