...
public class ServiceComponentSupportTest extends org.easymock.EasyMockSupport {
    ...
    private void targetStackWith(java.lang.String... serviceNames) throws org.apache.ambari.server.AmbariException {
        org.easymock.EasyMock.expect(ambariMetaInfo.getServices(org.apache.ambari.server.state.ServiceComponentSupportTest.STACK_NAME, org.apache.ambari.server.state.ServiceComponentSupportTest.VERSION)).andReturn(serviceInfoMap(serviceNames)).anyTimes();
    ...
    private org.apache.ambari.server.state.Cluster clusterWith(java.lang.String... installedServiceNames) {
        ...
        org.easymock.EasyMock.expect(cluster.getServices()).andReturn(serviceMap);
