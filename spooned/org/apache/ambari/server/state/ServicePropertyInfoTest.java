...
public class ServicePropertyInfoTest {
    ...
    public void testEquals() throws java.lang.Exception {
        nl.jqno.equalsverifier.EqualsVerifier.forClass(org.apache.ambari.server.state.ServicePropertyInfo.class).suppress(nl.jqno.equalsverifier.Warning.NONFINAL_FIELDS).verify();
    }
