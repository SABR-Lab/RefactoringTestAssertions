...
public class ServiceTest {
    ...
    public void testDeleteAllServiceConfigGroups() throws org.apache.ambari.server.AmbariException {
        ...
        org.easymock.EasyMock.expect(configGroup1.getId()).andReturn(1L).anyTimes();
        org.easymock.EasyMock.expect(configGroup2.getId()).andReturn(2L).anyTimes();
        org.easymock.EasyMock.expect(configGroup1.getServiceName()).andReturn(serviceName).anyTimes();
        org.easymock.EasyMock.expect(configGroup2.getServiceName()).andReturn(serviceName).anyTimes();
        org.easymock.EasyMock.expect(configGroup1.getClusterName()).andReturn(cluster.getClusterName()).anyTimes();
        org.easymock.EasyMock.expect(configGroup2.getClusterName()).andReturn(cluster.getClusterName()).anyTimes();
        org.easymock.EasyMock.replay(configGroup1, configGroup2);
        ...
        org.easymock.EasyMock.verify(configGroup1, configGroup2);
    }
