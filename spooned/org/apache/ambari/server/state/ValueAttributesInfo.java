...
public class ValueAttributesInfo implements org.apache.ambari.server.controller.ApiModel {
    ...
    @com.fasterxml.jackson.annotation.JsonProperty(org.apache.ambari.server.state.ValueAttributesInfo.EMPTY_VALUE_VALID)
    private java.lang.Boolean emptyValueValid;

    @javax.xml.bind.annotation.XmlElement(name = "ui-only-property")
    @com.fasterxml.jackson.annotation.JsonProperty(org.apache.ambari.server.state.ValueAttributesInfo.UI_ONLY_PROPERTY)
    private java.lang.Boolean uiOnlyProperty;

    @javax.xml.bind.annotation.XmlElement(name = "read-only")
    @com.fasterxml.jackson.annotation.JsonProperty(org.apache.ambari.server.state.ValueAttributesInfo.READ_ONLY)
    private java.lang.Boolean readOnly;

    @javax.xml.bind.annotation.XmlElement(name = "editable-only-at-install")
    @com.fasterxml.jackson.annotation.JsonProperty(org.apache.ambari.server.state.ValueAttributesInfo.EDITABLE_ONLY_AT_INSTALL)
    private java.lang.Boolean editableOnlyAtInstall;

    @javax.xml.bind.annotation.XmlElement(name = "show-property-name")
    @com.fasterxml.jackson.annotation.JsonProperty(org.apache.ambari.server.state.ValueAttributesInfo.SHOW_PROPERTY_NAME)
    private java.lang.Boolean showPropertyName;

    @javax.xml.bind.annotation.XmlElement(name = "increment-step")
    @com.fasterxml.jackson.annotation.JsonProperty(org.apache.ambari.server.state.ValueAttributesInfo.INCREMENT_STEP)
    ...
    @com.fasterxml.jackson.annotation.JsonProperty(org.apache.ambari.server.state.ValueAttributesInfo.SELECTION_CARDINALITY)
    ...
    @com.fasterxml.jackson.annotation.JsonProperty(org.apache.ambari.server.state.ValueAttributesInfo.PROPERTY_FILE_NAME)
    ...
    @com.fasterxml.jackson.annotation.JsonProperty(org.apache.ambari.server.state.ValueAttributesInfo.PROPERTY_FILE_TYPE)
    ...
    public java.util.Map<java.lang.String, java.lang.String> toMap(java.util.Optional<com.fasterxml.jackson.databind.ObjectMapper> mapper) {
        java.util.Map<java.lang.String, java.lang.String> map = mapper.orElseGet(com.fasterxml.jackson.databind.ObjectMapper::new).convertValue(this, new com.fasterxml.jackson.core.type.TypeReference<java.util.Map<java.lang.String, java.lang.String>>() {});
    ...
    public static org.apache.ambari.server.state.ValueAttributesInfo fromMap(java.util.Map<java.lang.String, java.lang.String> attributes, java.util.Optional<com.fasterxml.jackson.databind.ObjectMapper> mapper) {
        return mapper.orElseGet(com.fasterxml.jackson.databind.ObjectMapper::new).convertValue(attributes, org.apache.ambari.server.state.ValueAttributesInfo.class);
    }
