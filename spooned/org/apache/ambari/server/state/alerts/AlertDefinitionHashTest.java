...
public class AlertDefinitionHashTest extends junit.framework.TestCase {
    ...
    protected void setUp() throws java.lang.Exception {
        ...
        org.easymock.EasyMock.expect(sch.getHostName()).andReturn(org.apache.ambari.server.state.alerts.AlertDefinitionHashTest.HOSTNAME).anyTimes();
        ...
        org.easymock.EasyMock.expect(sch.getServiceName()).andReturn("HDFS").anyTimes();
        org.easymock.EasyMock.expect(sch.getServiceComponentName()).andReturn("DATANODE").anyTimes();
        org.easymock.EasyMock.expect(sch.getHostName()).andReturn(org.apache.ambari.server.state.alerts.AlertDefinitionHashTest.HOSTNAME).anyTimes();
        org.easymock.EasyMock.replay(sch);
        serviceComponentHosts.add(sch);
        ...
        org.easymock.EasyMock.expect(host.getHostName()).andReturn(org.apache.ambari.server.state.alerts.AlertDefinitionHashTest.HOSTNAME).anyTimes();
        ...
        org.easymock.EasyMock.expect(namenode.getServiceComponentHosts()).andReturn(mapComponentHosts).anyTimes();
        org.easymock.EasyMock.expect(namenode.isMasterComponent()).andReturn(true).anyTimes();
        ...
        org.easymock.EasyMock.expect(hdfs.getName()).andReturn("HDFS").anyTimes();
        org.easymock.EasyMock.expect(hdfs.getServiceComponents()).andReturn(serviceComponents).anyTimes();
        services.put(hdfsName, hdfs);
        org.easymock.EasyMock.replay(hdfs, host, namenode);
        org.easymock.EasyMock.expect(m_mockClusters.getCluster(((java.lang.String) (org.easymock.EasyMock.anyObject())))).andReturn(m_mockCluster).atLeastOnce();
        org.easymock.EasyMock.expect(m_mockClusters.getClusterById(org.easymock.EasyMock.anyInt())).andReturn(m_mockCluster).atLeastOnce();
        ...
        org.easymock.EasyMock.expect(m_mockClusters.getHostsForCluster(org.easymock.EasyMock.eq(org.apache.ambari.server.state.alerts.AlertDefinitionHashTest.CLUSTERNAME))).andReturn(clusterHosts).anyTimes();
        org.easymock.EasyMock.expect(m_mockCluster.getClusterId()).andReturn(java.lang.Long.valueOf(1)).anyTimes();
        org.easymock.EasyMock.expect(m_mockCluster.getClusterName()).andReturn(org.apache.ambari.server.state.alerts.AlertDefinitionHashTest.CLUSTERNAME).anyTimes();
        org.easymock.EasyMock.expect(m_mockCluster.getServices()).andReturn(services).anyTimes();
        org.easymock.EasyMock.expect(m_mockCluster.getServiceComponentHosts(org.easymock.EasyMock.anyObject(java.lang.String.class))).andReturn(serviceComponentHosts).anyTimes();
        ...
        org.easymock.EasyMock.expect(m_configHelper.getEffectiveDesiredTags(((org.apache.ambari.server.state.Cluster) (org.easymock.EasyMock.anyObject())), org.easymock.EasyMock.anyString())).andReturn(new java.util.HashMap<>()).anyTimes();
        org.easymock.EasyMock.expect(m_configHelper.getEffectiveConfigProperties(((org.apache.ambari.server.state.Cluster) (org.easymock.EasyMock.anyObject())), ((java.util.Map<java.lang.String, java.util.Map<java.lang.String, java.lang.String>>) (org.easymock.EasyMock.anyObject())))).andReturn(new java.util.HashMap<>()).anyTimes();
