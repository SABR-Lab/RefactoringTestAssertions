...
public class ClusterImplTest {
    ...
    public void testAddSessionAttributes() throws java.lang.Exception {
        ...
        org.apache.ambari.server.controller.AmbariSessionManager sessionManager = org.easymock.EasyMock.createMock(org.apache.ambari.server.controller.AmbariSessionManager.class);
        org.apache.ambari.server.state.cluster.ClusterImpl cluster = org.easymock.EasyMock.createMockBuilder(org.apache.ambari.server.state.cluster.ClusterImpl.class).addMockedMethod("getSessionManager").addMockedMethod("getClusterName").addMockedMethod("getSessionAttributes").createMock();
        org.easymock.EasyMock.expect(cluster.getSessionManager()).andReturn(sessionManager);
        org.easymock.EasyMock.expect(cluster.getClusterName()).andReturn("c1");
        ...
        org.easymock.EasyMock.replay(sessionManager, cluster);
        cluster.addSessionAttributes(attributes);
        org.easymock.EasyMock.verify(sessionManager, cluster);
    }
    ...
    public void testSetSessionAttribute() throws java.lang.Exception {
        ...
        org.easymock.EasyMock.expect(cluster.getSessionManager()).andReturn(sessionManager);
        org.easymock.EasyMock.expect(cluster.getClusterName()).andReturn("c1");
        org.easymock.EasyMock.expect(cluster.getSessionAttributes()).andReturn(updatedAttributes);
    ...
    public void testGetSessionAttributes() throws java.lang.Exception {
        ...
        attributes.put("foo", "bar");
        org.apache.ambari.server.controller.AmbariSessionManager sessionManager = org.easymock.EasyMock.createMock(org.apache.ambari.server.controller.AmbariSessionManager.class);
        org.apache.ambari.server.state.cluster.ClusterImpl cluster = org.easymock.EasyMock.createMockBuilder(org.apache.ambari.server.state.cluster.ClusterImpl.class).addMockedMethod("getSessionManager").addMockedMethod("getClusterName").createMock();
        org.easymock.EasyMock.expect(cluster.getSessionManager()).andReturn(sessionManager).anyTimes();
        org.easymock.EasyMock.expect(cluster.getClusterName()).andReturn("c1").anyTimes();
        org.easymock.EasyMock.expect(sessionManager.getAttribute("cluster_session_attributes:c1")).andReturn(attributes);
        org.easymock.EasyMock.expect(sessionManager.getAttribute("cluster_session_attributes:c1")).andReturn(null);
        org.easymock.EasyMock.replay(sessionManager, cluster);
    ...
    public void testGetConfigGroupsByServiceName() throws org.apache.ambari.server.AmbariException {
        ...
        org.apache.ambari.server.state.cluster.ClusterImplTest.clusters.addCluster(clusterName, stackId);
        org.apache.ambari.server.state.Cluster cluster = org.apache.ambari.server.state.cluster.ClusterImplTest.clusters.getCluster(clusterName);
        org.apache.ambari.server.state.configgroup.ConfigGroup serviceConfigGroup1 = org.easymock.EasyMock.createNiceMock(org.apache.ambari.server.state.configgroup.ConfigGroup.class);
        org.apache.ambari.server.state.configgroup.ConfigGroup serviceConfigGroup2 = org.easymock.EasyMock.createNiceMock(org.apache.ambari.server.state.configgroup.ConfigGroup.class);
        org.easymock.EasyMock.expect(serviceConfigGroup1.getId()).andReturn(1L).anyTimes();
        org.easymock.EasyMock.expect(serviceConfigGroup2.getId()).andReturn(2L).anyTimes();
        org.easymock.EasyMock.expect(serviceConfigGroup1.getServiceName()).andReturn(serviceToCheckName).anyTimes();
        org.easymock.EasyMock.expect(serviceConfigGroup2.getServiceName()).andReturn(serviceNotToCheckName).anyTimes();
        org.easymock.EasyMock.replay(serviceConfigGroup1, serviceConfigGroup2);
        ...
        org.easymock.EasyMock.verify(serviceConfigGroup1, serviceConfigGroup2);
    }
}
