...
public class ClustersTest {
    ...
    public void testDeleteCluster() throws java.lang.Exception {
        ...
        org.apache.ambari.server.topology.Blueprint bp = org.easymock.EasyMock.createNiceMock(org.apache.ambari.server.topology.Blueprint.class);
        org.easymock.EasyMock.expect(bp.getName()).andReturn("TestBluePrint").anyTimes();
        ...
        org.apache.ambari.server.controller.internal.ProvisionClusterRequest topologyRequest = org.easymock.EasyMock.createNiceMock(org.apache.ambari.server.controller.internal.ProvisionClusterRequest.class);
        org.easymock.EasyMock.expect(topologyRequest.getType()).andReturn(org.apache.ambari.server.topology.TopologyRequest.Type.PROVISION).anyTimes();
        org.easymock.EasyMock.expect(topologyRequest.getBlueprint()).andReturn(bp).anyTimes();
        org.easymock.EasyMock.expect(topologyRequest.getClusterId()).andReturn(cluster.getClusterId()).anyTimes();
        org.easymock.EasyMock.expect(topologyRequest.getConfiguration()).andReturn(clusterConfig).anyTimes();
        org.easymock.EasyMock.expect(topologyRequest.getDescription()).andReturn("Test description").anyTimes();
        org.easymock.EasyMock.expect(topologyRequest.getHostGroupInfo()).andReturn(hostGroups).anyTimes();
        org.easymock.EasyMock.replay(bp, topologyRequest);
    ...
    private org.apache.ambari.server.topology.HostRequest createHostRequest(long hrId, java.lang.String hostName) {
        org.apache.ambari.server.topology.HostRequest hr = org.easymock.EasyMock.createNiceMock(org.apache.ambari.server.topology.HostRequest.class);
        org.easymock.EasyMock.expect(hr.getId()).andReturn(hrId).anyTimes();
        org.easymock.EasyMock.expect(hr.getHostgroupName()).andReturn("MyHostGroup").anyTimes();
        org.easymock.EasyMock.expect(hr.getHostName()).andReturn(hostName).anyTimes();
        org.easymock.EasyMock.expect(hr.getStageId()).andReturn(1L);
        org.easymock.EasyMock.expect(hr.getTopologyTasks()).andReturn(java.util.Collections.emptyList());
        org.easymock.EasyMock.replay(hr);
        return hr;
    }
    ...
    private void createTopologyLogicalRequest(org.apache.ambari.server.state.Cluster cluster, java.lang.String hostName) {
        ...
        org.apache.ambari.server.topology.LogicalRequest logicalRequest = org.easymock.EasyMock.createNiceMock(org.apache.ambari.server.topology.LogicalRequest.class);
        org.easymock.EasyMock.expect(logicalRequest.getHostRequests()).andReturn(hostRequests).anyTimes();
        org.easymock.EasyMock.expect(logicalRequest.getRequestContext()).andReturn("Description").anyTimes();
        org.easymock.EasyMock.expect(logicalRequest.getRequestId()).andReturn(1L).anyTimes();
        org.easymock.EasyMock.replay(logicalRequest);
    ...
    private static class MockModule implements com.google.inject.Module {
        ...
        public void configure(com.google.inject.Binder binder) {
            binder.bind(org.apache.ambari.server.topology.TopologyManager.class).toInstance(org.easymock.EasyMock.createNiceMock(org.apache.ambari.server.topology.TopologyManager.class));
        }
    }
}
