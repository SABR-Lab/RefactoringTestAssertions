...
public class HostTest {
    ...
    public void testHostOs() throws java.lang.Exception {
        org.apache.ambari.server.state.Clusters clusters = org.mockito.Mockito.mock(org.apache.ambari.server.state.Clusters.class);
        org.apache.ambari.server.actionmanager.ActionManager manager = org.mockito.Mockito.mock(org.apache.ambari.server.actionmanager.ActionManager.class);
        com.google.inject.Injector injector = org.mockito.Mockito.mock(com.google.inject.Injector.class);
        ...
        org.mockito.Mockito.doNothing().when(injector).injectMembers(org.mockito.Matchers.any());
        org.mockito.Mockito.when(injector.getInstance(org.apache.ambari.server.events.publishers.AmbariEventPublisher.class)).thenReturn(org.mockito.Mockito.mock(org.apache.ambari.server.events.publishers.AmbariEventPublisher.class));
