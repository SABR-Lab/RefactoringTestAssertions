...
public class VersionDefinitionTest extends org.easymock.EasyMockSupport {
    ...
    public void testAvailableFull() throws java.lang.Exception {
        ...
        org.easymock.EasyMock.expect(repositoryVersion.getVersion()).andReturn("2.3.4.0").atLeastOnce();
        org.apache.ambari.server.state.Service serviceHdfs = createNiceMock(org.apache.ambari.server.state.Service.class);
        org.easymock.EasyMock.expect(serviceHdfs.getName()).andReturn("HDFS").atLeastOnce();
        org.easymock.EasyMock.expect(serviceHdfs.getDisplayName()).andReturn("HDFS").atLeastOnce();
        org.easymock.EasyMock.expect(serviceHdfs.getDesiredRepositoryVersion()).andReturn(repositoryVersion).atLeastOnce();
        org.apache.ambari.server.state.Service serviceHBase = createNiceMock(org.apache.ambari.server.state.Service.class);
        org.easymock.EasyMock.expect(serviceHBase.getName()).andReturn("HBASE").atLeastOnce();
        org.easymock.EasyMock.expect(serviceHBase.getDisplayName()).andReturn("HBase").atLeastOnce();
        org.easymock.EasyMock.expect(serviceHBase.getDesiredRepositoryVersion()).andReturn(repositoryVersion).atLeastOnce();
        org.apache.ambari.server.state.StackInfo stackInfo = createNiceMock(org.apache.ambari.server.state.StackInfo.class);
        org.easymock.EasyMock.expect(stackInfo.getReleaseVersion()).andReturn(new org.apache.ambari.server.state.repository.DefaultStackVersion()).atLeastOnce();
        ...
        org.easymock.EasyMock.expect(ami.getStack(org.easymock.EasyMock.anyObject(org.apache.ambari.server.state.StackId.class))).andReturn(stackInfo).atLeastOnce();
        org.apache.ambari.server.state.Service serviceAMS = createNiceMock(org.apache.ambari.server.state.Service.class);
        org.easymock.EasyMock.expect(cluster.getServices()).andReturn(com.google.common.collect.ImmutableMap.<java.lang.String, org.apache.ambari.server.state.Service>builder().put("HDFS", serviceHdfs).put("HBASE", serviceHBase).put("AMBARI_METRICS", serviceAMS).build()).atLeastOnce();
        replayAll();
        java.io.File f = new java.io.File("src/test/resources/version_definition_test_all_services.xml");
        org.apache.ambari.server.state.repository.VersionDefinitionXml xml = org.apache.ambari.server.state.repository.VersionDefinitionXml.load(f.toURI().toURL());
    ...
    public void testAvailableBuildVersion() throws java.lang.Exception {
        org.apache.ambari.server.state.Cluster cluster = createNiceMock(org.apache.ambari.server.state.Cluster.class);
        org.apache.ambari.server.orm.entities.RepositoryVersionEntity repositoryVersion = createNiceMock(org.apache.ambari.server.orm.entities.RepositoryVersionEntity.class);
        org.easymock.EasyMock.expect(repositoryVersion.getVersion()).andReturn("2.3.4.1-1").atLeastOnce();
        org.apache.ambari.server.state.Service serviceHdfs = createNiceMock(org.apache.ambari.server.state.Service.class);
        org.easymock.EasyMock.expect(serviceHdfs.getName()).andReturn("HDFS").atLeastOnce();
        org.easymock.EasyMock.expect(serviceHdfs.getDisplayName()).andReturn("HDFS").atLeastOnce();
        org.easymock.EasyMock.expect(serviceHdfs.getDesiredRepositoryVersion()).andReturn(repositoryVersion).atLeastOnce();
    ...
    public void testBuild() throws java.lang.Exception {
        ...
        org.easymock.EasyMock.expect(serviceWithVersionAdvertised.isVersionAdvertised()).andReturn(true).atLeastOnce();
        org.easymock.EasyMock.expect(serviceWithVersionAdvertised.getName()).andReturn("BAR").atLeastOnce();
        org.easymock.EasyMock.expect(serviceWithVersionAdvertised.getVersion()).andReturn("1.5.0").atLeastOnce();
        org.easymock.EasyMock.expect(serviceWithoutVersionAdvertised.isVersionAdvertised()).andReturn(false).atLeastOnce();
        org.easymock.EasyMock.expect(serviceWithoutVersionAdvertised.getName()).andReturn("BAZ").atLeastOnce();
        org.easymock.EasyMock.expect(serviceWithoutVersionAdvertised.getVersion()).andReturn("2.0.0").atLeastOnce();
        java.io.File f = new java.io.File("src/test/resources/version_definition_test_all_services.xml");
        org.apache.ambari.server.state.repository.VersionDefinitionXml xml1 = org.apache.ambari.server.state.repository.VersionDefinitionXml.load(f.toURI().toURL());
        ...
        org.easymock.EasyMock.expect(repositoryXml.getOses()).andReturn(xml1.repositoryInfo.getOses()).atLeastOnce();
        org.apache.ambari.server.state.StackInfo stackInfo = createNiceMock(org.apache.ambari.server.state.StackInfo.class);
        org.easymock.EasyMock.expect(stackInfo.getName()).andReturn("FOO").anyTimes();
        org.easymock.EasyMock.expect(stackInfo.getVersion()).andReturn("1.0.0").anyTimes();
        org.easymock.EasyMock.expect(stackInfo.getServices()).andReturn(stackServices).atLeastOnce();
        org.easymock.EasyMock.expect(stackInfo.getRepositoryXml()).andReturn(repositoryXml).atLeastOnce();
        replayAll();
