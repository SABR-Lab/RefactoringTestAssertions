...
public class AlertNoticeDispatchServiceTest extends org.apache.ambari.server.state.services.AlertNoticeDispatchService {
    ...
    public void before() {
        ...
        m_dispatchFactory = org.easymock.EasyMock.createStrictMock(org.apache.ambari.server.notifications.DispatchFactory.class);
        m_metaInfo = org.easymock.EasyMock.createNiceMock(org.apache.ambari.server.api.services.AmbariMetaInfo.class);
        ...
        org.easymock.EasyMock.expect(m_runtimeMXBean.getUptime()).andReturn(org.apache.ambari.server.state.services.AlertNoticeDispatchServiceTest.UPTIME_MILLIS).atLeastOnce();
        org.easymock.EasyMock.replay(m_runtimeMXBean);
    }
