...
public class MetricsRetrievalService extends com.google.common.util.concurrent.AbstractService {
    ...
    private final com.fasterxml.jackson.databind.ObjectReader m_jmxObjectReader;
    ...
    public MetricsRetrievalService() {
        ...
        jmxObjectMapper.configure(com.fasterxml.jackson.core.JsonParser.Feature.ALLOW_NON_NUMERIC_NUMBERS, true);
    ...
    private abstract static class MetricRunnable implements java.lang.Runnable {
