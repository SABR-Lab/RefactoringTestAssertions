...
public class AmbariContextTest {
    ...
    private static final org.apache.ambari.server.controller.AmbariManagementController controller = org.easymock.EasyMock.createNiceMock(org.apache.ambari.server.controller.AmbariManagementController.class);

    private static final org.apache.ambari.server.controller.spi.ClusterController clusterController = org.easymock.EasyMock.createStrictMock(org.apache.ambari.server.controller.spi.ClusterController.class);

    private static final org.apache.ambari.server.controller.internal.HostResourceProvider hostResourceProvider = org.easymock.EasyMock.createStrictMock(org.apache.ambari.server.controller.internal.HostResourceProvider.class);

    private static final org.apache.ambari.server.controller.internal.ServiceResourceProvider serviceResourceProvider = org.easymock.EasyMock.createStrictMock(org.apache.ambari.server.controller.internal.ServiceResourceProvider.class);

    private static final org.apache.ambari.server.controller.internal.ComponentResourceProvider componentResourceProvider = org.easymock.EasyMock.createStrictMock(org.apache.ambari.server.controller.internal.ComponentResourceProvider.class);

    private static final org.apache.ambari.server.controller.internal.HostComponentResourceProvider hostComponentResourceProvider = org.easymock.EasyMock.createStrictMock(org.apache.ambari.server.controller.internal.HostComponentResourceProvider.class);

    private static final org.apache.ambari.server.controller.internal.ConfigGroupResourceProvider configGroupResourceProvider = org.easymock.EasyMock.createStrictMock(org.apache.ambari.server.controller.internal.ConfigGroupResourceProvider.class);

    private static final org.apache.ambari.server.topology.ClusterTopology topology = org.easymock.EasyMock.createNiceMock(org.apache.ambari.server.topology.ClusterTopology.class);

    private static final org.apache.ambari.server.topology.Blueprint blueprint = org.easymock.EasyMock.createNiceMock(org.apache.ambari.server.topology.Blueprint.class);

    private static final org.apache.ambari.server.controller.internal.Stack stack = org.easymock.EasyMock.createNiceMock(org.apache.ambari.server.controller.internal.Stack.class);
    ...
    private static final org.apache.ambari.server.state.Cluster cluster = org.easymock.EasyMock.createNiceMock(org.apache.ambari.server.state.Cluster.class);

    private static final org.apache.ambari.server.topology.HostGroupInfo group1Info = org.easymock.EasyMock.createNiceMock(org.apache.ambari.server.topology.HostGroupInfo.class);

    private static final org.apache.ambari.server.state.ConfigHelper configHelper = org.easymock.EasyMock.createNiceMock(org.apache.ambari.server.state.ConfigHelper.class);

    private static final org.apache.ambari.server.state.configgroup.ConfigGroup configGroup1 = org.easymock.EasyMock.createMock(org.apache.ambari.server.state.configgroup.ConfigGroup.class);

    private static final org.apache.ambari.server.state.configgroup.ConfigGroup configGroup2 = org.easymock.EasyMock.createMock(org.apache.ambari.server.state.configgroup.ConfigGroup.class);

    private static final org.apache.ambari.server.state.Host host1 = org.easymock.EasyMock.createNiceMock(org.apache.ambari.server.state.Host.class);

    private static final org.apache.ambari.server.state.Host host2 = org.easymock.EasyMock.createNiceMock(org.apache.ambari.server.state.Host.class);

    private static final org.apache.ambari.server.state.ConfigFactory configFactory = org.easymock.EasyMock.createNiceMock(org.apache.ambari.server.state.ConfigFactory.class);

    private static final org.apache.ambari.server.state.Service mockService1 = org.easymock.EasyMock.createStrictMock(org.apache.ambari.server.state.Service.class);

    private static final com.google.inject.Provider<org.apache.ambari.server.state.ConfigHelper> mockConfigHelperProvider = org.easymock.EasyMock.createNiceMock(com.google.inject.Provider.class);

    private static final org.apache.ambari.server.state.ConfigHelper mockConfigHelper = org.easymock.EasyMock.createNiceMock(org.apache.ambari.server.state.ConfigHelper.class);
    ...
    public void setUp() throws java.lang.Exception {
        ...
        org.apache.ambari.server.state.Config type1Group1 = org.easymock.EasyMock.createNiceMock(org.apache.ambari.server.state.Config.class);
        org.easymock.EasyMock.expect(type1Group1.getType()).andReturn("type1").anyTimes();
        org.easymock.EasyMock.expect(type1Group1.getTag()).andReturn("group1").anyTimes();
        org.easymock.EasyMock.expect(type1Group1.getProperties()).andReturn(group1ResolvedProperties).anyTimes();
        org.easymock.EasyMock.expect(org.apache.ambari.server.topology.AmbariContextTest.configFactory.createReadOnly(org.easymock.EasyMock.eq("type1"), org.easymock.EasyMock.eq("group1"), org.easymock.EasyMock.anyObject(), org.easymock.EasyMock.anyObject())).andReturn(type1Group1).anyTimes();
        org.easymock.EasyMock.replay(type1Group1);
        org.apache.ambari.server.state.Config type1Service1 = org.easymock.EasyMock.createNiceMock(org.apache.ambari.server.state.Config.class);
        org.easymock.EasyMock.expect(type1Service1.getType()).andReturn("type1").anyTimes();
        org.easymock.EasyMock.expect(type1Service1.getTag()).andReturn("service1").anyTimes();
        org.easymock.EasyMock.expect(type1Service1.getProperties()).andReturn(type1Props).anyTimes();
        org.easymock.EasyMock.expect(org.apache.ambari.server.topology.AmbariContextTest.configFactory.createReadOnly(org.easymock.EasyMock.eq("type1"), org.easymock.EasyMock.eq("service1"), org.easymock.EasyMock.anyObject(), org.easymock.EasyMock.anyObject())).andReturn(type1Service1).anyTimes();
        org.easymock.EasyMock.replay(type1Service1);
        ...
        org.easymock.EasyMock.expect(repositoryVersion.getId()).andReturn(1L).atLeastOnce();
        org.easymock.EasyMock.expect(repositoryVersion.getVersion()).andReturn("1.1.1.1").atLeastOnce();
        org.easymock.EasyMock.expect(repositoryVersion.getType()).andReturn(org.apache.ambari.spi.RepositoryType.STANDARD).atLeastOnce();
        org.easymock.EasyMock.expect(repositoryVersionDAO.findByStack(org.easymock.EasyMock.anyObject(org.apache.ambari.server.state.StackId.class))).andReturn(java.util.Collections.singletonList(repositoryVersion)).atLeastOnce();
        ...
        org.easymock.EasyMock.replay(repositoryVersionDAO, repositoryVersion, hostLevelParamsHolder);
        ...
        org.easymock.EasyMock.expect(org.apache.ambari.server.topology.AmbariContextTest.topology.getClusterId()).andReturn(org.apache.ambari.server.topology.AmbariContextTest.CLUSTER_ID).anyTimes();
        org.easymock.EasyMock.expect(org.apache.ambari.server.topology.AmbariContextTest.topology.getBlueprint()).andReturn(org.apache.ambari.server.topology.AmbariContextTest.blueprint).anyTimes();
        org.easymock.EasyMock.expect(org.apache.ambari.server.topology.AmbariContextTest.topology.getHostGroupInfo()).andReturn(java.util.Collections.singletonMap(org.apache.ambari.server.topology.AmbariContextTest.HOST_GROUP_1, org.apache.ambari.server.topology.AmbariContextTest.group1Info)).anyTimes();
        org.easymock.EasyMock.expect(org.apache.ambari.server.topology.AmbariContextTest.blueprint.getName()).andReturn(org.apache.ambari.server.topology.AmbariContextTest.BP_NAME).anyTimes();
        org.easymock.EasyMock.expect(org.apache.ambari.server.topology.AmbariContextTest.blueprint.getStack()).andReturn(org.apache.ambari.server.topology.AmbariContextTest.stack).anyTimes();
        org.easymock.EasyMock.expect(org.apache.ambari.server.topology.AmbariContextTest.blueprint.getServices()).andReturn(org.apache.ambari.server.topology.AmbariContextTest.blueprintServices).anyTimes();
        org.easymock.EasyMock.expect(org.apache.ambari.server.topology.AmbariContextTest.blueprint.getComponents("service1")).andReturn(java.util.Arrays.asList("s1Component1", "s1Component2")).anyTimes();
        org.easymock.EasyMock.expect(org.apache.ambari.server.topology.AmbariContextTest.blueprint.getComponents("service2")).andReturn(java.util.Collections.singleton("s2Component1")).anyTimes();
        org.easymock.EasyMock.expect(org.apache.ambari.server.topology.AmbariContextTest.blueprint.getConfiguration()).andReturn(bpConfiguration).anyTimes();
        org.easymock.EasyMock.expect(org.apache.ambari.server.topology.AmbariContextTest.blueprint.getCredentialStoreEnabled("service1")).andReturn("true").anyTimes();
        org.easymock.EasyMock.expect(org.apache.ambari.server.topology.AmbariContextTest.stack.getName()).andReturn(org.apache.ambari.server.topology.AmbariContextTest.STACK_NAME).anyTimes();
        org.easymock.EasyMock.expect(org.apache.ambari.server.topology.AmbariContextTest.stack.getVersion()).andReturn(org.apache.ambari.server.topology.AmbariContextTest.STACK_VERSION).anyTimes();
        for (java.util.Map.Entry<java.lang.String, java.lang.String> entry : configTypeServiceMapping.entrySet()) {
            org.easymock.EasyMock.expect(org.apache.ambari.server.topology.AmbariContextTest.stack.getServicesForConfigType(entry.getKey())).andReturn(java.util.Collections.singletonList(entry.getValue())).anyTimes();
        }
        org.easymock.EasyMock.expect(org.apache.ambari.server.topology.AmbariContextTest.controller.getClusters()).andReturn(org.apache.ambari.server.topology.AmbariContextTest.clusters).anyTimes();
        org.easymock.EasyMock.expect(org.apache.ambari.server.topology.AmbariContextTest.controller.getConfigHelper()).andReturn(org.apache.ambari.server.topology.AmbariContextTest.configHelper).anyTimes();
        org.easymock.EasyMock.expect(org.apache.ambari.server.topology.AmbariContextTest.clusters.getCluster(org.apache.ambari.server.topology.AmbariContextTest.CLUSTER_NAME)).andReturn(org.apache.ambari.server.topology.AmbariContextTest.cluster).anyTimes();
        org.easymock.EasyMock.expect(org.apache.ambari.server.topology.AmbariContextTest.clusters.getClusterById(org.apache.ambari.server.topology.AmbariContextTest.CLUSTER_ID)).andReturn(org.apache.ambari.server.topology.AmbariContextTest.cluster).anyTimes();
        org.easymock.EasyMock.expect(org.apache.ambari.server.topology.AmbariContextTest.clusters.getHost(org.apache.ambari.server.topology.AmbariContextTest.HOST1)).andReturn(org.apache.ambari.server.topology.AmbariContextTest.host1).anyTimes();
        org.easymock.EasyMock.expect(org.apache.ambari.server.topology.AmbariContextTest.clusters.getHost(org.apache.ambari.server.topology.AmbariContextTest.HOST2)).andReturn(org.apache.ambari.server.topology.AmbariContextTest.host2).anyTimes();
        ...
        org.easymock.EasyMock.expect(org.apache.ambari.server.topology.AmbariContextTest.clusters.getHostsForCluster(org.apache.ambari.server.topology.AmbariContextTest.CLUSTER_NAME)).andReturn(clusterHosts).anyTimes();
        org.easymock.EasyMock.expect(org.apache.ambari.server.topology.AmbariContextTest.cluster.getClusterId()).andReturn(org.apache.ambari.server.topology.AmbariContextTest.CLUSTER_ID).anyTimes();
        org.easymock.EasyMock.expect(org.apache.ambari.server.topology.AmbariContextTest.cluster.getClusterName()).andReturn(org.apache.ambari.server.topology.AmbariContextTest.CLUSTER_NAME).anyTimes();
        org.easymock.EasyMock.expect(org.apache.ambari.server.topology.AmbariContextTest.host1.getHostId()).andReturn(1L).anyTimes();
        org.easymock.EasyMock.expect(org.apache.ambari.server.topology.AmbariContextTest.host2.getHostId()).andReturn(2L).anyTimes();
        org.easymock.EasyMock.expect(org.apache.ambari.server.topology.AmbariContextTest.group1Info.getConfiguration()).andReturn(group1Configuration).anyTimes();
        org.easymock.EasyMock.expect(org.apache.ambari.server.topology.AmbariContextTest.group1Info.getHostNames()).andReturn(org.apache.ambari.server.topology.AmbariContextTest.group1Hosts).anyTimes();
        org.easymock.EasyMock.expect(org.apache.ambari.server.topology.AmbariContextTest.configGroup1.getName()).andReturn(java.lang.String.format("%s:%s", org.apache.ambari.server.topology.AmbariContextTest.BP_NAME, org.apache.ambari.server.topology.AmbariContextTest.HOST_GROUP_1)).anyTimes();
        org.easymock.EasyMock.expect(org.apache.ambari.server.topology.AmbariContextTest.configGroup2.getName()).andReturn(java.lang.String.format("%s:%s", org.apache.ambari.server.topology.AmbariContextTest.BP_NAME, org.apache.ambari.server.topology.AmbariContextTest.HOST_GROUP_2)).anyTimes();
        org.easymock.EasyMock.expect(org.apache.ambari.server.topology.AmbariContextTest.mockConfigHelperProvider.get()).andReturn(org.apache.ambari.server.topology.AmbariContextTest.mockConfigHelper).anyTimes();
    }

    @org.junit.After
    public void tearDown() throws java.lang.Exception {
        org.easymock.EasyMock.verify(org.apache.ambari.server.topology.AmbariContextTest.controller, org.apache.ambari.server.topology.AmbariContextTest.clusterController, org.apache.ambari.server.topology.AmbariContextTest.hostResourceProvider, org.apache.ambari.server.topology.AmbariContextTest.serviceResourceProvider, org.apache.ambari.server.topology.AmbariContextTest.componentResourceProvider, org.apache.ambari.server.topology.AmbariContextTest.hostComponentResourceProvider, org.apache.ambari.server.topology.AmbariContextTest.configGroupResourceProvider, org.apache.ambari.server.topology.AmbariContextTest.topology, org.apache.ambari.server.topology.AmbariContextTest.blueprint, org.apache.ambari.server.topology.AmbariContextTest.stack, org.apache.ambari.server.topology.AmbariContextTest.clusters, org.apache.ambari.server.topology.AmbariContextTest.cluster, org.apache.ambari.server.topology.AmbariContextTest.group1Info, org.apache.ambari.server.topology.AmbariContextTest.configHelper, org.apache.ambari.server.topology.AmbariContextTest.configGroup1, org.apache.ambari.server.topology.AmbariContextTest.configGroup2, org.apache.ambari.server.topology.AmbariContextTest.host1, org.apache.ambari.server.topology.AmbariContextTest.host2, org.apache.ambari.server.topology.AmbariContextTest.configFactory, org.apache.ambari.server.topology.AmbariContextTest.mockConfigHelperProvider, org.apache.ambari.server.topology.AmbariContextTest.mockConfigHelper);
        org.easymock.EasyMock.reset(org.apache.ambari.server.topology.AmbariContextTest.controller, org.apache.ambari.server.topology.AmbariContextTest.clusterController, org.apache.ambari.server.topology.AmbariContextTest.hostResourceProvider, org.apache.ambari.server.topology.AmbariContextTest.serviceResourceProvider, org.apache.ambari.server.topology.AmbariContextTest.componentResourceProvider, org.apache.ambari.server.topology.AmbariContextTest.hostComponentResourceProvider, org.apache.ambari.server.topology.AmbariContextTest.configGroupResourceProvider, org.apache.ambari.server.topology.AmbariContextTest.topology, org.apache.ambari.server.topology.AmbariContextTest.blueprint, org.apache.ambari.server.topology.AmbariContextTest.stack, org.apache.ambari.server.topology.AmbariContextTest.clusters, org.apache.ambari.server.topology.AmbariContextTest.cluster, org.apache.ambari.server.topology.AmbariContextTest.group1Info, org.apache.ambari.server.topology.AmbariContextTest.configHelper, org.apache.ambari.server.topology.AmbariContextTest.configGroup1, org.apache.ambari.server.topology.AmbariContextTest.configGroup2, org.apache.ambari.server.topology.AmbariContextTest.host1, org.apache.ambari.server.topology.AmbariContextTest.host2, org.apache.ambari.server.topology.AmbariContextTest.configFactory, org.apache.ambari.server.topology.AmbariContextTest.mockConfigHelperProvider, org.apache.ambari.server.topology.AmbariContextTest.mockConfigHelper);
    }

    private void replayAll() {
        org.easymock.EasyMock.replay(org.apache.ambari.server.topology.AmbariContextTest.controller, org.apache.ambari.server.topology.AmbariContextTest.clusterController, org.apache.ambari.server.topology.AmbariContextTest.hostResourceProvider, org.apache.ambari.server.topology.AmbariContextTest.serviceResourceProvider, org.apache.ambari.server.topology.AmbariContextTest.componentResourceProvider, org.apache.ambari.server.topology.AmbariContextTest.hostComponentResourceProvider, org.apache.ambari.server.topology.AmbariContextTest.configGroupResourceProvider, org.apache.ambari.server.topology.AmbariContextTest.topology, org.apache.ambari.server.topology.AmbariContextTest.blueprint, org.apache.ambari.server.topology.AmbariContextTest.stack, org.apache.ambari.server.topology.AmbariContextTest.clusters, org.apache.ambari.server.topology.AmbariContextTest.cluster, org.apache.ambari.server.topology.AmbariContextTest.group1Info, org.apache.ambari.server.topology.AmbariContextTest.configHelper, org.apache.ambari.server.topology.AmbariContextTest.configGroup1, org.apache.ambari.server.topology.AmbariContextTest.configGroup2, org.apache.ambari.server.topology.AmbariContextTest.host1, org.apache.ambari.server.topology.AmbariContextTest.host2, org.apache.ambari.server.topology.AmbariContextTest.configFactory, org.apache.ambari.server.topology.AmbariContextTest.mockConfigHelperProvider, org.apache.ambari.server.topology.AmbariContextTest.mockConfigHelper);
    }
    ...
    public void testCreateAmbariResources() throws java.lang.Exception {
        ...
        org.apache.ambari.server.topology.AmbariContextTest.controller.createCluster(org.easymock.EasyMock.capture(clusterRequestCapture));
        org.easymock.EasyMock.expectLastCall().once();
        org.easymock.EasyMock.expect(org.apache.ambari.server.topology.AmbariContextTest.cluster.getServices()).andReturn(org.apache.ambari.server.topology.AmbariContextTest.clusterServices).anyTimes();
        ...
        org.apache.ambari.server.topology.AmbariContextTest.serviceResourceProvider.createServices(org.easymock.EasyMock.capture(serviceRequestCapture));
        org.easymock.EasyMock.expectLastCall().once();
        org.apache.ambari.server.topology.AmbariContextTest.componentResourceProvider.createComponents(org.easymock.EasyMock.capture(serviceComponentRequestCapture));
        org.easymock.EasyMock.expectLastCall().once();
        ...
        org.easymock.EasyMock.expect(org.apache.ambari.server.topology.AmbariContextTest.serviceResourceProvider.updateResources(org.easymock.EasyMock.capture(serviceInstallRequestCapture), org.easymock.EasyMock.capture(installPredicateCapture))).andReturn(null).once();
        org.easymock.EasyMock.expect(org.apache.ambari.server.topology.AmbariContextTest.serviceResourceProvider.updateResources(org.easymock.EasyMock.capture(serviceStartRequestCapture), org.easymock.EasyMock.capture(startPredicateCapture))).andReturn(null).once();
        replayAll();
    ...
    public void testCreateAmbariHostResources() throws java.lang.Exception {
        org.easymock.EasyMock.expect(org.apache.ambari.server.topology.AmbariContextTest.cluster.getServices()).andReturn(org.apache.ambari.server.topology.AmbariContextTest.clusterServices).anyTimes();
        org.apache.ambari.server.topology.AmbariContextTest.hostResourceProvider.createHosts(org.easymock.EasyMock.anyObject(org.apache.ambari.server.controller.spi.Request.class));
        org.easymock.EasyMock.expectLastCall().once();
        org.easymock.EasyMock.expect(org.apache.ambari.server.topology.AmbariContextTest.cluster.getService("service1")).andReturn(org.apache.ambari.server.topology.AmbariContextTest.mockService1).times(2);
        org.easymock.EasyMock.expect(org.apache.ambari.server.topology.AmbariContextTest.cluster.getService("service2")).andReturn(org.apache.ambari.server.topology.AmbariContextTest.mockService1).once();
        ...
        org.apache.ambari.server.topology.AmbariContextTest.controller.createHostComponents(org.easymock.EasyMock.capture(requestsCapture), org.easymock.EasyMock.eq(true));
        org.easymock.EasyMock.expectLastCall().once();
        replayAll();
    ...
    public void testRegisterHostWithConfigGroup_createNewConfigGroup() throws java.lang.Exception {
        org.easymock.EasyMock.expect(org.apache.ambari.server.topology.AmbariContextTest.cluster.getConfigGroups()).andReturn(java.util.Collections.emptyMap()).once();
        org.easymock.EasyMock.expect(org.apache.ambari.server.topology.AmbariContextTest.clusterController.ensureResourceProvider(org.apache.ambari.server.controller.spi.Resource.Type.ConfigGroup)).andReturn(org.apache.ambari.server.topology.AmbariContextTest.configGroupResourceProvider).once();
        org.easymock.EasyMock.expect(org.apache.ambari.server.topology.AmbariContextTest.configGroupResourceProvider.createResources(org.easymock.EasyMock.capture(configGroupRequestCapture))).andReturn(null).once();
        replayAll();
    ...
    public void testRegisterHostWithConfigGroup_createNewConfigGroupWithPendingHosts() throws java.lang.Exception {
        ...
        org.easymock.EasyMock.expect(org.apache.ambari.server.topology.AmbariContextTest.clusterController.ensureResourceProvider(org.apache.ambari.server.controller.spi.Resource.Type.ConfigGroup)).andReturn(org.apache.ambari.server.topology.AmbariContextTest.configGroupResourceProvider).once();
        org.easymock.EasyMock.expect(org.apache.ambari.server.topology.AmbariContextTest.configGroupResourceProvider.createResources(org.easymock.EasyMock.capture(configGroupRequestCapture))).andReturn(null).once();
        org.easymock.EasyMock.reset(org.apache.ambari.server.topology.AmbariContextTest.group1Info);
        org.easymock.EasyMock.expect(org.apache.ambari.server.topology.AmbariContextTest.group1Info.getConfiguration()).andReturn(group1Configuration).anyTimes();
        ...
        org.easymock.EasyMock.expect(org.apache.ambari.server.topology.AmbariContextTest.group1Info.getHostNames()).andReturn(groupHosts).anyTimes();
        replayAll();
        org.apache.ambari.server.topology.AmbariContextTest.context.registerHostWithConfigGroup(org.apache.ambari.server.topology.AmbariContextTest.HOST1, org.apache.ambari.server.topology.AmbariContextTest.topology, org.apache.ambari.server.topology.AmbariContextTest.HOST_GROUP_1);
        java.util.Set<org.apache.ambari.server.controller.ConfigGroupRequest> configGroupRequests = configGroupRequestCapture.getValue();
        org.junit.Assert.assertEquals(1, configGroupRequests.size());
    ...
    public void testRegisterHostWithConfigGroup_registerWithExistingConfigGroup() throws java.lang.Exception {
        org.easymock.EasyMock.expect(org.apache.ambari.server.topology.AmbariContextTest.cluster.getConfigGroups()).andReturn(org.apache.ambari.server.topology.AmbariContextTest.configGroups).once();
        org.easymock.EasyMock.expect(org.apache.ambari.server.topology.AmbariContextTest.configGroup1.getHosts()).andReturn(java.util.Collections.singletonMap(2L, org.apache.ambari.server.topology.AmbariContextTest.host2)).once();
    ...
    public void testRegisterHostWithConfigGroup_registerWithExistingConfigGroup_hostAlreadyRegistered() throws java.lang.Exception {
        org.easymock.EasyMock.expect(org.apache.ambari.server.topology.AmbariContextTest.cluster.getConfigGroups()).andReturn(org.apache.ambari.server.topology.AmbariContextTest.configGroups).once();
        org.easymock.EasyMock.expect(org.apache.ambari.server.topology.AmbariContextTest.configGroup1.getHosts()).andReturn(java.util.Collections.singletonMap(1L, org.apache.ambari.server.topology.AmbariContextTest.host1)).once();
        replayAll();
        org.apache.ambari.server.topology.AmbariContextTest.context.registerHostWithConfigGroup(org.apache.ambari.server.topology.AmbariContextTest.HOST1, org.apache.ambari.server.topology.AmbariContextTest.topology, org.apache.ambari.server.topology.AmbariContextTest.HOST_GROUP_1);
    }
    ...
    public void testWaitForTopologyResolvedStateWithRequiredUpdatedSet() throws java.lang.Exception {
        ...
        org.easymock.EasyMock.expect(org.apache.ambari.server.topology.AmbariContextTest.cluster.getDesiredConfigs()).andReturn(testDesiredConfigs).atLeastOnce();
        replayAll();
    ...
    public void testIsTopologyResolved_True() throws java.lang.Exception {
        ...
        org.easymock.EasyMock.expect(org.apache.ambari.server.topology.AmbariContextTest.cluster.getAllDesiredConfigVersions()).andReturn(testDesiredConfigs).atLeastOnce();
        replayAll();
    ...
    public void testCreateAmbariResourcesNoVersions() throws java.lang.Exception {
        org.apache.ambari.server.controller.internal.VersionDefinitionResourceProvider vdfResourceProvider = org.easymock.EasyMock.createNiceMock(org.apache.ambari.server.controller.internal.VersionDefinitionResourceProvider.class);
        java.lang.Class<org.apache.ambari.server.topology.AmbariContext> clazz = org.apache.ambari.server.topology.AmbariContext.class;
        java.lang.reflect.Field f = clazz.getDeclaredField("versionDefinitionResourceProvider");
        f.setAccessible(true);
        f.set(null, vdfResourceProvider);
        org.apache.ambari.server.controller.spi.Resource resource = org.easymock.EasyMock.createNiceMock(org.apache.ambari.server.controller.spi.Resource.class);
        org.easymock.EasyMock.expect(resource.getPropertyValue(org.apache.ambari.server.controller.internal.VersionDefinitionResourceProvider.VERSION_DEF_ID)).andReturn(1L).atLeastOnce();
        org.apache.ambari.server.controller.spi.RequestStatus requestStatus = org.easymock.EasyMock.createNiceMock(org.apache.ambari.server.controller.spi.RequestStatus.class);
        org.easymock.EasyMock.expect(requestStatus.getAssociatedResources()).andReturn(java.util.Collections.singleton(resource)).atLeastOnce();
        org.easymock.EasyMock.expect(vdfResourceProvider.createResources(org.easymock.EasyMock.anyObject(org.apache.ambari.server.controller.spi.Request.class))).andReturn(requestStatus);
        org.apache.ambari.server.orm.dao.RepositoryVersionDAO repositoryVersionDAO = org.easymock.EasyMock.createNiceMock(org.apache.ambari.server.orm.dao.RepositoryVersionDAO.class);
        org.apache.ambari.server.orm.entities.RepositoryVersionEntity repositoryVersion = org.easymock.EasyMock.createNiceMock(org.apache.ambari.server.orm.entities.RepositoryVersionEntity.class);
        org.easymock.EasyMock.expect(repositoryVersion.getId()).andReturn(1L).atLeastOnce();
        org.easymock.EasyMock.expect(repositoryVersion.getVersion()).andReturn("1.1.1.1").atLeastOnce();
        org.easymock.EasyMock.expect(repositoryVersion.getType()).andReturn(org.apache.ambari.spi.RepositoryType.STANDARD).atLeastOnce();
        org.easymock.EasyMock.expect(repositoryVersionDAO.findByStack(org.easymock.EasyMock.anyObject(org.apache.ambari.server.state.StackId.class))).andReturn(java.util.Collections.<org.apache.ambari.server.orm.entities.RepositoryVersionEntity>emptyList()).atLeastOnce();
        org.easymock.EasyMock.expect(repositoryVersionDAO.findByPK(org.easymock.EasyMock.anyLong())).andReturn(repositoryVersion);
        org.easymock.EasyMock.replay(repositoryVersionDAO, repositoryVersion, resource, requestStatus, vdfResourceProvider);
        org.apache.ambari.server.topology.AmbariContextTest.context.repositoryVersionDAO = repositoryVersionDAO;
    ...
    private void expectAmbariResourceCreation() {
        try {
            org.apache.ambari.server.topology.AmbariContextTest.controller.createCluster(org.easymock.EasyMock.capture(org.easymock.Capture.newInstance()));
            org.easymock.EasyMock.expectLastCall().once();
            org.easymock.EasyMock.expect(org.apache.ambari.server.topology.AmbariContextTest.cluster.getServices()).andReturn(org.apache.ambari.server.topology.AmbariContextTest.clusterServices).anyTimes();
            org.apache.ambari.server.topology.AmbariContextTest.serviceResourceProvider.createServices(org.easymock.EasyMock.capture(org.easymock.Capture.newInstance()));
            org.easymock.EasyMock.expectLastCall().once();
            org.apache.ambari.server.topology.AmbariContextTest.componentResourceProvider.createComponents(org.easymock.EasyMock.capture(org.easymock.Capture.newInstance()));
            org.easymock.EasyMock.expectLastCall().once();
            org.easymock.EasyMock.expect(org.apache.ambari.server.topology.AmbariContextTest.serviceResourceProvider.updateResources(org.easymock.EasyMock.capture(org.easymock.Capture.newInstance()), org.easymock.EasyMock.capture(org.easymock.Capture.newInstance()))).andReturn(null).atLeastOnce();
    ...
    public void testCreateAmbariResourcesManyVersions() throws java.lang.Exception {
        org.apache.ambari.server.orm.dao.RepositoryVersionDAO repositoryVersionDAO = org.easymock.EasyMock.createNiceMock(org.apache.ambari.server.orm.dao.RepositoryVersionDAO.class);
        org.apache.ambari.server.orm.entities.RepositoryVersionEntity repositoryVersion1 = org.easymock.EasyMock.createNiceMock(org.apache.ambari.server.orm.entities.RepositoryVersionEntity.class);
        org.easymock.EasyMock.expect(repositoryVersion1.getId()).andReturn(1L).atLeastOnce();
        org.easymock.EasyMock.expect(repositoryVersion1.getVersion()).andReturn("1.1.1.1").atLeastOnce();
        org.apache.ambari.server.orm.entities.RepositoryVersionEntity repositoryVersion2 = org.easymock.EasyMock.createNiceMock(org.apache.ambari.server.orm.entities.RepositoryVersionEntity.class);
        org.easymock.EasyMock.expect(repositoryVersion2.getId()).andReturn(2L).atLeastOnce();
        org.easymock.EasyMock.expect(repositoryVersion2.getVersion()).andReturn("1.1.2.2").atLeastOnce();
        org.easymock.EasyMock.expect(repositoryVersionDAO.findByStack(org.easymock.EasyMock.anyObject(org.apache.ambari.server.state.StackId.class))).andReturn(java.util.Arrays.asList(repositoryVersion1, repositoryVersion2)).atLeastOnce();
        org.easymock.EasyMock.replay(repositoryVersionDAO, repositoryVersion1, repositoryVersion2);
        org.apache.ambari.server.topology.AmbariContextTest.context.repositoryVersionDAO = repositoryVersionDAO;
        replayAll();
        try {
            org.apache.ambari.server.topology.AmbariContextTest.context.createAmbariResources(org.apache.ambari.server.topology.AmbariContextTest.topology, org.apache.ambari.server.topology.AmbariContextTest.CLUSTER_NAME, null, null, null);
    ...
    public void testCreateAmbariResourcesBadVersion() throws java.lang.Exception {
        org.apache.ambari.server.orm.dao.RepositoryVersionDAO repositoryVersionDAO = org.easymock.EasyMock.createNiceMock(org.apache.ambari.server.orm.dao.RepositoryVersionDAO.class);
        org.easymock.EasyMock.expect(repositoryVersionDAO.findByStackAndVersion(org.easymock.EasyMock.anyObject(org.apache.ambari.server.state.StackId.class), org.easymock.EasyMock.anyString())).andReturn(null).atLeastOnce();
        org.easymock.EasyMock.replay(repositoryVersionDAO);
        org.apache.ambari.server.topology.AmbariContextTest.context.repositoryVersionDAO = repositoryVersionDAO;
        replayAll();
        try {
    ...
    private org.apache.ambari.server.orm.entities.RepositoryVersionEntity repositoryInClusterCreationRequest(java.lang.Long id, java.lang.String version, org.apache.ambari.server.state.StackId stackId) {
        org.apache.ambari.server.orm.entities.RepositoryVersionEntity repoEntity = org.easymock.EasyMock.createNiceMock(org.apache.ambari.server.orm.entities.RepositoryVersionEntity.class);
        org.easymock.EasyMock.expect(repoEntity.getStackId()).andStubReturn(stackId);
        org.easymock.EasyMock.expect(repoEntity.getId()).andStubReturn(id);
        org.easymock.EasyMock.expect(repoEntity.getType()).andStubReturn(org.apache.ambari.spi.RepositoryType.STANDARD);
        org.easymock.EasyMock.expect(repoEntity.getVersion()).andStubReturn(version);
        org.apache.ambari.server.orm.dao.RepositoryVersionDAO repositoryVersionDAO = org.easymock.EasyMock.createNiceMock(org.apache.ambari.server.orm.dao.RepositoryVersionDAO.class);
        org.easymock.EasyMock.expect(repositoryVersionDAO.findByPK(1L)).andStubReturn(repoEntity);
        org.easymock.EasyMock.expect(repositoryVersionDAO.findByStackAndVersion(org.easymock.EasyMock.anyObject(org.apache.ambari.server.state.StackId.class), org.easymock.EasyMock.anyString())).andStubReturn(repoEntity);
        org.easymock.EasyMock.replay(repositoryVersionDAO, repoEntity);
        org.apache.ambari.server.topology.AmbariContextTest.context.repositoryVersionDAO = repositoryVersionDAO;
        return repoEntity;
    }
}
