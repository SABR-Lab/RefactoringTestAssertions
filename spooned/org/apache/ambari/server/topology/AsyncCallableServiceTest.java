...
public class AsyncCallableServiceTest extends org.easymock.EasyMockSupport {
    ...
    public void testCallableServiceShouldCancelTaskWhenTimeoutExceeded() throws java.lang.Exception {
        ...
        org.easymock.EasyMock.expect(futureMock.get(timeout, java.util.concurrent.TimeUnit.MILLISECONDS)).andThrow(timeoutException);
        org.easymock.EasyMock.expect(futureMock.isDone()).andReturn(java.lang.Boolean.FALSE);
        org.easymock.EasyMock.expect(futureMock.cancel(true)).andReturn(java.lang.Boolean.TRUE);
        org.easymock.EasyMock.expect(executorServiceMock.submit(taskMock)).andReturn(futureMock);
    ...
    public void lastErrorIsReturnedIfSubsequentAttemptTimesOut() throws java.lang.Exception {
        ...
        org.easymock.EasyMock.expect(futureMock.get(org.apache.ambari.server.topology.AsyncCallableServiceTest.TIMEOUT, java.util.concurrent.TimeUnit.MILLISECONDS)).andThrow(computationException);
        org.easymock.EasyMock.expect(executorServiceMock.schedule(taskMock, org.apache.ambari.server.topology.AsyncCallableServiceTest.RETRY_DELAY, java.util.concurrent.TimeUnit.MILLISECONDS)).andReturn(futureMock);
        org.easymock.Capture<java.lang.Long> timeoutCapture = org.easymock.Capture.newInstance();
        org.easymock.EasyMock.expect(futureMock.get(org.easymock.EasyMock.captureLong(timeoutCapture), org.easymock.EasyMock.eq(java.util.concurrent.TimeUnit.MILLISECONDS))).andThrow(timeoutException);
        org.easymock.EasyMock.expect(futureMock.isDone()).andReturn(java.lang.Boolean.FALSE);
        org.easymock.EasyMock.expect(futureMock.cancel(true)).andReturn(java.lang.Boolean.TRUE);
        org.easymock.EasyMock.expect(executorServiceMock.submit(taskMock)).andReturn(futureMock);
    ...
    public void testCallableServiceShouldCancelTaskWhenTaskHangsAndTimeoutExceeded() throws java.lang.Exception {
        ...
        onErrorMock.accept(org.easymock.EasyMock.anyObject(java.util.concurrent.TimeoutException.class));
        replayAll();
    ...
    public void testCallableServiceShouldExitWhenTaskCompleted() throws java.lang.Exception {
        org.easymock.EasyMock.expect(taskMock.call()).andReturn(java.lang.Boolean.TRUE);
        onErrorMock.accept(org.easymock.EasyMock.anyObject(java.util.concurrent.TimeoutException.class));
        org.easymock.EasyMock.expectLastCall().andThrow(new java.lang.AssertionError("No error expected")).anyTimes();
        replayAll();
    ...
    public void testCallableServiceShouldRetryTaskExecutionTillTimeoutExceededWhenTaskThrowsException() throws java.lang.Exception {
        org.easymock.EasyMock.expect(taskMock.call()).andThrow(new java.lang.IllegalStateException("****************** TESTING ****************")).times(2, 20);
        onErrorMock.accept(org.easymock.EasyMock.anyObject(java.lang.IllegalStateException.class));
        replayAll();
        asyncCallableService = new org.apache.ambari.server.topology.AsyncCallableService<>(taskMock, org.apache.ambari.server.topology.AsyncCallableServiceTest.TIMEOUT, org.apache.ambari.server.topology.AsyncCallableServiceTest.RETRY_DELAY, "test", onErrorMock);
        java.lang.Boolean serviceResult = asyncCallableService.call();
        verifyAll();
