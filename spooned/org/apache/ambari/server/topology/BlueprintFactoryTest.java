...
public class BlueprintFactoryTest {
    ...
    org.apache.ambari.server.orm.dao.BlueprintDAO dao = org.powermock.api.easymock.PowerMock.createStrictMock(org.apache.ambari.server.orm.dao.BlueprintDAO.class);

    org.apache.ambari.server.orm.entities.BlueprintEntity entity = org.powermock.api.easymock.PowerMock.createStrictMock(org.apache.ambari.server.orm.entities.BlueprintEntity.class);

    org.apache.ambari.server.orm.entities.BlueprintConfigEntity configEntity = org.powermock.api.easymock.PowerMock.createStrictMock(org.apache.ambari.server.orm.entities.BlueprintConfigEntity.class);
    ...
    public void init() throws java.lang.Exception {
        ...
        org.easymock.EasyMock.expect(stack.getComponents()).andReturn(componentMap).anyTimes();
        org.easymock.EasyMock.expect(stack.isMasterComponent("component1")).andReturn(true).anyTimes();
        org.easymock.EasyMock.expect(stack.isMasterComponent("component2")).andReturn(false).anyTimes();
        org.easymock.EasyMock.expect(stack.getServiceForComponent("component1")).andReturn("test-service1").anyTimes();
        org.easymock.EasyMock.expect(stack.getServiceForComponent("component2")).andReturn("test-service2").anyTimes();
    }

    @org.junit.After
    public void tearDown() {
        org.powermock.api.easymock.PowerMock.reset(stack, dao, entity, configEntity);
    }

    @org.junit.Test
    public void testGetBlueprint_NotFound() throws java.lang.Exception {
        org.easymock.EasyMock.expect(dao.findByName(org.apache.ambari.server.topology.BlueprintFactoryTest.BLUEPRINT_NAME)).andReturn(null).once();
        org.powermock.api.easymock.PowerMock.replay(dao, entity, configEntity);
    ...
    public void testCreateBlueprint() throws java.lang.Exception {
        ...
        org.powermock.api.easymock.PowerMock.replay(stack, dao, entity, configEntity);
        ...
        org.junit.Assert.assertTrue(configuration.getProperties().isEmpty());
        org.junit.Assert.assertTrue(configuration.getAttributes().isEmpty());
        org.powermock.api.easymock.PowerMock.verify(dao, entity, configEntity);
    }
    ...
    public void testCreateInvalidStack() throws java.lang.Exception {
        ...
        org.easymock.EasyMock.expect(mockStackFactory.createStack("null", "null", null)).andThrow(new org.apache.ambari.server.ObjectNotFoundException("Invalid Stack"));
