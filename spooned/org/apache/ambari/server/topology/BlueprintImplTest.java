...
public class BlueprintImplTest {
    ...
    org.apache.ambari.server.topology.Setting setting = org.easymock.EasyMock.createNiceMock(org.apache.ambari.server.topology.Setting.class);

    org.apache.ambari.server.topology.HostGroup group1 = org.easymock.EasyMock.createMock(org.apache.ambari.server.topology.HostGroup.class);

    org.apache.ambari.server.topology.HostGroup group2 = org.easymock.EasyMock.createMock(org.apache.ambari.server.topology.HostGroup.class);
    ...
    public void setup() throws java.lang.NoSuchFieldException, java.lang.IllegalAccessException {
        ...
        org.easymock.EasyMock.expect(stack.isPasswordProperty("HDFS", "hdfs-site", "foo")).andReturn(false).anyTimes();
        org.easymock.EasyMock.expect(stack.isPasswordProperty("HDFS", "hdfs-site", "bar")).andReturn(false).anyTimes();
        org.easymock.EasyMock.expect(stack.isPasswordProperty("HDFS", "hdfs-site", "some_password")).andReturn(true).anyTimes();
        org.easymock.EasyMock.expect(stack.isPasswordProperty("HDFS", "category1", "prop1")).andReturn(false).anyTimes();
        org.easymock.EasyMock.expect(stack.isPasswordProperty("SERVICE2", "category2", "prop2")).andReturn(false).anyTimes();
        org.easymock.EasyMock.expect(stack.getServiceForComponent("c1")).andReturn("HDFS").anyTimes();
        org.easymock.EasyMock.expect(stack.getServiceForComponent("c2")).andReturn("HDFS").anyTimes();
        org.easymock.EasyMock.expect(stack.getServiceForComponent("c3")).andReturn("SERVICE2").anyTimes();
        ...
        org.easymock.EasyMock.expect(group1.getConfiguration()).andReturn(org.apache.ambari.server.topology.BlueprintImplTest.EMPTY_CONFIGURATION).anyTimes();
        ...
        org.easymock.EasyMock.expect(stack.getRequiredConfigurationProperties("HDFS")).andReturn(requiredHDFSProperties).anyTimes();
        org.easymock.EasyMock.expect(stack.getRequiredConfigurationProperties("SERVICE2")).andReturn(requiredService2Properties).anyTimes();
    ...
    public void testValidateConfigurations__basic_positive() throws java.lang.Exception {
        org.easymock.EasyMock.expect(group1.getCardinality()).andReturn("1").atLeastOnce();
        org.easymock.EasyMock.expect(group1.getComponents()).andReturn(java.util.Arrays.asList(new org.apache.ambari.server.topology.Component("c1"), new org.apache.ambari.server.topology.Component("c2"))).atLeastOnce();
        org.easymock.EasyMock.expect(group2.getCardinality()).andReturn("1").atLeastOnce();
        org.easymock.EasyMock.expect(group2.getComponents()).andReturn(java.util.Arrays.asList(new org.apache.ambari.server.topology.Component("c1"), new org.apache.ambari.server.topology.Component("c3"))).atLeastOnce();
        org.easymock.EasyMock.expect(group2.getConfiguration()).andReturn(org.apache.ambari.server.topology.BlueprintImplTest.EMPTY_CONFIGURATION).atLeastOnce();
        org.easymock.EasyMock.replay(stack, group1, group2, serverConfig);
        ...
        org.easymock.EasyMock.verify(stack, group1, group2, serverConfig);
    ...
    public void testValidateConfigurations__hostGroupConfig() throws java.lang.Exception {
        ...
        org.easymock.EasyMock.expect(group2.getConfiguration()).andReturn(group2Configuration).atLeastOnce();
        org.easymock.EasyMock.expect(group1.getCardinality()).andReturn("1").atLeastOnce();
        org.easymock.EasyMock.expect(group1.getComponents()).andReturn(java.util.Arrays.asList(new org.apache.ambari.server.topology.Component("NAMENODE"))).atLeastOnce();
        org.easymock.EasyMock.expect(group2.getCardinality()).andReturn("1").atLeastOnce();
        org.easymock.EasyMock.expect(group2.getComponents()).andReturn(java.util.Arrays.asList(new org.apache.ambari.server.topology.Component("NAMENODE"))).atLeastOnce();
        java.util.Map<java.lang.String, java.lang.String> category2Props = new java.util.HashMap<>();
        properties.put("category2", category2Props);
        category2Props.put("prop2", "val");
    ...
    public void testValidateConfigurations__hostGroupConfigForNameNodeHAPositive() throws java.lang.Exception {
        ...
        org.easymock.EasyMock.expect(group2.getConfiguration()).andReturn(group2Configuration).atLeastOnce();
        org.easymock.EasyMock.expect(group1.getCardinality()).andReturn("1").atLeastOnce();
        org.easymock.EasyMock.expect(group1.getComponents()).andReturn(java.util.Arrays.asList(new org.apache.ambari.server.topology.Component("NAMENODE"), new org.apache.ambari.server.topology.Component("ZKFC"))).atLeastOnce();
        org.easymock.EasyMock.expect(group2.getCardinality()).andReturn("1").atLeastOnce();
        org.easymock.EasyMock.expect(group2.getComponents()).andReturn(java.util.Arrays.asList(new org.apache.ambari.server.topology.Component("NAMENODE"), new org.apache.ambari.server.topology.Component("ZKFC"))).atLeastOnce();
        java.util.Map<java.lang.String, java.lang.String> category2Props = new java.util.HashMap<>();
        properties.put("category2", category2Props);
        category2Props.put("prop2", "val");
        group1Components.add("NAMENODE");
    ...
    public void testValidateConfigurations__hostGroupConfigForNameNodeHAInCorrectHostGroups() throws java.lang.Exception {
        ...
        group2Components.add("NAMENODE");
        group2Components.add("ZKFC");
        org.easymock.EasyMock.expect(stack.getServiceForComponent("NAMENODE")).andReturn("SERVICE2").atLeastOnce();
        org.easymock.EasyMock.expect(stack.getServiceForComponent("ZKFC")).andReturn("SERVICE2").atLeastOnce();
        java.util.Map<java.lang.String, java.lang.String> hdfsProps = new java.util.HashMap<>();
        properties.put("hdfs-site", hdfsProps);
        hdfsProps.put("foo", "val");
        hdfsProps.put("bar", "val");
    ...
    public void testAutoSkipFailureEnabled() {
        ...
        org.easymock.EasyMock.expect(setting.getSettingValue(org.apache.ambari.server.topology.Setting.SETTING_NAME_DEPLOYMENT_SETTINGS)).andReturn(java.util.Collections.singleton(skipFailureSetting));
        org.easymock.EasyMock.replay(stack, setting);
        org.junit.Assert.assertTrue(blueprint.shouldSkipFailure());
        org.easymock.EasyMock.verify(stack, setting);
    }
    ...
    public static org.apache.ambari.server.configuration.Configuration setupConfigurationWithGPLLicense(boolean isGPLAllowed) throws java.lang.NoSuchFieldException, java.lang.IllegalAccessException {
        org.apache.ambari.server.configuration.Configuration serverConfig = org.easymock.EasyMock.mock(org.apache.ambari.server.configuration.Configuration.class);
        org.easymock.EasyMock.expect(serverConfig.getGplLicenseAccepted()).andReturn(isGPLAllowed).atLeastOnce();
