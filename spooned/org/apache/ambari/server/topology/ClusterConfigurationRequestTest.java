...
public class ClusterConfigurationRequestTest {
    ...
    private org.easymock.Capture<? extends java.util.Set<java.lang.String>> testProcessWithKerberos(java.lang.String blueprintPropertyValue, java.lang.String stackPropertyValue, java.util.Map<java.lang.String, java.util.Map<java.lang.String, java.lang.String>> kerberosConfig) throws org.apache.ambari.server.AmbariException, org.apache.ambari.server.serveraction.kerberos.KerberosInvalidConfigurationException, org.apache.ambari.server.controller.internal.ConfigurationTopologyException {
        ...
        org.easymock.EasyMock.expectLastCall().andReturn(controller).anyTimes();
        org.easymock.EasyMock.expect(controller.getClusters()).andReturn(clusters).anyTimes();
        org.easymock.EasyMock.expect(controller.getKerberosHelper()).andReturn(kerberosHelper).times(1);
        org.easymock.EasyMock.expect(clusters.getCluster("testCluster")).andReturn(cluster).anyTimes();
        ...
        org.easymock.EasyMock.expect(stack.getServiceForConfigType("testConfigType")).andReturn("KERBEROS").anyTimes();
        org.easymock.EasyMock.expect(stack.getAllConfigurationTypes(org.easymock.EasyMock.anyString())).andReturn(java.util.Collections.singletonList("testConfigType")).anyTimes();
        org.easymock.EasyMock.expect(stack.getExcludedConfigurationTypes(org.easymock.EasyMock.anyString())).andReturn(java.util.Collections.emptySet()).anyTimes();
        org.easymock.EasyMock.expect(stack.getConfigurationPropertiesWithMetadata(org.easymock.EasyMock.anyString(), org.easymock.EasyMock.anyString())).andReturn(java.util.Collections.emptyMap()).anyTimes();
        ...
        org.easymock.EasyMock.expect(stack.getConfiguration(services)).andReturn(stackDefaultConfig).once();
        ...
        org.easymock.EasyMock.expect(blueprint.getComponents("HDFS")).andReturn(hdfsComponents).anyTimes();
        org.easymock.EasyMock.expect(blueprint.getComponents("KERBEROS")).andReturn(kerberosComponents).anyTimes();
        org.easymock.EasyMock.expect(blueprint.getComponents("ZOOKEPER")).andReturn(zookeeperComponents).anyTimes();
        org.easymock.EasyMock.expect(topology.getAmbariContext()).andReturn(ambariContext).anyTimes();
        org.easymock.EasyMock.expect(topology.getConfigRecommendationStrategy()).andReturn(org.apache.ambari.server.topology.ConfigRecommendationStrategy.NEVER_APPLY).anyTimes();
        org.easymock.EasyMock.expect(topology.getBlueprint()).andReturn(blueprint).anyTimes();
        org.easymock.EasyMock.expect(blueprint.isValidConfigType("testConfigType")).andReturn(true).anyTimes();
        org.easymock.EasyMock.expect(topology.getConfiguration()).andReturn(blueprintConfig).anyTimes();
        org.easymock.EasyMock.expect(topology.getHostGroupInfo()).andReturn(java.util.Collections.emptyMap()).anyTimes();
        org.easymock.EasyMock.expect(topology.getClusterId()).andReturn(java.lang.Long.valueOf(1)).anyTimes();
        org.easymock.EasyMock.expect(topology.getHostGroupsForComponent(org.easymock.EasyMock.anyString())).andReturn(java.util.Collections.emptyList()).anyTimes();
        org.easymock.EasyMock.expect(ambariContext.getConfigHelper()).andReturn(configHelper).anyTimes();
        org.easymock.EasyMock.expect(ambariContext.getClusterName(java.lang.Long.valueOf(1))).andReturn("testCluster").anyTimes();
        org.easymock.EasyMock.expect(ambariContext.createConfigurationRequests(org.easymock.EasyMock.anyObject())).andReturn(java.util.Collections.emptyList()).anyTimes();
        ...
        org.easymock.EasyMock.expect(kerberosHelper.ensureHeadlessIdentities(org.easymock.EasyMock.anyObject(org.apache.ambari.server.state.Cluster.class), org.easymock.EasyMock.anyObject(), org.easymock.EasyMock.anyObject())).andReturn(true).once();
        org.easymock.EasyMock.expect(kerberosHelper.getServiceConfigurationUpdates(org.easymock.EasyMock.anyObject(org.apache.ambari.server.state.Cluster.class), org.easymock.EasyMock.anyObject(), org.easymock.EasyMock.anyObject(), org.easymock.EasyMock.anyObject(), org.easymock.EasyMock.anyObject(), org.easymock.EasyMock.anyBoolean(), org.easymock.EasyMock.eq(false))).andReturn(kerberosConfig).once();
        org.easymock.Capture<? extends java.lang.String> captureClusterName = org.easymock.EasyMock.newCapture(org.easymock.CaptureType.ALL);
        org.easymock.Capture<? extends java.util.Set<java.lang.String>> captureUpdatedConfigTypes = org.easymock.EasyMock.newCapture(org.easymock.CaptureType.ALL);
        ambariContext.waitForConfigurationResolution(org.easymock.EasyMock.capture(captureClusterName), org.easymock.EasyMock.capture(captureUpdatedConfigTypes));
        ...
        org.easymock.EasyMock.verify(blueprint, topology, ambariContext, controller, kerberosHelper, configHelper);
    ...
    public void testProcessClusterConfigRequestDontIncludeKererosConfigs() throws java.lang.Exception {
        ...
        org.easymock.EasyMock.expect(topology.getConfigRecommendationStrategy()).andReturn(org.apache.ambari.server.topology.ConfigRecommendationStrategy.NEVER_APPLY).anyTimes();
        org.easymock.EasyMock.expect(topology.getBlueprint()).andReturn(blueprint).anyTimes();
        org.easymock.EasyMock.expect(topology.getConfiguration()).andReturn(stackConfig).anyTimes();
        org.easymock.EasyMock.expect(topology.getHostGroupInfo()).andReturn(java.util.Collections.emptyMap()).anyTimes();
        org.easymock.EasyMock.expect(topology.getClusterId()).andReturn(java.lang.Long.valueOf(1)).anyTimes();
        org.easymock.EasyMock.expect(ambariContext.getConfigHelper()).andReturn(configHelper).anyTimes();
        org.easymock.EasyMock.expect(ambariContext.getClusterName(java.lang.Long.valueOf(1))).andReturn("testCluster").anyTimes();
        ...
        clusterConfigurationRequest.process();
        org.easymock.EasyMock.verify(blueprint, topology, ambariContext, controller, configHelper);
    }
    ...
    public void testProcessClusterConfigRequestRemoveUnusedConfigTypes() throws java.lang.Exception {
        ...
        org.easymock.EasyMock.expect(topology.getAmbariContext()).andReturn(ambariContext).anyTimes();
        org.easymock.EasyMock.expect(topology.getConfiguration()).andReturn(configuration).anyTimes();
        org.easymock.EasyMock.expect(topology.getBlueprint()).andReturn(blueprint).anyTimes();
        org.easymock.EasyMock.expect(topology.getHostGroupInfo()).andReturn(hostGroupInfoMap);
        org.easymock.EasyMock.expect(blueprint.getStack()).andReturn(stack).anyTimes();
        org.easymock.EasyMock.expect(blueprint.getServices()).andReturn(services).anyTimes();
        org.easymock.EasyMock.expect(blueprint.isValidConfigType("hdfs-site")).andReturn(true).anyTimes();
        org.easymock.EasyMock.expect(blueprint.isValidConfigType("admin-properties")).andReturn(true).anyTimes();
        org.easymock.EasyMock.expect(blueprint.isValidConfigType("yarn-site")).andReturn(false).anyTimes();
        org.easymock.EasyMock.expect(blueprint.isValidConfigType("cluster-env")).andReturn(true).anyTimes();
        org.easymock.EasyMock.expect(blueprint.isValidConfigType("global")).andReturn(true).anyTimes();
        org.easymock.EasyMock.expect(ambariContext.getConfigHelper()).andReturn(configHelper).anyTimes();
        org.easymock.EasyMock.expect(configHelper.getDefaultStackProperties(org.easymock.EasyMock.eq(new org.apache.ambari.server.state.StackId(STACK_NAME, STACK_VERSION)))).andReturn(stackProperties).anyTimes();
        ...
        org.easymock.EasyMock.verify(stack, blueprint, topology, ambariContext, configHelper);
    }
