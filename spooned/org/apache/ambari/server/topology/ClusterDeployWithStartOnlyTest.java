...
public class ClusterDeployWithStartOnlyTest extends org.easymock.EasyMockSupport {
    ...
    public void setup() throws java.lang.Exception {
        ...
        org.easymock.EasyMock.expect(blueprint.getName()).andReturn(org.apache.ambari.server.topology.ClusterDeployWithStartOnlyTest.BLUEPRINT_NAME).anyTimes();
        ...
        org.easymock.EasyMock.expect(stack.getName()).andReturn(org.apache.ambari.server.topology.ClusterDeployWithStartOnlyTest.STACK_NAME).anyTimes();
        org.easymock.EasyMock.expect(stack.getVersion()).andReturn(org.apache.ambari.server.topology.ClusterDeployWithStartOnlyTest.STACK_VERSION).anyTimes();
        ...
        org.easymock.EasyMock.expect(request.getClusterId()).andReturn(org.apache.ambari.server.topology.ClusterDeployWithStartOnlyTest.CLUSTER_ID).anyTimes();
        org.easymock.EasyMock.expect(request.getClusterName()).andReturn(org.apache.ambari.server.topology.ClusterDeployWithStartOnlyTest.CLUSTER_NAME).anyTimes();
        ...
        org.easymock.EasyMock.expect(request.getProvisionAction()).andReturn(org.apache.ambari.server.controller.internal.ProvisionAction.START_ONLY).anyTimes();
        ...
        org.easymock.EasyMock.expect(group1.getBlueprintName()).andReturn(org.apache.ambari.server.topology.ClusterDeployWithStartOnlyTest.BLUEPRINT_NAME).anyTimes();
        ...
        org.easymock.EasyMock.expect(group1.getComponentNames(org.easymock.EasyMock.anyObject(org.apache.ambari.server.controller.internal.ProvisionAction.class))).andReturn(java.util.Collections.emptyList()).anyTimes();
        ...
        org.easymock.EasyMock.expect(group2.getBlueprintName()).andReturn(org.apache.ambari.server.topology.ClusterDeployWithStartOnlyTest.BLUEPRINT_NAME).anyTimes();
        ...
        org.easymock.EasyMock.expect(group2.getComponentNames(org.easymock.EasyMock.anyObject(org.apache.ambari.server.controller.internal.ProvisionAction.class))).andReturn(java.util.Collections.emptyList()).anyTimes();
        ...
        org.easymock.EasyMock.expect(clusters.getCluster(org.apache.ambari.server.topology.ClusterDeployWithStartOnlyTest.CLUSTER_NAME)).andReturn(cluster).anyTimes();
        org.easymock.EasyMock.expect(cluster.getClusterName()).andReturn(org.apache.ambari.server.topology.ClusterDeployWithStartOnlyTest.CLUSTER_NAME).anyTimes();
        org.easymock.EasyMock.expect(ambariContext.getPersistedTopologyState()).andReturn(persistedState).anyTimes();
        ambariContext.createAmbariResources(org.easymock.EasyMock.isA(org.apache.ambari.server.topology.ClusterTopology.class), org.easymock.EasyMock.eq(org.apache.ambari.server.topology.ClusterDeployWithStartOnlyTest.CLUSTER_NAME), ((org.apache.ambari.server.state.SecurityType) (org.easymock.EasyMock.isNull())), org.easymock.EasyMock.eq("1"), org.easymock.EasyMock.anyLong());
        org.easymock.EasyMock.expectLastCall().once();
        org.easymock.EasyMock.expect(ambariContext.getNextRequestId()).andReturn(1L).once();
        org.easymock.EasyMock.expect(ambariContext.isClusterKerberosEnabled(org.apache.ambari.server.topology.ClusterDeployWithStartOnlyTest.CLUSTER_ID)).andReturn(false).anyTimes();
        org.easymock.EasyMock.expect(ambariContext.getClusterId(org.apache.ambari.server.topology.ClusterDeployWithStartOnlyTest.CLUSTER_NAME)).andReturn(org.apache.ambari.server.topology.ClusterDeployWithStartOnlyTest.CLUSTER_ID).anyTimes();
        org.easymock.EasyMock.expect(ambariContext.getClusterName(org.apache.ambari.server.topology.ClusterDeployWithStartOnlyTest.CLUSTER_ID)).andReturn(org.apache.ambari.server.topology.ClusterDeployWithStartOnlyTest.CLUSTER_NAME).anyTimes();
        ...
        org.easymock.EasyMock.expect(ambariContext.createAmbariTask(org.easymock.EasyMock.anyLong(), org.easymock.EasyMock.anyLong(), org.easymock.EasyMock.eq("component3"), org.easymock.EasyMock.anyString(), org.easymock.EasyMock.eq(org.apache.ambari.server.topology.AmbariContext.TaskType.INSTALL), org.easymock.EasyMock.anyBoolean())).andReturn(hostRoleCommandInstallComponent3).times(3);
        org.easymock.EasyMock.expect(ambariContext.createAmbariTask(org.easymock.EasyMock.anyLong(), org.easymock.EasyMock.anyLong(), org.easymock.EasyMock.eq("component4"), org.easymock.EasyMock.anyString(), org.easymock.EasyMock.eq(org.apache.ambari.server.topology.AmbariContext.TaskType.INSTALL), org.easymock.EasyMock.anyBoolean())).andReturn(hostRoleCommandInstallComponent4).times(2);
        org.easymock.EasyMock.expect(hostRoleCommandInstallComponent3.getTaskId()).andReturn(1L).atLeastOnce();
        org.easymock.EasyMock.expect(hostRoleCommandInstallComponent3.getRoleCommand()).andReturn(org.apache.ambari.server.RoleCommand.INSTALL).atLeastOnce();
        org.easymock.EasyMock.expect(hostRoleCommandInstallComponent3.getRole()).andReturn(org.apache.ambari.server.Role.INSTALL_PACKAGES).atLeastOnce();
        org.easymock.EasyMock.expect(hostRoleCommandInstallComponent3.getStatus()).andReturn(org.apache.ambari.server.actionmanager.HostRoleStatus.COMPLETED).atLeastOnce();
        org.easymock.EasyMock.expect(hostRoleCommandInstallComponent4.getTaskId()).andReturn(2L).atLeastOnce();
        org.easymock.EasyMock.expect(hostRoleCommandInstallComponent4.getRoleCommand()).andReturn(org.apache.ambari.server.RoleCommand.INSTALL).atLeastOnce();
        org.easymock.EasyMock.expect(hostRoleCommandInstallComponent4.getRole()).andReturn(org.apache.ambari.server.Role.INSTALL_PACKAGES).atLeastOnce();
        org.easymock.EasyMock.expect(hostRoleCommandInstallComponent4.getStatus()).andReturn(org.apache.ambari.server.actionmanager.HostRoleStatus.COMPLETED).atLeastOnce();
        org.easymock.EasyMock.expect(ambariContext.createAmbariTask(org.easymock.EasyMock.anyLong(), org.easymock.EasyMock.anyLong(), org.easymock.EasyMock.eq("component1"), org.easymock.EasyMock.anyString(), org.easymock.EasyMock.eq(org.apache.ambari.server.topology.AmbariContext.TaskType.START), org.easymock.EasyMock.anyBoolean())).andReturn(hostRoleCommandStartComponent1).times(1);
        org.easymock.EasyMock.expect(ambariContext.createAmbariTask(org.easymock.EasyMock.anyLong(), org.easymock.EasyMock.anyLong(), org.easymock.EasyMock.eq("component2"), org.easymock.EasyMock.anyString(), org.easymock.EasyMock.eq(org.apache.ambari.server.topology.AmbariContext.TaskType.START), org.easymock.EasyMock.anyBoolean())).andReturn(hostRoleCommandStartComponent2).times(1);
        org.easymock.EasyMock.expect(hostRoleCommandStartComponent1.getTaskId()).andReturn(3L).anyTimes();
        org.easymock.EasyMock.expect(hostRoleCommandStartComponent1.getRoleCommand()).andReturn(org.apache.ambari.server.RoleCommand.START).atLeastOnce();
        org.easymock.EasyMock.expect(hostRoleCommandStartComponent1.getRole()).andReturn(org.apache.ambari.server.Role.DATANODE).atLeastOnce();
        org.easymock.EasyMock.expect(hostRoleCommandStartComponent1.getStatus()).andReturn(org.apache.ambari.server.actionmanager.HostRoleStatus.COMPLETED).atLeastOnce();
        org.easymock.EasyMock.expect(hostRoleCommandStartComponent2.getTaskId()).andReturn(4L).anyTimes();
        org.easymock.EasyMock.expect(hostRoleCommandStartComponent2.getRoleCommand()).andReturn(org.apache.ambari.server.RoleCommand.START).atLeastOnce();
        org.easymock.EasyMock.expect(hostRoleCommandStartComponent2.getRole()).andReturn(org.apache.ambari.server.Role.NAMENODE).atLeastOnce();
        org.easymock.EasyMock.expect(hostRoleCommandStartComponent2.getStatus()).andReturn(org.apache.ambari.server.actionmanager.HostRoleStatus.COMPLETED).atLeastOnce();
