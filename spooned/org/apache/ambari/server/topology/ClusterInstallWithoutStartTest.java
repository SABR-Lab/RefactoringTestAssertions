...
public class ClusterInstallWithoutStartTest extends org.easymock.EasyMockSupport {
    ...
    public void setup() throws java.lang.Exception {
        ...
        org.easymock.EasyMock.expect(blueprint.getName()).andReturn(org.apache.ambari.server.topology.ClusterInstallWithoutStartTest.BLUEPRINT_NAME).anyTimes();
        ...
        org.easymock.EasyMock.expect(stack.getName()).andReturn(org.apache.ambari.server.topology.ClusterInstallWithoutStartTest.STACK_NAME).anyTimes();
        org.easymock.EasyMock.expect(stack.getVersion()).andReturn(org.apache.ambari.server.topology.ClusterInstallWithoutStartTest.STACK_VERSION).anyTimes();
        ...
        org.easymock.EasyMock.expect(request.getClusterId()).andReturn(org.apache.ambari.server.topology.ClusterInstallWithoutStartTest.CLUSTER_ID).anyTimes();
        org.easymock.EasyMock.expect(request.getClusterName()).andReturn(org.apache.ambari.server.topology.ClusterInstallWithoutStartTest.CLUSTER_NAME).anyTimes();
        ...
        org.easymock.EasyMock.expect(request.getProvisionAction()).andReturn(org.apache.ambari.server.controller.internal.ProvisionAction.INSTALL_ONLY).anyTimes();
        ...
        org.easymock.EasyMock.expect(group1.getBlueprintName()).andReturn(org.apache.ambari.server.topology.ClusterInstallWithoutStartTest.BLUEPRINT_NAME).anyTimes();
        ...
        org.easymock.EasyMock.expect(group2.getBlueprintName()).andReturn(org.apache.ambari.server.topology.ClusterInstallWithoutStartTest.BLUEPRINT_NAME).anyTimes();
        ...
        org.easymock.EasyMock.expect(clusters.getCluster(org.apache.ambari.server.topology.ClusterInstallWithoutStartTest.CLUSTER_NAME)).andReturn(cluster).anyTimes();
        org.easymock.EasyMock.expect(cluster.getClusterName()).andReturn(org.apache.ambari.server.topology.ClusterInstallWithoutStartTest.CLUSTER_NAME).anyTimes();
        org.easymock.EasyMock.expect(ambariContext.getPersistedTopologyState()).andReturn(persistedState).anyTimes();
        ambariContext.createAmbariResources(org.easymock.EasyMock.isA(org.apache.ambari.server.topology.ClusterTopology.class), org.easymock.EasyMock.eq(org.apache.ambari.server.topology.ClusterInstallWithoutStartTest.CLUSTER_NAME), ((org.apache.ambari.server.state.SecurityType) (org.easymock.EasyMock.isNull())), org.easymock.EasyMock.eq("1"), org.easymock.EasyMock.anyLong());
        org.easymock.EasyMock.expectLastCall().once();
        org.easymock.EasyMock.expect(ambariContext.getNextRequestId()).andReturn(1L).once();
        org.easymock.EasyMock.expect(ambariContext.isClusterKerberosEnabled(org.apache.ambari.server.topology.ClusterInstallWithoutStartTest.CLUSTER_ID)).andReturn(false).anyTimes();
        org.easymock.EasyMock.expect(ambariContext.getClusterId(org.apache.ambari.server.topology.ClusterInstallWithoutStartTest.CLUSTER_NAME)).andReturn(org.apache.ambari.server.topology.ClusterInstallWithoutStartTest.CLUSTER_ID).anyTimes();
        org.easymock.EasyMock.expect(ambariContext.getClusterName(org.apache.ambari.server.topology.ClusterInstallWithoutStartTest.CLUSTER_ID)).andReturn(org.apache.ambari.server.topology.ClusterInstallWithoutStartTest.CLUSTER_NAME).anyTimes();
        ...
        org.easymock.EasyMock.expect(ambariContext.createAmbariTask(org.easymock.EasyMock.anyLong(), org.easymock.EasyMock.anyLong(), org.easymock.EasyMock.anyString(), org.easymock.EasyMock.anyString(), org.easymock.EasyMock.eq(org.apache.ambari.server.topology.AmbariContext.TaskType.INSTALL), org.easymock.EasyMock.anyBoolean())).andReturn(hostRoleCommand).atLeastOnce();
        ...
        ambariContext.persistInstallStateForUI(org.apache.ambari.server.topology.ClusterInstallWithoutStartTest.CLUSTER_NAME, org.apache.ambari.server.topology.ClusterInstallWithoutStartTest.STACK_NAME, org.apache.ambari.server.topology.ClusterInstallWithoutStartTest.STACK_VERSION);
        org.easymock.EasyMock.expectLastCall().once();
