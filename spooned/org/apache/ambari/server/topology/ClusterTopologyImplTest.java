...
public class ClusterTopologyImplTest {
    ...
    private final org.apache.ambari.server.topology.Blueprint blueprint = org.powermock.api.easymock.PowerMock.createNiceMock(org.apache.ambari.server.topology.Blueprint.class);

    private final org.apache.ambari.server.topology.HostGroup group1 = org.powermock.api.easymock.PowerMock.createNiceMock(org.apache.ambari.server.topology.HostGroup.class);

    private final org.apache.ambari.server.topology.HostGroup group2 = org.powermock.api.easymock.PowerMock.createNiceMock(org.apache.ambari.server.topology.HostGroup.class);

    private final org.apache.ambari.server.topology.HostGroup group3 = org.powermock.api.easymock.PowerMock.createNiceMock(org.apache.ambari.server.topology.HostGroup.class);

    private final org.apache.ambari.server.topology.HostGroup group4 = org.powermock.api.easymock.PowerMock.createNiceMock(org.apache.ambari.server.topology.HostGroup.class);
    ...
    public void setUp() throws java.lang.Exception {
        ...
        org.easymock.EasyMock.expect(blueprint.getHostGroups()).andReturn(hostGroupMap).anyTimes();
        ...
        org.easymock.EasyMock.expect(blueprint.getHostGroup("group3")).andReturn(group3).anyTimes();
        org.easymock.EasyMock.expect(blueprint.getHostGroup("group4")).andReturn(group4).anyTimes();
        org.easymock.EasyMock.expect(group1.getConfiguration()).andReturn(configuration).anyTimes();
        org.easymock.EasyMock.expect(group2.getConfiguration()).andReturn(configuration).anyTimes();
        org.easymock.EasyMock.expect(group3.getConfiguration()).andReturn(configuration).anyTimes();
        org.easymock.EasyMock.expect(group4.getConfiguration()).andReturn(configuration).anyTimes();
        ...
        org.easymock.EasyMock.expect(group3.getComponents()).andReturn(group3Components).anyTimes();
        org.easymock.EasyMock.expect(group4.getComponents()).andReturn(group4Components).anyTimes();
        org.easymock.EasyMock.expect(group1.getComponentNames()).andReturn(group1ComponentNames).anyTimes();
        org.easymock.EasyMock.expect(group2.getComponentNames()).andReturn(java.util.Collections.singletonList("component3")).anyTimes();
        org.easymock.EasyMock.expect(group3.getComponentNames()).andReturn(java.util.Collections.singletonList("component4")).anyTimes();
        org.easymock.EasyMock.expect(group4.getComponentNames()).andReturn(java.util.Collections.singletonList("NAMENODE")).anyTimes();
    }

    @org.junit.After
    public void tearDown() {
        org.powermock.api.easymock.PowerMock.verify(blueprint, group1, group2, group3, group4);
        org.powermock.api.easymock.PowerMock.reset(blueprint, group1, group2, group3, group4);
        hostGroupInfoMap.clear();
        hostGroupMap.clear();
    }

    private void replayAll() {
        org.powermock.api.easymock.PowerMock.replay(blueprint, group1, group2, group3, group4);
    }
    ...
    public void testDecidingIfComponentIsHadoopCompatible() throws java.lang.Exception {
        org.easymock.EasyMock.expect(blueprint.getServiceInfos()).andReturn(java.util.Arrays.asList(aHCFSWith(aComponent("ONEFS_CLIENT")), aServiceWith(aComponent("ZOOKEEPER_CLIENT")))).anyTimes();
        replayAll();
