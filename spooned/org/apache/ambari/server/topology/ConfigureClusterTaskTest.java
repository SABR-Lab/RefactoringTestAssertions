...
public class ConfigureClusterTaskTest extends org.easymock.EasyMockSupport {
    ...
    public void taskShouldBeExecutedIfRequiredHostgroupsAreResolved() throws java.lang.Exception {
        org.easymock.EasyMock.expect(clusterConfigurationRequest.getRequiredHostGroups()).andReturn(java.util.Collections.emptyList());
        org.easymock.EasyMock.expect(clusterTopology.getHostGroupInfo()).andReturn(java.util.Collections.emptyMap());
        org.easymock.EasyMock.expect(clusterTopology.getClusterId()).andReturn(1L).anyTimes();
        org.easymock.EasyMock.expect(clusterTopology.getAmbariContext()).andReturn(ambariContext);
        org.easymock.EasyMock.expect(ambariContext.getClusterName(1L)).andReturn("testCluster");
