...
public class LogicalRequestTest extends org.easymock.EasyMockSupport {
    ...
    public void setup() throws java.lang.Exception {
        ...
        org.easymock.EasyMock.expect(replayedTopologyRequest.getDescription()).andReturn(topologyReqestDescription).anyTimes();
        org.easymock.EasyMock.expect(clusterTopology.getAmbariContext()).andReturn(ambariContext).anyTimes();
        org.easymock.EasyMock.expect(clusterTopology.getClusterId()).andReturn(clusterId).anyTimes();
        org.easymock.EasyMock.expect(clusterTopology.getProvisionAction()).andReturn(org.apache.ambari.server.controller.internal.ProvisionAction.INSTALL_ONLY).anyTimes();
        org.easymock.EasyMock.expect(clusterTopology.getBlueprint()).andReturn(blueprint).anyTimes();
        org.easymock.EasyMock.expect(blueprint.getName()).andReturn("blueprintDef").anyTimes();
    ...
    public void testPersistedRequestsWithReservedHosts() throws java.lang.Exception {
        ...
        org.easymock.EasyMock.expect(ambariContext.isHostRegisteredWithCluster(org.easymock.EasyMock.eq(clusterId), org.easymock.EasyMock.eq(host1.getFqdn()))).andReturn(true).anyTimes();
        ...
        org.easymock.EasyMock.expect(ambariContext.isHostRegisteredWithCluster(org.easymock.EasyMock.eq(clusterId), org.easymock.EasyMock.eq(host2.getFqdn()))).andReturn(true).anyTimes();
        ...
        org.easymock.EasyMock.expect(ambariContext.isHostRegisteredWithCluster(org.easymock.EasyMock.eq(clusterId), org.easymock.EasyMock.eq(host3.getFqdn()))).andReturn(false).anyTimes();
        ...
        org.easymock.EasyMock.expect(ambariContext.isHostRegisteredWithCluster(org.easymock.EasyMock.eq(clusterId), org.easymock.EasyMock.eq(host4.getFqdn()))).andReturn(false).anyTimes();
        ...
        org.easymock.EasyMock.expect(logicalRequestEntity.getTopologyHostRequestEntities()).andReturn(reservedHostRequestEntities).atLeastOnce();
        org.easymock.EasyMock.expect(logicalRequestEntity.getTopologyRequestEntity()).andReturn(topologyRequestEntity).atLeastOnce();
        org.easymock.EasyMock.expect(blueprint.getHostGroup(org.easymock.EasyMock.eq("host_group_1"))).andReturn(hostGroup1).atLeastOnce();
        org.easymock.EasyMock.expect(hostGroup1.containsMasterComponent()).andReturn(false).atLeastOnce();
        replayAll();
    ...
    public void testPersistedRequestsWithHostPredicate() throws java.lang.Exception {
        ...
        hostRequestEntityHost1Matched.setTopologyHostTaskEntities(java.util.Collections.emptySet());
        org.easymock.EasyMock.expect(ambariContext.isHostRegisteredWithCluster(org.easymock.EasyMock.eq(clusterId), org.easymock.EasyMock.eq("host1"))).andReturn(true).anyTimes();
        org.apache.ambari.server.orm.entities.TopologyHostRequestEntity hostRequestEntityHost2Matched = new org.apache.ambari.server.orm.entities.TopologyHostRequestEntity();
        hostRequestEntityHost2Matched.setId(2L);
        hostRequestEntityHost2Matched.setHostName("host2");
        hostRequestEntityHost2Matched.setTopologyHostGroupEntity(hostGroupEntity2);
        hostRequestEntityHost2Matched.setTopologyHostTaskEntities(java.util.Collections.emptySet());
        org.easymock.EasyMock.expect(ambariContext.isHostRegisteredWithCluster(org.easymock.EasyMock.eq(clusterId), org.easymock.EasyMock.eq("host2"))).andReturn(true).anyTimes();
        org.apache.ambari.server.orm.entities.TopologyHostRequestEntity hostRequestEntityHost3NotMatched = new org.apache.ambari.server.orm.entities.TopologyHostRequestEntity();
        hostRequestEntityHost3NotMatched.setId(3L);
        hostRequestEntityHost3NotMatched.setTopologyHostGroupEntity(hostGroupEntity2);
        hostRequestEntityHost3NotMatched.setTopologyHostTaskEntities(java.util.Collections.emptySet());
        org.easymock.EasyMock.expect(ambariContext.isHostRegisteredWithCluster(org.easymock.EasyMock.eq(clusterId), org.easymock.EasyMock.eq("host3"))).andReturn(false).anyTimes();
        org.apache.ambari.server.orm.entities.TopologyHostRequestEntity hostRequestEntityHost4NotMatched = new org.apache.ambari.server.orm.entities.TopologyHostRequestEntity();
        hostRequestEntityHost4NotMatched.setId(4L);
        hostRequestEntityHost4NotMatched.setTopologyHostGroupEntity(hostGroupEntity2);
        hostRequestEntityHost4NotMatched.setTopologyHostTaskEntities(java.util.Collections.emptySet());
        org.easymock.EasyMock.expect(ambariContext.isHostRegisteredWithCluster(org.easymock.EasyMock.eq(clusterId), org.easymock.EasyMock.eq("host4"))).andReturn(false).anyTimes();
        java.util.Collection<org.apache.ambari.server.orm.entities.TopologyHostRequestEntity> reservedHostRequestEntities = com.google.common.collect.ImmutableSet.of(hostRequestEntityHost1Matched, hostRequestEntityHost2Matched, hostRequestEntityHost3NotMatched, hostRequestEntityHost4NotMatched);
        ...
        org.easymock.EasyMock.expect(logicalRequestEntity.getTopologyHostRequestEntities()).andReturn(reservedHostRequestEntities).atLeastOnce();
        org.easymock.EasyMock.expect(logicalRequestEntity.getTopologyRequestEntity()).andReturn(topologyRequestEntity).atLeastOnce();
        org.easymock.EasyMock.expect(blueprint.getHostGroup(org.easymock.EasyMock.eq("host_group_2"))).andReturn(hostGroup2).atLeastOnce();
        org.easymock.EasyMock.expect(hostGroup2.containsMasterComponent()).andReturn(false).atLeastOnce();
        replayAll();
        org.apache.ambari.server.topology.LogicalRequest req = new org.apache.ambari.server.topology.LogicalRequest(requestId, replayedTopologyRequest, clusterTopology, logicalRequestEntity);
        verifyAll();
        java.util.Collection<java.lang.String> actualReservedHosts = req.getReservedHosts();
    ...
    public void testRemoveHostRequestByHostName() throws java.lang.Exception {
        ...
        org.easymock.EasyMock.expect(ambariContext.isHostRegisteredWithCluster(org.easymock.EasyMock.eq(clusterId), org.easymock.EasyMock.eq(host4.getFqdn()))).andReturn(true).anyTimes();
    ...
    public void testRemovePendingHostRequests() throws java.lang.Exception {
        ...
        org.easymock.EasyMock.expect(ambariContext.isHostRegisteredWithCluster(org.easymock.EasyMock.eq(clusterId), org.easymock.EasyMock.eq(host2.getFqdn()))).andReturn(false).anyTimes();
    ...
    private org.apache.ambari.server.topology.LogicalRequest createTopologyRequestByHostCount(int hostCount, java.lang.String hostGroupName) throws java.lang.Exception {
        ...
        org.easymock.EasyMock.expect(logicalRequestEntity.getTopologyRequestEntity()).andReturn(topologyRequestEntity).anyTimes();
        org.easymock.EasyMock.expect(logicalRequestEntity.getTopologyHostRequestEntities()).andReturn(hostRequests).anyTimes();
        org.easymock.EasyMock.expect(blueprint.getHostGroup(org.easymock.EasyMock.eq(hostGroupEntity.getName()))).andReturn(hostGroup1).anyTimes();
        org.easymock.EasyMock.expect(hostGroup1.containsMasterComponent()).andReturn(false).anyTimes();
        replayAll();
