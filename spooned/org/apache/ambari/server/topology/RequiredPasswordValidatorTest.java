...
public class RequiredPasswordValidatorTest extends org.easymock.EasyMockSupport {
    ...
    public void setup() {
        ...
        org.easymock.EasyMock.expect(topology.getConfiguration()).andReturn(org.apache.ambari.server.topology.RequiredPasswordValidatorTest.topoClusterConfig).anyTimes();
        org.easymock.EasyMock.expect(topology.getBlueprint()).andReturn(blueprint).anyTimes();
        org.easymock.EasyMock.expect(topology.getHostGroupInfo()).andReturn(org.apache.ambari.server.topology.RequiredPasswordValidatorTest.hostGroupInfo).anyTimes();
        org.easymock.EasyMock.expect(blueprint.getHostGroups()).andReturn(org.apache.ambari.server.topology.RequiredPasswordValidatorTest.hostGroups).anyTimes();
        ...
        org.easymock.EasyMock.expect(group1.getComponentNames()).andReturn(org.apache.ambari.server.topology.RequiredPasswordValidatorTest.group1Components).anyTimes();
        org.easymock.EasyMock.expect(group2.getComponentNames()).andReturn(org.apache.ambari.server.topology.RequiredPasswordValidatorTest.group2Components).anyTimes();
        org.easymock.EasyMock.expect(group1.getComponents("service1")).andReturn(java.util.Arrays.asList("component1", "component2")).anyTimes();
        org.easymock.EasyMock.expect(group1.getComponents("service2")).andReturn(java.util.Arrays.asList("component3")).anyTimes();
        org.easymock.EasyMock.expect(group1.getComponents("service3")).andReturn(java.util.Collections.emptySet()).anyTimes();
        org.easymock.EasyMock.expect(group2.getComponents("service1")).andReturn(java.util.Arrays.asList("component1")).anyTimes();
        org.easymock.EasyMock.expect(group2.getComponents("service2")).andReturn(java.util.Collections.emptySet()).anyTimes();
        org.easymock.EasyMock.expect(group2.getComponents("service3")).andReturn(java.util.Arrays.asList("component4")).anyTimes();
        ...
        org.easymock.EasyMock.expect(stack.getServiceForComponent("component4")).andReturn("service3").anyTimes();
        org.easymock.EasyMock.expect(stack.getRequiredConfigurationProperties("service1", org.apache.ambari.server.state.PropertyInfo.PropertyType.PASSWORD)).andReturn(org.apache.ambari.server.topology.RequiredPasswordValidatorTest.service1RequiredPwdConfigs).anyTimes();
        org.easymock.EasyMock.expect(stack.getRequiredConfigurationProperties("service2", org.apache.ambari.server.state.PropertyInfo.PropertyType.PASSWORD)).andReturn(org.apache.ambari.server.topology.RequiredPasswordValidatorTest.service2RequiredPwdConfigs).anyTimes();
        org.easymock.EasyMock.expect(stack.getRequiredConfigurationProperties("service3", org.apache.ambari.server.state.PropertyInfo.PropertyType.PASSWORD)).andReturn(org.apache.ambari.server.topology.RequiredPasswordValidatorTest.service3RequiredPwdConfigs).anyTimes();
    }
    ...
    public void testValidate_noRequiredProps__noDefaultPwd() throws java.lang.Exception {
        org.easymock.EasyMock.expect(topology.getDefaultPassword()).andReturn(null);
        replayAll();
    ...
    public void testValidate_noRequiredProps__defaultPwd() throws java.lang.Exception {
        org.easymock.EasyMock.expect(topology.getDefaultPassword()).andReturn("pwd");
        replayAll();
        validator.validate(topology);
    }
    ...
    public void testValidate_missingPwd__defaultPwd() throws java.lang.Exception {
        org.easymock.EasyMock.expect(topology.getDefaultPassword()).andReturn("default-pwd");
        replayAll();
        org.apache.ambari.server.controller.internal.Stack.ConfigProperty pwdProp = new org.apache.ambari.server.controller.internal.Stack.ConfigProperty("test-type", "pwdProp", null);
        org.apache.ambari.server.topology.RequiredPasswordValidatorTest.service1RequiredPwdConfigs.add(pwdProp);
        validator.validate(topology);
