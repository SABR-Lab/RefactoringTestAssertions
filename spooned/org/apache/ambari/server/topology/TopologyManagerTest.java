...
public class TopologyManagerTest {
    ...
    public void setup() throws java.lang.Exception {
        ...
        org.easymock.EasyMock.expect(securityConfiguration.getType()).andReturn(org.apache.ambari.server.state.SecurityType.KERBEROS).anyTimes();
        org.easymock.EasyMock.expect(credential.getType()).andReturn(org.apache.ambari.server.security.encryption.CredentialStoreType.TEMPORARY).anyTimes();
        ...
        org.easymock.EasyMock.expect(blueprint.getName()).andReturn(org.apache.ambari.server.topology.TopologyManagerTest.BLUEPRINT_NAME).anyTimes();
        ...
        org.easymock.EasyMock.expect(stack.getName()).andReturn(org.apache.ambari.server.topology.TopologyManagerTest.STACK_NAME).anyTimes();
        org.easymock.EasyMock.expect(stack.getVersion()).andReturn(org.apache.ambari.server.topology.TopologyManagerTest.STACK_VERSION).anyTimes();
        ...
        org.easymock.EasyMock.expect(request.getClusterId()).andReturn(org.apache.ambari.server.topology.TopologyManagerTest.CLUSTER_ID).anyTimes();
        org.easymock.EasyMock.expect(request.getClusterName()).andReturn(org.apache.ambari.server.topology.TopologyManagerTest.CLUSTER_NAME).anyTimes();
        ...
        org.easymock.EasyMock.expect(request.getConfigRecommendationStrategy()).andReturn(org.apache.ambari.server.topology.ConfigRecommendationStrategy.NEVER_APPLY).anyTimes();
        org.easymock.EasyMock.expect(request.getSecurityConfiguration()).andReturn(null).anyTimes();
        org.easymock.EasyMock.expect(group1.getBlueprintName()).andReturn(org.apache.ambari.server.topology.TopologyManagerTest.BLUEPRINT_NAME).anyTimes();
        ...
        org.easymock.EasyMock.expect(group1.getComponents()).andReturn(group1Components).anyTimes();
        ...
        org.easymock.EasyMock.expect(group2.getBlueprintName()).andReturn(org.apache.ambari.server.topology.TopologyManagerTest.BLUEPRINT_NAME).anyTimes();
        ...
        org.easymock.EasyMock.expect(group2.getComponents()).andReturn(group2Components).anyTimes();
        ...
        org.easymock.EasyMock.expect(logicalRequestFactory.createRequest(org.easymock.EasyMock.eq(1L), ((org.apache.ambari.server.topology.TopologyRequest) (org.easymock.EasyMock.anyObject())), org.easymock.EasyMock.capture(clusterTopologyCapture))).andReturn(logicalRequest).anyTimes();
        org.easymock.EasyMock.expect(logicalRequest.getRequestId()).andReturn(1L).anyTimes();
        org.easymock.EasyMock.expect(logicalRequest.getClusterId()).andReturn(org.apache.ambari.server.topology.TopologyManagerTest.CLUSTER_ID).anyTimes();
        org.easymock.EasyMock.expect(logicalRequest.getReservedHosts()).andReturn(java.util.Collections.singleton("host1")).anyTimes();
        org.easymock.EasyMock.expect(logicalRequest.getRequestStatus()).andReturn(requestStatusResponse).anyTimes();
        org.easymock.EasyMock.expect(ambariContext.getPersistedTopologyState()).andReturn(persistedState).anyTimes();
        ambariContext.createAmbariResources(org.easymock.EasyMock.isA(org.apache.ambari.server.topology.ClusterTopology.class), org.easymock.EasyMock.eq(org.apache.ambari.server.topology.TopologyManagerTest.CLUSTER_NAME), ((org.apache.ambari.server.state.SecurityType) (org.easymock.EasyMock.isNull())), ((java.lang.String) (org.easymock.EasyMock.isNull())), org.easymock.EasyMock.anyLong());
        org.easymock.EasyMock.expectLastCall().anyTimes();
        org.easymock.EasyMock.expect(ambariContext.getNextRequestId()).andReturn(1L).anyTimes();
        org.easymock.EasyMock.expect(ambariContext.isClusterKerberosEnabled(org.apache.ambari.server.topology.TopologyManagerTest.CLUSTER_ID)).andReturn(false).anyTimes();
        org.easymock.EasyMock.expect(ambariContext.getClusterId(org.apache.ambari.server.topology.TopologyManagerTest.CLUSTER_NAME)).andReturn(org.apache.ambari.server.topology.TopologyManagerTest.CLUSTER_ID).anyTimes();
        org.easymock.EasyMock.expect(ambariContext.getClusterName(org.apache.ambari.server.topology.TopologyManagerTest.CLUSTER_ID)).andReturn(org.apache.ambari.server.topology.TopologyManagerTest.CLUSTER_NAME).anyTimes();
        org.easymock.EasyMock.expect(clusters.getCluster(org.apache.ambari.server.topology.TopologyManagerTest.CLUSTER_NAME)).andReturn(cluster).anyTimes();
        org.easymock.EasyMock.expect(ambariManagementController.getClusters()).andReturn(clusters).anyTimes();
        org.easymock.EasyMock.expect(ambariContext.createConfigurationRequests(org.easymock.EasyMock.capture(configRequestPropertiesCapture))).andReturn(java.util.Collections.singletonList(configurationRequest)).anyTimes();
        org.easymock.EasyMock.expect(ambariContext.createConfigurationRequests(org.easymock.EasyMock.capture(configRequestPropertiesCapture2))).andReturn(java.util.Collections.singletonList(configurationRequest2)).anyTimes();
        org.easymock.EasyMock.expect(ambariContext.createConfigurationRequests(org.easymock.EasyMock.capture(configRequestPropertiesCapture3))).andReturn(java.util.Collections.singletonList(configurationRequest3)).anyTimes();
        ...
        org.easymock.EasyMock.expectLastCall().anyTimes();
        org.easymock.EasyMock.expect(clusterController.ensureResourceProvider(org.easymock.EasyMock.anyObject(org.apache.ambari.server.controller.spi.Resource.Type.class))).andReturn(resourceProvider);
        org.easymock.EasyMock.expect(resourceProvider.createResources(org.easymock.EasyMock.anyObject(org.apache.ambari.server.controller.spi.Request.class))).andReturn(new org.apache.ambari.server.controller.internal.RequestStatusImpl(null));
        ...
        org.easymock.EasyMock.expect(executor.submit(org.easymock.EasyMock.anyObject(org.apache.ambari.server.topology.AsyncCallableService.class))).andReturn(mockFuture).anyTimes();
        org.easymock.EasyMock.expect(persistedState.persistTopologyRequest(request)).andReturn(persistedTopologyRequest).anyTimes();
    ...
    public void testBlueprintProvisioningStateEvent() throws java.lang.Exception {
        org.easymock.EasyMock.expect(persistedState.getAllRequests()).andReturn(java.util.Collections.emptyMap()).anyTimes();
        eventPublisher.publish(org.easymock.EasyMock.anyObject(org.apache.ambari.server.events.ClusterProvisionStartedEvent.class));
    ...
    public void testAddKerberosClientAtTopologyInit() throws java.lang.Exception {
        ...
        org.easymock.EasyMock.expect(logicalRequest.hasPendingHostRequests()).andReturn(false).anyTimes();
        org.easymock.EasyMock.expect(logicalRequest.isFinished()).andReturn(false).anyTimes();
        allRequests.put(clusterTopologyMock, requestList);
        org.easymock.EasyMock.expect(requestStatusResponse.getTasks()).andReturn(java.util.Collections.emptyList()).anyTimes();
        org.easymock.EasyMock.expect(clusterTopologyMock.isClusterKerberosEnabled()).andReturn(true);
        org.easymock.EasyMock.expect(clusterTopologyMock.getClusterId()).andReturn(org.apache.ambari.server.topology.TopologyManagerTest.CLUSTER_ID).anyTimes();
        org.easymock.EasyMock.expect(clusterTopologyMock.getBlueprint()).andReturn(blueprint).anyTimes();
        org.easymock.EasyMock.expect(persistedState.getAllRequests()).andReturn(allRequests).anyTimes();
        org.easymock.EasyMock.expect(persistedState.getProvisionRequest(org.apache.ambari.server.topology.TopologyManagerTest.CLUSTER_ID)).andReturn(logicalRequest).anyTimes();
        org.easymock.EasyMock.expect(ambariContext.isTopologyResolved(org.apache.ambari.server.topology.TopologyManagerTest.CLUSTER_ID)).andReturn(true).anyTimes();
        org.easymock.EasyMock.expect(group1.addComponent("KERBEROS_CLIENT")).andReturn(true).anyTimes();
        org.easymock.EasyMock.expect(group2.addComponent("KERBEROS_CLIENT")).andReturn(true).anyTimes();
        replayAll();
        topologyManager.provisionCluster(request);
    }
    ...
    public void testDoNotAddKerberosClientAtTopologyInit_KdcTypeNone() throws java.lang.Exception {
        ...
        org.easymock.EasyMock.expect(persistedState.getProvisionRequest(org.apache.ambari.server.topology.TopologyManagerTest.CLUSTER_ID)).andReturn(logicalRequest).anyTimes();
        org.easymock.EasyMock.expect(ambariContext.isTopologyResolved(org.apache.ambari.server.topology.TopologyManagerTest.CLUSTER_ID)).andReturn(true).anyTimes();
        org.easymock.EasyMock.expect(blueprint.getSecurity()).andReturn(securityConfiguration).anyTimes();
        org.easymock.EasyMock.expect(securityConfiguration.getDescriptor()).andReturn(java.util.Optional.empty());
        org.easymock.EasyMock.expect(request.getCredentialsMap()).andReturn(java.util.Collections.singletonMap(org.apache.ambari.server.topology.TopologyManager.KDC_ADMIN_CREDENTIAL, credential));
        org.easymock.EasyMock.expect(credential.getAlias()).andReturn("").anyTimes();
        org.easymock.EasyMock.expect(credential.getKey()).andReturn("").anyTimes();
        org.easymock.EasyMock.expect(credential.getPrincipal()).andReturn("").anyTimes();
    ...
    public void testBlueprintRequestCompletion() throws java.lang.Exception {
        ...
        tasks.add(t3);
        org.easymock.EasyMock.expect(requestStatusResponse.getTasks()).andReturn(tasks).anyTimes();
        org.easymock.EasyMock.expect(persistedState.getAllRequests()).andReturn(java.util.Collections.emptyMap()).anyTimes();
        org.easymock.EasyMock.expect(persistedState.getProvisionRequest(org.apache.ambari.server.topology.TopologyManagerTest.CLUSTER_ID)).andReturn(logicalRequest).anyTimes();
        org.easymock.EasyMock.expect(logicalRequest.isFinished()).andReturn(true).anyTimes();
        org.easymock.EasyMock.expect(logicalRequest.isSuccessful()).andReturn(true).anyTimes();
        eventPublisher.publish(org.easymock.EasyMock.anyObject(org.apache.ambari.server.events.ClusterProvisionedEvent.class));
        org.easymock.EasyMock.expectLastCall().once();
        replayAll();
        topologyManager.provisionCluster(request);
        requestFinished();
    ...
    public void testBlueprintRequestCompletion__Failure() throws java.lang.Exception {
        ...
        org.easymock.EasyMock.expect(persistedState.getProvisionRequest(org.apache.ambari.server.topology.TopologyManagerTest.CLUSTER_ID)).andReturn(logicalRequest).anyTimes();
        org.easymock.EasyMock.expect(logicalRequest.isFinished()).andReturn(true).anyTimes();
        org.easymock.EasyMock.expect(logicalRequest.isSuccessful()).andReturn(false).anyTimes();
        replayAll();
        topologyManager.provisionCluster(request);
        requestFinished();
        org.junit.Assert.assertTrue(topologyManager.isClusterProvisionWithBlueprintFinished(org.apache.ambari.server.topology.TopologyManagerTest.CLUSTER_ID));
    ...
    public void testBlueprintRequestCompletion__Replay() throws java.lang.Exception {
        ...
        org.easymock.EasyMock.expect(clusterTopologyMock.getClusterId()).andReturn(org.apache.ambari.server.topology.TopologyManagerTest.CLUSTER_ID).anyTimes();
        org.easymock.EasyMock.expect(ambariContext.isTopologyResolved(org.easymock.EasyMock.anyLong())).andReturn(true).anyTimes();
        allRequests.put(clusterTopologyMock, logicalRequests);
        org.easymock.EasyMock.expect(persistedState.getAllRequests()).andReturn(allRequests).anyTimes();
        org.easymock.EasyMock.expect(persistedState.getProvisionRequest(org.apache.ambari.server.topology.TopologyManagerTest.CLUSTER_ID)).andReturn(logicalRequest).anyTimes();
        org.easymock.EasyMock.expect(logicalRequest.hasPendingHostRequests()).andReturn(true).anyTimes();
        org.easymock.EasyMock.expect(logicalRequest.getCompletedHostRequests()).andReturn(java.util.Collections.EMPTY_LIST).anyTimes();
        org.easymock.EasyMock.expect(logicalRequest.isFinished()).andReturn(true).anyTimes();
        org.easymock.EasyMock.expect(requestStatusResponse.getTasks()).andReturn(tasks).anyTimes();
        replayAll();
    ...
    public void testScaleHosts__alreadyExistingHost() throws org.apache.ambari.server.topology.InvalidTopologyTemplateException, org.apache.ambari.server.topology.InvalidTopologyException, org.apache.ambari.server.AmbariException, org.apache.ambari.server.stack.NoSuchStackException {
        ...
        org.easymock.EasyMock.replay(bpfMock);
        org.easymock.EasyMock.expect(persistedState.getAllRequests()).andReturn(java.util.Collections.emptyMap()).anyTimes();
        replayAll();
        topologyManager.provisionCluster(request);
    ...
    public void testProvisionCluster_QuickLinkProfileIsSavedTheFirstTime() throws java.lang.Exception {
        org.easymock.EasyMock.expect(persistedState.getAllRequests()).andReturn(java.util.Collections.emptyMap()).anyTimes();
        org.easymock.EasyMock.expect(request.getQuickLinksProfileJson()).andReturn(org.apache.ambari.server.topology.TopologyManagerTest.SAMPLE_QUICKLINKS_PROFILE_1).anyTimes();
        org.easymock.EasyMock.expect(settingDAO.findByName(org.apache.ambari.server.state.quicklinksprofile.QuickLinksProfile.SETTING_NAME_QUICKLINKS_PROFILE)).andReturn(null);
        final long timeStamp = java.lang.System.currentTimeMillis();
        org.powermock.api.easymock.PowerMock.mockStatic(java.lang.System.class);
        org.easymock.EasyMock.expect(java.lang.System.currentTimeMillis()).andReturn(timeStamp);
        ...
        settingDAO.create(org.easymock.EasyMock.eq(quickLinksProfile));
        replayAll();
        topologyManager.provisionCluster(request);
    }
    ...
    public void testProvisionCluster_ExistingQuickLinkProfileIsOverwritten() throws java.lang.Exception {
        org.easymock.EasyMock.expect(persistedState.getAllRequests()).andReturn(java.util.Collections.emptyMap()).anyTimes();
        org.easymock.EasyMock.expect(request.getQuickLinksProfileJson()).andReturn(org.apache.ambari.server.topology.TopologyManagerTest.SAMPLE_QUICKLINKS_PROFILE_2).anyTimes();
        ...
        org.easymock.EasyMock.expect(settingDAO.findByName(org.apache.ambari.server.state.quicklinksprofile.QuickLinksProfile.SETTING_NAME_QUICKLINKS_PROFILE)).andReturn(originalProfile);
        org.powermock.api.easymock.PowerMock.mockStatic(java.lang.System.class);
        final long timeStamp2 = timeStamp1 + 100;
        org.easymock.EasyMock.expect(java.lang.System.currentTimeMillis()).andReturn(timeStamp2);
        org.powermock.api.easymock.PowerMock.replay(java.lang.System.class);
        ...
        org.easymock.EasyMock.expect(settingDAO.merge(newProfile)).andReturn(newProfile);
        replayAll();
        topologyManager.provisionCluster(request);
    }
