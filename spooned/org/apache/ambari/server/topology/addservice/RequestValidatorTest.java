...
public class RequestValidatorTest extends org.easymock.EasyMockSupport {
    ...
    public void setUp() {
        try {
            ...
            org.easymock.EasyMock.expect(cluster.getClusterName()).andReturn("TEST").anyTimes();
            org.easymock.EasyMock.expect(cluster.getServices()).andStubReturn(com.google.common.collect.ImmutableMap.of());
            org.easymock.EasyMock.expect(cluster.getSecurityType()).andStubReturn(org.apache.ambari.server.state.SecurityType.NONE);
            org.easymock.EasyMock.expect(configHelper.calculateExistingConfigs(cluster)).andStubReturn(org.apache.ambari.server.topology.Configuration.newEmpty().asPair());
            org.easymock.EasyMock.expect(request.getServices()).andStubReturn(com.google.common.collect.ImmutableSet.of());
            org.easymock.EasyMock.expect(request.getComponents()).andStubReturn(com.google.common.collect.ImmutableSet.of());
            org.easymock.EasyMock.expect(request.getSecurity()).andStubReturn(java.util.Optional.empty());
            org.easymock.EasyMock.expect(request.getValidationType()).andStubReturn(org.apache.ambari.server.topology.addservice.AddServiceRequest.ValidationType.DEFAULT);
    ...
    public void reportsUnknownStackFromRequest() throws java.lang.Exception {
        ...
        org.easymock.EasyMock.expect(request.getStackId()).andReturn(java.util.Optional.of(requestStackId)).anyTimes();
        org.easymock.EasyMock.expect(stackFactory.createStack(requestStackId.getStackName(), requestStackId.getStackVersion(), controller)).andThrow(new org.apache.ambari.server.AmbariException("Stack not found"));
        replayAll();
    ...
    public void reportsUnknownStackFromCluster() throws java.lang.Exception {
        ...
        org.easymock.EasyMock.expect(request.getStackId()).andReturn(java.util.Optional.empty()).anyTimes();
        org.easymock.EasyMock.expect(cluster.getCurrentStackVersion()).andReturn(clusterStackId);
        org.easymock.EasyMock.expect(stackFactory.createStack(clusterStackId.getStackName(), clusterStackId.getStackVersion(), controller)).andThrow(new org.apache.ambari.server.AmbariException("Stack not found"));
        replayAll();
    ...
    public void useClusterStackIfAbsentInRequest() throws java.lang.Exception {
        ...
        org.easymock.EasyMock.expect(request.getStackId()).andReturn(java.util.Optional.empty()).anyTimes();
        org.easymock.EasyMock.expect(cluster.getCurrentStackVersion()).andReturn(clusterStackId);
        org.easymock.EasyMock.expect(stackFactory.createStack(clusterStackId.getStackName(), clusterStackId.getStackVersion(), controller)).andReturn(expectedStack);
        replayAll();
    ...
    public void handlesMultipleComponentInstances() {
        org.easymock.EasyMock.expect(request.getComponents()).andReturn(java.util.stream.Stream.of("c7401", "c7402").map(hostname -> org.apache.ambari.server.topology.addservice.Component.of("KAFKA_BROKER", hostname)).collect(java.util.stream.Collectors.toSet()));
        validator.setState(org.apache.ambari.server.topology.addservice.RequestValidator.State.INITIAL.with(simpleMockStack()));
        replayAll();
        validator.validateServicesAndComponents();
    ...
    private void clusterAlreadyHasServices(java.lang.String serviceName) {
        org.easymock.EasyMock.expect(cluster.getServices()).andReturn(com.google.common.collect.ImmutableMap.of(serviceName, createNiceMock(org.apache.ambari.server.state.Service.class))).anyTimes();
    }
    ...
    public void acceptsKnownHosts() {
        ...
        org.easymock.EasyMock.expect(cluster.getHostNames()).andReturn(clusterHosts).anyTimes();
    ...
    public void acceptsMatchingNoneSecurity() {
        org.easymock.EasyMock.expect(request.getSecurity()).andReturn(java.util.Optional.of(org.apache.ambari.server.topology.SecurityConfiguration.NONE)).anyTimes();
        replayAll();
        validator.validateSecurity();
    }
    ...
    public void rejectsKerberosDescriptorForNoSecurity() {
        ...
        org.easymock.EasyMock.expect(request.getSecurity()).andReturn(java.util.Optional.of(requestSecurity)).anyTimes();
        replayAll();
    ...
    public void rejectsRequestWithBothKerberosDescriptorAndReference() {
        ...
        org.easymock.EasyMock.expect(request.getSecurity()).andReturn(java.util.Optional.of(invalidConfig)).anyTimes();
        replayAll();
        java.lang.IllegalArgumentException e = org.apache.ambari.server.utils.Assertions.assertThrows(java.lang.IllegalArgumentException.class, validator::validateSecurity);
    ...
    public void reportsDanglingKerberosDescriptorReference() {
        ...
        org.easymock.EasyMock.expect(request.getSecurity()).andReturn(java.util.Optional.of(requestSecurity)).anyTimes();
        org.easymock.EasyMock.expect(securityConfigurationFactory.loadSecurityConfigurationByReference(org.apache.ambari.server.topology.addservice.RequestValidatorTest.FAKE_DESCRIPTOR_REFERENCE)).andThrow(new java.lang.IllegalArgumentException("No security configuration found for the reference: " + org.apache.ambari.server.topology.addservice.RequestValidatorTest.FAKE_DESCRIPTOR_REFERENCE));
        replayAll();
    ...
    public void combinesRequestConfigWithClusterAndStack() throws org.apache.ambari.server.AmbariException {
        ...
        org.easymock.EasyMock.expect(request.getConfiguration()).andReturn(requestConfig.copy()).anyTimes();
        org.easymock.EasyMock.expect(request.getRecommendationStrategy()).andReturn(org.apache.ambari.server.topology.ConfigRecommendationStrategy.ALWAYS_APPLY).anyTimes();
        ...
        org.easymock.EasyMock.expect(configHelper.calculateExistingConfigs(cluster)).andReturn(clusterConfig.asPair()).anyTimes();
        org.apache.ambari.server.controller.internal.Stack stack = simpleMockStack();
        ...
        org.easymock.EasyMock.expect(stack.getDefaultConfig()).andReturn(stackConfig).anyTimes();
        replayAll();
        validator.setState(org.apache.ambari.server.topology.addservice.RequestValidator.State.INITIAL.with(stack));
    ...
    private org.apache.ambari.server.controller.internal.Stack simpleMockStack() {
        ...
        org.easymock.EasyMock.expect(stack.getServices()).andStubReturn(stackServices);
        org.easymock.EasyMock.expect(stack.getServiceForComponent("KAFKA_BROKER")).andStubReturn("KAFKA");
        org.easymock.EasyMock.expect(stack.getServiceForComponent("ZOOKEEPER_SERVER")).andStubReturn("ZOOKEEPER");
        org.easymock.EasyMock.expect(stack.getServiceForComponent("ZOOKEEPER_CLIENT")).andStubReturn("ZOOKEEPER");
        org.easymock.EasyMock.expect(stack.getValidDefaultConfig()).andStubReturn(org.apache.ambari.server.topology.Configuration.newEmpty());
        return stack;
    }
    ...
    private void permissiveValidation() {
        org.easymock.EasyMock.expect(request.getValidationType()).andReturn(org.apache.ambari.server.topology.addservice.AddServiceRequest.ValidationType.PERMISSIVE).anyTimes();
    }

    private void requestServices(boolean validated, java.lang.String... services) {
        org.easymock.EasyMock.expect(request.getServices()).andReturn(java.util.Arrays.stream(services).map(org.apache.ambari.server.topology.addservice.Service::of).collect(java.util.stream.Collectors.toSet())).anyTimes();
        if (validated) {
    ...
    private void requestComponents(java.lang.String... components) {
        org.easymock.EasyMock.expect(request.getComponents()).andReturn(java.util.Arrays.stream(components).map(componentName -> org.apache.ambari.server.topology.addservice.Component.of(componentName, "c7401.ambari.apache.org")).collect(java.util.stream.Collectors.toSet()));
    }
    ...
    private void requestSpecifiesSecurity() {
        org.easymock.EasyMock.expect(request.getSecurity()).andReturn(java.util.Optional.of(org.apache.ambari.server.topology.SecurityConfiguration.KERBEROS)).anyTimes();
    }
    ...
    private org.apache.ambari.server.state.kerberos.KerberosDescriptor requestHasKerberosDescriptorFor(boolean byReference, java.lang.String... services) {
        ...
        org.easymock.EasyMock.expect(request.getSecurity()).andReturn(java.util.Optional.of(requestSecurity)).anyTimes();
        if (byReference) {
            org.easymock.EasyMock.expect(securityConfigurationFactory.loadSecurityConfigurationByReference(org.apache.ambari.server.topology.addservice.RequestValidatorTest.FAKE_DESCRIPTOR_REFERENCE)).andReturn(org.apache.ambari.server.topology.SecurityConfiguration.forTest(org.apache.ambari.server.state.SecurityType.KERBEROS, org.apache.ambari.server.topology.addservice.RequestValidatorTest.FAKE_DESCRIPTOR_REFERENCE, org.apache.ambari.server.topology.addservice.RequestValidatorTest.FAKE_DESCRIPTOR));
        }
        ...
        org.easymock.EasyMock.expect(kerberosDescriptorFactory.createInstance(org.apache.ambari.server.topology.addservice.RequestValidatorTest.FAKE_DESCRIPTOR)).andReturn(kerberosDescriptor).anyTimes();
