...
public class StackAdvisorAdapterTest {
    ...
    public void setUp() throws java.lang.Exception {
        org.apache.ambari.server.state.Cluster cluster = org.easymock.EasyMock.mock(org.apache.ambari.server.state.Cluster.class);
        org.easymock.EasyMock.expect(cluster.getHostNames()).andReturn(com.google.common.collect.ImmutableSet.of("c7401", "c7402"));
        org.easymock.EasyMock.expect(cluster.getServices()).andReturn(com.google.common.collect.ImmutableMap.of("HDFS", org.apache.ambari.server.topology.addservice.StackAdvisorAdapterTest.service("HDFS", com.google.common.collect.ImmutableMap.of("NAMENODE", com.google.common.collect.ImmutableSet.of("c7401"), "HDFS_CLIENT", com.google.common.collect.ImmutableSet.of("c7401", "c7402"))), "ZOOKEEPER", org.apache.ambari.server.topology.addservice.StackAdvisorAdapterTest.service("ZOOKEEPER", com.google.common.collect.ImmutableMap.of("ZOOKEEPER_SERVER", com.google.common.collect.ImmutableSet.of("c7401"), "ZOOKEEPER_CLIENT", com.google.common.collect.ImmutableSet.of("c7401", "c7402"))), "MAPREDUCE2", org.apache.ambari.server.topology.addservice.StackAdvisorAdapterTest.service("MAPREDUCE2", com.google.common.collect.ImmutableMap.of("HISTORYSERVER", com.google.common.collect.ImmutableSet.of("c7401")))));
        org.apache.ambari.server.state.Clusters clusters = org.easymock.EasyMock.mock(org.apache.ambari.server.state.Clusters.class);
        ...
        org.easymock.EasyMock.replay(clusters, cluster, managementController);
        org.easymock.EasyMock.expect(serverConfig.getGplLicenseAccepted()).andReturn(java.lang.Boolean.FALSE).anyTimes();
        @java.lang.SuppressWarnings("unchecked")
        org.easymock.IExpectationSetters iExpectationSetters = org.easymock.EasyMock.expect(serverConfig.getAddServiceHostGroupStrategyClass()).andReturn(((java.lang.Class) (org.apache.ambari.server.topology.addservice.GroupByComponentsStrategy.class))).anyTimes();
        org.easymock.EasyMock.replay(serverConfig);
        org.easymock.EasyMock.expect(injector.getInstance(org.apache.ambari.server.topology.addservice.GroupByComponentsStrategy.class)).andReturn(new org.apache.ambari.server.topology.addservice.GroupByComponentsStrategy()).anyTimes();
        ...
        org.easymock.EasyMock.expect(stackAdvisorHelper.recommend(org.easymock.EasyMock.anyObject())).andAnswer(() -> {
        ...
        org.easymock.EasyMock.expect(stackAdvisorHelper.validate(org.easymock.EasyMock.anyObject())).andReturn(validationResponse);
        org.easymock.EasyMock.replay(stackAdvisorHelper);
        org.easymock.EasyMock.expect(stack.getStackId()).andReturn(new org.apache.ambari.server.state.StackId("HDP", "3.0")).anyTimes();
        ...
        org.easymock.EasyMock.expect(stack.getServiceForComponent(org.easymock.EasyMock.anyString())).andAnswer(() -> serviceComponentMap.get(getCurrentArguments()[0])).anyTimes();
    ...
    private static org.apache.ambari.server.state.Service service(java.lang.String name, com.google.common.collect.ImmutableMap<java.lang.String, com.google.common.collect.ImmutableSet<java.lang.String>> componentHostMap) {
        org.apache.ambari.server.state.Service service = org.easymock.EasyMock.mock(org.apache.ambari.server.state.Service.class);
        ...
        java.util.Map<java.lang.String, org.apache.ambari.server.state.ServiceComponent> serviceComponents = componentHostMap.entrySet().stream().map(entry -> {
            org.apache.ambari.server.state.ServiceComponent component = org.easymock.EasyMock.mock(org.apache.ambari.server.state.ServiceComponent.class);
            org.easymock.EasyMock.expect(component.getName()).andReturn(entry.getKey()).anyTimes();
            org.easymock.EasyMock.expect(component.getServiceComponentsHosts()).andReturn(entry.getValue()).anyTimes();
            org.easymock.EasyMock.replay(component);
        ...
        org.easymock.EasyMock.replay(service);
        return service;
    }
