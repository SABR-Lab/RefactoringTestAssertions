...
public class ClusterConfigTypeValidatorTest extends org.easymock.EasyMockSupport {
    ...
    public void testEquals() throws java.lang.Exception {
        nl.jqno.equalsverifier.EqualsVerifier.forClass(org.apache.ambari.server.topology.validators.ClusterConfigTypeValidator.class).usingGetClass().suppress(nl.jqno.equalsverifier.Warning.INHERITED_DIRECTLY_FROM_OBJECT).verify();
    }
}
