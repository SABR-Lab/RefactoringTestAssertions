...
public class NameNodeHaValidatorTest {
    ...
    @org.junit.Before
    public void setUp() {
        org.easymock.EasyMock.expect(clusterTopology.getConfiguration()).andReturn(clusterConfig).anyTimes();
        org.easymock.EasyMock.expect(clusterTopology.getAllHosts()).andReturn(hosts).anyTimes();
        org.easymock.EasyMock.expect(clusterTopology.getHostAssignmentsForComponent("NAMENODE")).andReturn(nameNodes).anyTimes();
        org.easymock.EasyMock.expect(clusterTopology.isNameNodeHAEnabled()).andAnswer(() -> org.apache.ambari.server.topology.ClusterTopologyImpl.isNameNodeHAEnabled(fullProperties)).anyTimes();
        org.easymock.EasyMock.expect(clusterTopology.getHostGroupInfo()).andReturn(hostGroupInfos).anyTimes();
        org.easymock.EasyMock.expect(clusterConfig.getFullProperties()).andReturn(fullProperties).anyTimes();
        org.easymock.EasyMock.replay(clusterTopology, clusterConfig);
