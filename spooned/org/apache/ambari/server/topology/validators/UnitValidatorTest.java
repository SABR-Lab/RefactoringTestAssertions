...
public class UnitValidatorTest extends org.easymock.EasyMockSupport {
    ...
    public void setUp() throws java.lang.Exception {
        ...
        org.easymock.EasyMock.expect(clusterTopology.getHostGroupInfo()).andReturn(java.util.Collections.emptyMap()).anyTimes();
        org.easymock.EasyMock.expect(blueprint.getStack()).andReturn(stack).anyTimes();
        org.easymock.EasyMock.expect(stack.getConfigurationPropertiesWithMetadata(org.apache.ambari.server.topology.validators.UnitValidatorTest.SERVICE, org.apache.ambari.server.topology.validators.UnitValidatorTest.CONFIG_TYPE)).andReturn(stackConfigWithMetadata).anyTimes();
    }
    ...
    private void propertyToBeValidatedIs(java.lang.String propertyName, java.lang.String propertyValue) throws org.apache.ambari.server.topology.InvalidTopologyException, org.apache.ambari.server.controller.internal.ConfigurationTopologyException {
        ...
        org.easymock.EasyMock.expect(clusterTopology.getConfiguration()).andReturn(new org.apache.ambari.server.topology.Configuration(propertiesToBeValidated, java.util.Collections.emptyMap())).anyTimes();
        replayAll();
    }
