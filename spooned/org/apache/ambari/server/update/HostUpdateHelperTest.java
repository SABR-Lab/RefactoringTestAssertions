...
public class HostUpdateHelperTest {
    ...
    public void testValidateHostChanges_Success() throws java.lang.Exception {
        ...
        org.easymock.EasyMock.expect(mockAmbariManagementController.getClusters()).andReturn(mockClusters).once();
        org.easymock.EasyMock.expect(mockClusters.getCluster("cl1")).andReturn(mockCluster).once();
        org.easymock.EasyMock.expect(mockCluster.getHosts()).andReturn(clusterHosts).once();
        org.easymock.EasyMock.expect(host1.getHostName()).andReturn("host1");
        org.easymock.EasyMock.expect(host2.getHostName()).andReturn("host2");
    ...
    public void testValidateHostChanges_InvalidCluster() throws java.lang.Exception {
        ...
        org.easymock.EasyMock.expect(mockAmbariManagementController.getClusters()).andReturn(mockClusters).once();
        org.easymock.EasyMock.expect(mockClusters.getCluster("cl1")).andReturn(null).once();
        org.apache.ambari.server.update.HostUpdateHelper hostUpdateHelper = new org.apache.ambari.server.update.HostUpdateHelper(null, null, mockInjector);
        hostUpdateHelper.setHostChangesFileMap(clusterHostsToChange);
        easyMockSupport.replayAll();
        try {
    ...
    public void testUpdateHostsInConfigurations() throws org.apache.ambari.server.AmbariException {
        ...
        final javax.persistence.EntityManager entityManager = org.easymock.EasyMock.createNiceMock(javax.persistence.EntityManager.class);
        final org.apache.ambari.server.orm.DBAccessor dbAccessor = org.easymock.EasyMock.createNiceMock(org.apache.ambari.server.orm.DBAccessor.class);
        org.apache.ambari.server.state.Clusters mockClusters = easyMockSupport.createStrictMock(org.apache.ambari.server.state.Clusters.class);
        org.apache.ambari.server.state.Cluster mockCluster = easyMockSupport.createNiceMock(org.apache.ambari.server.state.Cluster.class);
        ...
        clusterHostsToChange.put("cl1", hosts);
        org.easymock.EasyMock.expect(mockClusterDAO.findByName("cl1")).andReturn(mockClusterEntity1).atLeastOnce();
        org.easymock.EasyMock.expect(mockAmbariManagementController.getClusters()).andReturn(mockClusters).once();
        org.easymock.EasyMock.expect(mockClusters.getCluster("cl1")).andReturn(mockCluster).once();
        org.easymock.EasyMock.expect(mockCluster.getClusterId()).andReturn(1L).anyTimes();
        org.apache.ambari.server.state.Host host = easyMockSupport.createNiceMock(org.apache.ambari.server.state.Host.class);
        org.easymock.EasyMock.expect(mockCluster.getHost(org.easymock.EasyMock.anyString())).andReturn(host).anyTimes();
        org.easymock.EasyMock.expect(host.getHostId()).andReturn(1L).anyTimes();
        org.easymock.EasyMock.expect(mockClusterEntity1.getClusterConfigEntities()).andReturn(clusterConfigEntities1).atLeastOnce();
        org.easymock.EasyMock.expect(mockClusterConfigEntity1.getClusterId()).andReturn(1L).atLeastOnce();
        org.easymock.EasyMock.expect(mockClusterConfigEntity1.getConfigId()).andReturn(1L).atLeastOnce();
        org.easymock.EasyMock.expect(mockClusterConfigEntity1.getStack()).andReturn(mockStackEntity).atLeastOnce();
        org.easymock.EasyMock.expect(mockClusterConfigEntity1.getData()).andReturn(("{\"testProperty1\" : \"testValue_host1\", " + "\"testProperty2\" : \"testValue_HOST5\", \"testProperty3\" : \"testValue_host11\", ") + "\"testProperty4\" : \"testValue_host55\"}").atLeastOnce();
        org.easymock.EasyMock.expect(mockClusterConfigEntity1.getTag()).andReturn("testTag1").atLeastOnce();
        org.easymock.EasyMock.expect(mockClusterConfigEntity1.getType()).andReturn("testType1").atLeastOnce();
        org.easymock.EasyMock.expect(mockClusterConfigEntity1.getVersion()).andReturn(1L).atLeastOnce();
        org.easymock.EasyMock.expect(mockClusterDAO.findConfig(1L)).andReturn(mockClusterConfigEntity1).atLeastOnce();
        org.easymock.EasyMock.expect(mockClusterConfigEntity2.getClusterId()).andReturn(1L).atLeastOnce();
        org.easymock.EasyMock.expect(mockClusterConfigEntity2.getConfigId()).andReturn(2L).anyTimes();
        org.easymock.EasyMock.expect(mockClusterConfigEntity2.getStack()).andReturn(mockStackEntity).atLeastOnce();
        org.easymock.EasyMock.expect(mockClusterConfigEntity2.getData()).andReturn("{\"testProperty5\" : \"test_host1_test_HOST5_test_host11_test_host55\"}").atLeastOnce();
        org.easymock.EasyMock.expect(mockClusterConfigEntity2.getTag()).andReturn("testTag2").atLeastOnce();
        org.easymock.EasyMock.expect(mockClusterConfigEntity2.getType()).andReturn("testType2").atLeastOnce();
        org.easymock.EasyMock.expect(mockClusterConfigEntity2.getVersion()).andReturn(2L).atLeastOnce();
        org.easymock.EasyMock.expect(mockClusterDAO.findConfig(2L)).andReturn(mockClusterConfigEntity2).atLeastOnce();
    ...
    public void testCheckForSecurity_SecureCluster() throws org.apache.ambari.server.AmbariException {
        ...
        org.easymock.EasyMock.expect(mockAmbariManagementController.getClusters()).andReturn(mockClusters).once();
        org.easymock.EasyMock.expect(mockClusters.getCluster("cl1")).andReturn(mockCluster).once();
        org.easymock.EasyMock.expect(mockCluster.getDesiredConfigByType("cluster-env")).andReturn(mockConfig).once();
        org.easymock.EasyMock.expect(mockConfig.getProperties()).andReturn(clusterEnvProperties).once();
        org.apache.ambari.server.update.HostUpdateHelper hostUpdateHelper = new org.apache.ambari.server.update.HostUpdateHelper(null, null, mockInjector);
        hostUpdateHelper.setHostChangesFileMap(clusterHostsToChange);
        easyMockSupport.replayAll();
        try {
    ...
    public void testUpdateHostsInDB() throws org.apache.ambari.server.AmbariException {
        ...
        org.easymock.EasyMock.expect(mockClusterDAO.findByName("cl1")).andReturn(mockClusterEntity).once();
        org.easymock.EasyMock.expect(mockClusterEntity.getHostEntities()).andReturn(hostEntities).times(2);
    ...
    public void testUpdateHostsForAlertsInDB() throws org.apache.ambari.server.AmbariException {
        ...
        final com.google.inject.Injector mockInjector = com.google.inject.Guice.createInjector(new com.google.inject.AbstractModule() {
            ...
            protected void configure() {
                ...
                bind(org.apache.ambari.server.topology.PersistedState.class).toInstance(org.easymock.EasyMock.createNiceMock(org.apache.ambari.server.topology.PersistedState.class));
                ...
                bind(org.apache.ambari.server.controller.KerberosHelper.class).toInstance(org.easymock.EasyMock.createNiceMock(org.apache.ambari.server.controller.KerberosHelper.class));
            }
        });
        org.easymock.EasyMock.expect(mockAmbariManagementController.getClusters()).andReturn(mockClusters).once();
        org.easymock.EasyMock.expect(mockClusters.getClusters()).andReturn(clusterMap).once();
        org.easymock.EasyMock.expect(mockCluster.getClusterId()).andReturn(1L).once();
        org.easymock.EasyMock.expect(mockAlertsDAO.findCurrentByCluster(1L)).andReturn(alertCurrentEntities).once();
        org.easymock.EasyMock.expect(mockAlertCurrentEntity1.getAlertHistory()).andReturn(mockAlertHistoryEntity1).once();
        org.easymock.EasyMock.expect(mockAlertCurrentEntity2.getAlertHistory()).andReturn(mockAlertHistoryEntity2).once();
        org.easymock.EasyMock.expect(mockAlertHistoryEntity1.getHostName()).andReturn("host1").atLeastOnce();
        org.easymock.EasyMock.expect(mockAlertHistoryEntity2.getHostName()).andReturn("host2").atLeastOnce();
        org.easymock.EasyMock.expect(mockAlertDefinitionDAO.findAll(1L)).andReturn(alertDefinitionEntities).once();
        mockAlertHistoryEntity1.setHostName("host10");
        org.easymock.EasyMock.expectLastCall();
        mockAlertHistoryEntity2.setHostName("host11");
        org.easymock.EasyMock.expectLastCall();
        mockAlertDefinitionEntity.setHash(org.easymock.EasyMock.anyString());
        org.easymock.EasyMock.expectLastCall();
        org.apache.ambari.server.update.HostUpdateHelper hostUpdateHelper = new org.apache.ambari.server.update.HostUpdateHelper(null, null, mockInjector);
        hostUpdateHelper.setHostChangesFileMap(clusterHostsToChange);
        easyMockSupport.replayAll();
    ...
    public void testInitHostChangesFileMap_SUCCESS() throws org.apache.ambari.server.AmbariException {
        ...
        org.easymock.EasyMock.expect(mockConfiguration.getHostChangesJson(null)).andReturn(cluster).once();
