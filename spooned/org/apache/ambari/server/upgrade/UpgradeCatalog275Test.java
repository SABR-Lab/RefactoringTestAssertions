...
public class UpgradeCatalog275Test {
    ...
    public void testRemoveDfsHAInitial() {
        ...
        org.apache.ambari.server.orm.dao.BlueprintDAO blueprintDAO = org.easymock.EasyMock.createMock(org.apache.ambari.server.orm.dao.BlueprintDAO.class);
        ...
        org.easymock.EasyMock.expect(injector.getInstance(org.apache.ambari.server.orm.dao.BlueprintDAO.class)).andReturn(blueprintDAO);
        org.easymock.EasyMock.expect(blueprintDAO.findAll()).andReturn(blueprintEntityList);
        ...
        org.easymock.EasyMock.expect(blueprintDAO.merge(org.easymock.EasyMock.capture(blueprintEntityCapture))).andReturn(null);
        org.easymock.EasyMock.replay(injector, blueprintDAO);
        ...
        org.easymock.EasyMock.verify(injector, blueprintDAO);
