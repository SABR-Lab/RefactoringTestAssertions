...
public class StageUtils {
    ...
    public static java.lang.String jaxbToString(java.lang.Object jaxbObj) throws javax.xml.bind.JAXBException, com.fasterxml.jackson.core.JsonGenerationException, com.fasterxml.jackson.databind.JsonMappingException, java.io.IOException {
    ...
    public static void useAmbariJdkInCommandParams(java.util.Map<java.lang.String, java.lang.String> commandParams, org.apache.ambari.server.configuration.Configuration configuration) {
        if (org.apache.commons.lang.StringUtils.isNotEmpty(configuration.getJavaHome()) && (!configuration.getJavaHome().equals(configuration.getStackJavaHome()))) {
            commandParams.put(org.apache.ambari.server.agent.ExecutionCommand.KeyNames.AMBARI_JAVA_HOME, configuration.getAmbariJavaHome());
