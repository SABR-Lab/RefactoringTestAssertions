...
public class ViewDataMigrationContextImplTest {
    ...
    public void getDataVersion() throws java.lang.Exception {
        ...
        org.apache.ambari.server.view.configuration.ViewConfig config1 = org.easymock.EasyMock.createNiceMock(org.apache.ambari.server.view.configuration.ViewConfig.class);
        org.easymock.EasyMock.expect(config1.getDataVersion()).andReturn(41);
        org.apache.ambari.server.view.configuration.ViewConfig config2 = org.easymock.EasyMock.createNiceMock(org.apache.ambari.server.view.configuration.ViewConfig.class);
        org.easymock.EasyMock.expect(config2.getDataVersion()).andReturn(42);
        org.easymock.EasyMock.replay(config1, config2);
        org.easymock.EasyMock.expect(entity1.getConfiguration()).andReturn(config1);
        org.easymock.EasyMock.expect(entity2.getConfiguration()).andReturn(config2);
        org.easymock.EasyMock.replay(entity1, entity2);
        ...
        org.easymock.EasyMock.replay(instanceEntity1, instanceEntity2);
    ...
    public void putCurrentInstanceData() throws java.lang.Exception {
        ...
        org.easymock.EasyMock.expect(instanceEntity1.getData()).andReturn(data1).anyTimes();
        org.apache.ambari.server.orm.entities.ViewInstanceEntity instanceEntity2 = getViewInstanceEntityMock(entity2);
        java.util.List<org.apache.ambari.server.orm.entities.ViewInstanceDataEntity> data2 = new java.util.ArrayList<>();
        org.easymock.EasyMock.expect(instanceEntity2.getData()).andReturn(data2).anyTimes();
        org.easymock.EasyMock.replay(instanceEntity1, instanceEntity2);
        org.apache.ambari.server.view.ViewDataMigrationContextImpl context = new org.apache.ambari.server.view.ViewDataMigrationContextImplTest.TestViewDataMigrationContextImpl(instanceEntity1, instanceEntity2);
    ...
    public void copyAllObjects() throws java.lang.Exception {
        ...
        org.apache.ambari.view.DataStore dataStore1 = org.easymock.EasyMock.createStrictMock(org.apache.ambari.view.DataStore.class);
        org.easymock.EasyMock.expect(dataStore1.findAll(org.easymock.EasyMock.eq(org.apache.ambari.server.view.ViewDataMigrationContextImplTest.SampleEntity.class), ((java.lang.String) (org.easymock.EasyMock.isNull())))).andReturn(java.util.Arrays.asList(new org.apache.ambari.server.view.ViewDataMigrationContextImplTest.SampleEntity("data1"), new org.apache.ambari.server.view.ViewDataMigrationContextImplTest.SampleEntity("data2")));
        org.easymock.EasyMock.replay(dataStore1);
        org.apache.ambari.view.DataStore dataStore2 = org.easymock.EasyMock.createStrictMock(org.apache.ambari.view.DataStore.class);
        ...
        dataStore2.store(org.easymock.EasyMock.capture(copiedEntity1));
        org.easymock.EasyMock.expectLastCall();
        dataStore2.store(org.easymock.EasyMock.capture(copiedEntity2));
        org.easymock.EasyMock.expectLastCall();
        org.easymock.EasyMock.replay(dataStore2);
        ...
        org.easymock.EasyMock.verify(dataStore1);
        org.easymock.EasyMock.verify(dataStore2);
    ...
    public void copyAllObjectsWithCustomConverter() throws java.lang.Exception {
        ...
        org.easymock.EasyMock.expect(dataStore1.findAll(org.easymock.EasyMock.eq(org.apache.ambari.server.view.ViewDataMigrationContextImplTest.SampleEntity.class), ((java.lang.String) (org.easymock.EasyMock.isNull())))).andReturn(java.util.Arrays.asList(sampleEntity1, sampleEntity2));
        org.easymock.EasyMock.replay(dataStore1);
        org.apache.ambari.view.DataStore dataStore2 = org.easymock.EasyMock.createStrictMock(org.apache.ambari.view.DataStore.class);
        org.easymock.Capture<org.apache.ambari.server.view.ViewDataMigrationContextImplTest.SampleEntity> copiedEntity1 = org.easymock.Capture.newInstance();
        org.easymock.Capture<org.apache.ambari.server.view.ViewDataMigrationContextImplTest.SampleEntity> copiedEntity2 = org.easymock.Capture.newInstance();
        ...
        context.setMockOriginDataStore(dataStore1);
        context.setMockCurrentDataStore(dataStore2);
        org.apache.ambari.view.migration.EntityConverter converter = org.easymock.EasyMock.createStrictMock(org.apache.ambari.view.migration.EntityConverter.class);
        converter.convert(org.easymock.EasyMock.eq(sampleEntity1), org.easymock.EasyMock.capture(convertedEntity1));
        org.easymock.EasyMock.expectLastCall();
        converter.convert(org.easymock.EasyMock.eq(sampleEntity2), org.easymock.EasyMock.capture(convertedEntity2));
        org.easymock.EasyMock.expectLastCall();
        org.easymock.EasyMock.replay(converter);
        ...
        org.easymock.EasyMock.verify(dataStore1);
        org.easymock.EasyMock.verify(dataStore2);
        org.easymock.EasyMock.verify(converter);
    ...
    public void getEntityClasses() throws java.lang.Exception {
        org.apache.ambari.server.orm.entities.ViewEntity entity1 = getViewEntityMock(org.apache.ambari.server.view.ViewDataMigrationContextImplTest.VERSION_1);
        org.apache.ambari.server.orm.entities.ViewEntity entity2 = getViewEntityMock(org.apache.ambari.server.view.ViewDataMigrationContextImplTest.VERSION_2);
        org.apache.ambari.server.view.configuration.EntityConfig entityConfig = org.easymock.EasyMock.createNiceMock(org.apache.ambari.server.view.configuration.EntityConfig.class);
        org.easymock.EasyMock.expect(entityConfig.getClassName()).andReturn(org.apache.ambari.server.view.ViewDataMigrationContextImplTest.SampleEntity.class.getName()).anyTimes();
        org.easymock.EasyMock.replay(entityConfig);
        org.apache.ambari.server.view.configuration.PersistenceConfig persistenceConfig1 = org.easymock.EasyMock.createStrictMock(org.apache.ambari.server.view.configuration.PersistenceConfig.class);
        org.easymock.EasyMock.expect(persistenceConfig1.getEntities()).andReturn(java.util.Arrays.asList(entityConfig));
        org.apache.ambari.server.view.configuration.PersistenceConfig persistenceConfig2 = org.easymock.EasyMock.createStrictMock(org.apache.ambari.server.view.configuration.PersistenceConfig.class);
        org.easymock.EasyMock.expect(persistenceConfig2.getEntities()).andReturn(java.util.Arrays.asList(entityConfig));
        org.easymock.EasyMock.replay(persistenceConfig1, persistenceConfig2);
        org.apache.ambari.server.view.configuration.ViewConfig config1 = org.easymock.EasyMock.createNiceMock(org.apache.ambari.server.view.configuration.ViewConfig.class);
        org.easymock.EasyMock.expect(config1.getPersistence()).andReturn(persistenceConfig1);
        org.apache.ambari.server.view.configuration.ViewConfig config2 = org.easymock.EasyMock.createNiceMock(org.apache.ambari.server.view.configuration.ViewConfig.class);
        org.easymock.EasyMock.expect(config2.getPersistence()).andReturn(persistenceConfig2);
        org.easymock.EasyMock.replay(config1, config2);
        org.easymock.EasyMock.expect(entity1.getConfiguration()).andReturn(config1);
        org.easymock.EasyMock.expect(entity2.getConfiguration()).andReturn(config2);
        org.easymock.EasyMock.replay(entity1, entity2);
    ...
    public void getInstanceDataByUser() throws java.lang.Exception {
        ...
        org.apache.ambari.server.orm.entities.ViewInstanceEntity instanceEntity1 = getViewInstanceEntityMock(entity1);
        org.easymock.EasyMock.expect(instanceEntity1.getData()).andReturn(data1);
        org.apache.ambari.server.orm.entities.ViewInstanceEntity instanceEntity2 = getViewInstanceEntityMock(entity2);
        org.easymock.EasyMock.expect(instanceEntity2.getData()).andReturn(data2);
        org.easymock.EasyMock.replay(instanceEntity1, instanceEntity2);
        org.apache.ambari.server.view.ViewDataMigrationContextImpl context = new org.apache.ambari.server.view.ViewDataMigrationContextImplTest.TestViewDataMigrationContextImpl(instanceEntity1, instanceEntity2);
    ...
    private org.apache.ambari.server.orm.entities.ViewInstanceEntity getViewInstanceEntityMock(org.apache.ambari.server.orm.entities.ViewEntity viewEntity) {
        ...
        org.easymock.EasyMock.expect(instanceEntity.getViewEntity()).andReturn(viewEntity).anyTimes();
        org.easymock.EasyMock.expect(instanceEntity.getViewName()).andReturn(org.apache.ambari.server.view.ViewDataMigrationContextImplTest.VIEW_NAME).anyTimes();
        org.easymock.EasyMock.expect(instanceEntity.getInstanceName()).andReturn(org.apache.ambari.server.view.ViewDataMigrationContextImplTest.INSTANCE).anyTimes();
    ...
    private org.apache.ambari.server.orm.entities.ViewEntity getViewEntityMock(java.lang.String version) {
        ...
        org.easymock.EasyMock.expect(viewEntity.getViewName()).andReturn(org.apache.ambari.server.view.ViewDataMigrationContextImplTest.VIEW_NAME).anyTimes();
        org.easymock.EasyMock.expect(viewEntity.getVersion()).andReturn(version).anyTimes();
        org.easymock.EasyMock.expect(viewEntity.getClassLoader()).andReturn(getClass().getClassLoader()).anyTimes();
        return viewEntity;
    }
    ...
    private static class TestViewDataMigrationContextImpl extends org.apache.ambari.server.view.ViewDataMigrationContextImpl {
        ...
        private org.apache.ambari.view.DataStore createDataStoreMock() {
            org.apache.ambari.view.DataStore dataStoreMock = org.easymock.EasyMock.createNiceMock(org.apache.ambari.view.DataStore.class);
            org.easymock.EasyMock.replay(dataStoreMock);
