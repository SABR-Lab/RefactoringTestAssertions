...
public class ViewExtractorTest extends org.easymock.EasyMockSupport {
    ...
    public void testExtractViewArchive() throws java.lang.Exception {
        ...
        org.easymock.EasyMock.expect(configuration.getViewExtractionThreadPoolCoreSize()).andReturn(2).anyTimes();
        org.easymock.EasyMock.expect(configuration.getViewExtractionThreadPoolMaxSize()).andReturn(3).anyTimes();
        org.easymock.EasyMock.expect(configuration.getViewExtractionThreadPoolTimeout()).andReturn(10000L).anyTimes();
        if (java.lang.System.getProperty("os.name").contains("Windows")) {
            ...
            org.easymock.EasyMock.expect(metaInfManifest.getAbsolutePath()).andReturn("\\var\\lib\\ambari-server\\resources\\views\\work\\MY_VIEW{1.0.0}\\META-INF\\MANIFEST.MF").anyTimes();
        ...
        org.easymock.EasyMock.expect(addDirPath.isDirectory()).andReturn(true);
        org.easymock.EasyMock.expect(addDirPath.exists()).andReturn(true);
        org.easymock.EasyMock.expect(addDirPath.listFiles()).andReturn(new java.io.File[]{ addDirPathFile1, addDirPathFile2 });
        org.easymock.EasyMock.expect(addDirPathFile1.isDirectory()).andReturn(false);
        org.easymock.EasyMock.expect(addDirPathFile1.toURI()).andReturn(new java.net.URI("file://file1"));
        org.easymock.EasyMock.expect(addDirPathFile2.isDirectory()).andReturn(false);
        org.easymock.EasyMock.expect(addDirPathFile2.toURI()).andReturn(new java.net.URI("file://file2"));
        org.easymock.EasyMock.expect(addDirPath2.isDirectory()).andReturn(true);
        org.easymock.EasyMock.expect(addDirPath2.exists()).andReturn(true);
        org.easymock.EasyMock.expect(addDirPath2.listFiles()).andReturn(new java.io.File[]{  });
        org.easymock.EasyMock.expect(addFilePath.isDirectory()).andReturn(false);
        org.easymock.EasyMock.expect(addFilePath.isFile()).andReturn(true);
        org.easymock.EasyMock.expect(addFilePath.toURI()).andReturn(new java.net.URI("file://file3"));
        replayAll();
    ...
    public void testEnsureExtractedArchiveDirectory() throws java.lang.Exception {
        ...
        org.apache.ambari.server.orm.entities.ViewEntity viewDefinition = org.apache.ambari.server.orm.entities.ViewEntityTest.getViewEntity();
        viewDefinition.setResourceType(resourceTypeEntity);
        org.easymock.EasyMock.expect(extractedArchiveDir.exists()).andReturn(true);
        replayAll();
        org.apache.ambari.server.view.ViewExtractor viewExtractor = getViewExtractor(viewDefinition);
        if (java.lang.System.getProperty("os.name").contains("Windows")) {
        ...
        verifyAll();
        org.easymock.EasyMock.reset(extractedArchiveDir);
        ...
        org.easymock.EasyMock.replay(extractedArchiveDir);
        ...
        org.easymock.EasyMock.verify(extractedArchiveDir);
        org.easymock.EasyMock.reset(extractedArchiveDir);
        org.easymock.EasyMock.expect(extractedArchiveDir.exists()).andReturn(false);
        org.easymock.EasyMock.expect(extractedArchiveDir.mkdir()).andReturn(false);
        org.easymock.EasyMock.replay(extractedArchiveDir);
        viewExtractor = getViewExtractor(viewDefinition);
        if (java.lang.System.getProperty("os.name").contains("Windows")) {
