...
public class ViewRegistryTest {
    ...
    private static final org.apache.ambari.server.view.ViewInstanceOperationHandler viewInstanceOperationHandler = org.easymock.EasyMock.createNiceMock(org.apache.ambari.server.view.ViewInstanceOperationHandler.class);

    private static final org.apache.ambari.server.orm.dao.UserDAO userDAO = org.easymock.EasyMock.createNiceMock(org.apache.ambari.server.orm.dao.UserDAO.class);
    ...
    private static final org.apache.ambari.server.orm.dao.PrivilegeDAO privilegeDAO = org.easymock.EasyMock.createNiceMock(org.apache.ambari.server.orm.dao.PrivilegeDAO.class);

    private static final org.apache.ambari.server.orm.dao.PermissionDAO permissionDAO = org.easymock.EasyMock.createNiceMock(org.apache.ambari.server.orm.dao.PermissionDAO.class);

    private static final org.apache.ambari.server.orm.dao.ResourceDAO resourceDAO = org.easymock.EasyMock.createNiceMock(org.apache.ambari.server.orm.dao.ResourceDAO.class);
    ...
    private static final org.apache.ambari.server.configuration.Configuration configuration = org.easymock.EasyMock.createNiceMock(org.apache.ambari.server.configuration.Configuration.class);
    ...
    private static final org.apache.ambari.server.api.services.AmbariMetaInfo ambariMetaInfo = org.easymock.EasyMock.createNiceMock(org.apache.ambari.server.api.services.AmbariMetaInfo.class);
    ...
    public void resetGlobalMocks() {
        ...
        org.easymock.EasyMock.reset(org.apache.ambari.server.view.ViewRegistryTest.viewInstanceOperationHandler, org.apache.ambari.server.view.ViewRegistryTest.viewDAO, org.apache.ambari.server.view.ViewRegistryTest.resourceDAO, org.apache.ambari.server.view.ViewRegistryTest.viewInstanceDAO, org.apache.ambari.server.view.ViewRegistryTest.userDAO, org.apache.ambari.server.view.ViewRegistryTest.memberDAO, org.apache.ambari.server.view.ViewRegistryTest.privilegeDAO, org.apache.ambari.server.view.ViewRegistryTest.resourceTypeDAO, org.apache.ambari.server.view.ViewRegistryTest.securityHelper, org.apache.ambari.server.view.ViewRegistryTest.configuration, org.apache.ambari.server.view.ViewRegistryTest.handlerList, org.apache.ambari.server.view.ViewRegistryTest.ambariMetaInfo, org.apache.ambari.server.view.ViewRegistryTest.clusters);
    }
    ...
    private void testReadViewArchives(boolean badArchive, boolean removeUndeployed, boolean checkAutoInstanceCreation) throws java.lang.Exception {
        java.io.File viewDir = org.easymock.EasyMock.createNiceMock(java.io.File.class);
        java.io.File extractedArchiveDir = org.easymock.EasyMock.createNiceMock(java.io.File.class);
        java.io.File viewArchive = org.easymock.EasyMock.createNiceMock(java.io.File.class);
        java.io.File archiveDir = org.easymock.EasyMock.createNiceMock(java.io.File.class);
        java.io.File entryFile = org.easymock.EasyMock.createNiceMock(java.io.File.class);
        java.io.File classesDir = org.easymock.EasyMock.createNiceMock(java.io.File.class);
        java.io.File libDir = org.easymock.EasyMock.createNiceMock(java.io.File.class);
        java.io.File metaInfDir = org.easymock.EasyMock.createNiceMock(java.io.File.class);
        java.io.File fileEntry = org.easymock.EasyMock.createNiceMock(java.io.File.class);
        java.util.jar.JarInputStream viewJarFile = org.easymock.EasyMock.createNiceMock(java.util.jar.JarInputStream.class);
        java.util.jar.JarEntry jarEntry = org.easymock.EasyMock.createNiceMock(java.util.jar.JarEntry.class);
        java.io.FileOutputStream fos = org.easymock.EasyMock.createMock(java.io.FileOutputStream.class);
        ...
        org.easymock.EasyMock.expect(org.apache.ambari.server.view.ViewRegistryTest.configuration.getViewsDir()).andReturn(viewDir).anyTimes();
        if (java.lang.System.getProperty("os.name").contains("Windows")) {
            org.easymock.EasyMock.expect(viewDir.getAbsolutePath()).andReturn("\\var\\lib\\ambari-server\\resources\\views").anyTimes();
        } else {
            org.easymock.EasyMock.expect(viewDir.getAbsolutePath()).andReturn("/var/lib/ambari-server/resources/views").anyTimes();
        }
        org.easymock.EasyMock.expect(org.apache.ambari.server.view.ViewRegistryTest.configuration.getViewExtractionThreadPoolCoreSize()).andReturn(2).anyTimes();
        org.easymock.EasyMock.expect(org.apache.ambari.server.view.ViewRegistryTest.configuration.getViewExtractionThreadPoolMaxSize()).andReturn(3).anyTimes();
        org.easymock.EasyMock.expect(org.apache.ambari.server.view.ViewRegistryTest.configuration.getViewExtractionThreadPoolTimeout()).andReturn(10000L).anyTimes();
        org.easymock.EasyMock.expect(org.apache.ambari.server.view.ViewRegistryTest.configuration.extractViewsAfterClusterConfig()).andReturn(java.lang.Boolean.FALSE).anyTimes();
        org.easymock.EasyMock.expect(viewDir.listFiles()).andReturn(new java.io.File[]{ viewArchive });
        org.easymock.EasyMock.expect(viewArchive.isDirectory()).andReturn(false);
        if (java.lang.System.getProperty("os.name").contains("Windows")) {
            org.easymock.EasyMock.expect(viewArchive.getAbsolutePath()).andReturn("\\var\\lib\\ambari-server\\resources\\views\\work\\MY_VIEW{1.0.0}").anyTimes();
        } else {
            org.easymock.EasyMock.expect(viewArchive.getAbsolutePath()).andReturn("/var/lib/ambari-server/resources/views/work/MY_VIEW{1.0.0}").anyTimes();
        }
        org.easymock.EasyMock.expect(archiveDir.exists()).andReturn(false).anyTimes();
        if (java.lang.System.getProperty("os.name").contains("Windows")) {
            org.easymock.EasyMock.expect(archiveDir.getAbsolutePath()).andReturn("\\var\\lib\\ambari-server\\resources\\views\\work\\MY_VIEW{1.0.0}").anyTimes();
        } else {
            org.easymock.EasyMock.expect(archiveDir.getAbsolutePath()).andReturn("/var/lib/ambari-server/resources/views/work/MY_VIEW{1.0.0}").anyTimes();
        }
        org.easymock.EasyMock.expect(archiveDir.mkdir()).andReturn(true).anyTimes();
        org.easymock.EasyMock.expect(archiveDir.toURI()).andReturn(new java.net.URI("file:./")).anyTimes();
        org.easymock.EasyMock.expect(metaInfDir.mkdir()).andReturn(true).anyTimes();
        if (!badArchive) {
            org.easymock.EasyMock.expect(viewJarFile.getNextJarEntry()).andReturn(jarEntry);
            org.easymock.EasyMock.expect(viewJarFile.getNextJarEntry()).andReturn(null);
            org.easymock.EasyMock.expect(jarEntry.getName()).andReturn("view.xml");
            org.easymock.EasyMock.expect(jarEntry.isDirectory()).andReturn(false);
            org.easymock.EasyMock.expect(viewJarFile.read(org.easymock.EasyMock.anyObject(byte[].class))).andReturn(10);
            org.easymock.EasyMock.expect(viewJarFile.read(org.easymock.EasyMock.anyObject(byte[].class))).andReturn(-1);
            fos.write(org.easymock.EasyMock.anyObject(byte[].class), org.easymock.EasyMock.eq(0), org.easymock.EasyMock.eq(10));
            fos.flush();
            fos.close();
            viewJarFile.closeEntry();
            viewJarFile.close();
            org.easymock.EasyMock.expect(org.apache.ambari.server.view.ViewRegistryTest.viewDAO.findByName("MY_VIEW{1.0.0}")).andReturn(viewDefinition);
        }
        org.easymock.EasyMock.expect(extractedArchiveDir.exists()).andReturn(false).anyTimes();
        org.easymock.EasyMock.expect(extractedArchiveDir.mkdir()).andReturn(true).anyTimes();
        org.easymock.EasyMock.expect(classesDir.exists()).andReturn(true).anyTimes();
        org.easymock.EasyMock.expect(classesDir.toURI()).andReturn(new java.net.URI("file:./")).anyTimes();
        org.easymock.EasyMock.expect(libDir.exists()).andReturn(true).anyTimes();
        org.easymock.EasyMock.expect(libDir.listFiles()).andReturn(new java.io.File[]{ fileEntry }).anyTimes();
        org.easymock.EasyMock.expect(fileEntry.toURI()).andReturn(new java.net.URI("file:./")).anyTimes();
        org.easymock.EasyMock.expect(org.apache.ambari.server.view.ViewRegistryTest.configuration.isViewRemoveUndeployedEnabled()).andReturn(removeUndeployed).anyTimes();
        ...
        org.apache.ambari.server.orm.entities.ViewInstanceEntity viewAutoInstanceEntity = org.easymock.EasyMock.createNiceMock(org.apache.ambari.server.orm.entities.ViewInstanceEntity.class);
        ...
        org.apache.ambari.server.orm.entities.ViewInstanceDataEntity autoInstanceDataEntity = org.easymock.EasyMock.createNiceMock(org.apache.ambari.server.orm.entities.ViewInstanceDataEntity.class);
        org.easymock.EasyMock.expect(autoInstanceDataEntity.getName()).andReturn("p1").anyTimes();
        org.easymock.EasyMock.expect(autoInstanceDataEntity.getUser()).andReturn(" ").anyTimes();
        ...
        if (checkAutoInstanceCreation) {
            ...
            org.easymock.EasyMock.expect(org.apache.ambari.server.view.ViewRegistryTest.clusters.getClusters()).andReturn(allClusters);
            org.easymock.EasyMock.expect(org.apache.ambari.server.view.ViewRegistryTest.viewInstanceDAO.merge(org.easymock.EasyMock.capture(viewAutoInstanceCapture))).andReturn(viewAutoInstanceEntity).anyTimes();
            org.easymock.EasyMock.expect(org.apache.ambari.server.view.ViewRegistryTest.viewInstanceDAO.findByName("MY_VIEW{1.0.0}", "AUTO-INSTANCE")).andReturn(viewAutoInstanceEntity).anyTimes();
            org.easymock.EasyMock.expect(viewAutoInstanceEntity.getInstanceData("p1")).andReturn(autoInstanceDataEntity).anyTimes();
        } else {
            org.easymock.EasyMock.expect(org.apache.ambari.server.view.ViewRegistryTest.clusters.getClusters()).andReturn(new java.util.HashMap<>());
        }
        if (removeUndeployed) {
            org.easymock.EasyMock.expect(org.apache.ambari.server.view.ViewRegistryTest.viewDAO.findAll()).andReturn(java.util.Collections.emptyList());
        }
        org.easymock.EasyMock.replay(org.apache.ambari.server.view.ViewRegistryTest.configuration, viewDir, extractedArchiveDir, viewArchive, archiveDir, entryFile, classesDir, libDir, metaInfDir, fileEntry, viewJarFile, jarEntry, fos, org.apache.ambari.server.view.ViewRegistryTest.resourceDAO, org.apache.ambari.server.view.ViewRegistryTest.viewDAO, org.apache.ambari.server.view.ViewRegistryTest.viewInstanceDAO, org.apache.ambari.server.view.ViewRegistryTest.clusters, cluster, viewAutoInstanceEntity);
    ...
    public void testReadViewArchives_exception() throws java.lang.Exception {
        ...
        org.easymock.EasyMock.expect(org.apache.ambari.server.view.ViewRegistryTest.configuration.getViewExtractionThreadPoolTimeout()).andReturn(10000L).anyTimes();
        org.easymock.EasyMock.expect(org.apache.ambari.server.view.ViewRegistryTest.configuration.extractViewsAfterClusterConfig()).andReturn(java.lang.Boolean.FALSE).anyTimes();
        org.easymock.EasyMock.expect(viewDir.listFiles()).andReturn(new java.io.File[]{ viewArchive }).anyTimes();
        org.easymock.EasyMock.expect(viewArchive.isDirectory()).andReturn(false);
        if (java.lang.System.getProperty("os.name").contains("Windows")) {
            org.easymock.EasyMock.expect(viewArchive.getAbsolutePath()).andReturn("\\var\\lib\\ambari-server\\resources\\views\\work\\MY_VIEW{1.0.0}").anyTimes();
        } else {
        ...
        org.easymock.EasyMock.expect(archiveDir.exists()).andReturn(false);
        if (java.lang.System.getProperty("os.name").contains("Windows")) {
            org.easymock.EasyMock.expect(archiveDir.getAbsolutePath()).andReturn("\\var\\lib\\ambari-server\\resources\\views\\work\\MY_VIEW{1.0.0}").anyTimes();
        } else {
            org.easymock.EasyMock.expect(archiveDir.getAbsolutePath()).andReturn("/var/lib/ambari-server/resources/views/work/MY_VIEW{1.0.0}").anyTimes();
        }
        org.easymock.EasyMock.expect(archiveDir.mkdir()).andReturn(true);
        org.easymock.EasyMock.expect(archiveDir.toURI()).andReturn(new java.net.URI("file:./"));
        org.easymock.EasyMock.expect(metaInfDir.mkdir()).andReturn(true);
        org.easymock.EasyMock.expect(viewJarFile.getNextJarEntry()).andReturn(jarEntry);
        org.easymock.EasyMock.expect(viewJarFile.getNextJarEntry()).andReturn(null);
        org.easymock.EasyMock.expect(jarEntry.getName()).andReturn("view.xml");
        org.easymock.EasyMock.expect(jarEntry.isDirectory()).andReturn(false);
        ...
        viewJarFile.closeEntry();
        viewJarFile.close();
        org.easymock.EasyMock.expect(extractedArchiveDir.exists()).andReturn(false);
        org.easymock.EasyMock.expect(extractedArchiveDir.mkdir()).andReturn(true);
        org.easymock.EasyMock.expect(classesDir.exists()).andReturn(true);
        org.easymock.EasyMock.expect(classesDir.toURI()).andReturn(new java.net.URI("file:./"));
        org.easymock.EasyMock.expect(libDir.exists()).andReturn(true);
        org.easymock.EasyMock.expect(libDir.listFiles()).andReturn(new java.io.File[]{ fileEntry });
        org.easymock.EasyMock.expect(fileEntry.toURI()).andReturn(new java.net.URI("file:./"));
        org.easymock.EasyMock.expect(org.apache.ambari.server.view.ViewRegistryTest.viewDAO.findByName("MY_VIEW{1.0.0}")).andThrow(new java.lang.IllegalArgumentException("Expected exception."));
        org.easymock.EasyMock.replay(org.apache.ambari.server.view.ViewRegistryTest.configuration, viewDir, extractedArchiveDir, viewArchive, archiveDir, entryFile, classesDir, libDir, metaInfDir, fileEntry, viewJarFile, jarEntry, fos, org.apache.ambari.server.view.ViewRegistryTest.viewDAO);
        ...
        org.easymock.EasyMock.verify(org.apache.ambari.server.view.ViewRegistryTest.configuration, viewDir, extractedArchiveDir, viewArchive, archiveDir, entryFile, classesDir, libDir, metaInfDir, fileEntry, viewJarFile, jarEntry, fos, org.apache.ambari.server.view.ViewRegistryTest.viewDAO);
    }
    ...
    public void testInstallViewInstance() throws java.lang.Exception {
        ...
        org.easymock.EasyMock.expect(org.apache.ambari.server.view.ViewRegistryTest.viewInstanceDAO.merge(viewInstanceEntity)).andReturn(viewInstanceEntity);
        org.apache.ambari.server.view.ViewRegistryTest.handlerList.addViewInstance(viewInstanceEntity);
        org.easymock.EasyMock.replay(org.apache.ambari.server.view.ViewRegistryTest.viewDAO, org.apache.ambari.server.view.ViewRegistryTest.viewInstanceDAO, org.apache.ambari.server.view.ViewRegistryTest.resourceTypeDAO, org.apache.ambari.server.view.ViewRegistryTest.securityHelper, org.apache.ambari.server.view.ViewRegistryTest.handlerList);
        registry.addDefinition(viewEntity);
        ...
        org.easymock.EasyMock.verify(org.apache.ambari.server.view.ViewRegistryTest.viewDAO, org.apache.ambari.server.view.ViewRegistryTest.viewInstanceDAO, org.apache.ambari.server.view.ViewRegistryTest.resourceTypeDAO, org.apache.ambari.server.view.ViewRegistryTest.securityHelper, org.apache.ambari.server.view.ViewRegistryTest.handlerList);
    }
    ...
    public void testInstallViewInstance_invalid() throws java.lang.Exception {
        ...
        org.apache.ambari.server.orm.entities.ViewEntity viewEntity = org.apache.ambari.server.view.ViewRegistryTest.getViewEntity(config, ambariConfig, getClass().getClassLoader(), "");
        org.apache.ambari.server.orm.entities.ViewInstanceEntity viewInstanceEntity = org.apache.ambari.server.view.ViewRegistryTest.getViewInstanceEntity(viewEntity, config.getInstances().get(0));
        org.easymock.EasyMock.replay(org.apache.ambari.server.view.ViewRegistryTest.viewDAO, org.apache.ambari.server.view.ViewRegistryTest.viewInstanceDAO, org.apache.ambari.server.view.ViewRegistryTest.securityHelper, org.apache.ambari.server.view.ViewRegistryTest.resourceTypeDAO);
        registry.addDefinition(viewEntity);
        try {
            registry.installViewInstance(viewInstanceEntity);
        ...
        org.easymock.EasyMock.verify(org.apache.ambari.server.view.ViewRegistryTest.viewDAO, org.apache.ambari.server.view.ViewRegistryTest.viewInstanceDAO, org.apache.ambari.server.view.ViewRegistryTest.securityHelper, org.apache.ambari.server.view.ViewRegistryTest.resourceTypeDAO);
    }
    ...
    public void testInstallViewInstance_validatorPass() throws java.lang.Exception {
        ...
        properties.put("p1", "v1");
        org.apache.ambari.server.configuration.Configuration ambariConfig = new org.apache.ambari.server.configuration.Configuration(properties);
        org.apache.ambari.view.validation.Validator validator = org.easymock.EasyMock.createNiceMock(org.apache.ambari.view.validation.Validator.class);
        org.apache.ambari.view.validation.ValidationResult result = org.easymock.EasyMock.createNiceMock(org.apache.ambari.view.validation.ValidationResult.class);
        org.apache.ambari.server.view.configuration.ViewConfig config = org.apache.ambari.server.view.configuration.ViewConfigTest.getConfig(org.apache.ambari.server.view.ViewRegistryTest.XML_VALID_INSTANCE);
        org.apache.ambari.server.orm.entities.ViewEntity viewEntity = org.apache.ambari.server.view.ViewRegistryTest.getViewEntity(config, ambariConfig, getClass().getClassLoader(), "");
        ...
        org.easymock.EasyMock.expect(org.apache.ambari.server.view.ViewRegistryTest.viewInstanceDAO.merge(viewInstanceEntity)).andReturn(viewInstanceEntity);
        org.apache.ambari.server.view.ViewRegistryTest.handlerList.addViewInstance(viewInstanceEntity);
        org.easymock.EasyMock.expect(validator.validateInstance(viewInstanceEntity, org.apache.ambari.view.validation.Validator.ValidationContext.PRE_CREATE)).andReturn(result).anyTimes();
        org.easymock.EasyMock.expect(result.isValid()).andReturn(true).anyTimes();
        org.easymock.EasyMock.replay(org.apache.ambari.server.view.ViewRegistryTest.viewDAO, org.apache.ambari.server.view.ViewRegistryTest.viewInstanceDAO, org.apache.ambari.server.view.ViewRegistryTest.securityHelper, org.apache.ambari.server.view.ViewRegistryTest.handlerList, validator, result);
        registry.addDefinition(viewEntity);
        registry.installViewInstance(viewInstanceEntity);
        java.util.Collection<org.apache.ambari.server.orm.entities.ViewInstanceEntity> viewInstanceDefinitions = registry.getInstanceDefinitions(viewEntity);
        org.junit.Assert.assertEquals(1, viewInstanceDefinitions.size());
        ...
        org.junit.Assert.assertEquals("v2-1", instanceEntity.getProperty("p2").getValue());
        org.junit.Assert.assertEquals(viewInstanceEntity, viewInstanceDefinitions.iterator().next());
        org.easymock.EasyMock.verify(org.apache.ambari.server.view.ViewRegistryTest.viewDAO, org.apache.ambari.server.view.ViewRegistryTest.viewInstanceDAO, org.apache.ambari.server.view.ViewRegistryTest.securityHelper, org.apache.ambari.server.view.ViewRegistryTest.handlerList, validator, result);
    }
    ...
    public void testInstallViewInstance_validatorFail() throws java.lang.Exception {
        ...
        org.apache.ambari.server.orm.entities.ViewInstanceEntity viewInstanceEntity = org.apache.ambari.server.view.ViewRegistryTest.getViewInstanceEntity(viewEntity, config.getInstances().get(0));
        org.easymock.EasyMock.expect(validator.validateInstance(viewInstanceEntity, org.apache.ambari.view.validation.Validator.ValidationContext.PRE_CREATE)).andReturn(result).anyTimes();
        org.easymock.EasyMock.expect(result.isValid()).andReturn(false).anyTimes();
        org.easymock.EasyMock.replay(org.apache.ambari.server.view.ViewRegistryTest.viewDAO, org.apache.ambari.server.view.ViewRegistryTest.viewInstanceDAO, org.apache.ambari.server.view.ViewRegistryTest.securityHelper, org.apache.ambari.server.view.ViewRegistryTest.handlerList, validator, result);
        registry.addDefinition(viewEntity);
        try {
            registry.installViewInstance(viewInstanceEntity);
    ...
    public void testUpdateViewInstance() throws java.lang.Exception {
        ...
        org.easymock.EasyMock.expect(org.apache.ambari.server.view.ViewRegistryTest.viewInstanceDAO.merge(viewInstanceEntity)).andReturn(viewInstanceEntity);
        org.easymock.EasyMock.expect(org.apache.ambari.server.view.ViewRegistryTest.viewInstanceDAO.findByName("MY_VIEW{1.0.0}", viewInstanceEntity.getInstanceName())).andReturn(viewInstanceEntity).anyTimes();
        org.easymock.EasyMock.replay(org.apache.ambari.server.view.ViewRegistryTest.viewDAO, org.apache.ambari.server.view.ViewRegistryTest.viewInstanceDAO, org.apache.ambari.server.view.ViewRegistryTest.securityHelper);
        registry.addDefinition(viewEntity);
        registry.installViewInstance(viewInstanceEntity);
        ...
        org.junit.Assert.assertEquals(viewInstanceEntity, viewInstanceDefinitions.iterator().next());
        org.easymock.EasyMock.verify(org.apache.ambari.server.view.ViewRegistryTest.viewDAO, org.apache.ambari.server.view.ViewRegistryTest.viewInstanceDAO, org.apache.ambari.server.view.ViewRegistryTest.securityHelper);
    }
    ...
    public void testUninstallViewInstance() throws java.lang.Exception {
        ...
        org.easymock.EasyMock.replay(org.apache.ambari.server.view.ViewRegistryTest.viewInstanceOperationHandler, org.apache.ambari.server.view.ViewRegistryTest.handlerList);
        registry.addDefinition(viewEntity);
        registry.addInstanceDefinition(viewEntity, viewInstanceEntity);
        registry.uninstallViewInstance(viewInstanceEntity);
        java.util.Collection<org.apache.ambari.server.orm.entities.ViewInstanceEntity> viewInstanceDefinitions = registry.getInstanceDefinitions(viewEntity);
        org.junit.Assert.assertEquals(0, viewInstanceDefinitions.size());
        org.easymock.EasyMock.verify(org.apache.ambari.server.view.ViewRegistryTest.viewInstanceOperationHandler, org.apache.ambari.server.view.ViewRegistryTest.handlerList);
    }
    ...
    public void testUpdateViewInstance_validatorPass() throws java.lang.Exception {
        ...
        org.easymock.EasyMock.expect(org.apache.ambari.server.view.ViewRegistryTest.viewInstanceDAO.merge(viewInstanceEntity)).andReturn(viewInstanceEntity);
        org.easymock.EasyMock.expect(org.apache.ambari.server.view.ViewRegistryTest.viewInstanceDAO.findByName("MY_VIEW{1.0.0}", viewInstanceEntity.getInstanceName())).andReturn(viewInstanceEntity).anyTimes();
        org.easymock.EasyMock.expect(validator.validateInstance(viewInstanceEntity, org.apache.ambari.view.validation.Validator.ValidationContext.PRE_UPDATE)).andReturn(result).anyTimes();
        org.easymock.EasyMock.expect(result.isValid()).andReturn(true).anyTimes();
        org.easymock.EasyMock.replay(org.apache.ambari.server.view.ViewRegistryTest.viewDAO, org.apache.ambari.server.view.ViewRegistryTest.viewInstanceDAO, org.apache.ambari.server.view.ViewRegistryTest.securityHelper, validator, result);
        registry.addDefinition(viewEntity);
        registry.installViewInstance(viewInstanceEntity);
        registry.updateViewInstance(updateInstance);
        java.util.Collection<org.apache.ambari.server.orm.entities.ViewInstanceEntity> viewInstanceDefinitions = registry.getInstanceDefinitions(viewEntity);
        ...
        org.junit.Assert.assertEquals("v2-1", instanceEntity.getProperty("p2").getValue());
        org.junit.Assert.assertEquals(viewInstanceEntity, viewInstanceDefinitions.iterator().next());
        org.easymock.EasyMock.verify(org.apache.ambari.server.view.ViewRegistryTest.viewDAO, org.apache.ambari.server.view.ViewRegistryTest.viewInstanceDAO, org.apache.ambari.server.view.ViewRegistryTest.securityHelper, validator, result);
    }
    ...
    public void testIncludeDefinitionForAdmin() {
        ...
        org.easymock.EasyMock.replay(org.apache.ambari.server.view.ViewRegistryTest.configuration);
        ...
        org.easymock.EasyMock.verify(org.apache.ambari.server.view.ViewRegistryTest.configuration);
    }
    ...
    public void testIncludeDefinitionForUserNoInstances() {
        org.apache.ambari.server.view.ViewRegistry registry = org.apache.ambari.server.view.ViewRegistry.getInstance();
        org.apache.ambari.server.orm.entities.ViewEntity viewEntity = org.easymock.EasyMock.createNiceMock(org.apache.ambari.server.orm.entities.ViewEntity.class);
        org.easymock.EasyMock.expect(viewEntity.getInstances()).andReturn(java.util.Collections.emptyList()).anyTimes();
        org.easymock.EasyMock.replay(viewEntity, org.apache.ambari.server.view.ViewRegistryTest.configuration);
        ...
        org.easymock.EasyMock.verify(viewEntity, org.apache.ambari.server.view.ViewRegistryTest.configuration);
    }
    ...
    public void testIncludeDefinitionForUserHasAccess() {
        ...
        org.easymock.EasyMock.expect(viewEntity.getInstances()).andReturn(instances);
        org.easymock.EasyMock.expect(instanceEntity.getResource()).andReturn(resourceEntity);
        org.easymock.EasyMock.expect(resourceEntity.getId()).andReturn(54L).anyTimes();
        org.easymock.EasyMock.expect(resourceEntity.getResourceType()).andReturn(resourceTypeEntity).anyTimes();
        org.easymock.EasyMock.expect(resourceTypeEntity.getId()).andReturn(org.apache.ambari.server.security.authorization.ResourceType.VIEW.getId()).anyTimes();
        org.easymock.EasyMock.expect(resourceTypeEntity.getName()).andReturn(org.apache.ambari.server.security.authorization.ResourceType.VIEW.name()).anyTimes();
        org.easymock.EasyMock.replay(viewEntity, instanceEntity, resourceEntity, resourceTypeEntity, org.apache.ambari.server.view.ViewRegistryTest.configuration);
        ...
        org.junit.Assert.assertTrue(registry.includeDefinition(viewEntity));
        org.easymock.EasyMock.verify(viewEntity, instanceEntity, resourceEntity, resourceTypeEntity, org.apache.ambari.server.view.ViewRegistryTest.configuration);
    }
    ...
    public void testCheckViewVersions() {
        org.apache.ambari.server.view.ViewRegistry registry = org.apache.ambari.server.view.ViewRegistry.getInstance();
        org.apache.ambari.server.orm.entities.ViewEntity viewEntity = org.easymock.EasyMock.createNiceMock(org.apache.ambari.server.orm.entities.ViewEntity.class);
        org.apache.ambari.server.view.configuration.ViewConfig config = org.easymock.EasyMock.createNiceMock(org.apache.ambari.server.view.configuration.ViewConfig.class);
        org.easymock.EasyMock.expect(viewEntity.getConfiguration()).andReturn(config).anyTimes();
        org.easymock.EasyMock.expect(config.getMinAmbariVersion()).andReturn(null);
        org.easymock.EasyMock.expect(config.getMaxAmbariVersion()).andReturn(null);
        org.easymock.EasyMock.expect(config.getMinAmbariVersion()).andReturn("1.0.0");
        org.easymock.EasyMock.expect(config.getMaxAmbariVersion()).andReturn("3.0.0");
        org.easymock.EasyMock.expect(config.getMinAmbariVersion()).andReturn("1.0.0");
        org.easymock.EasyMock.expect(config.getMaxAmbariVersion()).andReturn("1.5");
        org.easymock.EasyMock.expect(config.getMinAmbariVersion()).andReturn("2.5");
        org.easymock.EasyMock.expect(config.getMinAmbariVersion()).andReturn(null);
        org.easymock.EasyMock.expect(config.getMaxAmbariVersion()).andReturn("3.0.0");
        org.easymock.EasyMock.expect(config.getMinAmbariVersion()).andReturn("1.0.0");
        org.easymock.EasyMock.expect(config.getMaxAmbariVersion()).andReturn(null);
        org.easymock.EasyMock.expect(config.getMinAmbariVersion()).andReturn("1.0.0");
        org.easymock.EasyMock.expect(config.getMaxAmbariVersion()).andReturn("*");
        org.easymock.EasyMock.expect(config.getMinAmbariVersion()).andReturn("*");
        org.easymock.EasyMock.expect(config.getMaxAmbariVersion()).andReturn("3.0.0");
        org.easymock.EasyMock.expect(config.getMinAmbariVersion()).andReturn("1.0.0");
        org.easymock.EasyMock.expect(config.getMaxAmbariVersion()).andReturn("2.*");
        org.easymock.EasyMock.expect(config.getMinAmbariVersion()).andReturn("1.*");
        org.easymock.EasyMock.expect(config.getMaxAmbariVersion()).andReturn("3.0.0");
        org.easymock.EasyMock.expect(config.getMinAmbariVersion()).andReturn("1.0.0");
        org.easymock.EasyMock.expect(config.getMaxAmbariVersion()).andReturn("2.1.*");
        org.easymock.EasyMock.expect(config.getMinAmbariVersion()).andReturn("1.5.*");
        org.easymock.EasyMock.expect(config.getMaxAmbariVersion()).andReturn("3.0.0");
        org.easymock.EasyMock.expect(config.getMinAmbariVersion()).andReturn("1.0.0");
        org.easymock.EasyMock.expect(config.getMaxAmbariVersion()).andReturn("1.9.9.*");
        org.easymock.EasyMock.expect(config.getMinAmbariVersion()).andReturn("2.0.0.1.*");
        org.easymock.EasyMock.replay(viewEntity, config);
        ...
        org.junit.Assert.assertFalse(registry.checkViewVersions(viewEntity, "2.0.0"));
        org.junit.Assert.assertFalse(registry.checkViewVersions(viewEntity, "2.0.0"));
        org.easymock.EasyMock.verify(viewEntity, config);
    }
    ...
    public void testExtractViewArchive() throws java.lang.Exception {
        ...
        java.util.jar.JarInputStream viewJarFile = org.easymock.EasyMock.createNiceMock(java.util.jar.JarInputStream.class);
        java.util.jar.JarEntry jarEntry = org.easymock.EasyMock.createNiceMock(java.util.jar.JarEntry.class);
        java.io.InputStream is = org.easymock.EasyMock.createMock(java.io.InputStream.class);
        java.io.FileOutputStream fos = org.easymock.EasyMock.createMock(java.io.FileOutputStream.class);
        org.apache.ambari.server.view.ViewExtractor viewExtractor = org.easymock.EasyMock.createMock(org.apache.ambari.server.view.ViewExtractor.class);
        org.apache.ambari.server.orm.entities.ResourceTypeEntity resourceTypeEntity = new org.apache.ambari.server.orm.entities.ResourceTypeEntity();
        resourceTypeEntity.setId(10);
        resourceTypeEntity.setName("MY_VIEW{1.0.0}");
        org.apache.ambari.server.orm.entities.ViewEntity viewDefinition = org.apache.ambari.server.orm.entities.ViewEntityTest.getViewEntity();
        ...
        java.util.Map<java.io.File, java.util.jar.JarInputStream> jarFiles = new java.util.HashMap<>();
        jarFiles.put(viewArchive, viewJarFile);
        org.easymock.EasyMock.expect(org.apache.ambari.server.view.ViewRegistryTest.configuration.getViewsDir()).andReturn(viewDir);
        if (java.lang.System.getProperty("os.name").contains("Windows")) {
            org.easymock.EasyMock.expect(viewDir.getAbsolutePath()).andReturn("\\var\\lib\\ambari-server\\resources\\views");
        } else {
            org.easymock.EasyMock.expect(viewDir.getAbsolutePath()).andReturn("/var/lib/ambari-server/resources/views");
        }
        org.easymock.EasyMock.expect(org.apache.ambari.server.view.ViewRegistryTest.configuration.getViewExtractionThreadPoolCoreSize()).andReturn(2).anyTimes();
        ...
        if (java.lang.System.getProperty("os.name").contains("Windows")) {
            org.easymock.EasyMock.expect(viewExtractor.ensureExtractedArchiveDirectory("\\var\\lib\\ambari-server\\resources\\views\\work")).andReturn(true);
        } else {
            org.easymock.EasyMock.expect(viewExtractor.ensureExtractedArchiveDirectory("/var/lib/ambari-server/resources/views/work")).andReturn(true);
        }
        org.easymock.EasyMock.expect(viewExtractor.extractViewArchive(org.easymock.EasyMock.capture(viewEntityCapture), org.easymock.EasyMock.eq(viewArchive), org.easymock.EasyMock.eq(archiveDir), org.easymock.EasyMock.anyObject(java.util.List.class))).andReturn(null);
    ...
    public void testSetViewInstanceRoleAccess() throws java.lang.Exception {
        ...
        org.easymock.Capture<org.apache.ambari.server.orm.entities.PrivilegeEntity> captureCreatedPrivilegeEntity = org.easymock.Capture.newInstance(org.easymock.CaptureType.ALL);
        for (java.util.Map.Entry<java.lang.String, org.apache.ambari.server.orm.entities.PermissionEntity> entry : permissions.entrySet()) {
            org.easymock.EasyMock.expect(org.apache.ambari.server.view.ViewRegistryTest.permissionDAO.findByName(entry.getKey())).andReturn(entry.getValue()).atLeastOnce();
        }
        org.easymock.EasyMock.expect(org.apache.ambari.server.view.ViewRegistryTest.permissionDAO.findViewUsePermission()).andReturn(permissionViewUser).atLeastOnce();
        org.easymock.EasyMock.expect(org.apache.ambari.server.view.ViewRegistryTest.privilegeDAO.exists(org.easymock.EasyMock.anyObject(org.apache.ambari.server.orm.entities.PrincipalEntity.class), org.easymock.EasyMock.eq(resourceEntity), org.easymock.EasyMock.eq(permissionViewUser))).andAnswer(new org.easymock.IAnswer<java.lang.Boolean>() {
            @java.lang.Override
        ...
        org.apache.ambari.server.view.ViewRegistryTest.privilegeDAO.create(org.easymock.EasyMock.capture(captureCreatedPrivilegeEntity));
        org.easymock.EasyMock.expectLastCall().times(expectedPrivileges.size());
        org.easymock.EasyMock.replay(org.apache.ambari.server.view.ViewRegistryTest.privilegeDAO, org.apache.ambari.server.view.ViewRegistryTest.permissionDAO);
        ...
        org.easymock.EasyMock.verify(org.apache.ambari.server.view.ViewRegistryTest.privilegeDAO, org.apache.ambari.server.view.ViewRegistryTest.permissionDAO);
    ...
    public static class TestViewModule extends org.apache.ambari.server.view.ViewRegistry.ViewModule {
        ...
        protected void configure() {
            ...
            org.easymock.EasyMock.replay(osFamily);
    ...
    private void testOnAmbariEventServiceCreation(java.lang.String xml, java.util.Set<java.lang.String> serviceNames, java.lang.String stackName, boolean success) throws java.lang.Exception {
        ...
        for (java.lang.String serviceName : serviceNames) {
            ...
            org.easymock.EasyMock.expect(cluster.getService(serviceName)).andReturn(service);
        }
        org.easymock.EasyMock.expect(org.apache.ambari.server.view.ViewRegistryTest.clusters.getClusterById(99L)).andReturn(cluster);
        org.easymock.EasyMock.expect(cluster.getClusterName()).andReturn("c1").anyTimes();
        org.easymock.EasyMock.expect(cluster.getCurrentStackVersion()).andReturn(stackId).anyTimes();
        org.easymock.EasyMock.expect(cluster.getServices()).andReturn(serviceMap).anyTimes();
        ...
        org.easymock.EasyMock.expect(org.apache.ambari.server.view.ViewRegistryTest.viewInstanceDAO.merge(org.easymock.EasyMock.capture(viewInstanceCapture))).andReturn(viewInstanceEntity).anyTimes();
        org.easymock.EasyMock.expect(org.apache.ambari.server.view.ViewRegistryTest.viewInstanceDAO.findByName("MY_VIEW{1.0.0}", "AUTO-INSTANCE")).andReturn(viewInstanceEntity).anyTimes();
        org.easymock.EasyMock.replay(org.apache.ambari.server.view.ViewRegistryTest.securityHelper, org.apache.ambari.server.view.ViewRegistryTest.configuration, org.apache.ambari.server.view.ViewRegistryTest.viewInstanceDAO, org.apache.ambari.server.view.ViewRegistryTest.clusters, cluster, service, viewInstanceEntity);
        ...
        org.easymock.EasyMock.verify(org.apache.ambari.server.view.ViewRegistryTest.securityHelper, org.apache.ambari.server.view.ViewRegistryTest.configuration, org.apache.ambari.server.view.ViewRegistryTest.viewInstanceDAO, org.apache.ambari.server.view.ViewRegistryTest.clusters, cluster, viewInstanceEntity);
    }
}
