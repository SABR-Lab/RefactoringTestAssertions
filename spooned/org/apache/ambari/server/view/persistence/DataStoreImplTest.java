...
public class DataStoreImplTest {
    ...
    public void testStore_create() throws java.lang.Exception {
        ...
        javax.persistence.EntityManagerFactory entityManagerFactory = org.easymock.EasyMock.createMock(javax.persistence.EntityManagerFactory.class);
        org.eclipse.persistence.jpa.JpaEntityManager jpaEntityManager = org.easymock.EasyMock.createMock(org.eclipse.persistence.jpa.JpaEntityManager.class);
        org.eclipse.persistence.sessions.server.ServerSession session = org.easymock.EasyMock.createMock(org.eclipse.persistence.sessions.server.ServerSession.class);
        org.eclipse.persistence.sessions.DatabaseLogin databaseLogin = org.easymock.EasyMock.createMock(org.eclipse.persistence.sessions.DatabaseLogin.class);
        javax.persistence.EntityManager entityManager = org.easymock.EasyMock.createMock(javax.persistence.EntityManager.class);
        org.eclipse.persistence.jpa.dynamic.JPADynamicHelper jpaDynamicHelper = org.easymock.EasyMock.createNiceMock(org.eclipse.persistence.jpa.dynamic.JPADynamicHelper.class);
        org.eclipse.persistence.tools.schemaframework.SchemaManager schemaManager = org.easymock.EasyMock.createNiceMock(org.eclipse.persistence.tools.schemaframework.SchemaManager.class);
        javax.persistence.EntityTransaction transaction = org.easymock.EasyMock.createMock(javax.persistence.EntityTransaction.class);
        org.powermock.api.easymock.PowerMock.mockStatic(org.eclipse.persistence.jpa.JpaHelper.class);
        org.easymock.EasyMock.expect(org.eclipse.persistence.jpa.JpaHelper.getEntityManager(entityManager)).andReturn(jpaEntityManager).anyTimes();
        org.powermock.api.easymock.PowerMock.replay(org.eclipse.persistence.jpa.JpaHelper.class);
        org.easymock.EasyMock.expect(jpaEntityManager.getServerSession()).andReturn(session).anyTimes();
        org.easymock.EasyMock.expect(session.getLogin()).andReturn(databaseLogin).anyTimes();
        org.easymock.Capture<org.eclipse.persistence.sequencing.Sequence> sequenceCapture = org.easymock.EasyMock.newCapture();
        databaseLogin.addSequence(org.easymock.EasyMock.capture(sequenceCapture));
        ...
        entityManager.persist(org.easymock.EasyMock.capture(entityCapture));
        ...
        entityManager.persist(org.easymock.EasyMock.capture(entityCapture2));
        org.easymock.EasyMock.expectLastCall().andAnswer(new org.easymock.IAnswer<java.lang.Object>() {
            @java.lang.Override
            public java.lang.Object answer() throws java.lang.Throwable {
        ...
        jpaDynamicHelper.addTypes(org.easymock.EasyMock.eq(true), org.easymock.EasyMock.eq(true), org.easymock.EasyMock.capture(typeCapture), org.easymock.EasyMock.capture(typeCapture2));
        org.easymock.EasyMock.expect(entityManagerFactory.createEntityManager()).andReturn(entityManager).anyTimes();
        org.easymock.EasyMock.expect(entityManager.getTransaction()).andReturn(transaction).anyTimes();
        entityManager.close();
        transaction.begin();
        transaction.commit();
        org.easymock.EasyMock.replay(entityManagerFactory, entityManager, jpaDynamicHelper, transaction, schemaManager, jpaEntityManager, session, databaseLogin);
        ...
        org.easymock.EasyMock.verify(entityManagerFactory, entityManager, jpaDynamicHelper, transaction, schemaManager, jpaEntityManager, session, databaseLogin);
    }
    ...
    public void testStore_create_longStringValue() throws java.lang.Exception {
        ...
        entityManager.close();
        transaction.begin();
        org.easymock.EasyMock.expect(transaction.isActive()).andReturn(true);
    ...
    public void testStore_update() throws java.lang.Exception {
        ...
        org.eclipse.persistence.tools.schemaframework.SchemaManager schemaManager = org.easymock.EasyMock.createNiceMock(org.eclipse.persistence.tools.schemaframework.SchemaManager.class);
        javax.persistence.EntityTransaction transaction = org.easymock.EasyMock.createMock(javax.persistence.EntityTransaction.class);
        org.eclipse.persistence.dynamic.DynamicEntity dynamicEntity = org.easymock.EasyMock.createMock(org.eclipse.persistence.dynamic.DynamicEntity.class);
        org.eclipse.persistence.dynamic.DynamicEntity dynamicSubEntity = org.easymock.EasyMock.createMock(org.eclipse.persistence.dynamic.DynamicEntity.class);
        org.powermock.api.easymock.PowerMock.mockStatic(org.eclipse.persistence.jpa.JpaHelper.class);
        org.easymock.EasyMock.expect(org.eclipse.persistence.jpa.JpaHelper.getEntityManager(entityManager)).andReturn(jpaEntityManager).anyTimes();
        org.powermock.api.easymock.PowerMock.replay(org.eclipse.persistence.jpa.JpaHelper.class);
        org.easymock.EasyMock.expect(jpaEntityManager.getServerSession()).andReturn(session).anyTimes();
        ...
        org.easymock.EasyMock.expect(entityManager.find(org.easymock.EasyMock.capture(entityClassCapture), org.easymock.EasyMock.eq(100))).andReturn(dynamicEntity);
        org.easymock.Capture<java.lang.Class> entityClassCapture2 = org.easymock.EasyMock.newCapture();
        org.easymock.EasyMock.expect(entityManager.find(org.easymock.EasyMock.capture(entityClassCapture2), org.easymock.EasyMock.eq(99))).andReturn(dynamicSubEntity);
        entityManager.close();
        org.easymock.EasyMock.expect(dynamicEntity.set("DS_id", 100)).andReturn(dynamicEntity);
        org.easymock.EasyMock.expect(dynamicEntity.set("DS_name", "foo")).andReturn(dynamicEntity);
        org.easymock.EasyMock.expect(dynamicSubEntity.set("DS_id", 99)).andReturn(dynamicSubEntity);
        org.easymock.EasyMock.expect(dynamicSubEntity.set("DS_name", "bar")).andReturn(dynamicSubEntity);
        org.easymock.Capture<org.eclipse.persistence.dynamic.DynamicEntity> subEntityCapture = org.easymock.EasyMock.newCapture();
        org.easymock.EasyMock.expect(dynamicEntity.set(org.easymock.EasyMock.eq("DS_subEntity"), org.easymock.EasyMock.capture(subEntityCapture))).andReturn(dynamicSubEntity);
        org.easymock.EasyMock.expect(dynamicEntity.get("DS_id")).andReturn(100);
        org.easymock.EasyMock.expect(dynamicEntity.get("DS_name")).andReturn("foo");
        org.easymock.EasyMock.expect(dynamicEntity.get("DS_subEntity")).andReturn(dynamicSubEntity);
        org.easymock.EasyMock.expect(dynamicEntity.get("DS_class")).andReturn(dynamicEntity.getClass());
        org.easymock.EasyMock.expect(dynamicSubEntity.get("DS_id")).andReturn(99);
        org.easymock.EasyMock.expect(dynamicSubEntity.get("DS_name")).andReturn("bar");
        transaction.begin();
        transaction.commit();
        org.easymock.EasyMock.replay(entityManagerFactory, entityManager, jpaDynamicHelper, transaction, schemaManager, dynamicEntity, jpaEntityManager, session, databaseLogin, dynamicSubEntity);
        org.apache.ambari.server.view.persistence.DataStoreImpl dataStore = getDataStore(entityManagerFactory, jpaDynamicHelper, classLoader, schemaManager);
        ...
        org.easymock.EasyMock.verify(entityManagerFactory, entityManager, jpaDynamicHelper, transaction, schemaManager, dynamicEntity, jpaEntityManager, session, databaseLogin, dynamicSubEntity);
    }
    ...
    public void testStore_update_longStringValue() throws java.lang.Exception {
        ...
        org.easymock.EasyMock.expect(entityManager.getTransaction()).andReturn(transaction).anyTimes();
        org.easymock.Capture<java.lang.Class> entityClassCapture2 = org.easymock.EasyMock.newCapture();
        org.easymock.EasyMock.expect(entityManager.find(org.easymock.EasyMock.capture(entityClassCapture2), org.easymock.EasyMock.eq(99))).andReturn(dynamicEntity);
        entityManager.close();
        java.lang.StringBuilder sb = new java.lang.StringBuilder();
        for (int i = 0; i < 5000; ++i) {
            sb.append("A");
        ...
        java.lang.String longString = sb.toString();
        org.easymock.EasyMock.expect(dynamicEntity.set("DS_id", 99)).andReturn(dynamicEntity).anyTimes();
        transaction.begin();
        org.easymock.EasyMock.expect(transaction.isActive()).andReturn(true).anyTimes();
        transaction.rollback();
        org.easymock.EasyMock.replay(entityManagerFactory, entityManager, jpaDynamicHelper, transaction, schemaManager, dynamicEntity, jpaEntityManager, session, databaseLogin);
        org.apache.ambari.server.view.persistence.DataStoreImpl dataStore = getDataStore(entityManagerFactory, jpaDynamicHelper, classLoader, schemaManager);
        try {
        ...
        org.easymock.EasyMock.verify(entityManagerFactory, entityManager, jpaDynamicHelper, transaction, schemaManager, dynamicEntity, jpaEntityManager, session, databaseLogin);
    }
    ...
    public void testRemove() throws java.lang.Exception {
        ...
        org.easymock.EasyMock.expect(entityManager.getTransaction()).andReturn(transaction).anyTimes();
        org.easymock.Capture<java.lang.Class> entityClassCapture = org.easymock.EasyMock.newCapture();
        org.easymock.EasyMock.expect(entityManager.getReference(org.easymock.EasyMock.capture(entityClassCapture), org.easymock.EasyMock.eq(99))).andReturn(dynamicEntity);
    ...
    public void testFind() throws java.lang.Exception {
        ...
        org.easymock.EasyMock.expect(entityManagerFactory.createEntityManager()).andReturn(entityManager).anyTimes();
        org.easymock.Capture<java.lang.Class> entityClassCapture = org.easymock.EasyMock.newCapture();
        org.easymock.EasyMock.expect(entityManager.find(org.easymock.EasyMock.capture(entityClassCapture), org.easymock.EasyMock.eq(99))).andReturn(dynamicEntity);
        entityManager.close();
        org.easymock.EasyMock.expect(dynamicEntity.get("DS_id")).andReturn(99);
        org.easymock.EasyMock.expect(dynamicEntity.get("DS_name")).andReturn("foo");
        ...
        org.easymock.EasyMock.expect(dynamicEntity.get("DS_subEntity")).andReturn(subEntity);
        org.easymock.EasyMock.replay(entityManagerFactory, entityManager, jpaDynamicHelper, dynamicEntity, schemaManager, jpaEntityManager, session, databaseLogin);
        org.apache.ambari.server.view.persistence.DataStoreImpl dataStore = getDataStore(entityManagerFactory, jpaDynamicHelper, classLoader, schemaManager);
        ...
        org.easymock.EasyMock.verify(entityManagerFactory, entityManager, jpaDynamicHelper, dynamicEntity, schemaManager, jpaEntityManager, session, databaseLogin);
    }
    ...
    public void testFindAll() throws java.lang.Exception {
        ...
        org.eclipse.persistence.tools.schemaframework.SchemaManager schemaManager = org.easymock.EasyMock.createNiceMock(org.eclipse.persistence.tools.schemaframework.SchemaManager.class);
        org.eclipse.persistence.dynamic.DynamicEntity dynamicEntity = org.easymock.EasyMock.createMock(org.eclipse.persistence.dynamic.DynamicEntity.class);
        javax.persistence.Query query = org.easymock.EasyMock.createMock(javax.persistence.Query.class);
        org.powermock.api.easymock.PowerMock.mockStatic(org.eclipse.persistence.jpa.JpaHelper.class);
        org.easymock.EasyMock.expect(org.eclipse.persistence.jpa.JpaHelper.getEntityManager(entityManager)).andReturn(jpaEntityManager).anyTimes();
        org.powermock.api.easymock.PowerMock.replay(org.eclipse.persistence.jpa.JpaHelper.class);
        org.easymock.EasyMock.expect(jpaEntityManager.getServerSession()).andReturn(session).anyTimes();
        ...
        jpaDynamicHelper.addTypes(org.easymock.EasyMock.eq(true), org.easymock.EasyMock.eq(true), org.easymock.EasyMock.capture(typeCapture), org.easymock.EasyMock.capture(typeCapture2));
        org.easymock.EasyMock.expect(entityManagerFactory.createEntityManager()).andReturn(entityManager).anyTimes();
        org.easymock.EasyMock.expect(entityManager.createQuery("SELECT e FROM DS_DataStoreImplTest$TestEntity_1 e WHERE e.DS_id=99")).andReturn(query);
        entityManager.close();
        org.easymock.EasyMock.expect(query.getResultList()).andReturn(java.util.Collections.singletonList(dynamicEntity));
        org.easymock.EasyMock.expect(dynamicEntity.get("DS_id")).andReturn(99);
        org.easymock.EasyMock.expect(dynamicEntity.get("DS_name")).andReturn("foo");
        org.apache.ambari.server.view.persistence.DataStoreImplTest.TestSubEntity subEntity = new org.apache.ambari.server.view.persistence.DataStoreImplTest.TestSubEntity("bar");
        org.easymock.EasyMock.expect(dynamicEntity.get("DS_subEntity")).andReturn(subEntity);
        org.easymock.EasyMock.replay(entityManagerFactory, entityManager, jpaDynamicHelper, dynamicEntity, query, schemaManager, jpaEntityManager, session, databaseLogin);
        org.apache.ambari.server.view.persistence.DataStoreImpl dataStore = getDataStore(entityManagerFactory, jpaDynamicHelper, classLoader, schemaManager);
        ...
        org.junit.Assert.assertEquals(99, ((int) (entity.getId())));
        org.junit.Assert.assertEquals("foo", entity.getName());
        org.easymock.EasyMock.verify(entityManagerFactory, entityManager, jpaDynamicHelper, dynamicEntity, query, schemaManager, jpaEntityManager, session, databaseLogin);
    }
    ...
    public void testFindAll_multiple() throws java.lang.Exception {
        ...
        org.eclipse.persistence.jpa.dynamic.JPADynamicHelper jpaDynamicHelper = org.easymock.EasyMock.createNiceMock(org.eclipse.persistence.jpa.dynamic.JPADynamicHelper.class);
        org.eclipse.persistence.tools.schemaframework.SchemaManager schemaManager = org.easymock.EasyMock.createNiceMock(org.eclipse.persistence.tools.schemaframework.SchemaManager.class);
        org.eclipse.persistence.dynamic.DynamicEntity dynamicEntity1 = org.easymock.EasyMock.createMock(org.eclipse.persistence.dynamic.DynamicEntity.class);
        org.eclipse.persistence.dynamic.DynamicEntity dynamicEntity2 = org.easymock.EasyMock.createMock(org.eclipse.persistence.dynamic.DynamicEntity.class);
        org.eclipse.persistence.dynamic.DynamicEntity dynamicEntity3 = org.easymock.EasyMock.createMock(org.eclipse.persistence.dynamic.DynamicEntity.class);
        javax.persistence.Query query = org.easymock.EasyMock.createMock(javax.persistence.Query.class);
        org.powermock.api.easymock.PowerMock.mockStatic(org.eclipse.persistence.jpa.JpaHelper.class);
        org.easymock.EasyMock.expect(org.eclipse.persistence.jpa.JpaHelper.getEntityManager(entityManager)).andReturn(jpaEntityManager).anyTimes();
        org.powermock.api.easymock.PowerMock.replay(org.eclipse.persistence.jpa.JpaHelper.class);
        ...
        jpaDynamicHelper.addTypes(org.easymock.EasyMock.eq(true), org.easymock.EasyMock.eq(true), org.easymock.EasyMock.capture(typeCapture), org.easymock.EasyMock.capture(typeCapture2));
        org.easymock.EasyMock.expect(entityManagerFactory.createEntityManager()).andReturn(entityManager).anyTimes();
        org.easymock.EasyMock.expect(entityManager.createQuery("SELECT e FROM DS_DataStoreImplTest$TestEntity_1 e WHERE e.DS_name='foo'")).andReturn(query);
        entityManager.close();
        ...
        org.easymock.EasyMock.expect(query.getResultList()).andReturn(entityList);
        org.easymock.EasyMock.expect(dynamicEntity1.get("DS_id")).andReturn(99);
        org.easymock.EasyMock.expect(dynamicEntity1.get("DS_name")).andReturn("foo");
        ...
        org.easymock.EasyMock.expect(dynamicEntity1.get("DS_subEntity")).andReturn(subEntity1);
        org.easymock.EasyMock.expect(dynamicEntity2.get("DS_id")).andReturn(100);
        org.easymock.EasyMock.expect(dynamicEntity2.get("DS_name")).andReturn("foo");
        ...
        org.easymock.EasyMock.expect(dynamicEntity2.get("DS_subEntity")).andReturn(subEntity2);
        org.easymock.EasyMock.expect(dynamicEntity3.get("DS_id")).andReturn(101);
        org.easymock.EasyMock.expect(dynamicEntity3.get("DS_name")).andReturn("foo");
        ...
        org.easymock.EasyMock.expect(dynamicEntity3.get("DS_subEntity")).andReturn(subEntity3);
        org.easymock.EasyMock.replay(entityManagerFactory, entityManager, jpaDynamicHelper, dynamicEntity1, dynamicEntity2, dynamicEntity3, query, schemaManager, jpaEntityManager, session, databaseLogin);
        org.apache.ambari.server.view.persistence.DataStoreImpl dataStore = getDataStore(entityManagerFactory, jpaDynamicHelper, classLoader, schemaManager);
        ...
        org.easymock.EasyMock.verify(entityManagerFactory, entityManager, jpaDynamicHelper, dynamicEntity1, dynamicEntity2, dynamicEntity3, query, schemaManager, jpaEntityManager, session, databaseLogin);
    }
