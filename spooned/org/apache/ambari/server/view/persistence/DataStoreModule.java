...
public class DataStoreModule implements com.google.inject.Module , org.apache.ambari.server.view.persistence.SchemaManagerFactory {
    ...
    private javax.persistence.EntityManagerFactory getEntityManagerFactory(org.apache.ambari.server.configuration.Configuration configuration) {
        ...
        if (!configuration.getPersistenceType().equals(org.apache.ambari.server.orm.PersistenceType.IN_MEMORY)) {
            persistenceMap.put(org.eclipse.persistence.config.PersistenceUnitProperties.JDBC_USER, configuration.getDatabaseUser());
            persistenceMap.put(org.eclipse.persistence.config.PersistenceUnitProperties.JDBC_PASSWORD, configuration.getDatabasePassword());
            persistenceMap.put(org.eclipse.persistence.config.PersistenceUnitProperties.CLASSLOADER, classLoader);
            persistenceMap.put(org.eclipse.persistence.config.PersistenceUnitProperties.WEAVING, "static");
        }
