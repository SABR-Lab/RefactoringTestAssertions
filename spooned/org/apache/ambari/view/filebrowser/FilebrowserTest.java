...
public class FilebrowserTest {
    ...
    public void setUp() throws java.lang.Exception {
        handler = org.easymock.EasyMock.createNiceMock(org.apache.ambari.view.ViewResourceHandler.class);
        context = org.easymock.EasyMock.createNiceMock(org.apache.ambari.view.ViewContext.class);
        httpHeaders = org.easymock.EasyMock.createNiceMock(javax.ws.rs.core.HttpHeaders.class);
        uriInfo = org.easymock.EasyMock.createNiceMock(javax.ws.rs.core.UriInfo.class);
        ...
        conf.set(org.apache.hadoop.hdfs.MiniDFSCluster.HDFS_MINIDFS_BASEDIR, baseDir.getAbsolutePath());
        ...
        org.easymock.EasyMock.expect(context.getUsername()).andReturn(java.lang.System.getProperty("user.name")).anyTimes();
        org.easymock.EasyMock.replay(handler, context, httpHeaders, uriInfo);
    ...
    private javax.ws.rs.core.Response uploadFile(java.lang.String path, java.lang.String fileName, java.lang.String fileExtension, java.lang.String fileContent) throws java.lang.Exception {
        ...
        org.glassfish.jersey.media.multipart.FormDataBodyPart inputStreamBody = new org.glassfish.jersey.media.multipart.FormDataBodyPart(org.glassfish.jersey.media.multipart.FormDataContentDisposition.name("file").fileName(fileName + fileExtension).build(), content, javax.ws.rs.core.MediaType.APPLICATION_OCTET_STREAM_TYPE);
