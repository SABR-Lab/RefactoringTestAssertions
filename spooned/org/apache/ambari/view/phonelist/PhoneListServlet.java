...
public class PhoneListServlet extends javax.servlet.http.HttpServlet {
    ...
    protected void doGet(javax.servlet.http.HttpServletRequest request, javax.servlet.http.HttpServletResponse response) throws javax.servlet.ServletException, java.io.IOException {
        ...
        try {
            java.lang.String name = request.getParameter("name");
            java.lang.String phone = getPhone(name);
            if (phone != null) {
    ...
    private void editNumber(java.io.PrintWriter writer, java.lang.String name, java.lang.String phone, javax.servlet.http.HttpServletRequest request) {
        writer.println(("<form name=\"input\" action = \"" + request.getRequestURI()) + "\" method=\"POST\">");
        writer.println("<table>");
        writer.println("<tr>");
    ...
    private void addUser(java.lang.String name, java.lang.String phone) throws org.apache.ambari.view.PersistenceException {
        if (userExists(name)) {
    ...
    private void updateUser(java.lang.String name, java.lang.String phone) throws org.apache.ambari.view.PersistenceException {
        if (dataStore != null) {
            dataStore.store(new org.apache.ambari.view.phonelist.PhoneUser(name, phone));
        } else {
            viewContext.putInstanceData(name, phone);
        }
    }

    private void removeUser(java.lang.String name, java.lang.String phone) throws org.apache.ambari.view.PersistenceException {
        if (dataStore != null) {
            dataStore.remove(new org.apache.ambari.view.phonelist.PhoneUser(name, phone));
        } else {
            viewContext.removeInstanceData(name);
        }
    }

    private java.lang.String getPhone(java.lang.String name) throws org.apache.ambari.view.PersistenceException {
        if ((name != null) && (name.length() > 0)) {
            if (dataStore != null) {
                org.apache.ambari.view.phonelist.PhoneUser phoneUser = dataStore.find(org.apache.ambari.view.phonelist.PhoneUser.class, name);
                if (phoneUser != null) {
    ...
    private java.util.Collection<org.apache.ambari.view.phonelist.PhoneUser> getAllUsers() throws org.apache.ambari.view.PersistenceException {
        ...
        for (java.util.Map.Entry<java.lang.String, java.lang.String> entry : data.entrySet()) {
            users.add(new org.apache.ambari.view.phonelist.PhoneUser(entry.getKey(), entry.getValue()));
            entry.getKey();
        }
        return users;
    }
