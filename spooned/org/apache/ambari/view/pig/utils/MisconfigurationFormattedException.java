...
public class MisconfigurationFormattedException extends javax.ws.rs.WebApplicationException {
    ...
    protected static javax.ws.rs.core.Response errorEntity(java.lang.String name) {
        ...
        return javax.ws.rs.core.Response.status(org.apache.ambari.view.pig.utils.MisconfigurationFormattedException.STATUS).entity(new org.json.simple.JSONObject(response)).type(javax.ws.rs.core.MediaType.APPLICATION_JSON).build();
    }
}
