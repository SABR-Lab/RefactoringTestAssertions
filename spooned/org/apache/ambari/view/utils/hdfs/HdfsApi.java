...
public class HdfsApi {
    ...
    private UserGroupInformation.AuthenticationMethod getAuthenticationMethod() {
        ...
        if (authParams.containsKey("auth")) {
            ...
            authMethod = org.apache.hadoop.security.UserGroupInformation.AuthenticationMethod.valueOf(authName.toUpperCase());
        } else {
    ...
    public java.util.Map<java.lang.String, java.lang.Object> fileStatusToJSON(org.apache.hadoop.fs.FileStatus status) {
        ...
        json.put("readAccess", org.apache.ambari.view.utils.hdfs.HdfsApi.checkAccessPermissions(status, org.apache.hadoop.fs.permission.FsAction.READ, ugi));
        json.put("writeAccess", org.apache.ambari.view.utils.hdfs.HdfsApi.checkAccessPermissions(status, org.apache.hadoop.fs.permission.FsAction.WRITE, ugi));
        json.put("executeAccess", org.apache.ambari.view.utils.hdfs.HdfsApi.checkAccessPermissions(status, org.apache.hadoop.fs.permission.FsAction.EXECUTE, ugi));
